...
static int omrsig_sigaction_internal(int signum,
...
typedef void(__cdecl*(__cdecl* SIGNAL)(_In_ int _SigNum,
                                       _In_opt_ void(__cdecl* _Func)(int)))(
    int);
...
static bool checkMaskEquality(int signum,
                              const sigset_t* mask,
...
#if defined(POSIX_SIGNAL)
int omrsig_primary_sigaction(int signum,
                             const struct sigaction* act,
                             struct sigaction* oldact) {
...
int omrsig_signalOS_internal(int signum,
                             const struct sigaction* act,
                             struct sigaction* oldact) {
  int rc = 0;
#if defined(J9ZOS390)
...
int __sigactionset(size_t newct,
                   const __sigactionset_t newsets[],
                   size_t* oldct,
                   __sigactionset_t oldsets[],
                   int options) {
