...
public:
  ...
  MM_LanguageThreadLocalHeap()
      : allocateThreadLocalHeap(), nonZeroAllocateThreadLocalHeap(),
        nonZeroHeapAlloc(NULL), heapAlloc(NULL), nonZeroHeapTop(NULL),
        heapTop(NULL), nonZeroTlhPrefetchFTA(0), tlhPrefetchFTA(0){};
};
