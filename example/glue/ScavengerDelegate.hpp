...
public:
     ...
     * scavenger forwarding slot, which may have been overwritten in the original copy process, and backing out changes
     * to object flags in the forwarding slot. With the exception of the scavenger forwarding slot, all of the other
     * bits of the original copied object should be intact.
     *
     ...
     * with refs to Nursery). Fixup should update slots to point to the forwarded version of the object and/or remove
