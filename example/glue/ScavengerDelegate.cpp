...
void
MM_ScavengerDelegate::workerSetupForGC_clearEnvironmentLangStats(
...
void
MM_ScavengerDelegate::reportScavengeEnd(MM_EnvironmentBase* envBase,
...
void
MM_ScavengerDelegate::masterThreadGarbageCollect_scavengeComplete(
...
void
MM_ScavengerDelegate::masterThreadGarbageCollect_scavengeSuccess(
  MM_EnvironmentBase* envBase)
{
  /* Do nothing for now */
}
...
bool
MM_ScavengerDelegate::hasIndirectReferentsInNewSpace(
...
bool
MM_ScavengerDelegate::scavengeIndirectObjectSlots(MM_EnvironmentStandard* env,
                                                  omrobjectptr_t objectPtr)
{
...
void
MM_ScavengerDelegate::backOutIndirectObjectSlots(MM_EnvironmentStandard* env,
                                                 omrobjectptr_t objectPtr)
{
  /* This method must be implemented if an object may hold any object references
   * that are live but not reachable by traversing the reference graph from the
...
void
MM_ScavengerDelegate::reverseForwardedObject(
  MM_EnvironmentBase* env,
