...
public:
   ...
   */
  MMINLINE bool canForceConcurrentKickoff(MM_EnvironmentBase* env, uintptr_t gcCode, uintptr_t* languageKickoffReason)
  {
   ...
   * @return the next language-defined tracing mode, or CONCURRENT_TRACE_ONLY if all language-defined roots have been
   * traced
   * @see MM_ConcurrentMarkingDelegate::collectRoots(MM_EnvironmentBase *, uintptr_t, bool *, bool *)
   */
   ...
   */
  MMINLINE bool scanThreadRoots(MM_EnvironmentBase* env)
  {
    return true;
  }
   ...
   */
  MMINLINE bool flushThreadRoots(MM_EnvironmentBase* env)
  {
    return false;
  }
