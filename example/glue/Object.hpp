...
/**
 * A header containing basic information about an object. Contains the object's
 * size and an 8 bit object flag. The size and flags are masked together into a
 * single fomrobjectptr_t.
 */
class ObjectHeader {
 public:
  ObjectHeader() {}
