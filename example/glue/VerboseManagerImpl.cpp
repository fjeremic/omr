...
bool MM_VerboseManagerImpl::configureVerboseGC(OMR_VM* omrVM, char* filename, uintptr_t fileCount, uintptr_t iterations)
{
...
MM_VerboseHandlerOutput* MM_VerboseManagerImpl::createVerboseHandlerOutputObject(MM_EnvironmentBase* env)
{
