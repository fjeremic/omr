...
template<typename T>
IlType*
toIlType(typename OMR::EnableIf<OMR::IsIntegral<T>::VALUE &&
                                (sizeof(T) == 1)>::Type* = 0)
{
  return Int8;
}
...
template<typename T>
IlType*
toIlType(typename OMR::EnableIf<OMR::IsFloatingPoint<T>::VALUE &&
                                (sizeof(T) == 4)>::Type* = 0)
{
  return Float;
}
...
template<typename T>
IlType*
toIlType(typename OMR::EnableIf<OMR::IsVoid<T>::VALUE>::Type* = 0)
{
  return NoType;
}
