...
const char *JitBuilder::ResolvedMethod::signature(TR_Memory *trMemory,
  ...
  if (!_signature) {
    ...
    if (allocKind == heapAlloc) _signature = s;
...
const char *JitBuilder::ResolvedMethod::externalName(
    TR_Memory *trMemory, TR_AllocationKind allocKind) {
  if (!_externalName) {
...
TR::IlInjector *JitBuilder::ResolvedMethod::getInjector(
    TR::IlGeneratorMethodDetails *details,
    TR::ResolvedMethodSymbol *methodSymbol, TR::FrontEnd *fe,
