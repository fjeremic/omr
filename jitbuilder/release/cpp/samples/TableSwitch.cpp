...
void TableSwitchMethod::PrintString(OMR::JitBuilder::IlBuilder* bldr, const char* s)
{
...
bool TableSwitchMethod::buildIL()
{
  ...
  TableSwitch("selector", &defaultBldr, true, 3, MakeCase(1, &case1Bldr, false), MakeCase(2, &case2Bldr, false),
