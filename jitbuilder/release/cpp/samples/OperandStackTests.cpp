...
void
OperandStackTestMethod::verifyStack(const char* step,
                                    int32_t max,
                                    int32_t num,
                                    ...)
{
  ...
  if (verbose)
    cout << "\tResult " << step << ": realSP-_realStack == " << (num - 1)
         << ": ";
  REPORT2((realSP - _realStack) == (num - 1),
  ...
  : OMR::JitBuilder::MethodBuilder(d)
{
  ...
  DefineFunction("createStack",
                 "0",
                 "0",
                 (void*)&OperandStackTestMethod::createStack,
                 NoType,
                 0);
  DefineFunction("moveStack",
                 "0",
                 "0",
                 (void*)&OperandStackTestMethod::moveStack,
                 pValueType,
                 0);
  DefineFunction("freeStack",
                 "0",
                 "0",
  ...
  DefineFunction(
    "verifyResult9", "0", "0", (void*)&verifyResult9, NoType, 1, _valueType);
  DefineFunction(
    "verifyResult10", "0", "0", (void*)&verifyResult10, NoType, 1, _valueType);
  DefineFunction("verifyResult11", "0", "0", (void*)&verifyResult11, NoType, 0);
  DefineFunction(
    "verifyResult12", "0", "0", (void*)&verifyResult12, NoType, 1, _valueType);
  DefineFunction("verifyValuesEqual",
                 "0",
                 "0",
                 (void*)&verifyValuesEqual,
                 NoType,
                 2,
                 _valueType,
                 _valueType);
  DefineFunction("modifyTop3Elements",
                 "0",
                 "0",
                 (void*)&modifyTop3Elements,
                 NoType,
                 1,
                 _valueType);
}
...
bool
OperandStackTestMethod::testStack(OMR::JitBuilder::BytecodeBuilder* b,
                                  bool useEqual)
{
  ...
  COMMIT(mergeBB);
  mergeBB->Call(
    "modifyTop3Elements", 1, mergeBB->ConstInteger(_valueType, amountToAdd));
  RELOAD(mergeBB);
...
OperandStackTestMethod::buildIL()
{
  ...
  OMR::JitBuilder::VirtualMachineRegister* stackTop =
    new OMR::JitBuilder::VirtualMachineRegister(
      this, "SP", pElementType, sizeof(STACKVALUETYPE), realStackTopAddress);
  OMR::JitBuilder::VirtualMachineOperandStack* stack =
    new OMR::JitBuilder::VirtualMachineOperandStack(
      this, 1, _valueType, stackTop);
  ...
  : OperandStackTestMethod(d)
{
  ...
  d->DefineField(
    "Thread", "sp", d->PointerTo(STACKVALUEILTYPE), offsetof(Thread, sp));
...
OperandStackTestUsingStructMethod::buildIL()
{
  ...
  OMR::JitBuilder::VirtualMachineRegisterInStruct* stackTop =
    new OMR::JitBuilder::VirtualMachineRegisterInStruct(
      this, "Thread", "thread", "sp", "SP");
  OMR::JitBuilder::VirtualMachineOperandStack* stack =
    new OMR::JitBuilder::VirtualMachineOperandStack(
      this, 1, _valueType, stackTop);
