...
public:
  ...
  TestState(OMR::JitBuilder::VirtualMachineOperandStack* stack, OMR::JitBuilder::VirtualMachineRegister* stackTop)
    : OMR::JitBuilder::VirtualMachineState()
    , _stack(stack)
    , _stackTop(stackTop)
  {}
...
{
  if (verbose)
    cout << "Push();Push();Push() - modify elements passed in real stack and return";
...
void OperandStackTestMethod::verifyStack(const char* step, int32_t max, int32_t num, ...)
{
...
OperandStackTestMethod::OperandStackTestMethod(OMR::JitBuilder::TypeDictionary* d)
...
bool OperandStackTestMethod::testStack(OMR::JitBuilder::BytecodeBuilder* b, bool useEqual)
{
  ...
  OMR::JitBuilder::IlValue* expected = mergeBB->ConstInteger(_valueType, 3 + amountToAdd);
...
bool OperandStackTestMethod::buildIL()
{
  ...
  OMR::JitBuilder::IlType* pElementType = dict->PointerTo(dict->PointerTo(STACKVALUEILTYPE));

  Call("createStack", 0);

  OMR::JitBuilder::IlValue* realStackTopAddress = ConstAddress(&_realStackTop);
  OMR::JitBuilder::VirtualMachineRegister* stackTop = new OMR::JitBuilder::VirtualMachineRegister(
    this, "SP", pElementType, sizeof(STACKVALUETYPE), realStackTopAddress);
  OMR::JitBuilder::VirtualMachineOperandStack* stack
    = new OMR::JitBuilder::VirtualMachineOperandStack(this, 1, _valueType, stackTop);
...
OperandStackTestUsingStructMethod::OperandStackTestUsingStructMethod(OMR::JitBuilder::TypeDictionary* d)
...
bool OperandStackTestUsingStructMethod::buildIL()
{
  ...
  OMR::JitBuilder::VirtualMachineRegisterInStruct* stackTop
    = new OMR::JitBuilder::VirtualMachineRegisterInStruct(this, "Thread", "thread", "sp", "SP");
  OMR::JitBuilder::VirtualMachineOperandStack* stack
    = new OMR::JitBuilder::VirtualMachineOperandStack(this, 1, _valueType, stackTop);
