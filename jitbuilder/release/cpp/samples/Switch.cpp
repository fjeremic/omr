...
void SwitchMethod::PrintString(OMR::JitBuilder::IlBuilder* bldr, const char* s)
{
...
bool SwitchMethod::buildIL()
{
  ...
  Switch("selector", &defaultBldr, 3, MakeCase(1, &case1Bldr, false), MakeCase(2, &case2Bldr, false),
