...
bool InliningRecursiveFibonacciMethod::buildIL()
{
  ...
  OMR::JitBuilder::IlValue* nMinusOne = recursiveCase->Sub(recursiveCase->Load("n"), recursiveCase->ConstInt32(1));
  ...
  OMR::JitBuilder::IlValue* nMinusTwo = recursiveCase->Sub(recursiveCase->Load("n"), recursiveCase->ConstInt32(2));
  ...
  recursiveCase->Store("result", recursiveCase->Add(fib_nMinusOne, fib_nMinusTwo));
