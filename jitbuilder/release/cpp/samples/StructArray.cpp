...
void
printStructElems(uint8_t type, int32_t value)
{
...
void
printElemOffsets(int32_t typeOffset, int32_t valueOffset)
{
...
CreateStructArrayMethod::buildIL()
{
  Store(
    "myArray",
    Call("malloc", 1, Mul(Load("size"), ConstInt32(StructType->getSize()))));
