...
ConstStringMethod::ConstStringMethod(OMR::JitBuilder::TypeDictionary* d)
  ...
  DefineFunction((const char* const) "printString", (const char* const)__FILE__,
                 (const char* const)PRINTSTRING_LINE, (void*)&printString,
                 NoType, 1, Address);
}

bool ConstStringMethod::buildIL() {
  OMR::JitBuilder::IlValue* value =
      ConstString("The test string is: Hello World!\n");
