...
verifyResult9(ARRAYVALUETYPE six, ARRAYVALUETYPE seven)
{
  ...
  OperandArrayTestMethod::verify(
    "9", 8, 8, 0, 1, 2, expectedResult8, 4, 5, 22, 22);
}
...
verifyResult10(ARRAYVALUETYPE one, ARRAYVALUETYPE two)
{
  ...
  OperandArrayTestMethod::verify(
    "10", 8, 8, 0, 7, 19, expectedResult8, 4, 5, 22, 22);
}
  ...
  : OMR::JitBuilder::MethodBuilder(d)
{
  ...
  DefineFunction("createArray",
                 "0",
                 "0",
                 (void*)&OperandArrayTestMethod::createArray,
                 NoType,
                 0);
  DefineFunction("moveArray",
                 "0",
                 "0",
                 (void*)&OperandArrayTestMethod::moveArray,
                 pValueType,
                 0);
  DefineFunction("freeArray",
                 "0",
                 "0",
  ...
  DefineFunction(
    "verifyResult2", "0", "0", (void*)&verifyResult2, NoType, 1, _valueType);
  DefineFunction(
    "verifyResult3", "0", "0", (void*)&verifyResult3, NoType, 1, _valueType);
  DefineFunction(
    "verifyResult4", "0", "0", (void*)&verifyResult4, NoType, 1, _valueType);
  DefineFunction(
    "verifyResult5", "0", "0", (void*)&verifyResult5, NoType, 1, _valueType);
  DefineFunction(
    "verifyResult6", "0", "0", (void*)&verifyResult6, NoType, 1, _valueType);
  DefineFunction("verifyResult7", "0", "0", (void*)&verifyResult7, NoType, 0);
  DefineFunction(
    "verifyResult8", "0", "0", (void*)&verifyResult8, NoType, 1, _valueType);
  DefineFunction("verifyResult9",
                 "0",
                 "0",
                 (void*)&verifyResult9,
                 NoType,
  ...
  DefineFunction("verifyResult10",
                 ...
                 _valueType,
                 _valueType);
  DefineFunction("modifyIndex1And2",
                 "0",
                 "0",
                 (void*)&modifyIndex1And2,
                 NoType,
                 2,
                 _valueType,
                 _valueType);
...
bool
OperandArrayTestMethod::testArray(OMR::JitBuilder::BytecodeBuilder* builder,
                                  bool useEqual)
{
...
OperandArrayTestMethod::buildIL()
{
  ...
  OMR::JitBuilder::VirtualMachineRegister* arrayBase =
    new OMR::JitBuilder::VirtualMachineRegister(
      this, "ARRAY", ppElementType, sizeof(ARRAYVALUETYPE), arrayBaseAddress);
  OMR::JitBuilder::VirtualMachineOperandArray* array =
    new OMR::JitBuilder::VirtualMachineOperandArray(
      this, _realArrayLength, _valueType, arrayBase);
