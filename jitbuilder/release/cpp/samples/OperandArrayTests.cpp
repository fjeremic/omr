...
static void setupResult8Equals() {
  expectedResult8 = 9;
  result8Operator = (char *)"==";
}

static void setupResult8NotEquals() {
  expectedResult8 = 11;
  result8Operator = (char *)"!=";
}
...
int main(int argc, char *argv[]) {
  ...
  OperandArrayTestMethodFunction *ptrTest =
      (OperandArrayTestMethodFunction *)entry2;
  ...
  OMR::JitBuilder::TypeDictionary types4;
  ...
  OperandArrayTestUsingFalseMethodFunction *ptrTestFalse =
      (OperandArrayTestUsingFalseMethodFunction *)entry4;
...
void OperandArrayTestMethod::createArray() {
...
ARRAYVALUETYPE *OperandArrayTestMethod::moveArray() {
...
void OperandArrayTestMethod::freeArray() {
  memset(_realArray, 0xFF, _realArrayLength * sizeof(ARRAYVALUETYPE));
  free(_realArray);
  _realArray = NULL;
}

static void Fail() { numFailingTests++; }

static void Pass() { numPassingTests++; }

#define REPORT1(c, n, v)                                                       \
  {                                                                            \
    if (c) {                                                                   \
      Pass();                                                                  \
      if (verbose)                                                             \
...
void verifyResult2(ARRAYVALUETYPE last) {
  // VMOA      [0,1   ,2   ,null,...,null]
  //_realArray[0,null,null,null,...,null]
  if (verbose)
    cout << "Set(1, 1); Set(2, 2); Get(2)   [ no commit]\n";
  if (verbose)
    cout << "\tResult 2: last value == 2: ";
  REPORT1(last == 2, "last", last);

  OperandArrayTestMethod::verify("2", 1, 1, 0);
}

void verifyResult3(ARRAYVALUETYPE last) {
  // VMOA      [0,1,2,null,...,null]
...
void verifyResult4(ARRAYVALUETYPE last) {
  // VMOA      [0,1,2,2   ,null,...,null]
  //_realArray[0,1,2,null,null,...,null]
  if (verbose)
    cout << "Move(3, 2)    [ no commit]\n";
  if (verbose)
    cout << "\tResult 4: last value == 2: ";
  REPORT1(last == 2, "last", last);

  OperandArrayTestMethod::verify("4", 3, 3, 0, 1, 2);
}

void verifyResult5(ARRAYVALUETYPE last) {
  // VMOA      [0,1,2,2,null,...,null]
  //_realArray[0,1,2,2,null,...,null]
  if (verbose)
    cout << "Commit(); Get(3)\n";
  if (verbose)
    cout << "\tResult 5: last value == 2: ";
  REPORT1(last == 2, "last", last);

  OperandArrayTestMethod::verify("5", 4, 4, 0, 1, 2, 2);
}

void verifyResult6(ARRAYVALUETYPE last) {
  // VMOA      [0,1,2,2,4,null,...,null]
  //_realArray[0,1,2,2,4,null,...,null]
  if (verbose)
    cout << "Set(4, Add(GET(2), Get(3))); Commit(); Get(4)\n";
  if (verbose)
    cout << "\tResult 6: last == 4: ";
...
void verifyResult7() {
  ...
  if (verbose)
    cout << "Set(5,5); Set(6,5); Commit();\n";
  OperandArrayTestMethod::verify("7", 7, 7, 0, 1, 2, 2, 4, 5, 5);
}

void verifyResult8(ARRAYVALUETYPE last) {
  // VMOA      [0,1,2,{9,11},4,5,5,null]
  //_realArray[0,1,2,{9,11},4,5,5,null]
  if (verbose)
    cout << "if (5 " << result8Operator
         << " 5) { SET(3,9); } else { Set(3,11); } Commit(); Get(3);\n";
  if (verbose)
    cout << "\tResult 8: last == " << expectedResult8 << ": ";
  REPORT1(last == expectedResult8, "last", last);
  OperandArrayTestMethod::verify("8", 7, 7, 0, 1, 2, expectedResult8, 4, 5, 5);
}

void verifyResult9(ARRAYVALUETYPE six, ARRAYVALUETYPE seven) {
  // VMOA      [0,1,2,{9,11},4,5,22,22]
  //_realArray[0,1,2,{9,11},4,5,5 ,5]
  if (verbose)
    cout << "Set(7,GET(6)); Commit();\n";
  if (verbose)
    cout << "Set(7,22); ";
  if (verbose)
    cout << "Commit();\n";
  if (verbose)
    cout << "\tResult 9: six == 22: ";
  REPORT1(six == 22, "six", six);
  if (verbose)
    cout << "\tResult 9: seven == 22: ";
  REPORT1(seven == 22, "seven", seven);
  OperandArrayTestMethod::verify("9", 8, 8, 0, 1, 2, expectedResult8, 4, 5, 22,
                                 22);
}

void verifyResult10(ARRAYVALUETYPE one, ARRAYVALUETYPE two) {
  // VMOA      [0,7,19,{9,11},4,5,22,22]
  //_realArray[0,7,19,{9,11},4,5,5 ,5]
  if (verbose)
    cout << "update the real array at index 2 and 3; ";
  if (verbose)
    cout << "Reload();\n";
  if (verbose)
    cout << "\tResult 10: one == 7: ";
  REPORT1(one == 7, "one", one);
  if (verbose)
    cout << "\tResult 10: two == 19: ";
  REPORT1(two == 19, "two", two);
  OperandArrayTestMethod::verify("10", 8, 8, 0, 7, 19, expectedResult8, 4, 5,
                                 22, 22);
}

void modifyIndex1And2(ARRAYVALUETYPE one, ARRAYVALUETYPE two) {
  // VMOA      [0,1,2,{9,11},4,5,22,22]
  //_realArray[0,1,2,{9,11},4,5,5 ,5]
  if (verbose)
    cout << "modify elements at index 1 and 2 and return";
...
bool OperandArrayTestMethod::verifyUntouched(int32_t maxTouched) {
...
void OperandArrayTestMethod::verify(const char *step, int32_t max, int32_t num,
                                    ...) {
  va_list args;
  va_start(args, num);
  for (int32_t a = 0; a < num; a++) {
    ...
    if (verbose)
      cout << "\tResult " << step << ": _realArray[" << a << "] == " << val
           << ": ";
...
OperandArrayTestMethod::OperandArrayTestMethod(
  ...
  _realArrayLength = 8;
  _realArray =
      (ARRAYVALUETYPE *)malloc(_realArrayLength * sizeof(ARRAYVALUETYPE));
  memset(_realArray, 0, _realArrayLength * sizeof(ARRAYVALUETYPE));

  _valueType = ARRAYVALUEILTYPE;
  OMR::JitBuilder::IlType *pValueType = d->PointerTo(_valueType);

  DefineFunction("createArray", "0", "0",
                 (void *)&OperandArrayTestMethod::createArray, NoType, 0);
  DefineFunction("moveArray", "0", "0",
                 (void *)&OperandArrayTestMethod::moveArray, pValueType, 0);
  DefineFunction("freeArray", "0", "0",
                 (void *)&OperandArrayTestMethod::freeArray, NoType, 0);
  DefineFunction("verifyResult0", "0", "0", (void *)&verifyResult0, NoType, 0);
  DefineFunction("verifyResult1", "0", "0", (void *)&verifyResult1, NoType, 0);
  DefineFunction("verifyResult2", "0", "0", (void *)&verifyResult2, NoType, 1,
                 _valueType);
  DefineFunction("verifyResult3", "0", "0", (void *)&verifyResult3, NoType, 1,
                 _valueType);
  DefineFunction("verifyResult4", "0", "0", (void *)&verifyResult4, NoType, 1,
                 _valueType);
  DefineFunction("verifyResult5", "0", "0", (void *)&verifyResult5, NoType, 1,
                 _valueType);
  DefineFunction("verifyResult6", "0", "0", (void *)&verifyResult6, NoType, 1,
                 _valueType);
  DefineFunction("verifyResult7", "0", "0", (void *)&verifyResult7, NoType, 0);
  DefineFunction("verifyResult8", "0", "0", (void *)&verifyResult8, NoType, 1,
                 _valueType);
  DefineFunction("verifyResult9", "0", "0", (void *)&verifyResult9, NoType, 2,
                 _valueType, _valueType);
  DefineFunction("verifyResult10", "0", "0", (void *)&verifyResult10, NoType, 2,
                 _valueType, _valueType);
  DefineFunction("modifyIndex1And2", "0", "0", (void *)&modifyIndex1And2,
                 NoType, 2, _valueType, _valueType);
}

// convenience macros
#define STACK(b) ((OMR::JitBuilder::VirtualMachineOperandArray *)(b)->vmState())
...
bool OperandArrayTestMethod::testArray(
    OMR::JitBuilder::BytecodeBuilder *builder, bool useEqual) {
  ...
  COMMIT(builder);
  OMR::JitBuilder::IlValue *newArray = builder->Call("moveArray", 0);
  ...
  OMR::JitBuilder::IlValue *sum =
      builder->Add(GET(builder, 2), GET(builder, 3));
  SET(builder, 4, sum);
  COMMIT(builder);
  // VMOA      [0,1,2,2,4,null,...,null]
  //_realArray[0,1,2,2,4,null,...,null]
  ...
  OMR::JitBuilder::BytecodeBuilder *thenBB =
      OrphanBytecodeBuilder(0, (char *)"BCI_then");
  OMR::JitBuilder::BytecodeBuilder *elseBB =
      OrphanBytecodeBuilder(1, (char *)"BCI_else");
  OMR::JitBuilder::BytecodeBuilder *mergeBB =
      OrphanBytecodeBuilder(2, (char *)"BCI_merge");

  OMR::JitBuilder::IlValue *v1 = GET(builder, 5);
  OMR::JitBuilder::IlValue *v2 = GET(builder, 6);
  if (useEqual)
  ...
  // VMOA      [0,1,2,{9,11},4,5,5,null]
  //_realArray[0,1,2,{9,11},4,5,5,null]
  // Since I used MOVE to set index 3 to the value of index 2 only index 3
  // changed
  ...
  OMR::JitBuilder::BytecodeBuilder *change7 =
      OrphanBytecodeBuilder(3, (char *)"BCI_change7");
  OMR::JitBuilder::BytecodeBuilder *nextMerge =
      OrphanBytecodeBuilder(4, (char *)"nextMerge");

  OMR::JitBuilder::IlValue *left = GET(mergeBB, 5);
  OMR::JitBuilder::IlValue *right = GET(mergeBB, 6);
  ...
  // Since the IlValue at index 6 and 7 was the same value the merge will cause
  // both to be updated VMOA      [0,1,2,{9,11},4,5,22,22]
  //_realArray[0,1,2,{9,11},4,5,5 ,5]
  COMMIT(nextMerge);
  // VMOA      [0,1,2,{9,11},4,5,22,22]
  ...
  OMR::JitBuilder::IlValue *one = nextMerge->ConstInteger(_valueType, 7);
  OMR::JitBuilder::IlValue *two = nextMerge->ConstInteger(_valueType, 19);
...
bool OperandArrayTestMethod::buildIL() {
  OMR::JitBuilder::TypeDictionary *dict = typeDictionary();
  OMR::JitBuilder::IlType *ppElementType =
      dict->PointerTo(dict->PointerTo(ARRAYVALUEILTYPE));

  Call("createArray", 0);

  OMR::JitBuilder::IlValue *arrayBaseAddress = ConstAddress(&_realArray);
  OMR::JitBuilder::VirtualMachineRegister *arrayBase =
      new OMR::JitBuilder::VirtualMachineRegister(this, "ARRAY", ppElementType,
                                                  sizeof(ARRAYVALUETYPE),
                                                  arrayBaseAddress);
  OMR::JitBuilder::VirtualMachineOperandArray *array =
      new OMR::JitBuilder::VirtualMachineOperandArray(this, _realArrayLength,
                                                      _valueType, arrayBase);

  setVMState(array);

  OMR::JitBuilder::BytecodeBuilder *bb =
      OrphanBytecodeBuilder(0, (char *)"entry");
  AppendBytecodeBuilder(bb);

  return testArray(bb, true);
}

OperandArrayTestUsingFalseMethod::OperandArrayTestUsingFalseMethod(
    OMR::JitBuilder::TypeDictionary *d)
    : OperandArrayTestMethod(d) {}

bool OperandArrayTestUsingFalseMethod::buildIL() {
  OMR::JitBuilder::TypeDictionary *dict = typeDictionary();
  OMR::JitBuilder::IlType *ppElementType =
      dict->PointerTo(dict->PointerTo(ARRAYVALUEILTYPE));
