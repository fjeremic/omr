...
LinkedListMethod::buildIL()
{
  ...
  loop->Call(
    "printInt16", 1, loop->LoadIndirect("Element", "key", loop->Load("ptr")));
  loop->Call("printString", 1, loop->ConstInt64((int64_t) ",v "));
  loop->Call(
    "printInt32", 1, loop->LoadIndirect("Element", "val", loop->Load("ptr")));
  ...
  foundBuilder->Store(
    "val",
    foundBuilder->LoadIndirect("Element", "val", foundBuilder->Load("ptr")));
