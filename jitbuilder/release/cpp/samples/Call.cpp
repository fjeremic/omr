  ...
  : OMR::JitBuilder::MethodBuilder(types)
{
  ...
  DefineFunction((char*)"doublesum", (char*)__FILE__, (char*)DOUBLESUM_LINE, (void*)&doublesum, Int32, 2, Int32, Int32);
}
...
bool CallMethod::buildIL()
{
  ...
  loop->Store("sum", loop->Call("doublesum", 2, loop->Load("sum"), loop->Load("i")));
...
bool ComputedCallMethod::buildIL()
{
  ...
  loop->Store("sum",
    loop->ComputedCall("doublesum", 3, loop->ConstAddress((void*)&doublesum), loop->Load("sum"), loop->Load("i")));
