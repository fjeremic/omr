  ...
  : OMR::JitBuilder::MethodBuilder(d)
{
  ...
  DefineFunction((char*)"printFloat", (char*)__FILE__, (char*)PRINTFLOAT_LINE, (void*)&printFloat, NoType, 1, Float);
  DefineFunction(
    (char*)"printDouble", (char*)__FILE__, (char*)PRINTDOUBLE_LINE, (void*)&printDouble, NoType, 1, Double);
  DefineFunction(
    (char*)"printPointer", (char*)__FILE__, (char*)PRINTPOINTER_LINE, (void*)&printPointer, NoType, 1, Int64);
}

void PointerMethod::PrintString(OMR::JitBuilder::IlBuilder* bldr, const char* s)
{
