...
PointerMethod::PointerMethod(OMR::JitBuilder::TypeDictionary* d)
  ...
  DefineFunction((char*)"printFloat", (char*)__FILE__, (char*)PRINTFLOAT_LINE,
                 (void*)&printFloat, NoType, 1, Float);
  DefineFunction((char*)"printDouble", (char*)__FILE__, (char*)PRINTDOUBLE_LINE,
                 (void*)&printDouble, NoType, 1, Double);
  DefineFunction((char*)"printPointer", (char*)__FILE__,
                 (char*)PRINTPOINTER_LINE, (void*)&printPointer, NoType, 1,
                 Int64);
}

void PointerMethod::PrintString(OMR::JitBuilder::IlBuilder* bldr,
                                const char* s) {
  bldr->Call("printString", 1, bldr->ConstInt64((int64_t)(char*)s));
}

bool PointerMethod::buildIL() {
  PrintString(this, "Pointer parameters:\n");

  PrintString(this, "   pInt32[");
  Call("printPointer", 1, Load("pInt32"));
  PrintString(this, "] = ");
  Call("printInt32", 1, LoadAt(pInt32, Load("pInt32")));

  PrintString(this, "   pFloat[");
  Call("printPointer", 1, Load("pFloat"));
  PrintString(this, "] = ");
  Call("printFloat", 1, LoadAt(pFloat, Load("pFloat")));

  PrintString(this, "   ppDouble[");
  Call("printPointer", 1, Load("ppDouble"));
  PrintString(this, "] = ");
  Call("printDouble", 1, LoadAt(pDouble, LoadAt(ppDouble, Load("ppDouble"))));

  PrintString(this, "\nOther pointers:\n");

  PrintString(this, "   staticInt32[");
  Call("printPointer", 1, ConstAddress(&staticInt32));
  PrintString(this, "] = ");
  Call("printInt32", 1, LoadAt(pInt32, ConstAddress(&staticInt32)));
