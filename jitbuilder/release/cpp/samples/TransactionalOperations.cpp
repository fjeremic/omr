 ...
 *
 * Note: users always need to provide all persistentFailure(persistentBuilder), transientFailure(transientBuilder) and
 * fallthrough(transactionBuilder) paths.
 */
bool TransactionalMethod::buildIL()
{
  ...
  persistentBuilder->AtomicAdd(
    persistentBuilder->IndexAt(pInt32, persistentBuilder->Load("addressOfValue"), persistentBuilder->ConstInt32(0)),
  ...
  transactionBuilder->StoreAt(
    transactionBuilder->IndexAt(pInt32, transactionBuilder->Load("addressOfValue"), transactionBuilder->ConstInt32(0)),
    transactionBuilder->Add(transactionBuilder->LoadAt(pInt32,
                              transactionBuilder->IndexAt(
                                pInt32, transactionBuilder->Load("addressOfValue"), transactionBuilder->ConstInt32(0))),
