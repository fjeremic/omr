...
extern void
setupCodeCacheParameters(int32_t*,
...
static void
initializeAllHelpers(JitBuilder::JitConfig* jitConfig,
...
bool
initializeJitBuilder(TR_RuntimeHelper* helperIDs,
                     void** helperAddresses,
                     int32_t numHelpers,
                     char* options)
{
...
internal_initializeJit()
{
  return initializeJitBuilder(
    ...
    0,
    0,
    (char*)"-Xjit:acceptHugeMethods,enableBasicBlockHoisting,omitFramePointer,"
           "useILValidator");
}
