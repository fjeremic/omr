...
static const AVLParams avlParams[] = {
  ...
  { "Single rotate: left; including root; balanced; via deletion", "{L10{R5@{=7@@}}{=15@@}}",
    "5, 10, 1, 7, 15, -1, 0" },
  { "Single rotate: right; including root; balanced; via deletion", "{R10{=7@@}{L20{=15@@}@}}",
    "20, 25, 10, 15, 7, -25, 0" },
  { "double rotation; height 3; left heavy", "{L20{=7{=1@@}{=10@@}}{=25@@}}", "20, 25, 10, 1, 7, 0" },
  { "Single rotate: right; not root; no graft", "{=30{=5{=1@@}{=10@@}}{L40{=35@@}@}}",
  ...
  { "single rotation test4", "{=20{R5{=1@@}{L10{=7@@}@}}{R40{=30@@}{R50@{=60@@}}}}",
    "20, 10, 40, 5, 15, 30, 50, 1, 7, 60, -15, 0" },
  { "single rotation test5", "{L20{=5{L4{=1@@}@}{=10{=7@@}{=15@@}}}{R40@{=50@@}}}",
    "20, 10, 40, 5, 15, 50, 4, 7, 1, 0" },
  { "single rotation test6", "{=20{=5{L4{=1@@}@}{=10{=7@@}{=15@@}}}{R40{=30@@}{R50@{=60@@}}}}",
  ...
  { "single rotation test10", "{=80{L60{L50{=40@@}@}{=70@@}}{L95{R90@{=93@@}}{=99@@}}}",
    "80, 60, 90, 50, 70, 85, 95, 40, 93, 99, -85, 0" },
  { "single rotation test11", "{R80{L60{=50@@}@}{=95{=90{=85@@}{=93@@}}{R96@{=99@@}}}}",
    "80, 60, 90, 50, 85, 95, 93, 96, 99, 0" },
  { "single rotation test12", "{=80{L60{L50{=40@@}@}{=70@@}}{=95{=90{=85@@}{=93@@}}{R96@{=99@@}}}}",
    "80, 60, 90, 50, 70, 85, 95, 40, 93, 96, 99, 0" },
  { "remove with immediate leaf predecessor", "{R20{=10@@}{R30@{=50@@}}}", "20, 10, 40, 30, 50, -40, 0" },
  { "remove with immediate left branch predecessor", "{=20{L10{=5@@}@}{=30{=25@@}{=50@@}}}",
    "20, 10, 40, 5, 30, 50, 25, -40, 0" },
  { "remove with leaf predecessor", "{R20{L10{=5@@}@}{L35{L30{=25@@}@}{=50@@}}}",
    "20, 10, 40, 5, 30, 50, 25, 35, -40, 0" },
  { "remove with leaf left branch predecessor", "{=20{L10{L5{=1@@}@}{=15@@}}{=35{=30{=25@@}{=32@@}}{R50@{=55@@}}}}",
  ...
  { "double rotation test5", "{L20{=7{L5{=4@@}@}{=10{=8@@}{=15@@}}}{R40@{=50@@}}}",
    "20, 10, 40, 5, 15, 50, 4, 7, 8, 0" },
  { "double rotation test6", "{=20{=7{=5{=4@@}{=6@@}}{=10{=8@@}{=15@@}}}{R40{=30@@}{R50@{=60@@}}}}",
    "20, 10, 40, 5, 15, 30, 50, 4, 7, 17, 60, 6, 8, -17, 0" },
  { "double rotation test7", "{L20{=13{L10{=5@@}@}{=15{=14@@}{=17@@}}}{R40@{=50@@}}}",
    "20, 10, 40, 5, 15, 50, 13, 17, 14, 0" },
  { "double rotation test8", "{=20{=13{=10{=5@@}{=12@@}}{=15{=14@@}{=17@@}}}{R40{=30@@}{R50@{=60@@}}}}",
  ...
  { "double rotation test13", "{R80{L60{=50@@}@}{=93{=90{=85@@}{=92@@}}{R95@{=96@@}}}}",
    "80, 60, 90, 50, 85, 95, 93, 96, 92, 0" },
  { "double rotation test14", "{=80{L60{L50{=40@@}@}{=70@@}}{=93{=90{=85@@}{=92@@}}{=95{=94@@}{=96@@}}}}",
    "80, 60, 90, 50, 70, 85, 95, 40, 83, 93, 96, 92, 94, -83, 0" },
  { "double rotation test15", "{R80{L60{=50@@}@}{=87{=85{=83@@}{=86@@}}{R90@{=95@@}}}}",
    "80, 60, 90, 50, 85, 95, 83, 87, 86, 0" },
  { "double rotation test16", "{=80{L60{L50{=40@@}@}{=70@@}}{=87{=85{=83@@}{=86@@}}{=90{=88@@}{=95@@}}}}",
...
TEST_P(AVLTest, test)
{
  ...
  ASSERT_EQ(0, buildAndVerifyAVLTree(omrTestEnv->getPortLibrary(), success, data))
...
class CollisionResilientHashtableTest
  : public ::testing::TestWithParam< ::testing::tuple<HashtableInputData, uint32_t> > {};
...
INSTANTIATE_TEST_CASE_P(OmrAlgoTest, CollisionResilientHashtableTest,
  ::testing::Combine(::testing::ValuesIn(hastableParams), ::testing::ValuesIn(listToTreeThresholdValues)));
