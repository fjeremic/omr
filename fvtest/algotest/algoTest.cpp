...
static const AVLParams avlParams[] = {
  ...
  { "Simple tree; height 3; right heavy",
    "{R5{=1@@}{=10{=7@@}{=15@@}}}",
    "5, 10, 1, 7, 15, 0" },
  { "Simple tree; height 3; left heavy",
    "{L20{=10{=7@@}{=15@@}}{=25@@}}",
    "20, 25, 10, 7, 15, 0" },
  ...
  { "Single rotate: right; including root; balanced; via deletion",
    "{R10{=7@@}{L20{=15@@}@}}",
    "20, 25, 10, 15, 7, -25, 0" },
  { "double rotation; height 3; left heavy",
    "{L20{=7{=1@@}{=10@@}}{=25@@}}",
    "20, 25, 10, 1, 7, 0" },
  { "Single rotate: right; not root; no graft",
    "{=30{=5{=1@@}{=10@@}}{L40{=35@@}@}}",
    "30, 10, 40, 5, 20, 35, 1, -20, 0" },
  { "Delete non-existant node", "{R10@{=15@@}}", "10, 15, -20, 0" },
  { "Delete node twice", "{=10@@}", "10, 15, -15, -15, 0" },
  { "Delete node; no root", "@", "-15, 0" },
  { "single rotation test1",
    "{L20{=5{=1@@}{=10@@}}{=40@@}}",
    "20, 10, 40, 5, 1, 0" },
  { "single rotation test2",
    "{=20{=5{=1@@}{=10@@}}{R40@{=50@@}}}",
    "20, 10, 40, 5, 50, 1, 0" },
  { "single rotation test3",
    "{L20{R5{=1@@}{L10{=7@@}@}}{R40@{=50@@}}}",
  ...
  { "single rotation test7",
    "{R80{=60@@}{=95{=90@@}{=99@@}}}",
    "80, 60, 90, 95, 99, 0" },
  { "single rotation test8",
    "{=80{L60{=50@@}@}{=95{=90@@}{=99@@}}}",
    "80, 60, 90, 50, 95, 99, 0" },
  { "single rotation test9",
    "{R80{L60{=50@@}@}{L95{R90@{=93@@}}{=99@@}}}",
  ...
  { "remove with immediate leaf predecessor",
    "{R20{=10@@}{R30@{=50@@}}}",
    "20, 10, 40, 30, 50, -40, 0" },
  ...
  { "double rotation test1",
    "{L20{=7{=5@@}{=10@@}}{=40@@}}",
    "20, 10, 40, 5, 7, 0" },
  { "double rotation test2",
    "{=20{=7{=5@@}{=10@@}}{R40@{=50@@}}}",
    "20, 10, 40, 5, 50, 7, 0" },
  { "double rotation test3",
    "{L20{=12{=10@@}{=15@@}}{=40@@}}",
    "20, 10, 40, 15, 12, 0" },
  { "double rotation test4",
    "{=20{=12{=10@@}{=15@@}}{R40@{=50@@}}}",
    "20, 10, 40, 15, 50, 12, 0" },
  ...
  { "double rotation test9",
    "{R80{=60@@}{=93{=90@@}{=95@@}}}",
    "80, 60, 90, 95, 93, 0" },
  { "double rotation test10",
    "{=80{L60{=50@@}@}{=93{=90@@}{=95@@}}}",
    "80, 60, 90, 50, 95, 93, 0" },
  { "double rotation test11",
    "{R80{=60@@}{=87{=85@@}{=90@@}}}",
    "80, 60, 90, 85, 87, 0" },
  { "double rotation test12",
    "{=80{L60{=50@@}@}{=87{=85@@}{=90@@}}}",
    "80, 60, 90, 85, 50, 87, 0" },
...
static const PoolInputData poolParams[] = {
  ...
  { "POOL_ALWAYS_KEEP_SORTED flag",
    32,
    10,
    sizeof(uintptr_t),
    0,
    POOL_ALWAYS_KEEP_SORTED },
  { "POOL_ROUND_TO_PAGE_SIZE flag",
    32,
    10,
    sizeof(uintptr_t),
    0,
    POOL_ROUND_TO_PAGE_SIZE },
  { "POOL_NEVER_FREE_PUDDLES flag",
    32,
    10,
    sizeof(uintptr_t),
    0,
...
static void
showResult(OMRPortLibrary* portlib,
           uintptr_t passCount,
           uintptr_t failCount,
...
TEST(OmrAlgoTest, hookabletest)
{
  ...
  showResult(
    omrTestEnv->getPortLibrary(), passCount, failCount, numSuitesNotRun);
}
