...
static int32_t testHookInterface(OMRPortLibrary* portLib,
                                 uintptr_t* passCount,
                                 uintptr_t* failCount,
                                 J9HookInterface** hookInterface);
static void testEnabled(OMRPortLibrary* portLib,
                        uintptr_t* passCount,
                        uintptr_t* failCount,
                        J9HookInterface** hookInterface,
                        uintptr_t event,
                        uintptr_t expectedResult);
static void testDisable(OMRPortLibrary* portLib,
                        uintptr_t* passCount,
                        uintptr_t* failCount,
                        J9HookInterface** hookInterface,
                        uintptr_t event,
                        uintptr_t expectedResult);
static void testReserve(OMRPortLibrary* portLib,
                        uintptr_t* passCount,
                        uintptr_t* failCount,
                        J9HookInterface** hookInterface,
                        uintptr_t event,
                        uintptr_t expectedResult);
static void testRegister(OMRPortLibrary* portLib,
                         uintptr_t* passCount,
                         uintptr_t* failCount,
                         J9HookInterface** hookInterface,
                         uintptr_t event,
                         uintptr_t expectedResult);
static void testRegisterWithAgent(OMRPortLibrary* portLib,
                                  uintptr_t* passCount,
                                  uintptr_t* failCount,
                                  J9HookInterface** hookInterface,
                                  uintptr_t event,
                                  ...
                                  uintptr_t userData,
                                  uintptr_t expectedResult);
static void testUnregister(OMRPortLibrary* portLib,
                           uintptr_t* passCount,
                           uintptr_t* failCount,
                           J9HookInterface** hookInterface,
                           uintptr_t event);
static void testUnregisterWithAgent(OMRPortLibrary* portLib,
                                    ...
                                    uintptr_t event,
                                    uintptr_t userData);
static void testDispatch(OMRPortLibrary* portLib,
                         uintptr_t* passCount,
                         uintptr_t* failCount,
                         uintptr_t event,
                         uintptr_t expectedResult);
static uintptr_t testAllocateAgentID(OMRPortLibrary* portLib,
                                     ...
                                     uintptr_t* failCount,
                                     J9HookInterface** hookInterface);
static void hookNormalEvent(J9HookInterface** hook,
                            uintptr_t eventNum,
                            void* voidEventData,
                            void* userData);
static void hookOrderedEvent(J9HookInterface** hook,
                             uintptr_t eventNum,
                             void* voidEventData,
                             void* userData);
