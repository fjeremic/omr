...
TEST_F(ReturnTypeTest, Int64_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt64ReturnType, testFunction);
...
TEST_F(ReturnTypeTest, Int32_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt32ReturnType, testFunction);
  ASSERT_EQ(testFunction(0), 1);
...
TEST_F(ReturnTypeTest, Int16_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt16ReturnType, testFunction);
  ASSERT_EQ(testFunction(0), 1);
...
TEST_F(ReturnTypeTest, Int8_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt8ReturnType, testFunction);
  ASSERT_EQ(testFunction(0), 1);
