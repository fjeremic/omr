...
static int64_t testInt64(int64_t val) {
#define TEST_INT64_LINE LINETOSTR(__LINE__)
  return val;
}

static int32_t testInt32(int32_t val) {
#define TEST_INT32_LINE LINETOSTR(__LINE__)
  return val;
}

static int16_t testInt16(int16_t val) {
#define TEST_INT16_LINE LINETOSTR(__LINE__)
  return val;
}

static int8_t testInt8(int8_t val) {
#define TEST_INT8_LINE LINETOSTR(__LINE__)
  return val;
}

DEFINE_BUILDER(TestInt64ReturnType, Int64, PARAM("param", Int64)) {
  DefineFunction((char*)"testInt64", (char*)__FILE__, (char*)TEST_INT64_LINE,
                 (void*)&testInt64, Int64, 1, Int64);
...
DEFINE_BUILDER(TestInt32ReturnType, Int32, PARAM("param", Int32)) {
  DefineFunction((char*)"testInt32", (char*)__FILE__, (char*)TEST_INT32_LINE,
                 (void*)&testInt32, Int32, 1, Int32);
...
DEFINE_BUILDER(TestInt16ReturnType, Int16, PARAM("param", Int16)) {
  DefineFunction((char*)"testInt16", (char*)__FILE__, (char*)TEST_INT16_LINE,
                 (void*)&testInt16, Int16, 1, Int16);
...
DEFINE_BUILDER(TestInt8ReturnType, Int8, PARAM("param", Int8)) {
  DefineFunction((char*)"testInt8", (char*)__FILE__, (char*)TEST_INT8_LINE,
                 (void*)&testInt8, Int8, 1, Int8);
...
TEST_F(ReturnTypeTest, Int64_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt64ReturnType,
                 testFunction);
...
TEST_F(ReturnTypeTest, Int32_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt32ReturnType,
                 testFunction);
  ASSERT_EQ(testFunction(0), 1);
...
TEST_F(ReturnTypeTest, Int16_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt16ReturnType,
                 testFunction);
  ASSERT_EQ(testFunction(0), 1);
...
TEST_F(ReturnTypeTest, Int8_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt8ReturnType,
                 testFunction);
  ASSERT_EQ(testFunction(0), 1);
