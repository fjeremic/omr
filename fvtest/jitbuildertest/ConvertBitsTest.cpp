...
TEST_F(BitConversionTest, Int2Float)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, BitConvertInt2Float, int2float);
...
TEST_F(BitConversionTest, Float2Int)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, BitConvertFloat2Int, float2int);
...
TEST_F(BitConversionTest, Long2Double)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, BitConvertLong2Double, long2double);
...
TEST_F(BitConversionTest, Double2Long)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, BitConvertDouble2Long, double2long);
