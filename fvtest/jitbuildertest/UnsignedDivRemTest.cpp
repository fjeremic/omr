...
TEST_F(UnsignedRemTest, UInt64_Test)
{
  ...
  ASSERT_EQ(
    testFunction(static_cast<uint64_t>(INT64_MIN), static_cast<uint64_t>(-1)), static_cast<uint64_t>(INT64_MIN));
...
TEST_F(UnsignedRemTest, UInt32_Test)
{
  ...
  ASSERT_EQ(testFunction(10, 3), 1);
  ASSERT_EQ(
    testFunction(static_cast<uint32_t>(INT32_MIN), static_cast<uint32_t>(-1)), static_cast<uint32_t>(INT32_MIN));
...
TEST_F(UnsignedRemTest, UInt16_Test)
{
  ...
  ASSERT_EQ(testFunction(10, 3), 1);
  ASSERT_EQ(
    testFunction(static_cast<uint16_t>(INT16_MIN), static_cast<uint16_t>(-1)), static_cast<uint16_t>(INT16_MIN));
