...
DEFINE_BUILDER(TestUInt64Div, Int64, PARAM("lhs", Int64), PARAM("rhs", Int64))
{
...
DEFINE_BUILDER(TestUInt64Rem, Int64, PARAM("lhs", Int64), PARAM("rhs", Int64))
{
  OMR::JitBuilder::IlValue* lhs = Load("lhs");
  OMR::JitBuilder::IlValue* rhs = Load("rhs");
...
DEFINE_BUILDER(TestUInt32Div, Int32, PARAM("lhs", Int32), PARAM("rhs", Int32))
{
  OMR::JitBuilder::IlValue* lhs = Load("lhs");
  OMR::JitBuilder::IlValue* rhs = Load("rhs");
  OMR::JitBuilder::IlValue* result = UnsignedDiv(lhs, rhs);
...
DEFINE_BUILDER(TestUInt32Rem, Int32, PARAM("lhs", Int32), PARAM("rhs", Int32))
{
  OMR::JitBuilder::IlValue* lhs = Load("lhs");
  OMR::JitBuilder::IlValue* rhs = Load("rhs");
  OMR::JitBuilder::IlValue* result = UnsignedRem(lhs, rhs);
...
DEFINE_BUILDER(TestUInt16Div, Int16, PARAM("lhs", Int16), PARAM("rhs", Int16))
{
  OMR::JitBuilder::IlValue* lhs = Load("lhs");
  OMR::JitBuilder::IlValue* rhs = Load("rhs");
  OMR::JitBuilder::IlValue* result = UnsignedDiv(lhs, rhs);
...
DEFINE_BUILDER(TestUInt16Rem, Int16, PARAM("lhs", Int16), PARAM("rhs", Int16))
{
  OMR::JitBuilder::IlValue* lhs = Load("lhs");
  OMR::JitBuilder::IlValue* rhs = Load("rhs");
  OMR::JitBuilder::IlValue* result = UnsignedRem(lhs, rhs);
...
DEFINE_BUILDER(TestUInt8Div, Int8, PARAM("lhs", Int8), PARAM("rhs", Int8))
{
  OMR::JitBuilder::IlValue* lhs = Load("lhs");
  OMR::JitBuilder::IlValue* rhs = Load("rhs");
  OMR::JitBuilder::IlValue* result = UnsignedDiv(lhs, rhs);
...
DEFINE_BUILDER(TestUInt8Rem, Int8, PARAM("lhs", Int8), PARAM("rhs", Int8))
{
  OMR::JitBuilder::IlValue* lhs = Load("lhs");
  OMR::JitBuilder::IlValue* rhs = Load("rhs");
  OMR::JitBuilder::IlValue* result = UnsignedRem(lhs, rhs);
...
TEST_F(UnsignedDivTest, UInt64_Test)
{
  ...
  ASSERT_EQ(
    testFunction(static_cast<uint64_t>(INT64_MIN), static_cast<uint64_t>(-1)),
    0);
...
TEST_F(UnsignedRemTest, UInt64_Test)
{
  ...
  ASSERT_EQ(testFunction(UINT64_MAX, UINT64_MAX - 1), 1);
  ASSERT_EQ(testFunction(static_cast<uint64_t>(INT64_MAX), UINT64_MAX),
...
TEST_F(UnsignedDivTest, UInt32_Test)
{
  ...
  ASSERT_EQ(testFunction(10, 3), 3);
  ASSERT_EQ(
    testFunction(static_cast<uint32_t>(INT32_MIN), static_cast<uint32_t>(-1)),
    0);
...
TEST_F(UnsignedRemTest, UInt32_Test)
{
  ...
  ASSERT_EQ(testFunction(UINT32_MAX, UINT32_MAX - 1), 1);
  ASSERT_EQ(testFunction(static_cast<uint32_t>(INT32_MAX), UINT32_MAX),
...
TEST_F(UnsignedDivTest, UInt16_Test)
{
  ...
  ASSERT_EQ(testFunction(10, 3), 3);
  ASSERT_EQ(
    testFunction(static_cast<uint16_t>(INT16_MIN), static_cast<uint16_t>(-1)),
    0);
...
TEST_F(UnsignedRemTest, UInt16_Test)
{
  ...
  ASSERT_EQ(testFunction(UINT16_MAX, UINT16_MAX - 1), 1);
  ASSERT_EQ(testFunction(static_cast<uint16_t>(INT16_MAX), UINT16_MAX),
...
TEST_F(UnsignedDivTest, UInt8_Test)
{
  ...
  ASSERT_EQ(testFunction(10, 3), 3);
  ASSERT_EQ(
    testFunction(static_cast<uint8_t>(INT8_MIN), static_cast<uint8_t>(-1)), 0);
...
TEST_F(UnsignedRemTest, UInt8_Test)
{
  ...
  ASSERT_EQ(testFunction(10, 3), 1);
  ASSERT_EQ(
    testFunction(static_cast<uint8_t>(INT8_MIN), static_cast<uint8_t>(-1)),
    static_cast<uint8_t>(INT8_MIN));
  ...
  ASSERT_EQ(testFunction(UINT8_MAX, UINT8_MAX - 1), 1);
  ASSERT_EQ(testFunction(static_cast<uint8_t>(INT8_MAX), UINT8_MAX),
            static_cast<uint8_t>(INT8_MAX));
  ASSERT_EQ(testFunction(UINT8_MAX, 10), UINT8_MAX % 10);
}
