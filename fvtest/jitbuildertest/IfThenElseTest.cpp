...
TEST_F(IfThenElseTest, TrueBothPath)
{
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary,
                 SubIfThenElseBothPathBuilder,
                 typeIfFunction);
...
TEST_F(IfThenElseTest, TrueElsePath)
{
  IfLongFunctionType typeIfFunction;
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, SubIfThenNullBuilder, typeIfFunction);
  ASSERT_EQ(typeIfFunction(10, 5), 5);
}
...
TEST_F(IfThenElseTest, FalseBothPath)
{
  IfLongFunctionType typeIfFunction;
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, SubIfNullElseBuilder, typeIfFunction);
  ASSERT_EQ(typeIfFunction(10, 5), 5);
}
