...
DEFINE_BUILDER(TypePunInt32Int32Builder, Int32, PARAM("u", PointerTo(LookupUnion("TestUnionInt32Int32"))),
  PARAM("v1", Int32), PARAM("v2", Int32))
{
...
DEFINE_BUILDER(TypePunInt16DoubleBuilder, Int16, PARAM("u", PointerTo(LookupUnion("TestUnionInt16Double"))),
  PARAM("v1", Int16), PARAM("v2", Double))
{
...
TEST_F(UnionTest, TypePunWithEqualTypes)
{
  ...
  ASSERT_EQ(v2, typePunInt32Int32(&testUnion, v1, v2)) << "Value returned by compiled method is wrong.";
}
