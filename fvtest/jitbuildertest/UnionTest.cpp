...
typedef uint32_t (*TypePunInt32Int32Function)(TestUnionInt32Int32*, uint32_t,
                                              uint32_t);
typedef uint16_t (*TypePunInt16DoubleFunction)(TestUnionInt16Double*, uint16_t,
                                               double);

DEFINE_BUILDER(TypePunInt32Int32Builder, Int32,
...
DEFINE_BUILDER(TypePunInt16DoubleBuilder, Int16,
