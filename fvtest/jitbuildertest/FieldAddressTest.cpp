...
DEFINE_BUILDER(GetUnionFieldAddressBuilder, toIlType<uint8_t *>(),
...
TEST_F(FieldAddressTest, StructField) {
  ...
  ASSERT_COMPILE(StructTypeDictionary, GetStructFieldAddressBuilder,
                 getStructFieldAddress);
...
TEST_F(FieldAddressTest, UnionField) {
  ...
  ASSERT_COMPILE(UnionTypeDictionary, GetUnionFieldAddressBuilder,
                 getUnionFieldAddress);
