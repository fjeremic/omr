...
DEFINE_BUILDER(
  GetStructFieldAddressBuilder, PointerTo(GetFieldType("Struct", "f2")), PARAM("s", PointerTo(LookupStruct("Struct"))))
{
...
DEFINE_BUILDER(GetUnionFieldAddressBuilder, toIlType<uint8_t*>(), PARAM("u", PointerTo(LookupUnion("Union"))))
{
