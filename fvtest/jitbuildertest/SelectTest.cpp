...
DEFINE_BUILDER(TestInt8Select, Int8, PARAM("condition", Int32), PARAM("trueValue", Int8), PARAM("falseValue", Int8))
{
...
DEFINE_BUILDER(TestInt16Select, Int16, PARAM("condition", Int32), PARAM("trueValue", Int16), PARAM("falseValue", Int16))
{
  OMR::JitBuilder::IlValue* condition = Load("condition");
  OMR::JitBuilder::IlValue* trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue* falseValue = Load("falseValue");
...
DEFINE_BUILDER(TestInt32Select, Int32, PARAM("condition", Int32), PARAM("trueValue", Int32), PARAM("falseValue", Int32))
{
  OMR::JitBuilder::IlValue* condition = Load("condition");
  OMR::JitBuilder::IlValue* trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue* falseValue = Load("falseValue");
...
DEFINE_BUILDER(TestInt64Select, Int64, PARAM("condition", Int32), PARAM("trueValue", Int64), PARAM("falseValue", Int64))
{
  OMR::JitBuilder::IlValue* condition = Load("condition");
  OMR::JitBuilder::IlValue* trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue* falseValue = Load("falseValue");
...
DEFINE_BUILDER(
  TestAddressSelect, Address, PARAM("condition", Int32), PARAM("trueValue", Address), PARAM("falseValue", Address))
{
  OMR::JitBuilder::IlValue* condition = Load("condition");
  OMR::JitBuilder::IlValue* trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue* falseValue = Load("falseValue");
...
DEFINE_BUILDER(TestFloatSelect, Float, PARAM("condition", Int32), PARAM("trueValue", Float), PARAM("falseValue", Float))
{
  OMR::JitBuilder::IlValue* condition = Load("condition");
  OMR::JitBuilder::IlValue* trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue* falseValue = Load("falseValue");
...
DEFINE_BUILDER(
  TestDoubleSelect, Double, PARAM("condition", Int32), PARAM("trueValue", Double), PARAM("falseValue", Double))
{
  OMR::JitBuilder::IlValue* condition = Load("condition");
  OMR::JitBuilder::IlValue* trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue* falseValue = Load("falseValue");
