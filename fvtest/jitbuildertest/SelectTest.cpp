...
DEFINE_BUILDER(TestInt8Select, Int8, PARAM("condition", Int32),
               PARAM("trueValue", Int8), PARAM("falseValue", Int8)) {
...
DEFINE_BUILDER(TestInt16Select, Int16, PARAM("condition", Int32),
               PARAM("trueValue", Int16), PARAM("falseValue", Int16)) {
  OMR::JitBuilder::IlValue *condition = Load("condition");
  OMR::JitBuilder::IlValue *trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue *falseValue = Load("falseValue");
  OMR::JitBuilder::IlValue *result = Select(condition, trueValue, falseValue);
...
DEFINE_BUILDER(TestInt32Select, Int32, PARAM("condition", Int32),
               PARAM("trueValue", Int32), PARAM("falseValue", Int32)) {
  OMR::JitBuilder::IlValue *condition = Load("condition");
  OMR::JitBuilder::IlValue *trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue *falseValue = Load("falseValue");
  OMR::JitBuilder::IlValue *result = Select(condition, trueValue, falseValue);
...
DEFINE_BUILDER(TestInt64Select, Int64, PARAM("condition", Int32),
               PARAM("trueValue", Int64), PARAM("falseValue", Int64)) {
  OMR::JitBuilder::IlValue *condition = Load("condition");
  OMR::JitBuilder::IlValue *trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue *falseValue = Load("falseValue");
  OMR::JitBuilder::IlValue *result = Select(condition, trueValue, falseValue);
...
DEFINE_BUILDER(TestAddressSelect, Address, PARAM("condition", Int32),
               PARAM("trueValue", Address), PARAM("falseValue", Address)) {
  OMR::JitBuilder::IlValue *condition = Load("condition");
  OMR::JitBuilder::IlValue *trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue *falseValue = Load("falseValue");
  OMR::JitBuilder::IlValue *result = Select(condition, trueValue, falseValue);
...
DEFINE_BUILDER(TestFloatSelect, Float, PARAM("condition", Int32),
               PARAM("trueValue", Float), PARAM("falseValue", Float)) {
  OMR::JitBuilder::IlValue *condition = Load("condition");
  OMR::JitBuilder::IlValue *trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue *falseValue = Load("falseValue");
  OMR::JitBuilder::IlValue *result = Select(condition, trueValue, falseValue);
...
DEFINE_BUILDER(TestDoubleSelect, Double, PARAM("condition", Int32),
               PARAM("trueValue", Double), PARAM("falseValue", Double)) {
  OMR::JitBuilder::IlValue *condition = Load("condition");
  OMR::JitBuilder::IlValue *trueValue = Load("trueValue");
  OMR::JitBuilder::IlValue *falseValue = Load("falseValue");
  OMR::JitBuilder::IlValue *result = Select(condition, trueValue, falseValue);
...
TEST_F(SelectTest, Int16_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt16Select,
                 testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Int32_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt32Select,
                 testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Int64_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt64Select,
                 testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Address_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestAddressSelect,
                 testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Float_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestFloatSelect,
                 testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Double_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestDoubleSelect,
                 testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
