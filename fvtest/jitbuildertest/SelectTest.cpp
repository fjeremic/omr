...
TEST_F(SelectTest, Int16_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt16Select, testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Int32_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt32Select, testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Int64_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt64Select, testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Address_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestAddressSelect, testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Float_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestFloatSelect, testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
...
TEST_F(SelectTest, Double_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestDoubleSelect, testFunction);
  ASSERT_EQ(testFunction(1, 1, 0), 1);
  ASSERT_EQ(testFunction(0, 1, 0), 0);
}
