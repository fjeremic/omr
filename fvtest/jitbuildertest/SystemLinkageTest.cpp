...
typedef int64_t(FooFunction)(int64_t, double, int32_t, double, int64_t, double,
                             int32_t, double);

DEFINE_BUILDER(FooBuilder, Int64, PARAM("arg0_int64", Int64),
               PARAM("arg1_double", Double), PARAM("arg2_int32", Int32),
               PARAM("arg3_double", Double), PARAM("arg4_int64", Int64),
               PARAM("arg5_double", Double), PARAM("arg6_int32", Int32),
  ...
  auto comp4 = And(comp0, And(comp1, And(comp2, comp3)));
  Return(comp4);
...
TEST_F(SystemLinkageTest, FooTest) {
  ...
  ASSERT_TRUE(foo(200, 3.14159, -10, 6.67300 * pow(10, -11), 200, 3.14159, -10,
                  6.67300 * pow(10, -11)));
}
