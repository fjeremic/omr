...
TEST_F(NegateTest, Int64_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt64Negate, testFunction);
...
TEST_F(NegateTest, Int32_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt32Negate, testFunction);
  ASSERT_EQ(testFunction(0), 0);
  ASSERT_EQ(testFunction(1), -1);
  ASSERT_EQ(testFunction(-1), 1);
...
TEST_F(NegateTest, Int16_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestInt16Negate, testFunction);
  ASSERT_EQ(testFunction(0), 0);
  ASSERT_EQ(testFunction(1), -1);
  ASSERT_EQ(testFunction(-1), 1);
...
TEST_F(NegateTest, Float_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestFloatNegate, testFunction);
  ASSERT_EQ(testFunction(0), 0);
  ASSERT_EQ(testFunction(1), -1);
  ASSERT_EQ(testFunction(-1), 1);
...
TEST_F(NegateTest, Double_Test)
{
  ...
  ASSERT_COMPILE(
    OMR::JitBuilder::TypeDictionary, TestDoubleNegate, testFunction);
  ASSERT_EQ(testFunction(0), 0);
  ASSERT_EQ(testFunction(1), -1);
  ASSERT_EQ(testFunction(-1), 1);
