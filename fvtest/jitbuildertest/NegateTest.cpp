...
DEFINE_BUILDER(TestInt64Negate, Int64, PARAM("param", Int64)) {
...
DEFINE_BUILDER(TestInt32Negate, Int32, PARAM("param", Int32)) {
  OMR::JitBuilder::IlValue *param = Load("param");
  OMR::JitBuilder::IlValue *result = Negate(param);
  Return(result);
  return true;
...
DEFINE_BUILDER(TestInt16Negate, Int16, PARAM("param", Int16)) {
  OMR::JitBuilder::IlValue *param = Load("param");
  OMR::JitBuilder::IlValue *result = Negate(param);
  Return(result);
  return true;
...
DEFINE_BUILDER(TestInt8Negate, Int8, PARAM("param", Int8)) {
  OMR::JitBuilder::IlValue *param = Load("param");
  OMR::JitBuilder::IlValue *result = Negate(param);
  Return(result);
  return true;
...
DEFINE_BUILDER(TestFloatNegate, Float, PARAM("param", Float)) {
  OMR::JitBuilder::IlValue *param = Load("param");
  OMR::JitBuilder::IlValue *result = Negate(param);
  Return(result);
  return true;
...
DEFINE_BUILDER(TestDoubleNegate, Double, PARAM("param", Double)) {
  OMR::JitBuilder::IlValue *param = Load("param");
  OMR::JitBuilder::IlValue *result = Negate(param);
  Return(result);
  return true;
...
TEST_F(NegateTest, Int64_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt64Negate,
                 testFunction);
...
TEST_F(NegateTest, Int32_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt32Negate,
                 testFunction);
  ASSERT_EQ(testFunction(0), 0);
  ASSERT_EQ(testFunction(1), -1);
  ASSERT_EQ(testFunction(-1), 1);
...
TEST_F(NegateTest, Int16_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestInt16Negate,
                 testFunction);
  ASSERT_EQ(testFunction(0), 0);
  ASSERT_EQ(testFunction(1), -1);
  ASSERT_EQ(testFunction(-1), 1);
...
TEST_F(NegateTest, Float_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestFloatNegate,
                 testFunction);
  ASSERT_EQ(testFunction(0), 0);
  ASSERT_EQ(testFunction(1), -1);
  ASSERT_EQ(testFunction(-1), 1);
...
TEST_F(NegateTest, Double_Test) {
  ...
  ASSERT_COMPILE(OMR::JitBuilder::TypeDictionary, TestDoubleNegate,
                 testFunction);
  ASSERT_EQ(testFunction(0), 0);
  ASSERT_EQ(testFunction(1), -1);
  ASSERT_EQ(testFunction(-1), 1);
