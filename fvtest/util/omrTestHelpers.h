...
#define OMRTEST_PRINT_ERROR(x)                                                 \
  ...
  omr_error_t omrTestPrintError(const char* funcCall,
                                const omr_error_t rc,
...
#define OMRTEST_PRINT_UNEXPECTED_INT_RC(x, exp)                                \
  ...
  omr_error_t omrTestPrintUnexpectedIntRC(const char* funcCall,
                                          const intptr_t rc,
...
#define OMRTEST_PRINT_UNEXPECTED_RC(x, exp)                                    \
  ...
  omr_error_t omrTestPrintUnexpectedRC(const char* funcCall,
                                       const omr_error_t rc,
...
#define OMRTEST_ASSERT_ERROR(e, x)                                             \
   ...
   */
  omr_error_t omrTestVMInit(OMRTestVM* const testVM,
                            OMRPortLibrary* portLibrary);
