...
int32_t i2lInput[] = { 0x0, 0x1, 0x0000FFFF, 0x2, 0x3E, (int32_t)0x80000000, (int32_t)0xFFFF0000, 0x40000000,
    0x7C000000, (int32_t)0xFFFFFFFF, 0x0003C000, 0x40000001 };

uint32_t iu2lInput[] = { 0x0, 0x1, 0x0000FFFF, 0x2, 0x3E, 0x80000000, 0xFFFF0000, 0x40000000, 0x7C000000, 0xFFFFFFFF,
    0x0003C000, 0x40000001 };
...
uint64_t lconstInput_zerosAroundOnes[] = { 0x7000000000000000, 0x0,
    0x1, // 00000..00001
    ...
    0x00007FFFFFFFFFFF, 0x0000FFFFFFFFFFFF, 0x000000000000FFFF, 0xFFFFFFFFFFFE0000, 0xFFFFFFFFFFFF0000,
    0xFFFF000000000000 };

// this array is for tests where contiguous zeros only appear once in the binary value.
// ex: 11100001111, 1000001, 0000000
uint64_t lconstInput_onesAroundZeros[]
    = { 0x0, 0x8000000000000001, 0xE000000000000003, 0xFFFFFFF00FFFFFFF, 0xFFFFFFFEFFFFFFFF, 0xFFFFFFFE7FFFFFFF,
          0xF0FFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFF0F, 0XFFFF000000000001, 0x8000FFFFFFFFFFFF };
...
class LongAndAsRotateTest
    : public ::testing::TestWithParam<std::tuple<VarType, ConstType, ConstType (*)(VarType, ConstType)> > {
public:
    static void SetUpTestCase()
    {
        const char* options
            = "-Xjit:disableTreeSimplification,disableAsyncCompilation,acceptHugeMethods,enableBasicBlockHoisting,"
...
template <typename VarType, typename ConstType>
LongAndAsRotateParamStruct<VarType, ConstType> to_struct(
    const std::tuple<VarType, ConstType, ConstType (*)(VarType, ConstType)>& param)
{
...
TEST_P(i2lLongAndAsRotateTest, iConstTest)
{
    ...
    std::snprintf(inputTrees, sizeof(inputTrees),
        ...
        "      )                            "
        "      (lconst %llu)))))            ",
        constValue, param.constantValue);
...
TEST_P(i2lLongAndAsRotateTest, GreaterThanOneRefCount1)
{
    ...
    std::snprintf(inputTrees, sizeof(inputTrees),
        ...
        "   )                                                 "
        ")                                                    ",
        constLongValue, param.constantValue);
...
TEST_P(i2lLongAndAsRotateTest, GreaterThanOneRefCount2)
{
    ...
    std::snprintf(inputTrees, sizeof(inputTrees),
        ...
        "   )                                                 "
        ")                                                    ",
        constValue1, constLongValue, constValue2, param.constantValue);
...
INSTANTIATE_TEST_CASE_P(i2lZerosAroundOnes, i2lLongAndAsRotateTest,
    ::testing::Combine(::testing::ValuesIn(i2lInput), ::testing::ValuesIn(lconstInput_zerosAroundOnes),
...
INSTANTIATE_TEST_CASE_P(iu2lZerosAroundOnes, iu2lLongAndAsRotateTest,
    ::testing::Combine(::testing::ValuesIn(iu2lInput), ::testing::ValuesIn(lconstInput_zerosAroundOnes),
...
INSTANTIATE_TEST_CASE_P(i2lOnesAroundZeros, i2lLongAndAsRotateTest,
    ::testing::Combine(::testing::ValuesIn(i2lInput), ::testing::ValuesIn(lconstInput_onesAroundZeros),
        ::testing::Values(static_cast<uint64_t (*)(int32_t, uint64_t)>(longAndAsRotateOracle))));

// iu2l case
INSTANTIATE_TEST_CASE_P(iu2lOnesAroundZeros, iu2lLongAndAsRotateTest,
    ::testing::Combine(::testing::ValuesIn(iu2lInput), ::testing::ValuesIn(lconstInput_onesAroundZeros),
        ::testing::Values(static_cast<uint64_t (*)(uint32_t, uint64_t)>(longAndAsRotateOracle))));
...
INSTANTIATE_TEST_CASE_P(i2lInvalidPatterns, i2lLongAndAsRotateTest,
    ::testing::Combine(::testing::ValuesIn(i2lInput), ::testing::ValuesIn(lconstInput_invalidPatterns),
        ::testing::Values(static_cast<uint64_t (*)(int32_t, uint64_t)>(longAndAsRotateOracle))));

// iu2l case
INSTANTIATE_TEST_CASE_P(iu2lInvalidPatterns, iu2lLongAndAsRotateTest,
    ::testing::Combine(::testing::ValuesIn(iu2lInput), ::testing::ValuesIn(lconstInput_invalidPatterns),
        ::testing::Values(static_cast<uint64_t (*)(uint32_t, uint64_t)>(longAndAsRotateOracle))));
