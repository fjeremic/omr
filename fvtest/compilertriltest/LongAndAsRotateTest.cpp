...
uint32_t iu2lInput[] = {0x0,        0x1,        0x0000FFFF, 0x2,
                        0x3E,       0x80000000, 0xFFFF0000, 0x40000000,
                        0x7C000000, 0xFFFFFFFF, 0x0003C000, 0x40000001};

// This array consists of all cases where contiguous 1's appear at most once in
// the binary value ex: 001111000, 1111111, 011110, 1110000, 00001111
...
// this array is for tests where contiguous zeros only appear once in the binary
// value. ex: 11100001111, 1000001, 0000000
uint64_t lconstInput_onesAroundZeros[] = {0x0,
                                          0x8000000000000001,
                                          0xE000000000000003,
                                          0xFFFFFFF00FFFFFFF,
                                          0xFFFFFFFEFFFFFFFF,
...
uint64_t lconstInput_invalidPatterns[] = {
    0x4000000000000001, 0xF0F0F0F0F0F0F0F0, 0x8000000000000002};

template <typename VarType, typename ConstType>
class LongAndAsRotateTest
    : public ::testing::TestWithParam<
          std::tuple<VarType, ConstType, ConstType (*)(VarType, ConstType)>> {
public:
  static void SetUpTestCase() {
    const char *options =
        "-Xjit:disableTreeSimplification,disableAsyncCompilation,"
        "acceptHugeMethods,enableBasicBlockHoisting,"
...
template <typename VarType, typename ConstType>
LongAndAsRotateParamStruct<VarType, ConstType>
to_struct(const std::tuple<VarType, ConstType,
                           ConstType (*)(VarType, ConstType)> &param) {
...
TEST_P(i2lLongAndAsRotateTest, SimpleTest) {
  ...
  ASSERT_EQ(param.oracle(param.variableValue, param.constantValue),
...
TEST_P(i2lLongAndAsRotateTest, iConstTest) {
  ...
  ASSERT_EQ(
      param.oracle((param.variableValue & constValue), param.constantValue),
      entry_point(param.variableValue));
}
...
TEST_P(i2lLongAndAsRotateTest, GreaterThanOneRefCount2) {
  ...
  ASSERT_EQ(
      param.oracle((param.variableValue & constValue2), param.constantValue),
      entry_point(param.variableValue));
}
...
INSTANTIATE_TEST_CASE_P(
    i2lZerosAroundOnes, i2lLongAndAsRotateTest,
    ::testing::Combine(
        ::testing::ValuesIn(i2lInput),
        ::testing::ValuesIn(lconstInput_zerosAroundOnes),
        ::testing::Values(static_cast<uint64_t (*)(int32_t, uint64_t)>(
            longAndAsRotateOracle))));

// iu2l case
INSTANTIATE_TEST_CASE_P(
    iu2lZerosAroundOnes, iu2lLongAndAsRotateTest,
    ::testing::Combine(
        ::testing::ValuesIn(iu2lInput),
        ::testing::ValuesIn(lconstInput_zerosAroundOnes),
        ::testing::Values(static_cast<uint64_t (*)(uint32_t, uint64_t)>(
            longAndAsRotateOracle))));
...
// i2l case
INSTANTIATE_TEST_CASE_P(
    i2lOnesAroundZeros, i2lLongAndAsRotateTest,
    ::testing::Combine(
        ::testing::ValuesIn(i2lInput),
...
// iu2l case
INSTANTIATE_TEST_CASE_P(
    iu2lOnesAroundZeros, iu2lLongAndAsRotateTest,
    ::testing::Combine(
        ::testing::ValuesIn(iu2lInput),
        ::testing::ValuesIn(lconstInput_onesAroundZeros),
        ::testing::Values(static_cast<uint64_t (*)(uint32_t, uint64_t)>(
...
// i2l case
INSTANTIATE_TEST_CASE_P(
    i2lInvalidPatterns, i2lLongAndAsRotateTest,
    ::testing::Combine(
        ::testing::ValuesIn(i2lInput),
...
// iu2l case
INSTANTIATE_TEST_CASE_P(
    iu2lInvalidPatterns, iu2lLongAndAsRotateTest,
    ::testing::Combine(
        ::testing::ValuesIn(iu2lInput),
        ::testing::ValuesIn(lconstInput_invalidPatterns),
        ::testing::Values(static_cast<uint64_t (*)(uint32_t, uint64_t)>(
