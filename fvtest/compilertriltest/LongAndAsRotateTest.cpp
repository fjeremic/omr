...
uint64_t lconstInput_invalidPatterns[] = { 0x4000000000000001,
                                           0xF0F0F0F0F0F0F0F0,
                                           0x8000000000000002 };
...
template<typename VarType, typename ConstType>
static ConstType
longAndAsRotateOracle(VarType a, ConstType b)
{
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      static_cast<uint64_t (*)(int32_t, uint64_t)>(longAndAsRotateOracle))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::ValuesIn(lconstInput_zerosAroundOnes),
    ::testing::Values(
      static_cast<uint64_t (*)(uint32_t, uint64_t)>(longAndAsRotateOracle))));
