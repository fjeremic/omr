...
to_struct(
  std::tuple<std::tuple<CompareType, CompareType>,
             std::tuple<ValType, ValType>,
             ValType (*)(CompareType, CompareType, ValType, ValType)> param)
{
...
template<typename CompareType, typename ValType>
static ValType
xternaryOracle(CompareType c1, CompareType c2, ValType v1, ValType v2)
{
  return ((c1 < c2) ? v1 : v2);
}
 ...
 */
template<typename T>
static std::vector<std::tuple<T, T>>
compareInputs()
{
