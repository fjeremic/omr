...
INSTANTIATE_TEST_CASE_P(CompareTest, Int32Compare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int32_t, int32_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("icmpeq", icmpeq), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("icmpne", icmpne), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("icmpgt", icmpgt), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("icmpge", icmpge), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("icmplt", icmplt), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("icmple", icmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, UInt32Compare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<uint32_t, uint32_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(uint32_t, uint32_t)>("iucmpgt", iucmpgt), std::make_tuple<const char*, int32_t (*)(uint32_t, uint32_t)>("iucmpge", iucmpge), std::make_tuple<const char*, int32_t (*)(uint32_t, uint32_t)>("iucmplt", iucmplt), std::make_tuple<const char*, int32_t (*)(uint32_t, uint32_t)>("iucmple", iucmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, Int64Compare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int64_t, int64_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("lcmpeq", lcmpeq), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("lcmpne", lcmpne), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("lcmpgt", lcmpgt), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("lcmpge", lcmpge), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("lcmplt", lcmplt), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("lcmple", lcmple), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("lcmp", lcmp))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, UInt64Compare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<uint64_t, uint64_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(uint64_t, uint64_t)>("lucmpgt", lucmpgt), std::make_tuple<const char*, int32_t (*)(uint64_t, uint64_t)>("lucmpge", lucmpge), std::make_tuple<const char*, int32_t (*)(uint64_t, uint64_t)>("lucmplt", lucmplt), std::make_tuple<const char*, int32_t (*)(uint64_t, uint64_t)>("lucmple", lucmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, Int32IfCompare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int32_t, int32_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ificmpeq", ificmpeq), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ificmpne", ificmpne), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ificmplt", ificmplt), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ificmple", ificmple), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ificmpge", ificmpge), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ificmpgt", ificmpgt))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, UInt32IfCompare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<uint32_t, uint32_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(uint32_t, uint32_t)>("ifiucmplt", ifiucmplt), std::make_tuple<const char*, int32_t (*)(uint32_t, uint32_t)>("ifiucmple", ifiucmple), std::make_tuple<const char*, int32_t (*)(uint32_t, uint32_t)>("ifiucmpge", ifiucmpge), std::make_tuple<const char*, int32_t (*)(uint32_t, uint32_t)>("ifiucmpgt", ifiucmpgt))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, Int64IfCompare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int64_t, int64_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("iflcmpeq", iflcmpeq), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("iflcmpne", iflcmpne), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("iflcmplt", iflcmplt), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("iflcmple", iflcmple), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("iflcmpge", iflcmpge), std::make_tuple<const char*, int32_t (*)(int64_t, int64_t)>("iflcmpgt", iflcmpgt))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, UInt64IfCompare, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<uint64_t, uint64_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(uint64_t, uint64_t)>("iflucmplt", iflucmplt), std::make_tuple<const char*, int32_t (*)(uint64_t, uint64_t)>("iflucmple", iflucmple), std::make_tuple<const char*, int32_t (*)(uint64_t, uint64_t)>("iflucmpge", iflucmpge), std::make_tuple<const char*, int32_t (*)(uint64_t, uint64_t)>("iflucmpgt", iflucmpgt))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, FloatCompare, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<float, float>(), smallFp_filter<float>)), ::testing::Values(std::make_tuple<const char*, int32_t (*)(float, float)>("fcmpeq", fcmpeq), std::make_tuple<const char*, int32_t (*)(float, float)>("fcmpne", fcmpne), std::make_tuple<const char*, int32_t (*)(float, float)>("fcmpgt", fcmpgt), std::make_tuple<const char*, int32_t (*)(float, float)>("fcmpge", fcmpge), std::make_tuple<const char*, int32_t (*)(float, float)>("fcmplt", fcmplt), std::make_tuple<const char*, int32_t (*)(float, float)>("fcmple", fcmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, DoubleCompare, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<double, double>(), smallFp_filter<double>)), ::testing::Values(std::make_tuple<const char*, int32_t (*)(double, double)>("dcmpeq", dcmpeq), std::make_tuple<const char*, int32_t (*)(double, double)>("dcmpne", dcmpne), std::make_tuple<const char*, int32_t (*)(double, double)>("dcmpgt", dcmpgt), std::make_tuple<const char*, int32_t (*)(double, double)>("dcmpge", dcmpge), std::make_tuple<const char*, int32_t (*)(double, double)>("dcmplt", dcmplt), std::make_tuple<const char*, int32_t (*)(double, double)>("dcmple", dcmple))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, FloatIfCompare, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<float, float>(), smallFp_filter<float>)), ::testing::Values(std::make_tuple<const char*, int32_t (*)(float, float)>("iffcmpeq", iffcmpeq), std::make_tuple<const char*, int32_t (*)(float, float)>("iffcmpne", iffcmpne), std::make_tuple<const char*, int32_t (*)(float, float)>("iffcmplt", iffcmplt), std::make_tuple<const char*, int32_t (*)(float, float)>("iffcmple", iffcmple), std::make_tuple<const char*, int32_t (*)(float, float)>("iffcmpge", iffcmpge), std::make_tuple<const char*, int32_t (*)(float, float)>("iffcmpgt", iffcmpgt))));
...
INSTANTIATE_TEST_CASE_P(CompareTest, DoubleIfCompare, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<double, double>(), smallFp_filter<double>)), ::testing::Values(std::make_tuple<const char*, int32_t (*)(double, double)>("ifdcmpeq", ifdcmpeq), std::make_tuple<const char*, int32_t (*)(double, double)>("ifdcmpne", ifdcmpne), std::make_tuple<const char*, int32_t (*)(double, double)>("ifdcmplt", ifdcmplt), std::make_tuple<const char*, int32_t (*)(double, double)>("ifdcmple", ifdcmple), std::make_tuple<const char*, int32_t (*)(double, double)>("ifdcmpge", ifdcmpge), std::make_tuple<const char*, int32_t (*)(double, double)>("ifdcmpgt", ifdcmpgt))));
