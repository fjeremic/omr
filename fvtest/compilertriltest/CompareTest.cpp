...
int32_t icmpeq(int32_t l, int32_t r) { return (l == r) ? 1 : 0; }

int32_t icmpne(int32_t l, int32_t r) { return (l != r) ? 1 : 0; }

int32_t icmpgt(int32_t l, int32_t r) { return (l > r) ? 1 : 0; }

int32_t icmpge(int32_t l, int32_t r) { return (l >= r) ? 1 : 0; }

int32_t icmplt(int32_t l, int32_t r) { return (l < r) ? 1 : 0; }

int32_t icmple(int32_t l, int32_t r) { return (l <= r) ? 1 : 0; }
...
int32_t iucmpgt(uint32_t l, uint32_t r) { return (l > r) ? 1 : 0; }

int32_t iucmpge(uint32_t l, uint32_t r) { return (l >= r) ? 1 : 0; }

int32_t iucmplt(uint32_t l, uint32_t r) { return (l < r) ? 1 : 0; }

int32_t iucmple(uint32_t l, uint32_t r) { return (l <= r) ? 1 : 0; }
...
int32_t lcmpeq(int64_t l, int64_t r) { return (l == r) ? 1 : 0; }

int32_t lcmpne(int64_t l, int64_t r) { return (l != r) ? 1 : 0; }

int32_t lcmpgt(int64_t l, int64_t r) { return (l > r) ? 1 : 0; }

int32_t lcmpge(int64_t l, int64_t r) { return (l >= r) ? 1 : 0; }

int32_t lcmplt(int64_t l, int64_t r) { return (l < r) ? 1 : 0; }

int32_t lcmple(int64_t l, int64_t r) { return (l <= r) ? 1 : 0; }

int32_t lcmp(int64_t l, int64_t r) { return (l < r) ? -1 : ((l > r) ? 1 : 0); }
...
INSTANTIATE_TEST_CASE_P(
    CompareTest, Int64Compare,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_value_pairs<int64_t, int64_t>()),
        ::testing::Values(
            std::make_tuple<const char *, int32_t (*)(int64_t, int64_t)>(
                "lcmpeq", lcmpeq),
            std::make_tuple<const char *, int32_t (*)(int64_t, int64_t)>(
                "lcmpne", lcmpne),
            std::make_tuple<const char *, int32_t (*)(int64_t, int64_t)>(
...
int32_t lucmpgt(uint64_t l, uint64_t r) { return (l > r) ? 1 : 0; }

int32_t lucmpge(uint64_t l, uint64_t r) { return (l >= r) ? 1 : 0; }

int32_t lucmplt(uint64_t l, uint64_t r) { return (l < r) ? 1 : 0; }

int32_t lucmple(uint64_t l, uint64_t r) { return (l <= r) ? 1 : 0; }
...
TEST_P(Int32IfCompare, UsingConst) {
  ...
  std::snprintf(inputTrees, 256,
                ...
                "(ireturn (iconst %d)))"
                ")",
                param.opcode.c_str(), param.lhs, param.rhs, IFCMP_FALSE_NUM,
                IFCMP_TRUE_NUM);
  auto trees = parseString(inputTrees);
...
template <typename T> bool smallFp_filter(std::tuple<T, T> a) {
...
int32_t fcmpeq(float l, float r) { return (l == r) ? 1 : 0; }

int32_t fcmpne(float l, float r) { return (l != r) ? 1 : 0; }

int32_t fcmpgt(float l, float r) { return (l > r) ? 1 : 0; }

int32_t fcmpge(float l, float r) { return (l >= r) ? 1 : 0; }

int32_t fcmplt(float l, float r) { return (l < r) ? 1 : 0; }

int32_t fcmple(float l, float r) { return (l <= r) ? 1 : 0; }
...
INSTANTIATE_TEST_CASE_P(
    CompareTest, FloatCompare,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::filter(
            TRTest::const_value_pairs<float, float>(), smallFp_filter<float>)),
        ::testing::Values(
            std::make_tuple<const char *, int32_t (*)(float, float)>("fcmpeq",
                                                                     fcmpeq),
            std::make_tuple<const char *, int32_t (*)(float, float)>("fcmpne",
                                                                     fcmpne),
            std::make_tuple<const char *, int32_t (*)(float, float)>("fcmpgt",
                                                                     fcmpgt),
            std::make_tuple<const char *, int32_t (*)(float, float)>("fcmpge",
                                                                     fcmpge),
            std::make_tuple<const char *, int32_t (*)(float, float)>("fcmplt",
                                                                     fcmplt),
            std::make_tuple<const char *, int32_t (*)(float, float)>("fcmple",
                                                                     fcmple))));

int32_t dcmpeq(double l, double r) { return (l == r) ? 1 : 0; }

int32_t dcmpne(double l, double r) { return (l != r) ? 1 : 0; }

int32_t dcmpgt(double l, double r) { return (l > r) ? 1 : 0; }

int32_t dcmpge(double l, double r) { return (l >= r) ? 1 : 0; }

int32_t dcmplt(double l, double r) { return (l < r) ? 1 : 0; }

int32_t dcmple(double l, double r) { return (l <= r) ? 1 : 0; }
    ...
    ::testing::Combine(
        ...
        ::testing::Values(
            ...
            std::make_tuple<const char *, int32_t (*)(double, double)>("dcmplt",
                                                                       dcmplt),
            std::make_tuple<const char *, int32_t (*)(double, double)>(
                "dcmple", dcmple))));
