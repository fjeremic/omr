...
public:
  ...
  public:
    FailedCurrentThreadAttachment()
      : std::runtime_error("Failed to attach current thread to thread library.")
    {}
  };
 ...
 */
template<typename L, typename R>
std::vector<std::tuple<L, R>>
combine(std::vector<L> l, std::vector<R> r)
{
 ...
 */
inline std::ostream&
operator<<(std::ostream& os, SkipReason reason)
{
