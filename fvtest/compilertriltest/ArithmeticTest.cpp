...
INSTANTIATE_TEST_CASE_P(ArithmeticTest, Int32Arithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int32_t, int32_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("iadd", add), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("isub", sub), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("imul", mul), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("imulh", imulh))));

INSTANTIATE_TEST_CASE_P(ArithmeticTest, Int64Arithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int64_t, int64_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("ladd", add), std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lsub", sub), std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lmul", mul))));

INSTANTIATE_TEST_CASE_P(ArithmeticTest, Int16Arithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int16_t, int16_t>()), ::testing::Values(std::make_tuple<const char*, int16_t (*)(int16_t, int16_t)>("sadd", add<int16_t>), std::make_tuple<const char*, int16_t (*)(int16_t, int16_t)>("ssub", sub<int16_t>), std::make_tuple<const char*, int16_t (*)(int16_t, int16_t)>("smul", mul<int16_t>))));

INSTANTIATE_TEST_CASE_P(ArithmeticTest, Int8Arithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int8_t, int8_t>()), ::testing::Values(std::make_tuple<const char*, int8_t (*)(int8_t, int8_t)>("badd", add<int8_t>), std::make_tuple<const char*, int8_t (*)(int8_t, int8_t)>("bsub", sub<int8_t>), std::make_tuple<const char*, int8_t (*)(int8_t, int8_t)>("bmul", mul<int8_t>))));
...
INSTANTIATE_TEST_CASE_P(DivArithmeticTest, Int32Arithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<int32_t, int32_t>(), div_filter<int32_t>)), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("idiv", div), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("irem", rem))));

INSTANTIATE_TEST_CASE_P(DivArithmeticTest, Int64Arithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<int64_t, int64_t>(), div_filter<int64_t>)), ::testing::Values(std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("ldiv", div), std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lrem", rem))));
...
INSTANTIATE_TEST_CASE_P(DivArithmeticTest, UInt32Arithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<uint32_t, uint32_t>(), udiv_filter<uint32_t>)), ::testing::Values(std::make_tuple<const char*, uint32_t (*)(uint32_t, uint32_t)>("iudiv", udiv), std::make_tuple<const char*, uint32_t (*)(uint32_t, uint32_t)>("iurem", urem))));

INSTANTIATE_TEST_CASE_P(DivArithmeticTest, UInt64Arithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<uint64_t, uint64_t>(), udiv_filter<uint64_t>)), ::testing::Values(std::make_tuple<const char*, uint64_t (*)(uint64_t, uint64_t)>("ludiv", udiv))));
...
INSTANTIATE_TEST_CASE_P(ArithmeticTest, FloatArithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<float, float>(), smallFp_filter<float>)), ::testing::Values(std::make_tuple<const char*, float (*)(float, float)>("fadd", static_cast<float (*)(float, float)>(add)), std::make_tuple<const char*, float (*)(float, float)>("fsub", static_cast<float (*)(float, float)>(sub)), std::make_tuple<const char*, float (*)(float, float)>("fmul", static_cast<float (*)(float, float)>(mul)), std::make_tuple<const char*, float (*)(float, float)>("fdiv", static_cast<float (*)(float, float)>(div)))));
...
INSTANTIATE_TEST_CASE_P(ArithmeticTest, DoubleArithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_value_pairs<double, double>(), smallFp_filter<double>)), ::testing::Values(std::make_tuple<const char*, double (*)(double, double)>("dadd", add), std::make_tuple<const char*, double (*)(double, double)>("dsub", sub), std::make_tuple<const char*, double (*)(double, double)>("dmul", mul), std::make_tuple<const char*, double (*)(double, double)>("ddiv", div))));
...
INSTANTIATE_TEST_CASE_P(ArithmeticTest, FloatUnaryArithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(), smallFp_unary_filter<float>)), ::testing::Values(std::make_tuple<const char*, float (*)(float)>("fabs", static_cast<float (*)(float)>(std::abs)), std::make_tuple<const char*, float (*)(float)>("fneg", fneg))));
...
INSTANTIATE_TEST_CASE_P(ArithmeticTest, DoubleUnaryArithmetic, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(), smallFp_unary_filter<double>)), ::testing::Values(std::make_tuple<const char*, double (*)(double)>("dabs", static_cast<double (*)(double)>(std::abs)), std::make_tuple<const char*, double (*)(double)>("dneg", dneg))));
