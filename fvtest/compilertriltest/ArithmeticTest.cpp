...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Combine(
        ...
        ::testing::Values(std::make_tuple<const char*, float (*)(float, float)>(
                              "fadd",
                              static_cast<float (*)(float, float)>(add)),
                          std::make_tuple<const char*, float (*)(float, float)>(
                              "fsub",
                              static_cast<float (*)(float, float)>(sub)),
                          std::make_tuple<const char*, float (*)(float, float)>(
                              "fmul",
                              static_cast<float (*)(float, float)>(mul)),
                          std::make_tuple<const char*, float (*)(float, float)>(
                              "fdiv",
                              static_cast<float (*)(float, float)>(div)))));
