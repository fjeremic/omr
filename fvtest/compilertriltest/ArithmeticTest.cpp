    ...
    ::testing::Combine(
        ...
        ::testing::Values(
            ...
            std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lsub",
                                                                        sub),
            std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lmul",
                                                                        mul))));
    ...
    ::testing::Combine(
        ...
        ::testing::Values(
            std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("idiv",
                                                                        div),
            std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("irem",
                                                                        rem))));
    ...
    ::testing::Combine(
        ...
        ::testing::Values(
            std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("ldiv",
                                                                        div),
            std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lrem",
                                                                        rem))));
