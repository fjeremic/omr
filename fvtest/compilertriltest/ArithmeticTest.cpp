...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      ...
      std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("imulh",
                                                                  imulh))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, int16_t (*)(int16_t, int16_t)>("sadd",
                                                                  add<int16_t>),
      std::make_tuple<const char*, int16_t (*)(int16_t, int16_t)>("ssub",
                                                                  sub<int16_t>),
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, int8_t (*)(int8_t, int8_t)>("badd",
                                                               add<int8_t>),
      std::make_tuple<const char*, int8_t (*)(int8_t, int8_t)>("bsub",
                                                               sub<int8_t>),
      std::make_tuple<const char*, int8_t (*)(int8_t, int8_t)>("bmul",
                                                               mul<int8_t>))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, uint32_t (*)(uint32_t, uint32_t)>("iudiv",
                                                                     udiv),
      std::make_tuple<const char*, uint32_t (*)(uint32_t, uint32_t)>("iurem",
                                                                     urem))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, uint64_t (*)(uint64_t, uint64_t)>("ludiv",
                                                                     udiv))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, float (*)(float)>(
                        "fabs",
                        static_cast<float (*)(float)>(std::abs)),
                      std::make_tuple<const char*, float (*)(float)>("fneg",
                                                                     fneg))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, double (*)(double)>(
                        "dabs",
                        static_cast<double (*)(double)>(std::abs)),
                      std::make_tuple<const char*, double (*)(double)>("dneg",
                                                                       dneg))));
