...
template<typename T>
static std::vector<std::tuple<T, int32_t>>
test_input_values()
{
...
static Left
shift_left(Left left, int32_t right)
{
  int32_t r = right;
...
template<typename Left>
static Left
shift_right(Left left, int32_t right)
{
  int32_t r = right;
  if (sizeof(Left) <= sizeof(int32_t)) {
    r = (r & (8 * sizeof(int32_t) - 1));
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>(
        "ishl",
        static_cast<int32_t (*)(int32_t, int32_t)>(shift_left)),
      std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>(
        "ishr",
        static_cast<int32_t (*)(int32_t, int32_t)>(shift_right)),
      std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>(
        "irol",
        static_cast<int32_t (*)(int32_t, int32_t)>(rotate)))));
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, int64_t (*)(int64_t, int32_t)>(
        "lshl",
        static_cast<int64_t (*)(int64_t, int32_t)>(shift_left)),
      std::make_tuple<const char*, int64_t (*)(int64_t, int32_t)>(
        "lshr",
        static_cast<int64_t (*)(int64_t, int32_t)>(shift_right)),
      std::make_tuple<const char*, int64_t (*)(int64_t, int32_t)>(
        "lrol",
        static_cast<int64_t (*)(int64_t, int32_t)>(rotate)))));
...
TEST_P(Int8ShiftAndRotate, UsingRhsConst)
{
  ...
  SKIP_IF(OMRPORT_ARCH_PPC64 == arch || OMRPORT_ARCH_PPC == arch, KnownBug)
    << "The Power code generator incorrectly spills sub-integer type arguments "
       "on big-endian machines (see issue #3525)";
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, int8_t (*)(int8_t, int32_t)>(
        "bshl",
        static_cast<int8_t (*)(int8_t, int32_t)>(shift_left)),
      std::make_tuple<const char*, int8_t (*)(int8_t, int32_t)>(
        "bshr",
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, int16_t (*)(int16_t, int32_t)>(
        "sshl",
        static_cast<int16_t (*)(int16_t, int32_t)>(shift_left)),
      std::make_tuple<const char*, int16_t (*)(int16_t, int32_t)>(
        "sshr",
...
test_masks<uint64_t>()
{
  return std::vector<uint64_t>(
    mask64Values, mask64Values + sizeof(mask64Values) / sizeof(*mask64Values));
}
...
test_masks<uint32_t>()
{
  return std::vector<uint32_t>(
    mask32Values, mask32Values + sizeof(mask32Values) / sizeof(*mask32Values));
}
...
test_masks<uint16_t>()
{
  return std::vector<uint16_t>(
    mask16Values, mask16Values + sizeof(mask16Values) / sizeof(*mask16Values));
}
...
static uint8_t mask8Values[] = {
  0x00, 0xff, 0x7f, 0x80, 0x3c, 0xf0, 0x0f, 0xc3
};
...
template<typename T>
T
mask_then_shift_right(T value, T mask, int32_t shift)
{
...
template<typename T>
T
mask_then_shift_left(T value, T mask, int32_t shift)
{
  if (sizeof(T) <= sizeof(int32_t)) {
    shift &= (shift & (8 * sizeof(int32_t) - 1));
  } else {
...
template<typename T>
MaskThenShiftParamStruct<T>
to_mask_then_shift_struct(
  std::tuple<std::tuple<std::tuple<T, T>, int32_t>,
             std::tuple<std::string, T (*)(T, T, int32_t)>> param)
{
  ...
  ::testing::Combine(
    ::testing::ValuesIn(
      static_cast<std::vector<
        ...
        test_mask_then_shift_values)()),
    ::testing::Values(
      std::make_tuple<const char*, uint64_t (*)(uint64_t, uint64_t, int32_t)>(
        "lushr",
        static_cast<uint64_t (*)(uint64_t, uint64_t, int32_t)>(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      std::make_tuple<const char*, int64_t (*)(int64_t, int64_t, int32_t)>(
        "lshr",
        static_cast<int64_t (*)(int64_t, int64_t, int32_t)>(
          mask_then_shift_right)),
      std::make_tuple<const char*, int64_t (*)(int64_t, int64_t, int32_t)>(
        "lshl",
        static_cast<int64_t (*)(int64_t, int64_t, int32_t)>(
  ...
  ::testing::Combine(
    ::testing::ValuesIn(
      static_cast<std::vector<
        ...
        test_mask_then_shift_values)()),
    ::testing::Values(
      std::make_tuple<const char*, uint32_t (*)(uint32_t, uint32_t, int32_t)>(
        "iushr",
        static_cast<uint32_t (*)(uint32_t, uint32_t, int32_t)>(
          mask_then_shift_right)))));
  ...
  ::testing::Combine(
    ::testing::ValuesIn(
      static_cast<std::vector<
        ...
        test_mask_then_shift_values)()),
    ::testing::Values(
      std::make_tuple<const char*, int32_t (*)(int32_t, int32_t, int32_t)>(
        "ishr",
        static_cast<int32_t (*)(int32_t, int32_t, int32_t)>(
          mask_then_shift_right)))));
  ...
  ::testing::Combine(
    ::testing::ValuesIn(
      static_cast<std::vector<
        ...
        test_mask_then_shift_values)()),
    ::testing::Values(
      std::make_tuple<const char*, uint16_t (*)(uint16_t, uint16_t, int32_t)>(
        "sushr",
        static_cast<uint16_t (*)(uint16_t, uint16_t, int32_t)>(
          mask_then_shift_right)))));
  ...
  ::testing::Combine(
    ::testing::ValuesIn(
      static_cast<std::vector<
        ...
        test_mask_then_shift_values)()),
    ::testing::Values(
      std::make_tuple<const char*, int16_t (*)(int16_t, int16_t, int32_t)>(
        "sshr",
        static_cast<int16_t (*)(int16_t, int16_t, int32_t)>(
          mask_then_shift_right)))));
  ...
  ::testing::Combine(
    ::testing::ValuesIn(
      static_cast<std::vector<
        ...
        test_mask_then_shift_values)()),
    ::testing::Values(
      std::make_tuple<const char*, uint8_t (*)(uint8_t, uint8_t, int32_t)>(
        "bushr",
        static_cast<uint8_t (*)(uint8_t, uint8_t, int32_t)>(
          mask_then_shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ::testing::ValuesIn(
      static_cast<
        std::vector<std::tuple<std::tuple<int8_t, int8_t>, int32_t>> (*)(void)>(
        test_mask_then_shift_values)()),
    ::testing::Values(
      std::make_tuple<const char*, int8_t (*)(int8_t, int8_t, int32_t)>(
        "bshr",
        static_cast<int8_t (*)(int8_t, int8_t, int32_t)>(
          mask_then_shift_right)))));
