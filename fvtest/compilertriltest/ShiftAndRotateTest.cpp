...
static std::vector<int32_t> test_shifts() {
  ...
  return std::vector<int32_t>(
      shiftArray, shiftArray + sizeof(shiftArray) / sizeof(int32_t));
}
...
std::vector<uint64_t> test_masks<uint64_t>() {
  return std::vector<uint64_t>(
      mask64Values,
      mask64Values + sizeof(mask64Values) / sizeof(*mask64Values));
}
...
std::vector<uint32_t> test_masks<uint32_t>() {
  return std::vector<uint32_t>(
      mask32Values,
      mask32Values + sizeof(mask32Values) / sizeof(*mask32Values));
}
...
std::vector<uint16_t> test_masks<uint16_t>() {
  return std::vector<uint16_t>(
      mask16Values,
      mask16Values + sizeof(mask16Values) / sizeof(*mask16Values));
}
