...
template <typename T> static std::vector<int32_t> test_shifts() {
  int32_t shiftArray[] = {0, 1, 5, 8, 25, 8 * sizeof(T) - 1, 8 * sizeof(T)};
  return std::vector<int32_t>(shiftArray, shiftArray + sizeof(shiftArray) /
                                                           sizeof(int32_t));
}
...
TEST_P(Int32ShiftAndRotate, UsingConst) {
  ...
  std::snprintf(
      inputTrees, 120,
      "(method return=Int32 (block (ireturn (%s (iconst %d) (iconst %d)))))",
...
TEST_P(Int32ShiftAndRotate, UsingLoadParam) {
  ...
  ASSERT_EQ(param.oracle(param.lhs, param.rhs),
            entry_point(param.lhs, param.rhs));
}

INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, Int32ShiftAndRotate,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<std::tuple<int32_t, int32_t>> (*)(void)>(
                test_input_values)()),
        ::testing::Values(
            std::make_tuple<const char *, int32_t (*)(int32_t, int32_t)>(
                "ishl", static_cast<int32_t (*)(int32_t, int32_t)>(shift_left)),
            std::make_tuple<const char *, int32_t (*)(int32_t, int32_t)>(
                "ishr",
                static_cast<int32_t (*)(int32_t, int32_t)>(shift_right)),
            std::make_tuple<const char *, int32_t (*)(int32_t, int32_t)>(
                "irol", static_cast<int32_t (*)(int32_t, int32_t)>(rotate)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, Int64ShiftAndRotate,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<std::tuple<int64_t, int32_t>> (*)(void)>(
                test_input_values)()),
        ::testing::Values(
            std::make_tuple<const char *, int64_t (*)(int64_t, int32_t)>(
                "lshl", static_cast<int64_t (*)(int64_t, int32_t)>(shift_left)),
            std::make_tuple<const char *, int64_t (*)(int64_t, int32_t)>(
                "lshr",
                static_cast<int64_t (*)(int64_t, int32_t)>(shift_right)),
            std::make_tuple<const char *, int64_t (*)(int64_t, int32_t)>(
                "lrol", static_cast<int64_t (*)(int64_t, int32_t)>(rotate)))));
...
TEST_P(Int8ShiftAndRotate, UsingRhsConst) {
  ...
  SKIP_IF(OMRPORT_ARCH_S390 == arch || OMRPORT_ARCH_S390X == arch, KnownBug)
      << "The Z code generator incorrectly spills sub-integer types arguments "
         "(see issue #3525)";
  SKIP_IF(OMRPORT_ARCH_PPC64 == arch || OMRPORT_ARCH_PPC == arch, KnownBug)
      << "The Power code generator incorrectly spills sub-integer type "
         "arguments on big-endian machines (see issue #3525)";
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, Int8ShiftAndRotate,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<std::tuple<int8_t, int32_t>> (*)(void)>(
                test_input_values)()),
        ::testing::Values(
            std::make_tuple<const char *, int8_t (*)(int8_t, int32_t)>(
                "bshl", static_cast<int8_t (*)(int8_t, int32_t)>(shift_left)),
            std::make_tuple<const char *, int8_t (*)(int8_t, int32_t)>(
                "bshr",
                static_cast<int8_t (*)(int8_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, Int16ShiftAndRotate,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<std::tuple<int16_t, int32_t>> (*)(void)>(
                test_input_values)()),
        ::testing::Values(
            std::make_tuple<const char *, int16_t (*)(int16_t, int32_t)>(
                "sshl", static_cast<int16_t (*)(int16_t, int32_t)>(shift_left)),
            std::make_tuple<const char *, int16_t (*)(int16_t, int32_t)>(
                "sshr",
                static_cast<int16_t (*)(int16_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, UInt32ShiftAndRotate,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<std::tuple<uint32_t, int32_t>> (*)(void)>(
                test_input_values)()),
        ::testing::Values(
            std::make_tuple<const char *, uint32_t (*)(uint32_t, int32_t)>(
                "iushr",
                static_cast<uint32_t (*)(uint32_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, UInt64ShiftAndRotate,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<std::tuple<uint64_t, int32_t>> (*)(void)>(
                test_input_values)()),
        ::testing::Values(
            std::make_tuple<const char *, uint64_t (*)(uint64_t, int32_t)>(
                "lushr",
                static_cast<uint64_t (*)(uint64_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, UInt8ShiftAndRotate,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<std::tuple<uint8_t, int32_t>> (*)(void)>(
                test_input_values)()),
        ::testing::Values(
            std::make_tuple<const char *, uint8_t (*)(uint8_t, int32_t)>(
                "bushr",
                static_cast<uint8_t (*)(uint8_t, int32_t)>(shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, UInt16ShiftAndRotate,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<std::tuple<uint16_t, int32_t>> (*)(void)>(
                test_input_values)()),
        ::testing::Values(
            std::make_tuple<const char *, uint16_t (*)(uint16_t, int32_t)>(
                "sushr",
                static_cast<uint16_t (*)(uint16_t, int32_t)>(shift_right)))));

template <typename T> static std::vector<T> test_masks();

static uint64_t mask64Values[] = {
    0x0000000000000000, 0x0000000000000001, 0x0000000000000002,
    0x000000000000003e, 0x000000000000ffff, 0x00000000ffffffff,
    0x00000003c0000000, 0x0000003f00000000, 0x00007fffffffffff,
    0x4000000000000000, 0x4000000000000001, 0x7000000000000000,
    0x7c00000000000000, 0x7fffffffffffffff, 0x8000000000000000,
    0x8000000000000002, 0xf0f0f0f0f0f0f0f0, 0xffff000000000000,
    0xffffffff00000000, 0xffffffffffff0000, 0xffffffffffffffff};

template <> std::vector<uint64_t> test_masks<uint64_t>() {
  return std::vector<uint64_t>(mask64Values,
                               mask64Values + sizeof(mask64Values) /
                                                  sizeof(*mask64Values));
}

template <> std::vector<int64_t> test_masks<int64_t>() {
  return std::vector<int64_t>(mask64Values,
                              mask64Values +
                                  sizeof(mask64Values) / sizeof(*mask64Values));
}

static uint32_t mask32Values[] = {0x00000000, 0xffffffff, 0x7fffffff,
                                  0x80000000, 0x003f0000, 0xffff0000,
                                  0x0000ffff, 0xff0000ff};

template <> std::vector<uint32_t> test_masks<uint32_t>() {
  return std::vector<uint32_t>(mask32Values,
                               mask32Values + sizeof(mask32Values) /
                                                  sizeof(*mask32Values));
}

template <> std::vector<int32_t> test_masks<int32_t>() {
  return std::vector<int32_t>(mask32Values,
                              mask32Values +
                                  sizeof(mask32Values) / sizeof(*mask32Values));
}

static uint16_t mask16Values[] = {0x0000, 0xffff, 0x7fff, 0x8000,
                                  0x03f0, 0xff00, 0x00ff, 0xf00f};

template <> std::vector<uint16_t> test_masks<uint16_t>() {
  return std::vector<uint16_t>(mask16Values,
                               mask16Values + sizeof(mask16Values) /
                                                  sizeof(*mask16Values));
}

template <> std::vector<int16_t> test_masks<int16_t>() {
  return std::vector<int16_t>(mask16Values,
                              mask16Values +
                                  sizeof(mask16Values) / sizeof(*mask16Values));
}

static uint8_t mask8Values[] = {0x00, 0xff, 0x7f, 0x80, 0x3c, 0xf0, 0x0f, 0xc3};

template <> std::vector<uint8_t> test_masks<uint8_t>() {
  return std::vector<uint8_t>(
      mask8Values, mask8Values + sizeof(mask8Values) / sizeof(*mask8Values));
}

template <> std::vector<int8_t> test_masks<int8_t>() {
  return std::vector<int8_t>(
      mask8Values, mask8Values + sizeof(mask8Values) / sizeof(*mask8Values));
}

template <typename T>
static std::vector<std::tuple<std::tuple<T, T>, int32_t>>
test_mask_then_shift_values() {
  return TRTest::combine(
      TRTest::combine(TRTest::const_values<T>(), test_masks<T>()),
      test_shifts<T>());
}

template <typename T> T mask_then_shift_right(T value, T mask, int32_t shift) {
...
template <typename T> T mask_then_shift_left(T value, T mask, int32_t shift) {
  if (sizeof(T) <= sizeof(int32_t)) {
    shift &= (shift & (8 * sizeof(int32_t) - 1));
  } else {
    shift &= (8 * sizeof(int64_t) - 1);
...
template <typename T> struct MaskThenShiftParamStruct {
  T value;
  T mask;
  int32_t shift;
  std::string opcode;
...
template <typename T>
MaskThenShiftParamStruct<T> to_mask_then_shift_struct(
    std::tuple<std::tuple<std::tuple<T, T>, int32_t>,
               std::tuple<std::string, T (*)(T, T, int32_t)>>
        param) {
...
template <typename T>
class MaskThenShiftArithmetic
    : public TRTest::JitTest,
...
TEST_P(UInt64MaskThenShift, UsingLoadParam) {
  ...
  std::snprintf(inputTrees, sizeof(inputTrees),
                ...
                "          (lconst %" OMR_PRIu64 "))"
                "        (iconst %d)))))",
                param.opcode.c_str(), param.mask, param.shift);
  auto trees = parseString(inputTrees);
  ...
  auto entry_point = compiler.getEntryPoint<uint64_t (*)(uint64_t)>();
  ASSERT_EQ(param.oracle(param.value, param.mask, param.shift),
            entry_point(param.value));
}

INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, UInt64MaskThenShift,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<
                std::tuple<std::tuple<uint64_t, uint64_t>, int32_t>> (*)(void)>(
                test_mask_then_shift_values)()),
        ::testing::Values(
            std::make_tuple<const char *,
                            uint64_t (*)(uint64_t, uint64_t, int32_t)>(
                "lushr", static_cast<uint64_t (*)(uint64_t, uint64_t, int32_t)>(
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, Int64MaskThenShift,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<
                std::tuple<std::tuple<int64_t, int64_t>, int32_t>> (*)(void)>(
                test_mask_then_shift_values)()),
        ::testing::Values(
            std::make_tuple<const char *,
                            int64_t (*)(int64_t, int64_t, int32_t)>(
                "lshr", static_cast<int64_t (*)(int64_t, int64_t, int32_t)>(
                            mask_then_shift_right)),
            std::make_tuple<const char *,
                            int64_t (*)(int64_t, int64_t, int32_t)>(
                "lshl", static_cast<int64_t (*)(int64_t, int64_t, int32_t)>(
                            mask_then_shift_left)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, UInt32MaskThenShift,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<
                std::tuple<std::tuple<uint32_t, uint32_t>, int32_t>> (*)(void)>(
                test_mask_then_shift_values)()),
        ::testing::Values(
            std::make_tuple<const char *,
                            uint32_t (*)(uint32_t, uint32_t, int32_t)>(
                "iushr", static_cast<uint32_t (*)(uint32_t, uint32_t, int32_t)>(
                             mask_then_shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, Int32MaskThenShift,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<
                std::tuple<std::tuple<int32_t, int32_t>, int32_t>> (*)(void)>(
                test_mask_then_shift_values)()),
        ::testing::Values(std::make_tuple<
                          const char *, int32_t (*)(int32_t, int32_t, int32_t)>(
            "ishr", static_cast<int32_t (*)(int32_t, int32_t, int32_t)>(
                        mask_then_shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, UInt16MaskThenShift,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<
                std::tuple<std::tuple<uint16_t, uint16_t>, int32_t>> (*)(void)>(
                test_mask_then_shift_values)()),
        ::testing::Values(
            std::make_tuple<const char *,
                            uint16_t (*)(uint16_t, uint16_t, int32_t)>(
                "sushr", static_cast<uint16_t (*)(uint16_t, uint16_t, int32_t)>(
                             mask_then_shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, Int16MaskThenShift,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<
                std::tuple<std::tuple<int16_t, int16_t>, int32_t>> (*)(void)>(
                test_mask_then_shift_values)()),
        ::testing::Values(std::make_tuple<
                          const char *, int16_t (*)(int16_t, int16_t, int32_t)>(
            "sshr", static_cast<int16_t (*)(int16_t, int16_t, int32_t)>(
                        mask_then_shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, UInt8MaskThenShift,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<
                std::tuple<std::tuple<uint8_t, uint8_t>, int32_t>> (*)(void)>(
                test_mask_then_shift_values)()),
        ::testing::Values(std::make_tuple<
                          const char *, uint8_t (*)(uint8_t, uint8_t, int32_t)>(
            "bushr", static_cast<uint8_t (*)(uint8_t, uint8_t, int32_t)>(
                         mask_then_shift_right)))));
...
INSTANTIATE_TEST_CASE_P(
    ShiftAndRotateTest, Int8MaskThenShift,
    ::testing::Combine(
        ::testing::ValuesIn(
            static_cast<std::vector<
                std::tuple<std::tuple<int8_t, int8_t>, int32_t>> (*)(void)>(
                test_mask_then_shift_values)()),
        ::testing::Values(
            std::make_tuple<const char *, int8_t (*)(int8_t, int8_t, int32_t)>(
                "bshr", static_cast<int8_t (*)(int8_t, int8_t, int32_t)>(
                            mask_then_shift_right)))));
