...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::
    Values("(method return=Int32 (block (ireturn (iadd (iconst 1) (sconst "
           ...
           "3)))))",
           "(method return=Address (block (areturn (aiadd (aconst 4) (lconst "
           "1)))))",
           "(method return=Address (block (areturn (aladd (aconst 4) (iconst "
           "1)))))",
           "(method return=Address (block (areturn (aiadd (iconst 1) (aconst "
           "4)))))",
           "(method return=Address (block (areturn (aladd (lconst 1) (aconst "
           "4)))))",
           "(method return=Int32 (block (ireturn (acmpeq (iconst 4) (aconst "
           "4)))))",
           "(method return=Int32 (block (ireturn (acmpge (lconst 4) (aconst "
           "4)))))",
           "(method return=NoType (block (return (GlRegDeps))))",
           "(method return=Int32 (block (ireturn (GlRegDeps) (iconst 3))))",
           "(method return=Int32 (block (ireturn (GlRegDeps) (iadd (iconst 1) "
           "(iconst 3)))))",
           "(method return=Int32 (block (ireturn (iconst 3 (GlRegDeps)))))",
           "(method return=Int32 (block (ireturn (iadd (GlRegDeps) (iconst 1) "
           "(iconst 3)))))"
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Values(
    ...
    "(method return=Int32 (block (ireturn (sconst 1) )))", // ireturn may return
                                                           // i,b or s
    "(method return=Int32 (block (ireturn (bconst 1) )))"  // ireturn may return
                                                           // i,b or s
    ));
...
TEST_P(CommoningTest, CommoningUnderSameTree)
{
  auto param = GetParam();
  auto tril = TRIL(
    (method return = Int32 args = [ Int32, Int32 ](block(ireturn(icmpeq(imul(
...
TEST_P(CommoningTest, CommoningWithinBlock)
{
  auto param = GetParam();
  auto tril =
    TRIL((method return = Int32 args = [ Int32, Int32 ](block(
