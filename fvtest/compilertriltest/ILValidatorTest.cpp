...
INSTANTIATE_TEST_CASE_P(ILValidatorTest, IllformedTrees,
  ::testing::Values("(method return=Int32 (block (ireturn (iadd (iconst 1) (sconst 3)))))",
...
INSTANTIATE_TEST_CASE_P(ILValidatorTest, WellformedTrees,
  ::testing::Values(
    "(method return=Int32 (block (ireturn (iconst 3))))", "(method return=Int32 (block (ireturn (s2i (sconst 3)))))",
...
{
  auto param = GetParam();
  auto tril = TRIL((method return = Int32 args = [ Int32, Int32 ](block(ireturn(icmpeq(imul(iadd(iload parm = 0 id
                      = "loadParm0")(iload parm = 1 id = "loadParm1"))(isub(@id "loadParm0")(@id "loadParm1")))(
                      isub(imul(@id "loadParm0")(@id "loadParm0"))(imul(@id "loadParm1")(@id "loadParm1"))))))));
...
{
  auto param = GetParam();
  auto tril = TRIL((method return = Int32 args
    = [ Int32, Int32 ](block(iload parm = 0 id = "loadParm0")(iload parm = 1 id = "loadParm1")(
      ireturn(icmpeq(imul(iadd(@id "loadParm0")(@id "loadParm1"))(isub(@id "loadParm0")(@id "loadParm1")))(
        isub(imul(@id "loadParm0")(@id "loadParm0"))(imul(@id "loadParm1")(@id "loadParm1"))))))));
...
INSTANTIATE_TEST_CASE_P(
  CommoningValidationTest, CommoningTest, ::testing::ValuesIn(TRTest::const_value_pairs<int32_t, int32_t>()));
...
TEST_F(InvalidCommoningTest, CommoningAcrossBlock)
{
  ...
  // invalid commoning.
  auto tril = TRIL((method return = Int32 args
    = [Int32](block name = "first"(iload parm = 0 id = "parm0")(imul id = "multwo"(iconst 2)(@id "parm0")))(
