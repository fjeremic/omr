...
class IfxcmpgeReductionTest
    : public ::testing::TestWithParam<std::tuple<ValType, ValType, int32_t (*)(ValType, ValType)> > {
public:
...
INSTANTIATE_TEST_CASE_P(IfxcmpgeReductionTest, Int8ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int8_t>()),
        ::testing::ValuesIn(TRTest::const_values<int8_t>()), ::testing::Values(ifxcmpgeReductionOracle<int8_t>)));
...
INSTANTIATE_TEST_CASE_P(IfxcmpgeReductionTest, UInt8ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint8_t>()),
        ::testing::ValuesIn(TRTest::const_values<uint8_t>()), ::testing::Values(ifxcmpgeReductionOracle<uint8_t>)));
...
INSTANTIATE_TEST_CASE_P(IfxcmpgeReductionTest, Int16ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int16_t>()),
        ::testing::ValuesIn(TRTest::const_values<int16_t>()), ::testing::Values(ifxcmpgeReductionOracle<int16_t>)));
...
INSTANTIATE_TEST_CASE_P(IfxcmpgeReductionTest, UInt16ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint16_t>()),
        ::testing::ValuesIn(TRTest::const_values<uint16_t>()), ::testing::Values(ifxcmpgeReductionOracle<uint16_t>)));
...
INSTANTIATE_TEST_CASE_P(IfxcmpgeReductionTest, Int32ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int32_t>()),
        ::testing::ValuesIn(TRTest::const_values<int32_t>()), ::testing::Values(ifxcmpgeReductionOracle<int32_t>)));
...
INSTANTIATE_TEST_CASE_P(IfxcmpgeReductionTest, UInt32ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint32_t>()),
        ::testing::ValuesIn(TRTest::const_values<uint32_t>()), ::testing::Values(ifxcmpgeReductionOracle<uint32_t>)));
...
INSTANTIATE_TEST_CASE_P(IfxcmpgeReductionTest, Int64ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int64_t>()),
        ::testing::ValuesIn(TRTest::const_values<int64_t>()), ::testing::Values(ifxcmpgeReductionOracle<int64_t>)));
...
INSTANTIATE_TEST_CASE_P(IfxcmpgeReductionTest, UInt64ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint64_t>()),
        ::testing::ValuesIn(TRTest::const_values<uint64_t>()), ::testing::Values(ifxcmpgeReductionOracle<uint64_t>)));
