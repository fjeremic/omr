...
class IfxcmpgeReductionTest
    : public ::testing::TestWithParam<
          std::tuple<ValType, ValType, int32_t (*)(ValType, ValType)>> {
public:
  static void SetUpTestCase() {
    // Disable global value propagation and local common subexpression
    // elimination. Otherwise, the trees are optimized into nothing.
    const char *options =
 ...
 */
template <typename ValType> struct IfxcmpgeReductionParamStruct {
  ValType val1;
  ValType val2;
...
/** \brief
 *     Given an instance of IfxcmpgeReductionParamType, returns an equivalent
 * instance of IfxcmpgeReductionParamStruct.
 */
template <typename ValType>
IfxcmpgeReductionParamStruct<ValType>
to_struct(std::tuple<ValType, ValType, int32_t (*)(ValType, ValType)> param) {
...
/** \brief
 *     The oracle function which computes the expected result of the reduction
 * tests.
 *
 *  \tparam T
 *     The type of the parameters of the oracle function.
 */
template <typename T> static int32_t ifxcmpgeReductionOracle(T a, T b) {
  return (a & b) >= b;
}
...
INSTANTIATE_TEST_CASE_P(
    IfxcmpgeReductionTest, Int8ReductionTest,
...
INSTANTIATE_TEST_CASE_P(
    IfxcmpgeReductionTest, UInt8ReductionTest,
...
INSTANTIATE_TEST_CASE_P(
    IfxcmpgeReductionTest, Int16ReductionTest,
...
INSTANTIATE_TEST_CASE_P(
    IfxcmpgeReductionTest, UInt16ReductionTest,
...
INSTANTIATE_TEST_CASE_P(
    IfxcmpgeReductionTest, Int32ReductionTest,
...
INSTANTIATE_TEST_CASE_P(
    IfxcmpgeReductionTest, UInt32ReductionTest,
...
INSTANTIATE_TEST_CASE_P(
    IfxcmpgeReductionTest, Int64ReductionTest,
...
INSTANTIATE_TEST_CASE_P(
    IfxcmpgeReductionTest, UInt64ReductionTest,
    ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint64_t>()),
