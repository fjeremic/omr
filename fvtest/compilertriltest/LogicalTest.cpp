...
int32_t ineg(int32_t l) { return -l; }
...
int32_t ior(int32_t l, int32_t r) { return l | r; }

int32_t iand(int32_t l, int32_t r) { return l & r; }

int32_t ixor(int32_t l, int32_t r) { return l ^ r; }

int64_t lor(int64_t l, int64_t r) { return l | r; }

int64_t land(int64_t l, int64_t r) { return l & r; }

int64_t lxor(int64_t l, int64_t r) { return l ^ r; }

int64_t lneg(int64_t l) { return l == INT64_MIN ? INT64_MIN : -l; }
...
TEST_P(Int32LogicalUnary, UsingConst) {
  ...
  std::snprintf(inputTrees, 120,
                "(method return=Int32 (block (ireturn (%s (iconst %d) ) )))",
...
TEST_P(Int32LogicalUnary, UsingLoadParam) {
  ...
  char inputTrees[120] = {0};
  std::snprintf(inputTrees, 120,
                "(method return=Int32 args=[Int32] (block (ireturn (%s (iload "
                "parm=0) ) )))",
                param.opcode.c_str());
...
TEST_P(Int32LogicalBinary, UsingLoadParam) {
  ...
  char inputTrees[120] = {0};
  std::snprintf(inputTrees, 120,
                "(method return=Int32 args=[Int32, Int32] (block (ireturn (%s "
                "(iload parm=0) (iload parm=1)) )))",
                param.opcode.c_str());
...
INSTANTIATE_TEST_CASE_P(
    LogicalTest, Int32LogicalBinary,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_value_pairs<int32_t, int32_t>()),
        ::testing::Values(
            std::make_tuple<const char *, int32_t (*)(int32_t, int32_t)>("ior",
                                                                         ior),
            std::make_tuple<const char *, int32_t (*)(int32_t, int32_t)>("iand",
                                                                         iand),
...
INSTANTIATE_TEST_CASE_P(
    LogicalTest, Int64LogicalBinary,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_value_pairs<int64_t, int64_t>()),
        ::testing::Values(
            std::make_tuple<const char *, int64_t (*)(int64_t, int64_t)>("lor",
                                                                         lor),
            std::make_tuple<const char *, int64_t (*)(int64_t, int64_t)>("land",
                                                                         land),
