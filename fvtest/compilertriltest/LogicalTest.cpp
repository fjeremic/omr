...
INSTANTIATE_TEST_CASE_P(LogicalTest, Int32LogicalUnary, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int32_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int32_t)>("ineg", ineg), std::make_tuple<const char*, int32_t (*)(int32_t)>("iabs", iabs))));
...
INSTANTIATE_TEST_CASE_P(LogicalTest, Int32LogicalBinary, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int32_t, int32_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ior", ior), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("iand", iand), std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ixor", ixor))));
...
INSTANTIATE_TEST_CASE_P(LogicalTest, Int64LogicalBinary, ::testing::Combine(::testing::ValuesIn(TRTest::const_value_pairs<int64_t, int64_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lor", lor), std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("land", land), std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lxor", lxor))));
...
INSTANTIATE_TEST_CASE_P(LogicalTest, Int64LogicalUnary, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int64_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(int64_t)>("lneg", lneg))));
