...
int32_t
ior(int32_t l, int32_t r)
{
  return l | r;
}

int32_t
iand(int32_t l, int32_t r)
{
  return l & r;
}

int32_t
ixor(int32_t l, int32_t r)
{
  return l ^ r;
}

int64_t
lor(int64_t l, int64_t r)
{
  return l | r;
}

int64_t
land(int64_t l, int64_t r)
{
  return l & r;
}

int64_t
lxor(int64_t l, int64_t r)
{
  return l ^ r;
}
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      ...
      std::make_tuple<const char*, int32_t (*)(int32_t, int32_t)>("ixor",
                                                                  ixor))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(
      ...
      std::make_tuple<const char*, int64_t (*)(int64_t, int64_t)>("lxor",
                                                                  lxor))));
