...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int8ToInt32, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int8_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int8_t)>("b2i", b2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt8ToInt32, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint8_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(uint8_t)>("bu2i", bu2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int8ToInt64, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int8_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(int8_t)>("b2l", b2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt8ToInt64, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint8_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(uint8_t)>("bu2l", bu2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int16ToInt32, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int16_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int16_t)>("s2i", s2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt16ToInt32, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint16_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(uint16_t)>("su2i", su2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int16ToInt64, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int16_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(int16_t)>("s2l", s2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt16ToInt64, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint16_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(uint16_t)>("su2l", su2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int32ToInt64, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int32_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(int32_t)>("i2l", i2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt32ToInt64, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint32_t>()), ::testing::Values(std::make_tuple<const char*, int64_t (*)(uint32_t)>("iu2l", iu2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int64ToInt32, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int64_t>()), ::testing::Values(std::make_tuple<const char*, int32_t (*)(int64_t)>("l2i", l2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int32ToFloat, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int32_t>()), ::testing::Values(std::make_tuple<const char*, float (*)(int32_t)>("i2f", i2f))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int64ToFloat, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int64_t>()), ::testing::Values(std::make_tuple<const char*, float (*)(int64_t)>("l2f", l2f))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int32ToDouble, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int32_t>()), ::testing::Values(std::make_tuple<const char*, double (*)(int32_t)>("i2d", i2d))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int64ToDouble, ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int64_t>()), ::testing::Values(std::make_tuple<const char*, double (*)(int64_t)>("l2d", l2d))));
#endif
...
bool fp_filter(F a)
{
    ...
    return (std::abs(a) < 0.01 && a != 0.0) || (a > static_cast<F>(std::numeric_limits<I>::max())) || (a < static_cast<F>(std::numeric_limits<I>::min()));
}
...
TEST_P(FloatToInt32, UsingLoadParam)
{
    ...
    char* inputTrees = "(method return=Int32 args=[Float]"
                       "  (block"
                       "    (ireturn"
                       "      (f2i"
                       "        (fload parm=0) ) ) ) )";
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, FloatToInt32, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(), fp_filter<float, int32_t>)), ::testing::Values(std::make_tuple<const char*, int32_t (*)(float)>("f2i", f2i))));
...
TEST_P(FloatToInt64, UsingLoadParam)
{
    ...
    char* inputTrees = "(method return=Int64 args=[Float]"
                       "  (block"
                       "    (lreturn"
                       "      (f2l"
                       "        (fload parm=0) ) ) ) )";
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, FloatToInt64, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(), fp_filter<float, int64_t>)), ::testing::Values(std::make_tuple<const char*, int64_t (*)(float)>("f2l", f2l))));
...
TEST_P(DoubleToInt32, UsingLoadParam)
{
    ...
    char* inputTrees = "(method return=Int32 args=[Double]"
                       "  (block"
                       "    (ireturn"
                       "      (d2i"
                       "        (dload parm=0) ) ) ) )";
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, DoubleToInt32, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(), fp_filter<double, int32_t>)), ::testing::Values(std::make_tuple<const char*, int32_t (*)(double)>("d2i", d2i))));
...
TEST_P(DoubleToInt64, UsingLoadParam)
{
    ...
    char* inputTrees = "(method return=Int64 args=[Double]"
                       "  (block"
                       "    (lreturn"
                       "      (d2l"
                       "        (dload parm=0) ) ) ) )";
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, DoubleToInt64, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(), fp_filter<double, int64_t>)), ::testing::Values(std::make_tuple<const char*, int64_t (*)(double)>("d2l", d2l))));
...
TEST_P(FloatToDouble, UsingLoadParam)
{
    ...
    char* inputTrees = "(method return=Double args=[Float]"
                       "  (block"
                       "    (dreturn"
                       "      (f2d"
                       "        (fload parm=0) ) ) ) )";
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, FloatToDouble, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(), smallFp_filter<float>)), ::testing::Values(std::make_tuple<const char*, double (*)(float)>("f2d", f2d))));
...
TEST_P(DoubleToFloat, UsingLoadParam)
{
    ...
    char* inputTrees = "(method return=Float args=[Double]"
                       "  (block"
                       "    (freturn"
                       "      (d2f"
                       "        (dload parm=0) ) ) ) )";
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, DoubleToFloat, ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(), smallFp_filter<double>)), ::testing::Values(std::make_tuple<const char*, float (*)(double)>("d2f", d2f))));
...
TEST_P(FloatNormalizeNan, UsingLoadIndirect)
{
    ...
    char* inputTrees = "(method return=Int32 args=[Address]"
                       "  (block"
                       "    (ireturn"
...
TEST_P(FloatNormalizeNan, UsingLoadParam)
{
    ...
    char* inputTrees = "(method return=Int32 args=[Int32]"
                       "  (block"
                       "    (ireturn"
                       "      (fbits2i flags=[15]" // FLAG: mustNormalizeNanValues
                       "        (ibits2f"
...
TEST_P(DoubleNormalizeNan, UsingLoadIndirect)
{
    ...
    char* inputTrees = "(method return=Int64 args=[Address]"
                       "  (block"
                       "    (lreturn"
...
TEST_P(DoubleNormalizeNan, UsingLoadParam)
{
    ...
    char* inputTrees = "(method return=Int64 args=[Int64]"
                       "  (block"
                       "    (lreturn"
                       "      (dbits2l flags=[15]" // FLAG: mustNormalizeNanValues
                       "        (lbits2d"
