...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int8ToInt32,
    ::testing::Combine(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, UInt8ToInt32,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<uint8_t>()),
        ::testing::Values(std::make_tuple<const char *, int32_t (*)(uint8_t)>(
            "bu2i", bu2i))));
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int8ToInt64,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<int8_t>()),
        ::testing::Values(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, UInt8ToInt64,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<uint8_t>()),
        ::testing::Values(std::make_tuple<const char *, int64_t (*)(uint8_t)>(
            "bu2l", bu2l))));
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int16ToInt32,
    ::testing::Combine(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, UInt16ToInt32,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<uint16_t>()),
        ::testing::Values(std::make_tuple<const char *, int32_t (*)(uint16_t)>(
            "su2i", su2i))));
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int16ToInt64,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<int16_t>()),
        ::testing::Values(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, UInt16ToInt64,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<uint16_t>()),
        ::testing::Values(std::make_tuple<const char *, int64_t (*)(uint16_t)>(
            "su2l", su2l))));
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int32ToInt64,
    ::testing::Combine(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, UInt32ToInt64,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<uint32_t>()),
        ::testing::Values(std::make_tuple<const char *, int64_t (*)(uint32_t)>(
            "iu2l", iu2l))));
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int64ToInt32,
    ::testing::Combine(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int32ToFloat,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<int32_t>()),
        ::testing::Values(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int64ToFloat,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<int64_t>()),
        ::testing::Values(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int32ToDouble,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<int32_t>()),
        ::testing::Values(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, Int64ToDouble,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::const_values<int64_t>()),
        ::testing::Values(
...
template <typename F, typename I> bool fp_filter(F a) {
  // workaround: avoid failure caused by snprintf("%f") or potential undefined
  // behaviour
...
int32_t f2i(float x) { return static_cast<int32_t>(x); }

int64_t f2l(float x) { return static_cast<int64_t>(x); }

int32_t d2i(double x) { return static_cast<int32_t>(x); }

int64_t d2l(double x) { return static_cast<int64_t>(x); }
...
TEST_P(FloatToInt32, UsingConst) {
  ...
  std::string arch = omrsysinfo_get_CPU_architecture();
  SKIP_IF(
      (param.value <= static_cast<float>(std::numeric_limits<int32_t>::min()) ||
       param.value >=
           static_cast<float>(std::numeric_limits<int32_t>::max())) &&
          (OMRPORT_ARCH_HAMMER == arch),
      KnownBug)
      << "f2i test behaves unexpectedly on x86-64 with certain high input "
         "values (see issue #3602)";
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, FloatToInt64,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(),
                                           fp_filter<float, int64_t>)),
        ::testing::Values(
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, DoubleToInt64,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(),
                                           fp_filter<double, int64_t>)),
        ::testing::Values(
            std::make_tuple<const char *, int64_t (*)(double)>("d2l", d2l))));

template <typename T> bool smallFp_filter(T a) {
  // workaround: avoid failure caused by snprintf("%f")
  return (std::abs(a) < 0.01 && a != 0.0);
}

double f2d(float x) { return static_cast<double>(x); }

float d2f(double x) { return static_cast<float>(x); }
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, FloatToDouble,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(),
...
INSTANTIATE_TEST_CASE_P(
    TypeConversionTest, DoubleToFloat,
    ::testing::Combine(
        ::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(),
...
template <typename T>
class NormalizeNanTest : public TRTest::JitTest,
...
TEST_P(FloatNormalizeNan, UsingLoadIndirect) {
  std::string arch = omrsysinfo_get_CPU_architecture();
  SKIP_IF(OMRPORT_ARCH_S390 == arch || OMRPORT_ARCH_S390X == arch, KnownBug)
      << "The Z code generator crashes when specifying the "
         "mustNormalizeNanValues flag (see issue #4381)";
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, FloatNormalizeNan,
                        ::testing::ValuesIn(normalize_fnan_values()));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, DoubleNormalizeNan,
                        ::testing::ValuesIn(normalize_dnan_values()));
