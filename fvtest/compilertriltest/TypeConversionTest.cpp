...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int8ToInt32,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int8_t>()),
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(int8_t)>("b2i", b2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt8ToInt32,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint8_t>()),
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(uint8_t)>("bu2i", bu2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int8ToInt64,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int8_t>()),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(int8_t)>("b2l", b2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt8ToInt64,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint8_t>()),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(uint8_t)>("bu2l", bu2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int16ToInt32,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int16_t>()),
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(int16_t)>("s2i", s2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt16ToInt32,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint16_t>()),
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(uint16_t)>("su2i", su2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int16ToInt64,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int16_t>()),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(int16_t)>("s2l", s2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt16ToInt64,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint16_t>()),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(uint16_t)>("su2l", su2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int32ToInt64,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int32_t>()),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(int32_t)>("i2l", i2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, UInt32ToInt64,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<uint32_t>()),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(uint32_t)>("iu2l", iu2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int64ToInt32,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int64_t>()),
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(int64_t)>("l2i", l2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int32ToFloat,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int32_t>()),
    ::testing::Values(std::make_tuple<const char*, float (*)(int32_t)>("i2f", i2f))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int64ToFloat,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int64_t>()),
    ::testing::Values(std::make_tuple<const char*, float (*)(int64_t)>("l2f", l2f))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int32ToDouble,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int32_t>()),
    ::testing::Values(std::make_tuple<const char*, double (*)(int32_t)>("i2d", i2d))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, Int64ToDouble,
  ::testing::Combine(::testing::ValuesIn(TRTest::const_values<int64_t>()),
    ::testing::Values(std::make_tuple<const char*, double (*)(int64_t)>("l2d", l2d))));
#endif
...
bool fp_filter(F a)
{
  ...
  return (std::abs(a) < 0.01 && a != 0.0) || (a > static_cast<F>(std::numeric_limits<I>::max()))
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, FloatToInt32,
  ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(), fp_filter<float, int32_t>)),
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(float)>("f2i", f2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, FloatToInt64,
  ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(), fp_filter<float, int64_t>)),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(float)>("f2l", f2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, DoubleToInt32,
  ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(), fp_filter<double, int32_t>)),
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(double)>("d2i", d2i))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, DoubleToInt64,
  ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(), fp_filter<double, int64_t>)),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(double)>("d2l", d2l))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, FloatToDouble,
  ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<float>(), smallFp_filter<float>)),
    ::testing::Values(std::make_tuple<const char*, double (*)(float)>("f2d", f2d))));
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest, DoubleToFloat,
  ::testing::Combine(::testing::ValuesIn(TRTest::filter(TRTest::const_values<double>(), smallFp_filter<double>)),
    ::testing::Values(std::make_tuple<const char*, float (*)(double)>("d2f", d2f))));
