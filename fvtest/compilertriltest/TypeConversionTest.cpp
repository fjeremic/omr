...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(int8_t)>("b2i",
                                                                        b2i))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ::testing::ValuesIn(TRTest::const_values<int8_t>()),
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(int8_t)>("b2l",
                                                                        b2l))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ::testing::ValuesIn(TRTest::const_values<int32_t>()),
    ::testing::Values(std::make_tuple<const char*, float (*)(int32_t)>("i2f",
                                                                       i2f))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ::testing::ValuesIn(TRTest::const_values<int64_t>()),
    ::testing::Values(std::make_tuple<const char*, float (*)(int64_t)>("l2f",
                                                                       l2f))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ::testing::ValuesIn(TRTest::const_values<int32_t>()),
    ::testing::Values(std::make_tuple<const char*, double (*)(int32_t)>("i2d",
                                                                        i2d))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ::testing::ValuesIn(TRTest::const_values<int64_t>()),
    ::testing::Values(std::make_tuple<const char*, double (*)(int64_t)>("l2d",
                                                                        l2d))));
#endif
...
TEST_P(FloatToInt32, UsingConst)
{
  ...
  SKIP_IF(
    ...
    KnownBug)
    << "f2i test behaves unexpectedly on x86-64 with certain high input values "
       "(see issue #3602)";
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(float)>("f2i",
                                                                       f2i))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(float)>("f2l",
                                                                       f2l))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, int32_t (*)(double)>("d2i",
                                                                        d2i))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, int64_t (*)(double)>("d2l",
                                                                        d2l))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, double (*)(float)>("f2d",
                                                                      f2d))));
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Combine(
    ...
    ::testing::Values(std::make_tuple<const char*, float (*)(double)>("d2f",
                                                                      d2f))));

static std::vector<uint32_t>
normalize_fnan_values()
{
  uint32_t inputArray[] = {
    0,
    0x3F800000u, // 1.0
...
INSTANTIATE_TEST_CASE_P(TypeConversionTest,
                        FloatNormalizeNan,
