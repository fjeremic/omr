...
const char *ResolvedMethod::signature(TR_Memory *trMemory,
...
char *ResolvedMethod::localName(uint32_t slot, uint32_t bcIndex,
                                int32_t &nameLength, TR_Memory *trMemory) {
  char *name = NULL;
...
TR::DataType ResolvedMethod::returnType() {
  return _returnType->getPrimitiveType();
}

char *ResolvedMethod::getParameterTypeSignature(int32_t parmIndex) {
