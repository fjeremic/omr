...
void
FrontEnd::reserveTrampolineIfNecessary(TR::Compilation* comp,
...
TR_ResolvedMethod*
FrontEnd::createResolvedMethod(TR_Memory* trMemory,
...
intptrj_t
FrontEnd::methodTrampolineLookup(TR::Compilation* comp,
                                 TR::SymbolReference* symRef,
                                 void* callSite)
{
  TR_UNIMPLEMENTED();
