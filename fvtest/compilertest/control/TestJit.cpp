...
static void initializeAllHelpers(
  TestCompiler::JitConfig* jitConfig, TR_RuntimeHelper* helperIDs, void** helperAddresses, int32_t numHelpers)
{
...
static void initializeCodeCache(TR::CodeCacheManager& codeCacheManager)
{
  ...
  // setupCodeCacheParameters must stay before TestCompiler::CodeCacheManager::initialize() because it needs
  // trampolineCodeSize
...
extern "C" uint8_t* compileMethod(TR::IlGeneratorMethodDetails& details, TR_Hotness hotness, int32_t& rc)
{
