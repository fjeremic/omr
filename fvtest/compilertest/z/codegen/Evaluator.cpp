...
void TR_Debug::print(TR::FILE *pOutFile, TR::S390RestoreGPR7Snippet *snippet) {
  TR_UNIMPLEMENTED();
}

void TestCompiler::FrontEnd::generateBinaryEncodingPrologue(
    TR_BinaryEncodingData *beData, TR::CodeGenerator *cg) {
