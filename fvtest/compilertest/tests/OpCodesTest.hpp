...
typedef uintptrj_t(signatureCharILL_L_testMethodType)(int32_t,
                                                      uintptrj_t,
                                                      uintptrj_t);
...
class OpCodesTest : public TestDriver {
 public:
  ...
  template <typename functiontype>
  int32_t compileDirectCallOpCodeMethod(functiontype& resultpointer,
                                        int32_t opCodeArgsNum,
    ...
    switch (returnType) {
      ...
      case TR::Double:
        ...
        _doubleCompiledMethod =
            (signatureCharD_D_testMethodType*)(compileMethod(functionDetails,
                                                             warm, returnCode));
  ...
  void addUnsupportedOpCodeTest(int32_t opCodeArgsNum,
                                TR::ILOpCodes opCode,
                                char* resolvedMethodName,
                                TR::DataType* argTypes,
                                TR::DataType returnType);
