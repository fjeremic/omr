...
extern "C" uint8_t* compileMethod(TR::IlGeneratorMethodDetails&,
                                  TR_Hotness,
                                  int32_t&);
...
TR::DataType OpCodesTest::_argTypesUnaryDouble[_numberOfUnaryArgs] = {
    TR::Double};
TR::DataType OpCodesTest::_argTypesUnaryAddress[_numberOfUnaryArgs] = {
    TR::Address};

TR::DataType OpCodesTest::_argTypesBinaryByte[_numberOfBinaryArgs] = {TR::Int8,
                                                                      TR::Int8};
TR::DataType OpCodesTest::_argTypesBinaryShort[_numberOfBinaryArgs] = {
    TR::Int16, TR::Int16};
TR::DataType OpCodesTest::_argTypesBinaryInt[_numberOfBinaryArgs] = {TR::Int32,
                                                                     TR::Int32};
TR::DataType OpCodesTest::_argTypesBinaryLong[_numberOfBinaryArgs] = {
    TR::Int64, TR::Int64};
TR::DataType OpCodesTest::_argTypesBinaryFloat[_numberOfBinaryArgs] = {
    TR::Float, TR::Float};
TR::DataType OpCodesTest::_argTypesBinaryDouble[_numberOfBinaryArgs] = {
    TR::Double, TR::Double};
TR::DataType OpCodesTest::_argTypesBinaryAddress[_numberOfBinaryArgs] = {
    TR::Address, TR::Address};

TR::DataType OpCodesTest::_argTypesTernaryByte[_numberOfTernaryArgs] = {
    TR::Int32, TR::Int8, TR::Int8};
TR::DataType OpCodesTest::_argTypesTernaryShort[_numberOfTernaryArgs] = {
    TR::Int32, TR::Int16, TR::Int16};
TR::DataType OpCodesTest::_argTypesTernaryInt[_numberOfTernaryArgs] = {
    TR::Int32, TR::Int32, TR::Int32};
TR::DataType OpCodesTest::_argTypesTernaryLong[_numberOfTernaryArgs] = {
    TR::Int32, TR::Int64, TR::Int64};
TR::DataType OpCodesTest::_argTypesTernaryFloat[_numberOfTernaryArgs] = {
    TR::Int32, TR::Float, TR::Float};
TR::DataType OpCodesTest::_argTypesTernaryDouble[_numberOfTernaryArgs] = {
    TR::Int32, TR::Double, TR::Double};
TR::DataType OpCodesTest::_argTypesTernaryAddress[_numberOfTernaryArgs] = {
    TR::Int32, TR::Address, TR::Address};

TR::DataType OpCodesTest::_argTypesBinaryAddressByte[_numberOfBinaryArgs] = {
    TR::Address, TR::Int8};
TR::DataType OpCodesTest::_argTypesBinaryAddressShort[_numberOfBinaryArgs] = {
    TR::Address, TR::Int16};
TR::DataType OpCodesTest::_argTypesBinaryAddressInt[_numberOfBinaryArgs] = {
    TR::Address, TR::Int32};
TR::DataType OpCodesTest::_argTypesBinaryAddressLong[_numberOfBinaryArgs] = {
    TR::Address, TR::Int64};
TR::DataType OpCodesTest::_argTypesBinaryAddressFloat[_numberOfBinaryArgs] = {
    TR::Address, TR::Float};
TR::DataType OpCodesTest::_argTypesBinaryAddressDouble[_numberOfBinaryArgs] = {
    TR::Address, TR::Double};
TR::DataType OpCodesTest::_argTypesBinaryAddressAddress[_numberOfBinaryArgs] = {
    TR::Address, TR::Address};
...
void OpCodesTest::compileTestMethods() {}

void OpCodesTest::addUnsupportedOpCodeTest(int32_t opCodeArgsNum,
                                           TR::ILOpCodes opCode,
  ...
  compileOpCodeMethod(never_succeeds, opCodeArgsNum, opCode, resolvedMethodName,
                      argTypes, returnType, returnCode);
  EXPECT_TRUE(COMPILATION_IL_GEN_FAILURE == returnCode ||
              COMPILATION_REQUESTED == returnCode)
      << resolvedMethodName << " is " << returnCode << ", expected is 0 or "
      << COMPILATION_IL_GEN_FAILURE;
}

TR::ResolvedMethod* OpCodesTest::resolvedMethod(TR::DataType dataType) {
  switch (dataType) {
    case TR::Int32:
    ...
    default:
      TR_ASSERT(
          0,
          "compilee dataType should be int32, in64, double, float or address");
      return NULL;
  }
}

void OpCodesTest::compileIntegerArithmeticTestMethods() {
  int32_t rc = 0;
  compileOpCodeMethod(_iAdd, _numberOfBinaryArgs, TR::iadd, "iAdd",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iSub, _numberOfBinaryArgs, TR::isub, "iSub",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iDiv, _numberOfBinaryArgs, TR::idiv, "iDiv",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iMul, _numberOfBinaryArgs, TR::imul, "iMul",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iMulh, _numberOfBinaryArgs, TR::imulh, "iMulh",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iRem, _numberOfBinaryArgs, TR::irem, "iRem",
                      _argTypesBinaryInt, TR::Int32, rc);
}

void OpCodesTest::compileMemoryOperationTestMethods() {
  int32_t rc = 0;

  compileOpCodeMethod(_iLoad, _numberOfUnaryArgs, TR::iload, "iLoad",
                      _argTypesUnaryInt, TR::Int32, rc);
  compileOpCodeMethod(_lLoad, _numberOfUnaryArgs, TR::lload, "lLoad",
                      _argTypesUnaryLong, TR::Int64, rc);
  compileOpCodeMethod(_dLoad, _numberOfUnaryArgs, TR::dload, "dLoad",
                      _argTypesUnaryDouble, TR::Double, rc);
  compileOpCodeMethod(_fLoad, _numberOfUnaryArgs, TR::fload, "fLoad",
                      _argTypesUnaryFloat, TR::Float, rc);

  compileOpCodeMethod(_iStore, _numberOfUnaryArgs, TR::istore, "iStore",
                      _argTypesUnaryInt, TR::Int32, rc);

  compileOpCodeMethod(_iLoadi, _numberOfUnaryArgs, TR::iloadi, "iLoadi",
                      _argTypesUnaryAddress, TR::Int32, rc);
  compileOpCodeMethod(_lLoadi, _numberOfUnaryArgs, TR::lloadi, "lLoadi",
                      _argTypesUnaryAddress, TR::Int64, rc);
  compileOpCodeMethod(_dLoadi, _numberOfUnaryArgs, TR::dloadi, "dLoadi",
                      _argTypesUnaryAddress, TR::Double, rc);
  compileOpCodeMethod(_fLoadi, _numberOfUnaryArgs, TR::floadi, "fLoadi",
                      _argTypesUnaryAddress, TR::Float, rc);
  compileOpCodeMethod(_bLoadi, _numberOfUnaryArgs, TR::bloadi, "bLoadi",
                      _argTypesUnaryAddress, TR::Int8, rc);
  compileOpCodeMethod(_sLoadi, _numberOfUnaryArgs, TR::sloadi, "sLoadi",
                      _argTypesUnaryAddress, TR::Int16, rc);
  compileOpCodeMethod(_aLoadi, _numberOfUnaryArgs, TR::aloadi, "aLoadi",
                      _argTypesUnaryAddress, TR::Address, rc);
}

void OpCodesTest::compileUnaryTestMethods() {
  int32_t rc = 0;

  compileOpCodeMethod(_iNeg, _numberOfUnaryArgs, TR::ineg, "iNeg",
                      _argTypesUnaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iAbs, _numberOfUnaryArgs, TR::iabs, "iAbs",
                      _argTypesUnaryInt, TR::Int32, rc);

  compileOpCodeMethod(_iReturn, _numberOfUnaryArgs, TR::ireturn, "iReturn",
                      _argTypesUnaryInt, TR::Int32, rc);

  compileOpCodeMethod(_i2l, _numberOfUnaryArgs, TR::i2l, "i2l",
                      _argTypesUnaryInt, TR::Int64, rc);
  compileOpCodeMethod(_i2b, _numberOfUnaryArgs, TR::i2b, "i2b",
                      _argTypesUnaryInt, TR::Int8, rc);
  compileOpCodeMethod(_i2s, _numberOfUnaryArgs, TR::i2s, "i2s",
                      _argTypesUnaryInt, TR::Int16, rc);

  compileOpCodeMethod(_l2i, _numberOfUnaryArgs, TR::l2i, "l2i",
                      _argTypesUnaryLong, TR::Int32, rc);
  compileOpCodeMethod(_l2b, _numberOfUnaryArgs, TR::l2b, "l2b",
                      _argTypesUnaryLong, TR::Int8, rc);
  compileOpCodeMethod(_l2s, _numberOfUnaryArgs, TR::l2s, "l2s",
                      _argTypesUnaryLong, TR::Int16, rc);

  compileOpCodeMethod(_f2i, _numberOfUnaryArgs, TR::f2i, "f2i",
                      _argTypesUnaryFloat, TR::Int32, rc);
  compileOpCodeMethod(_d2i, _numberOfUnaryArgs, TR::d2i, "d2i",
                      _argTypesUnaryDouble, TR::Int32, rc);
}

void OpCodesTest::compileBitwiseMethods() {
  int32_t rc;

  compileOpCodeMethod(_iAnd, _numberOfBinaryArgs, TR::iand, "iAnd",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iOr, _numberOfBinaryArgs, TR::ior, "iOr",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iXor, _numberOfBinaryArgs, TR::ixor, "iXor",
                      _argTypesBinaryInt, TR::Int32, rc);
}

void OpCodesTest::compileCompareTestMethods() {
  int32_t rc = 0;

  // Compare
  compileOpCodeMethod(_iCmpeq, _numberOfBinaryArgs, TR::icmpeq, "iCmpeq",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iCmpne, _numberOfBinaryArgs, TR::icmpne, "iCmpne",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iCmpgt, _numberOfBinaryArgs, TR::icmpgt, "iCmpgt",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iCmplt, _numberOfBinaryArgs, TR::icmplt, "iCmplt",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iCmpge, _numberOfBinaryArgs, TR::icmpge, "iCmpge",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iCmple, _numberOfBinaryArgs, TR::icmple, "iCmple",
                      _argTypesBinaryInt, TR::Int32, rc);

  compileOpCodeMethod(_lCmpne, _numberOfBinaryArgs, TR::lcmpne, "lCmpne",
                      _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_lCmpgt, _numberOfBinaryArgs, TR::lcmpgt, "lCmpgt",
                      _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_lCmpge, _numberOfBinaryArgs, TR::lcmpge, "lCmpge",
                      _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_lCmple, _numberOfBinaryArgs, TR::lcmple, "lCmple",
                      _argTypesBinaryLong, TR::Int32, rc);

  compileOpCodeMethod(_iuCmplt, _numberOfBinaryArgs, TR::iucmplt, "iuCmplt",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iuCmpgt, _numberOfBinaryArgs, TR::iucmpgt, "iuCmpgt",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_iuCmple, _numberOfBinaryArgs, TR::iucmple, "iuCmple",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_luCmplt, _numberOfBinaryArgs, TR::lucmplt, "luCmplt",
                      _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_luCmpge, _numberOfBinaryArgs, TR::lucmpge, "luCmpge",
                      _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_luCmpgt, _numberOfBinaryArgs, TR::lucmpgt, "luCmpgt",
                      _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_luCmple, _numberOfBinaryArgs, TR::lucmple, "luCmple",
                      _argTypesBinaryLong, TR::Int32, rc);

  // CompareAndBranch
  compileOpCodeMethod(_ifIcmpeq, _numberOfBinaryArgs, TR::ificmpeq, "ifIcmpeq",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifIcmpne, _numberOfBinaryArgs, TR::ificmpne, "ifIcmpne",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifIcmpgt, _numberOfBinaryArgs, TR::ificmpgt, "ifIcmpgt",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifIcmplt, _numberOfBinaryArgs, TR::ificmplt, "ifIcmplt",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifIcmpge, _numberOfBinaryArgs, TR::ificmpge, "ifIcmpge",
                      _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifIcmple, _numberOfBinaryArgs, TR::ificmple, "ifIcmple",
                      _argTypesBinaryInt, TR::Int32, rc);

  compileOpCodeMethod(_ifLcmpne, _numberOfBinaryArgs, TR::iflcmpne, "ifLcmpne",
                      _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_ifLcmpge, _numberOfBinaryArgs, TR::iflcmpge, "ifLcmpge",
                      _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_ifLcmple, _numberOfBinaryArgs, TR::iflcmple, "ifLcmple",
                      _argTypesBinaryLong, TR::Int32, rc);

  compileOpCodeMethod(_ifIuCmplt, _numberOfBinaryArgs, TR::ifiucmplt,
                      "ifIuCmplt", _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifIuCmpge, _numberOfBinaryArgs, TR::ifiucmpge,
                      "ifIuCmpge", _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifIuCmpgt, _numberOfBinaryArgs, TR::ifiucmpgt,
                      "ifIuCmpgt", _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifIuCmple, _numberOfBinaryArgs, TR::ifiucmple,
                      "ifIuCmple", _argTypesBinaryInt, TR::Int32, rc);
  compileOpCodeMethod(_ifLuCmplt, _numberOfBinaryArgs, TR::iflucmplt,
                      "ifLuCmplt", _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_ifLuCmpge, _numberOfBinaryArgs, TR::iflucmpge,
                      "ifLuCmpge", _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_ifLuCmpgt, _numberOfBinaryArgs, TR::iflucmpgt,
                      "ifLuCmpgt", _argTypesBinaryLong, TR::Int32, rc);
  compileOpCodeMethod(_ifLuCmple, _numberOfBinaryArgs, TR::iflucmple,
                      "ifLuCmple", _argTypesBinaryLong, TR::Int32, rc);
}

void OpCodesTest::compileTernaryTestMethods() {
  int32_t rc = 0;

  compileOpCodeMethod(_iternary, _numberOfTernaryArgs, TR::iternary, "iTernary",
                      _argTypesTernaryInt, TR::Int32, rc);
}

void OpCodesTest::compileAddressTestMethods() {
  int32_t rc = 0;

  compileOpCodeMethod(_aload, _numberOfUnaryArgs, TR::aload, "aload",
                      _argTypesUnaryAddress, TR::Address, rc);
  compileOpCodeMethod(_astore, _numberOfUnaryArgs, TR::astore, "astore",
                      _argTypesUnaryAddress, TR::Address, rc);
  compileOpCodeMethod(_areturn, _numberOfUnaryArgs, TR::areturn, "areturn",
                      _argTypesUnaryAddress, TR::Address, rc);
  compileOpCodeMethod(_a2i, _numberOfUnaryArgs, TR::a2i, "a2i",
                      _argTypesUnaryAddress, TR::Int32, rc);
}

void OpCodesTest::compileDisabledOpCodesTests() {
  int32_t rc = 0;
  // Jazz103 Work item 110364
  compileOpCodeMethod(_fRem, _numberOfBinaryArgs, TR::frem, "fRem",
                      _argTypesBinaryFloat, TR::Float, rc);
  compileOpCodeMethod(_dRem, _numberOfBinaryArgs, TR::drem, "dRem",
                      _argTypesBinaryDouble, TR::Double, rc);
}

void OpCodesTest::invokeTests() {}

void OpCodesTest::invokeIntegerArithmeticTests() {
  // TR::Int32
  int32_t rc = 0;
  ...
  int32_t intAddArr[][2] = {INT_ZERO,    INT_ZERO,   INT_NEG,     INT_NEG,
                            INT_MINIMUM, INT_POS,    INT_MAXIMUM, INT_MAXIMUM,
                            INT_POS,     INT_MINIMUM};
  int32_t intSubArr[][2] = {INT_MAXIMUM, INT_MINIMUM, INT_NEG,  INT_POS,
                            INT_POS,     INT_MAXIMUM, INT_ZERO, INT_NEG,
                            INT_MINIMUM, INT_ZERO};
  int32_t intMulArr[][2] = {INT_NEG,     INT_MINIMUM, INT_ZERO,    INT_POS,
                            INT_MINIMUM, INT_NEG,     INT_POS,     INT_ZERO,
                            INT_MAXIMUM, INT_MINIMUM, INT_MINIMUM, INT_MAXIMUM};
  int32_t intDivArr[][2] = {INT_NEG,     INT_MAXIMUM, INT_POS,  INT_POS,
                            INT_MAXIMUM, INT_NEG,     INT_ZERO, INT_MINIMUM};
  int32_t intRemArr[][2] = {INT_MINIMUM, INT_MINIMUM, INT_ZERO,    INT_MAXIMUM,
                            INT_POS,     INT_NEG,     INT_MAXIMUM, INT_POS};

  // iadd
  testCaseArrLength = sizeof(intAddArr) / sizeof(intAddArr[0]);
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    OMR_CT_EXPECT_EQ(_iAdd, add(intAddArr[i][0], intAddArr[i][1]),
                     _iAdd(intAddArr[i][0], intAddArr[i][1]));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::iadd,
                        ...
                        4, 1, &intAddArr[i][0], 2, &intAddArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, add(intAddArr[i][0], intAddArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::iadd,
                        ...
                        2, 1, &intAddArr[i][0]);
    OMR_CT_EXPECT_EQ(iBinaryCons, add(intAddArr[i][0], intAddArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, intAddArr[i][1]));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::iadd,
                        ...
                        2, 2, &intAddArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, add(intAddArr[i][0], intAddArr[i][1]),
                     iBinaryCons(intAddArr[i][0], INT_PLACEHOLDER_2));
  }

  // isub
  testCaseArrLength = sizeof(intSubArr) / sizeof(intSubArr[0]);
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    OMR_CT_EXPECT_EQ(_iSub, sub(intSubArr[i][0], intSubArr[i][1]),
                     _iSub(intSubArr[i][0], intSubArr[i][1]));

    sprintf(resolvedMethodName, "iSubConst1_Testcase%d", i);
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::isub,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &intSubArr[i][0], 2, &intSubArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, sub(intSubArr[i][0], intSubArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::isub,
                        ...
                        2, 1, &intSubArr[i][0]);
    OMR_CT_EXPECT_EQ(iBinaryCons, sub(intSubArr[i][0], intSubArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, intSubArr[i][1]));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::isub,
                        ...
                        2, 2, &intSubArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, sub(intSubArr[i][0], intSubArr[i][1]),
                     iBinaryCons(intSubArr[i][0], INT_PLACEHOLDER_2));
  }

  // imul
  testCaseArrLength = sizeof(intMulArr) / sizeof(intMulArr[0]);
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    OMR_CT_EXPECT_EQ(_iMul, mul(intMulArr[i][0], intMulArr[i][1]),
                     _iMul(intMulArr[i][0], intMulArr[i][1]));

    sprintf(resolvedMethodName, "iMulConst1_Testcase%d", i);
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::imul,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &intMulArr[i][0], 2, &intMulArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, mul(intMulArr[i][0], intMulArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::imul,
                        ...
                        2, 1, &intMulArr[i][0]);
    OMR_CT_EXPECT_EQ(iBinaryCons, mul(intMulArr[i][0], intMulArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, intMulArr[i][1]));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::imul,
                        ...
                        2, 2, &intMulArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, mul(intMulArr[i][0], intMulArr[i][1]),
                     iBinaryCons(intMulArr[i][0], INT_PLACEHOLDER_2));
  }

  // imulh
  testCaseArrLength = sizeof(intMulArr) / sizeof(intMulArr[0]);
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    OMR_CT_EXPECT_EQ(_iMulh, imulh(intMulArr[i][0], intMulArr[i][1]),
                     _iMulh(intMulArr[i][0], intMulArr[i][1]));

    sprintf(resolvedMethodName, "iMulhConst1_Testcase%d", i);
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::imulh,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &intMulArr[i][0], 2, &intMulArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, imulh(intMulArr[i][0], intMulArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
  ...
  // idiv
  // TODO: Use ASSERT_DEATH() to catch Divide by zero which will get "Floating
  // point exception (core dumped)" Test secnario : _iDiv(INT_MIN, 0)
  testCaseArrLength = sizeof(intDivArr) / sizeof(intDivArr[0]);
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    OMR_CT_EXPECT_EQ(_iDiv, div(intDivArr[i][0], intDivArr[i][1]),
                     _iDiv(intDivArr[i][0], intDivArr[i][1]));

    sprintf(resolvedMethodName, "iDivConst1_Testcase%d", i);
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::idiv,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &intDivArr[i][0], 2, &intDivArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, div(intDivArr[i][0], intDivArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::idiv,
                        ...
                        2, 1, &intDivArr[i][0]);
    OMR_CT_EXPECT_EQ(iBinaryCons, div(intDivArr[i][0], intDivArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, intDivArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::irem,
                        ...
                        2, 1, &intRemArr[i][0]);
    OMR_CT_EXPECT_EQ(iBinaryCons, rem(intRemArr[i][0], intRemArr[i][1]),
                     iBinaryCons(INT_PLACEHOLDER_1, intRemArr[i][1]));
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::irem,
                        ...
                        2, 2, &intRemArr[i][1]);
    OMR_CT_EXPECT_EQ(iBinaryCons, rem(intRemArr[i][0], intRemArr[i][1]),
                     iBinaryCons(intRemArr[i][0], INT_PLACEHOLDER_2));
  }
}

void OpCodesTest::invokeMemoryOperationTests() {
  // iload
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iMemCons, _numberOfUnaryArgs, TR::istore,
  ...
  testCaseNum = sizeof(intDataArray) / sizeof(intDataArray[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_iLoadi, intDataArray[i],
                     _iLoadi((uintptrj_t)(&intDataArray[i])));
  }

  testCaseNum = sizeof(shortDataArray) / sizeof(shortDataArray[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_sLoadi, shortDataArray[i],
                     _sLoadi((uintptrj_t)(&shortDataArray[i])));
  }

  testCaseNum = sizeof(byteDataArray) / sizeof(byteDataArray[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_bLoadi, byteDataArray[i],
                     _bLoadi((uintptrj_t)(&byteDataArray[i])));
  }

  testCaseNum = sizeof(longDataArray) / sizeof(longDataArray[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_lLoadi, longDataArray[i],
                     _lLoadi((uintptrj_t)(&longDataArray[i])));
  }

  testCaseNum = sizeof(doubleDataArray) / sizeof(doubleDataArray[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_dLoadi, doubleDataArray[i],
                     _dLoadi((uintptrj_t)(&doubleDataArray[i])));
  }

  testCaseNum = sizeof(floatDataArray) / sizeof(floatDataArray[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_fLoadi, floatDataArray[i],
                     _fLoadi((uintptrj_t)(&floatDataArray[i])));
  }

  testCaseNum = sizeof(addressDataArray) / sizeof(addressDataArray[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_aLoadi, addressDataArray[i],
                     _aLoadi((uintptrj_t)(&addressDataArray[i])));
  }
}

void OpCodesTest::invokeUnaryTests() {
  int64_t longDataArray[] = {LONG_NEG, LONG_POS, LONG_MAXIMUM, LONG_MINIMUM,
                             LONG_ZERO};
  int32_t intDataArray[] = {INT_NEG, INT_POS, INT_MAXIMUM, INT_MINIMUM,
                            INT_ZERO};
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    ...
    compileOpCodeMethod(iUnaryCons, _numberOfUnaryArgs, TR::ineg,
                        resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc, 2,
                        1, &intDataArray[i]);
    OMR_CT_EXPECT_EQ(iUnaryCons, neg(intDataArray[i]),
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    ...
    compileOpCodeMethod(iUnaryCons, _numberOfUnaryArgs, TR::iabs,
                        resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc, 2,
                        1, &intDataArray[i]);
    OMR_CT_EXPECT_EQ(iUnaryCons, abs(intDataArray[i]),
                     iUnaryCons(INT_PLACEHOLDER_1));
  }
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iUnaryCons, _numberOfUnaryArgs, TR::ireturn,
                        resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc, 2,
                        1, &(intDataArray[i]));
    OMR_CT_EXPECT_EQ(iUnaryCons, intDataArray[i],
                     iUnaryCons(INT_PLACEHOLDER_1));
  }
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iUnaryCons, _numberOfUnaryArgs, TR::iconst,
                        resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc, 2,
                        1, &(intDataArray[i]));
    OMR_CT_EXPECT_EQ(iUnaryCons, intDataArray[i],
                     iUnaryCons(INT_PLACEHOLDER_1));
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(bUnaryCons, _numberOfUnaryArgs, TR::bconst,
                        resolvedMethodName, _argTypesUnaryByte, TR::Int8, rc, 2,
                        1, &(byteDataArray[i]));
    OMR_CT_EXPECT_EQ(bUnaryCons, byteDataArray[i],
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(sUnaryCons, _numberOfUnaryArgs, TR::sconst,
                        resolvedMethodName, _argTypesUnaryShort, TR::Int16, rc,
                        2, 1, &(shortDataArray[i]));
    OMR_CT_EXPECT_EQ(sUnaryCons, shortDataArray[i],
  ...
  testCaseNum = sizeof(intDataArray) / sizeof(intDataArray[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_i2b, convert(intDataArray[i], BYTE_POS),
                     _i2b(intDataArray[i]));
    OMR_CT_EXPECT_EQ(_i2s, convert(intDataArray[i], SHORT_POS),
                     _i2s(intDataArray[i]));
    OMR_CT_EXPECT_EQ(_i2l, convert(intDataArray[i], LONG_POS),
                     _i2l(intDataArray[i]));

    sprintf(resolvedMethodName, "i2bConst%d", i + 1);
    compileOpCodeMethod(i2bConst, _numberOfUnaryArgs, TR::i2b,
                        resolvedMethodName, _argTypesUnaryInt, TR::Int8, rc, 2,
                        1, &intDataArray[i]);
    OMR_CT_EXPECT_EQ(i2bConst, convert(intDataArray[i], BYTE_POS),
                     i2bConst(INT_PLACEHOLDER_1));

    sprintf(resolvedMethodName, "i2sConst%d", i + 1);
    compileOpCodeMethod(i2sConst, _numberOfUnaryArgs, TR::i2s,
                        resolvedMethodName, _argTypesUnaryInt, TR::Int16, rc, 2,
                        1, &intDataArray[i]);
    OMR_CT_EXPECT_EQ(i2sConst, convert(intDataArray[i], SHORT_POS),
                     i2sConst(INT_PLACEHOLDER_1));
    ...
    compileOpCodeMethod(i2lConst, _numberOfUnaryArgs, TR::i2l,
                        ...
                        1, &intDataArray[i]);
    OMR_CT_EXPECT_EQ(i2lConst, convert(intDataArray[i], LONG_POS),
                     i2lConst(INT_PLACEHOLDER_1));
  }

  // l 2 i,b,s
  testCaseNum = sizeof(longDataArray) / sizeof(longDataArray[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_l2b, convert(longDataArray[i], BYTE_POS),
                     _l2b(longDataArray[i]));
    OMR_CT_EXPECT_EQ(_l2s, convert(longDataArray[i], SHORT_POS),
                     _l2s(longDataArray[i]));
    OMR_CT_EXPECT_EQ(_l2i, convert(longDataArray[i], INT_POS),
                     _l2i(longDataArray[i]));

    sprintf(resolvedMethodName, "l2bConst%d", i + 1);
    compileOpCodeMethod(l2bConst, _numberOfUnaryArgs, TR::l2b,
                        resolvedMethodName, _argTypesUnaryLong, TR::Int8, rc, 2,
                        1, &longDataArray[i]);
    OMR_CT_EXPECT_EQ(l2bConst, convert(longDataArray[i], BYTE_POS),
                     l2bConst(LONG_PLACEHOLDER_1));

    sprintf(resolvedMethodName, "l2sConst%d", i + 1);
    compileOpCodeMethod(l2sConst, _numberOfUnaryArgs, TR::l2s,
                        resolvedMethodName, _argTypesUnaryLong, TR::Int16, rc,
                        2, 1, &longDataArray[i]);
    OMR_CT_EXPECT_EQ(l2sConst, convert(longDataArray[i], SHORT_POS),
                     l2sConst(LONG_PLACEHOLDER_1));

    sprintf(resolvedMethodName, "l2iConst%d", i + 1);
    compileOpCodeMethod(l2iConst, _numberOfUnaryArgs, TR::l2i,
                        resolvedMethodName, _argTypesUnaryLong, TR::Int32, rc,
                        2, 1, &longDataArray[i]);
    OMR_CT_EXPECT_EQ(l2iConst, convert(longDataArray[i], INT_POS),
                     l2iConst(LONG_PLACEHOLDER_1));
  }
  ...
  // lack of helper, which will lead to Segmentation fault, use i < 3
  // temporarily. When the helper for f2i MAXIMUM and MINIMUM is done, this part
  // should be moved back to the loop above.
  for (uint32_t i = 0; i < 3; ++i) {
    OMR_CT_EXPECT_EQ(_f2i, convert(floatDataArray[i], INT_POS),
                     _f2i(floatDataArray[i]));

    sprintf(resolvedMethodName, "f2iConst%d", i + 1);
    compileOpCodeMethod(f2iConst, _numberOfUnaryArgs, TR::f2i,
                        resolvedMethodName, _argTypesUnaryFloat, TR::Int32, rc,
                        2, 1, &floatDataArray[i]);
    OMR_CT_EXPECT_EQ(f2iConst, convert(floatDataArray[i], INT_POS),
                     f2iConst(FLOAT_PLACEHOLDER_1));
  }
  ...
  // temporarily When the helper for d2i MAXIMUM and MINIMUM is done, this part
  // should be moved back to the loop above.
  for (uint32_t i = 0; i < 3; ++i) {
    OMR_CT_EXPECT_EQ(_d2i, convert(doubleDataArray[i], INT_POS),
                     _d2i(doubleDataArray[i]));

    sprintf(resolvedMethodName, "d2iConst%d", i + 1);
    compileOpCodeMethod(d2iConst, _numberOfUnaryArgs, TR::d2i,
                        resolvedMethodName, _argTypesUnaryDouble, TR::Int32, rc,
                        2, 1, &doubleDataArray[i]);
    OMR_CT_EXPECT_EQ(d2iConst, convert(doubleDataArray[i], INT_POS),
                     d2iConst(DOUBLE_PLACEHOLDER_1));
  }
}

// This function is used to test the JIT helper for converting MAXIMUM and
// MINIMUM from float or double to int or long. When JIT helper can handle these
// conversion properly, these tests will be moved back to incokeUnaryTest()
// function. This function is disabled by default. To enable this function,
// uncomment in google test framework.
void OpCodesTest::invokeNoHelperUnaryTests() {
  int32_t rc = 0;
...
void OpCodesTest::invokeBitwiseTests() {
  int32_t rc = 0;
  char resolvedMethodName[RESOLVED_METHOD_NAME_LENGTH];
  uint32_t testCaseNum = 0;

  int32_t intAndArr[][2] = {INT_ZERO,    INT_NEG,     INT_POS,     INT_MAXIMUM,
                            INT_NEG,     INT_MINIMUM, INT_MAXIMUM, INT_POS,
                            INT_MAXIMUM, INT_MINIMUM, INT_POS,     INT_POS,
                            INT_NEG,     INT_MAXIMUM};
  int32_t intOrArr[][2] = {INT_MINIMUM, INT_POS};
  int32_t intXorArr[][2] = {INT_MAXIMUM, INT_ZERO, INT_MINIMUM, INT_MINIMUM};
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_iAnd, tand(intAndArr[i][0], intAndArr[i][1]),
                     _iAnd(intAndArr[i][0], intAndArr[i][1]));

    sprintf(resolvedMethodName, "iAndConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::iand,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(intAndArr[i][0]), 2, &(intAndArr[i][1]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, tand(intAndArr[i][0], intAndArr[i][1]),
                     iBitwiseConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::iand,
                        ...
                        2, 1, &(intAndArr[i][0]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, tand(intAndArr[i][0], intAndArr[i][1]),
                     iBitwiseConst(INT_PLACEHOLDER_1, intAndArr[i][1]));
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::iand,
                        ...
                        2, 2, &(intAndArr[i][1]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, tand(intAndArr[i][0], intAndArr[i][1]),
                     iBitwiseConst(intAndArr[i][0], INT_PLACEHOLDER_2));
  }

  // ior
  testCaseNum = sizeof(intOrArr) / sizeof(intOrArr[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_iOr, tor(intOrArr[i][0], intOrArr[i][1]),
                     _iOr(intOrArr[i][0], intOrArr[i][1]));

    sprintf(resolvedMethodName, "iOrConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::ior,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(intOrArr[i][0]), 2, &(intOrArr[i][1]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, tor(intOrArr[i][0], intOrArr[i][1]),
                     iBitwiseConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::ior,
                        ...
                        2, 1, &(intOrArr[i][0]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, tor(intOrArr[i][0], intOrArr[i][1]),
                     iBitwiseConst(INT_PLACEHOLDER_1, intOrArr[i][1]));
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::ior,
                        ...
                        2, 2, &(intOrArr[i][1]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, tor(intOrArr[i][0], intOrArr[i][1]),
                     iBitwiseConst(intOrArr[i][0], INT_PLACEHOLDER_2));
  }

  // ixor
  testCaseNum = sizeof(intXorArr) / sizeof(intXorArr[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_iXor, txor(intXorArr[i][0], intXorArr[i][1]),
                     _iXor(intXorArr[i][0], intXorArr[i][1]));

    sprintf(resolvedMethodName, "iXorConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::ixor,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(intXorArr[i][0]), 2, &(intXorArr[i][1]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, txor(intXorArr[i][0], intXorArr[i][1]),
                     iBitwiseConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::ixor,
                        ...
                        2, 1, &(intXorArr[i][0]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, txor(intXorArr[i][0], intXorArr[i][1]),
                     iBitwiseConst(INT_PLACEHOLDER_1, intXorArr[i][1]));
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::ixor,
                        ...
                        2, 2, &(intXorArr[i][1]));
    OMR_CT_EXPECT_EQ(iBitwiseConst, txor(intXorArr[i][0], intXorArr[i][1]),
                     iBitwiseConst(intXorArr[i][0], INT_PLACEHOLDER_2));
  }
}

void OpCodesTest::invokeDisabledOpCodesTests() {
  // frem
  OMR_CT_EXPECT_FLOAT_EQ(_fRem, remainderf(FLOAT_MINIMUM, FLOAT_MINIMUM),
                         _fRem(FLOAT_MINIMUM, FLOAT_MINIMUM));
  OMR_CT_EXPECT_FLOAT_EQ(_fRem, remainderf(FLOAT_ZERO, FLOAT_MAXIMUM),
                         _fRem(FLOAT_ZERO, FLOAT_MAXIMUM));
  OMR_CT_EXPECT_FLOAT_EQ(_fRem, remainderf(FLOAT_POS, FLOAT_NEG),
                         _fRem(FLOAT_POS, FLOAT_NEG));
  OMR_CT_EXPECT_FLOAT_EQ(_fRem, remainderf(FLOAT_MAXIMUM, FLOAT_POS),
                         _fRem(FLOAT_MAXIMUM, FLOAT_POS));

  // drem
  OMR_CT_EXPECT_DOUBLE_EQ(_dRem, remainder(DOUBLE_MINIMUM, DOUBLE_MINIMUM),
                          _dRem(DOUBLE_MINIMUM, DOUBLE_MINIMUM));
  OMR_CT_EXPECT_DOUBLE_EQ(_dRem, remainder(DOUBLE_ZERO, DOUBLE_MAXIMUM),
                          _dRem(DOUBLE_ZERO, DOUBLE_MAXIMUM));
  OMR_CT_EXPECT_DOUBLE_EQ(_dRem, remainder(DOUBLE_POS, DOUBLE_NEG),
                          _dRem(DOUBLE_POS, DOUBLE_NEG));
  OMR_CT_EXPECT_DOUBLE_EQ(_dRem, remainder(DOUBLE_MAXIMUM, DOUBLE_POS),
                          _dRem(DOUBLE_MAXIMUM, DOUBLE_POS));
}

void OpCodesTest::UnsupportedOpCodesTests() {
  // bdiv, brem
...
void OpCodesTest::invokeCompareTests() {
  // Compare op codes data array
  int32_t iCmpeqDataArr[][2] = {INT_MINIMUM, INT_MAXIMUM, INT_POS, INT_POS};
  int32_t iCmpneDataArr[][2] = {INT_MAXIMUM, INT_NEG, INT_NEG, INT_NEG};
  int32_t iCmpgtDataArr[][2] = {INT_NEG, INT_MINIMUM, INT_MINIMUM, INT_NEG};
  int32_t iCmpltDataArr[][2] = {INT_MINIMUM, INT_ZERO, INT_ZERO, INT_MINIMUM};
  int32_t iCmpgeDataArr[][2] = {INT_ZERO, INT_POS, INT_POS, INT_ZERO};
  int32_t iCmpleDataArr[][2] = {INT_POS, INT_ZERO, INT_ZERO, INT_POS};
  int64_t lCmpneDataArr[][2] = {LONG_ZERO, LONG_ZERO, LONG_MAXIMUM,
                                LONG_MINIMUM};
  int64_t lCmpgtDataArr[][2] = {LONG_MINIMUM, LONG_ZERO, LONG_ZERO,
                                LONG_MINIMUM};
  int64_t lCmpgeDataArr[][2] = {LONG_POS, LONG_NEG, LONG_NEG, LONG_POS};
  int64_t lCmpleDataArr[][2] = {LONG_NEG, LONG_POS, LONG_POS, LONG_NEG};
  uint32_t iuCmpgtDataArr[][2] = {UINT_POS, UINT_MINIMUM, UINT_MINIMUM,
                                  UINT_POS, UINT_POS,     UINT_POS};
  uint32_t iuCmpltDataArr[][2] = {UINT_MAXIMUM, UINT_POS,     UINT_POS,
                                  UINT_MAXIMUM, UINT_MINIMUM, UINT_POS,
                                  UINT_POS,     UINT_MINIMUM};
  uint32_t iuCmpleDataArr[][2] = {UINT_MINIMUM, UINT_MINIMUM, UINT_POS,
                                  UINT_MAXIMUM, UINT_MAXIMUM, UINT_POS};
  uint64_t luCmpgtDataArr[][2] = {ULONG_MINIMUM, ULONG_MAXIMUM, ULONG_MAXIMUM,
                                  ULONG_MINIMUM};
  uint64_t luCmpltDataArr[][2] = {
      ULONG_MAXIMUM, ULONG_MINIMUM, ULONG_MINIMUM, ULONG_MAXIMUM

  };
  uint64_t luCmpgeDataArr[][2] = {
      ULONG_POS, ULONG_MINIMUM, ULONG_MINIMUM, ULONG_POS

  };
  uint64_t luCmpleDataArr[][2] = {ULONG_MAXIMUM, ULONG_POS, ULONG_POS,
                                  ULONG_MAXIMUM};

  // CompareAndBranch data array
  int32_t ifIcmpeqDataArr[][2] = {INT_MINIMUM, INT_MAXIMUM, INT_POS, INT_POS};
  int32_t ifIcmpneDataArr[][2] = {INT_MAXIMUM, INT_NEG, INT_NEG, INT_NEG};
  int32_t ifIcmpgtDataArr[][2] = {INT_NEG, INT_MINIMUM, INT_MINIMUM, INT_NEG};
  int32_t ifIcmpltDataArr[][2] = {INT_MINIMUM, INT_ZERO, INT_ZERO, INT_MINIMUM};
  int32_t ifIcmpgeDataArr[][2] = {INT_ZERO, INT_POS, INT_POS, INT_ZERO};
  int32_t ifIcmpleDataArr[][2] = {INT_POS, INT_ZERO, INT_ZERO, INT_POS};
  int64_t ifLcmpneDataArr[][2] = {LONG_ZERO, LONG_ZERO, LONG_MAXIMUM,
                                  LONG_MINIMUM};
  int64_t ifLcmpgeDataArr[][2] = {LONG_POS, LONG_NEG, LONG_NEG, LONG_POS};
  int64_t ifLcmpleDataArr[][2] = {LONG_NEG, LONG_POS, LONG_POS, LONG_NEG};
  uint32_t ifIuCmpgtDataArr[][2] = {UINT_MAXIMUM, UINT_MAXIMUM, UINT_MAXIMUM,
                                    UINT_POS};
  uint32_t ifIuCmpltDataArr[][2] = {UINT_MINIMUM, UINT_POS, UINT_POS,
                                    UINT_MINIMUM};
  uint32_t ifIuCmpgeDataArr[][2] = {UINT_POS, UINT_MINIMUM, UINT_MINIMUM,
                                    UINT_POS};
  uint32_t ifIuCmpleDataArr[][2] = {UINT_POS, UINT_MINIMUM, UINT_MINIMUM,
                                    UINT_POS};
  uint64_t ifLuCmpgtDataArr[][2] = {ULONG_MINIMUM, ULONG_MINIMUM, ULONG_MAXIMUM,
                                    ULONG_POS};
  uint64_t ifLuCmpltDataArr[][2] = {ULONG_POS, ULONG_MAXIMUM, ULONG_MAXIMUM,
                                    ULONG_POS};
  uint64_t ifLuCmpgeDataArr[][2] = {ULONG_MAXIMUM, ULONG_POS, ULONG_POS,
                                    ULONG_MAXIMUM};
  uint64_t ifLuCmpleDataArr[][2] = {ULONG_MAXIMUM, ULONG_MAXIMUM, ULONG_POS,
                                    ULONG_MINIMUM};
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iCmpeq,
                     compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]),
                     _iCmpeq(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpeqConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpeq,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iCmpeqDataArr[i][0]), 2,
                        &(iCmpeqDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "iCmpeqConst2_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpeq,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iCmpeqDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, iCmpeqDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpeqConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpeq,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iCmpeqDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]),
                     iCompareConst(iCmpeqDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(iCmpneDataArr) / sizeof(iCmpneDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iCmpne,
                     compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]),
                     _iCmpne(iCmpneDataArr[i][0], iCmpneDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpneConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpne,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iCmpneDataArr[i][0]), 2,
                        &(iCmpneDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpne,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iCmpneDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, iCmpneDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpneConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpne,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iCmpneDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]),
                     iCompareConst(iCmpneDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(iCmpgtDataArr) / sizeof(iCmpgtDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iCmpgt,
                     compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]),
                     _iCmpgt(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpgtConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iCmpgtDataArr[i][0]), 2,
                        &(iCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iCmpgtDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, iCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpgtConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]),
                     iCompareConst(iCmpgtDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(iCmpltDataArr) / sizeof(iCmpltDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iCmplt,
                     compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]),
                     _iCmplt(iCmpltDataArr[i][0], iCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpltConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iCmpltDataArr[i][0]), 2,
                        &(iCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iCmpltDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, iCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpltConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]),
                     iCompareConst(iCmpltDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(iCmpgeDataArr) / sizeof(iCmpgeDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iCmpge,
                     compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]),
                     _iCmpge(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpgeConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iCmpgeDataArr[i][0]), 2,
                        &(iCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iCmpgeDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, iCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpgeConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]),
                     iCompareConst(iCmpgeDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(iCmpleDataArr) / sizeof(iCmpleDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iCmple,
                     compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]),
                     _iCmple(iCmpleDataArr[i][0], iCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpleConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iCmpleDataArr[i][0]), 2,
                        &(iCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iCmpleDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, iCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "iCmpleConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::icmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]),
                     iCompareConst(iCmpleDataArr[i][0], INT_PLACEHOLDER_2));
  }

  // lCompare
  testCaseNum = sizeof(lCmpneDataArr) / sizeof(lCmpneDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_lCmpne,
                     compareNE(lCmpneDataArr[i][0], lCmpneDataArr[i][1]),
                     _lCmpne(lCmpneDataArr[i][0], lCmpneDataArr[i][1]));

    sprintf(resolvedMethodName, "lCmpneConst1_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpne,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(lCmpneDataArr[i][0]), 2,
                        &(lCmpneDataArr[i][1]));
    ...
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpne,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(lCmpneDataArr[i][0]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareNE(lCmpneDataArr[i][0], lCmpneDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, lCmpneDataArr[i][1]));

    sprintf(resolvedMethodName, "lCmpneConst3_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpne,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(lCmpneDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareNE(lCmpneDataArr[i][0], lCmpneDataArr[i][1]),
                     lCompareConst(lCmpneDataArr[i][0], LONG_PLACEHOLDER_2));
#endif
  }

  testCaseNum = sizeof(lCmpgtDataArr) / sizeof(lCmpgtDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_lCmpgt,
                     compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]),
                     _lCmpgt(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "lCmpgtConst1_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(lCmpgtDataArr[i][0]), 2,
                        &(lCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(lCmpgtDataArr[i][0]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, lCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "lCmpgtConst3_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(lCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]),
                     lCompareConst(lCmpgtDataArr[i][0], LONG_PLACEHOLDER_2));
#endif
  }

  testCaseNum = sizeof(lCmpgeDataArr) / sizeof(lCmpgeDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_lCmpge,
                     compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]),
                     _lCmpge(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "lCmpgeConst1_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(lCmpgeDataArr[i][0]), 2,
                        &(lCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(lCmpgeDataArr[i][0]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, lCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "lCmpgeConst3_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(lCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]),
                     lCompareConst(lCmpgeDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(lCmpleDataArr) / sizeof(lCmpleDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_lCmple,
                     compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]),
                     _lCmple(lCmpleDataArr[i][0], lCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "lCmpleConst1_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(lCmpleDataArr[i][0]), 2,
                        &(lCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(lCmpleDataArr[i][0]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, lCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "lCmpleConst3_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::lcmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(lCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]),
                     lCompareConst(lCmpleDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  // iuCompare
  testCaseNum = sizeof(iuCmpgtDataArr) / sizeof(iuCmpgtDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iuCmpgt,
                     compareGT(iuCmpgtDataArr[i][0], iuCmpgtDataArr[i][1]),
                     _iuCmpgt(iuCmpgtDataArr[i][0], iuCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "iuCmpgtConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iuCmpgtDataArr[i][0]), 2,
                        &(iuCmpgtDataArr[i][1]));
    ...
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iuCmpgtDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareGT(iuCmpgtDataArr[i][0], iuCmpgtDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, iuCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "iuCmpgtConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iuCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareGT(iuCmpgtDataArr[i][0], iuCmpgtDataArr[i][1]),
                     iuCompareConst(iuCmpgtDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(iuCmpltDataArr) / sizeof(iuCmpltDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iuCmplt,
                     compareLT(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]),
                     _iuCmplt(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "iuCmpltConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iuCmpltDataArr[i][0]), 2,
                        &(iuCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLT(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iuCmpltDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLT(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, iuCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "iuCmpltConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iuCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLT(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]),
                     iuCompareConst(iuCmpltDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(iuCmpleDataArr) / sizeof(iuCmpleDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_iuCmple,
                     compareLE(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]),
                     _iuCmple(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "iuCmpleConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(iuCmpleDataArr[i][0]), 2,
                        &(iuCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLE(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(iuCmpleDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLE(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, iuCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "iuCmpleConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::iucmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(iuCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLE(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]),
                     iuCompareConst(iuCmpleDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(luCmpgtDataArr) / sizeof(luCmpgtDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_luCmpgt,
                     compareGT(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]),
                     _luCmpgt(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "luCmpgtConst1_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(luCmpgtDataArr[i][0]), 2,
                        &(luCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareGT(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "luCmpgtConst2_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(luCmpgtDataArr[i][0]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareGT(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, luCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "luCmpgtConst3_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(luCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareGT(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]),
                     luCompareConst(luCmpgtDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(luCmpltDataArr) / sizeof(luCmpltDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_luCmplt,
                     compareLT(luCmpltDataArr[i][0], luCmpltDataArr[i][1]),
                     _luCmplt(luCmpltDataArr[i][0], luCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "luCmpltConst1_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmplt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(luCmpltDataArr[i][0]), 2,
                        &(luCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareLT(luCmpltDataArr[i][0], luCmpltDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmplt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(luCmpltDataArr[i][0]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareLT(luCmpltDataArr[i][0], luCmpltDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, luCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "luCmpltConst3_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmplt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(luCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareLT(luCmpltDataArr[i][0], luCmpltDataArr[i][1]),
                     luCompareConst(luCmpltDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(luCmpgeDataArr) / sizeof(luCmpgeDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_luCmpge,
                     compareGE(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]),
                     _luCmpge(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "luCmpgeConst1_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(luCmpgeDataArr[i][0]), 2,
                        &(luCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareGE(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(luCmpgeDataArr[i][0]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareGE(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, luCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "luCmpgeConst3_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(luCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareGE(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]),
                     luCompareConst(luCmpgeDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(luCmpleDataArr) / sizeof(luCmpleDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_luCmple,
                     compareLE(luCmpleDataArr[i][0], luCmpleDataArr[i][1]),
                     _luCmple(luCmpleDataArr[i][0], luCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "luCmpleConst1_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(luCmpleDataArr[i][0]), 2,
                        &(luCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareLE(luCmpleDataArr[i][0], luCmpleDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(luCmpleDataArr[i][0]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareLE(luCmpleDataArr[i][0], luCmpleDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, luCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "luCmpleConst3_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::lucmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(luCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareLE(luCmpleDataArr[i][0], luCmpleDataArr[i][1]),
                     luCompareConst(luCmpleDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  // ifiCompare
  testCaseNum = sizeof(ifIcmpeqDataArr) / sizeof(ifIcmpeqDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifIcmpeq,
                     compareEQ(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]),
                     _ifIcmpeq(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpeqConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpeq,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIcmpeqDataArr[i][0]), 2,
                        &(ifIcmpeqDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareEQ(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpeq,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIcmpeqDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareEQ(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, ifIcmpeqDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpeqConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpeq,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIcmpeqDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareEQ(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]),
                     iCompareConst(ifIcmpeqDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIcmpneDataArr) / sizeof(ifIcmpneDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifIcmpne,
                     compareNE(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]),
                     _ifIcmpne(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpneConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpne,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIcmpneDataArr[i][0]), 2,
                        &(ifIcmpneDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareNE(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpne,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIcmpneDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareNE(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, ifIcmpneDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpneConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpne,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIcmpneDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareNE(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]),
                     iCompareConst(ifIcmpneDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIcmpgtDataArr) / sizeof(ifIcmpgtDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifIcmpgt,
                     compareGT(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]),
                     _ifIcmpgt(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpgtConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIcmpgtDataArr[i][0]), 2,
                        &(ifIcmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGT(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIcmpgtDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGT(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, ifIcmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpgtConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIcmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGT(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]),
                     iCompareConst(ifIcmpgtDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIcmpltDataArr) / sizeof(ifIcmpltDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifIcmplt,
                     compareLT(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]),
                     _ifIcmplt(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpltConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIcmpltDataArr[i][0]), 2,
                        &(ifIcmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLT(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIcmpltDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLT(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, ifIcmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpltConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIcmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLT(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]),
                     iCompareConst(ifIcmpltDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIcmpgeDataArr) / sizeof(ifIcmpgeDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifIcmpge,
                     compareGE(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]),
                     _ifIcmpge(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpgeConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIcmpgeDataArr[i][0]), 2,
                        &(ifIcmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGE(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIcmpgeDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGE(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, ifIcmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpgeConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIcmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareGE(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]),
                     iCompareConst(ifIcmpgeDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIcmpleDataArr) / sizeof(ifIcmpleDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifIcmple,
                     compareLE(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]),
                     _ifIcmple(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpleConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIcmpleDataArr[i][0]), 2,
                        &(ifIcmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLE(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIcmpleDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLE(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]),
                     iCompareConst(INT_PLACEHOLDER_1, ifIcmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIcmpleConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iCompareConst, _numberOfBinaryArgs, TR::ificmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIcmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iCompareConst,
                     compareLE(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]),
                     iCompareConst(ifIcmpleDataArr[i][0], INT_PLACEHOLDER_2));
  }

  // iflCompare
  testCaseNum = sizeof(ifLcmpneDataArr) / sizeof(ifLcmpneDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifLcmpne,
                     compareNE(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]),
                     _ifLcmpne(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLcmpneConst1_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmpne,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(ifLcmpneDataArr[i][0]), 2,
                        &(ifLcmpneDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareNE(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmpne,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(ifLcmpneDataArr[i][0]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareNE(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, ifLcmpneDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLcmpneConst3_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmpne,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(ifLcmpneDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareNE(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]),
                     lCompareConst(ifLcmpneDataArr[i][0], LONG_PLACEHOLDER_2));
#endif
  }

  testCaseNum = sizeof(ifLcmpgeDataArr) / sizeof(ifLcmpgeDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifLcmpge,
                     compareGE(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]),
                     _ifLcmpge(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLcmpgeConst1_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(ifLcmpgeDataArr[i][0]), 2,
                        &(ifLcmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGE(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(ifLcmpgeDataArr[i][0]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGE(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, ifLcmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLcmpgeConst3_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(ifLcmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareGE(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]),
                     lCompareConst(ifLcmpgeDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifLcmpleDataArr) / sizeof(ifLcmpleDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(_ifLcmple,
                     compareLE(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]),
                     _ifLcmple(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLcmpleConst1_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(ifLcmpleDataArr[i][0]), 2,
                        &(ifLcmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareLE(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
    ...
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(ifLcmpleDataArr[i][0]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareLE(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]),
                     lCompareConst(LONG_PLACEHOLDER_1, ifLcmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLcmpleConst3_TestCase%d", i + 1);
    compileOpCodeMethod(lCompareConst, _numberOfBinaryArgs, TR::iflcmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(ifLcmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(lCompareConst,
                     compareLE(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]),
                     lCompareConst(ifLcmpleDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIuCmpgtDataArr) / sizeof(ifIuCmpgtDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
        _ifIuCmpgt, compareGT(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]),
        _ifIuCmpgt(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIuCmpgtConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIuCmpgtDataArr[i][0]), 2,
                        &(ifIuCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareGT(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "ifIuCmpgtConst2_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIuCmpgtDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareGT(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIuCmpgtConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpgt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIuCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareGT(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]),
                     iuCompareConst(ifIuCmpgtDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIuCmpltDataArr) / sizeof(ifIuCmpltDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
        _ifIuCmplt, compareLT(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]),
        _ifIuCmplt(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIuCmpltConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIuCmpltDataArr[i][0]), 2,
                        &(ifIuCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLT(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "ifIuCmpltConst2_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIuCmpltDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLT(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIuCmpltConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmplt,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIuCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLT(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]),
                     iuCompareConst(ifIuCmpltDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIuCmpgeDataArr) / sizeof(ifIuCmpgeDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
        _ifIuCmpge, compareGE(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]),
        _ifIuCmpge(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIuCmpgeConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIuCmpgeDataArr[i][0]), 2,
                        &(ifIuCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareGE(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "ifIuCmpgeConst2_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIuCmpgeDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareGE(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIuCmpgeConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmpge,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIuCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareGE(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]),
                     iuCompareConst(ifIuCmpgeDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifIuCmpleDataArr) / sizeof(ifIuCmpleDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
        _ifIuCmple, compareLE(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]),
        _ifIuCmple(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIuCmpleConst1_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        4, 1, &(ifIuCmpleDataArr[i][0]), 2,
                        &(ifIuCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLE(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "ifIuCmpleConst2_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 1, &(ifIuCmpleDataArr[i][0]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLE(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]),
                     iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "ifIuCmpleConst3_TestCase%d", i + 1);
    compileOpCodeMethod(iuCompareConst, _numberOfBinaryArgs, TR::ifiucmple,
                        resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc,
                        2, 2, &(ifIuCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(iuCompareConst,
                     compareLE(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]),
                     iuCompareConst(ifIuCmpleDataArr[i][0], INT_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifLuCmpgtDataArr) / sizeof(ifLuCmpgtDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
        _ifLuCmpgt, compareGT(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]),
        _ifLuCmpgt(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLuCmpgtConst1_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(ifLuCmpgtDataArr[i][0]), 2,
                        &(ifLuCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareGT(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "ifLuCmpgtConst2_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(ifLuCmpgtDataArr[i][0]));
    OMR_CT_EXPECT_EQ(
        luCompareConst,
        compareGT(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]),
        luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpgtDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLuCmpgtConst3_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpgt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(ifLuCmpgtDataArr[i][1]));
    OMR_CT_EXPECT_EQ(
        luCompareConst,
        compareGT(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]),
        luCompareConst(ifLuCmpgtDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifLuCmpltDataArr) / sizeof(ifLuCmpltDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
        _ifLuCmplt, compareLT(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]),
        _ifLuCmplt(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLuCmpltConst1_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmplt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(ifLuCmpltDataArr[i][0]), 2,
                        &(ifLuCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareLT(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "ifLuCmpltConst2_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmplt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(ifLuCmpltDataArr[i][0]));
    OMR_CT_EXPECT_EQ(
        luCompareConst,
        compareLT(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]),
        luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpltDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLuCmpltConst3_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmplt,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(ifLuCmpltDataArr[i][1]));
    OMR_CT_EXPECT_EQ(
        luCompareConst,
        compareLT(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]),
        luCompareConst(ifLuCmpltDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifLuCmpgeDataArr) / sizeof(ifLuCmpgeDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
        _ifLuCmpge, compareGE(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]),
        _ifLuCmpge(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLuCmpgeConst1_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(ifLuCmpgeDataArr[i][0]), 2,
                        &(ifLuCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareGE(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "ifLuCmpgeConst2_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(ifLuCmpgeDataArr[i][0]));
    OMR_CT_EXPECT_EQ(
        luCompareConst,
        compareGE(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]),
        luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpgeDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLuCmpgeConst3_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmpge,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(ifLuCmpgeDataArr[i][1]));
    OMR_CT_EXPECT_EQ(
        luCompareConst,
        compareGE(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]),
        luCompareConst(ifLuCmpgeDataArr[i][0], LONG_PLACEHOLDER_2));
  }

  testCaseNum = sizeof(ifLuCmpleDataArr) / sizeof(ifLuCmpleDataArr[0]);
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
        _ifLuCmple, compareLE(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]),
        _ifLuCmple(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLuCmpleConst1_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        4, 1, &(ifLuCmpleDataArr[i][0]), 2,
                        &(ifLuCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(luCompareConst,
                     compareLE(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]),
                     luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

    sprintf(resolvedMethodName, "ifLuCmpleConst2_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 1, &(ifLuCmpleDataArr[i][0]));
    OMR_CT_EXPECT_EQ(
        luCompareConst,
        compareLE(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]),
        luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpleDataArr[i][1]));

    sprintf(resolvedMethodName, "ifLuCmpleConst3_TestCase%d", i + 1);
    compileOpCodeMethod(luCompareConst, _numberOfBinaryArgs, TR::iflucmple,
                        resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc,
                        2, 2, &(ifLuCmpleDataArr[i][1]));
    OMR_CT_EXPECT_EQ(
        luCompareConst,
        compareLE(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]),
        luCompareConst(ifLuCmpleDataArr[i][0], LONG_PLACEHOLDER_2));
  }
}

void OpCodesTest::invokeTernaryTests() {
  int32_t rc = 0;
  char resolvedMethodName[RESOLVED_METHOD_NAME_LENGTH];
  uint32_t testCaseNum = 0;
  ...
  int32_t iternaryChild1Arr[] = {
      INT_MAXIMUM, INT_MAXIMUM, INT_MINIMUM, INT_POS, INT_ZERO,
      INT_MINIMUM, INT_POS,     INT_ZERO,    INT_NEG, INT_NEG,
      INT_NEG,     INT_ZERO,    INT_POS,     INT_NEG, INT_ZERO,
      INT_MINIMUM, INT_MAXIMUM, INT_POS};

  int32_t intArr[][2] = {INT_NEG,     INT_MINIMUM, INT_NEG,     INT_POS,
                         INT_NEG,     INT_POS,     INT_MAXIMUM, INT_ZERO,
                         INT_ZERO,    INT_POS,     INT_ZERO,    INT_POS,
                         INT_ZERO,    INT_MAXIMUM, INT_POS,     INT_NEG,
                         INT_POS,     INT_MINIMUM, INT_MAXIMUM, INT_POS,
                         INT_MINIMUM, INT_ZERO,    INT_MINIMUM, INT_MAXIMUM,
                         INT_NEG,     INT_MAXIMUM, INT_ZERO,    INT_NEG,
                         INT_POS,     INT_ZERO,    INT_MAXIMUM, INT_NEG,
                         INT_ZERO,    INT_MINIMUM, INT_MINIMUM, INT_POS};
  ...
  TR_ASSERT((testCaseNum > 0) && (testCaseNum == testCaseNumCheck),
            "There is problem in iternary input array");
  signatureCharIII_I_testMethodType* iTernaryConst = 0;
  for (int32_t i = 0; i < testCaseNum; i++) {
    sprintf(resolvedMethodName, "iTernaryConst%d", i + 1);
    OMR_CT_EXPECT_EQ(
        _iternary, ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
        _iternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]));

    compileOpCodeMethod(iTernaryConst, _numberOfTernaryArgs, TR::iternary,
                        resolvedMethodName, _argTypesTernaryInt, TR::Int32, rc,
                        6, 1, &iternaryChild1Arr[i], 2, &intArr[i][0], 3,
                        &intArr[i][1]);
    OMR_CT_EXPECT_EQ(
        iTernaryConst,
        ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
        iTernaryConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2, INT_PLACEHOLDER_3));

    compileOpCodeMethod(iTernaryConst, _numberOfTernaryArgs, TR::iternary,
                        resolvedMethodName, _argTypesTernaryInt, TR::Int32, rc,
                        4, 1, &iternaryChild1Arr[i], 2, &intArr[i][0]);
    OMR_CT_EXPECT_EQ(
        iTernaryConst,
        ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
        iTernaryConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2, intArr[i][1]));

    compileOpCodeMethod(iTernaryConst, _numberOfTernaryArgs, TR::iternary,
                        resolvedMethodName, _argTypesTernaryInt, TR::Int32, rc,
                        4, 1, &iternaryChild1Arr[i], 3, &intArr[i][1]);
    OMR_CT_EXPECT_EQ(
        iTernaryConst,
        ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
        iTernaryConst(INT_PLACEHOLDER_1, intArr[i][0], INT_PLACEHOLDER_3));

    compileOpCodeMethod(iTernaryConst, _numberOfTernaryArgs, TR::iternary,
                        resolvedMethodName, _argTypesTernaryInt, TR::Int32, rc,
                        4, 2, &intArr[i][0], 3, &intArr[i][1]);
    OMR_CT_EXPECT_EQ(iTernaryConst,
                     ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
                     iTernaryConst(iternaryChild1Arr[i], INT_PLACEHOLDER_2,
                                   INT_PLACEHOLDER_3));

    compileOpCodeMethod(iTernaryConst, _numberOfTernaryArgs, TR::iternary,
                        resolvedMethodName, _argTypesTernaryInt, TR::Int32, rc,
                        2, 1, &iternaryChild1Arr[i]);
    OMR_CT_EXPECT_EQ(
        iTernaryConst,
        ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
        iTernaryConst(INT_PLACEHOLDER_1, intArr[i][0], intArr[i][1]));
    ...
    OMR_CT_EXPECT_EQ(
        iTernaryConst,
        ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
        iTernaryConst(iternaryChild1Arr[i], INT_PLACEHOLDER_1, intArr[i][1]));
    ...
    OMR_CT_EXPECT_EQ(
        iTernaryConst,
        ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
        iTernaryConst(iternaryChild1Arr[i], intArr[i][0], INT_PLACEHOLDER_1));
  }
}

void OpCodesTest::invokeAddressTests() {
  int32_t rc = 0;
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(aUnaryCons, _numberOfUnaryArgs, TR::aconst,
                        resolvedMethodName, _argTypesUnaryAddress, TR::Address,
                        rc, 2, 1, &(aUnaryDataArr[i]));
    OMR_CT_EXPECT_EQ(aUnaryCons, aUnaryDataArr[i],
                     aUnaryCons(ADDRESS_PLACEHOLDER_1));
  }
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(aUnaryCons, _numberOfUnaryArgs, TR::areturn,
                        resolvedMethodName, _argTypesUnaryAddress, TR::Address,
                        rc, 2, 1, &(aUnaryDataArr[i]));
    OMR_CT_EXPECT_EQ(aUnaryCons, aUnaryDataArr[i],
                     aUnaryCons(ADDRESS_PLACEHOLDER_1));
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(aUnaryCons, _numberOfUnaryArgs, TR::astore,
                        resolvedMethodName, _argTypesUnaryAddress, TR::Address,
                        rc, 2, 1, &(aUnaryDataArr[i]));
    OMR_CT_EXPECT_EQ(aUnaryCons, aUnaryDataArr[i],
                     aUnaryCons(ADDRESS_PLACEHOLDER_1));
  ...
  testCaseNum = sizeof(aUnaryDataArr) / sizeof(aUnaryDataArr[0]);
  for (int32_t i = 0; i < testCaseNum; i++) {
    OMR_CT_EXPECT_EQ(_a2i, convert(aUnaryDataArr[i], INT_POS),
                     _a2i(aUnaryDataArr[i]));

    sprintf(resolvedMethodName, "a2iConst%d", i + 1);
    compileOpCodeMethod(a2iConst, _numberOfUnaryArgs, TR::a2i,
                        resolvedMethodName, _argTypesUnaryAddress, TR::Int32,
                        rc, 2, 1, &aUnaryDataArr[i]);
    OMR_CT_EXPECT_EQ(a2iConst, convert(aUnaryDataArr[i], INT_POS),
                     a2iConst(ADDRESS_PLACEHOLDER_1));
  }
}
