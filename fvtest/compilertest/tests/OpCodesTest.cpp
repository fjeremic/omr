...
TR::ResolvedMethod *OpCodesTest::resolvedMethod(TR::DataType dataType) {
  ...
  default:
    TR_ASSERT(
        0, "compilee dataType should be int32, in64, double, float or address");
    return NULL;
  }
}
...
void OpCodesTest::invokeCompareTests() {
  ...
  uint64_t luCmpgtDataArr[][2] = {ULONG_MINIMUM, ULONG_MAXIMUM, ULONG_MAXIMUM,
                                  ULONG_MINIMUM};
  uint64_t luCmpltDataArr[][2] = {ULONG_MAXIMUM, ULONG_MINIMUM, ULONG_MINIMUM,
                                  ULONG_MAXIMUM

  };
  uint64_t luCmpgeDataArr[][2] = {ULONG_POS, ULONG_MINIMUM, ULONG_MINIMUM,
                                  ULONG_POS
