...
void OpCodesTest::invokeIntegerArithmeticTests()
{
  ...
  int32_t intAddArr[][2]
    = { INT_ZERO, INT_ZERO, INT_NEG, INT_NEG, INT_MINIMUM, INT_POS, INT_MAXIMUM, INT_MAXIMUM, INT_POS, INT_MINIMUM };
  int32_t intSubArr[][2]
    = { INT_MAXIMUM, INT_MINIMUM, INT_NEG, INT_POS, INT_POS, INT_MAXIMUM, INT_ZERO, INT_NEG, INT_MINIMUM, INT_ZERO };
  ...
  int32_t intRemArr[][2] = { INT_MINIMUM, INT_MINIMUM, INT_ZERO, INT_MAXIMUM, INT_POS, INT_NEG, INT_MAXIMUM, INT_POS };
  ...
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::iadd, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &intAddArr[i][0], 2, &intAddArr[i][1]);
    OMR_CT_EXPECT_EQ(
  ...
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::isub, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &intSubArr[i][0], 2, &intSubArr[i][1]);
    OMR_CT_EXPECT_EQ(
  ...
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::imul, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &intMulArr[i][0], 2, &intMulArr[i][1]);
    OMR_CT_EXPECT_EQ(
  ...
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::imulh, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &intMulArr[i][0], 2, &intMulArr[i][1]);
    OMR_CT_EXPECT_EQ(
  ...
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::idiv, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &intDivArr[i][0], 2, &intDivArr[i][1]);
    OMR_CT_EXPECT_EQ(
  ...
  for (uint32_t i = 0; i < testCaseArrLength; ++i) {
    ...
    compileOpCodeMethod(iBinaryCons, _numberOfBinaryArgs, TR::irem, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &intRemArr[i][0], 2, &intRemArr[i][1]);
    OMR_CT_EXPECT_EQ(
...
void OpCodesTest::invokeMemoryOperationTests()
{
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iMemCons, _numberOfUnaryArgs, TR::istore, resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc,
      2, 1, &(intDataArray[i]));
...
void OpCodesTest::invokeUnaryTests()
{
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    ...
    compileOpCodeMethod(iUnaryCons, _numberOfUnaryArgs, TR::ineg, resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc,
      2, 1, &intDataArray[i]);
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    ...
    compileOpCodeMethod(iUnaryCons, _numberOfUnaryArgs, TR::iabs, resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc,
      2, 1, &intDataArray[i]);
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iUnaryCons, _numberOfUnaryArgs, TR::ireturn, resolvedMethodName, _argTypesUnaryInt, TR::Int32,
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iUnaryCons, _numberOfUnaryArgs, TR::iconst, resolvedMethodName, _argTypesUnaryInt, TR::Int32,
      rc, 2, 1, &(intDataArray[i]));
    OMR_CT_EXPECT_EQ(iUnaryCons, intDataArray[i], iUnaryCons(INT_PLACEHOLDER_1));
  }
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(bUnaryCons, _numberOfUnaryArgs, TR::bconst, resolvedMethodName, _argTypesUnaryByte, TR::Int8,
      rc, 2, 1, &(byteDataArray[i]));
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(sUnaryCons, _numberOfUnaryArgs, TR::sconst, resolvedMethodName, _argTypesUnaryShort, TR::Int16,
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    ...
    compileOpCodeMethod(i2bConst, _numberOfUnaryArgs, TR::i2b, resolvedMethodName, _argTypesUnaryInt, TR::Int8, rc, 2,
      1, &intDataArray[i]);
    ...
    compileOpCodeMethod(i2sConst, _numberOfUnaryArgs, TR::i2s, resolvedMethodName, _argTypesUnaryInt, TR::Int16, rc, 2,
      1, &intDataArray[i]);
    ...
    compileOpCodeMethod(i2lConst, _numberOfUnaryArgs, TR::i2l, resolvedMethodName, _argTypesUnaryInt, TR::Int64, rc, 2,
      1, &intDataArray[i]);
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    ...
    compileOpCodeMethod(l2bConst, _numberOfUnaryArgs, TR::l2b, resolvedMethodName, _argTypesUnaryLong, TR::Int8, rc, 2,
      1, &longDataArray[i]);
    ...
    compileOpCodeMethod(l2sConst, _numberOfUnaryArgs, TR::l2s, resolvedMethodName, _argTypesUnaryLong, TR::Int16, rc, 2,
      1, &longDataArray[i]);
    ...
    compileOpCodeMethod(l2iConst, _numberOfUnaryArgs, TR::l2i, resolvedMethodName, _argTypesUnaryLong, TR::Int32, rc, 2,
      1, &longDataArray[i]);
  ...
  for (uint32_t i = 0; i < 3; ++i) {
    ...
    compileOpCodeMethod(f2iConst, _numberOfUnaryArgs, TR::f2i, resolvedMethodName, _argTypesUnaryFloat, TR::Int32, rc,
  ...
  for (uint32_t i = 0; i < 3; ++i) {
    ...
    compileOpCodeMethod(d2iConst, _numberOfUnaryArgs, TR::d2i, resolvedMethodName, _argTypesUnaryDouble, TR::Int32, rc,
...
void OpCodesTest::invokeBitwiseTests()
{
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::iand, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &(intAndArr[i][0]), 2, &(intAndArr[i][1]));
    OMR_CT_EXPECT_EQ(
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::ior, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &(intOrArr[i][0]), 2, &(intOrArr[i][1]));
    OMR_CT_EXPECT_EQ(
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(iBitwiseConst, _numberOfBinaryArgs, TR::ixor, resolvedMethodName, _argTypesBinaryInt, TR::Int32,
      rc, 4, 1, &(intXorArr[i][0]), 2, &(intXorArr[i][1]));
    OMR_CT_EXPECT_EQ(
...
void OpCodesTest::invokeCompareTests()
{
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _iCmpeq, compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]), _iCmpeq(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _iCmpne, compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]), _iCmpne(iCmpneDataArr[i][0], iCmpneDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _iCmpgt, compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]), _iCmpgt(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _iCmplt, compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]), _iCmplt(iCmpltDataArr[i][0], iCmpltDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _iCmpge, compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]), _iCmpge(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _iCmple, compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]), _iCmple(iCmpleDataArr[i][0], iCmpleDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _lCmpne, compareNE(lCmpneDataArr[i][0], lCmpneDataArr[i][1]), _lCmpne(lCmpneDataArr[i][0], lCmpneDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _lCmpgt, compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]), _lCmpgt(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _lCmpge, compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]), _lCmpge(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]));
  ...
  for (uint32_t i = 0; i < testCaseNum; ++i) {
    OMR_CT_EXPECT_EQ(
      _lCmple, compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]), _lCmple(lCmpleDataArr[i][0], lCmpleDataArr[i][1]));
...
void OpCodesTest::invokeAddressTests()
{
  ...
  for (int32_t i = 0; i < testCaseNum; i++) {
    ...
    compileOpCodeMethod(a2iConst, _numberOfUnaryArgs, TR::a2i, resolvedMethodName, _argTypesUnaryAddress, TR::Int32, rc,
      2, 1, &aUnaryDataArr[i]);
