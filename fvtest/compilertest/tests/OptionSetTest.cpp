 ...
 */
std::string TestCompiler::OptionSetTest::getMethodFromLine(const std::string& line)
{
 ...
 */
void TestCompiler::OptionSetTest::applyOptionSets(
  const char* limitFile, const char* optSetFile, const TestCompiler::MethodSets& methods)
{
...
TEST_F(OptionSetTest, UseOptionSets)
{
  ...
  std::string limitArg = std::string(optSet) + ",2(optlevel=hot)" + ",3(optlevel=cold)";
...
TEST_F(OptionSetTest, WithDefault)
{
  ...
  std::string limitArg
    = std::string(optSet) + ",1(optlevel=hot)" + ",3(optlevel=warm)" + ",9(optlevel=warm)" + ",optlevel=cold";
