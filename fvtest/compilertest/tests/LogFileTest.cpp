 ...
 */
void
TestCompiler::LogFileTest::runKeywordTests(
 ...
 */
void
TestCompiler::LogFileTest::checkLogForKeywords(
  std::map<const char*, bool> keywords,
  const char* logFile)
{
 ...
 */
void
TestCompiler::LogFileTest::forkAndCompile(std::string logFile,
                                          const char* logType)
{
  ...
  */
  ...
  logFileChecks.insert(std::pair<const char*, std::map<const char*, bool>>(
    ...
    buildKeywordMap(std::vector<const char*>(
      keywordsTraceFull,
      keywordsTraceFull + sizeof(keywordsTraceFull) / sizeof(const char*)))));
