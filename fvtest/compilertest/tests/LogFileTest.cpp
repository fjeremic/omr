 ...
 */
void TestCompiler::LogFileTest::createLog(std::string logFile, const char* logType)
{
 ...
 *        with that log type.
 */
void TestCompiler::LogFileTest::runKeywordTests(std::map<const char*, std::map<const char*, bool>> logFileChecks)
{
 ...
 */
void TestCompiler::LogFileTest::checkLogForKeywords(std::map<const char*, bool> keywords, const char* logFile)
{
 ...
 */
void TestCompiler::LogFileTest::forkAndCompile(std::string logFile, const char* logType)
{
...
TEST_F(LogFileTest, KeywordsLogTest)
{
   ...
   */
    ...
    logFileChecks.insert(std::pair<const char*, std::map<const char*, bool>>("traceFull", buildKeywordMap(std::vector<const char*>(keywordsTraceFull, keywordsTraceFull + sizeof(keywordsTraceFull) / sizeof(const char*)))));
    const char* keywordsTraceCG[] = { "<codegen" };
    logFileChecks.insert(std::pair<const char*, std::map<const char*, bool>>("traceCG", buildKeywordMap(std::vector<const char*>(keywordsTraceCG, keywordsTraceCG + sizeof(keywordsTraceCG) / sizeof(const char*)))));
