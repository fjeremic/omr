...
private:
  ...
  int32_t basicForLoop(int32_t initial,
                       int32_t final,
                       int32_t bump,
                       bool countsUp);
  int32_t forLoopIfThenElse(int32_t initial,
                            int32_t final,
                            int32_t bump,
                            int32_t compareValue,
                            bool countsUp = true);
  int32_t whileDoIfThenElse(int32_t initial,
                            int32_t final,
                            int32_t bump,
                            int32_t compareValue);
  int32_t doWhileIfThenElse(int32_t initial,
                            int32_t final,
                            int32_t bump,
                            int32_t compareValue);
