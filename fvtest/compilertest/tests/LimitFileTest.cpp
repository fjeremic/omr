 ...
 */
void
TestCompiler::LimitFileTest::generateVLog(const char* vlog,
 ...
 */
void
TestCompiler::LimitFileTest::checkVLogForMethod(const char* vlog,
                                                const char* method,
                                                const char* level,
                                                int* foundOnLine)
{
 ...
 */
void
TestCompiler::LimitFileTest::createAndCheckVLog(const char* vlog,
                                                const char* limitFile,
                                                int* methodLine)
{
...
TEST_F(LimitFileTest, UseLimitFileRangeTest)
{
  ...
  std::string limitArg =
    std::string("(") + limitFile + "," + iNegLineStr + "," + iNegLineStr + ")";
