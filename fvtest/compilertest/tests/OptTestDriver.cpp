 ...
 */
void
TestCompiler::OptTestDriver::makeOptimizationStrategyArray(
 ...
 */
void
TestCompiler::OptTestDriver::Verify()
{
  OptimizationStrategy* strategy =
 ...
 */
void
TestCompiler::OptTestDriver::VerifyAndInvoke()
{
  OptimizationStrategy* strategy =
    new OptimizationStrategy[_optimizations.size() + 1];
  makeOptimizationStrategyArray(strategy);
 ...
 */
void
TestCompiler::OptTestDriver::addOptimization(OMR::Optimizations opt)
{
 ...
 */
void
TestCompiler::OptTestDriver::addOptimizations(const OptimizationStrategy* opts)
{
 ...
 */
void
TestCompiler::OptTestDriver::compileTestMethods()
{
