...
public:
  ...
  virtual void iconstParm(uint32_t slot, int32_t value)
  {
    TR_ASSERT(slot > 0 && slot <= _numOptArgs,
      "iconstParm: slot %d should be greater than 0 and less than _numOptArgs %d\n", slot, _numOptArgs);
  ...
  {
    TR_ASSERT(slot > 0 && slot <= _numOptArgs,
      "lconstParm: slot %d should be greater than 0 and less than _numOptArgs %d\n", slot, _numOptArgs);
  ...
  {
    TR_ASSERT(slot > 0 && slot <= _numOptArgs,
      "bconstParm: slot %d should be greater than 0 and less than _numOptArgs %d\n", slot, _numOptArgs);
  ...
  {
    TR_ASSERT(slot > 0 && slot <= _numOptArgs,
      "sconstParm: slot %d should be greater than 0 and less than _numOptArgs %d\n", slot, _numOptArgs);
  ...
  {
    TR_ASSERT(slot > 0 && slot <= _numOptArgs,
      "aconstParm: slot %d should be greater than 0 and less than _numOptArgs %d\n", slot, _numOptArgs);
  ...
  {
    TR_ASSERT(slot > 0 && slot <= _numOptArgs,
      "dconstParm: slot %d should be greater than 0 and less than _numOptArgs %d\n", slot, _numOptArgs);
  ...
  {
    TR_ASSERT(slot > 0 && slot <= _numOptArgs,
      "fconstParm: slot %d should be greater than 0 and less than _numOptArgs %d\n", slot, _numOptArgs);
