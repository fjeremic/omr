...
TR::CodeCacheMemorySegment* TestCompiler::CodeCacheManager::allocateCodeCacheSegment(
...
void TestCompiler::CodeCacheManager::freeCodeCacheSegment(TR::CodeCacheMemorySegment* memSegment)
{
#if defined(OMR_OS_WINDOWS)
