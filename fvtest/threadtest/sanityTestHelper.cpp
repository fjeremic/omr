...
bool
TestNThreadsLooping(unsigned int numThreads,
...
TestLoopingWaitNotify(int runTime)
{
  ...
  CWaitNotifyLooper thread1(
    mon, (unsigned int*)&notifyCount, (unsigned int*)&doneRunningCount);
  CWaitNotifyLooper thread2(
    mon, (unsigned int*)&notifyCount, (unsigned int*)&doneRunningCount);
