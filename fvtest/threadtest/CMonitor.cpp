...
void CMonitor::NotifyAll(void) {
  omrthread_monitor_notify_all(m_monitor);
}

void CMonitor::Notify(void) {
  omrthread_monitor_notify(m_monitor);
}

omrthread_monitor_t CMonitor::GetMonitor(void) const {
  return m_monitor;
}
