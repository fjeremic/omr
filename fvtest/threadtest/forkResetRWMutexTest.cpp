...
static intptr_t
createJoinableThreadNoMacros(omrthread_t* newThread,
...
static void
siblingWriteChild(testdata_rw_t*, int[2]);
static int
siblingWriteMain(void* arg);
static void
parentWriteStart(int forkCount);
static void
parentWriteChild(testdata_rw_t*, int[2]);
static void
childSiblingWriteStart(int forkCount);
static void
childSiblingWriteChild(testdata_rw_t*, int[2]);
static int
childSiblingWriteMain(void* arg);
static void
parentWriteSiblingReadStart(int forkCount);
static void
parentWriteSiblingReadChild(testdata_rw_t*, int[2]);
static int
...
parentWriteSiblingReadStart(int forkCount)
{
  ...
  omrthread_rwmutex_init(
    &testdata.rwmutex, 0, "OMR_TEST ParentWriteSiblingReadLock");
  omrthread_monitor_enter(testdata.monitor);
