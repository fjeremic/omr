...
static void preforkSetup(OMR_VMThread** vmthread,
                         struct OMR_Agent** agent,
                         OMRTestVM* testVM,
                         int pipedata[2]);
static void postForkChild(OMR_VMThread* vmthread,
                          struct OMR_Agent* agent,
                          OMRTestVM* testVM,
                          int pipedata[2]);
static void postForkParent(OMR_VMThread* vmthread,
                           struct OMR_Agent* agent,
                           OMRTestVM* testVM,
                           int pipedata[2]);
...
static omr_error_t setupTestData(TestData* testData,
                                 OMRTestVM* testVM,
                                 int32_t threadCount);
 ...
 */
void postForkChild(OMR_VMThread* vmthread,
                   struct OMR_Agent* agent,
                   OMRTestVM* testVM,
                   int pipedata[2]) {
...
void postForkParent(OMR_VMThread* vmthread,
                    struct OMR_Agent* agent,
                    OMRTestVM* testVM,
                    int pipedata[2]) {
  /*  Fire some trace points! */
