 ...
 */
void postForkChild(OMR_VMThread* vmthread, struct OMR_Agent* agent, OMRTestVM* testVM, int pipedata[2])
{
...
void postForkParent(OMR_VMThread* vmthread, struct OMR_Agent* agent, OMRTestVM* testVM, int pipedata[2])
{
    /*  Fire some trace points! */
    Trc_OMR_Test_Init();
    Trc_OMR_Test_Ptr(vmthread, vmthread);
