    ...
    OMR_VMThread* vmThread, OMR_TI const* ti, omr_error_t expectedRc, BOOLEAN dummyPort, BOOLEAN checkRc)
{
    ...
    if ((processCpuLoad < 0.0) || (processCpuLoad > 1.0)) {
        omrtty_printf("%s:%d callIndex: %d: GetProcessCpuLoad() returned an invalid value, processCpuLoad = %lf ! "
                      "ProcessCpuLoad should be in [0, 1].\n",
 ...
 *	11		/				/			/				NULL		/
 */ doNotExist OMR_THREAD_NOT_ATTACHED** We could call the API 13 times
                in the following sequence to cover the above 11 cases
    : *call 1 --->call 2 --->call 3 --->call 4 --->call 5 --->call 6 --->call 7 -- ->*(valid)(invalid)(valid)(valid)(valid)(invalid)(invalid)
        * --->call 8 --->call 9 --->call 10 ----->call 11 ----->call
            12 ---- > call 13 * (call 8 to 10 valid, single CPU)(no privilege)(unsupported)(NULL thread) * *In this way,
    *case 1 is covered by call 1 to 3, case 2 is covered by call 3 to 5, case 3 is covered by call 3 to * 4,
    ...
    case 10 is covered* by call 12, case 11 is covered by call 13 * *Therefore,
    we should check the return value of the API in the following sequence : *callIndex expected
                                                                            return value covered caseID
                                                                            * 1 OMR_ERROR_RETRY 5
                                                                            * 2 OMR_ERROR_RETRY 4
                                                                            * 3 OMR_ERROR_NONE 1
                                                                            * 4 OMR_ERROR_NONE 3,
