    ...
    PerThreadWrapBuffer* wrapBuffer, UtSubscription* subscriptionID, TracePointCallback userCallback, void* userData)
{
    ...
    if (-1 == record->nextEntry) {
        /*
         * If (record->nextEntry == -1), then this entire buffer is spanned by a tracepoint. Add it to the lastRecord
         * cache.
         * TODO test this
         */
        ...
        /*
         * Cache the data in the record after the last complete tracepoint, in case the last tracepoint wrapped to the
         * next buffer.
         *
