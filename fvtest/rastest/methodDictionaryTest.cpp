...
TEST_F(RASMethodDictionaryTest, Test0)
{
  ...
  OMRTEST_ASSERT_ERROR(OMR_ERROR_RETRY,
    ti->GetMethodDescriptions(vmthread, methodArray, numMethods, (OMR_SampledMethodDescription*)desc, NULL, 0,
  ...
  OMRTEST_ASSERT_ERROR_NONE(ti->GetMethodDescriptions(vmthread, methodArray, numMethods,
    (OMR_SampledMethodDescription*)desc, nameBuffer, sizeof(nameBuffer), &firstRetryMethod, &nameBytesRemaining));
...
TEST_F(RASMethodDictionaryTest, TestNegativeCasesForGetMethodProperties)
{
  ...
  OMRTEST_ASSERT_ERROR(
    OMR_ERROR_NOT_AVAILABLE, ti->GetMethodProperties(vmthread, &getPropertyCount, &getPropertyNames, &getSizeof));
  ...
  OMRTEST_ASSERT_ERROR(
    OMR_ERROR_ILLEGAL_ARGUMENT, ti->GetMethodProperties(vmthread, NULL, &getPropertyNames, &getSizeof));

  /* NULL getPropertyNames */
  OMRTEST_ASSERT_ERROR(
    OMR_ERROR_ILLEGAL_ARGUMENT, ti->GetMethodProperties(vmthread, &getPropertyCount, NULL, &getSizeof));

  /* NULL getSizeof */
  OMRTEST_ASSERT_ERROR(
    OMR_ERROR_ILLEGAL_ARGUMENT, ti->GetMethodProperties(vmthread, &getPropertyCount, &getPropertyNames, NULL));
...
TEST_F(RASMethodDictionaryTest, TestNegativeCasesForGetMethodDescriptions)
{
  ...
  OMRTEST_ASSERT_ERROR(OMR_ERROR_NOT_AVAILABLE,
    ti->GetMethodDescriptions(vmthread, methodArray, numMethods, (OMR_SampledMethodDescription*)desc, nameBuffer,
   ...
   */
  OMRTEST_ASSERT_ERROR(OMR_ERROR_RETRY,
    ti->GetMethodDescriptions(vmthread, methodArray, numMethods, (OMR_SampledMethodDescription*)desc, nameBuffer, 0,
      &firstRetryMethod, &nameBytesRemaining));
  ASSERT_STREQ(origBuffer, nameBuffer);
  ASSERT_EQ((size_t)0, firstRetryMethod);
  ...
  OMRTEST_ASSERT_ERROR(OMR_ERROR_ILLEGAL_ARGUMENT,
    ti->GetMethodDescriptions(vmthread, methodArray, numMethods, (OMR_SampledMethodDescription*)desc, NULL,
      sizeof(nameBuffer), &firstRetryMethod, &nameBytesRemaining));

  /* zero methodArrayCount */
  OMRTEST_ASSERT_ERROR_NONE(ti->GetMethodDescriptions(vmthread, methodArray, (size_t)0,
    (OMR_SampledMethodDescription*)desc, nameBuffer, sizeof(nameBuffer), &firstRetryMethod, NULL));
  ASSERT_STREQ(origBuffer, nameBuffer);

  /* NULL methodArray */
  OMRTEST_ASSERT_ERROR(OMR_ERROR_ILLEGAL_ARGUMENT,
    ti->GetMethodDescriptions(
      vmthread, NULL, numMethods, (OMR_SampledMethodDescription*)desc, nameBuffer, sizeof(nameBuffer), NULL, NULL));

  /* NULL methodDescriptions */
  OMRTEST_ASSERT_ERROR(OMR_ERROR_ILLEGAL_ARGUMENT,
    ti->GetMethodDescriptions(
      vmthread, methodArray, numMethods, NULL, nameBuffer, sizeof(nameBuffer), &firstRetryMethod, &nameBytesRemaining));
...
TEST_F(RASMethodDictionaryTest, TestUndersizedNameBytes)
{
  ...
  OMRTEST_ASSERT_ERROR_NONE(
    ti->GetMethodDescriptions(vmthread, methodArray, numMethods, (OMR_SampledMethodDescription*)desc, newNameBuffer,
      sizeof(newNameBuffer), &newFirstRetryMethod, &newNameBytesRemaining));
...
TEST_F(RASMethodDictionaryTest, TestUndersizedMethodArrayCount)
{
  ...
  OMRTEST_ASSERT_ERROR_NONE(ti->GetMethodDescriptions(vmthread, methodArray, numMethods - 1,
    (OMR_SampledMethodDescription*)desc, nameBuffer, sizeof(nameBuffer), NULL, NULL));
  ASSERT_STRNE(origBuffer, nameBuffer);
