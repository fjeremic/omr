...
protected:
  virtual void SetUp()
  {
    ...
    OMRTEST_ASSERT_ERROR_NONE(
      OMR_Thread_Init(&testVM.omrVM, NULL, &vmthread, "methodDictionaryTest"));
    ti = omr_agent_getTI();
  }
...
{
  OMRTEST_ASSERT_ERROR_NONE(
    omr_ras_initMethodDictionary(&testVM.omrVM, propertyCount, propertyNames));
  ...
  void* methodArray[numMethods] = {
    (void*)0, (void*)2, (void*)3, (void*)4, (void*)1
  };
...
TEST_F(RASMethodDictionaryTest, TestNegativeCasesForGetMethodProperties)
{
  ...
  OMRTEST_ASSERT_ERROR(OMR_ERROR_ILLEGAL_ARGUMENT,
                       ti->GetMethodProperties(
                         vmthread, &getPropertyCount, &getPropertyNames, NULL));
