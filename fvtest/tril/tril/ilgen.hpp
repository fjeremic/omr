...
class TRLangBuilder : public TR::IlInjector {
 public:
   ...
   * @param trees is the list of AST nodes representing the TR::Node instances
   * to be generated
 ...
 private:
  ...
  std::map<std::string, TR::SymbolReference*>
      _symRefMap;  // mapping of string names to symrefs
  std::map<std::string, int>
      _blockMap;  // mapping of string names to basic block numbers
