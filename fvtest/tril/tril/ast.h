...
extern "C"
{
  ...
  /*
   * This file contains declarations that act as a C wrapper around the Tril AST
   * interface. This wrapper is mainly used by the parser.
   */
  ...
  ASTNode* createNode(const char* name,
                      ASTNodeArg* args,
                      ASTNode* children,
                      ASTNode* next);

  ASTNodeArg* createNodeArg(const char* name,
                            ASTValue* value,
                            ASTNodeArg* next);
  ...
  /**
   * @brief Searches a (linked-) list for an instance of ASTNode with a given
   * name
  ...
  /**
   * @brief Searches an AST sub-tree for an instance of ASTNode with a given
   * name
