...
{
    return (tokenIt->getType() == Token::DOUBLE_ || tokenIt->getType() == Token::INT || tokenIt->getType() == Token::STRING_ || tokenIt->getType() == Token::HEXINT || tokenIt->getType() == Token::ZERO || tokenIt->getType() == Token::ID);
}
