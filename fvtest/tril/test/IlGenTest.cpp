...
// This test is currently broken on AIX, since it is not valid to use the return
// value of compileMethodFromDetails as a function pointer.
#if !defined(AIXPPC)
TEST_F(IlGenTest, Return3) {
  ...
  TR::ResolvedMethod compilee(__FILE__, LINETOSTR(__LINE__), "Return3InIL",
                              sizeof(argTypes) / sizeof(TR::IlType*), argTypes,
                              Int32, 0, &injector);
