...
static uintptr_t variableDynamicSharedMemorySize(uint32_t blockSize, uintptr_t userData)
{
 ...
 */
void CudaDeviceTest::testFunction(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaFunction function)
{
...

  {
    ...
    int32_t rc = omrcuda_funcMaxPotentialBlockSize(
      deviceId, function, NULL, fixedDynamicSharedMemorySize, blockSizeLimit, flags, &minGridSize, &maxBlockSize);
