 ...
 */
static void
fileWrite(struct OMRPortLibrary* portLibrary,
          intptr_t fd,
          const char* format,
          ...)
{
...
intptr_t
omrfile_open_helper(struct OMRPortLibrary* portLibrary,
                    const char* path,
                    int32_t flags,
                    int32_t mode)
{
...
int32_t
omrfile_lock_bytes_helper(struct OMRPortLibrary* portLibrary,
                          intptr_t fd,
                          int32_t lockFlags,
                          uint64_t offset,
                          uint64_t length)
...
int32_t
omrfile_unlock_bytes_helper(struct OMRPortLibrary* portLibrary,
                            intptr_t fd,
                            uint64_t offset,
                            uint64_t length)
{
...
intptr_t
omrfile_read_helper(struct OMRPortLibrary* portLibrary,
                    intptr_t fd,
                    void* buf,
                    intptr_t nbytes)
{
...
intptr_t
omrfile_write_helper(struct OMRPortLibrary* portLibrary,
                     intptr_t fd,
                     void* buf,
                     intptr_t nbytes)
{
...
int32_t
omrfile_set_length_helper(struct OMRPortLibrary* portLibrary,
                          intptr_t fd,
                          I_64 newLength)
{
  OMRPORT_ACCESS_FROM_OMRPORT(portLibrary);
...
TEST_F(PortFileTest2, file_test3)
{
  ...
  fd1 =
    FILE_OPEN_FUNCTION(OMRPORTLIB, file1name, EsOpenCreate | EsOpenWrite, 0666);

  if (-1 == fd1) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "%s() failed\n", FILE_OPEN_FUNCTION_NAME);
    goto exit;
  }
 ...
 */
void
openFlagTest(struct OMRPortLibrary* portLibrary,
             const char* testName,
             const char* pathName,
             int32_t flags,
             int32_t mode)
{
  ...
  if (rc >= 0) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "omrfile_stat() returned %d, expected %d\n", rc, -1);
  }
...
TEST_F(PortFileTest2, file_test5)
{
   ...
   * attributes too */
  fd = FILE_OPEN_FUNCTION(
    OMRPORTLIB, fileName, EsOpenCreate | EsOpenRead | EsOpenWrite, 0666);
  if (-1 == fd) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
  ...
  if (rc != 0) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "omrfile_unlink() returned %d expected %d\n", rc, 0);
  }
...
TEST_F(PortFileTest2, file_test6)
{
  ...
  fd1 = FILE_OPEN_FUNCTION(
    OMRPORTLIB, path1, EsOpenCreateNew | EsOpenRead | EsOpenWrite, 0666);
  if (-1 == fd1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
   ...
   */
  fd1 =
    FILE_OPEN_FUNCTION(OMRPORTLIB, path1, EsOpenCreateNew | EsOpenWrite, 0666);
  if (-1 != fd1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "%s() returned valid file handle expected -1\n",
                       FILE_OPEN_FUNCTION_NAME);
  ...
  */
  ...
  openFlagTest(OMRPORTLIB,
               testName,
               path3,
               EsOpenAppend | EsOpenCreate | EsOpenWrite,
               0666);

  /* flags = EsOpenText */
  openFlagTest(
    OMRPORTLIB, testName, path3, EsOpenText | EsOpenCreate | EsOpenWrite, 0666);
...
TEST_F(PortFileTest2, file_test7)
{
  ...
  fd =
    FILE_OPEN_FUNCTION(OMRPORTLIB, fileName, EsOpenWrite | EsOpenCreate, 0666);
  if (-1 == fd) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "%s() returned %d expected valid file handle\n",
                       FILE_OPEN_FUNCTION_NAME,
...
TEST_F(PortFileTest2, file_test8)
{
  ...
  fd = FILE_OPEN_FUNCTION(
    OMRPORTLIB, fileName, EsOpenWrite | EsOpenCreate | EsOpenTruncate, 0666);
  if (-1 == fd) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "%s() returned %d expected valid file handle\n",
                       FILE_OPEN_FUNCTION_NAME,
  ...
  if (prevFilePtr + expectedReturnValue != filePtr) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       ...
                       prevFilePtr + expectedReturnValue,
                       filePtr);
  }
  ...
  fd =
    FILE_OPEN_FUNCTION(OMRPORTLIB, fileName, EsOpenWrite | EsOpenAppend, 0666);
...
TEST_F(PortFileTest2, file_test9)
{
  ...
  for (i = 0; i < numberIterations; i++) {
    ...
    fd = FILE_OPEN_FUNCTION(
      OMRPORTLIB, fileName, EsOpenCreate | EsOpenWrite | EsOpenAppend, 0666);
    if (-1 == fd) {
      outputErrorMessage(
        PORTTEST_ERROR_ARGS,
...
TEST_F(PortFileTest2, file_test10)
{
   ...
   */
  rc = FILE_WRITE_FUNCTION(
    OMRPORTLIB, fd, (char*)"X", 1); /* Note this should just do 1 character X*/
  if (1 != rc) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "%s() returned %d expected 1\n",
                       FILE_WRITE_FUNCTION_NAME,
                       rc);
    goto exit;
  }
...
TEST_F(PortFileTest2, file_test11)
{
  ...
  if (0 != rc) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "omrfile_mkdir() returned %d expected %d\n", rc, 0);
  }
  ...
  if (0 != rc) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "omrfile_unlinkdir() returned %d expected 0\n", rc);
    goto exit;
  }
...
TEST_F(PortFileTest2, file_test12)
{
  ...
  if (0 != rc) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "omrfile_mkdir() returned %d expected 0\n", rc);
    goto exit;
  }

  /* create some files within directory */
  fd1 =
    FILE_OPEN_FUNCTION(OMRPORTLIB, pathName1, EsOpenCreate | EsOpenWrite, 0666);
  if (-1 == fd1) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "%s() failed\n", FILE_OPEN_FUNCTION_NAME);
    goto exit;
  ...
  fd2 =
    FILE_OPEN_FUNCTION(OMRPORTLIB, pathName2, EsOpenCreate | EsOpenWrite, 0666);
  if (-1 == fd2) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "%s() failed\n", FILE_OPEN_FUNCTION_NAME);
    goto exit;
  ...
  if (-1 != rc) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "omrfile_unlink() returned %d expected -1\n", rc);
    goto exit;
  }
  ...
  if (0 != rc) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "omrfile_unlink() returned %d expected 0\n", rc);
    goto exit;
  }
  ...
  if (0 == rc) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "omrfile_unlinkdir() returned %d expected -1\n", rc);
    goto exit;
  }
...
TEST_F(PortFileTest2, file_test14)
{
  ...
  fd1 =
    FILE_OPEN_FUNCTION(OMRPORTLIB, pathName1, EsOpenWrite | EsOpenCreate, 0666);
  if (-1 == fd1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "%s() returned %d expected valid file handle\n",
                       FILE_OPEN_FUNCTION_NAME,
  ...
  /* try opening a "new" file - if file exists then should still work */
  fd2 =
    FILE_OPEN_FUNCTION(OMRPORTLIB, pathName2, EsOpenWrite | EsOpenCreate, 0666);
  if (-1 == fd2) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "%s() returned %d expected valid file handle\n",
                       FILE_OPEN_FUNCTION_NAME,
...
TEST_F(PortFileTest2, file_test18)
{
  ...
  lockRc = FILE_LOCK_BYTES_FUNCTION(OMRPORTLIB,
                                    fd,
                                    OMRPORT_FILE_READ_LOCK |
                                      OMRPORT_FILE_NOWAIT_FOR_LOCK,
                                    offset,
                                    length);
...
TEST_F(PortFileTest2, file_test20)
{
  ...
  pid1 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test20_1");
  if (NULL == pid1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
  ...
  pid2 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test20_2");
  if (NULL == pid2) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
...
TEST_F(PortFileTest2, file_test21)
{
  ...
  pid1 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test21_1");
  if (NULL == pid1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid1!\n");
    goto exit;
  ...
  pid2 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test21_2");
  if (NULL == pid2) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid2!\n");
    goto exit;
...
TEST_F(PortFileTest2, file_test22)
{
  ...
  pid1 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test22_1");
  if (NULL == pid1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid1!\n");
    goto exit;
  ...
  pid2 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test22_2");
  if (NULL == pid2) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid2!\n");
    goto exit;
...
TEST_F(PortFileTest2, file_test23)
{
  ...
  pid1 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test23_1");
  if (NULL == pid1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid1!\n");
    goto exit;
  ...
  pid2 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test23_2");
  if (NULL == pid2) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid2!\n");
    goto exit;
...
TEST_F(PortFileTest2, file_test24)
{
  ...
  pid1 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test24_1");
  if (NULL == pid1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid1!\n");
    goto exit;
  ...
  pid2 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test24_2");
  if (NULL == pid2) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid2!\n");
    goto exit;
...
TEST_F(PortFileTest2, file_test25)
{
  ...
  pid1 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test25_1");
  if (NULL == pid1) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid1!\n");
    goto exit;
  ...
  pid2 =
    launchChildProcess(OMRPORTLIB, testName, argv0, "-child_omrfile_test25_2");
  if (NULL == pid2) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "launchChildProcess() failed for pid2!\n");
    goto exit;
...
omrfile_test25_child_1(OMRPortLibrary* portLibrary)
{
  ...
  portTestEnv->log(
    "Child 1: Got read lock on bytes %lld for %lld\n", offset, length);
  ...
  portTestEnv->log(
    "Child 1: Released read lock on bytes %lld for %lld\n", offset, length);
  ...
  portTestEnv->log(
    "Child 1: Got write lock on bytes %lld for %lld\n", (offset + 2), length);
...
omrfile_test25_child_2(OMRPortLibrary* portLibrary)
{
  ...
  portTestEnv->log(
    "Child 2: Trying for write lock on bytes %lld for %lld\n", offset, length);
  omrfile_create_status_file(OMRPORTLIB, testFileTry, testName);
  ...
  portTestEnv->log(
    "Child 2: Got write lock on bytes %lld for %lld\n", offset, length);
  ...
  portTestEnv->log(
    "Child 2: Released write lock on bytes %lld for %lld\n", offset, length);
...
#define nModes 22
   ...
   */
  int32_t testModes[nModes] = { 0,     1,     2,     4,    6,    7,
                                010,   020,   040,   070,  0100, 0200,
                                0400,  0700,  0666,  0777, 0755, 0644,
                                02644, 04755, 06600, 04777 };
  ...
  fd1 = FILE_OPEN_FUNCTION(
    OMRPORTLIB, localFilename, EsOpenCreate | EsOpenWrite, 0666);
  if (-1 == fd1) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "%s() failed\n", FILE_OPEN_FUNCTION_NAME);
  } else {
...
#define nModes 22
  int32_t testModes[nModes] = { 0,     1,     2,     4,    6,    7,
                                01010, 02020, 04040, 070,  0100, 0200,
                                0400,  0700,  0666,  0777, 0755, 0644,
                                01644, 02755, 03600, 07777 };
...
TEST_F(PortFileTest2, file_test30)
{
  ...
  validFileFd =
    FILE_OPEN_FUNCTION(OMRPORTLIB,
                       validFilename,
                       EsOpenCreateNew | EsOpenWrite | EsOpenTruncate,
                       0666);
  if (-1 == validFileFd) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS,
  ...
  invalidFileFd =
    FILE_OPEN_FUNCTION(OMRPORTLIB,
                       illegalFileName,
                       EsOpenCreateNew | EsOpenRead | EsOpenTruncate,
                       0666);
  if (-1 == invalidFileFd) {
    int32_t lastErrorNumber = omrerror_last_error_number();
...
TEST_F(PortFileTest2, file_test31)
{
  ...
  fileFd = FILE_OPEN_FUNCTION(
    OMRPORTLIB, filename, EsOpenCreateNew | EsOpenWrite | EsOpenTruncate, 0666);
  if (-1 == fileFd) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS,
      "%s failed to create file %s: error_last_error_number %i\n",
...
TEST_F(PortFileTest2, file_test32)
{
  OMRPORT_ACCESS_FROM_OMRPORT(portTestEnv->getPortLibrary());
  const char* testName =
    APPEND_ASYNC(omrfile_test32_test_file_permission_bits_using_omrfile_stat());
  ...
  if (fd == -1) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "%s() file open failed\n", FILE_OPEN_FUNCTION_NAME);
    goto done;
  }
  FILE_CLOSE_FUNCTION(OMRPORTLIB, fd);
#if defined(OMR_OS_WINDOWS)
  ...
  omrfile_unlink(localFilename);
  fd = FILE_OPEN_FUNCTION(
    OMRPORTLIB, localFilename, EsOpenCreate | EsOpenRead, 0444);
  ...
  omrfile_unlink(localFilename);
  fd = FILE_OPEN_FUNCTION(
    OMRPORTLIB, localFilename, EsOpenCreate | EsOpenWrite, 0222);
  if (fd == -1) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS, "%s() file open failed\n", FILE_OPEN_FUNCTION_NAME);
    goto done;
...
TEST_F(PortFileTest2, file_test33)
{
  ...
  const unsigned char three_byte_utf8[] = {
    0xE2, 0x82, 0xAC, '\n'
  }; /* U+20AC ???*/
  const unsigned char four_byte_utf8[] = {
    0xF0, 0xA4, 0xAD, 0xA2, '\n'
  }; /* U+024B62 beyond BMP */
  ...
  omrfile_write_text(1,
                     (const char*)three_byte_utf8,
                     sizeof(char) *
                       4); /* Unicode string representation should be printed */
  omrfile_write_text(1,
                     (const char*)four_byte_utf8,
                     sizeof(char) * 5); /* '????' should be printed */
  omrfile_write_text(1,
                     (const char*)invalid_byte_utf8,
                     sizeof(char) * 3); /* '??' should be printed */
  omrfile_write_text(
    1,
    (const char*)many_byte_utf8,
...
#define FILENAME_LENGTH                                                        \
  ...
  for (i = 0; i < 2; i++) {
    ...
    while (strlen(filePathName) < MIN_LENGTH) {
      ...
      omrstr_printf(filePathName + strlen(filePathName),
                    FILENAME_LENGTH - strlen(filePathName),
                    "%s",
                    longDirName);
    ...
    fd = FILE_OPEN_FUNCTION(
      OMRPORTLIB, filePathName, EsOpenCreate | EsOpenWrite, 0666);
    if (-1 == fd) {
      outputErrorMessage(
        PORTTEST_ERROR_ARGS, "%s() failed\n", FILE_OPEN_FUNCTION_NAME);
      goto exit;
  ...
  exit:
    ...
    if (0 != unlinkRc) {
      outputErrorMessage(
        PORTTEST_ERROR_ARGS, "omrfile_unlink failed: %s\n", filePathName);
    }
...
#define J9FILETEST_FILESIZE 1000 * 512
  ...
  if (0 != rc) {
    portTestEnv->log(
      LEVEL_ERROR, "first omrfile_stat() returned %d, expected %d\n", rc, 0);
    returnCode = TEST_FAIL;
    goto exit;
  }
  ...
  if (NULL == stringToWrite) {
    portTestEnv->log(
      LEVEL_ERROR, "Failed to allocate %zu bytes\n", J9FILETEST_FILESIZE);
    returnCode = TEST_FAIL;
    goto exit;
  }
  ...
  if (buf_before.totalSizeBytes != buf_after.totalSizeBytes) {
    portTestEnv->log(
      ...
      buf_before.totalSizeBytes,
      buf_after.totalSizeBytes);
    returnCode = TEST_FAIL;
    goto exit;
  }
...
exit:
  ...
  if (-1 != fd) {
    ...
    if (0 != rc) {
      portTestEnv->log(
        LEVEL_ERROR, "omrfile_unlink() returned %d expected %d\n", rc, 0);
    }
  }
...
TEST_F(PortFileTest2, file_test35)
{
  ...
  fd =
    FILE_OPEN_FUNCTION(OMRPORTLIB, fileName, EsOpenCreate | EsOpenWrite, 0666);
  if (-1 == fd) {
    outputErrorMessage(PORTTEST_ERROR_ARGS,
                       "%s() returned -1 expected valid file handle",
                       FILE_OPEN_FUNCTION_NAME);
...
TEST_F(PortFileTest2, file_test36)
{
  ...
  if (omrfileFD == OMRPORT_INVALID_FD) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS,
      "j9fileFD == J9PORT_INVALID_FD, they should be the same. j9fileFD: %x\n",
      omrfileFD);
  }
...
TEST_F(PortFileTest2, file_test37)
{
  ...
  if (rc >= 0) {
    outputErrorMessage(
      PORTTEST_ERROR_ARGS,
      "Negative test failure: omrfile_fstat(-1, ..) on invalid file descriptor "
      "is expected to fail but it returned success with rc=%d (ignore the "
      "following LastErrorNumber and LastErrorMessage)\n",
      rc);
  }
...
TEST_F(PortFileTest2, file_test39)
{
  ...
  mode = 0666;
  fd =
    FILE_OPEN_FUNCTION(OMRPORTLIB, filename, EsOpenCreate | EsOpenWrite, mode);
  if (-1 != fd) {
    rc = omrfile_fstat(fd, &stat);
    if (0 != rc) {
      outputErrorMessage(PORTTEST_ERROR_ARGS,
 ...
 */
int32_t
omrfile_runTests(struct OMRPortLibrary* portLibrary,
                 char* argv0,
                 char* omrfile_child,
                 BOOLEAN async)
{
