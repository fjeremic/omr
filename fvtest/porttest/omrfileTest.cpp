 ...
 */
static void fileWrite(struct OMRPortLibrary* portLibrary,
                      intptr_t fd,
                      const char* format,
                      ...) {
...
intptr_t omrfile_read_helper(struct OMRPortLibrary* portLibrary,
                             intptr_t fd,
                             void* buf,
                             intptr_t nbytes) {
  OMRPORT_ACCESS_FROM_OMRPORT(portLibrary);
...
intptr_t omrfile_write_helper(struct OMRPortLibrary* portLibrary,
                              intptr_t fd,
                              void* buf,
                              intptr_t nbytes) {
  OMRPORT_ACCESS_FROM_OMRPORT(portLibrary);
...
/**
 */
void openFlagTest(struct OMRPortLibrary* portLibrary,
                  const char* testName,
                  const char* pathName,
                  int32_t flags,
                  int32_t mode) {
 ...
 *
 */
intptr_t omrfile_create_file(OMRPortLibrary* portLibrary,
                             const char* filename,
                             int32_t openMode,
                             const char* testName) {
  OMRPORT_ACCESS_FROM_OMRPORT(portLibrary);
 ...
 */
int32_t omrfile_runTests(struct OMRPortLibrary* portLibrary,
                         char* argv0,
                         char* omrfile_child,
                         BOOLEAN async) {
  OMRPORT_ACCESS_FROM_OMRPORT(portLibrary);
