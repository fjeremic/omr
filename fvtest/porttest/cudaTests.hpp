...
class CudaTest : public ::testing::Test {
 ...
 protected:
  ...
  static bool fillVerify(const void *buffer, uintptr_t size, const void *fill,
                         uintptr_t fillSize);
...
class CudaDeviceTest : public CudaTest {
 protected:
  ...
  static void testFunction(OMRPortLibrary *portLibrary, uint32_t deviceId,
                           J9CudaFunction function);

  static void testPeerTransfer(OMRPortLibrary *portLibrary, uint32_t deviceId,
