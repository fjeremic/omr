...
const CudaTestArray<char> CudaDeviceTest::ptxFragment1 =
  PTX_INIT(fragment1_code);
const CudaTestArray<char> CudaDeviceTest::ptxFragment2 =
  PTX_INIT(fragment2_code);
const CudaTestArray<char> CudaDeviceTest::ptxModule = PTX_INIT(module_code);
const CudaTestArray<char> CudaDeviceTest::ptxParameters =
  PTX_INIT(parameters_code);
