 ...
 * @return TEST_PASS on success, TEST_FAIL on error
 */
static int omrvmem_testReserveMemoryEx_impl(struct OMRPortLibrary* portLibrary,
                                            const char* testName,
                                            BOOLEAN topDown,
                                            BOOLEAN quickSearch,
                                            BOOLEAN strictAddress,
...
TEST(PortVmemTest, vmem_test_numa) {
  ...
  if ((detailReturnCode != 0) || (0 == totalNumaNodeCount)) {
    ...
    J9MemoryNodeDetail* nodeArray = (J9MemoryNodeDetail*)omrmem_allocate_memory(
...
void verifyFindValidPageSizeOutput(struct OMRPortLibrary* portLibrary,
                                   const char* testName,
