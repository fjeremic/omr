...
static const Attribute deviceAttributes[] = {
  ATTRIBUTE_ENTRY(ASYNC_ENGINE_COUNT, 0, 2), ATTRIBUTE_ENTRY(CAN_MAP_HOST_MEMORY, 0, 1),
  ATTRIBUTE_ENTRY(CLOCK_RATE /*kHz*/, 0, 5 * 1024 * 1024), ATTRIBUTE_ENTRY(COMPUTE_CAPABILITY, 0, 70),
  ATTRIBUTE_ENTRY(COMPUTE_CAPABILITY_MAJOR, 0, 7), ATTRIBUTE_ENTRY(COMPUTE_CAPABILITY_MINOR, 0, 5),
  ATTRIBUTE_ENTRY(COMPUTE_MODE, 0, 3), ATTRIBUTE_ENTRY(CONCURRENT_KERNELS, 0, 1), ATTRIBUTE_ENTRY(ECC_ENABLED, 0, 1),
  ATTRIBUTE_ENTRY(GLOBAL_MEMORY_BUS_WIDTH, 128, 384), ATTRIBUTE_ENTRY(INTEGRATED, 0, 1),
  ATTRIBUTE_ENTRY(KERNEL_EXEC_TIMEOUT, 0, 1), ATTRIBUTE_ENTRY(L2_CACHE_SIZE, 0, 4 * 1024 * 1024),
  ATTRIBUTE_ENTRY(MAX_BLOCK_DIM_X, 512, 1024), ATTRIBUTE_ENTRY(MAX_BLOCK_DIM_Y, 512, 1024),
  ATTRIBUTE_ENTRY(MAX_BLOCK_DIM_Z, 64, 64), ATTRIBUTE_ENTRY(MAX_GRID_DIM_X, 65535, 2147483647),
  ATTRIBUTE_ENTRY(MAX_GRID_DIM_Y, 65535, 65535), ATTRIBUTE_ENTRY(MAX_GRID_DIM_Z, 1, 65535),
  ATTRIBUTE_ENTRY(MAXIMUM_SURFACE1D_LAYERED_LAYERS, 0, 2 * 1024),
  ATTRIBUTE_ENTRY(MAXIMUM_SURFACE1D_LAYERED_WIDTH, 0, 64 * 1024),
  ATTRIBUTE_ENTRY(MAXIMUM_SURFACE1D_WIDTH, 0, 64 * 1024), ATTRIBUTE_ENTRY(MAXIMUM_SURFACE2D_HEIGHT, 0, 64 * 1024),
  ...
  ATTRIBUTE_ENTRY(MAXIMUM_SURFACE2D_WIDTH, 0, 64 * 1024), ATTRIBUTE_ENTRY(MAXIMUM_SURFACE3D_DEPTH, 0, 4 * 1024),
  ATTRIBUTE_ENTRY(MAXIMUM_SURFACE3D_HEIGHT, 0, 32 * 1024), ATTRIBUTE_ENTRY(MAXIMUM_SURFACE3D_WIDTH, 0, 64 * 1024),
  ...
  ATTRIBUTE_ENTRY(MAXIMUM_TEXTURECUBEMAP_WIDTH, 0, 16 * 1024), ATTRIBUTE_ENTRY(MAX_PITCH, 2147483647, 2147483647),
  ATTRIBUTE_ENTRY(MAX_REGISTERS_PER_BLOCK, 16 * 1024, 64 * 1024),
  ATTRIBUTE_ENTRY(MAX_SHARED_MEMORY_PER_BLOCK, 16 * 1024, 64 * 1024),
  ATTRIBUTE_ENTRY(MAX_THREADS_PER_BLOCK, 512, 1 * 1024), ATTRIBUTE_ENTRY(MAX_THREADS_PER_MULTIPROCESSOR, 512, 2 * 1024),
  ATTRIBUTE_ENTRY(MEMORY_CLOCK_RATE /*kHz*/, 500 * 1024, 6 * 1024 * 1024), ATTRIBUTE_ENTRY(MULTIPROCESSOR_COUNT, 1, 64),
  ATTRIBUTE_ENTRY(PCI_BUS_ID, 0, 255), ATTRIBUTE_ENTRY(PCI_DEVICE_ID, 0, 31), ATTRIBUTE_ENTRY(PCI_DOMAIN_ID, 0, 255),
  ATTRIBUTE_ENTRY(STREAM_PRIORITIES_SUPPORTED, 0, 1), ATTRIBUTE_ENTRY(SURFACE_ALIGNMENT, 1, 1 * 1024),
  ATTRIBUTE_ENTRY(TCC_DRIVER, 0, 1), ATTRIBUTE_ENTRY(TEXTURE_ALIGNMENT, 256, 1 * 1024),
  ATTRIBUTE_ENTRY(TEXTURE_PITCH_ALIGNMENT, 32, 1 * 1024), ATTRIBUTE_ENTRY(TOTAL_CONSTANT_MEMORY, 64 * 1024, 64 * 1024),
  ATTRIBUTE_ENTRY(UNIFIED_ADDRESSING, 0, 1), ATTRIBUTE_ENTRY(WARP_SIZE, 32, 32),
...
const Limit deviceLimits[] = {
  LIMIT_ENTRY(DEV_RUNTIME_PENDING_LAUNCH_COUNT, 35, 4, 4 * 1024), LIMIT_ENTRY(DEV_RUNTIME_SYNC_DEPTH, 35, 0, 16),
  LIMIT_ENTRY(MALLOC_HEAP_SIZE, 20, 4 * 1024, 16 * 1024 * 1024),
  LIMIT_ENTRY(PRINTF_FIFO_SIZE, 20, 4 * 1024, 8 * 1024 * 1024), LIMIT_ENTRY(STACK_SIZE, 20, 1 * 1024, 256 * 1024),
