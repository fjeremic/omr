...
static void freeMemPointers(struct OMRPortLibrary* portLibrary,
                            void** memPtrs,
                            uintptr_t length);
static void shuffleArray(struct OMRPortLibrary* portLibrary,
                         uintptr_t* sizes,
                         uintptr_t length);
 ...
 */
static uintptr_t categoryWalkFunction2(uint32_t categoryCode,
                                       const char* categoryName,
                                       uintptr_t liveBytes,
                                       uintptr_t liveAllocations,
                                       BOOLEAN isRoot,
