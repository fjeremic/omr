...
public:
  ...
  void setLength(int64_t lengthIn)
  {
    length = lengthIn;
  }
  void setWidth(int64_t widthIn)
  {
    width = widthIn;
  }
  void setHeight(int64_t heightIn)
  {
    height = heightIn;
  }
  uint64_t getVolume()
...
public:
  ...
  void setRed(int64_t redIn)
  {
    red = (uint8_t)redIn;
  }
  void setGreen(int64_t greenIn)
  {
    green = (uint8_t)greenIn;
  }
  void setBlue(int64_t blueIn)
  {
    blue = (uint8_t)blueIn;
  }
};
