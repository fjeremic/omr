...
struct SArrayWithTypedefType instanceOfSArrayWithTypedefType = {
...
sample3()
{
  std::cout << "\ninstanceOfS3.q: " << (unsigned int)instanceOfS3.q
            << std::endl;
  ...
  std::cout << "matchboxCar.durability: " << matchboxCar.durability
            << std::endl;
  std::cout << "matchboxCar.hasWheels: " << matchboxCar.hasWheels << std::endl;

  std::cout << "functionPointer: " << structFunctionPointer.functionPointer
            << std::endl;
}
