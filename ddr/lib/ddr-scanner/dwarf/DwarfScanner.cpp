...
DDR_RC
DwarfScanner::getTypeInfo(Dwarf_Die die,
                          Dwarf_Die* dieOut,
                          string* typeName,
                          Modifiers* modifiers,
                          size_t* typeSize,
 ...
 */
DDR_RC
DwarfScanner::addDieToIR(Dwarf_Die die,
                         Dwarf_Half tag,
 ...
 */
DDR_RC
DwarfScanner::getOrCreateNewType(Dwarf_Die die,
                                 Dwarf_Half tag,
                                 Type** newType,
                                 NamespaceUDT* outerUDT,
                                 bool* isNewType) {
 ...
 */
DDR_RC
DwarfScanner::createNewType(Dwarf_Die die,
                            Dwarf_Half tag,
                            const char* dieName,
                            Type** newType) {
  DDR_RC rc = DDR_RC_OK;
...
DDR_RC
DwarfScanner::addEnumMember(Dwarf_Die die,
                            NamespaceUDT* outerUDT,
                            EnumUDT* newEnum) {
  Dwarf_Attribute attr = NULL;
  string enumName = "";
...
static bool getUdata(Dwarf_Small** value,
                     Dwarf_Unsigned* len,
...
static bool evaluateOffset(Dwarf_Ptr expr,
                           Dwarf_Unsigned len,
...
DDR_RC
DwarfScanner::addClassField(Dwarf_Die die,
                            ClassType* newClass,
...
DDR_RC
DwarfScanner::startScan(OMRPortLibrary* portLibrary,
                        Symbol_IR* ir,
...
DDR_RC
DwarfScanner::scanFile(OMRPortLibrary* portLibrary,
                       Symbol_IR* ir,
                       const char* filepath) {
