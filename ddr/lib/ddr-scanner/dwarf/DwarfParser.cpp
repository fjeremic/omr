...
static int parseDwarfInfo(char* line,
                          Dwarf_Die* lastCreatedDie,
...
static int parseDwarfDie(char* line,
                         Dwarf_Die* lastCreatedDie,
                         Dwarf_Die* currentDie,
                         size_t* lastIndent,
                         size_t spaces,
...
static int parseAttribute(char* line,
                          Dwarf_Die* lastCreatedDie,
                          unordered_map<Dwarf_Die*, Dwarf_Off>* refToPopulate,
                          Dwarf_Error* error);
static void parseAttrType(char* string,
                          size_t length,
                          Dwarf_Half* type,
                          Dwarf_Half* form);
...
static int parseCompileUnit(char* line,
                            size_t* lastIndent,
                            Dwarf_Error* error) {
...
static const tuple<const char*, Dwarf_Half, Dwarf_Half> attrStrings[] = {
    ...
    make_tuple("data_member_location",
