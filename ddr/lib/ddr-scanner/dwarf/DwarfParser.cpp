...
static int parseDwarfDie(
  char* line, Dwarf_Die* lastCreatedDie, Dwarf_Die* currentDie, size_t* lastIndent, size_t spaces, Dwarf_Error* error);
static void parseTagString(char* string, size_t length, Dwarf_Half* tag);
static int parseAttribute(
