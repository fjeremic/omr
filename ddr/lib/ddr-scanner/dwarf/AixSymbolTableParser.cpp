...
static int parseArray(const string data,
                      Dwarf_Die currentDie,
                      Dwarf_Error* error);
static int parseBaseType(const string data,
                         Dwarf_Die currentDie,
                         Dwarf_Error* error);
static int parseNamelessReference(const string data,
                                  Dwarf_Die currentDie,
                                  Dwarf_Error* error);
...
static Dwarf_Half parseDeclarationLine(string data,
                                       int* typeID,
                                       declFormat* format,
                                       string* declarationData,
                                       string* name);
static int parseEnum(const string data,
                     string dieName,
                     Dwarf_Die currentDie,
                     Dwarf_Error* error);
static int parseFields(const string data,
                       Dwarf_Die currentDie,
                       Dwarf_Error* error);
static int parseCPPstruct(const string data,
                          const string dieName,
                          Dwarf_Die currentDie,
                          Dwarf_Error* error);
static int parseCstruct(const string data,
                        const string dieName,
                        Dwarf_Die currentDie,
                        Dwarf_Error* error);
static int parseTypeDef(const string data,
                        const string dieName,
                        Dwarf_Die currentDie,
                        Dwarf_Error* error);
...
static int setDieAttributes(const string dieName,
 ...
 */
static Dwarf_Half parseDeclarationLine(const string data,
                                       int* typeID,
                                       declFormat* format,
                                       string* declarationData,
                                       string* name) {
