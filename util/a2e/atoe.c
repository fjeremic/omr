...
char* sysTranslate(const char* source,
                   int length,
                   char* trtable,
                   char* xlate_buf) {
 ...
 * returns     -
 *************************************************************************/
size_t atoe_fwrite(const void* buffer,
                   size_t size,
                   size_t count,
                   FILE* stream) {
  int numwritten;
 ...
 * returns     -
 *************************************************************************/
struct hostent* atoe_gethostbyaddr(const void* address,
                                   int addrlen,
                                   int domain,
 ...
 * returns     -
 *************************************************************************/
int atoe_getaddrinfo(const char* nodename,
                     const char* servname,
 ...
 * returns     -
 *************************************************************************/
int atoe_getnameinfo(const struct sockaddr* sa,
                     socklen_t salen,
                     char* host,
                     socklen_t hostlen,
                     char* serv,
 ...
 * returns     -
 *************************************************************************/
pid_t atoe_spawnpe(const char* filename,
                   const int fd_cnt,
                   const int* fd_map,
...
pid_t atoe_spawnp(const char* filename,
                  const int fd_cnt,
                  const int* fd_map,
                  const struct inheritance* inherit,
                  char** argv,
