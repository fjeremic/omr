...
int iconv_init(void)
{
    ...
    if (((etoa_cd = iconv_open(asciiSet, ebcdicSet)) == (iconv_t)(-1)) || ((atoe_cd = iconv_open(ebcdicSet, asciiSet)) == (iconv_t)(-1))) {
        ...
        if (((etoa_cd = iconv_open(asciiSet, defaultSet)) == (iconv_t)(-1)) || ((atoe_cd = iconv_open(defaultSet, asciiSet)) == (iconv_t)(-1))) {
            return -1;
        } /*ibm@12741*/
    }
