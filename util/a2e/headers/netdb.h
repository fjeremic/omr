...
struct hostent *atoe_gethostbyname_r(char *, struct hostent *, char *, int,
                                     int *); /*ibm@38180.1*/
struct hostent *atoe_gethostbyaddr(const void *, int, int, struct hostent *,
                                   char *, int, int *);
struct protoent *atoe_getprotobyname(const char *name);
int atoe_getaddrinfo(const char *, const char *, const struct addrinfo *,
                     struct addrinfo **);
