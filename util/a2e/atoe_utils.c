...
#define CheckRet(x)                               \
  {                                               \
    if ((x) == ERROR_RETVAL) return ERROR_RETVAL; \
  }
 ...
 *************************************************************************/
static int pchar(InstanceData *this, int c) {
#if 0
	/*
 ...
 * returns     - int return code, 0 for success
 *************************************************************************/
static int fstring(InstanceData *this, char *str, int left_justify,
 ...
 * returns     - int return code, 0 for success
 *************************************************************************/
static int fnumber(InstanceData *this, long value, int format_type,
                   int left_justify, int min_width, int precision,
                   bool_t zero_pad) {
  int sign_value = 0;
 ...
 *=======================================================================
 */
static int flongnumber(InstanceData *this, signed long long value,
                       int format_type, int left_justify, int min_width,
                       int precision, bool_t zero_pad) {
  int sign_value = 0;
    ...
    next_char:
      ...
      switch (ch) {
        ...
        case 's':
          ...
          CheckRet(
              fstring(&this, strvalue, left_justify, min_width, precision));
          break;
        case 'c':
          ch = va_arg(args, int);
        ...
        case 'X':
          if (long_long_flag) { /*ibm@9094*/
            ...
            CheckRet(fnumber(&this, value, ch, left_justify, min_width,
                             precision, zero_pad));
          }
          break;
        case 'p':
          value = (long)va_arg(args, char *);
          CheckRet(fnumber(&this, value, ch, left_justify, min_width, precision,
                           zero_pad));
          break;
        case 'e':
        case 'E':
        ...
        default:
          ...
          if (long_long_flag) {
            ...
            CheckRet(flongnumber(&this, value64, 'd', left_justify, min_width,
                                 precision, zero_pad));
