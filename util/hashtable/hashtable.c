...
static J9HashTable* hashTableNewImpl(OMRPortLibrary* portLibrary,
...
static void** hashTableFindNodeSpaceOpt(J9HashTable* table,
                                        void* entry,
                                        void** head);
static void** hashTableFindNodeInList(J9HashTable* table,
                                      void* entry,
                                      void** head);
static void* hashTableFindNodeInTree(J9HashTable* table,
                                     void* entry,
                                     void** head);
static void* hashTableAddNodeSpaceOpt(J9HashTable* table,
                                      void* entry,
                                      void** head);
static void* hashTableAddNodeInList(J9HashTable* table,
                                    void* entry,
                                    void** head);
static void* hashTableAddNodeInTree(J9HashTable* table,
                                    void* entry,
                                    void** head);
static uint32_t hashTableRemoveNodeSpaceOpt(J9HashTable* table,
                                            void* entry,
                                            void** head);
static uint32_t hashTableRemoveNodeInList(J9HashTable* table,
                                          void* entry,
                                          void** head);
static uint32_t hashTableRemoveNodeInTree(J9HashTable* table,
                                          void* entry,
                                          void** head);
static uintptr_t listToTree(J9HashTable* table,
                            void** head,
                            uintptr_t listLength);
static void rebuildFromPools(J9HashTable* table,
                             uint32_t newSize,
                             void** newNodes);
...
static uintptr_t comparatorToEqualFn(void* leftKey,
                                     void* rightKey,
                                     void* userData) {
 ...
 *
 */
J9HashTable* hashTableNew(OMRPortLibrary* portLibrary,
                          const char* tableName,
                          uint32_t tableSize,
                          uint32_t entrySize,
                          uint32_t entryAlignment,
 ...
 * untouched.
 */
void hashTableForEachDo(J9HashTable* table,
                        J9HashTableDoFn doFn,
                        void* opaque) {
 ...
 *
 */
uint32_t hashTableGetCount(J9HashTable* table) {
