 ...
 * puddle.
 */
static int32_t pool_getElementPuddleSlot(J9Pool* pool,
                                         J9PoolPuddle* puddle,
                                         void* element) {
 ...
 *
 */
J9Pool* pool_new(uintptr_t structSizeArg,
 ...
 *
 */
void pool_do(J9Pool* pool,
             void (*doFunction)(void* anElement, void* userData),
             void* userData) {
  void* anElement;
  pool_state aState;
 ...
 *
 */
void* poolPuddle_startDo(J9Pool* pool,
                         J9PoolPuddle* currentPuddle,
                         pool_state* state,
                         uintptr_t followNextPointers) {
  int32_t slot = 0;
  uintptr_t* currAddr;
 ...
 * fix.  */
void refToPoolCap(J9Pool* aPool) {
