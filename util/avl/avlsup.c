...
static J9AVLTreeNode* deleteNode(J9AVLTree* tree,
                                 J9AVLTreeNode** walkPtr,
                                 J9WSRP* walkSRPPtr,
                                 J9AVLTreeNode* node,
                                 intptr_t* heightChange);
static J9AVLTreeNode* rotate(J9AVLTree* tree,
                             J9AVLTreeNode* walk,
                             intptr_t direction,
                             intptr_t* heightChange);
static J9AVLTreeNode* doubleRotate(J9AVLTree* tree,
                                   J9AVLTreeNode* walk,
                                   intptr_t direction,
                                   intptr_t* heightChange);
static void rebalance(J9AVLTree* tree,
                      J9AVLTreeNode** walkPtr,
                      J9WSRP* walkSRPPtr,
                      intptr_t direction,
                      intptr_t* heightChange);
static J9AVLTreeNode* findRightMostLeaf(J9AVLTree* tree,
                                        J9WSRP* walkSRPPtr,
                                        intptr_t* heightChange);
static J9AVLTreeNode* findNode(J9AVLTree* tree,
                               J9AVLTreeNode* walk,
                               uintptr_t search);
static J9AVLTreeNode* insertNode(J9AVLTree* tree,
                                 J9AVLTreeNode** walkPtr,
                                 J9WSRP* walkSRPPtr,
                                 J9AVLTreeNode* node,
                                 intptr_t* heightChange);
