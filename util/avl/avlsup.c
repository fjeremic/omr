...
deleteNode(J9AVLTree* tree,
           J9AVLTreeNode** walkPtr,
           J9WSRP* walkSRPPtr,
           J9AVLTreeNode* node,
           intptr_t* heightChange);
static J9AVLTreeNode*
rotate(J9AVLTree* tree,
       J9AVLTreeNode* walk,
       intptr_t direction,
       intptr_t* heightChange);
static J9AVLTreeNode*
doubleRotate(J9AVLTree* tree,
             J9AVLTreeNode* walk,
             intptr_t direction,
             intptr_t* heightChange);
static void
rebalance(J9AVLTree* tree,
          J9AVLTreeNode** walkPtr,
          J9WSRP* walkSRPPtr,
          intptr_t direction,
          intptr_t* heightChange);
...
static J9AVLTreeNode*
findNode(J9AVLTree* tree, J9AVLTreeNode* walk, uintptr_t search);
static J9AVLTreeNode*
insertNode(J9AVLTree* tree,
           J9AVLTreeNode** walkPtr,
           J9WSRP* walkSRPPtr,
           J9AVLTreeNode* node,
           intptr_t* heightChange);
  ...
  if (!find) {
    ...
    *heightChange = -1;
    if (tree->genericActionHook) {
      tree->genericActionHook(
        tree, walk, J9AVLTREE_ACTION_REPLACE_REMOVED_PARENT);
    }
  } else {
       ...
       intptr_t* heightChange)
{
  ...
  if (tree->genericActionHook) {
    tree->genericActionHook(
      tree, (J9AVLTreeNode*)walk, J9AVLTREE_ACTION_SINGLE_ROTATE);
  }
             ...
             intptr_t* heightChange)
{
  ...
  if (tree->genericActionHook) {
    tree->genericActionHook(
      tree, (J9AVLTreeNode*)walk, J9AVLTREE_ACTION_DOUBLE_ROTATE);
  }
