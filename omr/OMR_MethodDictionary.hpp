...
class OMR_MethodDictionary {
 ...
 public:
  ...
  void getProperties(size_t* numProperties,
                     const char* const** propertyNames,
 ...
 private:
  ...
  static uintptr_t entryEquals(void* leftEntry,
                               void* rightEntry,
                               void* userData);
