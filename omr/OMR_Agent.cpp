...
OMR_TI const OMR_Agent::theOmrTI = { OMR_TI_VERSION_0, (void*)&theOmrThreadAPI, omrtiBindCurrentThread,
  ...
  omrtiSetTraceOptions, omrtiGetSystemCpuLoad, omrtiGetProcessCpuLoad, omrtiGetMemoryCategories, omrtiFlushTraceData,
  omrtiGetFreePhysicalMemorySize, omrtiGetProcessVirtualMemorySize, omrtiGetProcessPrivateMemorySize,
  omrtiGetProcessPhysicalMemorySize, omrtiGetMethodDescriptions, omrtiGetMethodProperties };
