...
static omr_error_t
getEnvVar(OMRPortLibrary* portLibrary,
          const char* envVar,
          char* buf,
          size_t bufLen,
...
static omr_error_t
parseTraceOptions(OMRPortLibrary* portLibrary,
                  char* trcOpts[],
...
omr_error_t
omr_ras_initTraceEngine(OMR_VM* omrVM,
                        const char* traceOptString,
                        const char* datDir)
{
                  ...
                  const char* traceOptString)
{
  ...
  if (OMR_ERROR_NONE == rc) {
    ...
    if (OMR_ERROR_NONE == getEnvVar(OMRPORTLIB,
                                    "TRACEDEBUG",
                                    traceDebugBuf,
                                    sizeof(traceDebugBuf),
                                    &traceDebugEnv)) {
