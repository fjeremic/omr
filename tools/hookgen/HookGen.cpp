...
static const char* getChildTextOrElse(pugi::xml_node node,
                                      const char* name,
 ...
 */
void HookGen::writeEventToPublicHeader(const char* name,
 ...
 */
void HookGen::writeEventToPrivateHeader(const char* name,
                                        const char* condition,
                                        const char* once,
                                        int sampling,
                                        const char* structName,
