  ...
  : public RecursiveASTVisitor<OMRThisRewritingVisitor>
{
   ...
   */
  void InsertScopeQualifier(Expr* e,
                            SourceLocation loc,
...
public:
  explicit OMRRewriteConsumer(Rewriter& R)
    : TheRewriter(R)
  {}
  ...
  virtual void HandleTranslationUnit(ASTContext& Context)
  {
    ...
    if (extVisitor.TraverseDecl(Context.getTranslationUnitDecl())) {
      ...
      if (ClassVisitor.TraverseDecl(Context.getTranslationUnitDecl())) {
        ...
        OMRThisRewritingVisitor ThisRewriter(
          &Context, &ThisChecker, &ClassVisitor, TheRewriter);
      ...
      trace(
        "Returning early, extensible class discovery visitor returned false!");
    }
