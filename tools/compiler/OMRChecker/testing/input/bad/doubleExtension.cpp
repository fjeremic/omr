...
TR::Class1Ext *OMR::Class1Ext::self() {
  return static_cast<TR::Class1Ext *>(this);
}
...
public:
  //      TR::Class3Ext* self();  // Missed self, means below Self call is an
  //      upcast!
  bool foo() {
    // Assignment here to ensure the linter has to see through assignment
    // VarDecls to find the caller.
