 ...
 */
RCType
TraceHeaderWriter::tpTemplate(FILE* fd,
...
RCType
TraceHeaderWriter::tpAssert(FILE* fd,
                            unsigned int overhead,
                            unsigned int test,
                            const char* name,
                            const char* module,
...
RCType
TraceHeaderWriter::headerTemplate(J9TDFOptions* options,
                                  FILE* fd,
