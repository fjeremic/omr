...
RCType TDFParser::processTracePointDetail(const char* line,
                                          J9TDFTracepoint* tp,
                                          const char* module,
                                          unsigned int id,
                                          const char* fileName,
 ...
 * str - a malloc'd buffer to hold the result
 */
RCType TDFParser::processTemplate(const char* formatTemplate,
                                  char* str,
                                  unsigned int* count,
                                  const char* fileName,
                                  unsigned int lineNumber) {
...
void TDFParser::flagTdfSyntaxError(const char* message,
