...
typedef RCType (*VisitFileCallBack)(void *targetObject, J9TDFOptions *options,
                                    const char *fileName);
...
public:
   ...
   */
  static const char *getTargetFileName(J9TDFOptions *options,
  ...
  /**
   * Recursively traverse the filesystem and call merge on every partial DAT
   * file.
   ...
   */
  static RCType visitDirectory(J9TDFOptions *options, const char *dirName,
