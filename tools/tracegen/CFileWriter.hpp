...
class CFileWriter {
 ...
 private:
   ...
   */
  RCType writeActiveArray(FILE* fd,
                          J9TDFFile* tdf,
   ...
   * @return RC_OK on success, RC_FAILED on failure
   */
  RCType writeComponentDataOnStream(FILE* fd,
                                    J9TDFFile* tdf,
                                    unsigned int ntracepoints,
                                    unsigned int* levels,
                                    unsigned int* earlyAssertDefaults,
 ...
 public:
   ...
   * @return RC_OK on success, RC_FAILED on failure
   */
  RCType writeOutputFiles(J9TDFOptions* options,
                          J9TDFFile* tdf,
                          J9TDFGroup* groups,
