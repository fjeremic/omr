...
int32_t omrfile_blockingasync_close(struct OMRPortLibrary* portLibrary, intptr_t fd)
{
...
int64_t omrfile_blockingasync_flength(struct OMRPortLibrary* portLibrary, intptr_t fd)
{
