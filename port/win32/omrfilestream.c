...
OMRFileStream* omrfilestream_open(struct OMRPortLibrary* portLibrary, const char* path, int32_t flags, int32_t mode)
{
...
int32_t omrfilestream_close(struct OMRPortLibrary* portLibrary, OMRFileStream* fileStream)
{
  int32_t rc = 0;
...
int32_t omrfilestream_sync(struct OMRPortLibrary* portLibrary, OMRFileStream* fileStream)
{
  int32_t rc = 0;
...
int32_t omrfilestream_setbuffer(
  OMRPortLibrary* portLibrary, OMRFileStream* fileStream, char* buffer, int32_t mode, uintptr_t size)
{
  int localMode = 0;
  int32_t rc = 0;
...
OMRFileStream* omrfilestream_fdopen(OMRPortLibrary* portLibrary, intptr_t fd, int32_t flags)
{
  const char* standardFlags = NULL;
  int systemFlags = 0;
  OMRFileStream* fileStream = NULL;
...
intptr_t omrfilestream_fileno(OMRPortLibrary* portLibrary, OMRFileStream* fileStream)
{
