           ...
           void** value)
{
  ...
  *name = "";
  ...
  if ((index >= 0) && (index < NUM_REGS)) {
    *name = n_fpr[index];
    *value =
      &(info->platformSignalInfo.context->uc_mcontext.fpregs.fprs[index].d);
  ...
  if ((index >= 0) && (index < NUM_REGS)) {
    ...
    *value = &(info->platformSignalInfo.context->uc_mcontext.gregs[index]);
    ...
    if (UC_EXTENDED == info->platformSignalInfo.context->uc_flags) {
      struct ucontext_extended* extendedContext =
        (ucontext_extended*)info->platformSignalInfo.context;
      *name = n_gpr[index];
