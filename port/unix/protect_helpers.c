...
struct {
  ...
  int unixPermission;
} permissionsMap[] = { { OMRPORT_PAGE_PROTECT_NONE, PROT_NONE }, { OMRPORT_PAGE_PROTECT_READ, PROT_READ },
  { OMRPORT_PAGE_PROTECT_WRITE, PROT_WRITE }, { OMRPORT_PAGE_PROTECT_EXEC, PROT_EXEC } };
