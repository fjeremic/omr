                                    ...
                                    uintptr_t memorySize)
{
  ...
  Trc_PRT_mem_advise_and_free_memory_basic_params(
    pageSize, memoryPointer, memorySize);
  ...
  if (pageSize > 0 && memorySize >= pageSize) {
    ...
    if (memPtrSizePageRounded >= pageSize) {
      ...
      if (-1 == madvise((void*)memPtrPageRounded,
                        memPtrSizePageRounded,
                        MADV_DONTNEED)) {
...
#elif defined(AIXPPC)
      if (-1 == disclaim64((void*)memPtrPageRounded,
                           memPtrSizePageRounded,
                           DISCLAIM_ZEROMEM)) {
                     ...
                     uintptr_t portGlobalSize)
{
  ...
  if (0 <= portLibrary->sysinfo_get_env(
             portLibrary, "J9_SUBALLOC_FOR_32", (void*)tmpbuff, 256)) {
