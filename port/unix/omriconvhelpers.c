 ...
 */
static BOOLEAN openIconvDescriptor(iconv_t* globalConverter, MUTEX* globalConverterMutex, uint32_t index,
  const char* toCode, const char* fromCode, uint32_t* initializedConvertors)
{
...
int32_t iconv_global_init(struct OMRPortLibrary* portLibrary)
{
  ...
  success = openIconvDescriptor(globalConverter, globalConverterMutex, OMRPORT_UTF8_TO_EBCDIC_ICONV_DESCRIPTOR, ebcdic,
              utf8, &initializedConvertors)
    && openIconvDescriptor(globalConverter, globalConverterMutex, OMRPORT_EBCDIC_TO_UTF8_ICONV_DESCRIPTOR, utf8, ebcdic,
      &initializedConvertors)
    && openIconvDescriptor(globalConverter, globalConverterMutex, OMRPORT_UTF8_TO_LANG_ICONV_DESCRIPTOR, langinfo, utf8,
      &initializedConvertors)
    && openIconvDescriptor(globalConverter, globalConverterMutex, OMRPORT_LANG_TO_UTF8_ICONV_DESCRIPTOR, utf8, langinfo,
      &initializedConvertors)
    && openIconvDescriptor(globalConverter, globalConverterMutex, OMRPORT_UTF16_TO_LANG_ICONV_DESCRIPTOR, langinfo,
      utf16, &initializedConvertors)
    && openIconvDescriptor(globalConverter, globalConverterMutex, OMRPORT_LANG_TO_UTF16_ICONV_DESCRIPTOR, utf16,
  ...
  struct OMRPortLibrary* portLibrary, J9IconvName converterName, const char* toCode, const char* fromCode)
{
   ...
   * We attempt to allocate an uncached iconv descriptor in those cases, and use ptBuffer == NULL as a check for
   * caching.
   */
