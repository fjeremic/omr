...
static int growBuffer(struct OMRPortLibrary* portLibrary,
                      char* stackBuf,
                      char** bufStart,
                      char** cursor,
                      size_t* bytesLeft,
...
static void translateUTF8String(const uint8_t* in,
                                uint8_t* out,
                                intptr_t nbytes);
...
intptr_t omrfile_write_text(struct OMRPortLibrary* portLibrary,
                            intptr_t fd,
                            const char* buf,
                            intptr_t nbytes) {
  intptr_t result = 0;
