...
static BOOLEAN addressRange_Intersect(AddressRange* a,
                                      AddressRange* b,
                                      AddressRange* result);
...
static void addressIterator_init(AddressIterator* iterator,
                                 ADDRESS minimum,
                                 ADDRESS maximum,
                                 uintptr_t alignment,
                                 intptr_t direction);
...
static void* allocateMemoryForLargePages(
    ...
    uintptr_t pageSize,
    uintptr_t mode);
static BOOLEAN isStrictAndOutOfRange(void* memoryPointer,
                                     void* startAddress,
                                     void* endAddress,
                                     uintptr_t vmemOptions);
 ...
 */
static long do_mbind(void* start,
                     unsigned long len,
                     int policy,
 ...
 */
static long do_get_mempolicy(int* policy,
                             unsigned long* nmask,
                             unsigned long maxnode,
                             unsigned long addr,
                             unsigned long flags) {
