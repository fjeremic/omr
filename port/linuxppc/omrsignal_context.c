  ...
  *name = "";
  ...
  switch (index) {
    ...
    case 2:
      *name = "ORIG_GPR3";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.regs->orig_gpr3;
      return OMRPORT_SIG_VALUE_ADDRESS;
    ...
    case 7:
      *name = "SOFTE";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.regs->softe;
      return OMRPORT_SIG_VALUE_ADDRESS;
#else
    ...
    case 10:
      *name = "dsisr";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.regs->dsisr;
      return OMRPORT_SIG_VALUE_ADDRESS;
    case 11:
      *name = "RESULT";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.regs->result;
      return OMRPORT_SIG_VALUE_ADDRESS;
    default:
      return OMRPORT_SIG_VALUE_UNDEFINED;
  }
              ...
              void** value)
{
  ...
  *name = "";
  ...
  int dl_result = dladdr(
    (void*)info->platformSignalInfo.context->uc_mcontext.regs->nip, dl_info);
