...
uint32_t infoForControl(struct OMRPortLibrary *portLibrary,
  ...
  *name = "";
  ...
  switch (index) {
    ...
    case 2:
      *name = "ORIG_GPR3";
      *value = (void *)&info->platformSignalInfo.context->uc_mcontext.regs
                   ->orig_gpr3;
      return OMRPORT_SIG_VALUE_ADDRESS;
    ...
    case 4:
      *name = "LINK";
      *value =
          (void *)&info->platformSignalInfo.context->uc_mcontext.regs->link;
      return OMRPORT_SIG_VALUE_ADDRESS;
    ...
    case 8:
      *name = "TRAP";
      *value =
          (void *)&info->platformSignalInfo.context->uc_mcontext.regs->trap;
      return OMRPORT_SIG_VALUE_ADDRESS;
