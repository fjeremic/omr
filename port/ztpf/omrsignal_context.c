...
static void ztpfDeriveUcontext(ucontext_t* uscPtr)
{
    ...
    memcpy(uscPtr->uc_mcontext.fpregs.fprs, pDib->dfreg, sizeof(pDib->dfreg)); /*FPRs*/
...
U_32 infoForGPR(
    struct OMRPortLibrary* portLibrary, struct OMRUnixSignalInfo* info, int32_t index, const char** name, void** value)
{
    const char* n_gpr[NUM_REGS] = { "gpr0", "gpr1", "gpr2", "gpr3", "gpr4", "gpr5", "gpr6", "gpr7", "gpr8", "gpr9",
        "gpr10", "gpr11", "gpr12", "gpr13", "gpr14", "gpr15" };
