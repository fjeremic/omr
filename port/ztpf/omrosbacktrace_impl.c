 ...
 */
static uintptr_t
handler(struct OMRPortLibrary* portLibrary,
        uintptr_t gpType,
        void* gpInfo,
        void* userData)
{
                     ...
                     int capacity)
{
  ...
  if (omrthread_self()) {
    if (portLibrary->sig_protect(portLibrary,
                                 protectedBacktrace,
                                 &args,
                                   ...
                                   void* signalInfo)
{
  ...
  ret = backtrace_sigprotect(
    portLibrary, threadInfo, addresses, sizeof(addresses) / sizeof(void*));
