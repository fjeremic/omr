 ...
 *
 * @param [in]  lastDoubleWord   Size of the bits array in number of uint64_t,
 * minus 1.
 * @param [out] bits             Caller-supplied uint64_t array that gets
 * populated with the facility bits.
 *
