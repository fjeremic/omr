 ...
 * in the "Inside J9" Lotus Notes database.
 */
void j9nls_vprintf(struct OMRPortLibrary* portLibrary, uintptr_t flags, uint32_t module_name, uint32_t message_num, va_list args)
{
    const char* message;
 ...
 * @deprecated NLS API is deprecated.
 */
void j9nls_set_catalog(struct OMRPortLibrary* portLibrary, const char** paths, const int nPaths, const char* baseName, const char* extension)
{
    int i;
    char* p;
    J9NLSDataCache* nls;
...
#define MSG_IGNORE 5
    ...
    char prefix[sizeof(J9NLS_ERROR_PREFIX "" J9NLS_INFO_PREFIX "" J9NLS_WARNING_PREFIX
