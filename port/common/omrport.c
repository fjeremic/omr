...
static OMRPortLibrary MasterPortLibraryTable = {
  ...
  omrfile_convert_omrfile_fd_to_native_fd, omrfile_blockingasync_unlock_bytes, /* file_blockingasync_unlock_bytes */
 ...
 */
int32_t omrport_init_library(struct OMRPortLibrary* portLibrary, uintptr_t size)
{
...
int32_t omrport_create_library(struct OMRPortLibrary* portLibrary, uintptr_t size)
{
 ...
 */
int32_t omrport_isFunctionOverridden(struct OMRPortLibrary* portLibrary, uintptr_t offset)
{
