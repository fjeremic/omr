 ...
 * @param [in]  mappingName		The name of the file mapping object to be created/opened.  This will be used as the basis
 * of the name (invalid characters being converted to '_') of the file mapping object on Windows so that it can be
