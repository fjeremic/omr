...
openDriver(OMRPortLibrary* portLibrary)
{
    ...
    if (0 != portLibrary->sl_open_shared_library(portLibrary, (char*)driverLibrary, &globals->driverHandle, OMRPORT_SLOPEN_LAZY)) {
    ...
    /* initialize the driver */
    {
        ...
        if (0 != portLibrary->sl_lookup_name(portLibrary, globals->driverHandle, (char*)"cuInit", (uintptr_t*)&driverInit, "iI")) {
    ...
    /* query the driver version */
    {
        ...
        if (0 != portLibrary->sl_lookup_name(portLibrary, globals->driverHandle, (char*)"cuDriverGetVersion", (uintptr_t*)&driverGetVersion, "iP")) {
    ...
    /* query the number of available devices */
    {
        ...
        if (0 != portLibrary->sl_lookup_name(portLibrary, globals->driverHandle, (char*)"cuDeviceGetCount", (uintptr_t*)&deviceGetCount, "iP")) {
    ...
    if (0 != initializeTable(portLibrary, globals->driverHandle, (uint32_t)version, driverDescriptors, LENGTH_OF(driverDescriptors), (uintptr_t*)globals->functionTable)) {
    fail:
        deviceCount = 0;
        version = 0;
    }
...
openRuntimeAndGetVersion(OMRPortLibrary* portLibrary, uint32_t bestVersion, const char* library)
{
    ...
    /* query the runtime version */
    {
        ...
        if (0 != portLibrary->sl_lookup_name(portLibrary, dllHandle, (char*)"cudaRuntimeGetVersion", (uintptr_t*)&runtimeGetVersion, "iP")) {
    ...
    if (0 == initializeTable(portLibrary, dllHandle, (uint32_t)version, runtimeDescriptors, LENGTH_OF(runtimeDescriptors), (uintptr_t*)&localFunctions)) {
