 ...
 */
int32_t initializeTable(OMRPortLibrary* portLibrary, uintptr_t dllHandle, uint32_t libraryVersion,
  const J9CudaEntryDescriptor* entries, uintptr_t entryCount, uintptr_t* table)
{
  ...
  for (uintptr_t index = 0; index < entryCount; ++index) {
    ...
    if (0 != portLibrary->sl_lookup_name(portLibrary, dllHandle, (char*)entry->name, &function, entry->signature)) {
 ...
 */
int32_t getDeviceData(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaDeviceDescriptor* deviceData)
{
  ...
  if (globals->deviceCount <= deviceId) {
    ...
    if (J9CUDA_NO_ERROR
      != omrcuda_deviceGetMemInfo(portLibrary, deviceId, &deviceData->availableMemory, &deviceData->totalMemory)) {
 ...
 * @return J9CUDA_NO_ERROR on success or a non-zero value on failure
 */
int32_t getSummaryData(OMRPortLibrary* portLibrary, J9CudaSummaryDescriptor* summaryData)
{
...
struct J9CudaFunctionTable {
  ...
  CUresult(CUDAAPI* OccupancyMaxActiveBlocksPerMultiprocessorWithFlags)(
    int* numBlocks, CUfunction function, int blockSize, size_t dynamicSMemSize, unsigned int flags);
  ...
  cudaError_t(CUDARTAPI* MemcpyPeerAsync)(
  ...
  cudaError_t(CUDARTAPI* StreamAddCallback)(
 ...
 */
cudaError_t getDeviceName(J9CudaFunctionTable* functions, uint32_t deviceId, uint32_t nameSize, char* nameOut)
{
 ...
 */
cudaError_t initDeviceData(J9CudaFunctionTable* functions, uint32_t deviceId, J9CudaDeviceDescriptor* deviceData)
{
 ...
 */
const J9CudaEntryDescriptor driverDescriptors[] = { J9CUDA_DRIVER_ENTRY_v1(5050, DeviceGet, "iPi"),
  J9CUDA_DRIVER_ENTRY_v1(5050, DeviceGetName, "iPii"), J9CUDA_DRIVER_ENTRY_v1(5050, FuncGetAttribute, "iPiP"),
  J9CUDA_DRIVER_ENTRY_v1(5050, FuncSetCacheConfig, "iPi"), J9CUDA_DRIVER_ENTRY_v1(5050, FuncSetSharedMemConfig, "iPi"),
  J9CUDA_DRIVER_ENTRY_v1(5050, LaunchKernel, "iPiiiiiiiPPP"), J9CUDA_DRIVER_ENTRY_v2(7000, LinkAddData, "iPiPLPiPP"),
  J9CUDA_DRIVER_ENTRY_v1(5050, LinkAddData, "iPiPLPiPP"), J9CUDA_DRIVER_ENTRY_v1(5050, LinkComplete, "iPPP"),
  J9CUDA_DRIVER_ENTRY_v2(7000, LinkCreate, "iiPPP"), J9CUDA_DRIVER_ENTRY_v1(5050, LinkCreate, "iiPPP"),
  J9CUDA_DRIVER_ENTRY_v1(5050, LinkDestroy, "iP"), J9CUDA_DRIVER_ENTRY_v1(5050, MemsetD8Async, "iPbLP"),
  J9CUDA_DRIVER_ENTRY_v1(5050, MemsetD16Async, "iPcLP"), J9CUDA_DRIVER_ENTRY_v1(5050, MemsetD32Async, "iPiLP"),
  J9CUDA_DRIVER_ENTRY_v1(5050, ModuleGetFunction, "iPPP"), J9CUDA_DRIVER_ENTRY_v2(5050, ModuleGetGlobal, "iPPPP"),
  J9CUDA_DRIVER_ENTRY_v1(5050, ModuleGetSurfRef, "iPPP"), J9CUDA_DRIVER_ENTRY_v1(5050, ModuleGetTexRef, "iPPP"),
  J9CUDA_DRIVER_ENTRY_v1(5050, ModuleLoadDataEx, "iPPiPP"), J9CUDA_DRIVER_ENTRY_v1(5050, ModuleUnload, "iP"),
...
const J9CudaEntryDescriptor runtimeDescriptors[] = { J9CUDA_RUNTIME_ENTRY(5050, DeviceCanAccessPeer, "iPII"),
  J9CUDA_RUNTIME_ENTRY(5050, DeviceDisablePeerAccess, "iI"), J9CUDA_RUNTIME_ENTRY(5050, DeviceEnablePeerAccess, "iIi"),
  J9CUDA_RUNTIME_ENTRY(5050, DeviceGetAttribute, "iPiI"), J9CUDA_RUNTIME_ENTRY(5050, DeviceGetCacheConfig, "iP"),
  J9CUDA_RUNTIME_ENTRY(5050, DeviceGetLimit, "iPi"), J9CUDA_RUNTIME_ENTRY(5050, DeviceGetSharedMemConfig, "iP"),
  J9CUDA_RUNTIME_ENTRY(5050, DeviceGetStreamPriorityRange, "iPP"),
  J9CUDA_RUNTIME_ENTRY(5050, DeviceSetCacheConfig, "ii"), J9CUDA_RUNTIME_ENTRY(5050, DeviceReset, "i"),
  J9CUDA_RUNTIME_ENTRY(5050, DeviceSetLimit, "iiL"), J9CUDA_RUNTIME_ENTRY(5050, DeviceSetSharedMemConfig, "ii"),
  J9CUDA_RUNTIME_ENTRY(5050, DeviceSynchronize, "i"), J9CUDA_RUNTIME_ENTRY(5050, EventCreateWithFlags, "iPI"),
  J9CUDA_RUNTIME_ENTRY(5050, EventDestroy, "iP"), J9CUDA_RUNTIME_ENTRY(5050, EventElapsedTime, "iPPP"),
  J9CUDA_RUNTIME_ENTRY(5050, EventQuery, "iP"), J9CUDA_RUNTIME_ENTRY(5050, EventRecord, "iPP"),
  J9CUDA_RUNTIME_ENTRY(5050, EventSynchronize, "iP"), J9CUDA_RUNTIME_ENTRY(5050, Free, "iP"),
  J9CUDA_RUNTIME_ENTRY(5050, FreeHost, "iP"), J9CUDA_RUNTIME_ENTRY(5050, GetDevice, "iP"),
  J9CUDA_RUNTIME_ENTRY(5050, GetErrorString, "Pi"), J9CUDA_RUNTIME_ENTRY(5050, HostAlloc, "iPLi"),
  J9CUDA_RUNTIME_ENTRY(5050, Malloc, "iPL"), J9CUDA_RUNTIME_ENTRY(5050, Memcpy, "iPPLi"),
  J9CUDA_RUNTIME_ENTRY(5050, MemcpyAsync, "iPPLiP"), J9CUDA_RUNTIME_ENTRY(5050, Memcpy2D, "iPLPLLLi"),
  J9CUDA_RUNTIME_ENTRY(5050, Memcpy2DAsync, "iPLPLLLiP"), J9CUDA_RUNTIME_ENTRY(5050, MemcpyPeer, "iPIPIL"),
  J9CUDA_RUNTIME_ENTRY(5050, MemcpyPeerAsync, "iPIPILP"), J9CUDA_RUNTIME_ENTRY(5050, MemGetInfo, "iPP"),
  J9CUDA_RUNTIME_ENTRY(5050, SetDevice, "iI"), J9CUDA_RUNTIME_ENTRY(5050, StreamAddCallback, "iPPPi"),
  J9CUDA_RUNTIME_ENTRY(5050, StreamCreate, "iP"), J9CUDA_RUNTIME_ENTRY(5050, StreamCreateWithPriority, "iPiI"),
  J9CUDA_RUNTIME_ENTRY(5050, StreamDestroy, "iP"), J9CUDA_RUNTIME_ENTRY(5050, StreamGetFlags, "iPP"),
  J9CUDA_RUNTIME_ENTRY(5050, StreamGetPriority, "iPP"), J9CUDA_RUNTIME_ENTRY(5050, StreamQuery, "iP"),
  J9CUDA_RUNTIME_ENTRY(5050, StreamSynchronize, "iP"), J9CUDA_RUNTIME_ENTRY(5050, StreamWaitEvent, "iPPi") };
...
uint32_t openDriver(OMRPortLibrary* portLibrary)
{
  ...
  if (0
    != portLibrary->sl_open_shared_library(
      portLibrary, (char*)driverLibrary, &globals->driverHandle, OMRPORT_SLOPEN_LAZY)) {
  ...
  /* initialize the driver */
  {
    ...
    if (0
      != portLibrary->sl_lookup_name(
        portLibrary, globals->driverHandle, (char*)"cuInit", (uintptr_t*)&driverInit, "iI")) {
  ...
  /* query the driver version */
  {
    ...
    if (0
      != portLibrary->sl_lookup_name(
        portLibrary, globals->driverHandle, (char*)"cuDriverGetVersion", (uintptr_t*)&driverGetVersion, "iP")) {
  ...
  /* query the number of available devices */
  {
    ...
    if (0
      != portLibrary->sl_lookup_name(
        portLibrary, globals->driverHandle, (char*)"cuDeviceGetCount", (uintptr_t*)&deviceGetCount, "iP")) {
  ...
  if (0
    != initializeTable(portLibrary, globals->driverHandle, (uint32_t)version, driverDescriptors,
 ...
 */
uint32_t openRuntimeAndGetVersion(OMRPortLibrary* portLibrary, uint32_t bestVersion, const char* library)
{
  ...
  /* query the runtime version */
  {
    ...
    if (0
      != portLibrary->sl_lookup_name(
        portLibrary, dllHandle, (char*)"cudaRuntimeGetVersion", (uintptr_t*)&runtimeGetVersion, "iP")) {
  ...
  if (0
    == initializeTable(portLibrary, dllHandle, (uint32_t)version, runtimeDescriptors, LENGTH_OF(runtimeDescriptors),
 ...
 */
VMINLINE cudaError_t validateDeviceId(OMRPortLibrary* portLibrary, uint32_t deviceId)
{
...
private:
   ...
   * @return the ThreadState pointer for the calling thread
   */
  static ThreadState* getStateForCurrentThread(OMRPortLibrary* portLibrary, uint32_t deviceCount)
  {
...
public:
   ...
   * @return cudaSuccess on success, any other value on failure
   */
  static cudaError_t initDeviceForCurrentThread(
    OMRPortLibrary* portLibrary, J9CudaFunctionTable* functions, uint32_t deviceId)
  {
   ...
   * @return cudaSuccess on success, any other value on failure
   */
  static cudaError_t markDeviceForCurrentThread(OMRPortLibrary* portLibrary, uint32_t deviceId)
  {
   ...
   * @return cudaSuccess on success, any other value on failure
   */
  static cudaError_t unmarkDeviceForCurrentThread(OMRPortLibrary* portLibrary, uint32_t deviceId)
  {
...
struct InitializerNotNeeded {
   ...
   * @return cudaSuccess on success, any other value on failure
   */
  VMINLINE cudaError_t prepare(OMRPortLibrary*, J9CudaFunctionTable*, uint32_t) const
  {
...
struct InitializedAfter : public InitializerNotNeeded {
   ...
   * @return cudaSuccess on success, any other value on failure
   */
  VMINLINE cudaError_t onSuccess(OMRPortLibrary* portLibrary, uint32_t deviceId) const
  {
...
struct InitializedBefore : public InitializerNotNeeded {
   ...
   * @return cudaSuccess on success, any other value on failure
   */
  VMINLINE cudaError_t prepare(OMRPortLibrary* portLibrary, J9CudaFunctionTable* functions, uint32_t deviceId) const
  {
...
VMINLINE cudaError_t withDevice(OMRPortLibrary* portLibrary, uint32_t deviceId, Operation& operation)
{
 ...
 */
extern "C" int32_t omrcuda_deviceAlloc(
  OMRPortLibrary* portLibrary, uint32_t deviceId, uintptr_t size, void** deviceAddressOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceCanAccessPeer(
  OMRPortLibrary* portLibrary, uint32_t deviceId, uint32_t peerDeviceId, BOOLEAN* canAccessPeerOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceDisablePeerAccess(
  OMRPortLibrary* portLibrary, uint32_t deviceId, uint32_t peerDeviceId)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceEnablePeerAccess(OMRPortLibrary* portLibrary, uint32_t deviceId, uint32_t peerDeviceId)
{
...
struct Free : public InitializedAfter {
  ...
  explicit VMINLINE Free(void* deviceAddress)
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceFree(OMRPortLibrary* portLibrary, uint32_t deviceId, void* deviceAddress)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceGetAttribute(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaDeviceAttribute attribute, int32_t* valueOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceGetCacheConfig(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaCacheConfig* configOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceGetCount(OMRPortLibrary* portLibrary, uint32_t* countOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceGetLimit(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaDeviceLimit limit, uintptr_t* valueOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceGetMemInfo(
  OMRPortLibrary* portLibrary, uint32_t deviceId, uintptr_t* freeOut, uintptr_t* totalOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceGetName(
  OMRPortLibrary* portLibrary, uint32_t deviceId, uint32_t nameSize, char* nameOut)
{
...
extern "C" int32_t omrcuda_deviceGetSharedMemConfig(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaSharedMemConfig* configOut)
{
...
extern "C" int32_t omrcuda_deviceGetStreamPriorityRange(
  OMRPortLibrary* portLibrary, uint32_t deviceId, int32_t* leastPriorityOut, int32_t* greatestPriorityOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceReset(OMRPortLibrary* portLibrary, uint32_t deviceId)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceSetCacheConfig(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaCacheConfig config)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceSetLimit(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaDeviceLimit limit, uintptr_t value)
{
...
extern "C" int32_t omrcuda_deviceSetSharedMemConfig(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaSharedMemConfig config)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_deviceSynchronize(OMRPortLibrary* portLibrary, uint32_t deviceId)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_driverGetVersion(OMRPortLibrary* portLibrary, uint32_t* versionOut)
{
...
struct EventCreate : public InitializedAfter {
  ...
  explicit VMINLINE EventCreate(uint32_t flags)
    : event(NULL)
    , flags(flags)
  {}
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_eventCreate(
  OMRPortLibrary* portLibrary, uint32_t deviceId, uint32_t flags, J9CudaEvent* eventOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_eventDestroy(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaEvent event)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_eventElapsedTime(
  OMRPortLibrary* portLibrary, J9CudaEvent startEvent, J9CudaEvent endEvent, float* elapsedMillisOut)
{
 ...
 */
extern "C" int32_t omrcuda_eventQuery(OMRPortLibrary* portLibrary, J9CudaEvent event)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_eventRecord(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaEvent event, J9CudaStream stream)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_eventSynchronize(OMRPortLibrary* portLibrary, J9CudaEvent event)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_funcGetAttribute(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaFunction function,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_funcMaxActiveBlocksPerMultiprocessor(OMRPortLibrary* portLibrary, uint32_t deviceId,
...
struct FunctionPotentialBlockSize : public InitializedBefore {
  ...
  FunctionPotentialBlockSize(CUfunction function, J9CudaBlockToDynamicSharedMemorySize dynamicSharedMemoryFunction,
    uintptr_t userData, uint32_t blockSizeLimit, uint32_t flags, uint32_t maxThreadsPerMultiProcessor,
    uint32_t warpSize)
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_funcMaxPotentialBlockSize(OMRPortLibrary* portLibrary, uint32_t deviceId,
  ...
  uint32_t blockSizeLimit, uint32_t flags, uint32_t* minGridSizeOut, uint32_t* maxBlockSizeOut)
{
  Trc_PRT_cuda_funcMaxPotentialBlockSize_entry(
    deviceId, function, dynamicSharedMemoryFunction, userData, blockSizeLimit, flags);
...
#undef GET_DEVICE_ATTRIBUTE
    ...
    int value = 0;
    CUresult error = functions->FuncGetAttribute(&value, CU_FUNC_ATTRIBUTE_MAX_THREADS_PER_BLOCK, (CUfunction)function);
    ...
    FunctionPotentialBlockSize operation((CUfunction)function, dynamicSharedMemoryFunction, userData, blockSizeLimit,
      flags, (uint32_t)deviceMaxThreadsPerMultiProcessor, (uint32_t)deviceWarpSize);
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_funcSetCacheConfig(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaFunction function, J9CudaCacheConfig config)
{
...
extern "C" int32_t omrcuda_funcSetSharedMemConfig(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaFunction function, J9CudaSharedMemConfig config)
{
 ...
 */
extern "C" const char* omrcuda_getErrorString(OMRPortLibrary* portLibrary, int32_t error)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_hostAlloc(OMRPortLibrary* portLibrary, uintptr_t size, uint32_t flags, void** hostAddressOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_hostFree(OMRPortLibrary* portLibrary, void* hostAddress)
{
...
struct Launch : public InitializedBefore {
  ...
  VMINLINE
  Launch(
    CUfunction function, const dim3& gridDim, const dim3& blockDim, uint32_t sharedMem, CUstream stream, void** args)
    : function(function)
    , gridDim(gridDim)
    , blockDim(blockDim)
    , sharedMem(sharedMem)
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    return translate(functions->LaunchKernel(
      function, gridDim.x, gridDim.y, gridDim.z, blockDim.x, blockDim.y, blockDim.z, sharedMem, stream, args, NULL));
  }
};
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_launchKernel(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaFunction function,
...
public:
  ...
  VMINLINE uint32_t getCount() const
  {
    return count;
  }

  VMINLINE CUjit_option* getKeys()
  {
    return keys;
  }

  VMINLINE void** getValues()
  {
    return values;
  }
};
...
struct LinkerAdd : public InitializedBefore {
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    ...
    if (cudaSuccess == result) {
      ...
      result = translate(functions->LinkAddData(linker->state, inputType, image, imageSize, name, addOptions.getCount(),
        addOptions.getKeys(), addOptions.getValues()));
    }
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_linkerAddData(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaLinker linker,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_linkerComplete(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaLinker linker, void** cubinOut, uintptr_t* sizeOut)
{
...
struct LinkerCreate : public InitializedBefore {
  ...
  explicit VMINLINE LinkerCreate(J9CudaLinkerState* linker)
    : linker(linker)
  {}
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_linkerCreate(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaJitOptions* options, J9CudaLinker* linkerOut)
{
...
struct LinkerDestroy : public InitializedBefore {
  ...
  explicit VMINLINE LinkerDestroy(J9CudaLinker linker)
    : linker(linker)
  {}
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_linkerDestroy(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaLinker linker)
{
...
struct Copy2D : public InitializedAfter {
  ...
  {
    if (sync) {
      return functions->Memcpy2D(targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, direction);
    } else {
      return functions->Memcpy2DAsync(
        targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, direction, (cudaStream_t)stream);
    }
  }
};
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpy2DDeviceToDevice(OMRPortLibrary* portLibrary, uint32_t deviceId, void* targetAddress,
  size_t targetPitch, const void* sourceAddress, size_t sourcePitch, uintptr_t width, uintptr_t height)
{
  Trc_PRT_cuda_memcpy2D_entry(
    deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyDeviceToDevice);

  const Copy2D operation(
    targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyDeviceToDevice);
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpy2DDeviceToDeviceAsync(OMRPortLibrary* portLibrary, uint32_t deviceId,
...
{
  Trc_PRT_cuda_memcpy2DAsync_entry(
    deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyDeviceToDevice, stream);

  const Copy2D operation(
    targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyDeviceToDevice, stream);
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpy2DDeviceToHost(OMRPortLibrary* portLibrary, uint32_t deviceId, void* targetAddress,
  size_t targetPitch, const void* sourceAddress, size_t sourcePitch, uintptr_t width, uintptr_t height)
{
  Trc_PRT_cuda_memcpy2D_entry(
    deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyDeviceToHost);
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpy2DDeviceToHostAsync(OMRPortLibrary* portLibrary, uint32_t deviceId,
  void* targetAddress, size_t targetPitch, const void* sourceAddress, size_t sourcePitch, uintptr_t width,
  uintptr_t height, J9CudaStream stream)
{
  Trc_PRT_cuda_memcpy2DAsync_entry(
    deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyDeviceToHost, stream);

  const Copy2D operation(
    targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyDeviceToHost, stream);
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpy2DHostToDevice(OMRPortLibrary* portLibrary, uint32_t deviceId, void* targetAddress,
  size_t targetPitch, const void* sourceAddress, size_t sourcePitch, uintptr_t width, uintptr_t height)
{
  Trc_PRT_cuda_memcpy2D_entry(
    deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyHostToDevice);
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpy2DHostToDeviceAsync(OMRPortLibrary* portLibrary, uint32_t deviceId,
  void* targetAddress, size_t targetPitch, const void* sourceAddress, size_t sourcePitch, uintptr_t width,
  uintptr_t height, J9CudaStream stream)
{
  Trc_PRT_cuda_memcpy2DAsync_entry(
    deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyHostToDevice, stream);

  const Copy2D operation(
    targetAddress, targetPitch, sourceAddress, sourcePitch, width, height, cudaMemcpyHostToDevice, stream);
...
struct Copy : public InitializedAfter {
  ...
  VMINLINE
  Copy(
    void* targetAddress, void const* sourceAddress, uintptr_t byteCount, cudaMemcpyKind direction, J9CudaStream stream)
    : byteCount(byteCount)
    , direction(direction)
    , sourceAddress(sourceAddress)
    , stream(stream)
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpyDeviceToDevice(
  OMRPortLibrary* portLibrary, uint32_t deviceId, void* targetAddress, const void* sourceAddress, uintptr_t byteCount)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpyDeviceToDeviceAsync(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpyDeviceToHost(
  OMRPortLibrary* portLibrary, uint32_t deviceId, void* targetAddress, const void* sourceAddress, uintptr_t byteCount)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpyDeviceToHostAsync(OMRPortLibrary* portLibrary, uint32_t deviceId, void* targetAddress,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpyHostToDevice(
  OMRPortLibrary* portLibrary, uint32_t deviceId, void* targetAddress, const void* sourceAddress, uintptr_t byteCount)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpyHostToDeviceAsync(OMRPortLibrary* portLibrary, uint32_t deviceId, void* targetAddress,
  const void* sourceAddress, uintptr_t byteCount, J9CudaStream stream)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpyPeer(OMRPortLibrary* portLibrary, uint32_t targetDeviceId, void* targetAddress,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memcpyPeerAsync(OMRPortLibrary* portLibrary, uint32_t targetDeviceId, void* targetAddress,
  uint32_t sourceDeviceId, const void* sourceAddress, uintptr_t byteCount, J9CudaStream stream)
{
  ...
  if ((cudaSuccess == result) && (NULL != functions->MemcpyPeerAsync)) {
    result = functions->MemcpyPeerAsync(
      targetAddress, targetDeviceId, sourceAddress, sourceDeviceId, byteCount, (cudaStream_t)stream);
  }
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memset8Async(OMRPortLibrary* portLibrary, uint32_t deviceId, void* deviceAddress,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memset16Async(OMRPortLibrary* portLibrary, uint32_t deviceId, void* deviceAddress,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_memset32Async(OMRPortLibrary* portLibrary, uint32_t deviceId, void* deviceAddress,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_moduleGetFunction(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaModule module, const char* name, J9CudaFunction* functionOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_moduleGetGlobal(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaModule module,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_moduleGetSurfaceRef(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaModule module, const char* name, uintptr_t* surfRefOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_moduleGetTextureRef(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaModule module, const char* name, uintptr_t* texRefOut)
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions)
  {
    ...
    if (cudaSuccess == result) {
      result = translate(functions->ModuleLoadDataEx(
        &module, image, loadOptions.getCount(), loadOptions.getKeys(), loadOptions.getValues()));
    }
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_moduleLoad(
  OMRPortLibrary* portLibrary, uint32_t deviceId, const void* image, J9CudaJitOptions* options, J9CudaModule* moduleOut)
{
...
struct Unload : public InitializedBefore {
  ...
  explicit VMINLINE Unload(CUmodule module)
    : module(module)
  {}
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_moduleUnload(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaModule module)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_runtimeGetVersion(OMRPortLibrary* portLibrary, uint32_t* versionOut)
{
...
struct StreamCallback {
  ...
  static void CUDART_CB handler(cudaStream_t stream, cudaError_t error, void* data)
  {
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_streamAddCallback(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaStream stream,
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_streamCreate(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaStream* streamOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_streamCreateWithPriority(
  OMRPortLibrary* portLibrary, uint32_t deviceId, int32_t priority, uint32_t flags, J9CudaStream* streamOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_streamDestroy(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaStream stream)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_streamGetFlags(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaStream stream, uint32_t* flagsOut)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_streamGetPriority(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaStream stream, int32_t* priorityOut)
{
 ...
 */
extern "C" int32_t omrcuda_streamQuery(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaStream stream)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_streamSynchronize(OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaStream stream)
{
 ...
 * @return J9CUDA_NO_ERROR on success, any other value on failure
 */
extern "C" int32_t omrcuda_streamWaitEvent(
  OMRPortLibrary* portLibrary, uint32_t deviceId, J9CudaStream stream, J9CudaEvent event)
{
