...
#define J9CUDA_ALLOCATE_MEMORY(byteCount)                                      \
  OMRPORTLIB->mem_allocate_memory(                                             \
    OMRPORTLIB, byteCount, OMR_GET_CALLSITE(), OMRMEM_CATEGORY_CUDA)
 ...
 */
int32_t
initializeTable(OMRPortLibrary* portLibrary,
                uintptr_t dllHandle,
                ...
                uintptr_t* table)
{
  ...
  for (uintptr_t index = 0; index < entryCount; ++index) {
    ...
    if (0 != portLibrary->sl_lookup_name(portLibrary,
                                         dllHandle,
                                         (char*)entry->name,
                                         &function,
                                         entry->signature)) {
 ...
 */
int32_t
getDeviceData(OMRPortLibrary* portLibrary,
              uint32_t deviceId,
              J9CudaDeviceDescriptor* deviceData)
{
  ...
  if (globals->deviceCount <= deviceId) {
    ...
    if (J9CUDA_NO_ERROR !=
        omrcuda_deviceGetMemInfo(portLibrary,
                                 deviceId,
 ...
 */
int32_t
getSummaryData(OMRPortLibrary* portLibrary,
 ...
 */
cudaError_t
getDeviceName(J9CudaFunctionTable* functions,
              uint32_t deviceId,
              uint32_t nameSize,
              char* nameOut)
{
 ...
 */
cudaError_t
initDeviceData(J9CudaFunctionTable* functions,
               uint32_t deviceId,
               J9CudaDeviceDescriptor* deviceData)
{
...

  {
    ...
    result = functions->DeviceGetAttribute(
      &pciDomainId, cudaDevAttrPciDomainId, (int)deviceId);
...

  {
    ...
    result = functions->DeviceGetAttribute(
      &pciBusId, cudaDevAttrPciBusId, (int)deviceId);
...

  {
    ...
    result = functions->DeviceGetAttribute(
      &pciDeviceId, cudaDevAttrPciDeviceId, (int)deviceId);
...

  {
    ...
    result = functions->DeviceGetAttribute(
      &computeMode, cudaDevAttrComputeMode, (int)deviceId);
  ...
  {
    result = getDeviceName(functions,
                           deviceId,
...
const J9CudaEntryDescriptor driverDescriptors[] = {
  ...
  { "cuGetErrorString",
    "iiP",
    offsetof(J9CudaFunctionTable, GetDriverErrorString),
    6000 }
};
...
openDriver(OMRPortLibrary* portLibrary)
{
  ...
  if (0 != portLibrary->sl_open_shared_library(portLibrary,
                                               (char*)driverLibrary,
  ...
  if (0 != initializeTable(portLibrary,
                           globals->driverHandle,
                           (uint32_t)version,
                           driverDescriptors,
 ...
 */
uint32_t
openRuntimeAndGetVersion(OMRPortLibrary* portLibrary,
...
struct InitializedBefore : public InitializerNotNeeded
{
  ...
  VMINLINE cudaError_t prepare(OMRPortLibrary* portLibrary,
                               ...
                               uint32_t deviceId) const
  {
    return ThreadState::initDeviceForCurrentThread(
      portLibrary, functions, deviceId);
  }
};
 ...
 */
extern "C" int32_t
omrcuda_deviceAlloc(OMRPortLibrary* portLibrary,
                    uint32_t deviceId,
                    uintptr_t size,
 ...
 */
extern "C" int32_t
omrcuda_deviceCanAccessPeer(OMRPortLibrary* portLibrary,
                            uint32_t deviceId,
                            ...
                            BOOLEAN* canAccessPeerOut)
{
  ...
  if ((cudaSuccess == result) && (NULL != functions->DeviceCanAccessPeer)) {
    ...
    result =
      functions->DeviceCanAccessPeer(&access, (int)deviceId, (int)peerDeviceId);
 ...
 */
extern "C" int32_t
omrcuda_deviceDisablePeerAccess(OMRPortLibrary* portLibrary,
                                uint32_t deviceId,
                                uint32_t peerDeviceId)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceEnablePeerAccess(OMRPortLibrary* portLibrary,
                               uint32_t deviceId,
                               uint32_t peerDeviceId)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceFree(OMRPortLibrary* portLibrary,
                   uint32_t deviceId,
                   void* deviceAddress)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceGetAttribute(OMRPortLibrary* portLibrary,
                           uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceGetCacheConfig(OMRPortLibrary* portLibrary,
                             uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceGetLimit(OMRPortLibrary* portLibrary,
                       uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceGetMemInfo(OMRPortLibrary* portLibrary,
                         uint32_t deviceId,
                         uintptr_t* freeOut,
                         uintptr_t* totalOut)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceGetName(OMRPortLibrary* portLibrary,
                      uint32_t deviceId,
                      uint32_t nameSize,
                      char* nameOut)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceGetSharedMemConfig(OMRPortLibrary* portLibrary,
                                 uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceGetStreamPriorityRange(OMRPortLibrary* portLibrary,
                                     uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceSetCacheConfig(OMRPortLibrary* portLibrary,
                             uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceSetLimit(OMRPortLibrary* portLibrary,
                       uint32_t deviceId,
                       J9CudaDeviceLimit limit,
                       uintptr_t value)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceSetSharedMemConfig(OMRPortLibrary* portLibrary,
                                 uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_eventCreate(OMRPortLibrary* portLibrary,
                    uint32_t deviceId,
                    uint32_t flags,
 ...
 */
extern "C" int32_t
omrcuda_eventDestroy(OMRPortLibrary* portLibrary,
                     uint32_t deviceId,
                     J9CudaEvent event)
{
 ...
 */
extern "C" int32_t
omrcuda_eventElapsedTime(OMRPortLibrary* portLibrary,
 ...
 */
extern "C" int32_t
omrcuda_eventRecord(OMRPortLibrary* portLibrary,
                    uint32_t deviceId,
                    J9CudaEvent event,
                    J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_funcGetAttribute(OMRPortLibrary* portLibrary,
                         uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_funcMaxActiveBlocksPerMultiprocessor(OMRPortLibrary* portLibrary,
                                             uint32_t deviceId,
                                             J9CudaFunction function,
                                             uint32_t blockSize,
                                             uint32_t dynamicSharedMemorySize,
                                             ...
                                             uint32_t* valueOut)
{
  ...
  if (cudaSuccess == result) {
    if (NULL == functions->OccupancyMaxActiveBlocksPerMultiprocessorWithFlags) {
      ...
      FunctionMaxActiveBlocks operation(
        (CUfunction)function, blockSize, dynamicSharedMemorySize, flags);
...
{
  Trc_PRT_cuda_funcMaxPotentialBlockSize_entry(deviceId,
                                               function,
                                               dynamicSharedMemoryFunction,
                                               userData,
                                               blockSizeLimit,
...
#define GET_DEVICE_ATTRIBUTE(attribute)                                        \
  do {                                                                         \
    int value = 0;                                                             \
    result = functions->DeviceGetAttribute(                                    \
      &value, (cudaDevAttr##attribute), (int)deviceId);                        \
    if (cudaSuccess != result) {                                               \
      goto done;                                                               \
    }                                                                          \
 ...
 */
extern "C" int32_t
omrcuda_funcSetCacheConfig(OMRPortLibrary* portLibrary,
                           uint32_t deviceId,
                           J9CudaFunction function,
                           J9CudaCacheConfig config)
{
 ...
 */
extern "C" int32_t
omrcuda_funcSetSharedMemConfig(OMRPortLibrary* portLibrary,
                               uint32_t deviceId,
                               J9CudaFunction function,
                               J9CudaSharedMemConfig config)
{
 ...
 */
extern "C" int32_t
omrcuda_hostAlloc(OMRPortLibrary* portLibrary,
                  uintptr_t size,
                  uint32_t flags,
                  void** hostAddressOut)
{
...
struct Launch : public InitializedBefore
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    return translate(functions->LaunchKernel(function,
                                             gridDim.x,
                                             gridDim.y,
                                             gridDim.z,
                                             blockDim.x,
 ...
 */
extern "C" int32_t
omrcuda_launchKernel(OMRPortLibrary* portLibrary,
                     uint32_t deviceId,
                     J9CudaFunction function,
                     uint32_t gridDimX,
                     uint32_t gridDimY,
                     ...
                     void** kernelParms)
{
  Trc_PRT_cuda_launchKernel_entry(deviceId,
                                  function,
                                  gridDimX,
                                  gridDimY,
                                  gridDimZ,
  ...
  const Launch operation((CUfunction)function,
                         gridDim,
                         blockDim,
                         sharedMemBytes,
                         (CUstream)stream,
...
struct LinkerAdd : public InitializedBefore
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    ...
    if (cudaSuccess == result) {
      ...
      result = translate(functions->LinkAddData(linker->state,
                                                inputType,
                                                image,
                                                imageSize,
                                                name,
 ...
 */
extern "C" int32_t
omrcuda_linkerAddData(OMRPortLibrary* portLibrary,
                      uint32_t deviceId,
                      J9CudaLinker linker,
                      J9CudaJitInputType type,
                      void* data,
                      ...
                      J9CudaJitOptions* options)
{
  Trc_PRT_cuda_linkerAddData_entry(
 ...
 */
extern "C" int32_t
omrcuda_linkerComplete(OMRPortLibrary* portLibrary,
                       uint32_t deviceId,
                       J9CudaLinker linker,
                       void** cubinOut,
                       uintptr_t* sizeOut)
...
struct LinkerCreate : public InitializedBefore
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    return translate(functions->LinkCreate(linker->createOptions.getCount(),
 ...
 */
extern "C" int32_t
omrcuda_linkerCreate(OMRPortLibrary* portLibrary,
                     uint32_t deviceId,
                     J9CudaJitOptions* options,
 ...
 */
extern "C" int32_t
omrcuda_linkerDestroy(OMRPortLibrary* portLibrary,
                      uint32_t deviceId,
                      J9CudaLinker linker)
{
...
struct Copy2D : public InitializedAfter
{
  ...
  {
    if (sync) {
      return functions->Memcpy2D(targetAddress,
                                 targetPitch,
                                 sourceAddress,
                                 sourcePitch,
                                 width,
      ...
      return functions->Memcpy2DAsync(targetAddress,
                                      targetPitch,
                                      sourceAddress,
                                      sourcePitch,
                                      width,
 ...
 */
extern "C" int32_t
omrcuda_memcpy2DDeviceToDevice(OMRPortLibrary* portLibrary,
                               uint32_t deviceId,
                               void* targetAddress,
                               size_t targetPitch,
                               const void* sourceAddress,
                               ...
                               uintptr_t height)
{
  Trc_PRT_cuda_memcpy2D_entry(deviceId,
                              targetAddress,
                              targetPitch,
                              sourceAddress,
                              sourcePitch,
  ...
  const Copy2D operation(targetAddress,
                         targetPitch,
                         sourceAddress,
                         sourcePitch,
                         width,
 ...
 */
extern "C" int32_t
omrcuda_memcpy2DDeviceToDeviceAsync(OMRPortLibrary* portLibrary,
                                    uint32_t deviceId,
                                    void* targetAddress,
                                    size_t targetPitch,
                                    const void* sourceAddress,
                                    ...
                                    J9CudaStream stream)
{
  Trc_PRT_cuda_memcpy2DAsync_entry(deviceId,
                                   targetAddress,
                                   targetPitch,
                                   sourceAddress,
                                   sourcePitch,
 ...
 */
extern "C" int32_t
omrcuda_memcpy2DDeviceToHost(OMRPortLibrary* portLibrary,
                             uint32_t deviceId,
                             void* targetAddress,
                             size_t targetPitch,
                             const void* sourceAddress,
 ...
 */
extern "C" int32_t
omrcuda_memcpy2DDeviceToHostAsync(OMRPortLibrary* portLibrary,
                                  uint32_t deviceId,
                                  void* targetAddress,
                                  size_t targetPitch,
                                  const void* sourceAddress,
 ...
 */
extern "C" int32_t
omrcuda_memcpy2DHostToDevice(OMRPortLibrary* portLibrary,
                             uint32_t deviceId,
                             void* targetAddress,
                             size_t targetPitch,
                             const void* sourceAddress,
 ...
 */
extern "C" int32_t
omrcuda_memcpy2DHostToDeviceAsync(OMRPortLibrary* portLibrary,
                                  uint32_t deviceId,
                                  void* targetAddress,
                                  size_t targetPitch,
                                  const void* sourceAddress,
...
struct Copy : public InitializedAfter
{
  ...
  {
    if (sync) {
      return functions->Memcpy(
        targetAddress, sourceAddress, byteCount, direction);
    } else {
      return functions->MemcpyAsync(targetAddress,
                                    sourceAddress,
                                    byteCount,
                                    direction,
                                    (cudaStream_t)stream);
 ...
 */
extern "C" int32_t
omrcuda_memcpyDeviceToDevice(OMRPortLibrary* portLibrary,
                             uint32_t deviceId,
                             void* targetAddress,
                             const void* sourceAddress,
                             uintptr_t byteCount)
{
  Trc_PRT_cuda_memcpy_entry(deviceId,
                            targetAddress,
                            sourceAddress,
                            byteCount,
                            cudaMemcpyDeviceToDevice);
  ...
  const Copy operation(
    targetAddress, sourceAddress, byteCount, cudaMemcpyDeviceToDevice);
 ...
 */
extern "C" int32_t
omrcuda_memcpyDeviceToDeviceAsync(OMRPortLibrary* portLibrary,
                                  uint32_t deviceId,
                                  void* targetAddress,
                                  const void* sourceAddress,
                                  uintptr_t byteCount,
                                  J9CudaStream stream)
{
  Trc_PRT_cuda_memcpyAsync_entry(deviceId,
                                 targetAddress,
                                 sourceAddress,
                                 byteCount,
                                 cudaMemcpyDeviceToDevice,
  ...
  const Copy operation(
    targetAddress, sourceAddress, byteCount, cudaMemcpyDeviceToDevice, stream);
 ...
 */
extern "C" int32_t
omrcuda_memcpyDeviceToHost(OMRPortLibrary* portLibrary,
                           uint32_t deviceId,
                           void* targetAddress,
                           const void* sourceAddress,
                           uintptr_t byteCount)
{
  Trc_PRT_cuda_memcpy_entry(
    deviceId, targetAddress, sourceAddress, byteCount, cudaMemcpyDeviceToHost);

  const Copy operation(
    targetAddress, sourceAddress, byteCount, cudaMemcpyDeviceToHost);
 ...
 */
extern "C" int32_t
omrcuda_memcpyDeviceToHostAsync(OMRPortLibrary* portLibrary,
                                uint32_t deviceId,
                                void* targetAddress,
                                const void* sourceAddress,
                                uintptr_t byteCount,
                                J9CudaStream stream)
{
  ...
  const Copy operation(
    targetAddress, sourceAddress, byteCount, cudaMemcpyDeviceToHost, stream);
 ...
 */
extern "C" int32_t
omrcuda_memcpyHostToDevice(OMRPortLibrary* portLibrary,
                           uint32_t deviceId,
                           void* targetAddress,
                           const void* sourceAddress,
                           uintptr_t byteCount)
{
  Trc_PRT_cuda_memcpy_entry(
    deviceId, targetAddress, sourceAddress, byteCount, cudaMemcpyHostToDevice);

  const Copy operation(
    targetAddress, sourceAddress, byteCount, cudaMemcpyHostToDevice);
 ...
 */
extern "C" int32_t
omrcuda_memcpyHostToDeviceAsync(OMRPortLibrary* portLibrary,
                                uint32_t deviceId,
                                void* targetAddress,
                                const void* sourceAddress,
                                uintptr_t byteCount,
                                J9CudaStream stream)
{
  ...
  const Copy operation(
    targetAddress, sourceAddress, byteCount, cudaMemcpyHostToDevice, stream);
 ...
 */
extern "C" int32_t
omrcuda_memcpyPeer(OMRPortLibrary* portLibrary,
                   ...
                   uintptr_t byteCount)
{
  ...
  if ((cudaSuccess == result) && (NULL != functions->MemcpyPeer)) {
    result = functions->MemcpyPeer(
      targetAddress, targetDeviceId, sourceAddress, sourceDeviceId, byteCount);
  }
 ...
 */
extern "C" int32_t
omrcuda_memcpyPeerAsync(OMRPortLibrary* portLibrary,
                        uint32_t targetDeviceId,
                        void* targetAddress,
                        uint32_t sourceDeviceId,
                        const void* sourceAddress,
                        ...
                        J9CudaStream stream)
{
  Trc_PRT_cuda_memcpyPeerAsync_entry(targetDeviceId,
                                     targetAddress,
                                     sourceDeviceId,
                                     sourceAddress,
                                     byteCount,
  ...
  if ((cudaSuccess == result) && (NULL != functions->MemcpyPeerAsync)) {
    result = functions->MemcpyPeerAsync(targetAddress,
                                        targetDeviceId,
                                        sourceAddress,
                                        sourceDeviceId,
                                        byteCount,
...
struct Fill8 : InitializedBefore
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    return translate(functions->MemsetD8Async(
      (CUdeviceptr)deviceAddress, value, count, (CUstream)stream));
  }
};
 ...
 */
extern "C" int32_t
omrcuda_memset8Async(OMRPortLibrary* portLibrary,
                     uint32_t deviceId,
                     void* deviceAddress,
                     uint8_t value,
                     uintptr_t count,
...
struct Fill16 : public InitializedBefore
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    return translate(functions->MemsetD16Async(
      (CUdeviceptr)deviceAddress, value, count, (CUstream)stream));
  }
};
 ...
 */
extern "C" int32_t
omrcuda_memset16Async(OMRPortLibrary* portLibrary,
                      uint32_t deviceId,
                      void* deviceAddress,
                      uint16_t value,
                      uintptr_t count,
...
struct Fill32 : public InitializedBefore
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    return translate(functions->MemsetD32Async(
      (CUdeviceptr)deviceAddress, value, count, (CUstream)stream));
  }
};
 ...
 */
extern "C" int32_t
omrcuda_memset32Async(OMRPortLibrary* portLibrary,
                      uint32_t deviceId,
                      void* deviceAddress,
                      uint32_t value,
                      uintptr_t count,
 ...
 */
extern "C" int32_t
omrcuda_moduleGetFunction(OMRPortLibrary* portLibrary,
                          uint32_t deviceId,
                          J9CudaModule module,
                          const char* name,
 ...
 */
extern "C" int32_t
omrcuda_moduleGetGlobal(OMRPortLibrary* portLibrary,
                        uint32_t deviceId,
                        J9CudaModule module,
                        const char* name,
 ...
 */
extern "C" int32_t
omrcuda_moduleGetSurfaceRef(OMRPortLibrary* portLibrary,
                            uint32_t deviceId,
                            J9CudaModule module,
                            const char* name,
 ...
 */
extern "C" int32_t
omrcuda_moduleGetTextureRef(OMRPortLibrary* portLibrary,
                            uint32_t deviceId,
                            J9CudaModule module,
                            const char* name,
                            uintptr_t* texRefOut)
...
struct Load : public InitializedBefore
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions)
  {
    ...
    if (cudaSuccess == result) {
      result = translate(functions->ModuleLoadDataEx(&module,
                                                     image,
 ...
 */
extern "C" int32_t
omrcuda_moduleLoad(OMRPortLibrary* portLibrary,
                   uint32_t deviceId,
                   const void* image,
                   J9CudaJitOptions* options,
 ...
 */
extern "C" int32_t
omrcuda_moduleUnload(OMRPortLibrary* portLibrary,
                     uint32_t deviceId,
                     J9CudaModule module)
{
...
struct StreamAddCallback : public InitializedAfter
{
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    return functions->StreamAddCallback(
      (cudaStream_t)stream, &StreamCallback::handler, callback, 0);
  }
};
 ...
 */
extern "C" int32_t
omrcuda_streamAddCallback(OMRPortLibrary* portLibrary,
                          uint32_t deviceId,
                          J9CudaStream stream,
                          J9CudaStreamCallback clientFunction,
                          uintptr_t clientData)
{
  Trc_PRT_cuda_streamAddCallback_entry(
    deviceId, stream, (void*)clientFunction, clientData);
 ...
 */
extern "C" int32_t
omrcuda_streamCreate(OMRPortLibrary* portLibrary,
                     uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_streamCreateWithPriority(OMRPortLibrary* portLibrary,
                                 uint32_t deviceId,
                                 int32_t priority,
                                 uint32_t flags,
                                 J9CudaStream* streamOut)
 ...
 */
extern "C" int32_t
omrcuda_streamDestroy(OMRPortLibrary* portLibrary,
                      uint32_t deviceId,
                      J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_streamGetFlags(OMRPortLibrary* portLibrary,
                       uint32_t deviceId,
                       J9CudaStream stream,
                       uint32_t* flagsOut)
{
 ...
 */
extern "C" int32_t
omrcuda_streamGetPriority(OMRPortLibrary* portLibrary,
                          uint32_t deviceId,
                          J9CudaStream stream,
                          int32_t* priorityOut)
{
 ...
 */
extern "C" int32_t
omrcuda_streamQuery(OMRPortLibrary* portLibrary,
                    uint32_t deviceId,
                    J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_streamSynchronize(OMRPortLibrary* portLibrary,
                          uint32_t deviceId,
                          J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_streamWaitEvent(OMRPortLibrary* portLibrary,
                        uint32_t deviceId,
                        J9CudaStream stream,
                        J9CudaEvent event)
{
