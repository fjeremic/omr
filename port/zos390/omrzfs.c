 ...
 */
static void
fillSyscallParamList(J9ZFSSyscallParamList* syscallParamListPtr,
                     int32_t opcode,
                     int32_t param2)
{
...
getZFSClientCacheSize(uint64_t* clientCacheSizePtr)
{
   ...
   * is 0
   */
  fillSyscallParamList(
    &(configParam.syscallParamList), J9CFGOP_QUERY_CLIENT_CACHE_SIZE, 0);
...
getZFSUserCacheUsed(uint64_t* userCacheUsedPtr)
{
   ...
   * structure
   */
  fillSyscallParamList(&(statParam.syscallParamList),
                       J9STATOP_USER_CACHE,
...
getZFSMetaCacheSize(uint64_t* bufferCacheSizePtr)
{
   ...
   * structure
   */
  fillSyscallParamList(&(metaStatParam.syscallParamList),
                       J9STATOP_META_CACHE,
                       (sizeof(J9ZFSSyscallParamList) + sizeof(J9ZFSStatApi)));
