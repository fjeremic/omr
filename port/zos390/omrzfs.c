 ...
 * @return none
 */
static void fillSyscallParamList(J9ZFSSyscallParamList* syscallParamListPtr, int32_t opcode, int32_t param2)
{
...
int32_t getZFSUserCacheUsed(uint64_t* userCacheUsedPtr)
{
  ...
  fillSyscallParamList(
    &(statParam.syscallParamList), J9STATOP_USER_CACHE, (sizeof(J9ZFSSyscallParamList) + sizeof(J9ZFSStatApi)));
...
int32_t getZFSMetaCacheSize(uint64_t* bufferCacheSizePtr)
{
   ...
   */
  fillSyscallParamList(
    &(metaStatParam.syscallParamList), J9STATOP_META_CACHE, (sizeof(J9ZFSSyscallParamList) + sizeof(J9ZFSStatApi)));
