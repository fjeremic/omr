...
void
fillInJumpInfo(struct OMRPortLibrary* portLibrary,
               void* contextInfo,
               void* jumpInfo)
{
  int i = 0;
...
uint32_t
infoForVR(struct OMRPortLibrary* portLibrary,
          OMRUnixSignalInfo* info,
          int32_t index,
          const char** name,
          void** value)
              ...
              void** value)
{
  ...
  *name = "";
  ...
  void* caaptr =
    (void*)_gtca(); /* see note about _gtca() use in function documentation */
  _INT4 dsa_format =
