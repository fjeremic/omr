 ...
 * 	- 2_TO_32: an allocation in range between 2 and 32 GB, available if
 *2_TO_32 or 2_TO_64 is supported by OS
 *  - 2_TO_64: an allocation in range between 2 and 64 GB, available if 2_TO_64
 *is supported by OS
 * !! Do not modify these values without correspondent changes in
 *getUserExtendedPrivateAreaMemoryType.s
 */
