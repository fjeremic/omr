...
struct ceeocb {
  ...
  struct {
    unsigned int ceeocb_opt_on : 1, ceeocb_opt_nooverride : 1, ceeocb_opt_rsvd1 : 5, ceeocb_opt_on_v : 1;
...
struct ceeedb {
  char ceeedbeye[8];
  char ___008___[248];
  unsigned int ceeedbmaini : 1, ___100_1___ : 1, ceeedbactiv : 1, ceeedbtip : 1, ___100_4___ : 1, ceeedb_posix : 1,
    ceeedbmultithread : 1, ceeedb_omvs_dubbed : 1, ceeedbipm : 8, ceeedb_creator_id : 8, ___103___ : 8;
  char ___104___[4];
  void* ceeedbmembr;
...
struct ceeedb {
  char ceeedbeye[8];
  unsigned int ceeedbmaini : 1, ceeedb_initial_amode : 1, ceeedbactiv : 1, ceeedbtip : 1, ceeedbpici : 1,
    ceeedb_posix : 1, ceeedbmultithread : 1, ceeedb_omvs_dubbed : 1, ceeedbipm : 8, ceeedbpm : 8, ceeedb_creator_id : 8;
  void* ceeedbmembr;
  struct ceeocb* ceeedboptcb;
};
#endif
