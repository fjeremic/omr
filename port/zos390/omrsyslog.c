...
uintptr_t writeToZOSLog(const char *message) {
  ...
  int modcmd = 0;
  unsigned int routeCodes[2] = {2,
                                0}; /* routing code 2 = Operator Information */
  unsigned int descCodes[2] = {12,
                               0}; /* descriptor code 12 = Important
                                      Information, no operator action reqd */
  ...
  /* Re-implemented using _console2() instead of WTO, to provided proper
   * multi-line messages. See
