 ...
 */
void
fillInLEJumpInfo(struct OMRPortLibrary* portLibrary,
                 omr_31bit_mch* regs,
                 void* jumpInfo)
{
  int i = 0;
...
uint32_t
infoForFPR_ceehdlr(struct OMRPortLibrary* portLibrary,
 ...
 * port/zos390/omrsignal_context.c */
uint32_t
infoForGPR_ceehdlr(struct OMRPortLibrary* portLibrary,
                   OMRLEConditionInfo* info,
                   int32_t index,
                   const char** name,
                   void** value)
 ...
 * port/zos390/omrsignal_context.c */
uint32_t
infoForVR_ceehdlr(struct OMRPortLibrary* portLibrary,
                  OMRLEConditionInfo* info,
                  int32_t index,
                  const char** name,
                  void** value)
 ...
 */
uint32_t
infoForControl_ceehdlr(struct OMRPortLibrary* portLibrary,
                       OMRLEConditionInfo* info,
                       int32_t index,
                       const char** name,
                       void** value)
 ...
 */
uint32_t
infoForModule_ceehdlr(struct OMRPortLibrary* portLibrary,
                      OMRLEConditionInfo* info,
                      int32_t index,
                      const char** name,
                      void** value)
 ...
 */
uint32_t
infoForSignal_ceehdlr(struct OMRPortLibrary* portLibrary,
                      OMRLEConditionInfo* info,
                      int32_t index,
                      const char** name,
                      void** value)
