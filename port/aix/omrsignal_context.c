           ...
           void** value)
{
  ...
  *name = "";
  ...
  if ((index >= 0) && (index < NFPRS)) {
    *name = n_fpr[index];
    *value =
      &(info->platformSignalInfo.context->uc_mcontext.jmp_context.fpr[index]);
...
infoForGPR(struct OMRPortLibrary* portLibrary,
           ...
           void** value)
{
  const char* n_gpr[NGPRS] = { "R0",  "R1",  "R2",  "R3",  "R4",  "R5",  "R6",
  ...
  *name = "";
  ...
  if ((index >= 0) && (index < NGPRS)) {
    *name = n_gpr[index];
    *value = (void*)&(
      info->platformSignalInfo.context->uc_mcontext.jmp_context.gpr[index]);
    return OMRPORT_SIG_VALUE_ADDRESS;
  } else {
    return OMRPORT_SIG_VALUE_UNDEFINED;
  }
  ...
  *name = "";
  ...
  switch (index) {
    ...
    case 1:
      *name = "LR";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.jmp_context.lr;
      return OMRPORT_SIG_VALUE_ADDRESS;
    case OMRPORT_SIG_CONTROL_POWERPC_MSR:
    case 2:
      *name = "MSR";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.jmp_context.msr;
      return OMRPORT_SIG_VALUE_ADDRESS;
    case OMRPORT_SIG_CONTROL_POWERPC_CTR:
    case 3:
      *name = "CTR";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.jmp_context.ctr;
      return OMRPORT_SIG_VALUE_ADDRESS;
    case OMRPORT_SIG_CONTROL_POWERPC_CR:
    case 4:
      *name = "CR";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.jmp_context.cr;
      return OMRPORT_SIG_VALUE_ADDRESS;
    case OMRPORT_SIG_CONTROL_POWERPC_FPSCR:
    case 5:
      *name = "FPSCR";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.jmp_context.fpscr;
      return OMRPORT_SIG_VALUE_ADDRESS;
    case OMRPORT_SIG_CONTROL_POWERPC_XER:
    case 6:
      *name = "XER";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.jmp_context.xer;
      return OMRPORT_SIG_VALUE_ADDRESS;
#if !defined(PPC64)
    case 7:
      *name = "TID";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.jmp_context.tid;
      return OMRPORT_SIG_VALUE_ADDRESS;
    case OMRPORT_SIG_CONTROL_POWERPC_MQ:
    case 8:
      *name = "MQ";
      *value =
        (void*)&info->platformSignalInfo.context->uc_mcontext.jmp_context.mq;
      return OMRPORT_SIG_VALUE_ADDRESS;
#endif
    default:
      return OMRPORT_SIG_VALUE_UNDEFINED;
              ...
              void** value)
{
  ...
  void* iar =
    (void*)info->platformSignalInfo.context->uc_mcontext.jmp_context.iar;
  struct ld_info* ldInfo = NULL;
  int result;

  result =
    loadquery(L_GETINFO, buffer, sizeof(info->platformSignalInfo.ldInfo));
  ...
  if (result != -1) {
    ...
    while (cursor != next) {
      cursor = next;
      if (iar >= cursor->ldinfo_textorg &&
          iar < cursor->ldinfo_textorg + cursor->ldinfo_textsize) {
        ldInfo = cursor;
        break;
      }
