 ...
 ******************************************************************************/
static OMR_TraceBuffer* getTrcBuf(OMR_TraceThread* thr,
                                  OMR_TraceBuffer* oldBuf,
                                  int bufferType) {
 ...
 * returns     - void
 ******************************************************************************/
static void copyToBuffer(OMR_TraceThread* thr,
                         int bufferType,
                         const char* var,
                         char** p,
                         int length,
 ...
 *
 ******************************************************************************/
static void tracePrint(OMR_TraceThread* thr,
 ...
 *
 ******************************************************************************/
static void traceAssertion(OMR_TraceThread* thr,
                           UtModuleInfo* modInfo,
                           uint32_t traceId,
                           va_list var) {
  int id;
 ...
 *
 ******************************************************************************/
static void traceV(OMR_TraceThread* thr,
                   UtModuleInfo* modInfo,
                   uint32_t traceId,
                   const char* spec,
                   va_list var,
  ...
  if (OMR_ARE_ANY_BITS_SET(thr->currentOutputMask, UT_MAXIMAL | UT_EXCEPTION) &&
    ...
    if ((length > 0) && ((p + length + 1) < (char*)&trcBuf->record +
      ...
      *p = (unsigned char)entryLength;
      ...
      while (*str != '\0') {
        left =
            (int32_t)((char*)&trcBuf->record + OMR_TRACEGLOBAL(bufferSize) - p);
 ...
 *
 ******************************************************************************/
static void trace(OMR_TraceThread* thr,
                  UtModuleInfo* modinfo,
                  uint32_t traceId,
                  int bufferType,
                  const char* spec,
...
static void logTracePoint(OMR_TraceThread* thr,
                          UtModuleInfo* modInfo,
                          uint32_t traceId,
                          const char* spec,
                          va_list varArgs) {
