...
class MM_EnvironmentBase : public MM_BaseVirtual {
 ...
 public:
  ...
  static OMR_VMThread *attachVMThread(
      OMR_VM *omrVM, const char *threadName,
   ...
   */
  MMINLINE static MM_EnvironmentBase *getEnvironment(
   ...
   */
  MMINLINE void setCommonAllocationContext(
      MM_AllocationContext *commonAllocationContext) {
