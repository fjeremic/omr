...
public:
  ...
  MM_HeapLinkedFreeHeader*
    _connectPreviousPreviousFreeEntry; /**< previous free entry of the last free
                                          entry to be connected into the
                                          subspace */
  ...
  uintptr_t _largestFreeEntry; /**< Largest free entry found during the
                                  connection phase of a sweep */
  MM_HeapLinkedFreeHeader*
   ...
   */
  static MM_SweepPoolState* newInstance(MM_EnvironmentBase* env,
                                        J9Pool* pool,
                                        omrthread_monitor_t mutex,
                                        MM_MemoryPool* memoryPool);
