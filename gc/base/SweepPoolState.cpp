...
bool MM_SweepPoolState::initialize(MM_EnvironmentBase* env) {
  return true;
}

void MM_SweepPoolState::create(MM_EnvironmentBase* env,
                               void* memPtr,
...
void MM_SweepPoolState::kill(MM_EnvironmentBase* env,
                             J9Pool* pool,
...
void MM_SweepPoolState::tearDown(MM_EnvironmentBase* env) {
  return;
}
