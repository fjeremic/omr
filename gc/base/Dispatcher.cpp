...
void
MM_Dispatcher::prepareThreadsForTask(MM_EnvironmentBase* env,
                                     MM_Task* task,
...
void
MM_Dispatcher::run(MM_EnvironmentBase* env,
                   MM_Task* task,
...
uintptr_t
MM_Dispatcher::recomputeActiveThreadCountForTask(MM_EnvironmentBase* env,
                                                 MM_Task* task,
                                                 uintptr_t newThreadCount)
{
  return 1;
