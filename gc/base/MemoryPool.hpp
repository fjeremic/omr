...
protected:
    ...
    volatile uintptr_t _largestFreeEntry; /**< largest free entry found at the end of a global GC cycle (no meaning
                                             during mutator execution) */

    uintptr_t _approximateFreeMemorySize; /**< The approximate number of bytes free that could be made part of the free
                                             list */
    ...
    MM_LargeObjectAllocateStats* _largeObjectAllocateStats; /**< Approximate allocation profile for large objects.
                                                               Struct to keep merged stats from all free lists */
...
public:
    ...
    void resetFreeEntryAllocateStats(MM_LargeObjectAllocateStats* largeObjectAllocateStats)
    {
        ...
        largeObjectAllocateStats->getFreeEntrySizeClassStats()->initializeFrequentAllocation(
    ...
    MMINLINE void setApproximateFreeMemorySize(uintptr_t approximateFreeMemorySize)
    {
    ...
    /**
     * Allocates the contiguous portion of an object.  This means all mixed objects, all indexable objects outside of
     * arraylet VMs, and arraylet spines (including their leaves, if inline) take this path.
     */
