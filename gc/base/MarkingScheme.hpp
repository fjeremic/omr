...
class MM_MarkingScheme : public MM_BaseVirtual {
 ...
 public:
   ...
   * @see inlineMarkObject()
   */
  bool markObject(MM_EnvironmentBase* env,
                  omrobjectptr_t objectPtr,
                  bool leafType = false);
   ...
   * @see inlineMarkObjectNoCheck()
   */
  bool markObjectNoCheck(MM_EnvironmentBase* env,
                         omrobjectptr_t objectPtr,
                         bool leafType = false);
  ...
  uintptr_t numMarkBitsInRange(MM_EnvironmentBase* env,
                               void* heapBase,
                               void* heapTop);
  uintptr_t setMarkBitsInRange(MM_EnvironmentBase* env,
                               void* heapBase,
                               void* heapTop,
                               bool clear);
