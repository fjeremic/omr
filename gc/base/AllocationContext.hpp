...
public:
     ...
     * @note No collect and climb will occur - the allocation must be satisfied within the specified location and will
     * report a failure otherwise (implementation decision).
     *
