 ...
 */
enum {
  mm_heapmss_iterator_current_space, /**< Process the subspace associated to the
                                        current space */
  mm_heapmss_iterator_current_subspace,  /**< Process the current subspace */
  mm_heapmss_iterator_children_subspace, /**< Process the children of the
                                            current subspace */
  mm_heapmss_iterator_next_subspace, /**< Move to the next sibling (or parent if
 ...
 */
void MM_HeapMemorySubSpaceIterator::reset(MM_Heap *heap) {
 ...
 * processed.
 */
MM_MemorySubSpace *MM_HeapMemorySubSpaceIterator::nextSubSpace() {
