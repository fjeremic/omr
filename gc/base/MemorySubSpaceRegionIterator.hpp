...
/**
 * Iterate over all of the regions in the subspace, recursively from all its
 * leaf subspaces.
 * @ingroup GC_Base_Core
 */
...
#define MAX_STACK_SLOTS 4
  MM_MemorySubSpace
      *_subSpaceStack[MAX_STACK_SLOTS]; /**< current stack of subspaces used for
                                           recursive search of leaf subspaces.
                                           root subspace is at slot 0. */
