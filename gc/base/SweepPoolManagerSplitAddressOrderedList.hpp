...
class MM_SweepPoolManagerSplitAddressOrderedList
    : public MM_SweepPoolManagerAddressOrderedListBase {
 private:
  MMINLINE void setSplitCandidateInformation(
 ...
 protected:
  MMINLINE virtual void connectChunkPostProcess(
    ...
    setSplitCandidateInformation(chunk, sweepState, splitCandidate,
                                 splitCandidatePreviousEntry);
  }

 public:
  static MM_SweepPoolManagerSplitAddressOrderedList *newInstance(
