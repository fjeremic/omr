...
MM_MemoryPoolAddressOrderedList::initialize(MM_EnvironmentBase* env)
{
  ...
  _largeObjectAllocateStats = MM_LargeObjectAllocateStats::newInstance(
    env,
    (uint16_t)ext->largeObjectAllocationProfilingTopK,
    ...
    tlhMaximumSize + _minimumFreeEntrySize,
  ...
  if (!_heapLock.initialize(
        env, &ext->lnrlOptions, "MM_MemoryPoolAddressOrderedList:_heapLock")) {
    return false;
  }

  if (!_resetLock.initialize(
        env, &ext->lnrlOptions, "MM_MemoryPoolAddressOrderedList:_resetLock")) {
    return false;
  }
...
MMINLINE void
MM_MemoryPoolAddressOrderedList::updateHint(
 ...
 */
void
MM_MemoryPoolAddressOrderedList::updateHintsBeyondEntry(
 ...
 */
MMINLINE void*
MM_MemoryPoolAddressOrderedList::internalAllocate(
...
retry:
  ...
  if (recycleHeapChunk(recycleEntry,
...
void*
MM_MemoryPoolAddressOrderedList::allocateObject(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription)
{
  void* addr = internalAllocate(env,
                                allocDescription->getContiguousBytes(),
                                true,
                                _largeObjectAllocateStats);
...
void*
MM_MemoryPoolAddressOrderedList::collectorAllocate(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  bool lockingRequired)
{
...
MMINLINE bool
MM_MemoryPoolAddressOrderedList::internalAllocateTLH(
  MM_EnvironmentBase* env,
...
void*
MM_MemoryPoolAddressOrderedList::allocateTLH(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  uintptr_t maximumSizeInBytesRequired,
  void*& addrBase,
...
void*
MM_MemoryPoolAddressOrderedList::collectorAllocateTLH(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  uintptr_t maximumSizeInBytesRequired,
  void*& addrBase,
  ...
  MM_HeapLinkedFreeHeader* previousFreeEntry)
{
  ...
  if (createFreeEntry(env, rangeBase, rangeTop, previousFreeEntry, NULL)) {
    ...
    TRIGGER_J9HOOK_MM_PRIVATE_REBUILD_FREE_LIST(
      env->getExtensions()->privateHookInterface,
      env->getOmrVMThread(),
      rangeBase,
      rangeTop);
  }
 ...
 */
void
MM_MemoryPoolAddressOrderedList::expandWithRange(MM_EnvironmentBase* env,
 ...
 */
void*
MM_MemoryPoolAddressOrderedList::contractWithRange(MM_EnvironmentBase* env,
 ...
 */
void
MM_MemoryPoolAddressOrderedList::addFreeEntries(
  MM_EnvironmentBase* env,
...
bool
MM_MemoryPoolAddressOrderedList::removeFreeEntriesWithinRange(
  MM_EnvironmentBase* env,
  void* lowAddress,
  void* highAddress,
 ...
 */
void*
MM_MemoryPoolAddressOrderedList::findAddressAfterFreeSize(
  MM_EnvironmentBase* env,
 ...
 */
void*
MM_MemoryPoolAddressOrderedList::findFreeEntryEndingAtAddr(
  MM_EnvironmentBase* env,
  void* addr)
{
  bool const compressed = compressObjectReferences();
 ...
 */
void*
MM_MemoryPoolAddressOrderedList::findFreeEntryTopStartingAtAddr(
  MM_EnvironmentBase* env,
  void* addr)
{
  bool const compressed = compressObjectReferences();
 ...
 */
void*
MM_MemoryPoolAddressOrderedList::getFirstFreeStartingAddr(
  MM_EnvironmentBase* env)
{
 ...
 */
void*
MM_MemoryPoolAddressOrderedList::getNextFreeStartingAddr(
  MM_EnvironmentBase* env,
  void* currentFree)
{
  bool const compressed = compressObjectReferences();
 ...
 */
void
MM_MemoryPoolAddressOrderedList::moveHeap(MM_EnvironmentBase* env,
                                          void* srcBase,
                                          void* srcTop,
                                          void* dstBase)
{
 ...
 */
bool
MM_MemoryPoolAddressOrderedList::recycleHeapChunk(void* chunkBase,
                                                  void* chunkTop)
{
  bool const compressed = compressObjectReferences();
  bool recycled = false;
 ...
 */
void
MM_MemoryPoolAddressOrderedList::printCurrentFreeList(MM_EnvironmentBase* env,
                                                      const char* area)
{
  bool const compressed = compressObjectReferences();
 ...
 */
bool
MM_MemoryPoolAddressOrderedList::isMemoryPoolValid(MM_EnvironmentBase* env,
                                                   bool postCollect)
{
  bool const compressed = compressObjectReferences();
 ...
 */
uintptr_t
MM_MemoryPoolAddressOrderedList::getCurrentFreeMemorySize(
  MM_EnvironmentBase* env)
{
  bool const compressed = compressObjectReferences();
  MM_HeapLinkedFreeHeader* currentFreeEntry = _heapFreeList;
...
void
MM_MemoryPoolAddressOrderedList::recalculateMemoryPoolStatistics(
  MM_EnvironmentBase* env)
{
  bool const compressed = compressObjectReferences();
  uintptr_t largestFreeEntry = 0;
