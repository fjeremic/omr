...
void* MM_MemoryPoolAddressOrderedList::collectorAllocate(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription, bool lockingRequired)
{
 ...
 *
 */
void MM_MemoryPoolAddressOrderedList::expandWithRange(MM_EnvironmentBase* env, uintptr_t expandSize, void* lowAddress, void* highAddress, bool canCoalesce)
{
    bool const compressed = compressObjectReferences();
 ...
 *
 */
void* MM_MemoryPoolAddressOrderedList::contractWithRange(MM_EnvironmentBase* env, uintptr_t contractSize, void* lowAddress, void* highAddress)
{
    bool const compressed = compressObjectReferences();
 ...
 *
 */
void MM_MemoryPoolAddressOrderedList::addFreeEntries(MM_EnvironmentBase* env,
...
bool MM_MemoryPoolAddressOrderedList::removeFreeEntriesWithinRange(MM_EnvironmentBase* env, void* lowAddress, void* highAddress,
 ...
 */
void* MM_MemoryPoolAddressOrderedList::findAddressAfterFreeSize(MM_EnvironmentBase* env, uintptr_t sizeRequired, uintptr_t minimumSize)
{
    bool const compressed = compressObjectReferences();
...
bool MM_MemoryPoolAddressOrderedList::isMemoryPoolValid(MM_EnvironmentBase* env, bool postCollect)
{
    ...
    if (freeBytes == _freeMemorySize && freeCount == _freeEntryCount && (postCollect || largestFree == _largestFreeEntry)) {
        return true;
    } else {
        return false;
    }
