 ...
 */
MM_MemorySpace* MM_MemorySpace::newInstance(MM_EnvironmentBase* env, MM_Heap* heap, MM_PhysicalArena* physicalArena,
    MM_MemorySubSpace* memorySubSpace, MM_InitializationParameters* parameters, const char* name,
 ...
 */
bool MM_MemorySpace::initialize(MM_EnvironmentBase* env, MM_MemorySubSpace* memorySubSpace)
{
 ...
 */
void MM_MemorySpace::unregisterMemorySubSpace(MM_MemorySubSpace* memorySubSpace)
{
...
uintptr_t MM_MemorySpace::getActiveSurvivorMemorySize(uintptr_t includeMemoryType)
{
    MM_MemorySubSpace* currentMemorySubSpace;
    uintptr_t memory;
...
uintptr_t MM_MemorySpace::getApproximateActiveFreeSurvivorMemorySize(uintptr_t includeMemoryType)
{
    MM_MemorySubSpace* currentMemorySubSpace;
    uintptr_t memory;
 ...
 */
uintptr_t MM_MemorySpace::getActualActiveFreeMemorySize(uintptr_t includeMemoryType)
{
    MM_MemorySubSpace* currentMemorySubSpace;
    uintptr_t freeMemory;
 ...
 * @return the total free memory currently available for allocation from subspaces of the specified type.
 */
uintptr_t MM_MemorySpace::getApproximateActiveFreeMemorySize(uintptr_t includeMemoryType)
{
    MM_MemorySubSpace* currentMemorySubSpace;
    uintptr_t freeMemory;
 ...
 * @return the total free memory currently available for allocation from subspaces of the specified type.
 */
uintptr_t MM_MemorySpace::getApproximateActiveFreeLOAMemorySize(uintptr_t includeMemoryType)
{
    MM_MemorySubSpace* currentMemorySubSpace;
    uintptr_t freeMemory;
...
void MM_MemorySpace::mergeHeapStats(MM_HeapStats* heapStats, uintptr_t includeMemoryType)
{
    MM_MemorySubSpace* currentMemorySubSpace;
...
void MM_MemorySpace::systemGarbageCollect(MM_EnvironmentBase* env, uint32_t gcCode)
{
    getTenureMemorySubSpace()->systemGarbageCollect(env, gcCode);
}

void MM_MemorySpace::localGarbageCollect(MM_EnvironmentBase* env, uint32_t gcCode)
{
 ...
 */
uintptr_t MM_MemorySpace::findLargestFreeEntry(MM_EnvironmentBase* env, MM_AllocateDescription* allocateDescription)
{
 ...
 */
bool MM_MemorySpace::heapAddRange(
 ...
 *
 */
bool MM_MemorySpace::heapRemoveRange(MM_EnvironmentBase* env, MM_MemorySubSpace* subspace, uintptr_t size,
    void* lowAddress, void* highAddress, void* lowValidAddres, void* highValidAddress)
{
    _currentSize -= size;
 ...
 */
bool MM_MemorySpace::canContract(MM_EnvironmentBase* env, uintptr_t contractSize)
{
