...
uintptr_t
MM_MemorySpace::getApproximateActiveFreeSurvivorMemorySize(
 ...
 */
uintptr_t
MM_MemorySpace::getApproximateActiveFreeLOAMemorySize(
  uintptr_t includeMemoryType)
{
  MM_MemorySubSpace* currentMemorySubSpace;
  uintptr_t freeMemory;
 ...
 */
uintptr_t
MM_MemorySpace::findLargestFreeEntry(
...
{
  _currentSize -= size;
  return _heap->heapRemoveRange(env,
                                subspace,
                                size,
                                lowAddress,
                                highAddress,
