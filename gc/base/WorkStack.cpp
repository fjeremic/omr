...
void
MM_WorkStack::prepareForWork(MM_EnvironmentBase* env,
...
void
MM_WorkStack::pushFailed(MM_EnvironmentBase* env, void* element)
{
  if (_outputPacket) {
...
void
MM_WorkStack::pushFailed(MM_EnvironmentBase* env,
                         void* element1,
                         void* element2)
{
  if (_outputPacket) {
