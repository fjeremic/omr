...
class MM_Bits {
 public:
  ...
  /**
   * Return the number of bits set to 0 before the first bit set to one starting
   * at the lowest significant bit.
   * @note If the input is 0, the result is undefined.
   * @return Number of non-zero bits starting at the lowest significant bit.
   */
#if defined(OMR_OS_WINDOWS)
  /* Implicit return in eax, not seen by compiler.  Disable compile warning
   * C4035: no return value */
...
#pragma warning(default : 4035) /* re-enable warning */
  ...
  /**
   * Return the number of bits set to 0 before the first bit set to one starting
   * at the highest significant bit.
   * @note If the input is 0, the result is undefined.
...
#pragma warning(default : 4035) /* re-enable warning */
  ...
  /**
   * Return the number of bits set to 0 before the first bit set to one starting
   * at the highest significant bit. Use a binary search style divide and
   * conquer algorithm.  The check constantly splits the group in half, and
   * reduces the working set to either the upper or lower half of the remaining
   * value, depending on whether bits still exist in the upper half or not.
   * @note If the input is 0, the result is undefined.
   * @return Number of non-zero bits starting at the highest significant bit.
   */
  MMINLINE static uintptr_t trailingZeroes(uintptr_t input) {
