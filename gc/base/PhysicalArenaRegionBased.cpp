 ...
 */
void
MM_PhysicalArenaRegionBased::detachSubArena(MM_EnvironmentBase* env,
 ...
 */
bool
MM_PhysicalArenaRegionBased::attachSubArena(MM_EnvironmentBase* env,
                                            MM_PhysicalSubArena* subArena,
                                            uintptr_t size,
 ...
 */
bool
MM_PhysicalArenaRegionBased::canResize(MM_EnvironmentBase* env,
                                       MM_PhysicalSubArenaRegionBased* subArena,
                                       uintptr_t sizeDelta)
{
 ...
 */
uintptr_t
MM_PhysicalArenaRegionBased::maxExpansion(
