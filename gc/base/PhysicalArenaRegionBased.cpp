 ...
 */
MM_PhysicalArenaRegionBased *MM_PhysicalArenaRegionBased::newInstance(
    MM_EnvironmentBase *env, MM_Heap *heap) {
  MM_PhysicalArenaRegionBased *arena =
      (MM_PhysicalArenaRegionBased *)env->getForge()->allocate(
          sizeof(MM_PhysicalArenaRegionBased),
...
bool MM_PhysicalArenaRegionBased::initialize(MM_EnvironmentBase *env) {
 ...
 */
void MM_PhysicalArenaRegionBased::detachSubArena(
 ...
 */
bool MM_PhysicalArenaRegionBased::attachSubArena(MM_EnvironmentBase *env,
                                                 MM_PhysicalSubArena *subArena,
                                                 uintptr_t size,
                                                 uintptr_t attachPolicy) {
  MM_PhysicalSubArenaRegionBased *subArenaToAttach =
      (MM_PhysicalSubArenaRegionBased *)subArena;
  MM_PhysicalSubArenaRegionBased *headSubArena =
 ...
 */
bool MM_PhysicalArenaRegionBased::canResize(
    MM_EnvironmentBase *env, MM_PhysicalSubArenaRegionBased *subArena,
    uintptr_t sizeDelta) {
 ...
 */
uintptr_t MM_PhysicalArenaRegionBased::maxExpansion(
    MM_EnvironmentBase *env, MM_PhysicalSubArenaRegionBased *subArena) {
 ...
 */
bool MM_PhysicalArenaRegionBased::inflate(MM_EnvironmentBase *env) {
