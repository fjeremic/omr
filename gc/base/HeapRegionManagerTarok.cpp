  ...
  MM_RegionDescriptorDestructor regionDescriptorDestructor)
{
  MM_HeapRegionManagerTarok* regionManager =
    (MM_HeapRegionManagerTarok*)env->getForge()->allocate(
      sizeof(MM_HeapRegionManagerTarok),
      OMR::GC::AllocationCategory::FIXED,
      OMR_GET_CALLSITE());
  if (NULL != regionManager) {
    new (regionManager) MM_HeapRegionManagerTarok(env,
                                                  regionSize,
                                                  tableDescriptorSize,
                                                  regionDescriptorInitializer,
                                                  regionDescriptorDestructor);
...
bool
MM_HeapRegionManagerTarok::areFreeRegionsForNode(MM_EnvironmentBase* env,
                                                 uintptr_t numaNode)
{
...
MM_HeapRegionManagerTarok::acquireSingleTableRegion(MM_EnvironmentBase* env,
...
void*
MM_HeapRegionManagerTarok::findHighestValidAddressBelow(
...
void*
MM_HeapRegionManagerTarok::findLowestValidAddressAbove(
  MM_HeapRegionDescriptor* targetRegion)
{
...
bool
MM_HeapRegionManagerTarok::setContiguousHeapRange(MM_EnvironmentBase* env,
                                                  void* lowHeapEdge,
                                                  void* highHeapEdge)
{
  writeLock();
...
void
MM_HeapRegionManagerTarok::internalLinkRegions(
  MM_EnvironmentBase* env,
...
bool
MM_HeapRegionManagerTarok::enableRegionsInTable(MM_EnvironmentBase* env,
...
void
MM_HeapRegionManagerTarok::setNodeAndLinkRegions(MM_EnvironmentBase* env,
                                                 void* lowHeapEdge,
                                                 void* highHeapEdge,
                                                 uintptr_t numaNode)
{
...
void
MM_HeapRegionManagerTarok::releaseTableRegions(MM_EnvironmentBase* env,
...
void
MM_HeapRegionManagerTarok::internalReleaseTableRegions(
  MM_EnvironmentBase* env,
...
MM_HeapRegionManagerTarok::getHeapMemorySnapshot(
