...
void Forge::tearDown() { _portLibrary = NULL; }
 ...
 * be performed
 */
void *Forge::allocate(std::size_t bytesRequested,
                      OMR::GC::AllocationCategory::Enum category,
                      const char *callsite) {
  return _portLibrary->mem_allocate_memory(_portLibrary, bytesRequested,
                                           callsite, OMRMEM_CATEGORY_MM);
}
 ...
 * allocated by either the allocate or reallocate functions.  This function is a
 * wrapper of omrmem_free_memory.
 *
