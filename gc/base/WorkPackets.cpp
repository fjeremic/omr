...
bool MM_WorkPackets::initialize(MM_EnvironmentBase* env)
{
    ...
    /* round the initialPacketCount so there is the same number of packets in each packetblock, and we have a sane
     * minimum */
 ...
 */
void MM_WorkPackets::emptyToOverflow(MM_EnvironmentBase* env, MM_Packet* packet, MM_OverflowType type)
{
 ...
 */
MM_Packet* MM_WorkPackets::getPacketByAdddingWorkPacketBlock(MM_EnvironmentBase* env)
{
    MM_Packet* packet = NULL;
 ...
 */
MM_Packet* MM_WorkPackets::getLeastFullPacket(MM_EnvironmentBase* env, int requiredSlots)
{
 ...
 */
MM_Packet* MM_WorkPackets::getPacket(MM_EnvironmentBase* env, MM_PacketList* list)
{
    MM_Packet* packet;
 ...
 */
void MM_WorkPackets::putOutputPacket(MM_EnvironmentBase* env, MM_Packet* packet)
{
#if defined(J9MODRON_TGC_PARALLEL_STATISTICS)
 ...
 */
void MM_WorkPackets::putDeferredPacket(MM_EnvironmentBase* env, MM_Packet* packet)
{
    MM_PacketList* list;
    uintptr_t freeSlots = packet->freeSlots();
 ...
 */
void MM_WorkPackets::overflowItem(MM_EnvironmentBase* env, void* item, MM_OverflowType type)
{
...
MM_WorkPacketOverflow* MM_WorkPackets::createOverflowHandler(MM_EnvironmentBase* env, MM_WorkPackets* workPackets)
{
