 ...
 */
bool
MM_MemoryPoolAddressOrderedListBase::createFreeEntry(
...
#if defined(OMR_VALGRIND_MEMCHECK)
  valgrindClearRange(env->getExtensions(),
                     (uintptr_t)addrBase,
 ...
 */
bool
MM_MemoryPoolAddressOrderedListBase::createFreeEntry(MM_EnvironmentBase* env,
                                                     void* addrBase,
                                                     void* addrTop)
{
 ...
 */
bool
MM_MemoryPoolAddressOrderedListBase::connectInnerMemoryToPool(
  MM_EnvironmentBase* env,
  void* address,
  uintptr_t size,
 ...
 */
void
MM_MemoryPoolAddressOrderedListBase::connectOuterMemoryToPool(
  MM_EnvironmentBase* env,
  void* address,
  uintptr_t size,
  void* nextFreeEntry)
 ...
 */
void
MM_MemoryPoolAddressOrderedListBase::connectFinalMemoryToPool(
  MM_EnvironmentBase* env,
  void* address,
  uintptr_t size)
{
 ...
 */
void
MM_MemoryPoolAddressOrderedListBase::abandonMemoryInPool(
  MM_EnvironmentBase* env,
  void* address,
  uintptr_t size)
{
    ...
    if (pageSize <= currentFreeEntry->getSize()) {
      ...
      if (0 < totalFreePagesCount) {
        ...
        if (0 < decommitPagesCount) {
          if (_extensions->heap->decommitMemory((void*)addressBase,
                                                decommitPagesCount * pageSize,
                                                NULL,
