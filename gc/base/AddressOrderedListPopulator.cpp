...
void MM_AddressOrderedListPopulator::initializeObjectHeapBufferedIteratorState(
...
void MM_AddressOrderedListPopulator::reset(
...
void MM_AddressOrderedListPopulator::advance(
