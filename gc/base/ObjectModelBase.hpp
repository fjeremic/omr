...
protected:
  uintptr_t _objectAlignmentInBytes; /**< cached copy of heap object alignment
                                        factor, in bytes */
  uintptr_t
      _objectAlignmentShift; /**< cached copy of heap object alignment shift,
                                must be log2(_objectAlignmentInBytes)  */
...
public:
  ...
  initializeAllocation(MM_EnvironmentBase *env, void *allocatedBytes,
                       MM_AllocateInitialization *allocateInitialization) {
    return _delegate.initializeAllocation(env, allocatedBytes,
  ...
  MMINLINE void calculateObjectDetailsForCopy(
    ...
    _delegate.calculateObjectDetailsForCopy(
   ...
   */
  MMINLINE void setObjectFlags(omrobjectptr_t objectPtr, uintptr_t bitsToClear,
                               uintptr_t bitsToSet) {
    void *headerSlotPtr = getObjectHeaderSlotAddress(objectPtr);
    if (compressObjectReferences()) {
#if defined(OBJECT_MODEL_MODRON_ASSERTIONS)
  ...
  MMINLINE bool atomicSwitchReferencedState(omrobjectptr_t objectPtr,
    ...
    if (compressObjectReferences()) {
      ...
      uintptr_t rememberedMask =
          (uintptr_t)(OMR_OBJECT_METADATA_REMEMBERED_BITS
                      << getObjectHeaderSlotFlagsShift());
      uintptr_t oldFlags;
      uintptr_t newFlags;
