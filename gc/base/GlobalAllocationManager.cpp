 ...
 */
void MM_GlobalAllocationManager::flushAllocationContexts(MM_EnvironmentBase* env)
{
...
void MM_GlobalAllocationManager::flushAllocationContextsForShutdown(MM_EnvironmentBase* env)
{
    Assert_MM_true(_managedAllocationContextCount > 0);
