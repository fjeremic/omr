                                      ...
                                      uintptr_t minimumFreeEntrySize)
{
  MM_MemoryPoolBumpPointer* memoryPool =
    (MM_MemoryPoolBumpPointer*)env->getForge()->allocate(
      sizeof(MM_MemoryPoolBumpPointer),
...
void*
MM_MemoryPoolBumpPointer::allocateObject(
...
MMINLINE bool
MM_MemoryPoolBumpPointer::internalAllocateTLH(
  MM_EnvironmentBase* env,
...
void*
MM_MemoryPoolBumpPointer::allocateTLH(MM_EnvironmentBase* env,
                                      MM_AllocateDescription* allocDescription,
                                      uintptr_t maximumSizeInBytesRequired,
                                      void*& addrBase,
                                      void*& addrTop)
...
void*
MM_MemoryPoolBumpPointer::collectorAllocate(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
...
void*
MM_MemoryPoolBumpPointer::collectorAllocateTLH(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  uintptr_t maximumSizeInBytesRequired,
  void*& addrBase,
...
MM_MemoryPoolBumpPointer::rebuildFreeListInRegion(
  MM_EnvironmentBase* env,
...
void
MM_MemoryPoolBumpPointer::setAllocationPointer(MM_EnvironmentBase* env,
 ...
 */
void
MM_MemoryPoolBumpPointer::expandWithRange(MM_EnvironmentBase* env,
 ...
 */
void*
MM_MemoryPoolBumpPointer::contractWithRange(MM_EnvironmentBase* env,
...
MMINLINE bool
MM_MemoryPoolBumpPointer::internalRecycleHeapChunk(
  void* addrBase,
  void* addrTop,
...
void
MM_MemoryPoolBumpPointer::recalculateMemoryPoolStatistics(
  MM_EnvironmentBase* env)
{
 ...
 */
bool
MM_MemoryPoolBumpPointer::createFreeEntry(
  MM_EnvironmentBase* env,
  void* addrBase,
  void* addrTop,
  MM_HeapLinkedFreeHeader* previousFreeEntry,
 ...
 */
bool
MM_MemoryPoolBumpPointer::createFreeEntry(MM_EnvironmentBase* env,
                                          void* addrBase,
                                          void* addrTop)
{
 ...
 */
bool
MM_MemoryPoolBumpPointer::connectInnerMemoryToPool(MM_EnvironmentBase* env,
                                                   void* address,
                                                   uintptr_t size,
 ...
 */
void
MM_MemoryPoolBumpPointer::connectOuterMemoryToPool(MM_EnvironmentBase* env,
                                                   void* address,
                                                   uintptr_t size,
                                                   void* nextFreeEntry)
{
 ...
 */
void
MM_MemoryPoolBumpPointer::connectFinalMemoryToPool(MM_EnvironmentBase* env,
                                                   void* address,
                                                   uintptr_t size)
{
  Assert_MM_true((NULL == address) || (size >= getMinimumFreeEntrySize()));
  ...
  /* Build the free header */
  createFreeEntry(
    env, (MM_HeapLinkedFreeHeader*)address, (uint8_t*)address + size);
}
