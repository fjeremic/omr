...
protected:
  ...
  MM_LargeObjectAllocateStats*
    _largeObjectAllocateStatsForFreeList; /**< Approximate allocation profile
                                             for large objects. An array of stat
                                             structs for each free list */
  MM_LargeObjectAllocateStats*
...
protected:
  ...
  bool recycleHeapChunk(MM_EnvironmentBase* env,
                        void* addrBase,
                        void* addrTop,
...
public:
  ...
  virtual void* getNextFreeStartingAddr(MM_EnvironmentBase* env,
                                        void* currentFree);
  void* getNextFreeStartingAddr(MM_EnvironmentBase* env,
                                void* currentFree,
