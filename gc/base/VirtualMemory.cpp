...
MM_VirtualMemory* MM_VirtualMemory::newInstance(MM_EnvironmentBase* env,
...
bool MM_VirtualMemory::initialize(MM_EnvironmentBase* env,
                                  uintptr_t size,
                                  void* preferredAddress,
                                  void* ceiling,
                                  uintptr_t options,
 ...
 * @return true if successful, false otherwise.
 */
bool MM_VirtualMemory::decommitMemory(void* address,
                                      uintptr_t size,
...
bool MM_VirtualMemory::setNumaAffinity(uintptr_t numaNode,
                                       void* address,
