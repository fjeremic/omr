...
void* MM_MemorySubSpaceSemiSpace::allocateObject(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription, MM_MemorySubSpace* baseSubSpace, MM_MemorySubSpace* previousSubSpace, bool shouldCollectOnFailure)
{
...
void* MM_MemorySubSpaceSemiSpace::allocationRequestFailed(MM_EnvironmentBase* env, MM_AllocateDescription* allocateDescription, AllocationType allocationType, MM_ObjectAllocationInterface* objectAllocationInterface, MM_MemorySubSpace* baseSubSpace, MM_MemorySubSpace* previousSubSpace)
{
...
void* MM_MemorySubSpaceSemiSpace::allocateArrayletLeaf(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription, MM_MemorySubSpace* baseSubSpace, MM_MemorySubSpace* previousSubSpace, bool shouldCollectOnFailure)
{
    void* addr = NULL;
...
void* MM_MemorySubSpaceSemiSpace::allocateTLH(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription, MM_ObjectAllocationInterface* objectAllocationInterface, MM_MemorySubSpace* baseSubSpace, MM_MemorySubSpace* previousSubSpace, bool shouldCollectOnFailure)
{
...
void MM_MemorySubSpaceSemiSpace::flip(MM_EnvironmentBase* env, Flip_step step)
{
    ...
    case restore_allocation_and_set_survivor:
        ...
        _avgDeviationBytesAllocatedDuringConcurrent = sqrtf(MM_Math::weightedAverage(_avgDeviationBytesAllocatedDuringConcurrent * _avgDeviationBytesAllocatedDuringConcurrent,
 ...
 * 
 */
void MM_MemorySubSpaceSemiSpace::checkResize(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription, bool systemGC)
{
