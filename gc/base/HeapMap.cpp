 ...
 */
bool MM_HeapMap::heapAddRange(MM_EnvironmentBase* env,
                              uintptr_t size,
                              void* lowAddress,
                              void* highAddress) {
  bool commited = true;
 ...
 * @return true if succeed
 */
bool MM_HeapMap::heapRemoveRange(MM_EnvironmentBase* env,
                                 uintptr_t size,
                                 void* lowAddress,
                                 void* highAddress,
 ...
 */
uintptr_t MM_HeapMap::setBitsInRange(MM_EnvironmentBase* env,
                                     void* lowAddress,
                                     void* highAddress,
                                     bool clear) {
  uintptr_t baseIndex, topIndex;
