 ...
 */
bool MM_HeapMap::heapAddRange(MM_EnvironmentBase* env, uintptr_t size, void* lowAddress, void* highAddress)
{
    bool commited = true;
 ...
 * @return true if succeed
 */
bool MM_HeapMap::heapRemoveRange(MM_EnvironmentBase* env, uintptr_t size, void* lowAddress, void* highAddress, void* lowValidAddress, void* highValidAddress)
{
...
bool MM_HeapMap::checkBitsForRegion(MM_EnvironmentBase* env, MM_HeapRegionDescriptor* region)
{
    uintptr_t baseIndex, topIndex;
