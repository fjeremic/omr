 ...
 */
uintptr_t
MM_HeapMap::convertHeapIndexToHeapMapIndex(MM_EnvironmentBase* env,
                                           uintptr_t offset,
                                           uintptr_t roundTo)
{
  if (!_useCompressedHeapMap) {
...
MM_HeapMap::getMaximumHeapMapSize(MM_EnvironmentBase* env)
{
  ...
  return convertHeapIndexToHeapMapIndex(
    env, _maxHeapSize, extensions->heapAlignment);
}
 ...
 */
bool
MM_HeapMap::heapAddRange(MM_EnvironmentBase* env,
                         uintptr_t size,
                         void* lowAddress,
                         void* highAddress)
{
 ...
 */
bool
MM_HeapMap::heapRemoveRange(MM_EnvironmentBase* env,
                            uintptr_t size,
                            void* lowAddress,
                            void* highAddress,
 ...
 */
uintptr_t
MM_HeapMap::numberBitsInRange(MM_EnvironmentBase* env,
                              void* lowAddress,
                              void* highAddress)
{
  ...
  Assert_MM_true(
    ...
    MM_Math::roundToCeiling(_extensions->heapAlignment, (uintptr_t)lowAddress));
 ...
 */
uintptr_t
MM_HeapMap::setBitsInRange(MM_EnvironmentBase* env,
                           void* lowAddress,
                           void* highAddress,
                           bool clear)
{
...
uintptr_t
MM_HeapMap::setBitsForRegion(MM_EnvironmentBase* env,
                             MM_HeapRegionDescriptor* region,
                             bool clear)
{
  return setBitsInRange(
    env, region->getLowAddress(), region->getHighAddress(), clear);
}

bool
MM_HeapMap::checkBitsForRegion(MM_EnvironmentBase* env,
                               MM_HeapRegionDescriptor* region)
{
  uintptr_t baseIndex, topIndex;
