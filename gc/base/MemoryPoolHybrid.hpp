...
class MM_MemoryPoolHybrid : public MM_MemoryPoolSplitAddressOrderedListBase {
 ...
 private:
  ...
  void appendToReservedFreeList(MM_EnvironmentBase* env,
                                void* address,
                                uintptr_t size);
   ...
   */
  void appendToFreeList(MM_EnvironmentBase* env,
 ...
 public:
   ...
   */
  MM_MemoryPoolHybrid(MM_EnvironmentBase* env,
                      uintptr_t minimumFreeEntrySize,
                      uintptr_t splitAmount)
      : MM_MemoryPoolSplitAddressOrderedListBase(env,
