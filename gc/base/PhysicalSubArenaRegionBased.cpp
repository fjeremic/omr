...
{
  return _parent->attachSubArena(
    env, this, _subSpace->getInitialSize(), modron_pavm_attach_policy_none);
}
 ...
 */
uintptr_t
MM_PhysicalSubArenaRegionBased::doContractInSubSpace(
 ...
 */
uintptr_t
MM_PhysicalSubArenaRegionBased::doExpandInSubSpace(MM_EnvironmentBase* env,
...
uintptr_t
MM_PhysicalSubArenaRegionBased::performExpand(MM_EnvironmentBase* env,
                                              uintptr_t expandSize)
{
  uintptr_t result = 0;
...
uintptr_t
MM_PhysicalSubArenaRegionBased::expand(MM_EnvironmentBase* env,
                                       uintptr_t expandSize)
{
...
uintptr_t
MM_PhysicalSubArenaRegionBased::contract(MM_EnvironmentBase* env,
                                         uintptr_t expandSize)
{
  if (((MM_PhysicalArenaRegionBased*)_parent)
        ->canResize(env, this, expandSize)) {
...
uintptr_t
MM_PhysicalSubArenaRegionBased::getAvailableContractionSize(
  MM_EnvironmentBase* env,
