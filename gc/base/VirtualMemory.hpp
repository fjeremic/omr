...
class MM_VirtualMemory : public MM_BaseVirtual {
     ...
     */
private:
    uintptr_t _pageSize; /**< Page size for this virtual memory object (before reservation requested, after reservation
                            real) */
    uintptr_t _pageFlags; /**< Flags describing the pages used for the virtual memory object */
    uintptr_t _tailPadding; /**< The number of bytes of padding at the end of the virtual memory. This padding will be
                               committed into, but not reported as available */
    void* _heapBase; /**< The lowest usable address in the reserved block, once alignment and padding are taken into
                        account */
    void* _heapTop; /**< One byte past the highest usable address in the reserved block, once alignment and padding are
                       taken into account */
