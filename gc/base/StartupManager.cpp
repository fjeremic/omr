...
uintptr_t MM_StartupManager::getUDATAValue(char* option, uintptr_t* outputValue)
{
...
MM_Configuration* MM_StartupManager::createConfiguration(MM_EnvironmentBase* env)
{
