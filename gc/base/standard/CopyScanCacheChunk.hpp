...
class MM_CopyScanCacheChunk : public MM_BaseVirtual {
 ...
 protected:
  ...
  bool initialize(MM_EnvironmentBase *env, uintptr_t cacheEntryCount,
                  MM_CopyScanCacheChunk *nextChunk, uintptr_t flags,
 ...
 public:
  ...
  MMINLINE void setNext(MM_CopyScanCacheChunk *nextChunk) {
    _nextChunk = nextChunk;
  }

  static MM_CopyScanCacheChunk *newInstance(
  ...
  MM_CopyScanCacheChunk()
      : MM_BaseVirtual(), _baseCache(NULL), _nextChunk(NULL) {
