...
{
    return memorySubSpace->isLeafSubSpace()
 ...
 */
bool MM_ConcurrentSweepScheme::sweepNextAvailableChunk(MM_EnvironmentStandard* env, MM_ConcurrentSweepPoolState* sweepState)
{
    MM_ParallelSweepChunk* chunk;
 ...
 * @return true if a chunk was found and swept by the caller, false otherwise.
 */
bool MM_ConcurrentSweepScheme::sweepPreviousAvailableChunk(MM_EnvironmentStandard* env, MM_ConcurrentSweepPoolState* sweepState)
{
    MM_ParallelSweepChunk* chunk;
 ...
 * @return true if a chunk was found and swept by the caller, false otherwise.
 */
bool MM_ConcurrentSweepScheme::concurrentSweepNextAvailableChunk(MM_EnvironmentStandard* env, MM_ConcurrentSweepPoolState* sweepState)
{
    bool result = false;
 ...
 *  
 */
void MM_ConcurrentSweepScheme::payAllocationTax(MM_EnvironmentBase* env, MM_MemorySubSpace* subSpace, MM_AllocateDescription* allocDescription)
{
 ...
 * @note Do not call directly as this is the entry point for the dispatched task.
 */
void MM_ConcurrentSweepScheme::workThreadFindMinimumSizeFreeEntry(MM_EnvironmentBase* envBase, MM_MemorySubSpace* memorySubSpace, UDATA minimumFreeSize)
{
    MM_MemoryPool* memoryPool;
    MM_EnvironmentStandard* env = MM_EnvironmentStandard::getEnvironment(envBase);
    MM_ConcurrentSweepFindMinimumSizeFreeTask* task = (MM_ConcurrentSweepFindMinimumSizeFreeTask*)env->_currentTask;
 ...
 */
void MM_ConcurrentSweepScheme::propagateChunkProjections(MM_EnvironmentBase* envModron, MM_ParallelSweepChunk* startingChunkToPropagate)
{
 ...
 * @note Only the chunks after the first live object will be gaurenteed to have proper projections
 */
void MM_ConcurrentSweepScheme::abandonOverlappedChunks(MM_EnvironmentBase* envModron, MM_ParallelSweepChunk* startingChunk, bool isFirstChunkInSubpool)
{
 ...
 */
void MM_ConcurrentSweepScheme::walkChunkForOverlappingDeadSpace(MM_EnvironmentBase* envModron, MM_ParallelSweepChunk* currentChunk, void* walkStart)
{
    CONSS_DEBUG_OMRPORT_ACCESS_FROM_OMRPORT(envModron->getPortLibrary());
