 ...
 */
MM_ConcurrentGCSATB* MM_ConcurrentGCSATB::newInstance(MM_EnvironmentBase* env) {
  MM_ConcurrentGCSATB* concurrentGC =
      (MM_ConcurrentGCSATB*)env->getForge()->allocate(
          sizeof(MM_ConcurrentGCSATB), OMR::GC::AllocationCategory::FIXED,
          OMR_GET_CALLSITE());
 ...
 *
 */
void MM_ConcurrentGCSATB::kill(MM_EnvironmentBase* env) {
  tearDown(env);
 ...
 */
void MM_ConcurrentGCSATB::tearDown(MM_EnvironmentBase* env) {
  /* ..and then tearDown our super class */
  MM_ConcurrentGC::tearDown(env);
}

void MM_ConcurrentGCSATB::reportConcurrentHalted(MM_EnvironmentBase* env) {}

uintptr_t MM_ConcurrentGCSATB::localMark(MM_EnvironmentBase* env,
