                                  ...
                                  MM_WorkPacketsSATB* workPackets)
{
  ...
  rememberedSet = (MM_RememberedSetSATB*)env->getForge()->allocate(
    sizeof(MM_RememberedSetSATB),
    MM_AllocationCategory::WORK_PACKETS,
    J9_GET_CALLSITE());
 ...
 */
void
MM_RememberedSetSATB::initializeFragment(MM_EnvironmentBase* env,
 ...
 */
void
MM_RememberedSetSATB::storeInFragment(MM_EnvironmentBase* env,
                                      MM_GCRememberedSetFragment* fragment,
                                      UDATA* value)
{
 ...
 */
bool
MM_RememberedSetSATB::isFragmentValid(
 ...
 */
void
MM_RememberedSetSATB::preserveLocalFragmentIndex(
  MM_EnvironmentBase* env,
  MM_GCRememberedSetFragment* fragment)
{
 ...
 */
void
MM_RememberedSetSATB::restoreLocalFragmentIndex(
  MM_EnvironmentBase* env,
  MM_GCRememberedSetFragment* fragment)
{
  assume((fragment->localFragmentIndex == J9GC_REMEMBERED_SET_RESERVED_INDEX),
 ...
 */
bool
MM_RememberedSetSATB::refreshFragment(MM_EnvironmentBase* env,
                                      MM_GCRememberedSetFragment* fragment)
{
