 ...
 */
MM_RememberedSetSATB* MM_RememberedSetSATB::newInstance(MM_EnvironmentBase* env, MM_WorkPacketsSATB* workPackets)
{
 ...
 */
void MM_RememberedSetSATB::initializeFragment(MM_EnvironmentBase* env, MM_GCRememberedSetFragment* fragment)
{
 ...
 */
void MM_RememberedSetSATB::storeInFragment(MM_EnvironmentBase* env, MM_GCRememberedSetFragment* fragment, UDATA* value)
{
 ...
 */
bool MM_RememberedSetSATB::isFragmentValid(MM_EnvironmentBase* env, const MM_GCRememberedSetFragment* fragment)
{
 ...
 */
void MM_RememberedSetSATB::preserveLocalFragmentIndex(MM_EnvironmentBase* env, MM_GCRememberedSetFragment* fragment)
{
 ...
 */
void MM_RememberedSetSATB::restoreLocalFragmentIndex(MM_EnvironmentBase* env, MM_GCRememberedSetFragment* fragment)
{
    assume((fragment->localFragmentIndex == J9GC_REMEMBERED_SET_RESERVED_INDEX),
 ...
 * will see a difference in the fragment indexes and force the JIT to go out-of-line.
 */
void MM_RememberedSetSATB::preserveGlobalFragmentIndex(MM_EnvironmentBase* env)
{
 ...
 */
void MM_RememberedSetSATB::setGlobalIndex(MM_EnvironmentBase* env, UDATA indexValue)
{
 ...
 * is to be updated.
 */
bool MM_RememberedSetSATB::refreshFragment(MM_EnvironmentBase* env, MM_GCRememberedSetFragment* fragment)
{
