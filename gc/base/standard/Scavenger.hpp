...
#define IS_CONCURRENT_ENABLED _extensions->isConcurrentScavengerEnabled()
 ...
 public:
  ...
  MMINLINE MM_CopyScanCacheStandard *reserveMemoryForAllocateInSemiSpace(
      MM_EnvironmentStandard *env, omrobjectptr_t objectToEvacuate,
      uintptr_t objectReserveSizeInBytes);
  MM_CopyScanCacheStandard *reserveMemoryForAllocateInTenureSpace(
      MM_EnvironmentStandard *env, omrobjectptr_t objectToEvacuate,
      uintptr_t objectReserveSizeInBytes);
  ...
  MMINLINE bool scavengeObjectSlots(MM_EnvironmentStandard *env,
                                    ...
                                    omrobjectptr_t *rememberedSetSlot);
  MMINLINE MM_CopyScanCacheStandard *incrementalScavengeObjectSlots(
  ...
  void backoutFixupAndReverseForwardPointersInSurvivor(
  ...
  MMINLINE MM_CopyScanCacheStandard *aliasToCopyCache(
  ...
  MMINLINE MM_CopyScanCacheStandard *getNextScanCacheFromList(
      MM_EnvironmentStandard *env);
  void addCopyCachesToFreeList(MM_EnvironmentStandard *env);
  MMINLINE void addCacheEntryToScanListAndNotify(
  ...
  MMINLINE bool isWorkAvailableInCacheWithCheck(
   ...
   */
  MM_CopyScanCacheStandard *releaseLocalCopyCache(
 ...
 public:
  ...
  virtual void preConcurrentInitializeStatsAndReport(
  ...
  virtual void postConcurrentUpdateStatsAndReport(
      MM_EnvironmentBase *env, MM_ConcurrentPhaseStatsBase *stats,
