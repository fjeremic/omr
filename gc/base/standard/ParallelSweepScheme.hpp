...
class MM_ParallelSweepTask : public MM_ParallelTask {
 ...
 public:
   ...
   */
  MM_ParallelSweepTask(MM_EnvironmentBase* env,
...
class MM_ParallelSweepScheme : public MM_BaseVirtual {
 ...
 protected:
  ...
  void sweepMarkMapBody(uintptr_t*& markMapCurrent,
  ...
  void sweepMarkMapHead(uintptr_t* markMapFreeHead,
                        uintptr_t* markMapChunkBase,
                        uintptr_t*& heapSlotFreeHead,
                        uintptr_t& heapSlotFreeCount);
  void sweepMarkMapTail(uintptr_t* markMapCurrent,
                        uintptr_t* markMapChunkTop,
                        uintptr_t& heapSlotFreeCount);
