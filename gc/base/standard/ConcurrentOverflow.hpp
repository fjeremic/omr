...
class MM_ConcurrentOverflow : public MM_WorkPacketOverflow {
 ...
 private:
  ...
  /* Methods */
 public:
  static MM_ConcurrentOverflow* newInstance(MM_EnvironmentBase* env,
 ...
 private:
   ...
   *
   */
  void overflowItemInternal(MM_EnvironmentBase* env,
                            void* item,
   ...
   */
  void clearCardsForNewSpace(MM_EnvironmentStandard* env,
