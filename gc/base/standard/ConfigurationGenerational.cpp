...
MM_ConfigurationGenerational::newInstance(MM_EnvironmentBase* env)
{
  ...
  configuration = (MM_ConfigurationGenerational*)env->getForge()->allocate(
    sizeof(MM_ConfigurationGenerational),
...
MM_ConfigurationGenerational::createSemiSpace(
  ...
  UDATA numaNode)
{
  ...
  if (NULL ==
      (memorySubSpaceSemiSpace = MM_MemorySubSpaceSemiSpace::newInstance(
         env,
         scavenger,
         physicalSubArenaSemiSpace,
         memorySubSpaceGenericAllocate,
         memorySubSpaceGenericSurvivor,
         false,
...
MM_MemorySpace*
MM_ConfigurationGenerational::createDefaultMemorySpace(
  MM_EnvironmentBase* envBase,
  MM_Heap* heap,
  MM_InitializationParameters* parameters)
{
  ...
  if (NULL == (memorySubSpaceGenericOld = MM_MemorySubSpaceGeneric::newInstance(
                 env,
                 memoryPoolOld,
                 NULL,
                 false,
  ...
  if (NULL == (memorySubSpaceOld = MM_MemorySubSpaceFlat::newInstance(
                 env,
                 physicalSubArenaFlat,
  ...
  return MM_MemorySpace::newInstance(env,
                                     heap,
                                     physicalArena,
                                     memorySubSpaceGenerational,
                                     parameters,
                                     MEMORY_SPACE_NAME_GENERATIONAL,
                                     MEMORY_SPACE_DESCRIPTION_GENERATIONAL);
}
  ...
  MM_HeapRegionManager* regionManager)
{
  ...
  if (extensions->enableSplitHeap) {
    ...
    heap = MM_HeapSplit::newInstance(
      env, extensions->heapAlignment, lowSize, highSize, regionManager);
...
void
MM_ConfigurationGenerational::defaultMemorySpaceAllocated(
...
uintptr_t
MM_ConfigurationGenerational::calculateDefaultRegionSize(
  MM_EnvironmentBase* env)
{
