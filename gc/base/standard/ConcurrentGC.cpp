 ...
 */
MMINLINE float MM_ConcurrentGC::interpolateInRange(float val1,
                                                   float val8,
                                                   float val10,
                                                   uintptr_t traceRate) {
  float ret;
 ...
 */
bool MM_ConcurrentGC::getInitRange(MM_EnvironmentBase* env,
                                   void** from,
                                   void** to,
                                   InitType* type,
 ...
 */
MMINLINE uintptr_t
MM_ConcurrentGC::potentialFreeSpace(MM_EnvironmentBase* env,
                                    MM_AllocateDescription* allocDescription) {
