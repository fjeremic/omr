 ...
 */
MM_OverflowStandard* MM_OverflowStandard::newInstance(MM_EnvironmentBase* env, MM_WorkPackets* workPackets)
{
    MM_OverflowStandard* overflow = (MM_OverflowStandard*)env->getForge()->allocate(
        sizeof(MM_OverflowStandard), OMR::GC::AllocationCategory::FIXED, OMR_GET_CALLSITE());
    if (NULL != overflow) {
...
void MM_OverflowStandard::emptyToOverflow(MM_EnvironmentBase* env, MM_Packet* packet, MM_OverflowType type)
{
    void* objectPtr;
...
void MM_OverflowStandard::overflowItem(MM_EnvironmentBase* env, void* item, MM_OverflowType type)
{
    _overflow = true;
...
void MM_OverflowStandard::overflowItemInternal(MM_EnvironmentBase* env, void* item)
{
...
void MM_OverflowStandard::fillFromOverflow(MM_EnvironmentBase* env, MM_Packet* packet)
{
