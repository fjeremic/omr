...
void
MM_OverflowStandard::emptyToOverflow(MM_EnvironmentBase* env,
                                     MM_Packet* packet,
...
void
MM_OverflowStandard::overflowItem(MM_EnvironmentBase* env,
                                  void* item,
                                  MM_OverflowType type)
{
  _overflow = true;
...
void
MM_OverflowStandard::fillFromOverflow(MM_EnvironmentBase* env,
                                      MM_Packet* packet)
{
