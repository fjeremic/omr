...
public:
  ...
  enum
  {
    sizeof_page = 2 * J9MODRON_HEAP_BYTES_PER_HEAPMAP_SLOT
  };
...
protected:
  ...
  void moveObjects(MM_EnvironmentStandard* env,
                   uintptr_t& objectCount,
                   uintptr_t& byteCount,
                   uintptr_t& skippedObjectCount);
   ...
   */
  void fixupSubArea(MM_EnvironmentStandard* env,
                    omrobjectptr_t firstObject,
                    omrobjectptr_t finish,
                    bool markedOnly,
                    uintptr_t& objectCount);
   ...
   */
  bool changeSubAreaAction(MM_EnvironmentBase* env,
                           SubAreaEntry* entry,
                           uintptr_t newAction);
...
public:
  ...
  virtual void compact(MM_EnvironmentBase* env,
