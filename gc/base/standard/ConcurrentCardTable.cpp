 ...
 */
uintptr_t
MM_ConcurrentCardTable::calculateTLHMarkMapSize(MM_EnvironmentBase *env,
                                                uintptr_t cardTableSize) {
  uintptr_t size;
...
MM_ConcurrentCardTable::newInstance(MM_EnvironmentBase *env, MM_Heap *heap,
 ...
 */
MMINLINE bool
MM_ConcurrentCardTable::getExclusiveCardTableAccess(MM_EnvironmentBase *env,
                                                    CardCleanPhase currentPhase,
