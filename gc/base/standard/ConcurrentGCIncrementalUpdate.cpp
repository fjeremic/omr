...
{
    MM_ConcurrentGCIncrementalUpdate* concurrentGC = (MM_ConcurrentGCIncrementalUpdate*)env->getForge()->allocate(sizeof(MM_ConcurrentGCIncrementalUpdate),
...
bool MM_ConcurrentGCIncrementalUpdate::heapAddRange(MM_EnvironmentBase* env, MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress, void* highAddress)
{
 ...
 */
void MM_ConcurrentGCIncrementalUpdate::hookCardCleanPass2Start(J9HookInterface** hook, uintptr_t eventNum, void* eventData, void* userData)
{
...
void MM_ConcurrentGCIncrementalUpdate::recordCardCleanPass2Start(MM_EnvironmentBase* env)
{
    _pass2Started = true;
...
bool MM_ConcurrentGCIncrementalUpdate::createCardTable(MM_EnvironmentBase* env)
{
    bool result = false;
