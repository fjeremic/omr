...
protected:
  MM_PacketList _inUseBarrierPacketList; /**< List for packets currently being
                                            used for the remembered set*/
...
public:
  ...
  virtual void removePacketFromInUseList(MM_EnvironmentBase *env,
                                         MM_Packet *packet);
  ...
  MM_WorkPacketsSATB(MM_EnvironmentBase *env)
      : MM_WorkPackets(env), _inUseBarrierPacketList(NULL) {
