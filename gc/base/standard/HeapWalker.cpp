 ...
 */
static void heapWalkerObjectFieldSlotDo(OMR_VM* omrVM, omrobjectptr_t object, GC_SlotObject* slotObject,
    MM_HeapWalkerSlotFunc oSlotIterator, void* localUserData)
{
 ...
 */
static void heapWalkerObjectSlotDo(
    OMR_VM* omrVM, omrobjectptr_t object, MM_HeapWalkerSlotFunc oSlotIterator, void* localUserData)
{
...
MM_HeapWalker* MM_HeapWalker::newInstance(MM_EnvironmentBase* env)
{
    ...
    heapWalker = (MM_HeapWalker*)env->getForge()->allocate(
        sizeof(MM_HeapWalker), OMR::GC::AllocationCategory::FIXED, OMR_GET_CALLSITE());
    if (heapWalker) {
...
void MM_HeapWalker::rememberedObjectSlotsDo(
    MM_EnvironmentBase* env, MM_HeapWalkerSlotFunc function, void* userData, uintptr_t walkFlags, bool parallel)
{
 ...
 */
void MM_HeapWalker::allObjectSlotsDo(MM_EnvironmentBase* env, MM_HeapWalkerSlotFunc function, void* userData,
    uintptr_t walkFlags, bool parallel, bool prepareHeapForWalk)
{
    ...
    allObjectsDo(
        env, heapWalkerObjectSlotDo, (void*)&slotObjectDoUserData, modifiedWalkFlags, parallel, prepareHeapForWalk);
 ...
 */
void MM_HeapWalker::allObjectsDo(MM_EnvironmentBase* env, MM_HeapWalkerObjectFunc function, void* userData,
    uintptr_t walkFlags, bool parallel, bool prepareHeapForWalk)
{
