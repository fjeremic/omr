 ...
 */
static void heapWalkerObjectFieldSlotDo(OMR_VM* omrVM,
 ...
 */
static void heapWalkerObjectSlotDo(OMR_VM* omrVM,
                                   omrobjectptr_t object,
                                   MM_HeapWalkerSlotFunc oSlotIterator,
                                   void* localUserData) {
...
bool MM_HeapWalker::initialize(MM_EnvironmentBase* env) {
  return true;
}
