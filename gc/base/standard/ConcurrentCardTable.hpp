...
private:
  ...
  bool allocateCardTableEntriesForHeapRange(MM_EnvironmentBase* env,
                                            ...
                                            void* highAddress,
                                            bool clearNewCards);
  bool freeCardTableEntriesForHeapRange(MM_EnvironmentBase* env,
                                        uintptr_t size,
                                        void* lowAddress,
                                        void* highAddress,
  ...
  void setTLHMarkBits(MM_EnvironmentBase* env,
                      uintptr_t slotIndex,
                      uintptr_t slotBits);
  void clearTLHMarkBits(MM_EnvironmentBase* env,
                        uintptr_t slotIndex,
                        uintptr_t slotBits);
  ...
  void processTLHMarkBits(MM_EnvironmentBase* env,
                          MM_MemorySubSpace* subspace,
                          void* tlhBase,
                          void* tlhTop,
                          BitMapAction action);
...
protected:
  ...
  bool cleanSingleCard(MM_EnvironmentBase* env,
                       Card* card,
                       uintptr_t bytesToClean,
                       uintptr_t* totalBytesCleaned);
  Card* getNextDirtyCard(MM_EnvironmentBase* env,
                         Card cardMask,
...
public:
   ...
   */
  uintptr_t cardBytesForHeapRange(MM_EnvironmentBase* env,
                                  void* heapBase,
                                  void* heapTop);
  /**
   ...
   */
  void dirtyCardsInRange(MM_EnvironmentBase* env,
                         void* heapBase,
                         void* heapTop);
  /**
   ...
   */
  bool cleanCards(MM_EnvironmentBase* env,
                  bool isMutator,
                  uintptr_t sizeToDo,
                  uintptr_t* sizeDone,
                  bool threadAtSafePoint);
   ...
   */
  static void tlhCleared(J9HookInterface** hook,
                         uintptr_t eventNum,
                         void* eventData,
                         void* userData);
  /**
   ...
   */
  static void tlhRefreshed(J9HookInterface** hook,
                           uintptr_t eventNum,
                           void* eventData,
                           void* userData);
