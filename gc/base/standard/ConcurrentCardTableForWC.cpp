...
MM_ConcurrentCardTableForWC::newInstance(MM_EnvironmentBase* env,
                                         MM_Heap* heap,
                                         ...
                                         MM_ConcurrentGC* collector)
{
  ...
  cardTable = (MM_ConcurrentCardTableForWC*)env->getForge()->allocate(
    sizeof(MM_ConcurrentCardTableForWC),
...
MM_ConcurrentCardTableForWC::initialize(MM_EnvironmentBase* env, MM_Heap* heap)
{
  ...
  _callback->registerCallback(
    env, prepareCardTableAsyncEventHandler, this, true);
 ...
 */
void
MM_ConcurrentCardTableForWC::prepareCardTableAsyncEventHandler(
 ...
 */
MMINLINE bool
MM_ConcurrentCardTableForWC::getExclusiveCardTableAccess(
 ...
 */
MMINLINE void
MM_ConcurrentCardTableForWC::releaseExclusiveCardTableAccess(
  MM_EnvironmentBase* env)
{
 ...
 */
uintptr_t
MM_ConcurrentCardTableForWC::countCardsInRange(MM_EnvironmentBase* env,
                                               Card* chunkStart,
                                               Card* chunkEnd)
{
 ...
 */
void
MM_ConcurrentCardTableForWC::prepareCardTableChunk(MM_EnvironmentBase* env,
                                                   Card* chunkStart,
                                                   Card* chunkEnd,
                                                   CardAction action)
{
  ...
  prepareUnitSize =
    prepareUnitSize > 0
      ? MM_Math::roundToCeiling(PREPARE_UNIT_SIZE_ALIGNMENT, prepareUnitSize)
 ...
 */
void
MM_ConcurrentCardTableForWC::initializeFinalCardCleaning(
  MM_EnvironmentBase* env)
{
