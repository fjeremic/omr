  ...
  MM_RegionDescriptorDestructor regionDescriptorDestructor)
{
  ...
  if (regionManager) {
    new (regionManager)
      MM_HeapRegionManagerStandard(env,
                                   regionSize,
                                   tableDescriptorSize,
                                   regionDescriptorInitializer,
                                   regionDescriptorDestructor);
...
bool
MM_HeapRegionManagerStandard::setContiguousHeapRange(MM_EnvironmentBase* env,
                                                     void* lowHeapEdge,
                                                     void* highHeapEdge)
{
  writeLock();
...
bool
MM_HeapRegionManagerStandard::enableRegionsInTable(MM_EnvironmentBase* env,
