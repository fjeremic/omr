...
MM_HeapRegionManagerStandard* MM_HeapRegionManagerStandard::newInstance(MM_EnvironmentBase* env, uintptr_t regionSize,
    uintptr_t tableDescriptorSize, MM_RegionDescriptorInitializer regionDescriptorInitializer,
    MM_RegionDescriptorDestructor regionDescriptorDestructor)
{
...
bool MM_HeapRegionManagerStandard::enableRegionsInTable(MM_EnvironmentBase* env, MM_MemoryHandle* handle)
{
    return true;
}
