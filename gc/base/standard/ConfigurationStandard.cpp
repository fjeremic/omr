 ...
 */
MM_MemoryPool*
MM_ConfigurationStandard::createMemoryPool(
  MM_EnvironmentBase* env,
  bool appendCollectorLargeAllocateStats)
{
  ...
  if (extensions->largeObjectArea) {
    ...
    return MM_MemoryPoolLargeObjects::newInstance(
      env, memoryPoolLargeObjects, memoryPoolSmallObjects);
...
MM_EnvironmentBase*
MM_ConfigurationStandard::allocateNewEnvironment(
...
MM_ConfigurationStandard::createEnvironmentPool(MM_EnvironmentBase* env)
{
  ...
  return pool_new(sizeof(MM_EnvironmentStandard),
                  numberOfElements,
                  sizeof(uint64_t),
                  0,
                  OMR_GET_CALLSITE(),
 ...
 */
bool
MM_ConfigurationStandard::createSweepPoolManagerAddressOrderedList(
  MM_EnvironmentBase* env)
{
  MM_GCExtensionsBase* extensions = env->getExtensions();
 ...
 */
bool
MM_ConfigurationStandard::createSweepPoolManagerSplitAddressOrderedList(
  MM_EnvironmentBase* env)
{
  MM_GCExtensionsBase* extensions = env->getExtensions();
...
MM_ConfigurationStandard::createHeapRegionManager(MM_EnvironmentBase* env)
{
  ...
  MM_HeapRegionManager* heapRegionManager =
    MM_HeapRegionManagerStandard::newInstance(
      ...
      sizeof(MM_HeapRegionDescriptorStandard),
