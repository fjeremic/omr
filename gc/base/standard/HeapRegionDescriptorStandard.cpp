...
bool
MM_HeapRegionDescriptorStandard::initialize(MM_EnvironmentBase* envBase,
  ...
  void* highAddress)
{
  new ((MM_HeapRegionDescriptorStandard*)descriptor)
    MM_HeapRegionDescriptorStandard(
      (MM_EnvironmentStandard*)env, lowAddress, highAddress);
  return ((MM_HeapRegionDescriptorStandard*)descriptor)
    ->initialize(env, regionManager);
}

void
MM_HeapRegionDescriptorStandard::destructor(MM_EnvironmentBase* env,
                                            MM_HeapRegionManager* regionManager,
                                            MM_HeapRegionDescriptor* descriptor)
{
