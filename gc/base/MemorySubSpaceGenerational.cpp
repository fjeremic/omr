...
void*
MM_MemorySubSpaceGenerational::allocateObject(
...
{
  Trc_MM_MSSGenerational_allocate_entry(env->getLanguageVMThread(),
                                        "Object",
  ...
  if (shouldCollectOnFailure) {
    ...
    Trc_MM_MSSGenerational_allocate_exit(env->getLanguageVMThread(),
                                         "Object",
                                         allocDescription->getBytesRequested(),
                                         1,
                                         NULL);
    ...
    if (previousSubSpace == _memorySubSpaceNew) {
       ...
       * area */
      Trc_MM_MSSGenerational_allocate(env->getLanguageVMThread(),
                                      "Object",
                                      allocDescription->getBytesRequested(),
                                      _memorySubSpaceNew,
                                      _memorySubSpaceOld);
...
void*
MM_MemorySubSpaceGenerational::allocationRequestFailed(
  MM_EnvironmentBase* env,
  ...
  MM_MemorySubSpace* previousSubSpace)
{
  ...
  if (previousSubSpace == _memorySubSpaceNew) {
    ...
    Trc_MM_MSSGenerational_allocationRequestFailed1(
      ...
      _memorySubSpaceOld);
    addr =
      _memorySubSpaceOld->allocationRequestFailed(env,
                                                  allocateDescription,
                                                  allocationType,
...
void*
MM_MemorySubSpaceGenerational::allocateArrayletLeaf(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  MM_MemorySubSpace* baseSubSpace,
  MM_MemorySubSpace* previousSubSpace,
...
void*
MM_MemorySubSpaceGenerational::allocateTLH(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  MM_ObjectAllocationInterface* objectAllocationInterface,
  MM_MemorySubSpace* baseSubSpace,
  ...
  bool shouldCollectOnFailure)
{
  if (shouldCollectOnFailure) {
    ...
    if (previousSubSpace == _memorySubSpaceNew) {
      /* The allocate request is coming from new space - forward on to the old
       * area */
      return _memorySubSpaceOld->allocateTLH(env,
                                             allocDescription,
                                             objectAllocationInterface,
                                             baseSubSpace,
                                             this,
...
MM_MemorySubSpaceGenerational::newInstance(MM_EnvironmentBase* env,
                                           ...
                                           uintptr_t maximumSize)
{
  ...
  memorySubSpace = (MM_MemorySubSpaceGenerational*)env->getForge()->allocate(
    sizeof(MM_MemorySubSpaceGenerational),
    OMR::GC::AllocationCategory::FIXED,
    OMR_GET_CALLSITE());
  if (memorySubSpace) {
    new (memorySubSpace) MM_MemorySubSpaceGenerational(env,
                                                       memorySubSpaceNew,
                                                       memorySubSpaceOld,
                                                       usesGlobalCollector,
                                                       minimumSize,
 ...
 */
intptr_t
MM_MemorySubSpaceGenerational::performResize(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription)
{
...
void
MM_MemorySubSpaceGenerational::checkResize(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  bool _systemGC)
{
 ...
 */
uintptr_t
MM_MemorySubSpaceGenerational::getAvailableContractionSize(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription)
{
