 ...
 */
MM_MemoryPool*
MM_MemorySubSpaceGeneric::getMemoryPool(MM_EnvironmentBase* env,
                                        void* addrBase,
                                        void* addrTop,
                                        void*& highAddr)
{
...
void*
MM_MemorySubSpaceGeneric::allocateObject(
...
{
  Trc_MM_MSSGeneric_allocate_entry(env->getLanguageVMThread(),
                                   "Object",
                                   ...
                                   baseSubSpace,
                                   previousSubSpace,
                                   (uintptr_t)_allocateAtSafePointOnly,
  ...
  if (!_allocateAtSafePointOnly || shouldCollectOnFailure) {
    ...
    if (NULL != result) {
      ...
      if (shouldCollectOnFailure) {
        Trc_MM_MSSGeneric_allocate(env->getLanguageVMThread(),
                                   "Object",
                                   allocDescription->getBytesRequested(),
                                   1,
                                   this,
        ...
        Trc_MM_MSSGeneric_allocate(env->getLanguageVMThread(),
                                   ...
                                   this,
                                   _parent);
        result = _parent->allocateObject(
          env, allocDescription, baseSubSpace, this, shouldCollectOnFailure);
      }
    }
  }

  Trc_MM_MSSGeneric_allocate_exit(env->getLanguageVMThread(),
                                  "Object",
                                  allocDescription->getBytesRequested(),
                                  this,
                                  result);
 ...
 */
void*
MM_MemorySubSpaceGeneric::allocateArrayletLeaf(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  MM_MemorySubSpace* baseSubSpace,
  MM_MemorySubSpace* previousSubSpace,
...
void*
MM_MemorySubSpaceGeneric::allocationRequestFailed(
  MM_EnvironmentBase* env,
  ...
  MM_MemorySubSpace* previousSubSpace)
{
  void* result = allocateGeneric(
    env, allocateDescription, allocationType, objectAllocationInterface, this);
...
void*
MM_MemorySubSpaceGeneric::allocateTLH(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  MM_ObjectAllocationInterface* objectAllocationInterface,
  MM_MemorySubSpace* baseSubSpace,
  ...
  bool shouldCollectOnFailure)
{
  ...
  if (!_allocateAtSafePointOnly || shouldCollectOnFailure) {
    if (_isAllocatable) {
      result = objectAllocationInterface->allocateTLH(
        env, allocDescription, this, _memoryPool);
    }
    ...
    if (NULL == result) {
      if (shouldCollectOnFailure) {
        ...
        if (allocDescription->shouldCollectAndClimb()) {
          result = _parent->allocationRequestFailed(env,
                                                    allocDescription,
                                                    ALLOCATION_TYPE_TLH,
        ...
        Trc_MM_MSSGeneric_allocate(env->getLanguageVMThread(),
                                   ...
                                   this,
                                   _parent);
        result = _parent->allocateTLH(env,
                                      allocDescription,
                                      objectAllocationInterface,
                                      baseSubSpace,
                                      this,
 ...
 */
void*
MM_MemorySubSpaceGeneric::collectorAllocate(
  MM_EnvironmentBase* env,
...
#if defined(OMR_GC_THREAD_LOCAL_HEAP)
void*
MM_MemorySubSpaceGeneric::collectorAllocateTLH(
  MM_EnvironmentBase* env,
  MM_Collector* requestCollector,
  MM_AllocateDescription* allocDescription,
  ...
  void*& addrTop)
{
  ...
  if (NULL == result) {
    ...
    if ((NULL == result) &&
      ...
      if (0 != collectorExpand(env, requestCollector, allocDescription)) {
        allocDescription->setCollectorAllocateSatisfyAnywhere(true);
        result = _memoryPool->collectorAllocateTLH(env,
                                                   allocDescription,
 ...
 */
uintptr_t
MM_MemorySubSpaceGeneric::collectorExpand(
  MM_EnvironmentBase* env,
  MM_Collector* requestCollector,
  MM_AllocateDescription* allocDescription)
{
 ...
 */
bool
MM_MemorySubSpaceGeneric::completeFreelistRebuildRequired(
  MM_EnvironmentBase* env)
{
                                      ...
                                      uint32_t objectFlags)
{
  ...
  memorySubSpace = (MM_MemorySubSpaceGeneric*)env->getForge()->allocate(
    sizeof(MM_MemorySubSpaceGeneric),
    OMR::GC::AllocationCategory::FIXED,
    OMR_GET_CALLSITE());
  if (NULL != memorySubSpace) {
    new (memorySubSpace) MM_MemorySubSpaceGeneric(env,
                                                  memoryPool,
                                                  regionPool,
                                                  usesGlobalCollector,
                                                  minimumSize,
                                   ...
                                   bool canCoalesce)
{
  ...
  if (result) {
    ...
    _memoryPool->expandWithRange(
      env, size, lowAddress, highAddress, canCoalesce);
  }
  return result;
}
                                   ...
                                   bool canCoalesce)
{
  ...
  if (result) {
    addExistingMemory(
      env, subArena, size, lowAddress, highAddress, canCoalesce);
  }
  return result;
}
 ...
 */
void*
MM_MemorySubSpaceGeneric::findFreeEntryTopStartingAtAddr(
  MM_EnvironmentBase* env,
  void* addr)
{
 ...
 */
void*
MM_MemorySubSpaceGeneric::getNextFreeStartingAddr(MM_EnvironmentBase* env,
                                                  void* currentFree)
{
 ...
 */
void
MM_MemorySubSpaceGeneric::moveHeap(MM_EnvironmentBase* env,
                                   void* srcBase,
                                   void* srcTop,
                                   void* dstBase)
{
...
void
MM_MemorySubSpaceGeneric::addTenureRange(MM_EnvironmentBase* env,
                                         uintptr_t size,
                                         void* low,
                                         void* high)
{
...
void
MM_MemorySubSpaceGeneric::removeTenureRange(MM_EnvironmentBase* env,
                                            uintptr_t size,
                                            void* low,
                                            void* high)
{
