 ...
 */
MM_MemoryPool* MM_MemorySubSpaceGeneric::getMemoryPool() {
  return _memoryPool;
}
 ...
 */
void MM_MemorySubSpaceGeneric::addExistingMemory(MM_EnvironmentBase* env,
                                                 MM_PhysicalSubArena* subArena,
                                                 uintptr_t size,
                                                 void* lowAddress,
                                                 void* highAddress,
 ...
 *
 */
void MM_MemorySubSpaceGeneric::moveHeap(MM_EnvironmentBase* env,
                                        void* srcBase,
                                        void* srcTop,
                                        void* dstBase) {
