...
bool MM_PacketList::initialize(MM_EnvironmentBase *env) {
  ...
  _sublists = (struct PacketSublist *)extensions->getForge()->allocate(
      sizeof(struct PacketSublist) * _sublistCount,
...
void MM_PacketList::tearDown(MM_EnvironmentBase *env) {
  MM_GCExtensionsBase *extensions = env->getExtensions();
...
void MM_PacketList::pushList(MM_Packet *head, MM_Packet *tail,
                             uintptr_t count) {
...
bool MM_PacketList::popList(MM_Packet **head, MM_Packet **tail,
                            uintptr_t *count) {
  bool didPop = false;
...
void MM_PacketList::remove(MM_Packet *packetToRemove) {
 ...
 */
MM_Packet *MM_PacketList::getHead() {
