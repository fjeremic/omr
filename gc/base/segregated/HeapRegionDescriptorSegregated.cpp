...
bool
MM_HeapRegionDescriptorSegregated::initialize(
...
bool
MM_HeapRegionDescriptorSegregated::joinFreeRangeInit(
...
uintptr_t
MM_HeapRegionDescriptorSegregated::formatFresh(MM_EnvironmentBase* env,
                                               uintptr_t sizeClass,
                                               void* lowAddress)
{
...
uintptr_t*
MM_HeapRegionDescriptorSegregated::allocateArraylet(
  MM_EnvironmentBase* env,
...
void
MM_HeapRegionDescriptorSegregated::addBytesFreedToArrayletBackout(
  MM_EnvironmentBase* env)
{
  Assert_MM_true(isArraylet());
...
void
MM_HeapRegionDescriptorSegregated::addBytesFreedToSmallSpineBackout(
  MM_EnvironmentBase* env)
{
...
void
MM_HeapRegionDescriptorSegregated::updateCounts(MM_EnvironmentBase* env,
                                                bool fromFlush)
{
  if (isArraylet()) {
