...
MM_ConfigurationSegregated::newInstance(MM_EnvironmentBase* env)
{
  ...
  configuration = (MM_ConfigurationSegregated*)env->getForge()->allocate(
    sizeof(MM_ConfigurationSegregated),
...
MM_Heap*
MM_ConfigurationSegregated::createHeapWithManager(
...
MM_MemorySpace*
MM_ConfigurationSegregated::createDefaultMemorySpace(
  MM_EnvironmentBase* env,
  MM_Heap* heap,
  MM_InitializationParameters* parameters)
{
  ...
  memorySubSpaceSegregated =
    MM_MemorySubSpaceSegregated::newInstance(env,
                                             physicalSubArena,
                                             memoryPool,
                                             true,
  ...
  return MM_MemorySpace::newInstance(env,
                                     ...
                                     memorySubSpaceSegregated,
                                     parameters,
                                     MEMORY_SPACE_NAME_METRONOME,
                                     MEMORY_SPACE_DESCRIPTION_METRONOME);
}

void
MM_ConfigurationSegregated::defaultMemorySpaceAllocated(
  ...
  void* defaultMemorySpace)
{
  ...
  ((MM_GlobalAllocationManagerSegregated*)extensions->globalAllocationManager)
    ->setSweepScheme(
      ((MM_SegregatedGC*)extensions->getGlobalCollector())->getSweepScheme());
  ((MM_GlobalAllocationManagerSegregated*)extensions->globalAllocationManager)
    ->setMarkingScheme(
      ((MM_SegregatedGC*)extensions->getGlobalCollector())->getMarkingScheme());
}

MM_EnvironmentBase*
MM_ConfigurationSegregated::allocateNewEnvironment(
  MM_GCExtensionsBase* extensions,
...
MM_ConfigurationSegregated::createEnvironmentPool(MM_EnvironmentBase* env)
{
  ...
  return pool_new(sizeof(MM_EnvironmentBase),
                  numberOfElements,
                  sizeof(uint64_t),
                  0,
                  OMR_GET_CALLSITE(),
...
MM_Dispatcher*
MM_ConfigurationSegregated::createDispatcher(MM_EnvironmentBase* env,
