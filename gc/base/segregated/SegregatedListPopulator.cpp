...
void MM_SegregatedListPopulator::initializeObjectHeapBufferedIteratorState(
...
void MM_SegregatedListPopulator::reset(
...
uintptr_t MM_SegregatedListPopulator::populateObjectHeapBufferedIteratorCache(
  ...
  if (NULL != startPtr) {
    GC_ObjectHeapIteratorSegregated iterator(
        state->extensions, startPtr, (omrobjectptr_t)state->data2,
        (MM_HeapRegionDescriptor::RegionType)state->data3, state->data4,
...
void MM_SegregatedListPopulator::advance(
