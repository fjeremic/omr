...
/**
 * A HeapRegionList on which every Region stands for a contiguous range of
 * regions (possibly of length one).
 */
class MM_FreeHeapRegionList : public MM_HeapRegionList {
 ...
 public:
  ...
  MM_FreeHeapRegionList(MM_HeapRegionList::RegionListKind regionListKind,
  ...
  virtual MM_HeapRegionDescriptorSegregated* allocate(MM_EnvironmentBase* env,
                                                      ...
                                                      uintptr_t maxExcess) = 0;

  MM_HeapRegionDescriptorSegregated* allocate(MM_EnvironmentBase* env,
                                              uintptr_t szClass) {
