...
MM_SegregatedAllocationInterface::initialize(MM_EnvironmentBase* env)
{
  ...
  if (result) {
    _allocationCache =
      _languageAllocationCache.getLanguageSegregatedAllocationCacheStruct(env);
...
void*
MM_SegregatedAllocationInterface::allocateObject(
...
void*
MM_SegregatedAllocationInterface::allocateArray(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocateDescription,
  MM_MemorySpace* memorySpace,
  bool shouldCollectOnFailure)
{
  ...
  result = subSpace->allocateObject(
    env, allocateDescription, NULL, NULL, shouldCollectOnFailure);
 ...
 */
void*
MM_SegregatedAllocationInterface::allocateArrayletSpine(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocateDescription,
  MM_MemorySpace* memorySpace,
  bool shouldCollectOnFailure)
 ...
 */
void*
MM_SegregatedAllocationInterface::allocateArrayletLeaf(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocateDescription,
  MM_MemorySpace* memorySpace,
  bool shouldCollectOnFailure)
{
  ...
  result =
    subSpace->allocateArrayletLeaf(env, allocateDescription, NULL, NULL, true);
...
MM_SegregatedAllocationInterface::restartCache(MM_EnvironmentBase* env)
{
  ...
  memset(&(_allocationCacheStats.bytesPreAllocatedSinceRestart),
         0,
         sizeof(_allocationCacheStats.bytesPreAllocatedSinceRestart));
  memset(&(_allocationCacheStats.replenishesSinceRestart),
         0,
 ...
 */
void
MM_SegregatedAllocationInterface::replenishCache(MM_EnvironmentBase* env,
                                                 uintptr_t sizeInBytes,
                                                 void* cacheMemory,
                                                 uintptr_t cacheSize)
{
...
void
MM_SegregatedAllocationInterface::enableCachedAllocations(
  MM_EnvironmentBase* env)
{
  if (!_cachedAllocationsEnabled) {
    _cachedAllocationsEnabled = true;
...
void
MM_SegregatedAllocationInterface::disableCachedAllocations(
  MM_EnvironmentBase* env)
{
  if (_cachedAllocationsEnabled) {
...
void
MM_SegregatedAllocationInterface::updateFrequentObjectsStats(
  MM_EnvironmentBase* env,
  uintptr_t sizeClass)
{
  MM_GCExtensionsBase* extensions = env->getExtensions();
  ...
  if ((NULL != _frequentObjectsStats) && (NULL != base) && (NULL != top)) {
    ...
    GC_ObjectHeapIteratorSegregated objectHeapIterator(
      ...
      base,
      top,
      ac->_smallRegions[sizeClass]->getRegionType(),
      cellSize,
      false,
      false);
