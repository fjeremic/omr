...
void*
MM_MemorySubSpaceSegregated::allocateObject(
 ...
 */
void*
MM_MemorySubSpaceSegregated::allocateArrayletLeaf(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  MM_MemorySubSpace* baseSubSpace,
  MM_MemorySubSpace* previousSubSpace,
...
void*
MM_MemorySubSpaceSegregated::allocateMixedObjectOrArraylet(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  AllocateType allocType)
{
  ...
  if (NULL != _collector) {
    ...
    result = _collector->garbageCollect(env,
                                        this,
                                        allocDescription,
...
void*
MM_MemorySubSpaceSegregated::allocationRequestFailed(
  MM_EnvironmentBase* env,
...
MM_MemorySubSpaceSegregated::newInstance(MM_EnvironmentBase* env,
                                         ...
                                         uintptr_t maximumSize)
{
  ...
  memorySubSpace = (MM_MemorySubSpaceSegregated*)env->getForge()->allocate(
    sizeof(MM_MemorySubSpaceSegregated),
    OMR::GC::AllocationCategory::FIXED,
    OMR_GET_CALLSITE());
  if (NULL != memorySubSpace) {
    new (memorySubSpace) MM_MemorySubSpaceSegregated(env,
                                                     physicalSubArena,
                                                     memoryPool,
                                                     usesGlobalCollector,
                                                     minimumSize,
...
bool
MM_MemorySubSpaceSegregated::expanded(MM_EnvironmentBase* env,
                                      ...
                                      bool canCoalesce)
{
  ...
  bool result = heapAddRange(
    env, this, region->getSize(), regionLowAddress, regionHighAddress);
...
bool
MM_MemorySubSpaceSegregated::heapAddRange(MM_EnvironmentBase* env,
...
bool
MM_MemorySubSpaceSegregated::heapRemoveRange(MM_EnvironmentBase* env,
                                             MM_MemorySubSpace* subspace,
                                             uintptr_t size,
                                             void* lowAddress,
                                             void* highAddress,
...
{
  Assert_MM_unreachable();
  return MM_MemorySubSpaceUniSpace::heapRemoveRange(env,
                                                    subspace,
                                                    size,
                                                    lowAddress,
                                                    highAddress,
