...
bool
MM_SegregatedGC::heapAddRange(MM_EnvironmentBase* env,
                              MM_MemorySubSpace* subspace,
                              uintptr_t size,
                              void* lowAddress,
                              void* highAddress)
{
  return _markingScheme->heapAddRange(
    env, subspace, size, lowAddress, highAddress);
}

bool
MM_SegregatedGC::heapRemoveRange(MM_EnvironmentBase* env,
                                 MM_MemorySubSpace* subspace,
                                 uintptr_t size,
                                 void* lowAddress,
                                 void* highAddress,
...
{
  return _markingScheme->heapRemoveRange(env,
                                         subspace,
                                         size,
                                         lowAddress,
                                         highAddress,
...
void
MM_SegregatedGC::heapReconfigured(MM_EnvironmentBase* env)
{
...
void*
MM_SegregatedGC::createSweepPoolState(MM_EnvironmentBase* env,
 ...
 */
void
MM_SegregatedGC::deleteSweepPoolState(MM_EnvironmentBase* env,
                                      void* sweepPoolState)
{}
...
void
MM_SegregatedGC::abortCollection(MM_EnvironmentBase* env,
 ...
 */
bool
MM_SegregatedGC::internalGarbageCollect(
  ...
  MM_AllocateDescription* allocDescription)
{
  ...
  MM_SegregatedSweepTask sweepTask(
    ...
    _dispatcher,
    _sweepScheme,
    (MM_MemoryPoolSegregated*)env->getDefaultMemorySubSpace()->getMemoryPool());
...
void
MM_SegregatedGC::internalPreCollect(MM_EnvironmentBase* env,
                                    MM_MemorySubSpace* subSpace,
                                    MM_AllocateDescription* allocDescription,
                                    uint32_t gcCode)
{
...
void
MM_SegregatedGC::internalPostCollect(MM_EnvironmentBase* env,
                                     MM_MemorySubSpace* subSpace)
{
