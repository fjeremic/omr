...
MM_SegregatedGC* MM_SegregatedGC::newInstance(MM_EnvironmentBase* env)
{
    ...
    globalGC = (MM_SegregatedGC*)env->getForge()->allocate(
        sizeof(MM_SegregatedGC), OMR::GC::AllocationCategory::FIXED, OMR_GET_CALLSITE());
    if (NULL != globalGC) {
...
bool MM_SegregatedGC::heapAddRange(
...
bool MM_SegregatedGC::heapRemoveRange(MM_EnvironmentBase* env, MM_MemorySubSpace* subspace, uintptr_t size,
...
void* MM_SegregatedGC::createSweepPoolState(MM_EnvironmentBase* env, MM_MemoryPool* memoryPool)
{
    /*
 ...
 */
void MM_SegregatedGC::deleteSweepPoolState(MM_EnvironmentBase* env, void* sweepPoolState)
{}

void MM_SegregatedGC::setupForGC(MM_EnvironmentBase*)
{}

void MM_SegregatedGC::abortCollection(MM_EnvironmentBase* env, CollectionAbortReason reason)
{}
    ...
    MM_EnvironmentBase* env, MM_MemorySubSpace* subSpace, MM_AllocateDescription* allocDescription)
{
    ...
    MM_SegregatedSweepTask sweepTask(
        env, _dispatcher, _sweepScheme, (MM_MemoryPoolSegregated*)env->getDefaultMemorySubSpace()->getMemoryPool());
...
void MM_SegregatedGC::internalPostCollect(MM_EnvironmentBase* env, MM_MemorySubSpace* subSpace)
{
 ...
 * Reporting
 */
void MM_SegregatedGC::reportGCCycleFinalIncrementEnding(MM_EnvironmentBase* env)
{
    OMRPORT_ACCESS_FROM_OMRPORT(env->getPortLibrary());
