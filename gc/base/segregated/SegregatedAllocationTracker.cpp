...
MM_SegregatedAllocationTracker::newInstance(
...
bool
MM_SegregatedAllocationTracker::initialize(MM_EnvironmentBase* env,
...
void
MM_SegregatedAllocationTracker::updateAllocationTrackerThreshold(
  MM_EnvironmentBase* env)
{
 ...
 */
void
MM_SegregatedAllocationTracker::initializeGlobalAllocationTrackerValues(
  MM_EnvironmentBase* env)
{
  MM_GCExtensionsBase* extensions = env->getExtensions();
...
void
MM_SegregatedAllocationTracker::addBytesAllocated(MM_EnvironmentBase* env,
...
void
MM_SegregatedAllocationTracker::addBytesFreed(MM_EnvironmentBase* env,
