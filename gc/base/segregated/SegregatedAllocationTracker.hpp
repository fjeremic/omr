...
public:
  static MM_SegregatedAllocationTracker *
  newInstance(MM_EnvironmentBase *env, volatile uintptr_t *globalBytesInUse,
...
private:
  MM_SegregatedAllocationTracker(MM_EnvironmentBase *env)
      : _bytesAllocated(0), _flushThreshold(0), _globalBytesInUse(NULL) {
