...
public:
  ...
  virtual void* allocateTLH(MM_EnvironmentBase* env,
                            uintptr_t maxSizeInBytesRequired,
                            void*& addrBase,
                            void*& addrTop);
  ...
  virtual void addRange(MM_EnvironmentBase* env,
                        void* prevFreeEntry,
                        uintptr_t prevFreeEntrySize,
                        void* currentFreeEntry,
                        uintptr_t currentFreeEntrySize);
  virtual void insertRange(MM_EnvironmentBase* env,
                           void* prevFreeListEntry,
                           uintptr_t prevFreeListEntrySize,
                           void* expandRangeBase,
                           void* expandRangeTop,
                           void* nextFreeListEntry,
                           uintptr_t nextFreeListEntrySize);
  virtual void buildRange(MM_EnvironmentBase* env,
                          void* expandRangeBase,
                          void* expandRangeTop);
