...
void* MM_MemoryPoolSegregated::allocateChunkedArray(MM_EnvironmentBase* env, MM_AllocateDescription* allocDesc, MM_AllocationContextSegregated* ac)
{
 ...
 */
void* MM_MemoryPoolSegregated::allocateTLH(MM_EnvironmentBase* env, uintptr_t maximumSizeInBytesRequired, void*& addrBase, void*& addrTop)
{
    return NULL;
}
...
void MM_MemoryPoolSegregated::addRange(MM_EnvironmentBase* env, void* previousFreeEntry, uintptr_t previousFreeEntrySize, void* currentFreeEntry, uintptr_t currentFreeEntrySize)
{
...
void* MM_MemoryPoolSegregated::contractWithRange(MM_EnvironmentBase* env, uintptr_t expandSize, void* lowAddress, void* highAddress)
{
    Assert_MM_unreachable();
    return NULL;
}

void MM_MemoryPoolSegregated::expandWithRange(MM_EnvironmentBase* env, uintptr_t expandSize, void* base, void* top, bool canCoalesce)
{
    Assert_MM_unreachable();
}
