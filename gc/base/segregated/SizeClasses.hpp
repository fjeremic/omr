...
private:
  uintptr_t*
    _smallCellSizes; /**< Array mapping size classes to the cell size of that
                        size class. The array actually lives in the J9JavaVM. */
...
protected:
  ...
  MM_SizeClasses(MM_EnvironmentBase* env) { _typeId = __FUNCTION__; };
