                                     ...
                                     MM_HeapRegionManager* heapRegionManager)
{
  ...
  regionPool = (MM_RegionPoolSegregated*)env->getForge()->allocate(
    sizeof(MM_RegionPoolSegregated),
...
MM_RegionPoolSegregated::initialize(MM_EnvironmentBase* env)
{
  ...
  for (szClass = OMR_SIZECLASSES_MIN_SMALL;
       szClass <= OMR_SIZECLASSES_MAX_SMALL;
       szClass++) {
...
MM_RegionPoolSegregated::allocateFreeHeapRegionList(
  ...
  bool singleRegionsOnly)
{
  return MM_LockingFreeHeapRegionList::newInstance(
    env, regionListKind, singleRegionsOnly);
}
...
void
MM_RegionPoolSegregated::addSingleFree(MM_EnvironmentBase* env,
...
void
MM_RegionPoolSegregated::countFreeRegions(uintptr_t* singleFree,
                                          uintptr_t* multiFree,
...
MM_RegionPoolSegregated::addFreeRange(void* lowAddress, void* highAddress)
{
  ...
  uintptr_t range =
    ((uintptr_t)highAddress - (uintptr_t)lowAddress) / firstInRange->getSize();
  ...
  uintptr_t sizeClass)
{
  ...
  for (uintptr_t j = startList + 1;
       j < startList + _splitAvailableListSplitCount;
       j++) {
...
void
MM_RegionPoolSegregated::updateOccupancy(uintptr_t sizeClass,
                                         uintptr_t occupancy)
{
