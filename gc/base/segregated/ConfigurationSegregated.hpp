...
private:
  ...
  static const uintptr_t SEGREGATED_ARRAYLET_LEAF_SIZE_BYTES =
...
public:
  ...
  createHeapRegionManager(MM_EnvironmentBase *env);
  ...
  MM_ConfigurationSegregated(MM_EnvironmentBase *env)
      : MM_Configuration(
            env, gc_policy_metronome, mm_regionAlignment,
            SEGREGATED_REGION_SIZE_BYTES, SEGREGATED_ARRAYLET_LEAF_SIZE_BYTES,
            gc_modron_wrtbar_none, gc_modron_allocation_type_segregated) {
