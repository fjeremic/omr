...
void
MM_OverflowSegregated::emptyToOverflow(MM_EnvironmentBase* env,
                                       MM_Packet* packet,
...
void
MM_OverflowSegregated::overflowItem(MM_EnvironmentBase* env,
                                    void* item,
                                    MM_OverflowType type)
{
  _overflow = true;
...
void
MM_OverflowSegregated::fillFromOverflow(MM_EnvironmentBase* env,
                                        MM_Packet* packet)
{
  ...
  if (env->_currentTask->synchronizeGCThreadsAndReleaseMaster(env, UNIQUE_ID)) {
    ...
    while ((region = (MM_HeapRegionDescriptorSegregated*)
      ...
      GC_ObjectHeapIteratorSegregated objectIterator(
        _extensions,
        (omrobjectptr_t)region->getLowAddress(),
        (omrobjectptr_t)region->getHighAddress(),
