...
bool
MM_GlobalAllocationManagerSegregated::initialize(
  MM_EnvironmentBase* env,
  MM_RegionPoolSegregated* regionPool)
{
...
void
MM_GlobalAllocationManagerSegregated::setSweepScheme(
...
void
MM_GlobalAllocationManagerSegregated::setMarkingScheme(
...
bool
MM_GlobalAllocationManagerSegregated::acquireAllocationContext(
  MM_EnvironmentBase* env)
{
...
void
MM_GlobalAllocationManagerSegregated::releaseAllocationContext(
  MM_EnvironmentBase* env)
{
...
void
MM_GlobalAllocationManagerSegregated::flushCachedFullRegions(
  MM_EnvironmentBase* env)
{
