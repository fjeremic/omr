...
bool MM_MemoryPoolAggregatedCellList::initialize(MM_EnvironmentBase* env, MM_HeapRegionDescriptorSegregated* region)
{
 ...
 */
uintptr_t MM_MemoryPoolAggregatedCellList::reset(MM_EnvironmentBase* env, uintptr_t sizeClass, void* lowAddress)
{
...
void MM_MemoryPoolAggregatedCellList::addBytesAllocated(MM_EnvironmentBase* env, uintptr_t bytesAllocated)
{
...
void MM_MemoryPoolAggregatedCellList::updateCounts(MM_EnvironmentBase* env, bool fromFlush)
{
    bool const compressed = compressObjectReferences();
...
void MM_MemoryPoolAggregatedCellList::returnCell(MM_EnvironmentBase* env, uintptr_t* cell)
{
    bool const compressed = compressObjectReferences();
