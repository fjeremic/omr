...
bool
MM_MemoryPoolAggregatedCellList::initialize(
 ...
 */
uintptr_t*
MM_MemoryPoolAggregatedCellList::preAllocateCells(MM_EnvironmentBase* env,
                                                  uintptr_t cellSize,
 ...
 */
uintptr_t
MM_MemoryPoolAggregatedCellList::reset(MM_EnvironmentBase* env,
                                       uintptr_t sizeClass,
                                       void* lowAddress)
{
  uintptr_t numCells =
  ...
  MM_HeapLinkedFreeHeader* freeListEntry =
    MM_HeapLinkedFreeHeader::fillWithHoles(
      (uintptr_t*)lowAddress, cellSize * numCells, compressed);
  MM_HeapLinkedFreeHeader::linkInAsHead(
    (volatile uintptr_t*)(&_freeListHead), freeListEntry, compressed);
  resetCurrentEntry();
...
void
MM_MemoryPoolAggregatedCellList::addBytesAllocated(MM_EnvironmentBase* env,
...
void
MM_MemoryPoolAggregatedCellList::updateCounts(MM_EnvironmentBase* env,
                                              bool fromFlush)
{
  bool const compressed = compressObjectReferences();
...
void
MM_MemoryPoolAggregatedCellList::returnCell(MM_EnvironmentBase* env,
                                            uintptr_t* cell)
{
  bool const compressed = compressObjectReferences();
  ...
  MM_HeapLinkedFreeHeader::linkInAsHead(
    (volatile uintptr_t*)(&_freeListHead), cellHeader, compressed);
