...
protected:
  ...
  createAllocationContext(MM_EnvironmentBase *env,
   ...
   */
  virtual bool
  initializeAllocationContexts(MM_EnvironmentBase *env,
                               MM_RegionPoolSegregated *regionPool);
...
public:
  ...
  virtual void
  printAllocationContextStats(MM_EnvironmentBase *env, uintptr_t eventNum,
