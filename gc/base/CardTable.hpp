...
class MM_CardTable : public MM_BaseVirtual {
 ...
 public:
   ...
   */
  void dirtyCardWithValue(MM_EnvironmentBase* env,
   ...
   */
  void dirtyCardRange(MM_EnvironmentBase* env,
                      void* heapAddrFrom,
                      void* heapAddrTo);
   ...
   */
  uintptr_t clearCardsInRange(MM_EnvironmentBase* env,
                              void* heapBase,
                              void* heapTop);
   ...
   */
  void cleanCardsInRegion(MM_EnvironmentBase* env,
                          MM_CardCleaner* cardCleaner,
 ...
 protected:
   ...
   */
  bool commitCardTableMemory(MM_EnvironmentBase* env,
                             Card* lowCard,
                             Card* highCard);
   ...
   */
  bool decommitCardTableMemory(MM_EnvironmentBase* env,
                               Card* lowCard,
                               Card* highCard,
                               Card* lowValidCard,
                               Card* highValidCard);
 ...
 private:
  void cleanRange(MM_EnvironmentBase* env,
                  MM_CardCleaner* cardCleaner,
                  Card* low,
                  Card* high);
};
