...
private:
  ...
  MM_LargeObjectAllocateStats *
      _largeObjectCollectorAllocateStats; /**< Same as _largeObjectAllocateStats
...
private:
  ...
  void updateHint(MM_HeapLinkedFreeHeader *oldFreeEntry,
  ...
  bool recycleHeapChunk(void *addrBase, void *addrTop,
                        MM_HeapLinkedFreeHeader *previousFreeEntry,
                        MM_HeapLinkedFreeHeader *nextFreeEntry);

protected:
public:
  static MM_MemoryPoolAddressOrderedList *
   ...
   */
  MM_MemoryPoolAddressOrderedList(MM_EnvironmentBase *env,
                                  uintptr_t minimumFreeEntrySize)
      : MM_MemoryPoolAddressOrderedListBase(env, minimumFreeEntrySize),
        _heapFreeList(NULL), _largeObjectCollectorAllocateStats(NULL) {
