...
protected:
  ...
  uintptr_t
    _managedAllocationContextCount; /**< The number of allocation contexts which
                                       will be instantiated and managed by the
                                       GlobalAllocationManager that are part of
                                       the _managedAllocationContexts array,
                                       other allocation contexts may exist in
                                       certain specs */
