...
MM_ObjectMap::newInstance(MM_EnvironmentBase* env)
{
  ...
  objectMap =
    (MM_ObjectMap*)env->getForge()->allocate(sizeof(MM_ObjectMap),
...
bool
MM_ObjectMap::heapAddRange(MM_EnvironmentBase* env,
...
bool
MM_ObjectMap::heapRemoveRange(MM_EnvironmentBase* env,
                              MM_MemorySubSpace* subspace,
                              uintptr_t size,
                              void* lowAddress,
                              void* highAddress,
...
bool
MM_ObjectMap::markValidObjectNoAtomic(MM_EnvironmentBase* env,
...
uintptr_t
MM_ObjectMap::setMarkBitsInRange(MM_EnvironmentBase* env,
                                 void* heapBase,
                                 void* heapTop,
                                 bool clear)
{
...
void
MM_ObjectMap::markValidObjectForRange(MM_EnvironmentBase* env,
                                      void* heapBase,
                                      void* heapTop)
{
   ...
   * bound */
  _objectMap->getSlotIndexAndMask(
    (omrobjectptr_t)((uintptr_t)heapTop - 1), &slotIndexHigh, &bitMask);
