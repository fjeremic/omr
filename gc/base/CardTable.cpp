...
bool MM_CardTable::commitCardTableMemory(MM_EnvironmentBase* env,
                                         Card* lowCard,
                                         Card* highCard) {
  bool commited = true;
  MM_GCExtensionsBase* extensions = env->getExtensions();
...
bool MM_CardTable::canMemoryBeReleased(MM_EnvironmentBase* env,
                                       void* low,
                                       void* high) {
  bool result = true;
  MM_GCExtensionsBase* extensions = env->getExtensions();
...
bool MM_CardTable::isDirtyOrValue(MM_EnvironmentBase* env,
                                  void* heapAddr,
                                  Card cardValue) {
...
void MM_CardTable::dirtyCardRange(MM_EnvironmentBase* env,
                                  void* heapAddrFrom,
                                  void* heapAddrTo) {
