...
public:
  enum RegionType
  {
    ...
    BUMP_ALLOCATED_IDLE =
      9, /**< Represents regions that have a BumpPointer MemoryPool but are not
            actively being used (that is, they can be made into other kinds of
            regions without penalty) */
  ...
  uintptr_t
    _regionsInSpan; /**< most likely a temporary piece of data which, along with
                       _nextInSet, builds a freelist (public for assertions) */
  MM_HeapRegionDescriptor*
    _headOfSpan; /**< in a spanning region, points to the HEAD of the span.  In
                    non-spanning, points at this */
...
private:
  ...
  MM_HeapRegionDescriptor*
    _previousRegionInSubSpace; /**< previous region descriptor in the list (used
                                  by MM_MemorySubSpaceGeneric) */
  MM_HeapRegionDescriptor*
