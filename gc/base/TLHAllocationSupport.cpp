                                 ...
                                 bool shouldCollectOnFailure)
{
  ...
  if ((NULL != _abandonedList) && (sizeInBytesRequired <= tlhMinimumSize)) {
    ...
    setupTLH(env,
             (void*)_abandonedList,
             (void*)_abandonedList->afterEnd(),
             _abandonedList->_memorySubSpace,
 ...
 */
void*
MM_TLHAllocationSupport::allocateFromTLH(
                                     ...
                                     MM_MemoryPool* memoryPool)
{
  ...
  if (memoryPool->allocateTLH(
        env, allocDescription, getRefreshSize(), addrBase, addrTop)) {
...
MM_TLHAllocationSupport::updateFrequentObjectsStats(MM_EnvironmentBase* env)
{
  ...
  if (NULL != frequentObjectsStats) {
    ...
    GC_ObjectHeapIteratorAddressOrderedList objectHeapIterator(
      extensions,
      (omrobjectptr_t)getBase(),
      (omrobjectptr_t)getAlloc(),
      false,
      false);
...
void
MM_TLHAllocationSupport::objectAllocationNotify(MM_EnvironmentBase* env,
                                                void* heapBase,
                                                void* heapTop)
{
  MM_GCExtensionsBase* extensions = env->getExtensions();
