...
#if !defined(ADDRESSORDEREDLISTPOPULATOR_HPP_)
#define ADDRESSORDEREDLISTPOPULATOR_HPP_
...
class MM_AddressOrderedListPopulator
    : public MM_ObjectHeapBufferedIteratorPopulator {
 public:
  MM_AddressOrderedListPopulator() : MM_ObjectHeapBufferedIteratorPopulator() {
...
#endif /*ADDRESSORDEREDLISTPOPULATOR_HPP_*/
