...
protected:
    ...
    GC_IndexableObjectScanner(
        MM_EnvironmentBase* env, omrobjectptr_t arrayPtr, fomrobject_t* basePtr, fomrobject_t* limitPtr, fomrobject_t* scanPtr, fomrobject_t* endPtr, uintptr_t scanMap, uintptr_t elementSize, uintptr_t flags)
