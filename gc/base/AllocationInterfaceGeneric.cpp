 ...
 */
void MM_AllocationInterfaceGeneric::kill(MM_EnvironmentBase* env)
{
    tearDown(env);
 ...
 */
bool MM_AllocationInterfaceGeneric::initialize(MM_EnvironmentBase* env)
{
    return true;
}
 ...
 */
void MM_AllocationInterfaceGeneric::tearDown(MM_EnvironmentBase* env)
{
}

void* MM_AllocationInterfaceGeneric::allocateObject(MM_EnvironmentBase* env, MM_AllocateDescription* allocateDescription, MM_MemorySpace* memorySpace, bool shouldCollectOnFailure)
{
...
void* MM_AllocationInterfaceGeneric::allocateArray(MM_EnvironmentBase* env, MM_AllocateDescription* allocateDescription, MM_MemorySpace* memorySpace, bool shouldCollectOnFailure)
{
 ...
 */
void* MM_AllocationInterfaceGeneric::allocateArrayletSpine(MM_EnvironmentBase* env, MM_AllocateDescription* allocateDescription, MM_MemorySpace* memorySpace, bool shouldCollectOnFailure)
{
 ...
 */
void* MM_AllocationInterfaceGeneric::allocateArrayletLeaf(MM_EnvironmentBase* env, MM_AllocateDescription* allocateDescription, MM_MemorySpace* memorySpace, bool shouldCollectOnFailure)
{
    Assert_MM_unreachable();
    return NULL;
}
 ...
 */
void MM_AllocationInterfaceGeneric::flushCache(MM_EnvironmentBase* env)
{
}

void MM_AllocationInterfaceGeneric::enableCachedAllocations(MM_EnvironmentBase* env)
{
...
void MM_AllocationInterfaceGeneric::disableCachedAllocations(MM_EnvironmentBase* env)
{
    if (_cachedAllocationsEnabled) {
