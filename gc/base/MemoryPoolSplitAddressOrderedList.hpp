...
private:
   ...
   */
  MMINLINE bool
  isPreviousReservedFreeEntry(MM_HeapLinkedFreeHeader *previousFreeEntry,
   ...
   */
  MMINLINE bool
  isCurrentReservedFreeEntry(MM_HeapLinkedFreeHeader *curFreeEntry,
                             uintptr_t curFreeList) {
    bool const compressed = compressObjectReferences();
...
public:
  static MM_MemoryPoolSplitAddressOrderedList *
  newInstance(MM_EnvironmentBase *env, uintptr_t minimumFreeEntrySize,
              uintptr_t maxSplit);
  static MM_MemoryPoolSplitAddressOrderedList *
  newInstance(MM_EnvironmentBase *env, uintptr_t minimumFreeEntrySize,
