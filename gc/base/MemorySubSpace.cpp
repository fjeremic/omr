 ...
 */
uintptr_t
MM_MemorySubSpace::adjustExpansionWithinUserIncrement(MM_EnvironmentBase *env,
                                                      uintptr_t expandSize) {
  return expandSize;
}
 ...
 */
uintptr_t
MM_MemorySubSpace::collectorExpand(MM_EnvironmentBase *env,
 ...
 */
intptr_t
MM_MemorySubSpace::performResize(MM_EnvironmentBase *env,
                                 MM_AllocateDescription *allocDescription) {
  return 0;
}
 ...
 */
void *
MM_MemorySubSpace::collectorAllocate(MM_EnvironmentBase *env,
                                     MM_Collector *requestCollector,
                                     MM_AllocateDescription *allocDescription) {
 ...
 */
uintptr_t
MM_MemorySubSpace::counterBalanceContract(MM_EnvironmentBase *env,
                                          uintptr_t contractSize,
...
MM_HeapRegionDescriptor *
MM_MemorySubSpace::selectRegionForContraction(MM_EnvironmentBase *env,
                                              uintptr_t numaNode) {
  Assert_MM_unreachable();
  return NULL;
}
