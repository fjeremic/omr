 ...
 */
void
MM_MemorySubSpace::reportHeapResizeAttempt(MM_EnvironmentBase* env,
                                           uintptr_t amount,
                                           uintptr_t type)
{
  OMRPORT_ACCESS_FROM_ENVIRONMENT(env);
 ...
 */
void
MM_MemorySubSpace::reportAllocationFailureStart(
...
{
  if (!_lock.initialize(
        env, &env->getExtensions()->lnrlOptions, "MM_MemorySubSpace:_lock")) {
    return false;
  }
 ...
 */
MM_MemoryPool*
MM_MemorySubSpace::getMemoryPool(MM_EnvironmentBase* env,
                                 void* addrBase,
                                 void* addrTop,
                                 void*& highAddr)
{
 ...
 */
void
MM_MemorySubSpace::generateAllocationFailureStats(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription)
{
...
void
MM_MemorySubSpace::systemGarbageCollect(MM_EnvironmentBase* env,
                                        uint32_t gcCode)
{
  if (_parent) {
  ...
  if (_collector && _usesGlobalCollector && !_collector->isDisabled(env)) {
    ...
    if ((J9MMCONSTANT_EXPLICIT_GC_IDLE_GC == gcCode) &&
      ...
      TRIGGER_J9HOOK_MM_PRIVATE_HEAP_RESIZE(
        ...
        getActiveMemorySize(),
        omrtime_hires_delta(
          startTime, endTime, OMRPORT_TIME_DELTA_IN_MICROSECONDS),
        /* reason enum variable not applicable/used, so passing univeral value 1
           = not found*/
        1);
    }
#endif
...
bool
MM_MemorySubSpace::garbageCollect(MM_EnvironmentBase* env,
                                  MM_AllocateDescription* allocDescription,
                                  uint32_t gcCode)
{
  ...
  if (_collector) {
    ...
    _collector->garbageCollect(
      env, this, allocDescription, gcCode, NULL, NULL, NULL);
...
void*
MM_MemorySubSpace::allocateGeneric(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocateDescription,
  ...
  MM_MemorySubSpace* attemptSubspace)
{
  ...
  switch (allocationType) {
    case ALLOCATION_TYPE_OBJECT:
      result = attemptSubspace->allocateObject(
        env, allocateDescription, this, this, false);
      break;
    case ALLOCATION_TYPE_LEAF:
      result = attemptSubspace->allocateArrayletLeaf(
        env, allocateDescription, this, this, false);
      break;
 ...
 */
void
MM_MemorySubSpace::payAllocationTax(MM_EnvironmentBase* env,
                                    MM_AllocateDescription* allocDescription)
{
                                    ...
                                    MM_AllocateDescription* allocDescription)
{
  if (_extensions->payAllocationTax) {
    if (_parent) {
      ...
      Assert_MM_true(
        _usesGlobalCollector); /* If you don't have a parent, you really should
                                  be using the global */
      if (_usesGlobalCollector) {
 ...
 */
bool
MM_MemorySubSpace::expanded(MM_EnvironmentBase* env,
 ...
 */
void
MM_MemorySubSpace::addExistingMemory(MM_EnvironmentBase* env,
                                     MM_PhysicalSubArena* subArena,
                                     uintptr_t size,
                                     void* lowAddress,
                                     void* highAddress,
 ...
 */
void*
MM_MemorySubSpace::removeExistingMemory(MM_EnvironmentBase* env,
                                        MM_PhysicalSubArena* subArena,
                                        uintptr_t size,
                                        void* lowAddress,
                                        void* highAddress)
 ...
 */
bool
MM_MemorySubSpace::heapAddRange(MM_EnvironmentBase* env,
                                ...
                                void* highAddress)
{
  ...
  if (_parent) {
    result = result && _parent->heapAddRange(
                         env, subspace, size, lowAddress, highAddress);
  } else if (_memorySpace) {
    result = result && _memorySpace->heapAddRange(
                         env, subspace, size, lowAddress, highAddress);
  }
  return result;
}
 ...
 */
bool
MM_MemorySubSpace::heapRemoveRange(MM_EnvironmentBase* env,
                                   MM_MemorySubSpace* subspace,
                                   uintptr_t size,
                                   void* lowAddress,
                                   void* highAddress,
                                   ...
                                   void* highValidAddress)
{
  ...
  if (!_usesGlobalCollector && (NULL != _collector)) {
    result = _collector->heapRemoveRange(env,
                                         subspace,
                                         size,
                                         lowAddress,
                                         highAddress,
  ...
  if (_parent) {
    result = result && _parent->heapRemoveRange(env,
                                                subspace,
                                                size,
                                                lowAddress,
                                                highAddress,
    ...
    result = result && _memorySpace->heapRemoveRange(env,
                                                     subspace,
                                                     size,
                                                     lowAddress,
                                                     highAddress,
 ...
 */
void*
MM_MemorySubSpace::findFreeEntryEndingAtAddr(MM_EnvironmentBase* env,
                                             void* addr)
{
  Assert_MM_unreachable();
  return NULL;
 ...
 */
void*
MM_MemorySubSpace::findFreeEntryTopStartingAtAddr(MM_EnvironmentBase* env,
                                                  void* addr)
{
  Assert_MM_unreachable();
  return NULL;
 ...
 */
uintptr_t
MM_MemorySubSpace::getAvailableContractionSize(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription)
{
  Assert_MM_unreachable();
 ...
 */
void*
MM_MemorySubSpace::getNextFreeStartingAddr(MM_EnvironmentBase* env,
                                           void* currentFree)
{
  Assert_MM_unreachable();
  return NULL;
 ...
 */
void
MM_MemorySubSpace::moveHeap(MM_EnvironmentBase* env,
                            void* srcBase,
                            void* srcTop,
                            void* dstBase)
{
 ...
 */
void
MM_MemorySubSpace::checkResize(MM_EnvironmentBase* env,
                               MM_AllocateDescription* allocDescription,
                               bool _systemGC)
{}
 ...
 */
void*
MM_MemorySubSpace::collectorAllocateTLH(
  MM_EnvironmentBase* env,
  MM_Collector* requestCollector,
  MM_AllocateDescription* allocDescription,
 ...
 */
void
MM_MemorySubSpace::setAllocateAtSafePointOnly(MM_EnvironmentBase* env,
                                              bool safePoint)
{
  /* Call on children */
  MM_MemorySubSpace* child;
...
void
MM_MemorySubSpace::recycleRegion(MM_EnvironmentBase* env,
                                 MM_HeapRegionDescriptor* region)
{
 ...
 */
uintptr_t
MM_MemorySubSpace::findLargestFreeEntry(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocateDescription)
{
                                          ...
                                          uintptr_t contractAlignment)
{
  if (NULL != _parent) {
    return _parent->counterBalanceContract(
      env, this, this, contractSize, contractAlignment);
  }
  return contractSize;
}
 ...
 */
uintptr_t
MM_MemorySubSpace::counterBalanceContractWithExpand(
  MM_EnvironmentBase* env,
  MM_MemorySubSpace* previousSubSpace,
  MM_MemorySubSpace* contractSubSpace,
  uintptr_t contractSize,
  ...
  uintptr_t expandSize)
{
  if (NULL != _physicalSubArena) {
     ...
     * space */
    contractSubSpace->enqueueCounterBalanceExpand(
      env, this, adjustedExpandSize);
 ...
 */
void
MM_MemorySubSpace::enqueueCounterBalanceExpand(MM_EnvironmentBase* env,
                                               MM_MemorySubSpace* subSpace,
                                               uintptr_t expandSize)
{
 ...
 */
bool
MM_MemorySubSpace::replenishPoolForAllocate(MM_EnvironmentBase* env,
...
MM_MemorySubSpace::registerRegion(MM_HeapRegionDescriptor* region)
{
  ...
  J9_LINEAR_LINKED_LIST_ADD(
    _nextRegionInSubSpace, _previousRegionInSubSpace, _regionList, region);
