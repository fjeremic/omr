 ...
 * default.
 */
bool MM_MemorySubSpace::isActive() {
  return true;
}
 ...
 */
MM_MemoryPool* MM_MemorySubSpace::getMemoryPool() {
  return NULL;
}
 ...
 *
 */
void MM_MemorySubSpace::moveHeap(MM_EnvironmentBase* env,
                                 void* srcBase,
                                 void* srcTop,
                                 void* dstBase) {
  Assert_MM_unreachable();
...
void MM_MemorySubSpace::lockRegionList() {
  _lock.acquire();
}

void MM_MemorySubSpace::unlockRegionList() {
  _lock.release();
}
