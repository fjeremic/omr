...
public:
    ...
    static MM_MemorySpace* newInstance(MM_EnvironmentBase* env, MM_Heap* heap, MM_PhysicalArena* physicalArena,
    ...
    bool heapRemoveRange(MM_EnvironmentBase* env, MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress,
        void* highAddress, void* lowValidAddres, void* highValidAddress);
    /**
     ...
     */
    MM_MemorySpace(MM_Heap* heap, MM_PhysicalArena* physicalArena, MM_InitializationParameters* parameters,
