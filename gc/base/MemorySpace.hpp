...
public:
  ...
  virtual const char *getDescription() {
    return _description ? _description : MEMORY_SPACE_DESCRIPTION_UNDEFINED;
  }
  ...
  static MM_MemorySpace *newInstance(MM_EnvironmentBase *env, MM_Heap *heap,
  ...
  MMINLINE MM_MemorySubSpace *getDefaultMemorySubSpace() {
    return _defaultMemorySubSpace;
  }
  MMINLINE MM_MemorySubSpace *getTenureMemorySubSpace() {
    return _tenureMemorySubSpace;
  }
  MMINLINE void setDefaultMemorySubSpace(MM_MemorySubSpace *memorySpace) {
    _defaultMemorySubSpace = memorySpace;
  }
  MMINLINE void setTenureMemorySubSpace(MM_MemorySubSpace *memorySpace) {
    _tenureMemorySubSpace = memorySpace;
  }
  ...
  MMINLINE MM_MemorySubSpace *getMemorySubSpaceList() {
    return _memorySubSpaceList;
  }
  ...
  uintptr_t findLargestFreeEntry(MM_EnvironmentBase *env,
  ...
  bool heapRemoveRange(MM_EnvironmentBase *env, MM_MemorySubSpace *subspace,
                       uintptr_t size, void *lowAddress, void *highAddress,
                       void *lowValidAddres, void *highValidAddress);
  /**
  ...
  static MM_MemorySpace *getMemorySpace(void *memorySpace) {
    return (MM_MemorySpace *)memorySpace;
  }
   ...
   */
  MM_MemorySpace(MM_Heap *heap, MM_PhysicalArena *physicalArena,
                 MM_InitializationParameters *parameters, const char *name,
                 const char *description)
      : MM_BaseVirtual(), _next(NULL), _previous(NULL),
        _initialSize(parameters->_initialNewSpaceSize +
                     parameters->_initialOldSpaceSize),
        _minimumSize(parameters->_minimumSpaceSize), _currentSize(0),
        _maximumSize(parameters->_maximumSpaceSize), _heap(heap),
        _defaultMemorySubSpace(NULL), _tenureMemorySubSpace(NULL),
        _memorySubSpaceList(NULL), _physicalArena(physicalArena), _name(name),
        _description(description), _uniqueID(0) {
