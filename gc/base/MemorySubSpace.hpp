...
class MM_MemorySubSpace : public MM_BaseVirtual {
 ...
 public:
  ...
  virtual uintptr_t findLargestFreeEntry(
  ...
  virtual intptr_t performResize(
      MM_EnvironmentBase *env, MM_AllocateDescription *allocDescription = NULL);
   ...
   */
  virtual MM_HeapRegionDescriptor *selectRegionForContraction(
