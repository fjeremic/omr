...
class MM_Configuration : public MM_BaseVirtual {
 ...
 public:
  ...
  virtual MM_GlobalCollector* createGlobalCollector(
      MM_EnvironmentBase* env) = 0;
  ...
  virtual MM_HeapRegionManager* createHeapRegionManager(
      MM_EnvironmentBase* env) = 0;
 ...
 protected:
  ...
  virtual MM_EnvironmentBase* allocateNewEnvironment(
      MM_GCExtensionsBase* extensions, OMR_VMThread* omrVMThread) = 0;
