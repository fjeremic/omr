...
public:
    ...
    {
        return (getBarrierType() == gc_modron_wrtbar_satb_and_oldcheck) || (getBarrierType() == gc_modron_wrtbar_satb);
    }

    MMINLINE bool
    isIncrementalUpdateBarrierEnabled()
    {
        return (getBarrierType() == gc_modron_wrtbar_cardmark_and_oldcheck) || (getBarrierType() == gc_modron_wrtbar_cardmark);
    }
