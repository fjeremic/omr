...
private:
  ...
  void tilt(MM_EnvironmentBase *env, uintptr_t allocateSpaceSize,
...
public:
  ...
  newInstance(MM_EnvironmentBase *env, MM_Collector *collector,
  ...
  MM_MemorySubSpace *getMemorySubSpaceAllocate() {
    return _memorySubSpaceAllocate;
  };
  MM_MemorySubSpace *getMemorySubSpaceSurvivor() {
  ...
  virtual uintptr_t
  getActualActiveFreeSurvivorMemorySize(uintptr_t includeMemoryType);
  ...
  MMINLINE uintptr_t getSurvivorSpaceSizeRatio() const {
    return _survivorSpaceSizeRatio;
  }
  MMINLINE void setSurvivorSpaceSizeRatio(uintptr_t size) {
   ...
   */
  MM_MemorySubSpaceSemiSpace(MM_EnvironmentBase *env, MM_Collector *collector,
                             MM_PhysicalSubArena *physicalSubArena,
                             MM_MemorySubSpace *memorySubSpaceAllocate,
                             MM_MemorySubSpace *memorySubSpaceSurvivor,
                             bool usesGlobalCollector, uintptr_t minimumSize,
                             uintptr_t initialSize, uintptr_t maximumSize)
      : MM_MemorySubSpace(env, collector, physicalSubArena, usesGlobalCollector,
        ...
        _allocateSpaceBase(NULL), _allocateSpaceTop(NULL),
        _survivorSpaceBase(NULL), _survivorSpaceTop(NULL),
        _survivorSpaceSizeRatio(MODRON_SURVIVOR_SPACE_RATIO_DEFAULT),
        _previousBytesFlipped(0), _tiltedAverageBytesFlipped(0),
        _tiltedAverageBytesFlippedDelta(0), _averageScavengeTimeRatio(0.0),
        _lastScavengeEndTime(0), _desiredSurvivorSpaceRatio(0.0)
#if defined(OMR_GC_CONCURRENT_SCAVENGER)
        ,
