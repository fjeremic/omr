...
class MM_MemoryPoolAddressOrderedListBase : public MM_MemoryPool {
 ...
 protected:
   ...
   */
  void updateMemoryPoolStatistics(MM_EnvironmentBase* env,
                                  uintptr_t freeBytes,
  ...
  MMINLINE bool internalRecycleHeapChunk(void* addrBase,
                                         void* addrTop,
  ...
  MMINLINE bool appendToList(MM_EnvironmentBase* env,
                             void* addrBase,
                             void* addrTop,
  ...
  MMINLINE bool insertToList(MM_EnvironmentBase* env,
                             void* addrBase,
                             void* addrTop,
                             uintptr_t minimumSize,
                             MM_HeapLinkedFreeHeader*& freeListHead,
  ...
  void connectFinalMemoryToPool(MM_EnvironmentBase* env,
                                void* address,
                                uintptr_t size);
  void abandonMemoryInPool(MM_EnvironmentBase* env,
                           void* address,
                           uintptr_t size);
