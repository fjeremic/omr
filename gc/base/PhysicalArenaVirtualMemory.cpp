 ...
 */
void MM_PhysicalArenaVirtualMemory::detachSubArena(MM_EnvironmentBase* env, MM_PhysicalSubArena* subArena)
{
 ...
 */
bool MM_PhysicalArenaVirtualMemory::attachSubArena(MM_EnvironmentBase* env, MM_PhysicalSubArena* subArena, uintptr_t size, uintptr_t attachPolicy)
{
    void* candidateBase;
 ...
 */
bool MM_PhysicalArenaVirtualMemory::canExpand(MM_EnvironmentBase* env, MM_PhysicalSubArenaVirtualMemory* subArena, void* expandAddress, uintptr_t expandSize)
{
 ...
 */
void* MM_PhysicalArenaVirtualMemory::findAdjacentHighValidAddress(MM_EnvironmentBase* env)
{
