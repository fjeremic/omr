...
public:
  static MM_MemorySubSpaceGeneric* newInstance(MM_EnvironmentBase* env,
   ...
   */
  MM_MemorySubSpaceGeneric(MM_EnvironmentBase* env,
                           MM_MemoryPool* memoryPool,
                           MM_RegionPool* regionPool,
                           bool usesGlobalCollector,
                           uintptr_t minimumSize,
...
private:
   ...
   */
  void addTenureRange(MM_EnvironmentBase* env,
                      uintptr_t size,
                      void* low,
                      void* high);
   ...
   * @param high high expansion address
   */
  void removeTenureRange(MM_EnvironmentBase* env,
                         uintptr_t size,
                         void* low,
                         void* high);
};
