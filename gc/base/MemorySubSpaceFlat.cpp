...
void*
MM_MemorySubSpaceFlat::allocateObject(MM_EnvironmentBase* env,
...
{
  Trc_MM_MSSFlat_allocate_entry(env->getLanguageVMThread(),
                                "Object",
  ...
  if (shouldCollectOnFailure) {
    Trc_MM_MSSFlat_allocate(env->getLanguageVMThread(),
                            "Object",
                            allocDescription->getBytesRequested(),
                            1);
  ...
  Trc_MM_MSSFlat_allocate_exit(env->getLanguageVMThread(),
                               "Object",
                               allocDescription->getBytesRequested(),
                               result);
...
void*
MM_MemorySubSpaceFlat::allocationRequestFailed(
  ...
  MM_MemorySubSpace* previousSubSpace)
{
  ...
  if (previousSubSpace == _parent) {
    ...
    addr = _memorySubSpace->allocationRequestFailed(env,
                                                    allocateDescription,
                                                    allocationType,
  ...
  if (_collector) {
    ...
    if (!_collector->isDisabled(env)) {
      ...
      addr = _collector->garbageCollect(env,
                                        this,
                                        allocateDescription,
                                        J9MMCONSTANT_IMPLICIT_GC_AGGRESSIVE,
                                        objectAllocationInterface,
                                        baseSubSpace,
                                        NULL);
      allocateDescription->restoreObjects(env);
  ...
  if ((NULL != _parent) && (previousSubSpace != _parent)) {
    ...
    return _parent->allocationRequestFailed(env,
                                            allocateDescription,
                                            allocationType,
                                            objectAllocationInterface,
                                            baseSubSpace,
...
void*
MM_MemorySubSpaceFlat::allocateArrayletLeaf(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  MM_MemorySubSpace* baseSubSpace,
  MM_MemorySubSpace* previousSubSpace,
 ...
 */
void*
MM_MemorySubSpaceFlat::allocateTLH(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  MM_ObjectAllocationInterface* objectAllocationInterface,
  MM_MemorySubSpace* baseSubSpace,
...
{
  if (shouldCollectOnFailure) {
    return _memorySubSpace->allocateTLH(env,
                                        allocDescription,
                                        objectAllocationInterface,
                                        baseSubSpace,
                                        this,
...
MM_MemorySubSpaceFlat::newInstance(MM_EnvironmentBase* env,
                                   ...
                                   uint32_t objectFlags)
{
  ...
  memorySubSpace = (MM_MemorySubSpaceFlat*)env->getForge()->allocate(
    sizeof(MM_MemorySubSpaceFlat),
    OMR::GC::AllocationCategory::FIXED,
    OMR_GET_CALLSITE());
  if (memorySubSpace) {
    new (memorySubSpace) MM_MemorySubSpaceFlat(env,
                                               physicalSubArena,
                                               childMemorySubSpace,
                                               usesGlobalCollector,
                                               minimumSize,
 ...
 */
uintptr_t
MM_MemorySubSpaceFlat::adjustExpansionWithinUserIncrement(
  MM_EnvironmentBase* env,
 ...
 */
bool
MM_MemorySubSpaceFlat::expanded(MM_EnvironmentBase* env,
...
{
  /* Inform the child */
  return _memorySubSpace->expanded(
 ...
 */
uintptr_t
MM_MemorySubSpaceFlat::getAvailableContractionSize(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription)
{
  return _physicalSubArena->getAvailableContractionSize(
    env, _memorySubSpace, allocDescription);
}
 ...
 */
uintptr_t
MM_MemorySubSpaceFlat::collectorExpand(MM_EnvironmentBase* env,
