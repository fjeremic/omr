...
private:
   ...
   */
public:
  static HeapRegionStateTable *newInstance(Forge *forge, uintptr_t heapBase,
                                           uintptr_t regionShift,
                                           uintptr_t regionCount);

  bool initialize(Forge *forge, uintptr_t heapBase, uintptr_t regionShift,
                  uintptr_t regionCount);
  ...
  HeapRegionStateTable() : _table(NULL), _heapBase(0), _regionShift(0) {
  ...
  MMINLINE uint8_t getRegionState(const void *heapAddress) {
   ...
   */
  MMINLINE void setRegionState(const void *heapAddress, uint8_t state) {
