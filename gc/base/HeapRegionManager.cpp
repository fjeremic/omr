...
uintptr_t MM_HeapRegionManager::getTotalHeapSize() {
...
void MM_HeapRegionManager::lock() {
  _heapRegionListMonitor.enterRead();
}

void MM_HeapRegionManager::unlock() {
...
void MM_HeapRegionManager::writeLock() {
  _heapRegionListMonitor.enterWrite();
}

void MM_HeapRegionManager::writeUnlock() {
