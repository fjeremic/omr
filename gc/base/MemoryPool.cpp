...
bool MM_MemoryPool::initialize(MM_EnvironmentBase* env) {
  return true;
}
 ...
 */
uintptr_t MM_MemoryPool::getActualFreeMemorySize() {
 ...
 */
MM_MemoryPool* MM_MemoryPool::getMemoryPool(void* addr) {
  return this;
}
 ...
 * @return MM_MemoryPool
 */
MM_MemoryPool* MM_MemoryPool::getMemoryPool(uintptr_t size) {
  return this;
}
 ...
 */
void MM_MemoryPool::moveHeap(MM_EnvironmentBase* env,
                             void* srcBase,
                             void* srcTop,
                             void* dstBase) {
  Assert_MM_unreachable();  // should never get here
 ...
 * otherwise
 */
bool MM_MemoryPool::createFreeEntry(MM_EnvironmentBase* env,
                                    void* addrBase,
                                    void* addrTop,
                                    MM_HeapLinkedFreeHeader* previousFreeEntry,
