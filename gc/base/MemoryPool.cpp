 ...
 */
MM_MemoryPool*
MM_MemoryPool::getMemoryPool(MM_EnvironmentBase* env,
                             void* addrBase,
                             void* addrTop,
                             void*& highAddr)
{
 ...
 */
void*
MM_MemoryPool::allocateArrayletLeaf(MM_EnvironmentBase* env,
...
void*
MM_MemoryPool::allocateTLH(MM_EnvironmentBase* env,
...
MM_MemoryPool::rebuildFreeListInRegion(
 ...
 */
uintptr_t
MM_MemoryPool::getAvailableContractionSizeForRangeEndingAt(
  MM_EnvironmentBase* env,
  MM_AllocateDescription* allocDescription,
  void* lowAddr,
  void* highAddr)
 ...
 */
void*
MM_MemoryPool::findFreeEntryTopStartingAtAddr(MM_EnvironmentBase* env,
                                              void* addr)
{
  Assert_MM_unreachable(); // should never get here
  return NULL;
 ...
 */
void*
MM_MemoryPool::getNextFreeStartingAddr(MM_EnvironmentBase* env,
                                       void* currentFree)
{
  Assert_MM_unreachable(); // should never get here
  return NULL;
 ...
 */
void
MM_MemoryPool::moveHeap(MM_EnvironmentBase* env,
                        void* srcBase,
                        void* srcTop,
                        void* dstBase)
{
 ...
 */
void*
MM_MemoryPool::collectorAllocate(MM_EnvironmentBase* env,
                                 MM_AllocateDescription* allocDescription,
 ...
 */
void*
MM_MemoryPool::collectorAllocateTLH(MM_EnvironmentBase* env,
                                    MM_AllocateDescription* allocDescription,
                                    uintptr_t maximumSizeInBytesRequired,
                                    void*& addrBase,
                                    void*& addrTop,
 ...
 */
bool
MM_MemoryPool::createFreeEntry(MM_EnvironmentBase* env,
                               void* addrBase,
                               void* addrTop,
                               MM_HeapLinkedFreeHeader* previousFreeEntry,
 ...
 */
void
MM_MemoryPool::addFreeEntries(MM_EnvironmentBase* env,
 ...
 */
bool
MM_MemoryPool::removeFreeEntriesWithinRange(
  MM_EnvironmentBase* env,
  void* lowAddress,
  void* highAddress,
 ...
 */
void*
MM_MemoryPool::findAddressAfterFreeSize(MM_EnvironmentBase* env,
