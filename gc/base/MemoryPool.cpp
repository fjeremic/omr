 ...
 * @param highAddr If range spans the end of memory pool set to the first byte which doesn't belong in the returned
 * pool.
 * @return MM_MemoryPool for storage location addrBase
 */
MM_MemoryPool* MM_MemoryPool::getMemoryPool(MM_EnvironmentBase* env, void* addrBase, void* addrTop, void*& highAddr)
{
    highAddr = NULL;
    return this;
}
 ...
 */
void* MM_MemoryPool::allocateArrayletLeaf(MM_EnvironmentBase* env, MM_AllocateDescription* allocDesc)
{
...
void* MM_MemoryPool::allocateTLH(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription,
 ...
 */
void* MM_MemoryPool::findFreeEntryEndingAtAddr(MM_EnvironmentBase* env, void* addr)
{
    Assert_MM_unreachable(); // should never get here
    return NULL;
}
 ...
 */
void* MM_MemoryPool::findFreeEntryTopStartingAtAddr(MM_EnvironmentBase* env, void* addr)
{
    Assert_MM_unreachable(); // should never get here
    return NULL;
}
 ...
 */
void* MM_MemoryPool::getNextFreeStartingAddr(MM_EnvironmentBase* env, void* currentFree)
{
    Assert_MM_unreachable(); // should never get here
    return NULL;
}
 ...
 */
void MM_MemoryPool::moveHeap(MM_EnvironmentBase* env, void* srcBase, void* srcTop, void* dstBase)
{
    Assert_MM_unreachable(); // should never get here
}
 ...
 */
void* MM_MemoryPool::collectorAllocate(
 ...
 * @todo Provide function documentation
 */
void* MM_MemoryPool::collectorAllocateTLH(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription,
 ...
 */
bool MM_MemoryPool::createFreeEntry(MM_EnvironmentBase* env, void* addrBase, void* addrTop,
 ...
 */
void MM_MemoryPool::addFreeEntries(MM_EnvironmentBase* env, MM_HeapLinkedFreeHeader*& freeListHead,
    MM_HeapLinkedFreeHeader*& freeListTail, uintptr_t freeMemoryCount, uintptr_t freeMemorySize)
{
    Assert_MM_unreachable(); /* implementation required */
}
 ...
 */
bool MM_MemoryPool::removeFreeEntriesWithinRange(MM_EnvironmentBase* env, void* lowAddress, void* highAddress,
 ...
 */
void* MM_MemoryPool::findAddressAfterFreeSize(MM_EnvironmentBase* env, uintptr_t sizeRequired, uintptr_t minimumSize)
{
    Assert_MM_unreachable(); /* implementation required */
    return NULL;
}
