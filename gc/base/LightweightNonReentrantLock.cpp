 ...
 */
bool MM_LightweightNonReentrantLock::initialize(MM_EnvironmentBase* env, ModronLnrlOptions* options, const char* name)
{
 ...
 */
void MM_LightweightNonReentrantLock::tearDown()
{
    if (NULL != _extensions) {
        if (NULL != _tracing) {
            if (NULL != _tracing->monitor_name) {
