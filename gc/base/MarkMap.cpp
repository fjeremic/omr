...
MM_MarkMap::initializeMarkMap(MM_EnvironmentBase* env)
{
  ...
  heapClearUnitFactor = ((heapClearUnitFactor == 1)
                           ? 1
    ...
    if (region->isCommitted()) {
      ...
      while (0 != heapClearSizeRemaining) {
        ...
        uintptr_t heapCurrentClearSize =
          (heapClearUnitSize > heapClearSizeRemaining) ? heapClearSizeRemaining
                                                       : heapClearUnitSize;
        ...
        if (J9MODRON_HANDLE_NEXT_WORK_UNIT(env)) {
          ...
          uintptr_t heapMapClearSize =
            convertHeapIndexToHeapMapIndex(
              env, heapClearOffset + heapCurrentClearSize, sizeof(uintptr_t)) -
            heapMapClearIndex;
