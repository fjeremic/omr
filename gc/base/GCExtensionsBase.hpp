...
private:
  ...
  volatile BackOutState
    _backOutState; /**< set if a thread is unable to copy an object due to lack
                      of free space in both Survivor and Tenure */
...
public:
  ...
  void*
    _masterThreadTenureTLHRemainderBase; /**< base and top pointers of the last
                                            unused tenure TLH copy cache, that
                                            will be loaded to thread env during
                                            master setup */
  ...
  MM_ScavengerCopyScanRatio
    copyScanRatio; /* Most recent estimate of ratio of aggregate slots copied to
                      slots scanned in completeScan() */
#endif             /* OMR_GC_MODRON_SCAVENGER */
  ...
  float
    concurrentKickoffTenuringHeadroom; /**< percentage of free memory remaining
                                          in tenure heap. Used in conjunction
                                          with free memory to determine
                                          concurrent mark kickoff */
  ...
  uintptr_t
    largeObjectAllocationProfilingThreshold; /**< object size threshold above
                                                which the object is large enough
  ...
  uintptr_t
    largeObjectAllocationProfilingVeryLargeObjectSizeClass; /**< index of
                                                               ...
                                                               veryLargeEntry*/
  uint32_t
    largeObjectAllocationProfilingSizeClassRatio; /**< ratio of lower and upper
                                                     boundary of a size class in
                                                     large object allocation
                                                     profiling */
  uint32_t
    largeObjectAllocationProfilingTopK; /**< number of most allocation size we
                                           want to track/report in large object
  ...
  uintptr_t
    freeMemoryProfileMaxSizeClasses; /**< maximum number of sizeClass maintained
                                        for heap free memory profile (computed
                                        from SizeClassRatio) */
  ...
  volatile OMR_VMThread*
    gcExclusiveAccessThreadId; /**< thread token that represents the current
                                  ...
                                  collection */
  omrthread_monitor_t
    gcExclusiveAccessMutex; /**< Mutex used for acquiring gc priviledges as well
                               as for signalling waiting threads that GC has
                               been completed */
  ...
  uintptr_t
    tlhSurvivorDiscardThreshold; /**< below this size GC (Scavenger) will
                                    ...
                                    not succeeded (otherwise we reuse memory for
                                    next TLH) */
  uintptr_t
    tlhTenureDiscardThreshold; /**< below this size GC (Scavenger) will discard
                                  tenure copy cache TLH, if alloc not succeeded
                                  (otherwise we reuse memory for next TLH) */
  ...
  uintptr_t
    splitFreeListNumberChunksPrepared; /**< Used in MPSAOL postProcess. Shared
                                          for all MPSAOLs. Do not overwrite
                                          during postProcess for any MPSAOL. */
  bool enableHybridMemoryPool;

  bool largeObjectArea;
#if defined(OMR_GC_LARGE_OBJECT_AREA)
  typedef enum { METER_BY_SOA = 0,
                 METER_BY_LOA,
  ...
  uintptr_t
    heapExpansionStabilizationCount; /**< GC count required before the heap is
                                        allowed to expand due to excessvie time
                                        after last heap expansion */
  uintptr_t
    heapContractionStabilizationCount; /**< GC count required before the heap is
                                          allowed to contract due to excessvie
  ...
  uintptr_t
    markingArraySplitMaximumAmount; /**< maximum number of elements to split
                                       array scanning work in marking scheme */
  uintptr_t
    markingArraySplitMinimumAmount; /**< minimum number of elements to split
                                       array scanning work in marking scheme */
  ...
  uintptr_t
    fvtest_forceSweepChunkArrayCommitFailure; /**< Force failure at Sweep Chunk
                                                 Array commit operation */
  uintptr_t
    fvtest_forceSweepChunkArrayCommitFailureCounter; /**< Force failure at Sweep
                                                        Chunk Array commit
                                                        operation counter */
#if defined(OMR_ENV_DATA64) && defined(OMR_GC_FULL_POINTERS)
  ...
  uintptr_t
    fvtest_enableMonitorObjectsReadBarrierVerification; /**< Forces failure at
                                                           all direct memory
                                                           read sites for
                                                           monitor slot objects
                                                         */
  uintptr_t
    fvtest_enableClassStaticsReadBarrierVerification; /**< Forces failure at all
                                                         direct memory read
                                                         sites for class statics
                                                       */
  uintptr_t
    fvtest_enableJNIGlobalWeakReadBarrierVerification; /**< Forces failure at
                                                          all direct memory read
                                                          sites for JNI Global
                                                          weak references */
  uintptr_t
    fvtest_enableHeapReadBarrierVerification; /**< Forces failure at all direct
                                                 memory read sites for heap
                                                 references */
#endif /* defined(OMR_ENV_DATA64) && defined(OMR_GC_FULL_POINTERS) */
  ...
  uintptr_t fvtest_forceMarkMapDecommitFailure; /**< Force failure at Mark Map
                                                   decommit operation */
  uintptr_t
    fvtest_forceMarkMapDecommitFailureCounter; /**< Force failure at Mark Map
                                                  decommit operation counter */

  uintptr_t
    fvtest_forceReferenceChainWalkerMarkMapCommitFailure; /**< Force failure at
                                                             Reference Chain
                                                             Walker Mark Map
                                                             commit operation */
  uintptr_t
  ...
  uintptr_t
    fvtest_forceCopyForwardHybridRatio; /**< Force to run CopyForward Hybrid
                                           mode value = 1-100 the percentage of
                                           non evacuated eden regions */
  ...
  bool
    gcThreadCountForced; /**< true if number of GC threads is specified in java
                            options. Currently we have a few ways to do this:
                                                                       -Xgcthreads
                            -Xthreads= (RT only)	-XthreadCount= */
  ...
  bool concurrentScavengerForced;     /**< set to true if CS is requested (by
                                         ...
                                         is to be obeyed */
  bool
    concurrentScavengerHWSupport; /**< set to true if CS runs with HW support */
  ...
  double
    scavengerCollectorExpandRatio; /**< the ratio of _avgTenureBytes we use to
                                      expand when a collectorAllocate() fails */
  ...
  double
    aliasInhibitingThresholdPercentage; /**< percentage of threads that can be
                                           blocked before copy cache aliasing is
                                           inhibited (set through
  ...
  double
    globalMaximumContraction; /**< maximum percentage of committed global heap
                                 which can contract in one GC cycle (set through
                                 -Xgc:globalMaximumContraction=) */
  double
    globalMinimumContraction; /**< minimum percentage of committed global heap
                                 which can contract in one GC cycle (set through
                                 -Xgc:globalMinimumContraction=) */
  ...
  UDATA
    fvtest_forceConcurrentTLHMarkMapCommitFailure; /**< Force failure at
                                                      ...
                                                      commit operation */
  UDATA
    fvtest_forceConcurrentTLHMarkMapCommitFailureCounter; /**< Force failure at
                                                             Concurrent TLH Mark
                                                             Map commit
                                                             operation counter
                                                           */
  UDATA
    fvtest_forceConcurrentTLHMarkMapDecommitFailure; /**< Force failure at
                                                        Concurrent TLH Mark Map
                                                        decommit operation */
  UDATA
  ...
  UDATA fvtest_forceCardTableCommitFailure; /**< Force failure at Card Table
                                               commit operation */
  UDATA
    fvtest_forceCardTableCommitFailureCounter; /**< Force failure at Card Table
                                                  commit operation  counter */
  ...
  uintptr_t
    managedAllocationContextCount; /**< The number of allocation contexts which
                                      will be instantiated and managed by the
                                      GlobalAllocationManagerRealtime (currently
                                      2*cpu_count) */
  ...
  uintptr_t
    splitAvailableListSplitAmount; /**< Number of split available lists per size
                                      class, per defragment bucket */
  ...
  uintptr_t
    allocationTrackerFlushThreshold; /**< The flush threshold to be used for all
                                        allocation trackers, this value is
  ...
  MM_ConfigurationOptions
    configurationOptions; /**< holds the options struct, used during startup for
  ...
  uintptr_t
    suballocatorInitialSize; /**< the initial chunk size in bytes for the J9Heap
  ...
  bool
    shouldAllowShiftingCompression; /**< temporary option to enable compressed
                                       reference scaling by shifting pointers */
  ...
  uintptr_t
    forcedShiftingCompressionAmount; /**< temporary option to force compressed
                                        ...
                                        shifted value (typically 0-3 in current
                                        usage) */
  ...
  MM_NUMAManager
    _numaManager; /**< The object which abstracts the details of our NUMA
                     support so that the GCExtensions and the callers don't need
                     to duplicate the support to interpret our intention */
  bool
  ...
  uintptr_t
    fvtest_tarokFirstContext; /**< The allocation context number to use first,
                                 when associating the first thread (assignments
                                 will proceed, as a round robin, from this
                                 number).  Defaults to 0 */
  bool tarokEnableScoreBasedAtomicCompact; /**< True if atomic compact does use
                                              score based compact region
                                              selection heuristic */
  uintptr_t
    tarokIdealEdenMinimumBytes; /**< The ideal size of the eden space, in bytes,
                                   when the heap is at its -Xms size */
  uintptr_t
    tarokIdealEdenMaximumBytes; /**< The ideal size of the eden space, in bytes,
                                   when the heap is at its -Xmx size */
  ...
  MM_UserSpecifiedParameterUDATA
    tarokNurseryMaxAge; /**< The maximum age that a region will be before it is
                           excluded from a partial garbage collection */
  uintptr_t
  ...
  MM_RememberedSetCardBucket*
    rememberedSetCardBucketPool; /* GC thread local pools of RS Card Buckets for
                                    each Region (its Card List) */
  ...
  uintptr_t
    tarokDynamicCollectionSetSelectionAbsoluteBudget; /**< Number of budgeted
                                                         regions to dynamically
                                                         select for PGC
                                                         collection (outside of
                                                         the required nursery
                                                         set) */
  double
    tarokDynamicCollectionSetSelectionPercentageBudget; /**< Percentage increase
                                                           of nursery region
                                                           count to use as
                                                           dynamically selected
                                                           regions for PGC */
  uintptr_t
    tarokCoreSamplingAbsoluteBudget; /**< Number of budgeted regions to select
                                        for core sampling in a PGC collection
                                        (outside of the required nursery set) */
  double
  ...
  bool tarokPGCShouldCopyForward; /**< True if we want to allow PGC increments
                                     ...
                                     (default is true) */
  bool
    tarokPGCShouldMarkCompact; /**< True if we want to allow PGC increments to
                                  reclaim memory using compact (default is true)
                                  and require a corresponding mark operation */
  MM_InterRegionRememberedSet*
    interRegionRememberedSet; /**< The remembered set abstraction to be used to
                                 track inter-region references found while
  ...
  bool
    tarokAttachedThreadsAreCommon; /**< True if we want to associate all common
                                      threads with the "common context" which is
                                      otherwise only reserved for regions which
                                      the collector has identified as common to
                                      all nodes ("common" regions are still
                                      moved to this context, no matter the value
                                      of this flag) */
  ...
  MM_ClassLoaderRememberedSet*
    classLoaderRememberedSet; /**< The remembered set abstraction to be used to
                                 track references from instances to the class
                                 loaders containing their defining class */
  ...
  uintptr_t
    tarokAllocationAgeUnit; /**< base unit for allocation-based aging system */
  ...
  uintptr_t
    tarokWorkSplittingPeriod; /**< The number of objects which must be scanned
                                 ...
                                 copy-forward implementation makes to see if it
                                 should push work out to other threads */
  MM_UserSpecifiedParameterUDATA
    tarokMinimumGMPWorkTargetBytes; /**< Minimum used for GMP work targets.
                                       This avoids the low-scan-rate -> low GMP
                                       work target -> low scan-rate feedback
                                       loop. */
  ...
  enum ReserveRegions{ RESERVE_REGIONS_NO = 0,
                       RESERVE_REGIONS_MOST_ALLOCATABLE,
                       RESERVE_REGIONS_MOST_FREE };
  ReserveRegions tarokReserveRegionsFromCollectionSet;
  bool
    tarokEnableRecoverRegionTailsAfterSweep; /**< Enable recovering region tail
                                                during post sweep of GMP */
#if defined(OMR_GC_VLHGC_CONCURRENT_COPY_FORWARD)
  bool _isConcurrentCopyForward;
#endif
  enum TarokRegionTailCondidateListSortOrder{ SORT_ORDER_NOORDER = 0,
  ...
  uint64_t
    _masterThreadCpuTimeNanos; /**< Total CPU time used by all master threads */
  ...
  MM_ReferenceChainWalkerMarkMap*
    referenceChainWalkerMarkMap; /**< Reference to Reference Chain Walker mark
                                    map - will be created at first call and
                                    destroyed in Configuration tearDown*/
  ...
  virtual void setTenureAddressRange(void* base, uintptr_t size)
  {
    ...
    while (OMR_VMThread* walkThread = vmThreadListIterator.nextOMRVMThread()) {
      ...
      walkThread->highTenureAddress =
        (void*)((uintptr_t)heapBaseForBarrierRange0 + heapSizeForBarrierRange0);
...
#define CONCURRENT_SCAVENGER_PAGE_SECTIONS 64
   ...
   */
  MMINLINE void calculateConcurrentScavengerPageParameters(
    uintptr_t nurserySize)
  {
#if defined(OMR_GC_CONCURRENT_SCAVENGER)
    /*
  ...
  MM_GCExtensionsBase()
    ...
    , doFrequentObjectAllocationSampling(
        false) /* Finds most frequently allocated classes. Disabled by default.
                */
...
#endif                               /* OMR_GC_MODRON_SCAVENGER */
    , globalMaximumContraction(0.05) /* by default, contract must be at most 5%
                                        of the committed heap */
    , globalMinimumContraction(0.01) /* by default, contract must be at least 1%
                                        of the committed heap */
    , excessiveGCEnabled()
    , isRecursiveGC(false)
    , didGlobalGC(false)
    ...
    , overflowCacheCount(0) /**< initial value of 0.  This is set in workpackets
    ...
    , instrumentableAllocateHookEnabled(
        false) /* by default the hook J9HOOK_VM_OBJECT_ALLOCATE_INSTRUMENTABLE
                  is disabled */
    ...
    , traceCostToCheckYield(
        500) /* weighted sum of marked objects and scanned pointers before we
                check yield in main tracing loop */
    , sweepCostToCheckYield(500) /* weighted count of free chunks/marked objects
                                    before we check yield in sweep small loop */
    , splitAvailableListSplitAmount(0)
    , newThreadAllocationColor(0)
    , minimumFreeEntrySize((uintptr_t)-1) /* -1 => user did not override default
                                             minimumFreeEntrySize */
    ...
    , suballocatorInitialSize(
        SUBALLOCATOR_INITIAL_SIZE) /* default for J9Heap suballocator initial
                                      size is 200 MB */
    , suballocatorCommitSize(
        SUBALLOCATOR_COMMIT_SIZE) /* default for J9Heap suballocator commit size
                                     is 50 MB */
#if defined(OMR_GC_COMPRESSED_POINTERS)
    , shouldAllowShiftingCompression(
        true) /* VM Design 1810: shifting compression enabled, by default, for
                 compressed refs */
...
#if defined(OMR_GC_VLHGC)
    , tarokDebugEnabled(
        false) /* by default, we turn off the Tarok debug options since they are
                  an appreciable performance hit */
