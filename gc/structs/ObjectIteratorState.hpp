...
/**
 * Defines the class for storing ObjectIterator state. It is necessary to use
 * this common class to allow inlining of some costly virtual methods, and also
...
class GC_ObjectIteratorState {
 ...
 public:
  ...
  union {
    ...
    fomrobject_t
        *_scanPtr; /**< scan pointer into non-arraylet reference slot */
  };
  bool
      _contiguous; /**< whether or not the array being iterated is contiguous */
