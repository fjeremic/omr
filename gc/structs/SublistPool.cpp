 ...
 */
bool MM_SublistPool::initialize(MM_EnvironmentBase* env, OMR::GC::AllocationCategory::Enum category)
{
...
void MM_SublistPool::freePuddles(MM_EnvironmentBase* env, MM_SublistPuddle* list)
{
 ...
 */
bool MM_SublistPool::allocate(MM_EnvironmentBase* env, MM_SublistFragment* fragment)
{
 ...
 */
uintptr_t* MM_SublistPool::allocateElementNoContention(MM_EnvironmentBase* env)
{
    uintptr_t* element;
...
MM_SublistPuddle* MM_SublistPool::popPreviousPuddle(MM_SublistPuddle* returnedPuddle)
{
    omrthread_monitor_enter(_mutex);
