...
public:
   ...
   */
  void handleMarkEnd(J9HookInterface** hook,
                     uintptr_t eventNum,
                     void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleSweepEnd(J9HookInterface** hook,
                      uintptr_t eventNum,
                      void* eventData);

#if defined(OMR_GC_MODRON_COMPACTION)

  void handleCompactStart(J9HookInterface** hook,
                          uintptr_t eventNum,
                          void* eventData);
  /**
   ...
   * @param eventData hook specific event data.
   */
  void handleCompactEnd(J9HookInterface** hook,
                        uintptr_t eventNum,
                        void* eventData);
#endif /* defined(OMR_GC_MODRON_COMPACTION) */
   ...
   * @param eventData hook specific event data.
   */
  void handleScavengeEnd(J9HookInterface** hook,
                         uintptr_t eventNum,
                         void* eventData);
  void handleScavengeEndNoLock(J9HookInterface** hook,
                               uintptr_t eventNum,
                               void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleScavengePercolate(J9HookInterface** hook,
                               uintptr_t eventNum,
                               void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleConcurrentTracingEnd(J9HookInterface** hook,
                                  uintptr_t eventNum,
                                  void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleConcurrentKickoff(J9HookInterface** hook,
                               uintptr_t eventNum,
                               void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleConcurrentHalted(J9HookInterface** hook,
                              uintptr_t eventNum,
                              void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleConcurrentCollectionEnd(J9HookInterface** hook,
                                     uintptr_t eventNum,
                                     void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleConcurrentAborted(J9HookInterface** hook,
                               uintptr_t eventNum,
                               void* eventData);
#endif /* defined(OMR_GC_MODRON_CONCURRENT_MARK) */
};
