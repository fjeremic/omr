...
void MM_VerboseHandlerOutputStandard::handleGCOPStanza(MM_EnvironmentBase* env, const char* type, uintptr_t contextID, uint64_t duration, bool deltaTimeSuccess)
{
...
void MM_VerboseHandlerOutputStandard::handleGCOPOuterStanzaStart(MM_EnvironmentBase* env, const char* type, uintptr_t contextID, uint64_t duration, bool deltaTimeSuccess)
{
    MM_VerboseManager* manager = getManager();
    MM_VerboseWriterChain* writer = manager->getWriterChain();
    OMRPORT_ACCESS_FROM_OMRPORT(env->getPortLibrary());
...
#if defined(OMR_GC_MODRON_SCAVENGER)
void MM_VerboseHandlerOutputStandard::handleScavengeEndNoLock(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleConcurrentGCOpEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleScavengePercolate(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
#if defined(OMR_GC_MODRON_CONCURRENT_MARK)
void MM_VerboseHandlerOutputStandard::handleConcurrentRememberedSetScanEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleConcurrentRememberedSetScanEndInternal(MM_EnvironmentBase* env, void* eventData)
{
    /* Empty stub */
}

void MM_VerboseHandlerOutputStandard::handleConcurrentCardCleaningEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleConcurrentTracingEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleConcurrentKickoff(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleConcurrentHalted(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleConcurrentCollectionStart(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleConcurrentCollectionEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::handleConcurrentAborted(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutputStandard::outputMemType(MM_EnvironmentBase* env, uintptr_t indent, const char* type, uintptr_t free, uintptr_t total, uint32_t tenureFragmentation, uintptr_t microFragment, uintptr_t macroFragment)
{
...
void MM_VerboseHandlerOutputStandard::outputMemoryInfoInnerStanza(MM_EnvironmentBase* env, uintptr_t indent, MM_CollectionStatistics* statsBase)
{
    MM_VerboseWriterChain* writer = _manager->getWriterChain();
...
void MM_VerboseHandlerOutputStandard::outputMemoryInfoInnerStanzaInternal(MM_EnvironmentBase* env, uintptr_t indent, MM_CollectionStatistics* statsBase)
{
    /* Empty stub */
}
...
void verboseHandlerFailedAllocationCompleted(J9HookInterface** hook, uintptr_t eventNum, void* eventData, void* userData)
{
...
void verboseHandlerAcquiredExclusiveToSatisfyAllocation(J9HookInterface** hook, uintptr_t eventNum, void* eventData, void* userData)
{
...
#if defined(OMR_GC_MODRON_CONCURRENT_MARK)
void verboseHandlerConcurrentRememberedSetScanEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData, void* userData)
{
    ((MM_VerboseHandlerOutputStandard*)userData)->handleConcurrentRememberedSetScanEnd(hook, eventNum, eventData);
}

void verboseHandlerConcurrentCardCleaningEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData, void* userData)
{
...
void verboseHandlerConcurrentCollectionStart(J9HookInterface** hook, uintptr_t eventNum, void* eventData, void* userData)
{
