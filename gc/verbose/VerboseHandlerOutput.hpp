...
protected:
  ...
  virtual bool getThreadName(char* buf,
                             uintptr_t bufLen,
   ...
   * @param eventData hook specific event data.
   */
  void handleInitializedRegion(J9HookInterface** hook,
                               uintptr_t eventNum,
                               void* eventData);
   ...
   */
  void outputMemoryInfo(MM_EnvironmentBase* env,
                        uintptr_t indent,
   ...
   */
  void outputStringConstantInfo(MM_EnvironmentBase* env,
                                uintptr_t indent,
...
public:
   ...
   * @param eventData hook specific event data.
   */
  virtual void handleInitialized(J9HookInterface** hook,
                                 uintptr_t eventNum,
                                 void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleCycleStart(J9HookInterface** hook,
                        uintptr_t eventNum,
                        void* eventData);

  void handleCycleContinue(J9HookInterface** hook,
                           uintptr_t eventNum,
                           void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleCycleEnd(J9HookInterface** hook,
                      uintptr_t eventNum,
                      void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleExclusiveStart(J9HookInterface** hook,
                            uintptr_t eventNum,
                            void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleExclusiveEnd(J9HookInterface** hook,
                          uintptr_t eventNum,
                          void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleSystemGCStart(J9HookInterface** hook,
                           uintptr_t eventNum,
                           void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleSystemGCEnd(J9HookInterface** hook,
                         uintptr_t eventNum,
                         void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleAllocationFailureStart(J9HookInterface** hook,
                                    uintptr_t eventNum,
                                    void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleAllocationFailureEnd(J9HookInterface** hook,
                                  uintptr_t eventNum,
                                  void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleGCStart(J9HookInterface** hook,
                     uintptr_t eventNum,
                     void* eventData);
  ...
  void handleConcurrentStart(J9HookInterface** hook,
                             UDATA eventNum,
                             void* eventData);
  void handleConcurrentEnd(J9HookInterface** hook,
                           UDATA eventNum,
                           void* eventData);
  ...
  void handleHeapResize(J9HookInterface** hook,
                        uintptr_t eventNum,
                        void* eventData);
   ...
   * @param eventData hook specific event data.
   */
  void handleExcessiveGCRaised(J9HookInterface** hook,
                               uintptr_t eventNum,
                               void* eventData);
};
