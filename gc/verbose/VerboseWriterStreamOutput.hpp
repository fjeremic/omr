...
class MM_VerboseWriterStreamOutput : public MM_VerboseWriter {
 ...
 public:
  static MM_VerboseWriterStreamOutput *newInstance(MM_EnvironmentBase *env,
                                                   const char *filename);

  virtual bool reconfigure(MM_EnvironmentBase *env, const char *filename,
 ...
 private:
  ...
  MM_VerboseWriterStreamOutput::StreamID getStreamID(MM_EnvironmentBase *env,
                                                     const char *string);

  MMINLINE void setStream(MM_VerboseWriterStreamOutput::StreamID stream) {
