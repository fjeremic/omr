...
MM_VerboseWriterStreamOutput::MM_VerboseWriterStreamOutput(
 ...
 */
MM_VerboseWriterStreamOutput *MM_VerboseWriterStreamOutput::newInstance(
    MM_EnvironmentBase *env, const char *filename) {
  MM_GCExtensionsBase *extensions =
      MM_GCExtensionsBase::getExtensions(env->getOmrVM());

  MM_VerboseWriterStreamOutput *agent =
      (MM_VerboseWriterStreamOutput *)extensions->getForge()->allocate(
          sizeof(MM_VerboseWriterStreamOutput),
 ...
 */
bool MM_VerboseWriterStreamOutput::initialize(MM_EnvironmentBase *env,
                                              const char *filename) {
 ...
 */
void MM_VerboseWriterStreamOutput::closeStream(MM_EnvironmentBase *env) {
 ...
 */
void MM_VerboseWriterStreamOutput::tearDown(MM_EnvironmentBase *env) {
 ...
 */
void MM_VerboseWriterStreamOutput::endOfCycle(MM_EnvironmentBase *env) {
  /* Nothing to really do */
}

bool MM_VerboseWriterStreamOutput::reconfigure(MM_EnvironmentBase *env,
                                               const char *filename,
                                               uintptr_t fileCount,
...
MM_VerboseWriterStreamOutput::getStreamID(MM_EnvironmentBase *env,
                                          const char *string) {
  if (NULL == string) {
    return STDERR;
  }
...
void MM_VerboseWriterStreamOutput::outputString(MM_EnvironmentBase *env,
                                                const char *string) {
  OMRPORT_ACCESS_FROM_OMRPORT(env->getPortLibrary());
