 ...
 */
MM_VerboseWriterStreamOutput* MM_VerboseWriterStreamOutput::newInstance(MM_EnvironmentBase* env, const char* filename)
{
    MM_GCExtensionsBase* extensions = MM_GCExtensionsBase::getExtensions(env->getOmrVM());

    MM_VerboseWriterStreamOutput* agent = (MM_VerboseWriterStreamOutput*)extensions->getForge()->allocate(
        sizeof(MM_VerboseWriterStreamOutput), OMR::GC::AllocationCategory::DIAGNOSTIC, OMR_GET_CALLSITE());
    if (agent) {
 ...
 */
bool MM_VerboseWriterStreamOutput::initialize(MM_EnvironmentBase* env, const char* filename)
{
...
bool MM_VerboseWriterStreamOutput::reconfigure(
...
MM_VerboseWriterStreamOutput::StreamID MM_VerboseWriterStreamOutput::getStreamID(
...
void MM_VerboseWriterStreamOutput::outputString(MM_EnvironmentBase* env, const char* string)
{
    OMRPORT_ACCESS_FROM_OMRPORT(env->getPortLibrary());
