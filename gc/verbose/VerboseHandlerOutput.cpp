...
static void
verboseHandlerInitialized(J9HookInterface** hook,
                          uintptr_t eventNum,
                          void* eventData,
                          void* userData);
static void
verboseHandlerHeapResize(J9HookInterface** hook,
                         uintptr_t eventNum,
                         void* eventData,
                         void* userData);
                                     ...
                                     MM_VerboseManager* manager)
{
  ...
  MM_VerboseHandlerOutput* verboseHandlerOutput =
    (MM_VerboseHandlerOutput*)extensions->getForge()->allocate(
      sizeof(MM_VerboseHandlerOutput),
...
bool
MM_VerboseHandlerOutput::initialize(MM_EnvironmentBase* env,
                                    MM_VerboseManager* manager)
{
  _omrVM = env->getOmrVM();
  ...
  if (!_reportingLock.initialize(env,
                                 &env->getExtensions()->lnrlOptions,
...
MM_VerboseHandlerOutput::disableVerbose()
{
  ...
  (*_mmOmrHooks)
    ->J9HookUnregister(
      _mmOmrHooks, J9HOOK_MM_OMR_INITIALIZED, verboseHandlerInitialized, NULL);
  (*_mmPrivateHooks)
...
bool
MM_VerboseHandlerOutput::getThreadName(char* buf,
                                       uintptr_t bufLen,
...
uintptr_t
MM_VerboseHandlerOutput::getTagTemplate(char* buf,
                                        uintptr_t bufsize,
                                        uint64_t wallTimeMs)
{
  OMRPORT_ACCESS_FROM_OMRVM(_omrVM);
  ...
  bufPos += omrstr_ftime(
    buf + bufPos, bufsize - bufPos, VERBOSEGC_DATE_FORMAT_PRE_MS, wallTimeMs);
  bufPos +=
    omrstr_printf(buf + bufPos, bufsize - bufPos, "%03llu", wallTimeMs % 1000);
  bufPos += omrstr_ftime(
    buf + bufPos, bufsize - bufPos, VERBOSEGC_DATE_FORMAT_POST_MS, wallTimeMs);
                                        ...
                                        uint64_t wallTimeMs)
{
  ...
  bufPos +=
    omrstr_printf(buf,
                  bufsize,
                  "id=\"%zu\" type=\"%s\" contextid=\"%zu\" timestamp=\"",
                  id,
                  type,
                  contextId);
  bufPos += omrstr_ftime(
...
uintptr_t
MM_VerboseHandlerOutput::getTagTemplateWithOldType(char* buf,
                                                   uintptr_t bufsize,
                                                   uintptr_t id,
                                                   const char* oldType,
                                                   const char* newType,
...
uintptr_t
MM_VerboseHandlerOutput::getTagTemplateWithDuration(char* buf,
                                                    uintptr_t bufsize,
                                                    uintptr_t id,
                                                    const char* type,
                                                    uintptr_t contextId,
...
void
MM_VerboseHandlerOutput::handleInitializedInnerStanzas(J9HookInterface** hook,
                                                       uintptr_t eventNum,
                                                       void* eventData)
{
  return;
...
void
MM_VerboseHandlerOutput::handleInitializedRegion(J9HookInterface** hook,
                                                 uintptr_t eventNum,
                                                 void* eventData)
{
  ...
  writer->formatAndOutput(
    env,
    2,
    "<attribute name=\"arrayletLeafSize\" value=\"%zu\" />",
    event->arrayletLeafSize);
  writer->formatAndOutput(env, 1, "</region>");
}

void
MM_VerboseHandlerOutput::handleInitialized(J9HookInterface** hook,
                                           uintptr_t eventNum,
                                           void* eventData)
{
  MM_InitializedEvent* event = (MM_InitializedEvent*)eventData;
  ...
  if (_extensions->isConcurrentScavengerEnabled()) {
    writer->formatAndOutput(
      env,
      1,
      "<attribute name=\"concurrentScavenger\" value=\"%s\" />",
#if defined(S390)
  ...
  writer->formatAndOutput(
    env,
    1,
    "<attribute name=\"initialHeapSize\" value=\"0x%zx\" />",
  ...
  if (env->compressObjectReferences()) {
    ...
    writer->formatAndOutput(
      env,
      1,
      "<attribute name=\"compressedRefsDisplacement\" value=\"0x%zx\" />",
      0);
    writer->formatAndOutput(
      env,
      1,
      "<attribute name=\"compressedRefsShift\" value=\"0x%zx\" />",
  ...
  writer->formatAndOutput(
    env,
    1,
    "<attribute name=\"requestedPageSize\" value=\"0x%zx\" />",
    event->heapRequestedPageSize);
  writer->formatAndOutput(
    env,
    1,
    "<attribute name=\"requestedPageType\" value=\"%s\" />",
    event->heapRequestedPageType);
  writer->formatAndOutput(
    env, 1, "<attribute name=\"gcthreads\" value=\"%zu\" />", event->gcThreads);
  ...
  writer->formatAndOutput(
    env,
    1,
    "<attribute name=\"packetListSplit\" value=\"%zu\" />",
  ...
  writer->formatAndOutput(
    env,
    1,
    "<attribute name=\"splitFreeListSplitAmount\" value=\"%zu\" />",
    _extensions->splitFreeListSplitAmount);
  writer->formatAndOutput(
    env, 1, "<attribute name=\"numaNodes\" value=\"%zu\" />", event->numaNodes);
  ...
  writer->formatAndOutput(
    env,
    2,
    "<attribute name=\"physicalMemory\" value=\"%llu\" />",
  ...
  writer->formatAndOutput(env,
                          ...
                          event->architecture);
  writer->formatAndOutput(
    env, 2, "<attribute name=\"os\" value=\"%s\" />", event->os);
  writer->formatAndOutput(
    env, 2, "<attribute name=\"osVersion\" value=\"%s\" />", event->osVersion);
  writer->formatAndOutput(env, 1, "</system>");
...
void
MM_VerboseHandlerOutput::handleCycleStart(J9HookInterface** hook,
                                          uintptr_t eventNum,
                                          void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleCycleContinue(J9HookInterface** hook,
                                             uintptr_t eventNum,
                                             void* eventData)
{
  ...
  char tagTemplate[200];
  getTagTemplateWithOldType(tagTemplate,
                            sizeof(tagTemplate),
                            _manager->getIdAndIncrement(),
                            oldCycleType,
                            newCycleType,
...
void
MM_VerboseHandlerOutput::handleCycleEnd(J9HookInterface** hook,
                                        uintptr_t eventNum,
                                        void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleCycleStartInnerStanzas(J9HookInterface** hook,
                                                      uintptr_t eventNum,
                                                      void* eventData,
...
void
MM_VerboseHandlerOutput::handleCycleEndInnerStanzas(J9HookInterface** hook,
                                                    uintptr_t eventNum,
                                                    void* eventData,
                                                    uintptr_t indentDepth)
{
...
void
MM_VerboseHandlerOutput::handleExclusiveStart(J9HookInterface** hook,
                                              uintptr_t eventNum,
                                              void* eventData)
{
  ...
  getThreadName(
    escapedLastResponderName, sizeof(escapedLastResponderName), lastResponder);
...
void
MM_VerboseHandlerOutput::handleExclusiveEnd(J9HookInterface** hook,
                                            uintptr_t eventNum,
                                            void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleSystemGCStart(J9HookInterface** hook,
                                             uintptr_t eventNum,
                                             void* eventData)
{
  ...
  writer->formatAndOutput(
    env,
    0,
    "<sys-start reason=\"%s\" %s intervalms=\"%llu.%03llu\" />",
    getSystemGCReasonAsString(event->gcCode),
    tagTemplate,
    deltaTime / 1000,
    deltaTime % 1000);
  writer->flush(env);
...
void
MM_VerboseHandlerOutput::handleSystemGCEnd(J9HookInterface** hook,
                                           uintptr_t eventNum,
                                           void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleAllocationFailureStart(J9HookInterface** hook,
                                                      uintptr_t eventNum,
                                                      void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleFailedAllocationCompleted(J9HookInterface** hook,
                                                         uintptr_t eventNum,
                                                         void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleAllocationFailureEnd(J9HookInterface** hook,
                                                    uintptr_t eventNum,
                                                    void* eventData)
{
  ...
  if ((gc_policy_gencon == _extensions->configurationOptions._gcPolicy) &&
    ...
    writer->formatAndOutput(
      env,
      0,
      "<af-end %s threadId=\"%p\" success=\"%s\" from=\"%s\"/>",
      tagTemplate,
      event->currentThread,
      successString,
      region);
  ...
  void* eventData)
{
  ...
  writer->formatAndOutput(
    env,
    indentLevel + 1,
    "<warning details=\"exclusive access acquired to satisfy allocation\" />");
...
void
MM_VerboseHandlerOutput::outputMemoryInfo(MM_EnvironmentBase* env,
                                          uintptr_t indent,
...
MM_VerboseHandlerOutput::printAllocationStats(MM_EnvironmentBase* env)
{
  ...
  writer->formatAndOutput(env,
                          0,
                          "<allocation-stats totalBytes=\"%zu\" >",
  ...
  if (_extensions->isVLHGC()) {
    ...
    writer->formatAndOutput(
      ...
      systemStats->nontlhBytesAllocated(),
      systemStats->tlhBytesAllocated(),
    ...
    writer->formatAndOutput(env,
                            1,
                            "<allocated-bytes non-tlh=\"%zu\" tlh=\"%zu\" />",
                            systemStats->nontlhBytesAllocated(),
                            systemStats->tlhBytesAllocated());
  ...
  if (0 != _extensions->bytesAllocatedMost) {
    ...
    if (NULL != vmThreadAllocatedMost) {
      ...
      omrstr_printf(
        escapedThreadName, sizeof(escapedThreadName), "unknown thread");
    }
    writer->formatAndOutput(
      env,
      1,
      "<largest-consumer threadName=\"%s%s\" threadId=\"%p\" bytes=\"%zu\" />",
      escapedThreadName,
      dots,
      threadID,
...
void
MM_VerboseHandlerOutput::handleGCStart(J9HookInterface** hook,
                                       uintptr_t eventNum,
                                       void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleGCEnd(J9HookInterface** hook,
                                     uintptr_t eventNum,
                                     void* eventData)
{
  ...
  char tagTemplate[200];
  getTagTemplateWithDuration(tagTemplate,
                             sizeof(tagTemplate),
                             _manager->getIdAndIncrement(),
                             getCurrentCycleType(env),
                             env->_cycleState->_verboseContextID,
                             durationInMicroseconds,
                             userTimeInMicroseconds,
                             systemTimeInMicroseconds,
                             omrtime_current_time_millis());
  ...
  writer->formatAndOutput(
    env, 0, "<gc-end %s activeThreads=\"%zu\">", tagTemplate, activeThreads);
  outputMemoryInfo(env, _manager->getIndentLevel() + 1, stats);
...
void
MM_VerboseHandlerOutput::handleConcurrentStart(J9HookInterface** hook,
                                               UDATA eventNum,
                                               void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleConcurrentEndInternal(J9HookInterface** hook,
                                                     UDATA eventNum,
                                                     void* eventData)
{
...
void
MM_VerboseHandlerOutput::handleConcurrentEnd(J9HookInterface** hook,
                                             UDATA eventNum,
                                             void* eventData)
{
  MM_ConcurrentPhaseEndEvent* event = (MM_ConcurrentPhaseEndEvent*)eventData;
...
void
MM_VerboseHandlerOutput::handleHeapResize(J9HookInterface** hook,
                                          uintptr_t eventNum,
                                          void* eventData)
{
  ...
  enterAtomicReportingBlock();
  outputHeapResizeInfo(env,
                       _manager->getIndentLevel(),
                       resizeType,
                       resizeAmount,
                       resizeCount,
                       subSpaceType,
...
void
MM_VerboseHandlerOutput::outputHeapResizeInfo(MM_EnvironmentBase* env,
                                              uintptr_t indent,
...
void
MM_VerboseHandlerOutput::outputCollectorHeapResizeInfo(
  MM_EnvironmentBase* env,
  uintptr_t indent,
  HeapResizeType resizeType,
  uintptr_t resizeAmount,
...
void
MM_VerboseHandlerOutput::handleExcessiveGCRaised(J9HookInterface** hook,
                                                 uintptr_t eventNum,
                                                 void* eventData)
{
...
void
MM_VerboseHandlerOutput::outputStringConstantInfo(MM_EnvironmentBase* env,
                                                  uintptr_t ident,
                                                  ...
                                                  uintptr_t cleared)
{
  ...
  if (0 != candidates) {
    writer->formatAndOutput(
      env,
      ident,
      "<stringconstants candidates=\"%zu\" cleared=\"%zu\"  />",
      candidates,
      cleared);
  }
}
