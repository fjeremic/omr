...
#if defined(S390)
            _extensions->concurrentScavengerHWSupport ? "enabled, with H/W assistance" : "enabled, without H/W assistance");
#else /* defined(S390) */
            "enabled");
#endif /* defined(S390) */
    }
...
void MM_VerboseHandlerOutput::handleCycleStartInnerStanzas(J9HookInterface** hook, uintptr_t eventNum, void* eventData, uintptr_t indentDepth)
{
    /* do nothing */
}
...
void MM_VerboseHandlerOutput::handleCycleEndInnerStanzas(J9HookInterface** hook, uintptr_t eventNum, void* eventData, uintptr_t indentDepth)
{
    /* do nothing */
}
...
void MM_VerboseHandlerOutput::handleAllocationFailureStartInnerStanzas(J9HookInterface** hook, uintptr_t eventNum, void* eventData, uintptr_t indentDepth)
{
}
...
void MM_VerboseHandlerOutput::handleFailedAllocationCompleted(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutput::handleAcquiredExclusiveToSatisfyAllocation(J9HookInterface** hook, uintptr_t eventNum, void* eventData)
{
...
void MM_VerboseHandlerOutput::outputMemoryInfo(MM_EnvironmentBase* env, uintptr_t indent, MM_CollectionStatistics* stats)
{
    MM_VerboseWriterChain* writer = _manager->getWriterChain();
...
void MM_VerboseHandlerOutput::outputMemoryInfoInnerStanza(MM_EnvironmentBase* env, uintptr_t indent, MM_CollectionStatistics* stats)
{
}
...
void MM_VerboseHandlerOutput::outputHeapResizeInfo(MM_EnvironmentBase* env, uintptr_t indent, HeapResizeType resizeType, uintptr_t resizeAmount, uintptr_t resizeCount, uintptr_t subSpaceType, uintptr_t reason, uint64_t timeInMicroSeconds)
{
    OMRPORT_ACCESS_FROM_OMRPORT(env->getPortLibrary());
    MM_VerboseWriterChain* writer = _manager->getWriterChain();
    uintptr_t id = _manager->getIdAndIncrement();
...
void MM_VerboseHandlerOutput::outputCollectorHeapResizeInfo(MM_EnvironmentBase* env, uintptr_t indent, HeapResizeType resizeType, uintptr_t resizeAmount, uintptr_t resizeCount, uintptr_t subSpaceType, uintptr_t reason, uint64_t timeInMicroSeconds)
{
    OMRPORT_ACCESS_FROM_OMRPORT(env->getPortLibrary());
    MM_VerboseWriterChain* writer = _manager->getWriterChain();
    const char* reasonString = NULL;
...
void MM_VerboseHandlerOutput::outputStringConstantInfo(MM_EnvironmentBase* env, uintptr_t ident, uintptr_t candidates, uintptr_t cleared)
{
    MM_VerboseWriterChain* writer = _manager->getWriterChain();
