 ...
 */
bool MM_VerboseWriterFileLoggingSynchronous::initialize(MM_EnvironmentBase* env, const char* filename, uintptr_t numFiles, uintptr_t numCycles)
{
 ...
 */
void MM_VerboseWriterFileLoggingSynchronous::closeFile(MM_EnvironmentBase* env)
{
    OMRPORT_ACCESS_FROM_OMRPORT(env->getPortLibrary());
...
void MM_VerboseWriterFileLoggingSynchronous::outputString(MM_EnvironmentBase* env, const char* string)
{
    OMRPORT_ACCESS_FROM_OMRPORT(env->getPortLibrary());
