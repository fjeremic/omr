...
public:
  ...
  MMINLINE uint64_t getLastAllocationFailureTime() {
    return _timeOfLast.allocationFailure;
  };
  ...
  MMINLINE uint64_t getLastConcurrentGCTime() {
    return _timeOfLast.concurrentGC;
  };
  ...
  MMINLINE uint64_t getLastGlobalMarkGCTime() {
    return _timeOfLast.globalMarkGC;
  };
  MMINLINE uint64_t getLastBalancedGlobalGCTime() {
    return _timeOfLast.balancedGlobalGC;
  };
  MMINLINE uint64_t getLastTaxationEntryPointTime() {
    return _timeOfLast.taxationEntryPoint;
  };
  MMINLINE uint64_t getLastExclusiveAccessStartTime() {
    return _timeOfLast.exclusiveAccessStart;
  };
  MMINLINE uint64_t getLastExclusiveAccessEndTime() {
    return _timeOfLast.exclusiveAccessEnd;
  };

  MMINLINE void setInitializedTime(uint64_t time) {
    _timeOfLast.initialized = time;
  };
  MMINLINE void setLastSystemGCTime(uint64_t time) {
    _timeOfLast.systemGC = time;
  };
  MMINLINE void setLastAllocationFailureTime(uint64_t time) {
    _timeOfLast.allocationFailure = time;
  };
  MMINLINE void setLastNurseryAFTime(uint64_t time) {
    _timeOfLast.nurseryAF = time;
  };
  MMINLINE void setLastTenureAFTime(uint64_t time) {
    _timeOfLast.tenureAF = time;
  };
  MMINLINE void setLastGlobalGCTime(uint64_t time) {
    _timeOfLast.globalGC = time;
  };
  MMINLINE void setLastConcurrentGCTime(uint64_t time) {
    _timeOfLast.concurrentGC = time;
  };
  MMINLINE void setLastLocalGCTime(uint64_t time) {
    _timeOfLast.localGC = time;
  };
  MMINLINE void setLastPartialGCTime(uint64_t time) {
    _timeOfLast.partialGC = time;
  };
  MMINLINE void setLastGlobalMarkGCTime(uint64_t time) {
    _timeOfLast.globalMarkGC = time;
  };
  MMINLINE void setLastBalancedGlobalGCTime(uint64_t time) {
    _timeOfLast.balancedGlobalGC = time;
  };
  MMINLINE void setLastTaxationEntryPointTime(uint64_t time) {
    _timeOfLast.taxationEntryPoint = time;
  };
  MMINLINE void setLastExclusiveAccessStartTime(uint64_t time) {
    _timeOfLast.exclusiveAccessStart = time;
  };
  MMINLINE void setLastExclusiveAccessEndTime(uint64_t time) {
    _timeOfLast.exclusiveAccessEnd = time;
  };

  MMINLINE uint64_t getLastTarokIncrementEndTime() {
    return _timeOfLast.tarokIncrementStart;
  }
  MMINLINE void setLastTarokIncrementEndTime(uint64_t time) {
    _timeOfLast.tarokIncrementStart = time;
  }
  MMINLINE uint64_t getLastTarokIncrementStartTime() {
    return _timeOfLast.tarokIncrementEnd;
  }
  MMINLINE void setLastTarokIncrementStartTime(uint64_t time) {
    _timeOfLast.tarokIncrementEnd = time;
  }
  ...
  MMINLINE uint64_t getLastMetronomeTime(void) {
    return OMR_MAX(
        OMR_MAX(_timeOfLast.metronomeSynchGC, _timeOfLast.metronomeHeartbeat),
        OMR_MAX(_timeOfLast.metronomeTriggerStart,
                _timeOfLast.metronomeTriggerEnd));
  }

  MMINLINE uint64_t getLastMetronomeSynchGCTime() {
    return _timeOfLast.metronomeSynchGC;
  }
  MMINLINE void setLastMetronomeSynchGCTime(uint64_t time) {
    _timeOfLast.metronomeSynchGC = time;
  }
  MMINLINE uintptr_t getMetronomeSynchGCCount() {
    return _countOf.metronomeSynchGC;
  }
  MMINLINE void incrementMetronomeSynchGCCount() {
    _countOf.metronomeSynchGC += 1;
  }

  MMINLINE uint64_t getLastMetronomeHeartbeatTime() {
    return _timeOfLast.metronomeHeartbeat;
  }
  MMINLINE void setLastMetronomeHeartbeatTime(uint64_t time) {
    _timeOfLast.metronomeHeartbeat = time;
  }
  MMINLINE uintptr_t getMetronomeHeartbeatCount() {
    return _countOf.metronomeHeartbeat;
  }
  MMINLINE void incrementMetronomeHeartbeatCount() {
    _countOf.metronomeHeartbeat += 1;
  }

  MMINLINE uint64_t getLastMetronomeThreadPriorityChangeTime() {
    return _timeOfLast.metronomeThreadPriorityChange;
  }
  MMINLINE void setLastMetronomeThreadPriorityChangeTime(uint64_t time) {
    _timeOfLast.metronomeThreadPriorityChange = time;
  }
  MMINLINE uintptr_t getMetronomeThreadPriorityChangeCount() {
    return _countOf.metronomeThreadPriorityChange;
  }
  MMINLINE void incrementMetronomeThreadPriorityChangeCount() {
    _countOf.metronomeThreadPriorityChange += 1;
  }

  MMINLINE uint64_t getLastMetronomeTriggerStartTime(void) {
    return _timeOfLast.metronomeTriggerStart;
  }
  MMINLINE void setLastMetronomeTriggerStartTime(uint64_t time) {
    _timeOfLast.metronomeTriggerStart = time;
  }
  MMINLINE uint64_t getLastMetronomeTriggerEndTime(void) {
    return _timeOfLast.metronomeTriggerEnd;
  }
  MMINLINE void setLastMetronomeTriggerEndTime(uint64_t time) {
    _timeOfLast.metronomeTriggerEnd = time;
  }
  MMINLINE uintptr_t getMetronomeTriggerCount(void) {
    return _countOf.metronomeTrigger;
  }
  MMINLINE void incrementMetronomeTriggerCount(void) {
    _countOf.metronomeTrigger += 1;
  }

  MMINLINE uint64_t getLastMetronomeCycleStartTime(void) {
    return _timeOfLast.metronomeCycleStart;
  }
  MMINLINE void setLastMetronomeCycleStartTime(uint64_t time) {
    _timeOfLast.metronomeCycleStart = time;
  }
  MMINLINE uint64_t getLastMetronomeCycleEndTime(void) {
    return _timeOfLast.metronomeCycleEnd;
  }
  MMINLINE void setLastMetronomeCycleEndTime(uint64_t time) {
    _timeOfLast.metronomeCycleEnd = time;
  }
  MMINLINE uintptr_t getMetronomeCycleCount(void) {
    return _countOf.metronomeCycle;
  }
  MMINLINE void incrementMetronomeCycleCount(void) {
    _countOf.metronomeCycle += 1;
  }
#endif /* OMR_GC_REALTIME */
  ...
  MMINLINE uintptr_t getIdAndIncrement() {
    return MM_AtomicOperations::add(&_curId, 1);
  }

  /* Interface for Dynamic Configuration */
  virtual bool configureVerboseGC(OMR_VM *vm, char *filename,
                                  uintptr_t fileCount,
                                  uintptr_t iterations) = 0;
  ...
  MM_VerboseManagerBase(OMR_VM *omrVM)
      : MM_BaseVirtual(), _omrVM(omrVM), _indentationLevel(0),
        _hooksAttached(false), _mmPrivateHooks(NULL), _omrHooks(NULL),
        _outputCount(0), _curId(0) {
