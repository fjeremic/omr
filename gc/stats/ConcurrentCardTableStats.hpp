...
public:
  ...
  MMINLINE void setCardCleaningPhase1Kickoff(uintptr_t kickoff) {
    _cardCleaningPhase1Kickoff = kickoff;
  };
  MMINLINE uintptr_t getCardCleaningPhase1Kickoff() {
    return _cardCleaningPhase1Kickoff;
  };

  MMINLINE void setCardCleaningPhase2Kickoff(uintptr_t kickoff) {
    _cardCleaningPhase2Kickoff = kickoff;
  };
  MMINLINE uintptr_t getCardCleaningPhase2Kickoff() {
    return _cardCleaningPhase2Kickoff;
  };

  MMINLINE void setCardCleaningPhase3Kickoff(uintptr_t kickoff) {
    _cardCleaningPhase3Kickoff = kickoff;
  };
  MMINLINE uintptr_t getCardCleaningPhase3Kickoff() {
    return _cardCleaningPhase3Kickoff;
  };

  MMINLINE uintptr_t getConcurrentCleanedCards() {
    return concurrentCleanedCardsPhase1 + concurrentCleanedCardsPhase2 +
           concurrentCleanedCardsPhase3;
  };
  MMINLINE uintptr_t getFinalCleanedCards() {
    return finalCleanedCardsPhase1 + finalCleanedCardsPhase2;
  };

  MMINLINE uintptr_t getConcurrentCleanedCardsPhase1() {
    return concurrentCleanedCardsPhase1;
  };
  MMINLINE void incConcurrentCleanedCardsPhase1(uintptr_t numCards) {
    incrementCount(concurrentCleanedCardsPhase1, numCards);
  };

  MMINLINE uintptr_t getConcurrentCleanedCardsPhase2() {
    return concurrentCleanedCardsPhase2;
  };
  MMINLINE void incConcurrentCleanedCardsPhase2(uintptr_t numCards) {
    incrementCount(concurrentCleanedCardsPhase2, numCards);
  };

  MMINLINE uintptr_t getConcurrentCleanedCardsPhase3() {
    return concurrentCleanedCardsPhase3;
  };
  MMINLINE void incConcurrentCleanedCardsPhase3(uintptr_t numCards) {
    incrementCount(concurrentCleanedCardsPhase3, numCards);
  };

  MMINLINE uintptr_t getFinalCleanedCardsPhase1() {
    return finalCleanedCardsPhase1;
  };
  MMINLINE void incFinalCleanedCardsPhase1(uintptr_t numCards) {
    incrementCount(finalCleanedCardsPhase1, numCards);
  };

  MMINLINE uintptr_t getFinalCleanedCardsPhase2() {
    return finalCleanedCardsPhase2;
  };
  ...
  MM_ConcurrentCardTableStats()
      : MM_Base(), totalCards(0), concurrentCleanedCardsPhase1(0),
        finalCleanedCardsPhase1(0), concurrentCleanedCardsPhase2(0),
        finalCleanedCardsPhase2(0), concurrentCleanedCardsPhase3(0){};
};
