...
public:
  ...
  uintptr_t finalizableCount; /**< count of objects pushed for finalization
                                 during one quantum */

  uintptr_t _workPacketOverflowCount; /**< count of work packets overflowed
                                         since the end of the last quantum */
  uintptr_t _objectOverflowCount;     /**< count of single objects that are
                                         overflowed since the last quantum */
  ...
  uint64_t
      _microsToStopMutators; /**< The number of microseconds the master thread
                                had to wait for the mutator threads to stop, at
                                the beginning of this increment */
protected:
private:
public:
  /**
   ...
   */
  MM_MetronomeStats()
      : MM_Base(), classLoaderUnloadedCount(0), classesUnloadedCount(0),
        anonymousClassesUnloadedCount(0), finalizableCount(0),
        _workPacketOverflowCount(0), _objectOverflowCount(0),
        nonDeterministicSweepCount(0), nonDeterministicSweepConsecutive(0),
        nonDeterministicSweepDelay(0), _microsToStopMutators(0) {}
