...
public:
  ...
  MM_MetronomeStats
      metronomeStats; /**< Stats collected during one GC increment (quantum) */
...
#endif /* OMR_GC_MODRON_COMPACTION */
        ,
        fixHeapForWalkReason(FIXUP_NONE), fixHeapForWalkTime(0), markStats(),
        classUnloadStats(), metronomeStats(), finalizableCount(0){};
};
