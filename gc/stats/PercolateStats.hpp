...
public:
  MMINLINE void setLastPercolateReason(PercolateReason reason) {
    _lastPercolateReason = reason;
  }
  MMINLINE PercolateReason getLastPercolateReason() {
    return _lastPercolateReason;
  }
  ...
  MM_PercolateStats()
      : MM_Base(), _lastPercolateReason(NONE_SET),
