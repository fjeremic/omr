...
public:
  ...
  uint32_t
    _tenureFragmentation; /**< fragmentation indicator, can be NO_FRAGMENTATION,
                             MICRO_FRAGMENTATION, MACRO_FRAGMENTATION, indicate
                             if fragmentation info are ready in
