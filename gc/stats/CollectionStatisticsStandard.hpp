...
class MM_CollectionStatisticsStandard : public MM_CollectionStatistics {
 ...
 protected:
 public:
  static MM_CollectionStatisticsStandard *getCollectionStatistics(
      MM_CollectionStatistics *stats) {
    return (MM_CollectionStatisticsStandard *)stats;
  }

  MMINLINE void collectCollectionStatistics(
      MM_EnvironmentBase *env, MM_CollectionStatisticsStandard *stats) {
