...
public:
  ...
  uintptr_t _copyDiscardBytesTotal; /**< total bytes discarded due to copying
                                       into survivor */
  uintptr_t
    _scanObjectsTotal; /**< Total count of objects scanned in abort recovery */
  ...
  uintptr_t _scanObjectsEden; /**< Objects scanned in abort recovery in Eden
                                 (age 0) space*/
  uintptr_t
    _scanBytesEden; /**< Bytes scanned in abort recovery in Eden (age 0) space*/
  ...
  uintptr_t
    _edenEvacuateRegionCount; /**< Counts the number of Eden regions selected to
                                 be evacuated in this copy-forward (only counted
                                 globally - unused in per-thread stats) */
  ...
  uintptr_t
    _completeStallCount; /**< The number of times the thread stalled, and waited
                            for all other threads to complete working */
  ...
  uint64_t
    _completeStallTime; /**< The time, in hi-res ticks, the thread spent stalled
                           waiting for all other threads to complete working */
  ...
  uintptr_t
    _objectsScannedFromWorkPackets; /**< In depth-first copy-forward, the number
                                       of objects scanned by this thread which
                                       it found on a work packet */
  uintptr_t
  ...
  uintptr_t
    _objectsScannedFromNextInChain; /**< In depth-first copy-forward, the number
                                       of objects scanned by this thread which
                                       it found as the next child to scan from
                                       an object it was already scanning (going
                                       "down" the tree) */
  uintptr_t
    _objectsScannedFromDepthStack; /**< In depth-first copy-forward, the number
                                      of objects scanned by this thread which it
                                      found on its depth stack (that is, one it
                                      resumed as it was going "up" the tree) */
  uintptr_t
    _objectsScannedFromRoot; /**< In depth-first copy-forward, the number of
                                objects scanned by this thread which it found in
                                the non-card root set */
