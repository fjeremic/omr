...
public:
  ...
  uintptr_t workPacketsExchanged; /**< The number of output packets converted
                                     into input packets without being returned
                                     to the shared pool first */
...
public:
  ...
  void merge(MM_WorkPacketStats *statsToMerge) {
    ...
    _stwWorkStackOverflowOccured = (_stwWorkStackOverflowOccured ||
                                    statsToMerge->_stwWorkStackOverflowOccured);
    _stwWorkpacketCountAtOverflow =
        OMR_MAX(_stwWorkpacketCountAtOverflow,
                statsToMerge->_stwWorkpacketCountAtOverflow);
  ...
  MMINLINE bool getSTWWorkStackOverflowOccured() {
    return _stwWorkStackOverflowOccured;
  };
  MMINLINE void setSTWWorkStackOverflowOccured(bool overflow) {
    _stwWorkStackOverflowOccured = overflow;
  };
  MMINLINE uintptr_t getSTWWorkStackOverflowCount() {
    return _stwWorkStackOverflowCount;
  };
  MMINLINE uintptr_t getSTWWorkpacketCountAtOverflow() {
    return _stwWorkpacketCountAtOverflow;
  };
  ...
  MM_WorkPacketStats()
      : _gcCount(UDATA_MAX), workPacketsAcquired(0), workPacketsReleased(0),
        workPacketsExchanged(0), _workStallCount(0), _completeStallCount(0),
        _workStallTime(0), _completeStallTime(0), _stwWorkStackOverflowCount(0),
        _stwWorkStackOverflowOccured(false), _stwWorkpacketCountAtOverflow(0) {}
