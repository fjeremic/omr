...
uintptr_t
MM_ScavengerCopyScanRatio::record(MM_EnvironmentBase* env,
                                            ...
                                            UpdateHistory* historyRecord)
{
  ...
  return omrtime_hires_delta(
    start, historyRecord->time, OMRPORT_TIME_DELTA_IN_MICROSECONDS);
}

void
MM_ScavengerCopyScanRatio::failedUpdate(MM_EnvironmentBase* env,
                                        uint64_t copied,
                                        uint64_t scanned)
{
