...
void MM_AllocationStats::merge(MM_AllocationStats *stats) {
#if defined(OMR_GC_THREAD_LOCAL_HEAP)
  MM_AtomicOperations::add(&_tlhRefreshCountFresh,
                           stats->_tlhRefreshCountFresh);
  MM_AtomicOperations::add(&_tlhRefreshCountReused,
                           stats->_tlhRefreshCountReused);
  ...
  for (uintptr_t prevMax = _tlhMaxAbandonedListSize;
       prevMax < stats->_tlhMaxAbandonedListSize;
       prevMax = _tlhMaxAbandonedListSize) {
    MM_AtomicOperations::lockCompareExchange(&_tlhMaxAbandonedListSize, prevMax,
                                             stats->_tlhMaxAbandonedListSize);
  }
#endif /* defined (OMR_GC_THREAD_LOCAL_HEAP) */

  MM_AtomicOperations::add(&_arrayletLeafAllocationCount,
                           stats->_arrayletLeafAllocationCount);
  MM_AtomicOperations::add(&_arrayletLeafAllocationBytes,
                           stats->_arrayletLeafAllocationBytes);
  ...
  MM_AtomicOperations::add(&_ownableSynchronizerObjectCount,
                           stats->_ownableSynchronizerObjectCount);
  MM_AtomicOperations::add(&_discardedBytes, stats->_discardedBytes);
  MM_AtomicOperations::add(&_allocationSearchCount,
                           stats->_allocationSearchCount);
  /* looping to set a maximum value in _tlhMaxAbandonedListSize */
  for (uintptr_t prevMax = _allocationSearchCountMax;
