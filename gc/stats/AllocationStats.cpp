...
void MM_AllocationStats::merge(MM_AllocationStats* stats)
{
    ...
    for (uintptr_t prevMax = _tlhMaxAbandonedListSize; prevMax < stats->_tlhMaxAbandonedListSize;
        ...
        MM_AtomicOperations::lockCompareExchange(&_tlhMaxAbandonedListSize, prevMax, stats->_tlhMaxAbandonedListSize);
    }
#endif /* defined (OMR_GC_THREAD_LOCAL_HEAP) */
    ...
    for (uintptr_t prevMax = _allocationSearchCountMax; prevMax < stats->_allocationSearchCountMax;
        ...
        MM_AtomicOperations::lockCompareExchange(&_allocationSearchCountMax, prevMax, stats->_allocationSearchCountMax);
    }
}
