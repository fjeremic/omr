...
bool
MM_FreeEntrySizeClassStats::initialize(MM_EnvironmentBase* env,
                                       ...
                                       bool simulation)
{
  ...
  if (0 != _maxSizeClasses) {
    _count =
      (uintptr_t*)env->getForge()->allocate(sizeof(uintptr_t) * _maxSizeClasses,
...
MM_FreeEntrySizeClassStats::mergeCountForVeryLargeEntries()
{
  if (NULL != _frequentAllocationHead) {
    for (uintptr_t sizeClassIndex = _veryLargeEntrySizeClass;
         sizeClassIndex < _maxSizeClasses;
         sizeClassIndex++) {
...
uintptr_t
MM_FreeEntrySizeClassStats::getPageAlignedFreeMemory(
...
uintptr_t
MM_FreeEntrySizeClassStats::copyTo(MM_FreeEntrySizeClassStats* stats,
                                   const uintptr_t sizeClassSizes[])
{
  uintptr_t totalFreeMemory = 0;
...
void
MM_FreeEntrySizeClassStats::initializeFrequentAllocation(
