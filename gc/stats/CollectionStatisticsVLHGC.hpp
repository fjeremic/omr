...
public:
  ...
  uintptr_t _arrayletReferenceObjects; /**< Count of non-contiguous reference
                                          arraylets */
  uintptr_t
    _arrayletReferenceLeaves; /**< Count (total) of reference arraylet leaves */
  ...
  uintptr_t _arrayletPrimitiveObjects; /**< Count of non-contiguous primitive
                                          arraylets */
  uintptr_t
    _arrayletPrimitiveLeaves; /**< Count (total) of primitive arraylet leaves */
  ...
  uintptr_t
    _rememberedSetBeingRebuiltRegionCount; /**< Count of overflowed regions that
                                              are being rebuilt currently by GMP
                                            */
...
protected:
public:
  static MM_CollectionStatisticsVLHGC* getCollectionStatistics(
    MM_CollectionStatistics* stats)
  {
    return (MM_CollectionStatisticsVLHGC*)stats;
  }

  MMINLINE void collectCollectionStatistics(MM_EnvironmentBase* env,
