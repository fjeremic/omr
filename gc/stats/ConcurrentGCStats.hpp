...
class MM_ConcurrentGCStats : public MM_Base {
 ...
 public:
  ...
  MMINLINE void printAllocationTaxReport(OMR_VM *omrVM) {
    ...
    omrtty_printf(
        "Concurrent mark analysis: Total Allocations: %zu Tax Paid 0%%: %zu "
        "25%%: %zu 50%%: %zu  75%%: %zu 100%%+: %zu\n",
        _allocationsTaxed, _allocationsTaxedAt0, _allocationsTaxedAt25,
        _allocationsTaxedAt50, _allocationsTaxedAt75, _allocationsTaxedAt100);
  }
