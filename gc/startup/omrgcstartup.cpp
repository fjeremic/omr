...
static omr_error_t
heapCreationHelper(OMR_VM* omrVM,
                   ...
                   bool createCollector)
{
  ...
  if (0 != omrthread_monitor_init_with_name(
             &extensions->gcStatsMutex, 0, "MM_GCExtensions::gcStats")) {
  ...
  extensions->configuration->prepareParameters(
    ...
    extensions->minNewSpaceSize,
    extensions->newSpaceSize,
    extensions->maxNewSpaceSize,
    extensions->minOldSpaceSize,
    extensions->oldSpaceSize,
    extensions->maxOldSpaceSize,
    extensions->maxSizeDefaultMemorySpace,
    MEMORY_TYPE_DISCARDABLE,
    &parameters);

  if (0 != omrthread_monitor_init_with_name(
             &extensions->gcExclusiveAccessMutex,
             0,
  ...
  if (0 != omrthread_monitor_init_with_name(
             &extensions->_lightweightNonReentrantLockPoolMutex,
             0,
