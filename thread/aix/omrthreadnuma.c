...
intptr_t
omrthread_numa_set_node_affinity_nolock(omrthread_t thread,
 ...
 */
intptr_t
omrthread_numa_set_node_affinity(omrthread_t thread,
                                 ...
                                 uint32_t flags)
{
  ...
  if (isNumaAvailable && (NULL != thread)) {
    if (NULL != thread) {
      ...
      result = omrthread_numa_set_node_affinity_nolock(
        thread, numaNodes, nodeCount, 0);
 ...
 */
intptr_t
omrthread_numa_get_node_affinity(omrthread_t thread,
                                 uintptr_t* numaNodes,
                                 uintptr_t* nodeCount)
{
  intptr_t result = 0;
...
bindThreadToNode(omrthread_t thread, uintptr_t nodeNumber)
{
  ...
  if ((NULL != PTR_ra_attach) && (NULL != PTR_rs_get_homesrad)) {
     ...
     * attaching strictly
     */
    result = PTR_ra_attach(
      R_THREAD, thisThreadResourceID, R_SRADID, targetSRADResourceID, 0);
  }
  return result;
}
