...
#ifdef _LP64
void BPX4GTH(unsigned int *InputArea_length, unsigned char **InputArea,
             unsigned int *OuputArea_length, unsigned char **OuputArea,
             unsigned int *Return_value, unsigned int *Return_code,
             unsigned int *Reason_code);

#pragma linkage(BPX4GTH, OS)
#else
void BPX1GTH(unsigned int *InputArea_length, unsigned char **InputArea,
             unsigned int *OuputArea_length, unsigned char **OuputArea,
             unsigned int *Return_value, unsigned int *Return_code,
             unsigned int *Reason_code);
