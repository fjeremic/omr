...
/**
 * Run finalizers on any non-NULL TLS values for the current thread without
 * locks. To be used by omrthread fork handler functions while the lock is
 * already held.
 *
...
/**
 * @brief Return a monotonically increasing high resolution clock in
 * nanoseconds.
 * @return uint64_t
 */
 ...
 * @return void*
 */
void *omrthread_mallocWrapper(void *unused, uint32_t size, const char *callSite,
 ...
 * @param omrthreadPriority[in]  The omrthread priority to map to the os
 * priority
