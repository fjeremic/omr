 ...
 */
intptr_t
omrthread_rwmutex_init(omrthread_rwmutex_t* handle,
                       uintptr_t flags,
                       const char* name)
{
  ...
  mutex = (RWMutex*)omrthread_allocate_memory(
    lib, sizeof(RWMutex), OMRMEM_CATEGORY_THREADS);
...
{
  return pool_new(sizeof(RWMutex),
                  0,
                  0,
                  0,
                  OMR_GET_CALLSITE(),
