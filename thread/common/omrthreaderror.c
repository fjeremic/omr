...
const char* omrthread_get_errordesc(intptr_t err)
{
  ...
  static const char* omrthread_create_errordesc[] = {
    ...
    "Thread create failed" /* ERR_THREAD_CREATE_FAILED */, "Invalid create attr" /* ERR_INVALID_CREATE_ATTR */,
    "Can't allocate create attr" /* ERR_CANT_ALLOC_CREATE_ATTR */, "Can't allocate stack" /* ERR_CANT_ALLOC_STACK */
  };
  const char* errdesc = "";
