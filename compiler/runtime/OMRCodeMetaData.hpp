...
public:
   ...
   * cache for a method.
   */
  uintptrj_t codeAllocStart()
  {
    return _codeAllocStart;
  }
   ...
   * within a code cache.
   */
  uint32_t codeAllocSize()
  {
    return _codeAllocSize;
  }
   ...
   * to the same address.
   */
  uintptrj_t interpreterEntryPC()
  {
    return _interpreterEntryPC;
  }
