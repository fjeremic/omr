...
struct CodeCacheCodeGenCallbacks {
  ...
  int (*patchTrampoline)(
    void* method, void* callingPoint, void* currentStartPC, void* currentTrampoline, void* newStartPC, void* extraArg);
...
public:
  ...
  size_t trampolineCodeSize() const
  {
    return _trampolineCodeSize;
  }
  int32_t trampolineSpacePercentage() const
  {
    return _trampolineSpacePercentage;
  }
  size_t ccPreLoadedCodeSize() const
  {
    return _CCPreLoadedCodeSize;
  }
  int32_t numRuntimeHelpers() const
  {
    return _numOfRuntimeHelpers;
  }
  size_t codeCacheKB() const
  {
    return _codeCacheKB;
  }
  size_t codeCachePadKB() const
  {
    return _codeCachePadKB;
  }
  size_t codeCacheTotalKB() const
  {
    return _codeCacheTotalKB;
  }
  size_t codeCacheAlignment() const
  {
    return _codeCacheAlignment;
  }

  // Alignment for per-code cache helpers
  //
  size_t codeCacheHelperAlignment() const
  {
    return _codeCacheHelperAlignmentBytes;
  }
  void setCodeCacheHelperAlignment(size_t a)
  {
    _codeCacheHelperAlignmentBytes = a;
  }

  size_t codeCacheHelperAlignmentMask() const
  {
    return _codeCacheHelperAlignmentBytes - 1;
  }

  //  align trampolines on this byte boundary
  //
  size_t codeCacheTrampolineAlignmentBytes() const
  {
    return _codeCacheTrampolineAlignmentBytes;
  }

  int32_t codeCacheMethodBodyAllocRetries() const
  {
    return _codeCacheMethodBodyAllocRetries;
  }

  size_t codeCacheTempTrampolineSyncArraySize() const
  {
    return _codeCacheTempTrampolineSyncArraySize;
  }

  size_t codeCacheHashEntryAllocatorSlabSize() const
  {
    return _codeCacheHashEntryAllocatorSlabSize;
  }

  size_t largeCodePageSize() const
  {
    return _largeCodePageSize;
  }
  uint32_t largeCodePageFlags() const
  {
    return _largeCodePageFlags;
  }
  bool allowedToGrowCache() const
  {
    return _allowedToGrowCache;
  }
  bool needsMethodTrampolines() const
  {
    return _needsMethodTrampolines;
  }
  size_t lowCodeCacheThreshold() const
  {
    return _lowCodeCacheThreshold;
  }
  int32_t maxNumberOfCodeCaches() const
  {
    return _maxNumberOfCodeCaches;
  }
  bool canChangeNumCodeCaches() const
  {
    return _canChangeNumCodeCaches;
  }
  bool codeCacheFreeBlockRecylingEnabled() const
  {
    return _codeCacheFreeBlockRecylingEnabled;
  }
  bool verbosePerformance() const
  {
    return _verbosePerformance;
  }
  bool verboseCodeCache() const
  {
    return _verboseCodeCache;
  }
  bool verboseReclamation() const
  {
    return _verboseReclamation;
  }
  bool doSanityChecks() const
  {
    return _doSanityChecks;
  }

  CodeCacheCodeGenCallbacks& mccCallbacks()
  {
    return _mccCallbacks;
  }

  bool emitExecutableELF() const
  {
    return _emitExecutableELF;
  }
  bool emitRelocatableELF() const
  {
    return _emitRelocatableELF;
  }
  ...
  char* const warmEyeCatcher()
  {
    return _warmEyeCatcher;
  }

  char* const coldEyeCatcher()
  {
    return _coldEyeCatcher;
  }
