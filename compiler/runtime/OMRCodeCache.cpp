...
OMR::CodeCache::replaceTrampoline(TR_OpaqueMethodBlock *method,
                                  void *oldTrampoline, void *oldTargetPC,
...
uint8_t *OMR::CodeCache::findFreeBlock(size_t size, bool isCold,
  ...
  TR_ASSERT(_freeBlockList, "Because we first checked that a freeBlockExists, "
                            "freeBlockList cannot be null");
...
OMR::CodeCache::removeFreeBlock(size_t blockSize, CodeCacheFreeCacheBlock *prev,
                                CodeCacheFreeCacheBlock *curr) {
...
void *
OMR::CodeCache::getCCPreLoadedCodeAddress(TR_CCPreLoadedCode h,
