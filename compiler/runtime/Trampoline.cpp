...
ppcCreateHelperTrampolines(uint8_t* trampPtr, int32_t numHelpers)
{
  ...
  for (int32_t cookie = 1; cookie < numHelpers; cookie++) {
    ...
    *(int32_t*)buffer =
      0xe9620000 | (((cookie - 1) * sizeof(intptrj_t)) & 0x0000ffff);
    buffer += 4;
    ...
    if (!(helper & 0x00008000)) {
      ...
      *(int32_t*)buffer =
        0x3d600000 |
        (((helper >> 16) + (helper & (1 << 15) ? 1 : 0)) & 0x0000ffff);
      buffer += 4;
      ...
      *(int32_t*)buffer = 0x396b0000 | (helper & 0x0000ffff);
      ...
      // Now, if highest bit is on we need to clear the sign extend bits on
      // 64bit CPUs
      // ** POWER4 pref fix **
    ...
    *(int32_t*)buffer =
      0xe8420000 | ((numHelpers * sizeof(intptrj_t)) & 0x0000ffff);
    buffer += 4;
    ...
    *(int32_t*)buffer = 0x4e800420;
    ...
    const char* helperName =
      TR::Options::findOrCreateDebug()->getRuntimeHelperName(
        (TR_RuntimeHelper)cookie);
...
void
ppcCodeCacheParameters(int32_t* trampolineSize,
                       void** callBacks,
                       int32_t* numHelpers,
...
#if defined(TR_TARGET_64BIT)
/*FIXME this IS_32BIT_RIP is already define in different places; should be moved
 * to a header file*/
...
void
amd64CodeCacheConfig(int32_t ccSizeInByte, uint32_t* numTempTrampolines)
{
...
void
amd64CreateHelperTrampolines(uint8_t* trampPtr, int32_t numHelpers)
{
  uint8_t *bufferStart = trampPtr, *buffer;
...
void
amd64CodeCacheParameters(int32_t* trampolineSize,
                         OMR::CodeCacheCodeGenCallbacks* callBacks,
                         int32_t* numHelpers,
                         int32_t* CCPreLoadedCodeSize)
{
  *trampolineSize = TRAMPOLINE_SIZE;
...
void
ia32CodeCacheParameters(int32_t* trampolineSize,
                        OMR::CodeCacheCodeGenCallbacks* callBacks,
                        int32_t* numHelpers,
                        int32_t* CCPreLoadedCodeSize)
{
...
extern void
armCodeSync(uint8_t*, uint32_t);
#endif /* TR_HOST_ARM */

void
armCodeCacheConfig(int32_t ccSizeInByte, int32_t* numTempTrampolines)
{
...
void
armCreateHelperTrampolines(void* trampPtr, int32_t numHelpers)
{
  uint32_t* buffer =
    (uint32_t*)((uint8_t*)trampPtr +
                TRAMPOLINE_SIZE); // Skip the first trampoline for index 0
...
void
armCodeCacheParameters(int32_t* trampolineSize,
                       void** callBacks,
                       int32_t* numHelpers,
                       int32_t* CCPreLoadedCodeSize)
{
...
void
arm64CodeCacheConfig(int32_t ccSizeInByte, int32_t* numTempTrampolines)
{
...
void
arm64CreateHelperTrampolines(void* trampPtr, int32_t numHelpers)
{
  uint32_t* buffer =
    (uint32_t*)((uint8_t*)trampPtr +
                TRAMPOLINE_SIZE); // Skip the first trampoline for index 0
...
void
arm64CodeCacheParameters(int32_t* trampolineSize,
                         void** callBacks,
                         int32_t* numHelpers,
                         int32_t* CCPreLoadedCodeSize)
{
...
void
s390zOS31CodeCacheParameters(int32_t* trampolineSize,
                             void** callBacks,
                             int32_t* numHelpers,
                             int32_t* CCPreLoadedCodeSize)
{
...
void
s390zOS64CodeCacheParameters(int32_t* trampolineSize,
                             void** callBacks,
                             int32_t* numHelpers,
                             int32_t* CCPreLoadedCodeSize)
{
...
void
s390zLinux31CodeCacheParameters(int32_t* trampolineSize,
                                void** callBacks,
                                int32_t* numHelpers,
                                int32_t* CCPreLoadedCodeSize)
{
...
extern "C" void
_Store4(int32_t* addr, uint32_t newData);
extern "C" void
_Store8(intptrj_t* addr, uintptrj_t newData);

// zLinux64 Configuration of Code Cache.
void
s390zLinux64CodeCacheConfig(int32_t ccSizeInByte, int32_t* numTempTrampolines)
{
  // The method trampolines used by zLinux can be modified in place.
  // Only modification of the data constant after the BCR instruction is
  // required. This DC is guaranteed to be aligned for atomic ST.
  *numTempTrampolines = 0;
}

// zLinux64 Create Trampolines to Runtime Helper Routines.
void
s390zLinux64CreateHelperTrampoline(void* trampPtr, int32_t numHelpers)
{
...
void
s390zLinux64CodeCacheParameters(int32_t* trampolineSize,
                                void** callBacks,
                                int32_t* numHelpers,
                                int32_t* CCPreLoadedCodeSize)
{
...
void
setupCodeCacheParameters(int32_t* trampolineSize,
                         OMR::CodeCacheCodeGenCallbacks* callBacks,
                         int32_t* numHelpers,
                         int32_t* CCPreLoadedCodeSize)
{
  ...
  if (TR::Compiler->target.cpu.isPower()) {
    ppcCodeCacheParameters(
      trampolineSize, (void**)callBacks, numHelpers, CCPreLoadedCodeSize);
    return;
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isI386()) {
    ia32CodeCacheParameters(
      trampolineSize, callBacks, numHelpers, CCPreLoadedCodeSize);
    return;
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isZ()) {
    s390zLinux31CodeCacheParameters(
      trampolineSize, (void**)callBacks, numHelpers, CCPreLoadedCodeSize);
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isZ()) {
    s390zLinux64CodeCacheParameters(
      trampolineSize, (void**)callBacks, numHelpers, CCPreLoadedCodeSize);
  }
#endif
}
