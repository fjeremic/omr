...
void createCCPreLoadedCode(uint8_t *CCPreLoadedCodeBase,
...
void ppcCodeCacheParameters(int32_t *trampolineSize, void **callBacks,
                            int32_t *numHelpers, int32_t *CCPreLoadedCodeSize) {
#if defined(TR_TARGET_64BIT)
...
void amd64CodeCacheParameters(int32_t *trampolineSize,
...
void ia32CodeCacheParameters(int32_t *trampolineSize,
                             OMR::CodeCacheCodeGenCallbacks *callBacks,
                             int32_t *numHelpers,
                             int32_t *CCPreLoadedCodeSize) {
  *trampolineSize = 0;
...
void armCodeCacheParameters(int32_t *trampolineSize, void **callBacks,
                            int32_t *numHelpers, int32_t *CCPreLoadedCodeSize) {
  *trampolineSize = TRAMPOLINE_SIZE;
...
void arm64CodeCacheParameters(int32_t *trampolineSize, void **callBacks,
                              int32_t *numHelpers,
                              int32_t *CCPreLoadedCodeSize) {
  *trampolineSize = TRAMPOLINE_SIZE;
...
void s390zOS31CodeCacheParameters(int32_t *trampolineSize, void **callBacks,
                                  int32_t *numHelpers,
                                  int32_t *CCPreLoadedCodeSize) {
  *trampolineSize = 0;
  callBacks[0] = NULL;
...
void s390zOS64CodeCacheParameters(int32_t *trampolineSize, void **callBacks,
                                  int32_t *numHelpers,
                                  int32_t *CCPreLoadedCodeSize) {
  *trampolineSize = 0;
  callBacks[0] = NULL;
...
void s390zLinux31CodeCacheParameters(int32_t *trampolineSize, void **callBacks,
                                     int32_t *numHelpers,
                                     int32_t *CCPreLoadedCodeSize) {
  *trampolineSize = 0;
  callBacks[0] = NULL;
...
void s390zLinux64CodeCacheConfig(int32_t ccSizeInByte,
                                 int32_t *numTempTrampolines) {
...
void s390zLinux64CodeCacheParameters(int32_t *trampolineSize, void **callBacks,
                                     int32_t *numHelpers,
                                     int32_t *CCPreLoadedCodeSize) {
  *trampolineSize = TRAMPOLINE_SIZE;
...
void setupCodeCacheParameters(int32_t *trampolineSize,
                              OMR::CodeCacheCodeGenCallbacks *callBacks,
                              int32_t *numHelpers,
                              int32_t *CCPreLoadedCodeSize) {
#if defined(TR_TARGET_POWER)
  if (TR::Compiler->target.cpu.isPower()) {
    ppcCodeCacheParameters(trampolineSize, (void **)callBacks, numHelpers,
                           CCPreLoadedCodeSize);
    return;
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isI386()) {
    ia32CodeCacheParameters(trampolineSize, callBacks, numHelpers,
                            CCPreLoadedCodeSize);
    return;
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isAMD64()) {
    amd64CodeCacheParameters(trampolineSize, callBacks, numHelpers,
                             CCPreLoadedCodeSize);
    return;
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isARM()) {
    armCodeCacheParameters(trampolineSize, (void **)callBacks, numHelpers,
                           CCPreLoadedCodeSize);
    return;
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isARM64()) {
    arm64CodeCacheParameters(trampolineSize, (void **)callBacks, numHelpers,
                             CCPreLoadedCodeSize);
    return;
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isZ()) {
    s390zOS31CodeCacheParameters(trampolineSize, (void **)callBacks, numHelpers,
                                 CCPreLoadedCodeSize);
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isZ()) {
    s390zOS64CodeCacheParameters(trampolineSize, (void **)callBacks, numHelpers,
                                 CCPreLoadedCodeSize);
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isZ()) {
    s390zLinux31CodeCacheParameters(trampolineSize, (void **)callBacks,
                                    numHelpers, CCPreLoadedCodeSize);
  }
#endif
  ...
  if (TR::Compiler->target.cpu.isZ()) {
    s390zLinux64CodeCacheParameters(trampolineSize, (void **)callBacks,
                                    numHelpers, CCPreLoadedCodeSize);
  }
#endif
}
...
void TR::createCCPreLoadedCode(uint8_t *CCPreLoadedCodeBase,
                               uint8_t *CCPreLoadedCodeTop,
