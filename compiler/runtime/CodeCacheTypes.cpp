...
CodeCacheHashEntrySlab::allocate(TR::CodeCacheManager *manager,
                                 size_t slabSize) {
...
//
CodeCacheHashKey
CodeCacheHashTable::hashUnresolvedMethod(void *constPool,
...
//
CodeCacheHashEntry *
CodeCacheHashTable::findUnresolvedMethod(void *constPool,
                                         int32_t constPoolIndex) {
