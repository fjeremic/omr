...
public:
  ...
  void* operator new(size_t s, TR::CodeCache* cache)
  {
    return cache;
  }
  ...
  uint8_t* getCodeBase();
  uint8_t* getCodeTop();
  uint8_t* getHelperBase()
  {
    return _helperBase;
  }
  uint8_t* getHelperTop()
  {
    return _helperTop;
  }

  void setWarmCodeAlloc(uint8_t* wca)
  {
    _warmCodeAlloc = wca;
  }
  void setColdCodeAlloc(uint8_t* cca)
  {
    _coldCodeAlloc = cca;
  }

  uint8_t* getWarmCodeAlloc()
  {
    return _warmCodeAlloc;
  }
  uint8_t* getColdCodeAlloc()
  {
    return _coldCodeAlloc;
  }
  ...
  TR_YesNoMaybe almostFull()
  {
    return _almostFull;
  }
  void setAlmostFull(TR_YesNoMaybe fullness)
  {
    _almostFull = fullness;
  }
  ...
  int32_t getReservingCompThreadID() const
  {
    return _reservingCompThreadID;
  }
  void setReservingCompThreadID(int32_t n)
  {
    _reservingCompThreadID = n;
  }
  ...
  uint32_t tempTrampolinesMax()
  {
    return _tempTrampolinesMax;
  }
  ...
  bool isCCPreLoadedCodeInitialized()
  {
    return _CCPreLoadedCodeInitialized;
  }
...
public:
  bool addFreeBlock2WithCallSite(uint8_t* start, uint8_t* end, char* file, uint32_t lineNumber);
   ...
   */
  void setManager(TR::CodeCacheManager* m)
  {
    _manager = m;
  }
   ...
   */
  void setHashEntrySlab(CodeCacheHashEntrySlab* hes)
  {
    _hashEntrySlab = hes;
  }
   ...
   */
  CodeCacheHashEntry* hashEntryFreeList()
  {
    return _hashEntryFreeList;
  }
   ...
   */
  void setHashEntryFreeList(CodeCacheHashEntry* fl)
  {
    _hashEntryFreeList = fl;
  }
   ...
   */
  CodeCacheFreeCacheBlock* freeBlockList()
  {
   ...
   */
  void setFreeBlockList(CodeCacheFreeCacheBlock* fcb)
  {
    _freeBlockList = fcb;
  }
   ...
   */
  uint8_t* tempTrampolineBase()
  {
    return _tempTrampolineBase;
  }
   ...
   */
  uint8_t* tempTrampolineTop()
  {
    return _tempTrampolineTop;
  }
   ...
   */
  void setTempTrampolineTop(uint8_t* address)
  {
    _tempTrampolineTop = address;
  }
   ...
   */
  uint8_t* tempTrampolineNext()
  {
    return _tempTrampolineNext;
  }
   ...
   */
  uint8_t* trampolineAllocationMark()
  {
    return _trampolineAllocationMark;
  }
   ...
   */
  uint8_t* trampolineReservationMark()
  {
    return _trampolineReservationMark;
  }
   ...
   */
  uint8_t* trampolineBase()
  {
    return _trampolineBase;
  }
   ...
   */
  void setTrampolineBase(uint8_t* address)
  {
    _trampolineBase = address;
  }
