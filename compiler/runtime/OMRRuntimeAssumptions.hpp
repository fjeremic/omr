...
protected:
   ...
   */
  RuntimeAssumption* getNextEvenIfDead()
  {
    return _next;
  }
   ...
   * and must be run under the assumptionTableMutex
   */
  void setNext(RuntimeAssumption* next)
  {
    _next = next;
  }
...
public:
  ...
  {
    return ((uintptrj_t)getFirstAssumingPC()) <= end && start <= ((uintptrj_t)getLastAssumingPC());
  }

  virtual uintptrj_t getKey()
  {
    return _key;
  }
  ...
  virtual bool matches(uintptrj_t key)
  {
    return _key == key;
  }
  ...
  virtual TR::PatchNOPedGuardSite* asPNGSite()
  {
    return 0;
  }
  virtual TR::PatchMultipleNOPedGuardSites* asPMNGSite()
  {
    return 0;
  }
  ...
  virtual TR_UnloadedClassPicSite* asUCPSite()
  {
    return 0;
  }
  ...
  virtual TR_PatchJNICallSite* asPJNICSite()
  {
    return 0;
  }
  ...
  bool isAssumingRange(uintptrj_t rangeStartPC, uintptrj_t rangeEndPC, uintptrj_t rangeColdStartPC,
    uintptrj_t rangeColdEndPC, uintptrj_t rangeStartMD, uintptrj_t rangeEndMD);
...
public:
  ...
  virtual bool equals(RuntimeAssumption& other)
  {
    return false;
  }
...
protected:
  PatchNOPedGuardSite(
    TR_PersistentMemory* pm, uintptrj_t key, TR_RuntimeAssumptionKind kind, uint8_t* location, uint8_t* destination)
...
public:
  ...
  virtual PatchNOPedGuardSite* asPNGSite()
  {
    return this;
  }
  virtual uint8_t* getFirstAssumingPC()
...
public:
  ...
  uint8_t* getFirstLocation()
  {
    return _firstLocation;
  }
  uint8_t* getLastLocation()
  {
...
protected:
  PatchMultipleNOPedGuardSites(
    TR_PersistentMemory* pm, uintptrj_t key, TR_RuntimeAssumptionKind kind, PatchSites* sites)
    : OMR::LocationRedirectRuntimeAssumption(pm, key)
    , _patchSites(sites)
  {}
...
public:
  ...
  virtual PatchMultipleNOPedGuardSites* asPMNGSite()
  {
    return this;
  }
  ...
  virtual PatchSites* getPatchSites()
  {
    return _patchSites;
  }
  virtual void dumpInfo();
