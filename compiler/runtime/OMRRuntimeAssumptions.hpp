...
private:
  ...
  RuntimeAssumption *
      _nextAssumptionForSameJittedBody; // links assumptions that pertain to the
                                        // same method body These should form a
                                        // circular linked list with a sentinel
                                        // Lower bit is used to mark assumptions
                                        // that will be lazily removed
protected:
