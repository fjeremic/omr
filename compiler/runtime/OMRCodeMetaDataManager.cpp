...
CodeMetaDataManager::allocateMetaDataAVL()
{
  ...
  metaDataAVLTree->insertionComparator =
    (intptr_t(*)(J9AVLTree*, J9AVLTreeNode*, J9AVLTreeNode*))
      OMR::avl_jit_metadata_insertionCompare;
  metaDataAVLTree->searchComparator = (intptr_t(*)(
    J9AVLTree*, uintptr_t, J9AVLTreeNode*))OMR::avl_jit_metadata_searchCompare;
...
// protected
bool
CodeMetaDataManager::insertRange(TR::MethodMetaDataPOD* metaData,
                                 uintptr_t startPC,
                                 uintptr_t endPC)
{
...
// protected
bool
CodeMetaDataManager::removeRange(const TR::MethodMetaDataPOD* metaData,
                                 uintptr_t startPC,
                                 uintptr_t endPC)
{
  bool removeSuccess = false;
  ...
  uintptr_t endPC)
{
  ...
  index = (TR::MethodMetaDataPOD**)DETERMINE_BUCKET(
    startPC, table->start, table->buckets);
  endIndex = (TR::MethodMetaDataPOD**)DETERMINE_BUCKET(
    endPC, table->start, table->buckets);
