...
typedef struct CodeCacheRelocationInfo {
  ...
  uint32_t
    _symbol; /**< index of the symbol to be relocated in the linked list of CodeCacheSymbol, with head symbol being 0 */
...
public:
  ...
  TR::CodeCache* getFirstCodeCache()
  {
    return _codeCacheList._head;
  }
  int32_t getCurrentNumberOfCodeCaches()
  {
    return _curNumberOfCodeCaches;
  }
  TR::Monitor* cacheListMutex() const
  {
    return _codeCacheList._mutex;
  }
  ...
  bool usingRepository()
  {
    return _codeCacheRepositorySegment != NULL;
  }
...
protected:
  ...
  TR::CodeCacheSymbolContainer*
    _relocatableSymbolContainer; /**< Symbol container used for tracking CodeCacheSymbols, for the purpose of writing to
