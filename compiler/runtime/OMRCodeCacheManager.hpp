...
class OMR_EXTENSIBLE CodeCacheManager {
 ...
 public:
  ...
  TR::CodeCache *allocateCodeCacheObject(
  ...
  TR::CodeCacheMemorySegment *allocateCodeCacheRepository(
      size_t repositorySize);
  TR::CodeCacheMemorySegment *carveCodeCacheSpaceFromRepository(
