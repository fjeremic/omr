...
public:
  ...
  virtual Index
  getIndex(uintptrj_t objectPointer); // Must hold vm access for this
  Index
  getIndex(uintptrj_t objectPointer,
           bool isArrayWithConstantElements); // Must hold vm access for this
