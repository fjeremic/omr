...
class OMR_EXTENSIBLE ClassEnv {
 public:
  ...
  bool sameClassLoaders(TR::Compilation* comp,
                        TR_OpaqueClassBlock*,
                        TR_OpaqueClassBlock*) {
    return false;
  }
  ...
  bool jitStaticsAreSame(TR::Compilation* comp,
  ...
  bool jitFieldsAreSame(TR::Compilation* comp,
                        TR_ResolvedMethod* method1,
                        int32_t cpIndex1,
                        TR_ResolvedMethod* method2,
                        int32_t cpIndex2,
  ...
  uint16_t getStringCharacter(TR::Compilation* comp,
                              uintptrj_t objectPointer,
                              int32_t index) {
    return 0;
  }
  bool getStringFieldByName(TR::Compilation*,
                            TR::SymbolReference* stringRef,
                            TR::SymbolReference* fieldRef,
                            void*& pResult) {
    return false;
  }

  int32_t vTableSlot(TR::Compilation* comp,
  ...
  char* classNameChars(TR::Compilation*,
  ...
  char* classSignature(TR::Compilation* comp,
                       TR_OpaqueClassBlock* clazz,
                       TR_Memory*) {
    return NULL;
  }
   ...
   */
  intptrj_t getVFTEntry(TR::Compilation* comp,
                        TR_OpaqueClassBlock* clazz,
                        int32_t offset);
