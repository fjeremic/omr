...
TR_ResolvedMethod*
TR_FrontEnd::createResolvedMethod(TR_Memory*,
...
uintptrj_t
TR_FrontEnd::getObjectHeaderSizeInBytes()
{
  TR_UNIMPLEMENTED();
  return 0;
}
uintptrj_t
TR_FrontEnd::getOffsetOfContiguousArraySizeField()
{
  TR_UNIMPLEMENTED();
  return 0;
}
uintptrj_t
TR_FrontEnd::getOffsetOfDiscontiguousArraySizeField()
{
  TR_UNIMPLEMENTED();
  return 0;
}
...
uintptrj_t
TR_FrontEnd::getOffsetOfIndexableSizeField()
{
  TR_UNIMPLEMENTED();
  return 0;
}
...
char*
TR_FrontEnd::getFormattedName(char* buf,
                              int32_t bufLength,
                              char* name,
                              char* format,
                              bool suffix)
...
TR_OpaqueMethodBlock*
TR_FrontEnd::getMethodFromName(char* className,
                               char* methodName,
                               char* signature)
{
  TR_UNIMPLEMENTED();
...
TR_OpaqueClassBlock*
TR_FrontEnd::getArrayClassFromComponentClass(
...
TR_OpaqueClassBlock*
TR_FrontEnd::getLeafComponentClassFromArrayClass(
...
TR_OpaqueClassBlock*
TR_FrontEnd::getClassFromSignature(const char* sig,
                                   int32_t length,
...
TR_YesNoMaybe
TR_FrontEnd::isInstanceOf(TR_OpaqueClassBlock* instanceClass,
...
bool
TR_FrontEnd::isUnloadAssumptionRequired(TR_OpaqueClassBlock*,
                                        TR_ResolvedMethod*)
{
  TR_UNIMPLEMENTED();
  return true;
...
const char*
TR_FrontEnd::sampleSignature(TR_OpaqueMethodBlock* aMethod,
                             char* bug,
                             int32_t bufLen,
                             TR_Memory* memory)
{
...
char*
TR_FrontEnd::getStringUTF8(uintptrj_t objectPointer,
                           char* buffer,
...
void
TR_FrontEnd::reserveTrampolineIfNecessary(TR::Compilation*,
...
intptrj_t
TR_FrontEnd::methodTrampolineLookup(TR::Compilation* comp,
                                    TR::SymbolReference* symRef,
                                    void* callSite)
{
  TR_UNIMPLEMENTED();
