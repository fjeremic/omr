...
TR_OpaqueMethodBlock* TR_FrontEnd::getMethodFromName(char* className, char* methodName, char* signature)
{
  TR_UNIMPLEMENTED();
  return 0;
}
...
int32_t TR_FrontEnd::getLineNumberForMethodAndByteCodeIndex(TR_OpaqueMethodBlock*, int32_t)
{
  return -1;
}

TR_OpaqueMethodBlock* TR_FrontEnd::getInlinedCallSiteMethod(TR_InlinedCallSite* ics)
{
...
char* TR_FrontEnd::getStringUTF8(uintptrj_t objectPointer, char* buffer, intptrj_t bufferSize)
{
  TR_UNIMPLEMENTED();
  return NULL;
}
...
intptrj_t TR_FrontEnd::methodTrampolineLookup(TR::Compilation* comp, TR::SymbolReference* symRef, void* callSite)
{
  TR_UNIMPLEMENTED();
  return 0;
}
