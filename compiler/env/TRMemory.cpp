...
const char* objectName[] = { "Array", "Instruction", "ListElement", "Node", "BitVector", "Register", "MemoryReference",
  ...
  "Machine", "CFGEdge", "TreeTop", "GCStackMap", "IlGenerator", "RegisterDependencyConditions", "Snippet", "Relocation",
  "VirtualGuard", "RegisterDependencyGroup", "RegisterDependency", "FrontEnd", "VMField", "VMFieldsInfo", "Method",
  "Pair", "HashTab", "HashTable", "HashTabEntry", "DebugCounter", "JSR292", "Memory", "CS2", "UnknownType",

  // Optimizer Types
  "AVLTree", "CFGChecker", "CFGSimplifier", "CatchBlockRemover", "CompactLocals", "CopyPropagation", "DataFlowAnalysis",
  "DominatorVerifier", "Dominators", "DominatorsChk", "EscapeAnalysis", "EstimateCodeSize", "ExpressionsSimplification",
  "GlobalRegisterAllocator", "GlobalRegisterCandidates", "HedgeTree", "Inliner", "InnerPreexistence",
  "IsolatedStoreElimination", "LocalLiveVariablesForGC", "LocalAnalysis", "LocalCSE", "LocalDeadStoreElimination",
  "LocalOpts", "LocalReordering", "LocalLiveRangeReduction", "LoopAliasRefiner", "LoopTransformer",
  "MonitorElimination", "NewInitialization", "Optimization", "OSR", "PartialRedundancy", "RedundantAsycCheckRemoval",
  "RegionAnalysis", "RightNumberOfNames", "Structure", "SwitchAnalyzer", "UseDefInfo", "ValueNumberInfo",
  "ValuePropagation", "VirtualGuardTailSplitter", "InterProceduralAnalyzer", "InductionVariableAnalysis",
  ...
  "ExceptionTableEntryIterator", "ExtendedBlockSuccessorIterator", "ExtraInfoForNew", "GlobalRegister", "GCRegisterMap",
  "GCStackAtlas", "GRABlockInfo", "IdAddrNodes",
  ...
  "IProfiler", "TR_IPBytecodeHashTableEntry", "TR_IPBCDataFourBytes", "TR_IPBCDataAllocation", "TR_IPBCDataEightWords",
  "TR_IPBCDataPointer", "TR_IPBCDataCallGraph", "TR_ICallingContext",

  "TR_IPMethodTable", "TR_IPCCNode", "IPHashedCallSite", "Assumptions", "PatchSites",

  "TR_ZHWProfiler", "TR_PPCHWProfiler", "TR_ZGuardedStorage", "TR_PPCLMGuardedStorage",

  "CatchTable",

  "DecimalPrivatization", "DecimalReduction",

  "TR_PreviousNodeConversion", "TR::RelocationDebugInfo", "TR::AOTClassInfo", "TR_SharedCache",
...
void GlobalSingletonAllocator::createInstance()
{
  TR_ASSERT(::trPersistentMemory != NULL,
    "Attempting to use GlobalAllocator too early. It cannot be used until TR_PersistentMemory has been initialized.");
