...
public:
  ...
  void setProcessorInfo(void* buf)
  {
    _processorInfo = buf;
  }

  void setInterpreterTOC(size_t interpreterTOC)
  {
    _interpreterTOC = interpreterTOC;
  }
  size_t getInterpreterTOC()
  {
    return _interpreterTOC;
  }
  ...
  void setPseudoTOC(void* pseudoTOC)
  {
    _pseudoTOC = pseudoTOC;
  }
