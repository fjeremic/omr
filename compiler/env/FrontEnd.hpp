...
public:
  ...
  getMethodFromName(char *className, char *methodName, char *signature);
  ...
  virtual TR_OpaqueMethodBlock *
  getInlinedCallSiteMethod(TR_InlinedCallSite *ics);
  ...
  getClassClassPointer(TR_OpaqueClassBlock *objectClassPointer);
  virtual TR_OpaqueClassBlock *
  getClassFromMethodBlock(TR_OpaqueMethodBlock *mb);
  virtual int32_t getNewArrayTypeFromClass(TR_OpaqueClassBlock *clazz);

  // VM+Shared
  virtual TR_OpaqueClassBlock *
  getArrayClassFromComponentClass(TR_OpaqueClassBlock *componentClass);
  virtual TR_OpaqueClassBlock *getClassFromNewArrayType(int32_t arrayType);
  virtual TR_OpaqueClassBlock *
  getClassFromSignature(const char *sig, int32_t length,
  ...
  virtual TR_OpaqueClassBlock *
  getComponentClassFromArrayClass(TR_OpaqueClassBlock *arrayClass);
  virtual TR_OpaqueClassBlock *
  getLeafComponentClassFromArrayClass(TR_OpaqueClassBlock *arrayClass);
