...
public:
  ...
  const char* extraAssertMessage(TR::Compilation* comp)
  {
    return "";
  }

  int32_t hexAddressWidthInChars()
  {
    return _hexAddressWidthInChars;
  }

  // Deprecate in favour of 'pointerPrintfMaxLenInChars' ?
  //
  int32_t hexAddressFieldWidthInChars()
  {
    return _hexAddressFieldWidthInChars;
  }

  int32_t codeByteColumnWidth()
  {
    return _codeByteColumnWidth;
  }

  int32_t pointerPrintfMaxLenInChars()
  {
    return _hexAddressFieldWidthInChars;
  }
