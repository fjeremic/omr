...
protected:
  CPU()
      : _processor(TR_NullProcessor), _endianness(TR::endian_unknown),
        _majorArch(TR::arch_unknown), _minorArch(TR::m_arch_none) {}
...
public:
   ...
   *
   *  @return false; this is the default answer unless overridden by an
   * extending class.
   */
