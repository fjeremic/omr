...
typedef struct TR_ByteCodeInfo {
  ...
  bool doNotProfile()
  {
    return this->_doNotProfile;
  }
  void setDoNotProfile(bool b)
  {
    this->_doNotProfile = b;
  }
  bool isSameReceiver()
  {
    return this->_isSameReceiver;
  }
  void setIsSameReceiver(bool b)
  {
    this->_isSameReceiver = b;
  }
  ...
  int32_t getByteCodeIndex() const
  {
    return _byteCodeIndex;
  }

  void setCallerIndex(int16_t i)
  {
    _callerIndex = i;
  }
  int16_t getCallerIndex() const
  {
    return _callerIndex;
  }
