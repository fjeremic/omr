...
public:
  ...
  friend bool operator==(const PersistentAllocator& left,
                         const PersistentAllocator& right)
  {
...
inline void*
operator new(size_t size, OMR::PersistentAllocator& allocator)
{
...
operator new(size_t size,
             OMR::PersistentAllocator& allocator,
             const std::nothrow_t& tag) throw()
{
...
inline void
operator delete(void* ptr, OMR::PersistentAllocator& allocator) throw()
{
