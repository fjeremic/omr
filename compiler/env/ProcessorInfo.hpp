...
enum TR_X86ProcessorFeatures
{
  ...
  TR_X86ProcessorInfoInitialized =
    0x80000000 // FIXME: Using a reserved bit for our purposes.
};

inline uint32_t
getFeatureFlagsMask()
{
  return TR_BuiltInFPU | TR_CMPXCHG8BInstruction | TR_CMOVInstructions |
         TR_MMXInstructions | TR_SSE | TR_SSE2;
}
...
inline uint32_t
getFeatureFlags2Mask()
{
  return TR_SSSE3 | TR_SSE4_1 | TR_POPCNT | TR_AESNI | TR_OSXSAVE | TR_AVX;
}
...
inline uint32_t
getFeatureFlags8Mask()
{
  return TR_HLE | TR_RTM;
}
