...
char*
OMR::ClassEnv::classNameChars(TR::Compilation* comp,
...
uintptrj_t
OMR::ClassEnv::getArrayElementWidthInBytes(TR::Compilation* comp,
...
intptrj_t
OMR::ClassEnv::getVFTEntry(TR::Compilation* comp,
