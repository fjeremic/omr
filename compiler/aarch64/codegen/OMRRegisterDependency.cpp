...
void OMR::ARM64::RegisterDependencyConditions::unionNoRegPostCondition(
...
bool OMR::ARM64::RegisterDependencyConditions::defsRealRegister(
    TR::Register *r) {
  for (uint16_t i = 0; i < _addCursorForPre; i++) {
...
void OMR::ARM64::RegisterDependencyConditions::incRegisterTotalUseCounts(
    TR::CodeGenerator *cg) {
