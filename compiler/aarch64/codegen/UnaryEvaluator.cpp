...
static TR::Register*
commonConstEvaluator(TR::Node* node, int32_t value, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM64::TreeEvaluator::iconstEvaluator(TR::Node* node,
                                           TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM64::TreeEvaluator::sconstEvaluator(TR::Node* node,
                                           TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM64::TreeEvaluator::bconstEvaluator(TR::Node* node,
                                           TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM64::TreeEvaluator::cconstEvaluator(TR::Node* node,
                                           TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM64::TreeEvaluator::aconstEvaluator(TR::Node* node,
                                           TR::CodeGenerator* cg)
{
  TR::Register* tempReg = cg->allocateRegister();
...
TR::Register*
OMR::ARM64::TreeEvaluator::lconstEvaluator(TR::Node* node,
                                           TR::CodeGenerator* cg)
{
  TR::Register* tempReg = cg->allocateRegister();
...
TR::Register*
OMR::ARM64::TreeEvaluator::inegEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM64::TreeEvaluator::lnegEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
...
static TR::Register*
commonIntegerAbsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
  TR::Register* reg = cg->gprClobberEvaluate(firstChild);
  TR::Register* tempReg = cg->allocateRegister();
...
TR::Register*
OMR::ARM64::TreeEvaluator::iabsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return commonIntegerAbsEvaluator(node, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::labsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return commonIntegerAbsEvaluator(node, cg);
}
...
TR::Register*
OMR::ARM64::TreeEvaluator::l2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
static TR::Register*
extendToIntOrLongHelper(TR::Node* node,
...
TR::Register*
OMR::ARM64::TreeEvaluator::b2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::sbfmw, 7, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::s2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::sbfmw, 15, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::b2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::sbfmx, 7, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::s2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::sbfmx, 15, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::i2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::sbfmx, 31, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::bu2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::ubfmw, 7, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::su2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::ubfmw, 15, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::bu2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::ubfmx, 7, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::su2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return extendToIntOrLongHelper(node, TR::InstOpCode::ubfmx, 15, cg);
}

TR::Register*
OMR::ARM64::TreeEvaluator::iu2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
