 ...
 */
TR::Register *genericReturnEvaluator(TR::Node *node,
                                     TR::RealRegister::RegNum rnum,
                                     TR_RegisterKinds rk, TR_ReturnInfo i,
                                     TR::CodeGenerator *cg);
 ...
 * @param[in] cg : CodeGenerator
 */
TR::Register *commonLoadEvaluator(TR::Node *node, TR::InstOpCode::Mnemonic op,
 ...
 * @param[in] cg : CodeGenerator
 */
TR::Register *commonStoreEvaluator(TR::Node *node, TR::InstOpCode::Mnemonic op,
                                   int32_t memSize, TR::CodeGenerator *cg);
...
public:
  ...
  static TR::Register *asynccheckEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  ...
  static TR::Register *ifiucmpeqEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *ifiucmpneEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *ifiucmpltEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *ifiucmpgeEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *ifiucmpgtEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *ifiucmpleEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *iflucmpeqEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *iflucmpneEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *iflucmpltEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *iflucmpgeEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *iflucmpgtEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *iflucmpleEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *ifdcmpequEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *ifdcmpneuEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *ifbucmpeqEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *ifbucmpneEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *ifsucmpeqEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *ifsucmpneEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *iRegStoreEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *aRegStoreEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *dRegStoreEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *sRegStoreEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *bRegStoreEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *MethodEnterHookEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg);
  static TR::Register *MethodExitHookEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  ...
  static TR::Register *vigetelemEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *visetelemEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *vicmpalleqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpallneEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpallgtEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpallgeEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpallltEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpallleEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpanyeqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpanyneEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpanygtEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpanygeEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpanyltEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vicmpanyleEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  ...
  static TR::Register *vdsetelemEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *vdgetelemEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *vdcmpalleqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpallneEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpallgtEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpallgeEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpallltEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpallleEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpanyeqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpanyneEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpanygtEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpanygeEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpanyltEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdcmpanyleEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  ...
  static TR::Register *vbRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *vsRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *viRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *vlRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *vfRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *vdRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *vbRegStoreEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vsRegStoreEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *viRegStoreEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vlRegStoreEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vfRegStoreEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *vdRegStoreEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  ...
  static TR::Register *iuRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *luRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *iuRegStoreEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *luRegStoreEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  ...
  static TR::Register *instanceofEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *checkcastEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *checkcastAndNULLCHKEvaluator(TR::Node *node,
                                                    TR::CodeGenerator *cg);
  ...
  static TR::Register *anewarrayEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *variableNewEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *variableNewArrayEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg);
  static TR::Register *multianewarrayEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *arraylengthEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *contigarraylengthEvaluator(TR::Node *node,
                                                  TR::CodeGenerator *cg);
  static TR::Register *discontigarraylengthEvaluator(TR::Node *node,
                                                     TR::CodeGenerator *cg);
  ...
  static TR::Register *trtLookupEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *exceptionRangeFenceEvaluator(TR::Node *node,
                                                    TR::CodeGenerator *cg);
  ...
  static TR::Register *ResolveCHKEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  ...
  static TR::Register *OverflowCHKEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *UnsignedOverflowCHKEvaluator(TR::Node *node,
                                                    TR::CodeGenerator *cg);
  static TR::Register *BNDCHKEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *ArrayCopyBNDCHKEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg);
  static TR::Register *BNDCHKwithSpineCHKEvaluator(TR::Node *node,
                                                   TR::CodeGenerator *cg);
  static TR::Register *SpineCHKEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *ArrayStoreCHKEvaluator(TR::Node *node,
                                              TR::CodeGenerator *cg);
  ...
  static TR::Register *bitOpMemNDEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *arraycmpEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *arraycmpWithPadEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg);
  static TR::Register *allocationFenceEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg);
  static TR::Register *loadFenceEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *storeFenceEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *fullFenceEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *MergeNewEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *computeCCEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *bztestnsetEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *ibatomicorEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *isatomicorEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *iiatomicorEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *ilatomicorEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  ...
  static TR::Register *trtSimpleEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *ibyteswapEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *bbitpermuteEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *sbitpermuteEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *ibitpermuteEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *lbitpermuteEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *PrefetchEvaluator(TR::Node *node, TR::CodeGenerator *cg);

  static TR::Instruction *
  generateVFTMaskInstruction(TR::CodeGenerator *cg, TR::Node *node,
                             TR::Register *dstReg, TR::Register *srcReg,
                             TR::Instruction *preced = NULL);
  static TR::Instruction *
  generateVFTMaskInstruction(TR::CodeGenerator *cg, TR::Node *node,
                             TR::Register *reg, TR::Instruction *preced = NULL);
};
