...
static const char *ARM64ConditionNames[] = {"eq", "ne", "cs", "cc", "mi", "pl",
                                            "vs", "vc", "hi", "ls", "ge", "lt",
                                            "gt", "le", "al", "nv"};

static const char *ARM64ShiftCodeNames[] = {"lsl", "lsr", "asr", "???"};

static const char *ARM64ExtendCodeNames[] = {"uxtb", "uxth", "uxtw", "uxtx",
                                             "sxtb", "sxth", "sxtw", "sxtx"};

static const char *opCodeToNameMap[] = {
    "bad",         "cbzw",        "cbnzw",       "cbzx",       "cbnzx",
    "tbz",         "tbnz",        "b_cond",      "brkarm64",   "dsb",
    "dmb",         "br",          "blr",         "ret",        "b",
    "bl",          "stxrb",       "stlxrb",      "ldxrb",      "ldaxrb",
    "stlrb",       "ldarb",       "stxrh",       "stlxrh",     "ldxrh",
    "ldaxrh",      "stlrh",       "ldarh",       "stxrw",      "stlxrw",
    "stxpw",       "stlxpw",      "ldxrw",       "ldaxrw",     "ldxpw",
    "ldaxpw",      "stlrw",       "ldarw",       "stxrx",      "stlxrx",
    "stxpx",       "stlxpx",      "ldxrx",       "ldaxrx",     "ldxpx",
    "ldaxpx",      "stlrx",       "ldarx",       "ldrw",       "vldrs",
    "ldrx",        "vldrd",       "ldrsw",       "vldrq",      "prfm",
    "stnpw",       "ldnpw",       "vstnps",      "vldnps",     "vstnpd",
    "vldnpd",      "stnpx",       "ldnpx",       "vstnpq",     "vldnpq",
    "stppostw",    "ldppostw",    "vstpposts",   "vldpposts",  "ldpswpost",
    "vstppostd",   "vldppostd",   "stppostx",    "ldppostx",   "vstppostq",
    "vldppostq",   "stpoffw",     "ldpoffw",     "vstpoffs",   "vldpoffs",
    "ldpswoff",    "vstpoffd",    "vldpoffd",    "stpoffx",    "ldpoffx",
    "vstpoffq",    "vldpoffq",    "stpprew",     "ldpprew",    "vstppres",
    "vldppres",    "ldpswpre",    "vstppred",    "vldppred",   "stpprex",
    "ldpprex",     "vstppreq",    "vldppreq",    "sturb",      "ldurb",
    "ldursbx",     "ldursbw",     "vsturb",      "vldurb",     "vsturq",
    "vldurq",      "sturh",       "ldurh",       "ldurshx",    "ldurshw",
    "vsturh",      "vldurh",      "sturw",       "ldurw",      "ldursw",
    "vsturs",      "vldurs",      "sturx",       "ldurx",      "prfum",
    "vsturd",      "vldurd",      "strbpost",    "ldrbpost",   "ldrsbpostx",
    "ldrsbpostw",  "vstrpostb",   "vldrpostb",   "vstrpostq",  "vldrpostq",
    "strhpost",    "ldrhpost",    "ldrshpostx",  "ldrshpostw", "vstrposth",
    "vldrposth",   "strpostw",    "ldrpostw",    "ldrswpost",  "vstrposts",
    "vldrposts",   "strpostx",    "ldrpostx",    "vstrpostd",  "vldrpostd",
    "sttrb",       "ldtrb",       "ldtrsbx",     "ldtrsbw",    "sttrh",
    "ldtrh",       "ldtrshx",     "ldtrshw",     "sttrw",      "ldtrw",
    "ldtrsw",      "sttrx",       "ldtrx",       "strbpre",    "ldrbpre",
    "ldrsbprex",   "ldrsbprew",   "vstrpreb",    "vldrpreb",   "vstrpreq",
    "vldrpreq",    "strhpre",     "ldrhpre",     "ldrshprex",  "ldrshprew",
    "vstrpreh",    "vldrpreh",    "strprew",     "ldrprew",    "ldrswpre",
    "vstrpres",    "vldrpres",    "strprex",     "ldrprex",    "vstrpred",
    "vldrpred",    "strboff",     "ldrboff",     "ldrsboffx",  "ldrsboffw",
    "vstroffb",    "vldroffb",    "vstroffq",    "vldroffq",   "strhoff",
    "ldrhoff",     "ldrshoffx",   "ldrshoffw",   "vstroffh",   "vldroffh",
    "stroffw",     "ldroffw",     "ldrswoff",    "vstroffs",   "vldroffs",
    "stroffx",     "ldroffx",     "vstroffd",    "vldroffd",   "prfmoff",
    "strbimm",     "ldrbimm",     "ldrsbimmx",   "ldrsbimmw",  "vstrimmb",
    "vldrimmb",    "vstrimmq",    "vldrimmq",    "strhimm",    "ldrhimm",
    "ldrshimmx",   "ldrshimmw",   "vstrimmh",    "vldrimmh",   "strimmw",
    "ldrimmw",     "ldrswimm",    "vstrimms",    "vldrimms",   "strimmx",
    "ldrimmx",     "vstrimmd",    "vldrimmd",    "prfmimm",    "adr",
    "adrp",        "addimmw",     "addsimmw",    "subimmw",    "subsimmw",
    "addimmx",     "addsimmx",    "subimmx",     "subsimmx",   "andimmw",
    "orrimmw",     "eorimmw",     "andsimmw",    "andimmx",    "orrimmx",
    "eorimmx",     "andsimmx",    "movnw",       "movzw",      "movkw",
    "movnx",       "movzx",       "movkx",       "sbfmw",      "bfmw",
    "ubfmw",       "sbfmx",       "bfmx",        "ubfmx",      "extrw",
    "extrx",       "andw",        "bicw",        "orrw",       "ornw",
    "eorw",        "eonw",        "andsw",       "bicsw",      "andx",
    "bicx",        "orrx",        "ornx",        "eorx",       "eonx",
    "andsx",       "bicsx",       "addw",        "addsw",      "subw",
    "subsw",       "addx",        "addsx",       "subx",       "subsx",
    "addextw",     "addsextw",    "subextw",     "subsextw",   "addextx",
    "addsextx",    "subextx",     "subsextx",    "adcw",       "adcsw",
    "sbcw",        "sbcsw",       "adcx",        "adcsx",      "sbcx",
    "sbcsx",       "ccmnw",       "ccmnx",       "ccmpw",      "ccmpx",
    "ccmnimmw",    "ccmnimmx",    "ccmpimmw",    "ccmpimmx",   "cselw",
    "csincw",      "csinvw",      "csnegw",      "cselx",      "csincx",
    "csinvx",      "csnegx",      "maddw",       "maddx",      "smaddl",
    "umaddl",      "msubw",       "msubx",       "smsubl",     "umsubl",
    "smulh",       "umulh",       "crc32x",      "crc32cx",    "crc32b",
    "crc32cb",     "crc32h",      "crc32ch",     "crc32w",     "crc32cw",
    "udivw",       "udivx",       "sdivw",       "sdivx",      "lslvw",
    "lslvx",       "lsrvw",       "lsrvx",       "asrvw",      "asrvx",
    "rorvw",       "rorvx",       "rbitw",       "rbitx",      "clzw",
    "clzx",        "clsw",        "clsx",        "revw",       "revx",
    "rev16w",      "rev16x",      "rev32",       "fmov_stow",  "fmov_wtos",
    "fmov_dtox",   "fmov_xtod",   "fcvt_stod",   "fcvt_dtos",  "fcvtzs_stow",
    "fcvtzs_dtow", "fcvtzs_stox", "fcvtzs_dtox", "scvtf_wtos", "scvtf_wtod",
    "scvtf_xtos",  "scvtf_xtod",  "fmovimms",    "fmovimmd",   "fcmps",
    "fcmps_zero",  "fcmpd",       "fcmpd_zero",  "fmovs",      "fmovd",
    "fabss",       "fabsd",       "fnegs",       "fnegd",      "fadds",
    "faddd",       "fsubs",       "fsubd",       "fmuls",      "fmuld",
    "fdivs",       "fdivd",       "fmaxs",       "fmaxd",      "fmins",
    "fmind",       "nop",         "proc",        "fence",      "return",
    "dd",          "label",       "vgdnop"};
...
void TR_Debug::print(TR::FILE *pOutFile, TR::Instruction *instr) {
  ...
  switch (instr->getKind()) {
    ...
    case OMR::Instruction::IsSynchronization:
      print(
          pOutFile,
          (TR::ARM64ImmInstruction *)instr);  // printing handled by superclass
      break;
...
void TR_Debug::print(TR::FILE *pOutFile, TR::ARM64ImmInstruction *instr) {
  printPrefix(pOutFile, instr);
  trfprintf(pOutFile, "%s \t0x%08x", getOpCodeName(&instr->getOpCode()),
...
void TR_Debug::print(TR::FILE *pOutFile, TR::ARM64ImmSymInstruction *instr) {
  ...
  if (name)
    trfprintf(
        pOutFile, "%s \t" POINTER_PRINTF_FORMAT "\t\t; Direct Call \"%s\"",
        getOpCodeName(&instr->getOpCode()), instr->getAddrImmediate(), name);
  else
    trfprintf(pOutFile, "%s \t" POINTER_PRINTF_FORMAT,
              getOpCodeName(&instr->getOpCode()), instr->getAddrImmediate());
...
void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64VirtualGuardNOPInstruction *instr) {
  printPrefix(pOutFile, instr);
...
void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64ConditionalBranchInstruction *instr) {
  printPrefix(pOutFile, instr);

  TR::LabelSymbol *label = instr->getLabelSymbol();
  TR::Snippet *snippet = label ? label->getSnippet() : NULL;
  TR_ASSERT(instr->getOpCodeValue() == TR::InstOpCode::b_cond,
            "Unsupported instruction for conditional branch");
  trfprintf(pOutFile, "b.%s \t",
            ARM64ConditionNames[instr->getConditionCode()]);
  print(pOutFile, label);
  if (snippet) {
    trfprintf(pOutFile, " (%s)", getName(snippet));
  }
...
void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64CompareBranchInstruction *instr) {
  printPrefix(pOutFile, instr);
...
void TR_Debug::print(TR::FILE *pOutFile, TR::ARM64AdminInstruction *instr) {
  ...
  if (node) {
    if (node->getOpCodeValue() == TR::BBStart) {
      trfprintf(pOutFile, " (BBStart (block_%d))",
...
void TR_Debug::print(TR::FILE *pOutFile, TR::ARM64Trg1CondInstruction *instr) {
  ...
  if (instr->getOpCodeValue() == TR::InstOpCode::csincx) {
    ...
    trfprintf(pOutFile, ", %s",
              ARM64ConditionNames[cc_invert(instr->getConditionCode())]);
  } else {
    trfprintf(pOutFile, "%s \t", getOpCodeName(&instr->getOpCode()));
    print(pOutFile, instr->getTargetRegister(), TR_WordReg);
    trfprintf(pOutFile, ", xzr, xzr, %s",
              ARM64ConditionNames[instr->getConditionCode()]);
  }
  trfflush(_comp->getOutFile());
}
...
void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64Trg1ImmSymInstruction *instr) {
  printPrefix(pOutFile, instr);
  trfprintf(pOutFile, "%s \t", getOpCodeName(&instr->getOpCode()));
  print(pOutFile, instr->getTargetRegister(), TR_WordReg);
...
void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64Trg1Src1ImmInstruction *instr) {
  printPrefix(pOutFile, instr);
  ...
  if (op == TR::InstOpCode::subsimmx || op == TR::InstOpCode::subsimmw) {
    ...
    if (r && r->getRealRegister() &&
      ...
      // cmp alias
      isAlias = true;
      trfprintf(pOutFile, "cmpimm%c \t",
                (op == TR::InstOpCode::subsimmx) ? 'x' : 'w');
      print(pOutFile, instr->getSource1Register(), TR_WordReg);
    ...
    if (op == TR::InstOpCode::sbfmx) {
      if (imms == 63) {
        ...
        isAlias = true;
        trfprintf(pOutFile, "sxt%cx \t",
                  (imms == 7) ? 'b' : ((imms == 15) ? 'h' : 'w'));
        print(pOutFile, instr->getTargetRegister(), TR_WordReg);
        trfprintf(pOutFile, ", ");
        print(pOutFile, instr->getSource1Register(), TR_WordReg);
      }
    } else if ((op == TR::InstOpCode::sbfmw) && ((immr & (1 << 6)) == 0) &&
               ((imms & (1 << 6)) == 0)) {
      if (imms == 31) {
        // asr alias
        isAlias = true;
    ...
    } else if ((op == TR::InstOpCode::ubfmw) && ((immr & (1 << 6)) == 0) &&
               ((imms & (1 << 6)) == 0)) {
      if (imms == 31) {
        // lsr alias
        isAlias = true;
...
void TR_Debug::print(TR::FILE *pOutFile, TR::ARM64Trg1Src2Instruction *instr) {
  ...
  if (op == TR::InstOpCode::subsx || op == TR::InstOpCode::subsw) {
    ...
    if (r && r->getRealRegister() &&
      ...
      // cmp alias
      isCmp = true;
      trfprintf(pOutFile, "cmp%c \t",
                (op == TR::InstOpCode::subsx) ? 'x' : 'w');
    }
  }
  if (!isCmp) {
    trfprintf(pOutFile, "%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64CondTrg1Src2Instruction *instr) {
  printPrefix(pOutFile, instr);
  trfprintf(pOutFile, "%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64Trg1Src2ShiftedInstruction *instr) {
  printPrefix(pOutFile, instr);
  trfprintf(pOutFile, "%s \t", getOpCodeName(&instr->getOpCode()));
  ...
  trfprintf(pOutFile, ", ");
  print(pOutFile, instr->getSource2Register(), TR_WordReg);
  trfprintf(pOutFile, " %s %d", ARM64ShiftCodeNames[instr->getShiftType()],
            instr->getShiftAmount());
  trfflush(_comp->getOutFile());
}

void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64Trg1Src2ExtendedInstruction *instr) {
  printPrefix(pOutFile, instr);
  trfprintf(pOutFile, "%s \t", getOpCodeName(&instr->getOpCode()));
  ...
  trfprintf(pOutFile, ", ");
  print(pOutFile, instr->getSource2Register(), TR_WordReg);
  trfprintf(pOutFile, " %s %d", ARM64ExtendCodeNames[instr->getExtendType()],
            instr->getShiftAmount());
  trfflush(_comp->getOutFile());
}
...
void TR_Debug::print(TR::FILE *pOutFile,
                     TR::ARM64Trg1MemSrc1Instruction *instr) {
  printPrefix(pOutFile, instr);
  trfprintf(pOutFile, "%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::FILE *pOutFile,
  ...
  if (conditions) {
    ...
    for (i = 0; i < conditions->getAddCursorForPost(); i++) {
      print(pOutFile,
            conditions->getPostConditions()->getRegisterDependency(i));
    }
    trfflush(_comp->getOutFile());
  }
}
...
void TR_Debug::printARM64GCRegisterMap(TR::FILE *pOutFile,
...
const char *TR_Debug::getName(TR::RealRegister *reg, TR_RegisterSizes size) {
  return getRegisterName(reg->getRegisterNumber(),
                         (size == TR_DoubleWordReg || size == TR_DoubleReg));
}
...
// This function assumes that if a trampoline is required then it must be to a
// helper function. Use this API only for inquiring about branches to helpers.
bool TR_Debug::isBranchToTrampoline(TR::SymbolReference *symRef,
                                    uint8_t *cursor, int32_t &distance) {
