...
namespace OMR {
typedef OMR::ARM64::RegisterDependencyConditions
...
public:
   ...
   * @param[in] m : memory
   */
  // Use TR_ARM64RegisterDependencyGroup::create to allocate an object of this
  // type
   ...
   * @param[in] m : memory
   */
  static TR_ARM64RegisterDependencyGroup *create(int32_t numDependencies,
                                                 TR_Memory *m) {
...
public:
  ...
  RegisterDependencyConditions(uint16_t numPreConds, uint16_t numPostConds,
      ...
      : _preConditions(TR_ARM64RegisterDependencyGroup::create(numPreConds, m)),
        _postConditions(
            TR_ARM64RegisterDependencyGroup::create(numPostConds, m)),
   ...
   */
  TR_ARM64RegisterDependencyGroup *getPostConditions() {
  ...
  /**
   * @brief Increment totalUseCounts of registers in the
   * RegisterDependencyConditions
   * @param[in] cg : CodeGenerator
   */
