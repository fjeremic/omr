    ...
    if (node->isInternalPointer()) {
        ...
        if (node->getPinningArrayPointer()) {
            ...
            if ((firstChild->getOpCodeValue() == TR::aload) && firstChild->getSymbolReference()->getSymbol()->isAuto() && firstChild->getSymbolReference()->getSymbol()->isPinningArrayPointer()) {
                ...
                pinningArrayPointerSymbol = firstChildSymbol->isInternalPointer() ? firstChildSymbol->castToInternalPointerAutoSymbol()->getPinningArrayPointer() : firstChildSymbol->castToAutoSymbol();
