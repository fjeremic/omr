...
int32_t TR::ARM64LabelInstruction::estimateBinaryLength(
...
int32_t TR::ARM64AdminInstruction::estimateBinaryLength(
    int32_t currentEstimate) {
  setEstimatedBinaryLength(0);
...
int32_t TR::ARM64Trg1MemInstruction::estimateBinaryLength(
    int32_t currentEstimate) {
...
int32_t TR::ARM64MemSrc1Instruction::estimateBinaryLength(
    int32_t currentEstimate) {
  setEstimatedBinaryLength(
      getMemoryReference()->estimateBinaryLength(getOpCodeValue()));
  return (currentEstimate + getEstimatedBinaryLength());
...
int32_t TR::ARM64Trg1MemSrc1Instruction::estimateBinaryLength(
    int32_t currentEstimate) {
  setEstimatedBinaryLength(
      getMemoryReference()->estimateBinaryLength(getOpCodeValue()));
  return currentEstimate + getEstimatedBinaryLength();
