                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  generateTrg1Src1Instruction(
    cg, TR::InstOpCode::fmov_wtos, node, trgReg, tmpReg);
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  generateTrg1Src1Instruction(
    cg, TR::InstOpCode::fmov_xtod, node, trgReg, tmpReg);
  cg->stopUsingRegister(tmpReg);
...
static TR::Register*
commonFpEvaluator(TR::Node* node,
                  TR::InstOpCode::Mnemonic op,
                  bool isDouble,
                  TR::CodeGenerator* cg)
{
...
static TR::Register*
commonFpUnaryEvaluator(TR::Node* node,
                       TR::InstOpCode::Mnemonic op,
                       bool isDouble,
                       TR::CodeGenerator* cg)
{
...
static TR::Register*
singlePrecisionUnaryEvaluator(TR::Node* node,
                              TR::InstOpCode::Mnemonic op,
                              TR::CodeGenerator* cg)
{
...
static TR::Register*
doublePrecisionUnaryEvaluator(TR::Node* node,
                              TR::InstOpCode::Mnemonic op,
                              TR::CodeGenerator* cg)
{
...
static TR::Register*
intFpTypeConversionHelper(TR::Node* node,
                          TR::InstOpCode::Mnemonic op,
                          TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  ...
  if (node->getNumChildren() == 3) {
    ...
    if (!isUnordered) {
      result = generateConditionalBranchInstruction(
        cg, TR::InstOpCode::b_cond, node, dstLabel, cc, deps);
    } else {
      generateConditionalBranchInstruction(
        cg, TR::InstOpCode::b_cond, node, dstLabel, cc);
      result = generateConditionalBranchInstruction(
    ...
    if (isUnordered) {
      result = generateConditionalBranchInstruction(
        cg, TR::InstOpCode::b_cond, node, dstLabel, TR::CC_VS);
    }
  }
