...
static TR::Instruction* iffcmpHelper(
  TR::Node* node, TR::ARM64ConditionCode cc, bool isDouble, bool isUnordered, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
  TR::Node* secondChild = node->getSecondChild();
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::dcmplEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::fmaxEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::fminEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::dcmpequEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::dcmpltuEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::dcmpgeuEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::dcmpgtuEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::dcmpleuEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
...
{
  // TODO:ARM64: Enable TR::TreeEvaluator::dcmpgEvaluator in compiler/aarch64/codegen/TreeEvaluatorTable.hpp when
  // Implemented.
  return OMR::ARM64::TreeEvaluator::unImpOpEvaluator(node, cg);
}
