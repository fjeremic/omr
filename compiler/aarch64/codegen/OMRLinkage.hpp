...
public:
   ...
   * @param[in] argMemReg : register pointing to address for the outgoing
   * argument
  ...
  getOutgoingArgumentMemRef(TR::Register *argMemReg, TR::Register *argReg,
                            TR::InstOpCode::Mnemonic opCode,
  ...
  saveArguments(TR::Instruction *cursor); // may need more parameters
  /**
