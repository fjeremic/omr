...
OMR::ARM64::Instruction::Instruction(TR::CodeGenerator *cg,
                                     TR::InstOpCode::Mnemonic op,
                                     TR::Node *node)
    : OMR::Instruction(cg, op, node), _conditions(NULL) {
...
OMR::ARM64::Instruction::Instruction(TR::CodeGenerator *cg,
                                     ...
                                     TR::InstOpCode::Mnemonic op,
                                     TR::Node *node)
    : OMR::Instruction(cg, precedingInstruction, op, node), _conditions(NULL) {
  self()->setBlockIndex(cg->getCurrentBlockIndex());
}
...
OMR::ARM64::Instruction::Instruction(TR::CodeGenerator *cg,
                                     ...
                                     TR::Node *node)
    : OMR::Instruction(cg, op, node), _conditions(cond) {
  self()->setBlockIndex(cg->getCurrentBlockIndex());
...
OMR::ARM64::Instruction::Instruction(TR::CodeGenerator *cg,
                                     ...
                                     TR::RegisterDependencyConditions *cond,
                                     TR::Node *node)
    : OMR::Instruction(cg, precedingInstruction, op, node), _conditions(cond) {
  self()->setBlockIndex(cg->getCurrentBlockIndex());
  if (cond) cond->incRegisterTotalUseCounts(cg);
}
...
void OMR::ARM64::Instruction::ARM64NeedsGCMap(TR::CodeGenerator *cg,
                                              uint32_t mask) {
  if (cg->comp()->useRegisterMaps()) self()->setNeedsGCMap(mask);
}
...
bool OMR::ARM64::Instruction::refsRegister(TR::Register *reg) {
  TR::RegisterDependencyConditions *cond =
      OMR::ARM64::Instruction::getDependencyConditions();
...
void OMR::ARM64::Instruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
  TR::RegisterDependencyConditions *cond =
      OMR::ARM64::Instruction::getDependencyConditions();
  if (cond) {
    cond->assignPostConditionRegisters(self(), kindToBeAssigned, self()->cg());
    cond->assignPreConditionRegisters(self()->getPrev(), kindToBeAssigned,
                                      self()->cg());
  }
}
