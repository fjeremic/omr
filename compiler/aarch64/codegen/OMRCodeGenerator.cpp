...
OMR::ARM64::CodeGenerator::CodeGenerator()
    : OMR::CodeGenerator(),
      ...
      _outOfLineCodeSectionList(
          getTypedAllocator<TR_ARM64OutOfLineCodeSection *>(
              self()->comp()->allocator())) {
...
void OMR::ARM64::CodeGenerator::beginInstructionSelection() {
  ...
  new (self()->trHeapMemory())
      TR::ARM64AdminInstruction(TR::InstOpCode::proc, startNode, NULL,
                                _returnTypeInfoInstruction, self());
}
...
void OMR::ARM64::CodeGenerator::doRegisterAssignment(
...
TR::Linkage *OMR::ARM64::CodeGenerator::createLinkage(
...
int32_t OMR::ARM64::CodeGenerator::setEstimatedLocationsForDataSnippetLabels(
...
static uint32_t registerBitMask(int32_t reg) { return 1 << (reg - 1); }

void OMR::ARM64::CodeGenerator::buildRegisterMapForInstruction(
    TR_GCStackMap *map) {
...
TR_GlobalRegisterNumber OMR::ARM64::CodeGenerator::pickRegister(
...
bool OMR::ARM64::CodeGenerator::allowGlobalRegisterAcrossBranch(
    TR_RegisterCandidate *regCan, TR::Node *branchNode) {
...
int32_t OMR::ARM64::CodeGenerator::getMaximumNumberOfGPRsAllowedAcrossEdge(
    TR::Node *node) {
  TR_UNIMPLEMENTED();
  return 0;
}

int32_t OMR::ARM64::CodeGenerator::getMaximumNumberOfFPRsAllowedAcrossEdge(
    TR::Node *node) {
  TR_UNIMPLEMENTED();
  return 0;
}
...
bool OMR::ARM64::CodeGenerator::isGlobalRegisterAvailable(
...
void OMR::ARM64::CodeGenerator::apply24BitLabelRelativeRelocation(
...
void OMR::ARM64::CodeGenerator::apply32BitLabelRelativeRelocation(
    int32_t *cursor, TR::LabelSymbol *label) {
...
bool OMR::ARM64::CodeGenerator::directCallRequiresTrampoline(
