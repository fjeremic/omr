...
OMR::ARM64::CodeGenerator::CodeGenerator()
  : OMR::CodeGenerator()
  , _constantData(NULL)
  , _outOfLineCodeSectionList(getTypedAllocator<TR_ARM64OutOfLineCodeSection*>(
      self()->comp()->allocator()))
{
...
OMR::ARM64::CodeGenerator::beginInstructionSelection()
{
  ...
  if (comp->getMethodSymbol()->getLinkageConvention() == TR_Private) {
    _returnTypeInfoInstruction =
      generateImmInstruction(self(), TR::InstOpCode::dd, startNode, 0);
  } else {
    _returnTypeInfoInstruction = NULL;
  }

  new (self()->trHeapMemory()) TR::ARM64AdminInstruction(
    TR::InstOpCode::proc, startNode, NULL, _returnTypeInfoInstruction, self());
}
...
OMR::ARM64::CodeGenerator::doRegisterAssignment(TR_RegisterKinds kindsToAssign)
{
  ...
  while (instructionCursor) {
    ...
    if (instructionCursor->isLabel()) {
      TR::ARM64LabelInstruction* li =
        (TR::ARM64LabelInstruction*)instructionCursor;
...
TR::Linkage*
OMR::ARM64::CodeGenerator::createLinkage(TR_LinkageConventions lc)
{
  TR::Linkage* linkage;
  switch (lc) {
    case TR_System:
    ...
    default:
      TR_ASSERT(
        false, "using system linkage for unrecognized convention %d\n", lc);
      linkage = new (self()->trHeapMemory()) TR::ARM64SystemLinkage(self());
  }
...
void
OMR::ARM64::CodeGenerator::emitDataSnippets()
{
  TR_UNIMPLEMENTED();
  /*
...
bool
OMR::ARM64::CodeGenerator::hasDataSnippets()
{
  return (_constantData == NULL) ? false : true;
}

int32_t
OMR::ARM64::CodeGenerator::setEstimatedLocationsForDataSnippetLabels(
...
#ifdef DEBUG
void
OMR::ARM64::CodeGenerator::dumpDataSnippets(TR::FILE* outFile)
{
  if (outFile == NULL)
    return;
...
TR::Instruction*
OMR::ARM64::CodeGenerator::generateSwitchToInterpreterPrePrologue(
...
TR::Register*
OMR::ARM64::CodeGenerator::gprClobberEvaluate(TR::Node* node)
{
...
void
OMR::ARM64::CodeGenerator::buildRegisterMapForInstruction(TR_GCStackMap* map)
{
...
OMR::ARM64::CodeGenerator::pickRegister(
...
bool
OMR::ARM64::CodeGenerator::allowGlobalRegisterAcrossBranch(
  TR_RegisterCandidate* regCan,
  TR::Node* branchNode)
{
...
int32_t
OMR::ARM64::CodeGenerator::getMaximumNumberOfGPRsAllowedAcrossEdge(
  TR::Node* node)
{
  TR_UNIMPLEMENTED();
  return 0;
...
int32_t
OMR::ARM64::CodeGenerator::getMaximumNumberOfFPRsAllowedAcrossEdge(
  TR::Node* node)
{
  TR_UNIMPLEMENTED();
  return 0;
...
int32_t
OMR::ARM64::CodeGenerator::getMaximumNumbersOfAssignableGPRs()
{
  return TR::RealRegister::LastGPR - TR::RealRegister::FirstGPR + 1;
}

int32_t
OMR::ARM64::CodeGenerator::getMaximumNumbersOfAssignableFPRs()
{
  return TR::RealRegister::LastFPR - TR::RealRegister::FirstFPR + 1;
}

bool
OMR::ARM64::CodeGenerator::isGlobalRegisterAvailable(TR_GlobalRegisterNumber i,
                                                     TR::DataType dt)
{
  return self()
           ->machine()
...
TR_GlobalRegisterNumber
OMR::ARM64::CodeGenerator::getLinkageGlobalRegisterNumber(
...
void
OMR::ARM64::CodeGenerator::apply24BitLabelRelativeRelocation(
  int32_t* cursor,
...
void
OMR::ARM64::CodeGenerator::apply32BitLabelRelativeRelocation(
  int32_t* cursor,
  TR::LabelSymbol* label)
{
...
int64_t
OMR::ARM64::CodeGenerator::getLargestNegConstThatMustBeMaterialized()
{
...
int64_t
OMR::ARM64::CodeGenerator::getSmallestPosConstThatMustBeMaterialized()
{
  TR_ASSERT(0, "Not Implemented on AArch64");
  return 0;
}
...
bool
OMR::ARM64::CodeGenerator::directCallRequiresTrampoline(intptrj_t targetAddress,
                                                        intptrj_t sourceAddress)
{
  return !TR::Compiler->target.cpu
            .isTargetWithinUnconditionalBranchImmediateRange(targetAddress,
                                                             sourceAddress) ||
