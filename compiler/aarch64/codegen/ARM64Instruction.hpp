 ...
 */
inline bool
constantIsImm9(int32_t intValue)
{
 ...
 */
inline bool
constantIsUnsignedImm4(uint64_t intValue)
{
 ...
 */
inline bool
constantIsUnsignedImm12(uint64_t intValue)
{
 ...
 */
inline bool
constantIsUnsignedImm16(uint64_t intValue)
{
 ...
 */
inline bool
constantIsSignedImm28(intptr_t intValue)
{
...
public:
   ...
   */
  ARM64ImmInstruction(TR::InstOpCode::Mnemonic op,
                      TR::Node* node,
                      uint32_t imm,
                      TR::CodeGenerator* cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64LabelInstruction(TR::InstOpCode::Mnemonic op,
                        TR::Node* node,
                        TR::LabelSymbol* sym,
                        TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64ConditionalBranchInstruction(TR::InstOpCode::Mnemonic op,
                                    TR::Node* node,
                                    TR::LabelSymbol* sym,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64CompareBranchInstruction(TR::InstOpCode::Mnemonic op,
                                TR::Node* node,
                                TR::Register* sreg,
                                TR::LabelSymbol* sym,
                                TR::CodeGenerator* cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64RegBranchInstruction(TR::InstOpCode::Mnemonic op,
                            TR::Node* node,
                            TR::Register* treg,
                            TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Instruction(TR::InstOpCode::Mnemonic op,
                       TR::Node* node,
                       TR::Register* treg,
                       TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1CondInstruction(TR::InstOpCode::Mnemonic op,
                           TR::Node* node,
                           TR::Register* treg,
                           TR::ARM64ConditionCode cc,
                           TR::CodeGenerator* cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1ImmInstruction(TR::InstOpCode::Mnemonic op,
                          TR::Node* node,
                          TR::Register* treg,
                          uint32_t imm,
                          TR::CodeGenerator* cg)
  ...
  void insertImmediateField(uint32_t* instruction)
  {
    ...
    if (op == TR::InstOpCode::movzx || op == TR::InstOpCode::movzw ||
      ...
      *instruction |=
        ((_sourceImmediate & 0x1ffffc) << 3) | ((_sourceImmediate & 0x3) << 29);
    } else {
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1ImmSymInstruction(TR::InstOpCode::Mnemonic op,
                             TR::Node* node,
                             TR::Register* treg,
                             uint32_t imm,
                             TR::LabelSymbol* sym,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src1Instruction(TR::InstOpCode::Mnemonic op,
                           TR::Node* node,
                           TR::Register* treg,
                           TR::Register* sreg,
                           TR::CodeGenerator* cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op,
                              TR::Node* node,
                              TR::Register* treg,
                              TR::Register* sreg,
                              uint32_t imm,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Src1Instruction(TR::InstOpCode::Mnemonic op,
                       TR::Node* node,
                       TR::Register* sreg,
                       TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64SynchronizationInstruction(TR::InstOpCode::Mnemonic op,
                                  TR::Node* node,
                                  uint32_t imm,
                                  TR::CodeGenerator* cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64ExceptionInstruction(TR::InstOpCode::Mnemonic op,
                            TR::Node* node,
                            uint32_t imm,
                            TR::CodeGenerator* cg)
    : ARM64ImmInstruction(op, node, imm, cg)
...
public:
  ...
  ARM64VirtualGuardNOPInstruction(TR::Node* node,
                                  ...
                                  TR::Instruction* precedingInstruction,
                                  TR::CodeGenerator* cg)
    : TR::ARM64LabelInstruction(TR::InstOpCode::vgdnop,
                                node,
                                sym,
                                cond,
                                precedingInstruction,
