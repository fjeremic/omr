...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, uint32_t imm, TR::Instruction* precedingInstruction,
    TR::CodeGenerator* cg)
...
public:
   ...
   * @return address immediate
   */
  uintptrj_t setAddrImmediate(uintptrj_t imm)
  {
    return (_addrImmediate = imm);
  }
...
public:
  ...
  ARM64ConditionalBranchInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::LabelSymbol* sym, TR::ARM64ConditionCode cc, TR::CodeGenerator* cg)
   ...
   */
  TR::ARM64ConditionCode getConditionCode()
  {
    return _cc;
  }
  /**
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1CondInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::ARM64ConditionCode cc, TR::CodeGenerator* cg)
...
public:
   ...
   */
  ARM64Trg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* sreg,
    uint32_t imm, TR::RegisterDependencyConditions* cond, TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src2ShiftedInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* s1reg,
   ...
   * @return shift type
   */
  ARM64ShiftCode setShiftType(ARM64ShiftCode st)
  {
    return (_shiftType = st);
  }
   ...
   * @return shift amount
   */
  uint32_t setShiftAmount(uint32_t sa)
  {
    return (_shiftAmount = sa);
  }
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src2ExtendedInstruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::Register* s1reg,
...
public:
  ...
  {
    return getMemoryReference()->getOffset();
  }
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1MemSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mr,
