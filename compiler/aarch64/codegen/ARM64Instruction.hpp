...
public:
  ARM64ImmSymInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                         uintptr_t imm, TR::RegisterDependencyConditions *cond,
                         TR::SymbolReference *sr, TR::Snippet *s,
                         TR::CodeGenerator *cg)
      : TR::Instruction(op, node, cond, cg), _addrImmediate(imm),
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64LabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64ConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                                    TR::LabelSymbol *sym,
  ...
  ARM64ConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
      ...
      : ARM64LabelInstruction(op, node, sym, cond, precedingInstruction, cg),
        _cc(cc), _estimatedBinaryLocation(0) {}
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64CompareBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                                TR::Register *sreg, TR::LabelSymbol *sym,
                                TR::CodeGenerator *cg)
  ...
  ARM64CompareBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
      ...
      : ARM64LabelInstruction(op, node, sym, precedingInstruction, cg),
        _source1Register(sreg), _estimatedBinaryLocation(0) {
    useRegister(sreg);
  }
  ...
  /**
   * @brief Answers whether this instruction references the given virtual
   * register
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64RegBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64AdminInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64AdminInstruction(TR::InstOpCode::Mnemonic op,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                       TR::Register *treg, TR::CodeGenerator *cg)
   ...
   * @return target register
   */
  TR::Register *setTargetRegister(TR::Register *tr) {
    return (_target1Register = tr);
  }
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1CondInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                           TR::Register *treg, TR::ARM64ConditionCode cc,
                           TR::CodeGenerator *cg)
  ...
  void insertZeroRegister(uint32_t *instruction) {
    TR::RealRegister *zeroReg =
        cg()->machine()->getRealRegister(TR::RealRegister::xzr);
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
  ...
  void insertImmediateField(uint32_t *instruction) {
    ...
    if (op == TR::InstOpCode::movzx || op == TR::InstOpCode::movzw ||
      ...
      *instruction |= ((_sourceImmediate & 0x1ffffc) << 3) |
                      ((_sourceImmediate & 0x3) << 29);
    } else {
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1ImmSymInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                             TR::Register *treg, uint32_t imm,
                             TR::LabelSymbol *sym, TR::CodeGenerator *cg)
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                              TR::Register *treg, TR::Register *sreg,
                              uint32_t imm, TR::CodeGenerator *cg)
      : ARM64Trg1Src1Instruction(op, node, treg, sreg, cg),
        _source1Immediate(imm), _Nbit(false) {}
   ...
   */
  ARM64Trg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                              TR::Register *treg, TR::Register *sreg, bool N,
                              uint32_t imm, TR::CodeGenerator *cg)
      : ARM64Trg1Src1Instruction(op, node, treg, sreg, cg),
        _source1Immediate(imm), _Nbit(N) {}
  ...
  ARM64Trg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                              ...
                              TR::Instruction *precedingInstruction,
                              TR::CodeGenerator *cg)
      : ARM64Trg1Src1Instruction(op, node, treg, sreg, precedingInstruction,
                                 cg),
        _source1Immediate(imm), _Nbit(false) {}
  ...
  ARM64Trg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                              ...
                              TR::Instruction *precedingInstruction,
                              TR::CodeGenerator *cg)
      : ARM64Trg1Src1Instruction(op, node, treg, sreg, cond,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
  ...
  ARM64Trg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                           ...
                           TR::Instruction *precedingInstruction,
                           TR::CodeGenerator *cg)
      : ARM64Trg1Src1Instruction(op, node, treg, s1reg, precedingInstruction,
                                 cg),
        _source2Register(s2reg) {
    useRegister(s2reg);
  }
  ...
  ARM64Trg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                           ...
                           TR::Instruction *precedingInstruction,
                           TR::CodeGenerator *cg)
      : ARM64Trg1Src1Instruction(op, node, treg, s1reg, cond,
                                 precedingInstruction, cg),
        _source2Register(s2reg) {
    useRegister(s2reg);
  }
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64CondTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                               TR::Register *treg, TR::Register *s1reg,
                               TR::Register *s2reg, TR::ARM64ConditionCode cc,
                               TR::CodeGenerator *cg)
  ...
  ARM64CondTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                               ...
                               TR::Instruction *precedingInstruction,
                               TR::CodeGenerator *cg)
      : ARM64Trg1Src2Instruction(op, node, treg, s1reg, s2reg,
                                 precedingInstruction, cg),
        _cc(cc) {}
  ...
  ARM64CondTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                               ...
                               TR::Instruction *precedingInstruction,
                               TR::CodeGenerator *cg)
      : ARM64Trg1Src2Instruction(op, node, treg, s1reg, s2reg, cond,
                                 precedingInstruction, cg),
        _cc(cc) {}
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src2ShiftedInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                                  TR::Register *treg, TR::Register *s1reg,
                                  TR::Register *s2reg, ARM64ShiftCode shiftType,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src2ExtendedInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                                   TR::Register *treg, TR::Register *s1reg,
                                   TR::Register *s2reg,
   ...
   * @return extend type
   */
  ARM64ExtendCode setExtendType(ARM64ExtendCode et) {
    return (_extendType = et);
  }
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1Src3Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                           TR::Register *treg, TR::Register *s1reg,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1MemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64MemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64MemSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Trg1MemSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                              TR::Register *treg, TR::MemoryReference *mr,
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Src1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
                       TR::Register *sreg, TR::CodeGenerator *cg)
   ...
   * @return source register
   */
  TR::Register *setSource1Register(TR::Register *tr) {
    return (_source1Register = tr);
  }
...
public:
   ...
   * @param[in] cg : CodeGenerator
   */
  ARM64Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *node,
...
public:
   ...
   */
  virtual void insertImmediateField(uint32_t *instruction) {
    TR_ASSERT_FATAL(constantIsUnsignedImm4(getSourceImmediate()),
                    "Immediate value exceeds 4 bits.");
...
public:
   ...
   */
  virtual void insertImmediateField(uint32_t *instruction) {
    TR_ASSERT_FATAL(constantIsUnsignedImm16(getSourceImmediate()),
                    "Immediate value exceeds 16 bits.");
...
public:
  ARM64VirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site,
                                  TR::RegisterDependencyConditions *cond,
                                  TR::LabelSymbol *sym, TR::CodeGenerator *cg)
  ...
  ARM64VirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site,
                                  ...
                                  TR::Instruction *precedingInstruction,
                                  TR::CodeGenerator *cg)
      : TR::ARM64LabelInstruction(TR::InstOpCode::vgdnop, node, sym, cond,
                                  precedingInstruction, cg),
        _site(site) {}
