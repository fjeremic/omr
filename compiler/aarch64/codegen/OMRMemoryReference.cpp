...
void OMR::ARM64::MemoryReference::populateMemoryReference(TR::Node* subTree, TR::CodeGenerator* cg)
{
    if (subTree->getReferenceCount() > 1 || subTree->getRegister() != NULL) {
        ...
        } else if (subTree->getOpCodeValue() == TR::aconst || subTree->getOpCodeValue() == TR::iconst || subTree->getOpCodeValue() == TR::lconst) {
...
{
    return (op == TR::InstOpCode::ldxrx || op == TR::InstOpCode::ldxrw || op == TR::InstOpCode::stxrx || op == TR::InstOpCode::stxrw);
}
