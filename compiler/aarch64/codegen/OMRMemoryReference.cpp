...
OMR::ARM64::MemoryReference::MemoryReference(TR::Register* br, int32_t disp, TR::CodeGenerator* cg)
  : _baseRegister(br)
  , _baseNode(NULL)
  , _indexRegister(NULL)
  , _indexNode(NULL)
...
OMR::ARM64::MemoryReference::MemoryReference(TR::Node* rootLoadOrStore, uint32_t len, TR::CodeGenerator* cg)
  : _baseRegister(NULL)
  , _baseNode(NULL)
  , _indexRegister(NULL)
  , _indexNode(NULL)
...
void OMR::ARM64::MemoryReference::setSymbol(TR::Symbol* symbol, TR::CodeGenerator* cg)
{
  ...
  if (_baseRegister != NULL && _indexRegister != NULL && (self()->hasDelayedOffset() || self()->getOffset(true) != 0)) {
...
void OMR::ARM64::MemoryReference::consolidateRegisters(
...
{
  return (op == TR::InstOpCode::ldxrx || op == TR::InstOpCode::ldxrw || op == TR::InstOpCode::stxrx
    || op == TR::InstOpCode::stxrw);
}
