    ...
    TR::Register* sreg, int32_t imm, TR::Instruction* preced)
{
    ...
    TR::Instruction* instr = (preced) ? new (cg->trHeapMemory()) TR::ARM64Trg1Src1ImmInstruction(op, node, zeroReg, sreg, imm, cond, preced, cg) : new (cg->trHeapMemory()) TR::ARM64Trg1Src1ImmInstruction(op, node, zeroReg, sreg, imm, cond, cg);
    ...
    TR::Register* s1reg, TR::Register* s2reg, TR::Instruction* preced)
{
    ...
    TR::Instruction* instr = (preced) ? new (cg->trHeapMemory()) TR::ARM64Trg1Src2Instruction(op, node, zeroReg, s1reg, s2reg, cond, preced, cg) : new (cg->trHeapMemory()) TR::ARM64Trg1Src2Instruction(op, node, zeroReg, s1reg, s2reg, cond, cg);
    ...
    TR::Register* treg, TR::Register* sreg, TR::Instruction* preced)
{
    ...
    TR::Instruction* instr = (preced) ? new (cg->trHeapMemory()) TR::ARM64Trg1Src2Instruction(op, node, treg, zeroReg, sreg, cond, preced, cg) : new (cg->trHeapMemory()) TR::ARM64Trg1Src2Instruction(op, node, treg, zeroReg, sreg, cond, cg);
    ...
    TR::Register* treg, TR::Register* s1reg, TR::Register* s2reg, TR::Instruction* preced)
{
    ...
    TR::Instruction* instr = (preced) ? new (cg->trHeapMemory()) TR::ARM64Trg1Src3Instruction(op, node, treg, s1reg, s2reg, zeroReg, cond, preced, cg) : new (cg->trHeapMemory()) TR::ARM64Trg1Src3Instruction(op, node, treg, s1reg, s2reg, zeroReg, cond, cg);
