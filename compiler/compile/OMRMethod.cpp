...
void OMR::Method::setArchetypeSpecimen(bool b) {
  TR_UNIMPLEMENTED();
}

TR_MethodParameterIterator* OMR::Method::getParameterIterator(
    TR::Compilation&,
    TR_ResolvedMethod*) {
  TR_UNIMPLEMENTED();
  return 0;
...
bool OMR::Method::isBigDecimalMethod(TR::Compilation* comp) {
  TR_UNIMPLEMENTED();
  return false;
}
...
bool OMR::Method::isBigDecimalConvertersMethod(TR::Compilation* comp) {
  TR_UNIMPLEMENTED();
  return false;
}
