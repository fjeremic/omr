...
class TR_ResolvedMethod {
 public:
  ...
  virtual TR::DataType parmType(
      uint32_t parmNumber);  // returns the type of the parmNumber'th parameter
                             // (0-based)
  ...
  virtual bool canAlwaysShareSymbolDespiteOwningMethod(
      TR_ResolvedMethod *other) {
    return false;
  }
  ...
  virtual const char *newInstancePrototypeSignature(
      TR_Memory *, TR_AllocationKind = heapAlloc);
  ...
  virtual TR_OpaqueClassBlock *getDeclaringClassFromFieldOrStatic(
  ...
  virtual TR_OpaqueClassBlock *getResolvedInterfaceMethod(
      int32_t cpIndex, uintptrj_t *pITableIndex);
  ...
  virtual TR_ResolvedMethod *getResolvedHandleMethod(TR::Compilation *,
                                                     int32_t cpIndex,
                                                     bool *unresolvedInCP = 0);
  virtual TR_ResolvedMethod *getResolvedHandleMethodWithSignature(
      TR::Compilation *, int32_t cpIndex, char *signature);
  virtual TR_ResolvedMethod *getResolvedVirtualMethod(
      TR::Compilation *, int32_t cpIndex, bool ignoreReResolve = true,
      bool *unresolvedInCP = 0);

  virtual uint32_t getResolvedInterfaceMethodOffset(
  ...
  TR::SymbolReferenceTable *genMethodILForPeeking(
  ...
  virtual TR::SymbolReferenceTable *_genMethodILForPeeking(
      TR::ResolvedMethodSymbol *methodSymbol, TR::Compilation *,
  ...
  virtual TR::ResolvedMethodSymbol *findOrCreateJittedMethodSymbol(
      TR::Compilation *comp);
};
