...
public:
  ...
  virtual TR::DataType parmType(
    uint32_t
      parmNumber); // returns the type of the parmNumber'th parameter (0-based)
  ...
  virtual bool isCold(TR::Compilation*,
                      bool,
  ...
  virtual bool fieldsAreSame(int32_t,
                             TR_ResolvedMethod*,
                             int32_t,
                             bool& sigSame);
  virtual bool staticsAreSame(int32_t,
                              TR_ResolvedMethod*,
                              int32_t,
                              bool& sigSame);
  ...
  virtual bool fieldAttributes(TR::Compilation*,
                               int32_t cpIndex,
  ...
  virtual bool staticAttributes(TR::Compilation*,
                                int32_t cpIndex,
                                void**,
                                TR::DataType* type,
                                bool* volatileP,
  ...
  TR_OpaqueClassBlock* getClassFromFieldOrStatic(TR::Compilation* comp,
                                                 int32_t cpIndex,
                                                 bool returnClassForAOT = false)
  {
    return getClassFromConstantPool(
      comp, classCPIndexOfFieldOrStatic(cpIndex), returnClassForAOT);
  }
  ...
  virtual char* fieldName(int32_t cpIndex,
                          TR_Memory*,
                          TR_AllocationKind kind = heapAlloc);
  virtual char* staticName(int32_t cpIndex,
                           TR_Memory*,
                           TR_AllocationKind kind = heapAlloc);
  ...
  virtual char* staticName(int32_t cpIndex,
                           ...
                           TR_Memory*,
                           TR_AllocationKind kind = heapAlloc);
  virtual char* localName(uint32_t slotNumber,
                          uint32_t bcIndex,
                          int32_t& len,
                          TR_Memory*);
  ...
  virtual int32_t exceptionData(int32_t exceptionNumber,
                                int32_t* startIndex,
                                int32_t* endIndex,
                                int32_t* catchType);
