...
public:
  ...
  static mcount_t valueOf(uint16_t value)
  {
    return mcount_t((uint32_t)value);
  }
  static mcount_t valueOf(uint32_t value)
  {
    return mcount_t((uint32_t)value);
  }
  static mcount_t valueOf(int32_t value)
  {
    return mcount_t((uint32_t)value);
  }

  bool operator>=(mcount_t other) const
  {
...
public:
  ...
  bool isJ9()
  {
    return _typeOfMethod == J9;
  }
  Type methodType()
  {
    return _typeOfMethod;
  }
  ...
  virtual bool isArchetypeSpecimen()
  {
    return false;
  }
  ...
  void setRecognizedMethod(TR::RecognizedMethod rm)
  {
    _recognizedMethod = rm;
  }
