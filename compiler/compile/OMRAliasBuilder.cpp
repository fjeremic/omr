...
void OMR::AliasBuilder::gatherLocalUseInfo(TR::Block* block, TR_BitVector& storeVector, TR_ScratchList<TR_Pair<TR::Block, TR_BitVector>>* seenBlockInfos, vcount_t visitCount, bool isOSRCatch)
{
...
void OMR::AliasBuilder::gatherLocalUseInfo(TR::Node* node, TR_BitVector& storeVector, vcount_t visitCount, bool isOSRCatch)
{
