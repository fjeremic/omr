...
OMR::AliasBuilder::AliasBuilder(TR::SymbolReferenceTable* symRefTab,
    ...
    : _addressShadowSymRefs(sizeHint, c->trMemory(), heapAlloc, growable),
      ...
      _genericIntArrayShadowSymRefs(sizeHint,
                                    c->trMemory(),
                                    heapAlloc,
                                    growable),
      _genericIntNonArrayShadowSymRefs(sizeHint,
                                       c->trMemory(),
                                       heapAlloc,
                                       growable),
      _nonIntPrimitiveShadowSymRefs(sizeHint,
                                    c->trMemory(),
                                    heapAlloc,
                                    growable),
      _addressStaticSymRefs(sizeHint, c->trMemory(), heapAlloc, growable),
      _intStaticSymRefs(sizeHint, c->trMemory(), heapAlloc, growable),
      _nonIntPrimitiveStaticSymRefs(sizeHint,
                                    c->trMemory(),
                                    heapAlloc,
                                    growable),
      ...
      _refinedNonIntPrimitiveArrayShadows(1,
                                          c->trMemory(),
                                          heapAlloc,
                                          growable),
