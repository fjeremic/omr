...
TR::Node*
TR_VirtualGuard::createVftGuard(TR_VirtualGuardKind kind, TR::Compilation* comp, int16_t calleeIndex,
...
TR::Node*
TR_VirtualGuard::createMethodGuard(TR_VirtualGuardKind kind, TR::Compilation* comp, int16_t calleeIndex,
 ...
 */
TR::Node*
TR_VirtualGuard::createBreakpointGuardNode(TR::Compilation* comp, int16_t calleeIndex,
 ...
 */
TR::Node*
TR_VirtualGuard::createBreakpointGuard(TR::Compilation* comp, int16_t calleeIndex,
    TR::Node* callNode, TR::TreeTop* destination, TR::ResolvedMethodSymbol* calleeSymbol)
{
...
TR::Node*
TR_VirtualGuard::createMethodGuardWithReceiver(TR_VirtualGuardKind kind, TR::Compilation* comp, int16_t calleeIndex,
...
TR::Node*
TR_VirtualGuard::createNonoverriddenGuard(TR_VirtualGuardKind kind, TR::Compilation* comp, int16_t calleeIndex,
...
TR_VirtualGuard*
TR_VirtualGuard::createGuardedDevirtualizationGuard(TR_VirtualGuardKind kind, TR::Compilation* comp, TR::Node* callNode)
{
...
TR::Node*
TR_VirtualGuard::createHCRGuard(TR::Compilation* comp, int16_t calleeIndex, TR::Node* node, TR::TreeTop* destination, TR::ResolvedMethodSymbol* symbol, TR_OpaqueClassBlock* thisClass)
{
    TR::SymbolReferenceTable* symRefTab = comp->getSymRefTab();
    TR::SymbolReference* addressSymRef = symRefTab->createKnownStaticDataSymbolRef(0, TR::Int32);
    addressSymRef->setSideEffectInfo();
