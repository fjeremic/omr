...
public:
  ...
  Compilation(int32_t compThreadId,
  ...
  bool incInlineDepth(TR::ResolvedMethodSymbol*,
                      TR_ByteCodeInfo&,
                      int32_t cpIndex,
                      TR::SymbolReference* callSymRef,
                      bool directCall,
                      TR_PrexArgInfo* argInfo = 0);
  bool incInlineDepth(TR_OpaqueMethodBlock*,
  ...
  void getOSRCallSiteRemat(uint32_t callSiteIndex,
                           uint32_t slot,
  ...
  void dumpMethodTrees(char* title1,
                       const char* title2,
  ...
  TR::Node* createDummyOrSideEffectGuard(TR::Compilation*,
                                         int16_t,
                                         TR::Node*,
                                         TR::TreeTop*);
  TR::Node* createSideEffectGuard(TR::Compilation*, TR::Node*, TR::TreeTop*);
  TR::Node* createAOTInliningGuard(TR::Compilation*,
                                   int16_t,
                                   TR::Node*,
                                   TR::TreeTop*,
                                   TR_VirtualGuardKind);
  TR::Node* createAOTGuard(TR::Compilation*,
                           int16_t,
                           TR::Node*,
                           TR::TreeTop*,
                           TR_VirtualGuardKind);
  TR::Node* createDummyGuard(TR::Compilation*,
                             int16_t,
                             TR::Node*,
                             TR::TreeTop*);
  ...
  int32_t convertNonDeterministicInput(int32_t i,
                                       int32_t max,
...
private:
  ...
  typedef std::map<TR_OpaqueClassBlock*,
                   const TR::TypeLayout*,
                   LayoutComparator,
                   LayoutAllocator>
    TypeLayoutMap;
