...
public:
  ...
  TR_BitVector& addressShadowSymRefs()
  {
    return _addressShadowSymRefs;
  }
  TR_BitVector& intShadowSymRefs()
  {
    return _intShadowSymRefs;
  }
  TR_BitVector& genericIntShadowSymRefs()
  {
    return _genericIntShadowSymRefs;
  }
  TR_BitVector& genericIntArrayShadowSymRefs()
  {
    return _genericIntArrayShadowSymRefs;
  }
  TR_BitVector& genericIntNonArrayShadowSymRefs()
  {
    return _genericIntNonArrayShadowSymRefs;
  }
  TR_BitVector& nonIntPrimitiveShadowSymRefs()
  {
    return _nonIntPrimitiveShadowSymRefs;
  }
  TR_BitVector& addressStaticSymRefs()
  {
    return _addressStaticSymRefs;
  }
  TR_BitVector& intStaticSymRefs()
  {
    return _intStaticSymRefs;
  }
  TR_BitVector& nonIntPrimitiveStaticSymRefs()
  {
    return _nonIntPrimitiveStaticSymRefs;
  }
  TR_BitVector& methodSymRefs()
  {
    return _methodSymRefs;
  }
  TR_BitVector& arrayElementSymRefs()
  {
    return _arrayElementSymRefs;
  }
  TR_BitVector& immutableArrayElementSymRefs()
  {
    return _immutableArrayElementSymRefs;
  }

  TR::SymbolReference* getSymRefForAliasing(TR::Node* node, TR::Node* addrChild);

  TR_BitVector& arrayletElementSymRefs()
  {
    return _arrayletElementSymRefs;
  }
  TR_BitVector& unsafeSymRefNumbers()
  {
    return _unsafeSymRefNumbers;
  }
  TR_BitVector& unsafeArrayElementSymRefs()
  {
    return _unsafeArrayElementSymRefs;
  }

  TR_BitVector& gcSafePointSymRefNumbers()
  {
    return _gcSafePointSymRefNumbers;
  }
  TR_BitVector& cpConstantSymRefs()
  {
    return _cpConstantSymRefs;
  }
  TR_BitVector& cpSymRefs()
  {
    return _cpSymRefs;
  }

  TR_BitVector& catchLocalUseSymRefs()
  {
    return _catchLocalUseSymRefs;
  }

  TR_BitVector& defaultMethodDefAliases()
  {
    return _defaultMethodDefAliases;
  }
  TR_BitVector& defaultMethodUseAliases()
  {
    return _defaultMethodUseAliases;
  }
  TR_BitVector& methodsThatMayThrow()
  {
    return _methodsThatMayThrow;
  }
  TR_BitVector& defaultMethodDefAliasesWithoutImmutable()
  {
    return _defaultMethodDefAliasesWithoutImmutable;
  }
  TR_BitVector& defaultMethodDefAliasesWithoutUserField()
  {
    return _defaultMethodDefAliasesWithoutUserField;
  }

  // used in support of LoopAliasRefiner
  TR_BitVector& refinedNonIntPrimitiveArrayShadows()
  {
    return _refinedNonIntPrimitiveArrayShadows;
  }
  TR_BitVector& refinedAddressArrayShadows()
  {
    return _refinedAddressArrayShadows;
  }
  TR_BitVector& refinedIntArrayShadows()
  {
    return _refinedIntArrayShadows;
  }

  bool litPoolGenericIntShadowHasBeenCreated()
  {
    return _litPoolGenericIntShadowHasBeenCreated;
  }
  void setLitPoolGenericIntShadowHasBeenCreated()
  {
    _litPoolGenericIntShadowHasBeenCreated = true;
  }
  ...
  TR_BitVector& notOsrCatchLocalUseSymRefs()
  {
    return _notOsrCatchLocalUseSymRefs;
  }
  ...
  void setConservativeGenericIntShadowAliasing(bool b)
  {
    _conservativeGenericIntShadowAliasingRequired = b;
  }
  bool mutableGenericIntShadowHasBeenCreated()
  {
    return _mutableGenericIntShadowHasBeenCreated;
  }
  void setMutableGenericIntShadowHasBeenCreated(bool b)
  {
    _mutableGenericIntShadowHasBeenCreated = b;
  }
