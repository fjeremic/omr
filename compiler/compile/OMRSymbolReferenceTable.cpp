...
TR::SymbolReference*
OMR::SymbolReferenceTable::findThisRangeExtensionSymRef(
  TR::ResolvedMethodSymbol* owningMethodSymbol)
{
  return element(thisRangeExtensionSymbol);
}
...
OMR::SymbolReferenceTable::findOrCreateOSRReturnAddressSymbolRef()
{
  if (!element(osrReturnAddressSymbol)) {
    ...
    element(osrReturnAddressSymbol)
      ->setOffset(TR::Compiler->vm.thisThreadGetOSRReturnAddressOffset(comp()));
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateInduceOSRSymbolRef(
  TR_RuntimeHelper induceOSRHelper)
{
  TR_ASSERT(
    induceOSRHelper == TR_induceOSRAtCurrentPC ||
  ...
  TR::SymbolReference* induceOSRSymRef =
    findOrCreateRuntimeHelper(induceOSRHelper,
                              true /* canGCandReturn */,
                              true /* canGCandExcept */,
...
bool
OMR::SymbolReferenceTable::isImmutableArrayShadow(TR::SymbolReference* symRef)
{
  ...
  TR::DataType elementType)
{
  ...
  aliasBuilder.arrayElementSymRefs().set(
    index); // this ensures the newly created shadow can still be aliased to all
            // other array shadows
...
bool
OMR::SymbolReferenceTable::isRefinedArrayShadow(TR::SymbolReference* symRef)
{
  int32_t index = symRef->getReferenceNumber();
  ...
  TR::SymbolReference* original)
{
  ...
  if (trace) {
    traceMsg(
      comp(), "Created new array shadow %d\nRefinedAddress shadows:", index);
...
OMR::SymbolReferenceTable::findOrCreatelong2StringSymbol()
{
  if (!element(long2StringSymbol)) {
    ...
    element(long2StringSymbol) =
      new (trHeapMemory()) TR::SymbolReference(self(), long2StringSymbol, sym);
  }
...
TR::SymbolReference*
OMR::SymbolReferenceTable::createKnownStaticDataSymbolRef(
  void* dataAddress,
  TR::DataType type,
...
TR::SymbolReference*
OMR::SymbolReferenceTable::createIsOverriddenSymbolRef(
  TR::ResolvedMethodSymbol* calleeSymbol)
{
  mcount_t index = calleeSymbol->getResolvedMethodIndex();
  TR::SymbolReference* symRef;
  ...
  aliasBuilder.addressStaticSymRefs().set(
    symRef->getReferenceNumber()); // add the symRef to the statics list to get
                                   // correct aliasing info
                                                     ...
                                                     bool preservesAllRegisters)
{
  ...
  if (!symRef)
    symRef = createRuntimeHelper(
      index, canGCandReturn, canGCandExcept, preservesAllRegisters);
  return symRef;
}
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateNewObjectSymbolRef(
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateNewArraySymbolRef(
  TR::ResolvedMethodSymbol*)
{
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateInstanceOfSymbolRef(
  TR::ResolvedMethodSymbol*)
{
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateCheckCastSymbolRef(
  TR::ResolvedMethodSymbol*)
{
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateAThrowSymbolRef(
  TR::ResolvedMethodSymbol*)
{
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateNullCheckSymbolRef(
  TR::ResolvedMethodSymbol*)
{
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateDivCheckSymbolRef(
  TR::ResolvedMethodSymbol*)
{
...
TR::SymbolReference*
OMR::SymbolReferenceTable::methodSymRefFromName(
  TR::ResolvedMethodSymbol* owningMethodSymbol,
  char* className,
  char* methodName,
  ...
  int32_t cpIndex)
{
  ...
  if (_methodsBySignature.Locate(key, hashIndex) && !ignoreMBSCache) {
    ...
    if (comp()->getOption(TR_TraceMethodIndex))
      traceMsg(comp(),
               "-- MBS cache miss (1) owning method #%d, signature %s\n",
               owningMethodSymbol->getResolvedMethodIndex().value(),
               fullSignature);
  }
  ...
  if (!method && comp()->compileRelocatableCode())
    comp()->failCompilation<TR::CompilationException>(
      "Failed to get method %s.%s%s from name",
      className,
      methodName,
      methodSignature);

  TR_ASSERT_FATAL(method,
                  "methodSymRefFromName: method must exist: %s.%s%s",
                  className,
                  methodName,
                  methodSignature);
  TR_ASSERT(
    kind != TR::MethodSymbol::Virtual,
    "methodSymRefFromName doesn't support virtual methods"); // Until we're able
                                                             // to look up
                                                             // vtable index
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findTempSymRefWithKnownObject(
  TR::KnownObjectTable::Index knownObjectIndex)
{
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findSymRefWithKnownObject(
  TR::Symbol* symbol,
  TR::KnownObjectTable::Index knownObjectIndex)
{
  ...
  TR::KnownObjectTable::Index knownObjectIndex)
{
  ...
  TR_BitVector* bucket = _knownObjectSymrefsByObjectIndex[knownObjectIndex];
  if (!bucket) {
    bucket = new (trHeapMemory()) TR_BitVector(baseArray.size(),
                                               trMemory(),
                                               heapAlloc,
                                               growable,
...
TR::SymbolReference*
OMR::SymbolReferenceTable::createTempSymRefWithKnownObject(
  TR::Symbol* symbol,
  ...
  TR::KnownObjectTable::Index knownObjectIndex)
{
  ...
  TR::SymbolReference* symRef =
    new (trHeapMemory()) TR::SymbolReference(self(),
                                             symbol,
                                             owningMethodIndex,
                                             slot,
                                             0 /*unresolvedIndex*/,
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateAsyncCheckSymbolRef(
  TR::ResolvedMethodSymbol*)
{
...
bool
OMR::SymbolReferenceTable::shouldMarkBlockAsCold(
...
void
OMR::SymbolReferenceTable::markBlockAsCold()
{
  ...
  bool allocateUseDefBitVector)
{
  TR::SymbolReference* symRef = new (trHeapMemory())
    TR::SymbolReference(self(),
                        findOrCreateGenericIntShadowSymbol(),
...
OMR::SymbolReferenceTable::findOrCreateConstantAreaSymbol()
{
  if (!_constantAreaSymbol) {
    ...
    _constantAreaSymbol = TR::StaticSymbol::createNamed(
      comp()->trHeapMemory(), TR::NoType, symName);
  }
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findStaticSymbol(TR_ResolvedMethod* owningMethod,
                                            int32_t cpIndex,
                                            TR::DataType type)
{
  TR::SymbolReference* symRef;
  ...
  while ((symRef = i.getNext())) {
    if (symRef->getSymbol()->getDataType() == type &&
        symRef->getCPIndex() != -1 &&
        TR::Compiler->cls.jitStaticsAreSame(comp(),
                                            owningMethod,
                                            cpIndex,
...
{
  return findOrCreateMethodSymbol(owningMethodIndex,
                                  cpIndex,
                                  resolvedMethod,
  ...
  bool isUnresolvedInCP)
{
    ...
    for (symRef = i.getNext(); symRef; symRef = i.getNext()) {
      ...
      if (existingMethod && (existingMethod->getMethodKind() == callKind) &&
        ...
        if (performTransformation(
              comp(),
              "O^O SYMBOL SHARING: Reusing #%d M%p for M%p\n",
              symRef->getReferenceNumber(),
              existingMethod->getResolvedMethod(),
              resolvedMethod)) {
          TR_ResolvedMethod* owningMethod =
  ...
  if (resolvedMethod) {
    TR::ResolvedMethodSymbol* resSym =
      TR::ResolvedMethodSymbol::create(trHeapMemory(), resolvedMethod, comp());
    sym = resSym;
#ifdef J9_PROJECT_SPECIFIC
    canGCandReturn =
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateAutoSymbol(
  TR::ResolvedMethodSymbol* owningMethodSymbol,
  int32_t slot,
  TR::DataType type,
  bool isReference,
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateAutoSymbolImpl(
  TR::ResolvedMethodSymbol* owningMethodSymbol,
  int32_t slot,
  TR::DataType type,
  bool isReference,
  ...
  TR::KnownObjectTable::Index knownObjectIndex)
{
  ...
  for (; symRef; symRef = i.getNext())
    ...
    // coerced
    {
      ...
      if (symRef->getSymbol()->getParmSymbol() ||
        ...
        comp()->failCompilation<TR::CompilationException>(
          "stack mapping can't handle a parameter slot that is shared between "
          "refs and nonrefs 0");
      }
  ...
  if (!symRef) {
    ...
    if (isInternalPointer) {
      sym =
        size ? TR::AutomaticSymbol::createInternalPointer(
    ...
    if (knownObjectIndex == TR::KnownObjectTable::UNKNOWN)
      ...
      symRef = createTempSymRefWithKnownObject(
        sym, owningMethodIndex, slot, knownObjectIndex);
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findAvailableAuto(TR::DataType type,
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findAvailableAuto(
...
TR::SymbolReference*
OMR::SymbolReferenceTable::createTemporary(
  TR::ResolvedMethodSymbol* owningMethodSymbol,
  TR::DataType type,
  bool isInternalPointer,
  size_t size)
...
TR::SymbolReference*
OMR::SymbolReferenceTable::createLocalObject(
  int32_t objectSize,
  TR::ResolvedMethodSymbol* owningMethodSymbol,
...
TR::SymbolReference*
OMR::SymbolReferenceTable::createLocalAddrArray(
  int32_t objectSize,
  TR::ResolvedMethodSymbol* owningMethodSymbol,
  TR::SymbolReference* classSymRef)
{
  ...
  TR::AutomaticSymbol* sym =
    TR::AutomaticSymbol::createLocalObject(trHeapMemory(),
                                           TR::anewarray,
                                           classSymRef,
                                           TR::Aggregate,
                                           objectSize,
...
TR::SymbolReference*
OMR::SymbolReferenceTable::createLocalPrimArray(
  int32_t objectSize,
  TR::ResolvedMethodSymbol* owningMethodSymbol,
  int32_t arrayType)
{
...
TR::SymbolReference*
OMR::SymbolReferenceTable::findOrCreateCounterSymRef(char* name,
                                                     TR::DataType d,
                                                     void* address)
{
...
bool
OMR::SymbolReferenceTable::isNonHelper(TR::SymbolReference* symRef,
...
bool
OMR::SymbolReferenceTable::isNonHelper(int32_t ref, CommonNonhelperSymbol s)
{
...
bool
OMR::SymbolReferenceTable::isNonHelper(int32_t ref)
{
...
int32_t
OMR::SymbolReferenceTable::getNonhelperIndex(CommonNonhelperSymbol s)
{
...
TR::SymbolReference*&
OMR::SymbolReferenceTable::element(TR_RuntimeHelper s)
{
...
void
OMR::SymbolReferenceTable::makeSharedAliases(TR::SymbolReference* sr1,
...
TR::SymbolReference*
OMR::SymbolReferenceTable::getOriginalUnimprovedSymRef(
  TR::SymbolReference* symRef)
{
