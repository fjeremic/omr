...
class TR_VirtualGuard {
 public:
  ...
  static TR_VirtualGuard *createArrayStoreCheckGuard(
      TR::Compilation *, TR::Node *node, TR_OpaqueClassBlock *clazz);
  ...
  bool indirectsTheThisPointer() {
    if (_kind == TR_HCRGuard) return false;
