...
class TR_VirtualGuard {
 public:
  ...
  TR_VirtualGuard(TR_VirtualGuardTestType test,
  ...
  static TR::Node* createVftGuard(TR_VirtualGuardKind,
                                  TR::Compilation*,
                                  int16_t calleeIndex,
                                  TR::Node*,
                                  TR::TreeTop*,
  ...
  static TR::Node* createMethodGuard(TR_VirtualGuardKind,
                                     TR::Compilation*,
                                     int16_t calleeIndex,
                                     TR::Node*,
                                     TR::TreeTop*,
  ...
  static TR::Node* createMethodGuardWithReceiver(TR_VirtualGuardKind,
                                                 TR::Compilation*,
                                                 int16_t calleeIndex,
                                                 TR::Node*,
                                                 TR::TreeTop*,
  ...
  static TR::Node* createNonoverriddenGuard(TR_VirtualGuardKind,
                                            TR::Compilation*,
                                            int16_t calleeIndex,
                                            TR::Node*,
                                            TR::TreeTop*,
  ...
  static TR::Node* createDummyOrSideEffectGuard(TR::Compilation*,
                                                TR::Node*,
                                                TR::TreeTop*);

  static TR::Node* createSideEffectGuard(TR::Compilation*,
                                         TR::Node*,
                                         TR::TreeTop*);

  static TR::Node* createAOTInliningGuard(TR::Compilation*,
                                          int16_t,
                                          TR::Node*,
                                          TR::TreeTop*,
                                          TR_VirtualGuardKind);

  static TR::Node* createAOTGuard(TR::Compilation*,
                                  int16_t,
                                  TR::Node*,
                                  TR::TreeTop*,
                                  TR_VirtualGuardKind);

  static TR::Node* createDummyGuard(TR::Compilation*,
                                    int16_t,
                                    TR::Node*,
                                    TR::TreeTop*);
  ...
  static TR::Node* createHCRGuard(TR::Compilation* comp,
                                  int16_t calleeIndex,
                                  TR::Node* node,
                                  TR::TreeTop* destination,
  ...
  static void setGuardKind(TR::Node* guard,
                           TR_VirtualGuardKind kind,
                           TR::Compilation* comp);
  ...
  void addInnerAssumption(TR::Compilation* comp,
                          int32_t ordinal,
