...
class SymbolReferenceTable {
 public:
  ...
  TR::SymbolReference* findOrCreateCounterSymRef(char* name,
                                                 TR::DataType d,
                                                 void* address);
 ...
 protected:
  ...
  typedef CS2::
      HashTable<OwningMethodAndString, TR::SymbolReference*, TR::Allocator>
  ...
  typedef TR::typed_allocator<std::pair<int32_t const, TR_BitVector*>,
      ...
      AliasMapAllocator;
  typedef std::
      map<int32_t, TR_BitVector*, std::less<int32_t>, AliasMapAllocator>
          AliasMap;
  ...
  typedef std::
      map<int32_t, int32_t, std::less<int32_t>, OriginalUnimprovedMapAlloc>
