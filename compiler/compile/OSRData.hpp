...
public:
  ...
  TR_Array<TR_SlotInfo>& getSlotInfos()
  {
    return slotInfos;
  }
...
public:
  ...
  uint32_t getMaxScratchBufferSize() const
  {
    return maxScratchBufferSize;
  }
  ...
  int32_t getNumOfSymsThatShareSlot()
  {
    return numOfSymsThatShareSlot;
  }
...
public:
  ...
  int32_t getInlinedSiteIndex() const
  {
    return inlinedSiteIndex;
  }
  TR::ResolvedMethodSymbol* getMethodSymbol() const
  {
    return methodSymbol;
  }
  TR::Block* findOrCreateOSRCodeBlock(TR::Node* n);
  TR::Block* findOrCreateOSRCatchBlock(TR::Node* n);
  TR::Block* getOSRCodeBlock() const
  {
    return osrCodeBlock;
  }
  TR::Block* getOSRCatchBlock() const
  {
    return osrCatchBlock;
  }
  ...
  void setNumSymRefs(int32_t numBits)
  {
    _numSymRefs = numBits;
  }
  ...
  bool linkedToCaller()
  {
    return _linkedToCaller;
  }
  void setLinkedToCaller(bool b)
  {
    _linkedToCaller = b;
  }
  ...
  void setSymRefs(TR_BitVector* symRefs)
  {
    _symRefs = symRefs;
  }
  TR_BitVector* getSymRefs()
  {
    return _symRefs;
  }
...
public:
  ...
  TR_OSRMethodData* getOSRMethodData()
  {
    return _methodData;
  }

  void setOSRIndex(uint32_t index)
  {
    _index = index;
  }
  uint32_t getOSRIndex()
  {
    return _index;
  }
