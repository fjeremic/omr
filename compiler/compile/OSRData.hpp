...
typedef std::
    map<int32_t, TR_BitVector*, DefiningMapComparator, DefiningMapAllocator>
        DefiningMap;
...
class TR_OSRSlotSharingInfo {
 public:
  ...
  class TR_SlotInfo {
   public:
    TR_SlotInfo(int32_t _slot,
                int32_t _symRefNum,
                int32_t _symRefOrder,
                int32_t _symSize,
                bool _takesTwoSlots)
        : slot(_slot),
...
class TR_OSRCompilationData {
 public:
  ...
  void addSlotSharingInfo(const TR_ByteCodeInfo& T,
                          int32_t slot,
                          int32_t symRefNum,
                          int32_t symRefOrder,
                          int32_t symSize,
  ...
  class TR_ScratchBufferInfo {
   public:
    TR_ScratchBufferInfo(int32_t _inlinedSiteIndex,
                         int32_t _osrBufferOffset,
                         int32_t _scratchBufferOffset,
                         int32_t _symSize)
...
class TR_OSRMethodData {
 public:
  ...
  int32_t slotIndex2OSRBufferIndex(int32_t slotIndex,
                                   int symSize,
                                   bool takesTwoSlots) const;
  void addScratchBufferOffset(int32_t slotIndex,
                              int32_t symRefOrder,
                              int32_t scratchBufferOffset);
  ...
  void buildDefiningMap(TR::Block* block,
                        DefiningMap* blockDefiningMap,
  ...
  void collectSubTreeSymRefs(TR::Node* node,
...
class TR_OSRPoint {
 public:
  ...
  TR_OSRPoint(TR_ByteCodeInfo& bcInfo,
