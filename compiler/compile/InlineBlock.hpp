...
public:
  ...
  int32_t getNumExceptionBlocks()
  {
    return _numExceptionBlocks;
  }

  void setCallNodeTreeTop(TR::TreeTop* tt)
  {
    _callNodeTreeTop = tt;
  }
  TR::TreeTop* getCallNodeTreeTop()
  {
    return _callNodeTreeTop;
  }

  bool hasGeneratedRestartTree()
  {
    return _generatedRestartTree != NULL;
  }
  TR::TreeTop* getGeneratedRestartTree()
  {
    return _generatedRestartTree;
  }
  ...
  void setLowestBCIndex(int32_t i)
  {
    _lowestBCIndex = i;
  }
  void setHighestBCIndex(int32_t i)
  {
    _highestBCIndex = i;
  }
  int32_t getLowestBCIndex()
  {
    return _lowestBCIndex;
  }
  int32_t getHighestBCIndex()
  {
    return _highestBCIndex;
  }
