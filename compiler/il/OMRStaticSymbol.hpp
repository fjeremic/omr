...
class OMR_EXTENSIBLE StaticSymbol : public TR::Symbol {
 ...
 public:
  ...
  template <typename AllocatorType>
  static TR::StaticSymbol* createWithAddress(AllocatorType t,
                                             TR::DataType d,
                                             void* address);

  template <typename AllocatorType>
  static TR::StaticSymbol* createWithSize(AllocatorType t,
                                          TR::DataType d,
                                          uint32_t s);
 ...
 public:
  template <typename AllocatorType>
  static TR::StaticSymbol* createNamed(AllocatorType m,
                                       TR::DataType d,
                                       const char* name);
