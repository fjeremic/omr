...
public:
   ...
   * @{
   */
  rcount_t getReferenceCount()
  {
    return _referenceCount;
  }
  rcount_t decReferenceCount()
  {
    return --_referenceCount;
  }
...
public:
  ...
  int32_t* getReferenceSlots()
  {
    return _referenceSlots;
  }
  void setReferenceSlots(int32_t* fields)
  {
    _referenceSlots = fields;
  }
...
#define TR_VSS_NAME "VTS"
  ...
  enum {
    ...
    IsSingleUse = 0x04, ///< a temp ref created for a one off privatization in a single evaluator (doesn't use refCounts
                        ///< so automatically freed)
  };
