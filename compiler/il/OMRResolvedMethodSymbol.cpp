 ...
 * induceBCI and the OSR induction helper call is generated successfully
 */
bool OMR::ResolvedMethodSymbol::induceOSRAfter(TR::TreeTop* insertionPoint,
                                               TR_ByteCodeInfo induceBCI,
                                               TR::TreeTop* branch,
                                               bool extendRemainder,
                                               int32_t offset,
...
bool OMR::ResolvedMethodSymbol::genIL(TR_FrontEnd* fe,
                                      TR::Compilation* comp,
                                      TR::SymbolReferenceTable* symRefTab,
...
void OMR::ResolvedMethodSymbol::insertStoresForDeadStackSlots(
    ...
    TR::TreeTop* insertTree,
    bool keepStashedArgsLive) {
...
bool OMR::ResolvedMethodSymbol::doJSR292PerfTweaks() {
  return false;
}
