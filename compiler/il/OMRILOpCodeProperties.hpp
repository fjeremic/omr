...

{
...

  {
    ...
    /* .childProperties      = */
    ONE_CHILD(
      ILChildProp::UnspecifiedChildType), // ireturn is used to return all types
                                          // smaller than Int32
    /* .swapChildrenOpCode   = */ TR::BadILOp,
    /* .reverseBranchOpCode  = */ TR::BadILOp,
    /* .booleanCompareOpCode = */ TR::BadILOp,
...

  {
    /* .opcode               = */ TR::ificmpeq,
    /* .name                 = */ "ificmpeq",
    /* .properties1          = */ ILProp1::BooleanCompare | ILProp1::Branch |
      ILProp1::TreeTop,
    /* .properties2          = */ 0,
    /* .properties3          = */ ILProp3::CompareTrueIfEqual,
    /* .properties4          = */ 0,
...

  {
    ...
    /* .name                 = */ "ZEROCHK",
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::CanRaiseException | ILProp2::Check |
      ILProp2::MayUseSystemStack,
    /* .properties3          = */ 0,
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::NoType,
...

  {
    ...
    /* .typeProperties       = */ 0,
    /* .childProperties      = */
      CHILD_COUNT(ILChildProp::UnspecifiedChildCount) | FIRST_CHILD(TR::Int32) |
...

  {
    ...
    /* .typeProperties       = */ ILTypeProp::Size_16 | ILTypeProp::Integer |
      ILTypeProp::Vector,
    /* .childProperties      = */
...

  {
    ...
    /* .typeProperties       = */ ILTypeProp::Size_16 | ILTypeProp::Integer |
      ILTypeProp::Vector | ILTypeProp::HasNoDataType,
    /* .childProperties      = */ ONE_CHILD(ILChildProp::UnspecifiedChildType),
    /* .swapChildrenOpCode   = */ TR::BadILOp,
    /* .reverseBranchOpCode  = */ TR::BadILOp,
    /* .booleanCompareOpCode = */ TR::BadILOp,
...

  {
    ...
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::CanRaiseException | ILProp2::Check |
      ILProp2::CheckCast | ILProp2::MayUseSystemStack,
    /* .properties3          = */ 0,
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::Address,
    /* .typeProperties       = */ ILTypeProp::Reference,
...

  {
    ...
    /* .properties1          = */ ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::MustBeLowered |
      ILProp2::CanRaiseException | ILProp2::MayUseSystemStack | ILProp2::New,
    /* .properties3          = */ ILProp3::LikeDef,
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::Address,
    /* .typeProperties       = */ ILTypeProp::Reference,
...

  {
    ...
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::ValueNumberShare |
      ILProp2::CanRaiseException | ILProp2::Check | ILProp2::ResolveCheck |
      ILProp2::MayUseSystemStack,
    /* .properties3          = */ ILProp3::LikeDef,
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::Address,
...

  {
    ...
    /* .name                 = */ "OverflowCHK",
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::Check | ILProp2::MayUseSystemStack |
   ...
   * This opcode has one child : the awrtbari node corresponding to the
   ...
   * therefore remain an awrtbari and not be changed to an astorei even if this
   * is possible if the ArrayStoreCHK node is present.
   *
   */
  {
    ...
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::ValueNumberShare |
      ILProp2::CanRaiseException | ILProp2::Check | ILProp2::MayUseSystemStack,
    /* .properties3          = */ 0,
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::Address,
    /* .typeProperties       = */ ILTypeProp::Reference,
...

  {
    /* .opcode               = */ TR::branch,
    /* .name                 = */ "branch",
    /* .properties1          = */ ILProp1::Branch | ILProp1::CompBranchOnly |
      ILProp1::TreeTop,
    /* .properties2          = */ 0,
    /* .properties3          = */ 0,
    /* .properties4          = */ 0,
