...

{
...

  {
    ...
    /* .dataType             = */ TR::Int32,
    /* .typeProperties       = */ ILTypeProp::Size_4 | ILTypeProp::Integer,
    /* .childProperties      = */ ONE_CHILD(ILChildProp::UnspecifiedChildType), // ireturn is used to return all types
                                                                                // smaller than Int32
    /* .swapChildrenOpCode   = */ TR::BadILOp,
    /* .reverseBranchOpCode  = */ TR::BadILOp,
    /* .booleanCompareOpCode = */ TR::BadILOp,
...

  {
    ...
    /* .dataType             = */ TR::NoType,
    /* .typeProperties       = */ 0,
    /* .childProperties      = */ CHILD_COUNT(ILChildProp::UnspecifiedChildCount) | FIRST_CHILD(TR::Int32)
      | SECOND_CHILD(ILChildProp::UnspecifiedChildType) | THIRD_CHILD(ILChildProp::UnspecifiedChildType),
    /* .swapChildrenOpCode   = */ TR::BadILOp,
    /* .reverseBranchOpCode  = */ TR::BadILOp,
    /* .booleanCompareOpCode = */ TR::BadILOp,
    /* .ifCompareOpCode      = */ TR::BadILOp,
...

  {
    ...
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::NoType,
    /* .typeProperties       = */ ILTypeProp::Size_16 | ILTypeProp::Vector | ILTypeProp::Unsigned
      | ILTypeProp::HasNoDataType,
    /* .childProperties      = */ TWO_SAME_CHILD(ILChildProp::UnspecifiedChildType),
    /* .swapChildrenOpCode   = */ TR::vcmpgt,
    /* .reverseBranchOpCode  = */ TR::vcmpge,
...

  {
    ...
    /* .name                 = */ "checkcast",
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::CanRaiseException | ILProp2::Check | ILProp2::CheckCast
...

  {
    ...
    /* .name                 = */ "NULLCHK",
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::ValueNumberShare | ILProp2::CanRaiseException | ILProp2::Check
      | ILProp2::NullCheck | ILProp2::MayUseSystemStack,
    /* .properties3          = */ 0,
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::Address,
    /* .typeProperties       = */ ILTypeProp::Reference,
...

  {
    ...
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::ValueNumberShare | ILProp2::CanRaiseException | ILProp2::Check
      | ILProp2::NullCheck | ILProp2::ResolveCheck | ILProp2::MayUseSystemStack,
    /* .properties3          = */ ILProp3::LikeDef,
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::Address,
    /* .typeProperties       = */ ILTypeProp::Reference,
...

  {
    ...
    /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
    /* .properties2          = */ ILProp2::ValueNumberShare | ILProp2::CanRaiseException | ILProp2::Check
      | ILProp2::BndCheck | ILProp2::MayUseSystemStack,
    /* .properties3          = */ 0,
    /* .properties4          = */ 0,
    /* .dataType             = */ TR::Int32,
    /* .typeProperties       = */ ILTypeProp::Size_4 | ILTypeProp::Integer,
...

  {
    ...
    /* .name                 = */ "ibatomicor",
    /* .properties1          = */ ILProp1::LoadVar | ILProp1::Store | ILProp1::Indirect | ILProp1::TreeTop
