...
static TR::ILOpCodes conversionMap[TR::NumOMRTypes][TR::NumOMRTypes] =
  //                    No      Int8     Int16    Int32    Int64    Float Double
  //                    Addr     VectorInt8 VectorInt16 VectorInt32 VectorInt64
  //                    VectorFloat VectorDouble Aggregate
  {
    /* NoType */ { TR_Bad,
                   TR_Bad,
                   TR_Bad,
...
static_assert(TR::NumOMRTypes ==
                (sizeof(OMRDataTypePrefixes) / sizeof(OMRDataTypePrefixes[0])),
