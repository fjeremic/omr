...
class OMR_EXTENSIBLE ResolvedMethodSymbol : public TR::MethodSymbol {
 ...
 public:
  ...
  static TR::ResolvedMethodSymbol* create(AllocatorType,
                                          TR_ResolvedMethod*,
                                          TR::Compilation*);
  ...
  bool induceOSRAfter(TR::TreeTop* insertionPoint,
                      TR_ByteCodeInfo induceBCI,
                      TR::TreeTop* branch,
  ...
  bool cannotAttemptOSRAt(TR_ByteCodeInfo& bci,
                          TR::Block* blockToOSRAt,
                          TR::Compilation* comp);
  bool cannotAttemptOSRDuring(int32_t callSite,
                              TR::Compilation* comp,
                              bool runCleanup = true);
  bool supportsInduceOSR(TR_ByteCodeInfo& bci,
                         TR::Block* blockToOSRAt,
                         TR::Compilation* comp,
                         bool runCleanup = true);
