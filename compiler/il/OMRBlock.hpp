...
public:
  ...
  TR::Block* splitEdge(
    TR::Block*, TR::Block*, TR::Compilation*, TR::TreeTop** lastTreeTop = NULL, bool findOptimalInsertionPoint = true);
  ...
  TR_BlockStructure* getStructureOf()
  {
    return _pStructureOf;
  }
  ...
  void clearGlobalRegisters()
  {
    _globalRegisters = NULL;
  }
  ...
  TR::Instruction* getLastInstruction()
  {
  ...
  void setHandlerInfoWithOutBCInfo(uint32_t c, uint8_t d, uint16_t i, TR_ResolvedMethod* m,
  ...
  {
    _unrollFactor = factor;
  }
  uint16_t getUnrollFactor()
  {
    return _unrollFactor;
  }

  void setBlockSize(int32_t s)
  {
    _blockSize = s;
  }
  ...
  void setBlockBCIndex(int32_t len)
  {
    _blockBCIndex = len;
  }
  int32_t getBlockBCIndex()
  {
    return _blockBCIndex;
  }
  ...
  TR::DebugCounterAggregation* getDebugCounters()
  {
  ...
  void setIsCold(bool b = true)
  {
    _flags.set(_isCold, b);
  }
  bool isCold()
  {
    return _flags.testAny(_isCold);
  }

  void setIsSuperCold(bool v = true);
  bool isSuperCold();

  void setDoNotProfile()
  {
    _flags.set(_doNotProfile);
  }
  bool doNotProfile()
  {
    return _flags.testAny(_doNotProfile);
  }
  ...
  void setFirstBlockInLoop()
  {
    _flags.set(_firstBlockInLoop);
  }
  bool firstBlockInLoop()
  {
    return _flags.testAny(_firstBlockInLoop);
  }

  void setBranchesBackwards()
  {
    _flags.set(_branchingBackwards);
  }
  bool branchesBackwards()
  {
    return _flags.testAny(_branchingBackwards);
  }

  void setIsSynchronizedHandler()
  {
    _flags.set(_isSynchronizedHandler);
  }
  ...
  void setHasBeenVisited(bool b = true)
  {
    _flags.set(_hasBeenVisited, b);
  }
  bool hasBeenVisited()
  {
    return _flags.testAny(_hasBeenVisited);
  }

  void setIsPRECandidate(bool b)
  {
    _flags.set(_isPRECandidate, b);
  }
  bool isPRECandidate()
  {
    return _flags.testAny(_isPRECandidate);
  }
  ...
  bool isAdded()
  {
    return _flags.testAny(_isAdded);
  }

  void setIsOSRInduceBlock()
  {
    _flags.set(_isOSRInduceBlock);
  }
  bool isOSRInduceBlock()
  {
    return _flags.testAny(_isOSRInduceBlock);
  }

  void setIsOSRCodeBlock()
  {
    _flags.set(_isOSRCodeBlock);
  }
  bool isOSRCodeBlock()
  {
    return _flags.testAny(_isOSRCodeBlock);
  }

  void setIsOSRCatchBlock()
  {
    _flags.set(_isOSRCatchBlock);
  }
  bool isOSRCatchBlock()
  {
    return _flags.testAny(_isOSRCatchBlock);
  }
  ...
  bool isCreatedAtCodeGen()
  {
    return _flags.testAny(_createdAtCodeGen);
  }

  void setHasCalls(bool b)
  {
    _flags.set(_hasCalls, b);
  }
  bool hasCalls()
  {
    return _flags.testAny(_hasCalls);
  }

  void setHasCallToSuperCold(bool b)
  {
    _flags.set(_hasCallToSuperCold, b);
  }
  bool hasCallToSuperCold()
  {
    return _flags.testAny(_hasCallToSuperCold);
  }

  void setIsSpecialized(bool b = true)
  {
    _flags.set(_isSpecialized, b);
  }
  bool isSpecialized()
  {
    return _flags.testAny(_isSpecialized);
  }

  bool isLoopInvariantBlock()
  {
    return _flags.testAny(_isLoopInvariantBlock);
  }
  void setAsLoopInvariantBlock(bool b)
  {
    _flags.set(_isLoopInvariantBlock, b);
  }
  ...
  void setCreatedByVersioning(bool b)
  {
    _flags.set(_isCreatedByVersioning, b);
  }
  ...
  bool isUnsanitizeable()
  {
    return _moreflags.testAny(_unsanitizeable);
  }

  void setContainsCall(bool b = true)
  {
    _moreflags.set(_containsCall, b);
  }
  bool containsCall()
  {
    return _moreflags.testAny(_containsCall);
  }
  ...
  bool isRestartBlock()
  {
    return _moreflags.testAny(_restartBlock);
  }
  ...
  void setIsEndBlock(bool b = true)
  {
    _moreflags.set(_endBlock, b);
  }
  bool isEndBlock()
  {
    return _moreflags.testAny(_endBlock);
  }
  ...
  bool isDifficultBlock()
  {
    return _moreflags.testAny(_difficultBlock);
  }
