...
OMR::Node::Node(TR::Node* originatingByteCodeNode,
                TR::ILOpCodes op,
...
void OMR::Node::copyChildren(
    TR::Node* from,
    uint16_t numChildren /* ignored if !forNodeExtensionOnly */,
...
TR::Node* OMR::Node::create(TR::Node* originatingByteCodeNode,
                            TR::ILOpCodes op,
                            uint16_t numChildren) {
...
TR::Node* OMR::Node::create(TR::ILOpCodes op,
                            uint16_t numChildren,
                            TR::TreeTop* dest) {
...
TR::Node* OMR::Node::createWithSymRef(TR::ILOpCodes op,
                                      uint16_t numChildren,
                                      TR::Node* first,
...
TR::Node* OMR::Node::createWithoutSymRef(TR::ILOpCodes op,
                                         uint16_t numChildren,
                                         uint16_t numChildArgs,
                                         ...) {
  va_list args;
...
TR::Node* OMR::Node::createWithRoomForThree(TR::ILOpCodes op,
                                            TR::Node* first,
                                            TR::Node* second,
                                            void* symbolRefOrBranchTarget) {
...
TR::Node* OMR::Node::createWithRoomForFive(TR::ILOpCodes op,
                                           TR::Node* first,
                                           TR::Node* second,
                                           TR::Node* third,
                                           TR::Node* fourth,
...
TR::Node* OMR::Node::createif(TR::ILOpCodes op,
                              TR::Node* first,
                              TR::Node* second,
...
TR::Node* OMR::Node::createbranch(TR::ILOpCodes op,
                                  TR::Node* first,
                                  TR::TreeTop* branchTarget) {
...
TR::Node* OMR::Node::createArraycopy(TR::Node* first,
                                     TR::Node* second,
                                     TR::Node* third) {
  TR::Node* node =
...
TR::Node* OMR::Node::createStore(TR::SymbolReference* symRef,
                                 TR::Node* value,
                                 TR::ILOpCodes op) {
...
TR::Node* OMR::Node::bconst(int8_t val) {
...
TR::Node* OMR::Node::buconst(uint8_t val) {
...
TR::Node* OMR::Node::sconst(int16_t val) {
...
TR::Node* OMR::Node::cconst(uint16_t val) {
...
TR::Node* OMR::Node::iconst(int32_t val) {
...
TR::Node* OMR::Node::iuconst(uint32_t val) {
...
TR::Node* OMR::Node::lconst(int64_t val) {
...
TR::Node* OMR::Node::luconst(uint64_t val) {
...
TR::Node* OMR::Node::aconst(TR::Node* originatingByteCodeNode,
                            uintptrj_t val,
                            uint8_t precision) {
  return TR::Node::createAddressNode(originatingByteCodeNode, TR::aconst, val,
                                     precision);
...
TR::Node* OMR::Node::aconst(uintptrj_t val) {
...
TR::Node* OMR::Node::createAddConstantToAddress(TR::Node* addr,
                                                intptr_t value,
                                                TR::Node* parent) {
  TR::Node* ret = NULL;
...
bool OMR::Node::collectSymbolReferencesInNode(
    TR_BitVector& symbolReferencesInNode,
    vcount_t visitCount) {
  int32_t i;
...
void OMR::Node::gatherAllNodesWhichMightKillCondCode(
    vcount_t vc,
    TR::list<TR::Node*>& nodesWhichKillCondCode) {
  if (self()->getVisitCount() == vc)
    return;
...
TR::Node* OMR::Node::setFirst(TR::Node* p) {
...
void OMR::Node::copyNodeExtension(TR::NodeExtension* other,
                                  uint16_t numElems,
                                  size_t size) {
  TR::Compilation* comp = TR::comp();
...
void OMR::Node::setArrayStoreClassInNode(TR_OpaqueClassBlock* o) {
  ...
  ArrayStoreCheckInfo* info =
      _unionBase._extension.getExtensionPtr()->getElem<ArrayStoreCheckInfo*>(2);
  info->objectClass = o;
}
...
const char* OMR::Node::printIsZero() {
  return self()->isZero() ? "X==0 " : "";
}

bool OMR::Node::isNonZero() {
