  ...
  if (from->hasNodeExtension()) {
    ...
    if (numChildren > from->_unionBase._extension.getNumElems()) {
      ...
      for (uint16_t childNum = 0;
           childNum < from->_unionBase._extension.getNumElems();
           childNum++)
...
TR::Node*
OMR::Node::recreateWithSymRef(TR::Node* originalNode,
                              TR::ILOpCodes op,
                              TR::SymbolReference* newSymRef)
{
  return TR::Node::recreateAndCopyValidPropertiesImpl(
    originalNode, op, newSymRef);
}
 ...
 */
TR::Node*
OMR::Node::recreateAndCopyValidPropertiesImpl(TR::Node* originalNode,
                                              TR::ILOpCodes op,
                                              TR::SymbolReference* newSymRef)
{
...
TR::Node*
OMR::Node::createInternal(TR::Node* originatingByteCodeNode,
                          TR::ILOpCodes op,
                          uint16_t numChildren,
...
TR::Node*
OMR::Node::create(TR::Node* originatingByteCodeNode,
                  TR::ILOpCodes op,
                  uint16_t numChildren)
{
...
TR::Node*
OMR::Node::createWithSymRef(TR::Node* originatingByteCodeNode,
                            TR::ILOpCodes op,
                            uint16_t numChildren,
...
TR::Node*
OMR::Node::createOnStack(TR::Node* originatingByteCodeNode,
                         TR::ILOpCodes op,
                         uint16_t numChildren)
{
...
TR::Node*
OMR::Node::recreateWithoutProperties(TR::Node* originalNode,
                                     TR::ILOpCodes op,
                                     uint16_t numChildren,
                                     TR::SymbolReference* symRef)
{
...
TR::Node*
OMR::Node::create(TR::ILOpCodes op,
                  uint16_t numChildren,
                  int32_t intValue,
                  TR::TreeTop* dest)
{
...
TR::Node*
OMR::Node::createWithSymRef(TR::ILOpCodes op,
                            uint16_t numChildren,
                            TR::Node* first,
...
TR::Node*
OMR::Node::recreateWithoutSymRef_va_args(TR::Node* originalNode,
                                         TR::ILOpCodes op,
                                         uint16_t numChildren,
...
TR::Node*
OMR::Node::createWithoutSymRef(TR::ILOpCodes op,
                               uint16_t numChildren,
                               uint16_t numChildArgs,
                               ...)
{
  ...
  TR::Node* node = TR::Node::recreateWithoutSymRef_va_args(
    0, op, numChildren, numChildArgs, args);
  va_end(args);
  return node;
}

TR::Node*
OMR::Node::recreateWithoutSymRef(TR::Node* originalNode,
                                 TR::ILOpCodes op,
                                 uint16_t numChildren,
                                 uint16_t numChildArgs,
                                 ...)
...
TR::Node*
OMR::Node::recreateWithSymRefWithoutProperties(TR::Node* originalNode,
                                               TR::ILOpCodes op,
                                               uint16_t numChildren,
                                               uint16_t numChildArgs,
                                               ...)
                  ...
                  TR::Node* third)
{
  ...
  return TR::Node::createWithoutSymRef(
    op, numChildren, 3, first, second, third);
}
                  ...
                  TR::Node* fourth)
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::createWithoutSymRef(
    op, numChildren, 4, first, second, third, fourth);
}
                  ...
                  TR::Node* fifth)
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::createWithoutSymRef(
    op, numChildren, 5, first, second, third, fourth, fifth);
}
                  ...
                  TR::Node* sixth)
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::createWithoutSymRef(
    op, numChildren, 6, first, second, third, fourth, fifth, sixth);
}
                  ...
                  TR::Node* seventh)
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::createWithoutSymRef(
    op, numChildren, 7, first, second, third, fourth, fifth, sixth, seventh);
}
...
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::createWithoutSymRef(op,
                                       numChildren,
                                       8,
                                       first,
                                       second,
                                     ...
                                     TR::Node* first)
{
  ...
  return TR::Node::recreateWithoutSymRef(
    originalNode, op, numChildren, 1, first);
}
                                     ...
                                     TR::Node* second)
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::recreateWithoutSymRef(
    originalNode, op, numChildren, 2, first, second);
}
                                     ...
                                     TR::Node* third)
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::recreateWithoutSymRef(
    originalNode, op, numChildren, 3, first, second, third);
}
                                     ...
                                     TR::Node* fourth)
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::recreateWithoutSymRef(
    originalNode, op, numChildren, 4, first, second, third, fourth);
}
...
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::recreateWithoutSymRef(originalNode,
                                         op,
                                         numChildren,
                                         6,
                                         first,
...
{
  TR_ASSERT(TR::Node::isLegalCallToCreate(op), "assertion failure");
  return TR::Node::recreateWithSymRefWithoutProperties(originalNode,
                                                       op,
                                                       numChildren,
                                                       5,
                                                       first,
...
TR::Node*
OMR::Node::createWithRoomForOneMore(TR::ILOpCodes op,
                                    uint16_t numChildren,
                                    ...
                                    TR::Node* fifth)
{
  ...
  if (symbolRefOrBranchTarget != NULL || node->hasSymbolReference() ||
    ...
    if (node->hasSymbolReference())
      ...
      TR_ASSERT(
        false,
        "attempting to access _branchDestinationNode or _symbolReference field "
        "for node %s %p that does not have one of them",
...
TR::Node*
OMR::Node::createWithRoomForThree(TR::ILOpCodes op,
                                  TR::Node* first,
                                  TR::Node* second,
                                  void* symbolRefOrBranchTarget)
{
...
TR::Node*
OMR::Node::createWithRoomForFive(TR::ILOpCodes op,
                                 TR::Node* first,
                                 TR::Node* second,
                                 TR::Node* third,
                                 TR::Node* fourth,
                                 void* symbolRefOrBranchTarget)
{
  ...
  return TR::Node::createWithRoomForOneMore(
    op, 4, symbolRefOrBranchTarget, first, second, third, fourth);
}

// An 'if' node is created with room for 3 children.
TR::Node*
OMR::Node::createif(TR::ILOpCodes op,
                    TR::Node* first,
                    TR::Node* second,
                    TR::TreeTop* branchTarget)
{
  ...
  //
  return TR::Node::createWithRoomForThree(
    op, first, second, (void*)branchTarget);
}

TR::Node*
OMR::Node::createbranch(TR::ILOpCodes op,
                        TR::Node* first,
                        TR::TreeTop* branchTarget)
{
...
TR::Node*
OMR::Node::createCase(TR::Node* originatingByteCodeNode,
 ...
 */
TR::Node*
OMR::Node::createArrayOperation(TR::ILOpCodes arrayOp,
                                TR::Node* first,
                                TR::Node* second,
                                TR::Node* third,
                                TR::Node* fourth,
                                TR::Node* fifth)
{
  ...
  return TR::Node::createWithRoomForOneMore(
    arrayOp, numChildren, 0, first, second, third, fourth, fifth);
}
...
TR::Node*
OMR::Node::createArraycopy(TR::Node* first,
                           TR::Node* second,
                           TR::Node* third,
                           TR::Node* fourth,
                           TR::Node* fifth)
{
  TR::Node* node = TR::Node::createArrayOperation(
    TR::arraycopy, first, second, third, fourth, fifth);
  node->setSymbolReference(
    TR::comp()->getSymRefTab()->findOrCreateArrayCopySymbol());
  return node;
}
...
TR::Node*
OMR::Node::createPotentialOSRPointHelperCallInILGen(
...
TR::Node*
OMR::Node::createLoad(TR::Node* originatingByteCodeNode,
                      TR::SymbolReference* symRef)
{
  TR::Node* load = TR::Node::createWithSymRef(
    originatingByteCodeNode,
    TR::comp()->il.opCodeForDirectLoad(symRef->getSymbol()->getDataType()),
    0,
    symRef);
...
TR::Node*
OMR::Node::createStore(TR::SymbolReference* symRef,
                       TR::Node* value,
                       TR::ILOpCodes op)
{
...
TR::Node*
OMR::Node::createStore(TR::Node* originatingByteCodeNode,
                       TR::SymbolReference* symRef,
                       TR::Node* value)
{
  TR::DataType type = symRef->getSymbol()->getDataType();
  TR::ILOpCodes op = TR::comp()->il.opCodeForDirectStore(type);
  return TR::Node::createWithSymRef(
    originatingByteCodeNode, op, 1, value, symRef);
}
...
{
  TR::Node* node = TR::Node::createInternal(
    originatingByteCodeNode, TR::exceptionRangeFence, 0);
...
TR::Node*
OMR::Node::createAddressNode(TR::Node* originatingByteCodeNode,
                             TR::ILOpCodes op,
                             uintptrj_t address,
                             uint8_t precision)
{
...
TR::Node*
OMR::Node::createAllocationFence(TR::Node* originatingByteCodeNode,
                                 TR::Node* fenceNode)
{
  TR::Node* node =
...
OMR::Node::iuconst(TR::Node* originatingByteCodeNode, uint32_t val)
{
  return TR::Node::create(
    originatingByteCodeNode, TR::iuconst, 0, (int32_t)val);
}
...
TR::Node*
OMR::Node::aconst(TR::Node* originatingByteCodeNode,
                  uintptrj_t val,
                  uint8_t precision)
{
  return TR::Node::createAddressNode(
    originatingByteCodeNode, TR::aconst, val, precision);
}
...
TR::Node*
OMR::Node::createConstZeroValue(TR::Node* originatingByteCodeNode,
                                TR::DataType dt)
{
...
TR::Node*
OMR::Node::createConstDead(TR::Node* originatingByteCodeNode,
                           TR::DataType dt,
                           intptrj_t extraData)
{
  TR::Node* result = NULL;
...
TR::Node*
OMR::Node::createAddConstantToAddress(TR::Node* addr,
                                      intptr_t value,
                                      TR::Node* parent)
{
  TR::Node* ret = NULL;
...
OMR::Node::setAndIncChild(int32_t c, TR::Node* p)
{
  TR_ASSERT(self()->getOpCodeValue() != TR::BBStart || c != 1,
            "Can't use second child of TR::BBStart %p",
            this);
  if (p)
    p->incReferenceCount();
...
OMR::Node::isUnsafeToDuplicateAndExecuteAgain(int32_t* nodeVisitBudget)
{
  ...
  for (int32_t i = 0; !unsafeChildFound && i < self()->getNumChildren(); i++)
    unsafeChildFound =
      self()->getChild(i)->isUnsafeToDuplicateAndExecuteAgain(nodeVisitBudget);
...
recordProcessedNodeResult(TR::Node* node,
                          ...
                          TR::NodeChecklist& processedNodesNotCollected)
{
  switch (collectedness) {
    ...
    default:
      TR_ASSERT_FATAL(
        false, "Invalid collectedness result for Node %p\n", node);
      break;
  }
...
TR_YesNoMaybe
OMR::Node::computeIsCollectedReferenceImpl(
  TR::NodeChecklist& processedNodesCollected,
  TR::NodeChecklist& processedNodesNotCollected)
{
  ...
  while (curNode) {
    if (curNode->isInternalPointer())
      return recordProcessedNodeResult(receiverNode,
                                       TR_yes,
    ...
    if (op.isLoadVar() || op.isLoadAddr() || op.isLoadReg()) {
      ...
      if (opValue == TR::aloadi &&
        ...
        return recordProcessedNodeResult(
          receiverNode,
          (symbol->isCollectedReference() ? TR_yes : TR_no),
          processedNodesCollected,
          processedNodesNotCollected);
    }
    ...
    switch (opValue) {
      ...
      default:
        TR_ASSERT(false,
                  "Unsupported opcode %s on node " POINTER_PRINTF_FORMAT,
                  op.getName(),
                  curNode);
        return TR_no;
    }
...
bool
OMR::Node::collectSymbolReferencesInNode(TR_BitVector& symbolReferencesInNode,
                                         vcount_t visitCount)
{
  int32_t i;
...
OMR::Node::isSafeToReplaceNode(TR::TreeTop* curTreeTop)
{
  ...
  TR_BitVector symbolReferencesInNode(
    c->getSymRefCount(), c->trMemory(), stackAlloc);
  c->incVisitCount();
...
OMR::Node::mayModifyValue(TR::SymbolReference* symRef)
{
  ...
  if (node->getOpCode().isStore()) {
      ...
      if (storeSymbol->isStatic()) {
        ...
        if (symRef->isUnresolved() || storeRef->isUnresolved())
          return TR::Compiler->cls.jitStaticsAreSame(
            c,
            storeRef->getOwningMethod(c),
            storeRef->getCPIndex(),
            symRef->getOwningMethod(c),
            symRef->getCPIndex());
    ...
    if (symbol->isShadow() && storeSymbol->isShadow()) {
      ...
      TR::Compilation* c = TR::comp();
      return TR::Compiler->cls.jitFieldsAreSame(c,
                                                storeRef->getOwningMethod(c),
                                                storeRef->getCPIndex(),
                                                symRef->getOwningMethod(c),
                                                symRef->getCPIndex(),
...
OMR::Node::isClassUnloadingConst()
{
  ...
  if ((((constNode->isClassPointerConstant()) &&
        !TR::Compiler->cls.sameClassLoaders(
          c,
          (TR_OpaqueClassBlock*)constNode->getAddress(),
...
void
OMR::Node::gatherAllNodesWhichMightKillCondCode(
  vcount_t vc,
 ...
 */
TR::TreeTop*
OMR::Node::createStoresForVar(TR::SymbolReference*& nodeRef,
...
{
  TR::Compilation* comp = TR::comp();
  TR_BitVector nodeChecklistBeforeDump(
    comp->getNodeCount(), comp->trMemory(), stackAlloc, notGrowable);
...
OMR::Node::setZeroExtendTo32BitAtSource(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting zeroExtendTo32BitAtSource flag on node %p to "
        "%d\n",
        self(),
        v)) {
...
OMR::Node::setZeroExtendTo64BitAtSource(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting zeroExtendTo64BitAtSource flag on node %p to "
        "%d\n",
        self(),
        v)) {
...
OMR::Node::getExtendedChild(int32_t c)
{
  TR_ASSERT(self()->hasNodeExtension() &&
              c < _unionBase._extension.getNumElems(),
...
OMR::Node::get32bitIntegralValue()
{
  ...
  if (type.isInt32())
    ...
    TR_ASSERT(false,
              "Must be an <= size 4 integral but it is type %s",
...
OMR::Node::set64bitIntegralValue(int64_t value)
{
  ...
  if (type.isInt8())
    ...
    TR_ASSERT(false,
              "Must be an integral value but it is type %s",
              self()->getDataType().toString());
  }
}
...
OMR::Node::get64bitIntegralValueAsUnsigned()
{
  ...
  if (type.isInt8())
    ...
    TR_ASSERT(false,
              "Must be an integral or address but it is type %s",
              self()->getDataType().toString());
    return 0;
  }
...
void
OMR::Node::copyNodeExtension(TR::NodeExtension* other,
                             uint16_t numElems,
                             size_t size)
{
  TR::Compilation* comp = TR::comp();
...
OMR::Node::freeExtensionIfExists()
{
  if (self()->hasNodeExtension()) {
    ...
    for (uint16_t childNum = 0;
         (childNum < NUM_DEFAULT_CHILDREN && childNum < numElems);
         childNum++) {
...
OMR::Node::getArrayCopyElementType()
{
  ...
  if (_numChildren == 3) {
    return static_cast<TR::DataTypes>(
      _unionBase._extension.getExtensionPtr()->getElem<uint32_t>(_numChildren));
  } else {
...
OMR::Node::setRelocationDestination(uint32_t n, void* p)
{
  self()->freeExtensionIfExists();
  return (
    _unionBase._unionedWithChildren._relocationInfo._relocationDestination[n] =
      p);
}
...
OMR::Node::computeDataType()
{
  ...
  TR_ASSERT(
    self()->hasDataType(),
    "attempting to access _dataType field for node %s %p that does not have it",
    self()->getOpCode().getName(),
    self());
  ...
  if (self()->getNumChildren() > 0) {
    ...
    if (_opCode.isVector()) {
      ...
      if (_opCode.isBooleanCompare())
        ...
        _unionPropertyA._dataType =
          self()->getFirstChild()->getDataType().scalarToVector().getDataType();
      else
        _unionPropertyA._dataType =
...
OMR::Node::setIsZero(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting nodeIsZero flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setIsNonZero(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting nodeIsNonZero flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setIsNonNull(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting nonNull flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setPointsToNull(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting nodePointsToNull flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setIsInvalid8BitGlobalRegister(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting invalid8BitGlobalRegister flag on node %p to "
        "%d\n",
        self(),
        v))
...
OMR::Node::setCannotOverflow(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting cannotOverflow flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setNOPLongStore(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting NOPLongStore flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setStoredValueIsIrrelevant(bool v)
{
  ...
  TR_ASSERT(
    ...
    "ends. If we wanted to reuse this query across front ends other than Java "
    "(which uses these kinds of stores for OSR) then we probably need to map "
    "it to a different bit in the OMR::Node flags");
  TR_ASSERT((self()->getOpCode().isStore() &&
             self()->getSymbolReference()->getSymbol()->isAutoOrParm()),
            "Opcode must be store to a stack slot");
  if (self()->getOpCode().isStore() &&
    ...
    if (performNodeTransformation2(
          c,
          "O^O NODE FLAGS: Setting StoredValueIsIrrelevant flag on node %p to "
          "%d\n",
          self(),
          v))
...
OMR::Node::setLiveMonitorInitStore(bool v)
{
  ...
  if (self()->getOpCode().hasSymbolReference() &&
      ...
      performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting liveMonitorInitStore flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setUseSignExtensionMode(bool b)
{
  ...
  if (self()->getOpCode().isLoadVar() && self()->getType().isInt32() &&
      performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting useSignExtensionMode flag on node %p to %d\n",
        self(),
        b)) {
...
OMR::Node::setHasFoldedImplicitNULLCHK(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting foldedImplicitNULLCHK flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setThrowInsertedByOSR(bool v)
{
  ...
  if (c->getOption(TR_EnableOSR) && (self()->getOpCodeValue() == TR::athrow)) {
    if (performNodeTransformation2(
          c,
          "O^O NODE FLAGS: Setting ThrowInsertedByOSR flag on node %p to %d\n",
          self(),
          v))
...
OMR::Node::setIsTheVirtualCallNodeForAGuardedInlinedCall()
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting virtualCallNodeForAGuardedInlinedCall flag on "
        "node %p\n",
        self()))
...
OMR::Node::resetIsTheVirtualCallNodeForAGuardedInlinedCall()
{
  ...
  if (performNodeTransformation1(
        c,
        "ReO^O NODE FLAGS: Setting virtualCallNodeForAGuardedInlinedCall flag "
        "on node %p\n",
        self()))
...
OMR::Node::setNodeIsRecognizedArrayCopyCall(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting nodeIsRecognizedArrayCopyCall flag on node %p "
        "to %d\n",
        self(),
        v))
...
OMR::Node::setContainsCompressionSequence(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting isCompressionSequence flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setIsInternalPointer(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting internalPointer flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setArrayTRT(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting arrayTRT flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setCharArrayTRT(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting charArrayTRT flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setSourceIsByteArrayTranslate(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting sourceIsByteArrayTranslate flag on node %p to "
        "%d\n",
        self(),
        v))
...
OMR::Node::setTargetIsByteArrayTranslate(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting targetIsByteArrayTranslate flag on node %p to "
        "%d\n",
        self(),
        v))
...
OMR::Node::setSourceCellIsTermChar(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting sourceCellIsTermChar flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setArrayCmpLen(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting arrayCmpLen flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setArrayCmpSign(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting arrayCmpSign flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setHalfWordElementArrayCopy(bool v)
{
  ...
  if (v) {
    if (performNodeTransformation2(
          c,
          "O^O NODE FLAGS: Setting halfWordElementArrayCopy flag on node %p to "
          "%d\n",
          self(),
          v))
...
OMR::Node::setRarePathForwardArrayCopy(bool v)
{
  ...
  if (v)
    TR_ASSERT(self()->isRarePathForwardArrayCopy() &&
                self()->isForwardArrayCopy() && !self()->isBackwardArrayCopy(),
              "assertion failure");
  else
    TR_ASSERT(!self()->isRarePathForwardArrayCopy() &&
...
OMR::Node::setNoArrayStoreCheckArrayCopy(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting noArrayStoreCheckArrayCopy flag on node %p to "
        "%d\n",
        self(),
        v))
...
OMR::Node::setIsHeapObjectWrtBar(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting heapObjectWrtBar flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setIsNodeCreatedByPRE()
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting nodeCreatedByPRE flag on node %p\n",
        self()))
...
OMR::Node::resetIsNodeCreatedByPRE()
{
  ...
  if (performNodeTransformation1(
        c,
        "ReO^O NODE FLAGS: Setting nodeCreatedByPRE flag on node %p\n",
        self()))
...
OMR::Node::setIsMaxLoopIterationGuard(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting maxLoopIterationGuard flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setIsProfiledGuard()
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting inlineProfiledGuard flag on node %p\n",
        self()))
...
OMR::Node::setIsInterfaceGuard()
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting inlineInterfaceGuard flag on node %p\n",
        self()))
...
OMR::Node::setIsAbstractGuard()
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting inlineAbstractGuard flag on node %p\n",
        self()))
...
OMR::Node::setIsHierarchyGuard()
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting inlineHierarchyGuard flag on node %p\n",
        self()))
...
OMR::Node::setIsMutableCallSiteTargetGuard()
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting mutableCallSiteTargetGuard flag on node %p\n",
        self()))
...
OMR::Node::setIsMethodEnterExitGuard(bool b)
{
  ...
  if (b &&
      performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting methodEnterExitGuard flag to %d on node %p\n",
        b,
        self()))
...
OMR::Node::setIsBreakpointGuard()
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting breakpoint guard flag on node %p\n",
        self()))
...
OMR::Node::setSwappedChildren(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting swappedChildren flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setIsVersionableIfWithMaxExpr(TR::Compilation* c)
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting versionIfWithMaxExpr flag on node %p\n",
        self()))
...
OMR::Node::setIsVersionableIfWithMinExpr(TR::Compilation* c)
{
  ...
  if (performNodeTransformation1(
        c,
        "O^O NODE FLAGS: Setting versionIfWithMinExpr flag on node %p\n",
        self()))
...
OMR::Node::setStoreAlreadyEvaluated(bool b)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting storeAlreadyEvaluated flag on node %p to %d\n",
        self(),
        b))
...
OMR::Node::setIsHighWordZero(bool b)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting highWordZero flag on node %p to %d\n",
        self(),
        b))
...
OMR::Node::setUnsigned(bool b)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting unsigned flag on node %p to %d\n",
        self(),
        b))
...
OMR::Node::setIsClassPointerConstant(bool b)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting classPointerConstant flag on node %p to %d\n",
        self(),
        b))
...
OMR::Node::setIsMethodPointerConstant(bool b)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting methodPointerConstant flag on node %p to %d\n",
        self(),
        b))
...
OMR::Node::setUnneededIALoad(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting unneededIALoad flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setSkipSync(bool v)
{
  ...
  if (performTransformation(
        c,
        "O^O NODE FLAGS: Setting skipSync flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setStaticMonitor(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting staticMonitor flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setReadMonitor(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting readMonitor flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setCanSkipZeroInitialization(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting skipZeroInit flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setCannotTrackLocalUses(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting cannotTrack flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setOmitSync(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting omitSync flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setSimpleDivCheck(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting simpleDivCheck flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::setNormalizedShift(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting normalizedShift flag on node %p to %d\n",
        self(),
        v))
...
OMR::Node::oneParentSupportsLazyClobber(TR::Compilation* comp)
{
  if (self()->getOpCode().isConversion() && self()->getReferenceCount() <= 1 &&
      performTransformation(
        comp,
        "O^O LAZY CLOBBERING: setParentSupportsLazyClobber(%s)\n",
...
OMR::Node::setAlignTLHAlloc(bool v)
{
  ...
  if (performNodeTransformation2(
        c,
        "O^O NODE FLAGS: Setting align on TLH flag on node %p to %d\n",
        self(),
        v))
