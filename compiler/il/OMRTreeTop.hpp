...
public:
  ...
  static TR::TreeTop* createIncTree(TR::Compilation* comp,
                                    TR::Node*,
                                    TR::SymbolReference*,
                                    int32_t incAmount,
                                    TR::TreeTop* precedingTreeTop = NULL,
                                    bool isRecompCounter = false);
  static TR::TreeTop* createResetTree(TR::Compilation* comp,
                                      TR::Node*,
                                      TR::SymbolReference*,
                                      int32_t resetAmount,
                                      TR::TreeTop* precedingTreeTop = NULL,
  ...
  static void removeDeadTrees(TR::Compilation* comp,
                              TR::TreeTop* first,
                              TR::TreeTop* last);
  ...
  explicit TreeTop(TR::Node* node = NULL,
                   TR::TreeTop* next = NULL,
                   TR::TreeTop* prev = NULL)
    : _pNext(next)
    , _pPrev(prev)
  ...
  bool adjustBranchOrSwitchTreeTop(TR::Compilation*,
                                   TR::TreeTop*,
                                   TR::TreeTop*);
