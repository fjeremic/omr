...
public:
  ...
  TR_LinkageConventions getLinkageConvention()
  {
    return _linkageConvention;
  }
  void setLinkage(TR_LinkageConventions lc)
  {
  ...
  bool isVirtual()
  {
    return _methodFlags.testValue(MethodKindMask, Virtual);
  }
  void setVirtual()
  {
    _methodFlags.setValue(MethodKindMask, Virtual);
  }

  void setInterface()
  {
    _methodFlags.setValue(MethodKindMask, Interface);
  }
  bool isInterface()
  {
  ...
  void setStatic()
  {
    _methodFlags.setValue(MethodKindMask, Static);
  }
  bool isStatic()
  {
    return _methodFlags.testValue(MethodKindMask, Static);
  }

  void setSpecial()
  {
    _methodFlags.setValue(MethodKindMask, Special);
  }
  bool isSpecial()
  {
    return _methodFlags.testValue(MethodKindMask, Special);
  }

  void setHelper()
  {
    _methodFlags.setValue(MethodKindMask, Helper);
  }
  bool isHelper()
  {
    return _methodFlags.testValue(MethodKindMask, Helper);
  }
  ...
  Kinds getMethodKind()
  {
    return (Kinds)_methodFlags.getValue(MethodKindMask);
  }
  ...
  void setPreservesAllRegisters()
  {
    _methodFlags.set(PreservesAllRegisters);
  }
  ...
  void setSystemLinkageDispatch()
  {
    _methodFlags.set(SystemLinkageDispatch);
  }

  bool isInterpreted()
  {
    return _methodFlags.testAny(Interpreted);
  }
  void setInterpreted(bool b = true)
  {
    _methodFlags.set(Interpreted, b);
  }

  void setSynchronised()
  {
    _methodFlags.set(Synchronised);
  }
  void setUnsynchronised()
  {
    _methodFlags.reset(Synchronised);
  }
  bool isSynchronised()
  {
    return _methodFlags.testAny(Synchronised);
  }

  void setEHAware()
  {
    _methodFlags.set(EHAware);
  }
  bool isEHAware()
  {
    return _methodFlags.testAny(EHAware);
  }

  void setNonReturning()
  {
    _methodFlags.set(NonReturning);
  }
  bool isNonReturning()
  {
    return _methodFlags.testAny(NonReturning);
  }

  void setJNI()
  {
    _methodFlags.set(JNI);
  }
  ...
  bool isJNI()
  {
    return _methodFlags.testAny(JNI);
  }
  bool isVMInternalNative()
  {
    return _methodFlags.testAny(VMInternalNative);
  }
  bool isJITInternalNative()
  {
    return _methodFlags.testAny(JITInternalNative);
  }
  bool isNative()
  {
  ...
  void setIsInlinedByCG()
  {
    _methodFlags.set(InlinedByCG);
  }
  bool isInlinedByCG()
  {
    return _methodFlags.testAny(InlinedByCG);
  }
