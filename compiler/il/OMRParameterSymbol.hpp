...
public:
  ...
  void setOrdinal(int32_t o)
  {
    _ordinal = o;
  }

  int8_t getLinkageRegisterIndex()
  {
    return _registerIndex;
  }
  void setLinkageRegisterIndex(int8_t li)
  {
    _registerIndex = li;
  }
  bool isParmPassedInRegister()
  {
    return (_registerIndex >= 0) ? true : false;
  }
   ...
   */
  int8_t getAssignedGlobalRegisterIndex()
  {
    return _allocatedHigh;
  }
   ...
   */
  void setAssignedGlobalRegisterIndex(int8_t gr)
  {
    _allocatedHigh = gr;
  }
   ...
   */
  int8_t getAssignedHighGlobalRegisterIndex()
  {
    return _allocatedHigh;
  }
   ...
   * @param[in] gr : the global register index
   */
  void setAssignedHighGlobalRegisterIndex(int8_t gr)
  {
    _allocatedHigh = gr;
  }
   ...
   *         a global register index has not been assigned.
   */
  int8_t getAssignedLowGlobalRegisterIndex()
  {
    return _allocatedLow;
  }
   ...
   * @param[in] gr : the global register index
   */
  void setAssignedLowGlobalRegisterIndex(int8_t gr)
  {
    _allocatedLow = gr;
  }
  ...
  void setFixedType(void* t)
  {
    _fixedType = t;
  }

  bool getIsPreexistent()
  {
    return _isPreexistent;
  }
  void setIsPreexistent(bool t)
  {
    _isPreexistent = t;
  }
  ...
  void setKnownObjectIndex(TR::KnownObjectTable::Index i)
  {
    _knownObjectIndex = i;
  }
