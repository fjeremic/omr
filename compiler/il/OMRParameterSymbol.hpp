...
public:
  ...
  template<typename AllocatorType>
  static TR::ParameterSymbol* create(AllocatorType,
                                     TR::DataType,
                                     int32_t,
                                     size_t);
  ...
  /**
   * @brief Sets the high global register index assigned to this parameter
   * symbol.
   * @param[in] gr : the global register index
   */
  ...
  /**
   * @brief Sets the low global register index assigned to this parameter
   * symbol.
   * @param[in] gr : the global register index
   */
