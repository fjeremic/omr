...
private:
  ...
  template <class... ChildrenAndSymRefType>
  static TR::Node *
  createWithSymRefInternal(TR::ILOpCodes op, uint16_t numChildren,
                           uint16_t numChildArgs, TR::Node *first,
                           ChildrenAndSymRefType... childrenAndSymRef);
...
public:
  ...
  static TR::Node *recreateWithoutProperties(TR::Node *originalNode,
                                             ...
                                             TR::SymbolReference *symRef);
  static TR::Node *
  recreateWithoutProperties(TR::Node *originalNode, TR::ILOpCodes op,
                            uint16_t numChildren, TR::Node *first,
                            TR::Node *second, TR::Node *third, TR::Node *fourth,
  ...
  recreateWithoutProperties(TR::Node *originalNode, TR::ILOpCodes op,
                            ...
                            TR::Node *second, TR::Node *third, TR::Node *fourth,
                            TR::Node *fifth, TR::Node *sixth, TR::Node *seventh,
                            TR::Node *eighth, TR::SymbolReference *symRef);
   ...
   */
  static TR::Node *
  createPotentialOSRPointHelperCallInILGen(TR::Node *originatingByteCodeNode,
                                           int32_t offset);
  /**
   * \brief
   ...
   */
  static TR::Node *
  createOSRFearPointHelperCall(TR::Node *originatingByteCodeNode);
  ...
  static TR::Node *
  createRelative32BitFenceNode(TR::Node *originatingByteCodeNode, void *);
...
private:
  ...
  static TR::Node *
  recreateAndCopyValidPropertiesImpl(TR::Node *originalNode, TR::ILOpCodes op,
                                     TR::SymbolReference *newSymRef);
...
public:
  ...
  setHighGlobalRegisterNumber(TR_GlobalRegisterNumber i);
  ...
  enum {
    ...
    referenceIsNonNull =
        0x00008000, ///< Sometimes we can't mark the child as non-null (because
                    ///< it's not provably non-null everywhere) but we know it's
