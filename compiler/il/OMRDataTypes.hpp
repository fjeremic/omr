...
enum TR_RawBCDSignCode {
  ...
  raw_bcd_sign_0xd = 2,
  raw_bcd_sign_0xf = 3,
  last_raw_bcd_sign = raw_bcd_sign_0xf, // NOTE: the TR_RawBCDSignCode fields in Node::DecimalInfo are 3 bits so the max
                                        // value for a raw_bcd_sign_* is 7 (enum range is -8->7)
...
public:
  ...
  TR::DataTypes getDataType() const
  {
    return _type;
  }
