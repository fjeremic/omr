...
enum TR_SharedCacheHint {
  ...
  TR_HintLargeMemoryMethodW =
      0x1000, // Compilation at warm requires large amount of JIT scratch memory
              // Used to contain footprint during startup by inhibiting AOT
              // forced upgrades at warm instead of cold
...
template <> inline int64_t getMinSigned<TR::Int32>() {
  return ((int32_t)0X80000000);
}
template <> inline int64_t getMinSigned<TR::Int64>() {
...
template <> inline uint64_t getMinUnsigned<TR::Int32>() {
  return ((uint32_t)0);
}
template <> inline uint64_t getMinUnsigned<TR::Int64>() {
  return ((uint64_t)0);
}

template <> inline int64_t getMaxSigned<TR::Int8>() { return 127; }
template <> inline int64_t getMaxSigned<TR::Int16>() { return 32767; }
template <> inline int64_t getMaxSigned<TR::Int32>() {
...
template <> inline uint64_t getMaxUnsigned<TR::Int32>() {
  return ((uint32_t)0xFFFFFFFF);
}
template <> inline uint64_t getMaxUnsigned<TR::Int64>() {
  return ((uint64_t)-1);
}
...
public:
  ...
  template <typename T> static bool isInt32() {
...
template <> inline bool OMR::DataType::isUnsignedInt8<uint8_t>() {
  return true;
}
template <> inline bool OMR::DataType::isUnsignedInt16<uint16_t>() {
  return true;
}
template <> inline bool OMR::DataType::isUnsignedInt32<uint32_t>() {
  return true;
}
template <> inline bool OMR::DataType::isUnsignedInt64<uint64_t>() {
  return true;
}
