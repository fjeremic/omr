...
enum TR_RawBCDSignCode
{
  ...
  raw_bcd_sign_0xf = 3,
  last_raw_bcd_sign =
    raw_bcd_sign_0xf, // NOTE: the TR_RawBCDSignCode fields in Node::DecimalInfo
                      // are 3 bits so the max value for a raw_bcd_sign_* is 7
                      // (enum range is -8->7)
...
enum TR_SharedCacheHint
{
  ...
  TR_HintLargeMemoryMethodW =
    0x1000, // Compilation at warm requires large amount of JIT scratch memory
  ...
  TR_HintLargeMemoryMethodC =
    0x2000, // Compilation at cold requires large amount of JIT scratch memory
...
template<>
inline int64_t
getMinSigned<TR::Int8>()
{
  return -128;
}
template<>
inline int64_t
getMinSigned<TR::Int16>()
{
  return -32768;
}
template<>
inline int64_t
getMinSigned<TR::Int32>()
{
  return ((int32_t)0X80000000);
}
template<>
inline int64_t
getMinSigned<TR::Int64>()
{
...
template<>
inline uint64_t
getMinUnsigned<TR::Int8>()
{
  return 0;
}
template<>
inline uint64_t
getMinUnsigned<TR::Int16>()
{
  return 0;
}
template<>
inline uint64_t
getMinUnsigned<TR::Int32>()
{
  return ((uint32_t)0);
}
template<>
inline uint64_t
getMinUnsigned<TR::Int64>()
{
  return ((uint64_t)0);
}
...
template<>
inline int64_t
getMaxSigned<TR::Int8>()
{
  return 127;
}
template<>
inline int64_t
getMaxSigned<TR::Int16>()
{
  return 32767;
}
template<>
inline int64_t
getMaxSigned<TR::Int32>()
{
  return ((int32_t)0X7FFFFFFF);
}
template<>
inline int64_t
getMaxSigned<TR::Int64>()
{
  return (
...
template<>
inline uint64_t
getMaxUnsigned<TR::Int8>()
{
  return 255;
}
template<>
inline uint64_t
getMaxUnsigned<TR::Int16>()
{
  return 65535;
}
template<>
inline uint64_t
getMaxUnsigned<TR::Int32>()
{
  return ((uint32_t)0xFFFFFFFF);
}
template<>
inline uint64_t
getMaxUnsigned<TR::Int64>()
{
  return ((uint64_t)-1);
}
...
template<>
inline int32_t
getMaxSignedPrecision<TR::Int8>()
{
  return 3;
}
template<>
inline int32_t
getMaxSignedPrecision<TR::Int16>()
{
  return 5;
}
template<>
inline int32_t
getMaxSignedPrecision<TR::Int32>()
{
  return 10;
}
template<>
inline int32_t
getMaxSignedPrecision<TR::Int64>()
{
  return 19;
}
...
template<>
inline int32_t
getMaxUnsignedPrecision<TR::Int8>()
{
  return 3;
}
template<>
inline int32_t
getMaxUnsignedPrecision<TR::Int16>()
{
  return 5;
}
template<>
inline int32_t
getMaxUnsignedPrecision<TR::Int32>()
{
  return 10;
}
template<>
inline int32_t
getMaxUnsignedPrecision<TR::Int64>()
{
  return 20;
}
...
template<>
inline bool
OMR::DataType::isSignedInt8<int8_t>()
{
  return true;
}
template<>
inline bool
OMR::DataType::isSignedInt16<int16_t>()
{
  return true;
}
template<>
inline bool
OMR::DataType::isSignedInt32<int32_t>()
{
  return true;
}
template<>
inline bool
OMR::DataType::isSignedInt64<int64_t>()
{
  return true;
}
...
template<>
inline bool
OMR::DataType::isUnsignedInt8<uint8_t>()
{
  return true;
}
template<>
inline bool
OMR::DataType::isUnsignedInt16<uint16_t>()
{
  return true;
}
template<>
inline bool
OMR::DataType::isUnsignedInt32<uint32_t>()
{
  return true;
}
template<>
inline bool
OMR::DataType::isUnsignedInt64<uint64_t>()
{
  return true;
}
