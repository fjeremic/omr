...
template <typename T>
T pointer_cast(void* p) { return static_cast<T>(p); }
...
template <>
inline int64_t getMinSigned<TR::Int8>() { return -128; }
template <>
inline int64_t getMinSigned<TR::Int16>() { return -32768; }
template <>
inline int64_t getMinSigned<TR::Int32>() { return ((int32_t)0X80000000); }
template <>
inline int64_t getMinSigned<TR::Int64>() { return (((int64_t)1) << 63) /**< -9223372036854775808 */; }

template <>
inline uint64_t getMinUnsigned<TR::Int8>() { return 0; }
template <>
inline uint64_t getMinUnsigned<TR::Int16>() { return 0; }
template <>
inline uint64_t getMinUnsigned<TR::Int32>() { return ((uint32_t)0); }
template <>
inline uint64_t getMinUnsigned<TR::Int64>() { return ((uint64_t)0); }

template <>
inline int64_t getMaxSigned<TR::Int8>() { return 127; }
template <>
inline int64_t getMaxSigned<TR::Int16>() { return 32767; }
template <>
inline int64_t getMaxSigned<TR::Int32>() { return ((int32_t)0X7FFFFFFF); }
template <>
inline int64_t getMaxSigned<TR::Int64>() { return ((int64_t)(((uint64_t)((int64_t)-1)) >> 1)) /**<  9223372036854775807 */; }

template <>
inline uint64_t getMaxUnsigned<TR::Int8>() { return 255; }
template <>
inline uint64_t getMaxUnsigned<TR::Int16>() { return 65535; }
template <>
inline uint64_t getMaxUnsigned<TR::Int32>() { return ((uint32_t)0xFFFFFFFF); }
template <>
inline uint64_t getMaxUnsigned<TR::Int64>() { return ((uint64_t)-1); }

template <>
inline int32_t getMaxSignedPrecision<TR::Int8>() { return 3; }
template <>
inline int32_t getMaxSignedPrecision<TR::Int16>() { return 5; }
template <>
inline int32_t getMaxSignedPrecision<TR::Int32>() { return 10; }
template <>
inline int32_t getMaxSignedPrecision<TR::Int64>() { return 19; }

template <>
inline int32_t getMaxUnsignedPrecision<TR::Int8>() { return 3; }
template <>
inline int32_t getMaxUnsignedPrecision<TR::Int16>() { return 5; }
template <>
inline int32_t getMaxUnsignedPrecision<TR::Int32>() { return 10; }
template <>
inline int32_t getMaxUnsignedPrecision<TR::Int64>() { return 20; }
...
public:
    ...
    template <typename T>
    static bool isSignedInt8() { return false; }
    template <typename T>
    static bool isSignedInt16() { return false; }
    template <typename T>
    static bool isSignedInt32() { return false; }
    template <typename T>
    static bool isSignedInt64() { return false; }
    template <typename T>
    static bool isSignedInt() { return isSignedInt8<T>() || isSignedInt16<T>() || isSignedInt32<T>() || isSignedInt64<T>(); }
    template <typename T>
    static bool isInt32() { return isSignedInt32<T>() || isUnsignedInt32<T>(); }

    template <typename T>
    static bool isUnsignedInt8() { return false; }
    template <typename T>
    static bool isUnsignedInt16() { return false; }
    template <typename T>
    static bool isUnsignedInt32() { return false; }
    template <typename T>
    static bool isUnsignedInt64() { return false; }
    template <typename T>
    static bool isUnsignedInt() { return isUnsignedInt8<T>() || isUnsignedInt16<T>() || isUnsignedInt32<T>() || isUnsignedInt64<T>(); }
...
template <>
inline bool OMR::DataType::isSignedInt8<int8_t>() { return true; }
template <>
inline bool OMR::DataType::isSignedInt16<int16_t>() { return true; }
template <>
inline bool OMR::DataType::isSignedInt32<int32_t>() { return true; }
template <>
inline bool OMR::DataType::isSignedInt64<int64_t>() { return true; }

template <>
inline bool OMR::DataType::isUnsignedInt8<uint8_t>() { return true; }
template <>
inline bool OMR::DataType::isUnsignedInt16<uint16_t>() { return true; }
template <>
inline bool OMR::DataType::isUnsignedInt32<uint32_t>() { return true; }
template <>
inline bool OMR::DataType::isUnsignedInt64<uint64_t>() { return true; }
