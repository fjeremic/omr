...
public:
  ...
  void init(TR::SymbolReferenceTable* symRefTab, uint32_t refNumber, TR::Symbol* sym = 0, intptrj_t offset = 0,
  ...
  TR::Symbol* setSymbol(TR::Symbol* ps)
  {
    return (_symbol = ps);
  }

  TR_ExtraInfoForNew* getExtraInfo()
  {
    return _extraInfo;
  }
  void setExtraInfo(TR_ExtraInfoForNew* info)
  {
    _extraInfo = info;
  }
  ...
  void setOffset(intptrj_t o)
  {
    _offset = o;
  }
  void addToOffset(intptrj_t o)
  {
    _offset += o;
  }
  ...
  mcount_t getOwningMethodIndex()
  {
    return _owningMethodIndex;
  }
  void setOwningMethodIndex(mcount_t i)
  {
    _owningMethodIndex = i;
  }

  void setCPIndex(int32_t i)
  {
    _cpIndex = i;
  }
  int32_t getCPIndex()
  ...
  int32_t getUnresolvedIndex()
  {
    return _unresolvedIndex;
  }
  ...
  int32_t setReferenceNumber(int32_t n)
  {
    return (_referenceNumber = n);
  }
  ...
  bool isUnresolved()
  {
    return _flags.testAny(Unresolved);
  }

  void setCanGCandReturn()
  {
    _flags.set(CanGCandReturn);
  }
  bool canGCandReturn()
  {
    return _flags.testAny(CanGCandReturn);
  }
  void setCanGCandExcept()
  {
    _flags.set(CanGCandExcept);
  }
  bool canGCandExcept()
  {
    return _flags.testAny(CanGCandExcept);
  }
  bool canCauseGC();

  void setReallySharesSymbol()
  {
    _flags.set(ReallySharesSymbol);
  }
  bool reallySharesSymbol()
  {
    return _flags.testAny(ReallySharesSymbol);
  }

  void setStackAllocatedArrayAccess()
  {
    _flags.set(StackAllocatedArrayAccess);
  }
  bool stackAllocatedArrayAccess()
  {
    return _flags.testAny(StackAllocatedArrayAccess);
  }

  void setSideEffectInfo()
  {
    _flags.set(SideEffectInfo);
  }
  bool isSideEffectInfo()
  {
    return _flags.testAny(SideEffectInfo);
  }

  void setLiteralPoolAddress()
  {
    _flags.set(LiteralPoolAddress);
  }
  bool isLiteralPoolAddress()
  {
    return _flags.testAny(LiteralPoolAddress);
  }
  void setFromLiteralPool()
  {
    _flags.set(FromLiteralPool);
  }
  bool isFromLiteralPool()
  {
    return _flags.testAny(FromLiteralPool);
  }
  bool isLitPoolReference();

  void setOverriddenBitAddress()
  {
    _flags.set(OverriddenBitAddress);
  }
  bool isOverriddenBitAddress()
  {
    return _flags.testAny(OverriddenBitAddress);
  }

  void setInitMethod()
  {
    _flags.set(InitMethod);
  }
  bool isInitMethod()
  {
    return _flags.testAny(InitMethod);
  }

  void setIsTempVariableSizeSymRef()
  {
    _flags.set(TempVariableSizeSymRef);
  }
  bool isTempVariableSizeSymRef()
  {
    return _flags.testAny(TempVariableSizeSymRef);
  }
  ...
  bool isDual()
  {
    return _flags.testAny(Dual);
  }

  void setHasTemporaryNegativeOffset()
  {
    _flags.set(TemporaryNegativeOffset);
  }
  void resetHasTemporaryNegativeOffset()
  {
    _flags.reset(TemporaryNegativeOffset);
  }
  bool hasTemporaryNegativeOffset()
  {
    return _flags.testAny(TemporaryNegativeOffset);
  }

  void setHoldsMonitoredObjectForSyncMethod()
  {
    _flags.set(HoldsMonitoredObjectForSyncMethod);
  }
  bool holdsMonitoredObjectForSyncMethod()
  {
    return _flags.testAny(HoldsMonitoredObjectForSyncMethod);
  }
...
public:
  ...
  TR::SymbolReference* getNext()
  {
    return hasMoreElements() ? _symRefTab->getSymRef(getNextElement()) : 0;
  }
