...
class OMR_EXTENSIBLE SymbolReference {
 public:
  ...
  TR_UseDefAliasSetInterface getUseDefAliasesIncludingGCSafePoint(
 ...
 protected:
  ...
  uint32_t _referenceNumber;  ///< Unique number identifying this
                              ///< SymbolReference in the symbol table
