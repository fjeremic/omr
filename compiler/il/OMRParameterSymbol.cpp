...
OMR::ParameterSymbol::ParameterSymbol(TR::DataType d, int32_t slot, size_t size)
    : TR::RegisterMappedSymbol(
          d,
          (uint32_t)
              size),  // cast argument size explicitly \TODO: Document why?
      _registerIndex(-1),
      _allocatedHigh(-1),
      _allocatedLow(-1),
      _fixedType(0),
...
template TR::ParameterSymbol* OMR::ParameterSymbol::create(TR_StackMemory,
                                                           TR::DataType,
                                                           int32_t);
template TR::ParameterSymbol* OMR::ParameterSymbol::create(TR_StackMemory,
                                                           TR::DataType,
                                                           int32_t,
                                                           size_t);
template TR::ParameterSymbol* OMR::ParameterSymbol::create(TR_HeapMemory,
                                                           TR::DataType,
                                                           int32_t);
template TR::ParameterSymbol* OMR::ParameterSymbol::create(TR_HeapMemory,
                                                           TR::DataType,
...
template TR::ParameterSymbol* OMR::ParameterSymbol::create(
