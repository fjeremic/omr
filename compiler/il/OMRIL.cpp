...
static_assert(TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForConst) /
                                  sizeof(OMR::IL::opCodesForConst[0])),
              "OMR::IL::opCodesForConst is not the correct size");

static_assert(TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForDirectLoad) /
                                  sizeof(OMR::IL::opCodesForDirectLoad[0])),
              "OMR::IL::opCodesForDirectLoad is not the correct size");

static_assert(TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForDirectStore) /
                                  sizeof(OMR::IL::opCodesForDirectStore[0])),
              "OMR::IL::opCodesForDirectStore is not the correct size");

static_assert(TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForIndirectLoad) /
                                  sizeof(OMR::IL::opCodesForIndirectLoad[0])),
              "OMR::IL::opCodesForIndirectLoad is not the correct size");

static_assert(TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForIndirectStore) /
                                  sizeof(OMR::IL::opCodesForIndirectStore[0])),
              "OMR::IL::opCodesForIndirectStore is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForIndirectArrayLoad) /
                   sizeof(OMR::IL::opCodesForIndirectArrayLoad[0])),
              "OMR::IL::opCodesForIndirectArrayLoad is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForIndirectArrayStore) /
                   sizeof(OMR::IL::opCodesForIndirectArrayStore[0])),
              "OMR::IL::opCodesForIndirectArrayStore is not the correct size");

static_assert(TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForRegisterLoad) /
                                  sizeof(OMR::IL::opCodesForRegisterLoad[0])),
              "OMR::IL::opCodesForRegisterLoad is not the correct size");

static_assert(TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForRegisterStore) /
                                  sizeof(OMR::IL::opCodesForRegisterStore[0])),
              "OMR::IL::opCodesForRegisterStore is not the correct size");

static_assert(TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForCompareEquals) /
                                  sizeof(OMR::IL::opCodesForCompareEquals[0])),
              "OMR::IL::opCodesForCompareEquals is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForIfCompareEquals) /
                   sizeof(OMR::IL::opCodesForIfCompareEquals[0])),
              "OMR::IL::opCodesForIfCompareEquals is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForCompareNotEquals) /
                   sizeof(OMR::IL::opCodesForCompareNotEquals[0])),
              "OMR::IL::opCodesForCompareNotEquals is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForIfCompareNotEquals) /
                   sizeof(OMR::IL::opCodesForIfCompareNotEquals[0])),
              "OMR::IL::opCodesForIfCompareNotEquals is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForCompareLessThan) /
                   sizeof(OMR::IL::opCodesForCompareLessThan[0])),
              "OMR::IL::opCodesForCompareLessThan is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForCompareLessOrEquals) /
                   sizeof(OMR::IL::opCodesForCompareLessOrEquals[0])),
              "OMR::IL::opCodesForCompareLessThan is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForIfCompareLessThan) /
                   sizeof(OMR::IL::opCodesForIfCompareLessThan[0])),
              "OMR::IL::opCodesForIfCompareLessThan is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForIfCompareLessOrEquals) /
                   sizeof(OMR::IL::opCodesForIfCompareLessOrEquals[0])),
              "OMR::IL::opCodesForIfCompareLessThan is not the correct size");

static_assert(TR::NumOMRTypes ==
                  (sizeof(OMR::IL::opCodesForCompareGreaterThan) /
                   sizeof(OMR::IL::opCodesForCompareGreaterThan[0])),
...
static_assert(
    TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForIfCompareGreaterThan) /
                        sizeof(OMR::IL::opCodesForIfCompareGreaterThan[0])),
    "OMR::IL::opCodesForIfCompareGreaterThan is not the correct size");

static_assert(
    TR::NumOMRTypes == (sizeof(OMR::IL::opCodesForIfCompareGreaterOrEquals) /
                        sizeof(OMR::IL::opCodesForIfCompareGreaterOrEquals[0])),
    "OMR::IL::opCodesForIfCompareGreaterThan is not the correct size");

TR::ILOpCodes OMR::IL::opCodeForCorrespondingIndirectLoad(
  ...
  switch (loadOpCode) {
    ...
    case TR::drdbari:
    case TR::ardbari:
      // There is not necessarily a guaranteed symmetry about whether an
      // indirect rdbar should be mapped to an indirect wrtbar or a normal
      // indirect store. The mapping of rdbar/ wrtbar totally depends on the
      // actual use in subprojects and should be undefined in OMR level.
      TR_ASSERT_FATAL(0,
                      "xrdbari can't be used with global opcode mapping API at "
                      "OMR level\n");
    default:
      break;
  }
...
TR::ILOpCodes OMR::IL::opCodeForCorrespondingIndirectStore(
  ...
  switch (storeOpCode) {
    ...
    case TR::dwrtbari:
      // There is not necessarily a guaranteed symmetry about whether an
      // indirect wrtbar should be mapped to an indirect rdbar or a normal
      // indirect load. The mapping of rdbar/wrtbar totally depends on the actual
      // use in subprojects and should be undefined in OMR level.
      TR_ASSERT_FATAL(0,
                      "xwrtbari can't be used with global opcode mapping API "
                      "at OMR level\n");
...
TR::ILOpCodes OMR::IL::opCodeForTernarySelect(TR::DataType dt) {
