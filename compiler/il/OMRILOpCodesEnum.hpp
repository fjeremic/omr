...
FirstOMROp,
    ...
    callIf, // Call symref if first child evaluates to true.  Other childrem are
    ...
    iternary, // Ternary Operator:  Based on the result of the first child, take
              // the value of the
    ...
    lucalli, // indirect call returning unsigned long integer (child1 is addr of
             // function)
    ...
    lusubh, // subtract 2 unsigned long integers (the high parts of prior lusub)
    ...
    ResolveCHK, // Resolve check a static, field or method. child 1 is reference
                // to be resolved. Symbolref indicates failure
                // action/destination
    ResolveAndNULLCHK, // Resolve check a static, field or method and Null check
                       // the underlying pointer.  child 1 is reference to be
                       // resolved. Symbolref indicates failure
                       // action/destination
    ...
    BNDCHK, // Array bounds check, checks that child 1 > child 2 >= 0 (child 1
            ...
            // action/destination
    ArrayCopyBNDCHK, // Array copy bounds check, checks that child 1 >= child 2.
                     // Symbolref indicates failure action/destination
    ...
    arraytranslateAndTest, // Inline code for scanning of part of an array for a
