...
public:
  ...
  {
    TR::Compilation* comp = TR::comp();
    TR_ASSERT(_aliasSetType == useDefAliasSet || _aliasSetType == UseOnlyAliasSet,
...
template <uint32_t _aliasSetType>
inline void TR_SymAliasSetInterface<_aliasSetType>::removeSymRef1KillsSymRef2Asymmetrically(
  TR::SymbolReference* symRef1, TR::SymbolReference* symRef2, bool includeGCSafePoint)
{
...
template <uint32_t _aliasSetType>
inline void TR_SymAliasSetInterface<_aliasSetType>::addSymRef1KillsSymRef2Asymmetrically(
  TR::SymbolReference* symRef1, TR::SymbolReference* symRef2, bool includeGCSafePoint)
{
  TR::Compilation* comp = TR::comp();
  TR_BitVector* symRef1_killedAliases = symRef1->getUseDefAliases(includeGCSafePoint).getTRAliases();
...
template <uint32_t _aliasSetType>
inline void TR_SymAliasSetInterface<_aliasSetType>::setSymRef1KillsSymRef2Asymmetrically(
  TR::SymbolReference* symRef1, TR::SymbolReference* symRef2, bool includeGCSafePoint, bool value)
{
  TR::Compilation* comp = TR::comp();
...
template <>
inline TR_BitVector* TR_SymAliasSetInterface<UseOnlyAliasSet>::getTRAliases_impl(
  bool isDirectCall, bool includeGCSafePoint)
{
  if (!_symbolReference)
