...
TR::TreeTop* OMR::TreeTop::createIncTree(TR::Compilation* comp,
                                         TR::Node* node,
...
TR::TreeTop* OMR::TreeTop::createResetTree(TR::Compilation* comp,
                                           TR::Node* node,
                                           TR::SymbolReference* symRef,
                                           int32_t resetAmount,
                                           TR::TreeTop* precedingTreeTop,
...
void OMR::TreeTop::removeDeadTrees(TR::Compilation* comp,
                                   TR::TreeTop* first,
                                   TR::TreeTop* last) {
...
OMR::TreeTop::TreeTop(TR::TreeTop* precedingTreeTop,
                      TR::Node* node,
                      TR::Compilation* c)
    : _pNode(node) {
