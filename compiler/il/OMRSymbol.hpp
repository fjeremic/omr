...
public:
  ...
  enum {
    ...
    SlotSharedByRefAndNonRef =
        0x00400000, ///< used in fsd to indicate that an reference symbol shares
                    ///< a slot with a nonreference symbol
    ...
    SpillTempLoaded =
        0x04000000, ///< share bit with loadaddr because spill temps will never
                    ///< have their address taken. Used to remove store to spill
                    ///< if never loaded
