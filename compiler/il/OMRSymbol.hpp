...
public:
  ...
  enum
  {
    ...
    SlotSharedByRefAndNonRef =
      0x00400000, ///< used in fsd to indicate that an reference symbol shares a
                  ///< slot with a nonreference symbol
    ...
    VariableSizeSymbol =
      0x01000000, ///< non-java only?: specially managed automatic symbols that
                  ///< contain both an activeSize and a size
