...
TR::MethodSymbol*
OMR::MethodSymbol::create(AllocatorType t,
...
template TR::MethodSymbol*
OMR::MethodSymbol::create(TR_HeapMemory t,
                          TR_LinkageConventions lc,
                          TR::Method* m);
template TR::MethodSymbol*
OMR::MethodSymbol::create(TR_StackMemory t,
                          TR_LinkageConventions lc,
                          TR::Method* m);
template TR::MethodSymbol*
OMR::MethodSymbol::create(PERSISTENT_NEW_DECLARE t,
                          TR_LinkageConventions lc,
                          TR::Method* m);
