...
TR::AutomaticSymbol*
OMR::AutomaticSymbol::create(AllocatorType t)
{
...
template<typename AllocatorType>
TR::AutomaticSymbol*
OMR::AutomaticSymbol::create(AllocatorType t, TR::DataType d)
{
...
template<typename AllocatorType>
TR::AutomaticSymbol*
OMR::AutomaticSymbol::create(AllocatorType t, TR::DataType d, uint32_t s)
{
...
template<typename AllocatorType>
TR::AutomaticSymbol*
OMR::AutomaticSymbol::createLocalObject(AllocatorType m,
                                        int32_t arrayType,
                                        TR::DataType d,
                                        uint32_t s,
                                        TR_FrontEnd* fe)
...
template<typename AllocatorType>
TR::AutomaticSymbol*
OMR::AutomaticSymbol::createInternalPointer(
  AllocatorType m,
...
template<typename AllocatorType>
TR::AutomaticSymbol*
OMR::AutomaticSymbol::createInternalPointer(AllocatorType m,
                                            TR::DataType d,
                                            uint32_t s,
                                            TR_FrontEnd* fe)
{
...
template<typename AllocatorType>
TR::AutomaticSymbol*
OMR::AutomaticSymbol::createVariableSized(AllocatorType m, uint32_t s)
{
...
OMR::AutomaticSymbol::createLocalObject(TR_HeapMemory m,
                                        int32_t arrayType,
                                        TR::DataType d,
                                        uint32_t s,
                                        TR_FrontEnd* fe);
...
OMR::AutomaticSymbol::createInternalPointer(
  ...
  TR::AutomaticSymbol* pinningArrayPointer);
template TR::AutomaticSymbol*
OMR::AutomaticSymbol::createInternalPointer(TR_HeapMemory m,
                                            TR::DataType d,
                                            uint32_t s,
                                            TR_FrontEnd* fe);
template TR::AutomaticSymbol*
...
template TR::AutomaticSymbol*
OMR::AutomaticSymbol::createLocalObject(TR_StackMemory m,
                                        int32_t arrayType,
                                        TR::DataType d,
                                        uint32_t s,
                                        TR_FrontEnd* fe);
...
OMR::AutomaticSymbol::createInternalPointer(
  ...
  TR::AutomaticSymbol* pinningArrayPointer);
template TR::AutomaticSymbol*
OMR::AutomaticSymbol::createInternalPointer(TR_StackMemory m,
                                            TR::DataType d,
                                            uint32_t s,
                                            TR_FrontEnd* fe);
template TR::AutomaticSymbol*
...
OMR::AutomaticSymbol::createInternalPointer(
  ...
  TR::AutomaticSymbol* pinningArrayPointer);
template TR::AutomaticSymbol*
OMR::AutomaticSymbol::createInternalPointer(PERSISTENT_NEW_DECLARE m,
                                            TR::DataType d,
                                            uint32_t s,
                                            TR_FrontEnd* fe);
template TR::AutomaticSymbol*
...
template TR::AutomaticSymbol* OMR::AutomaticSymbol::create(TR_StackMemory,
                                                           ...
                                                           uint32_t);
template TR::AutomaticSymbol*
OMR::AutomaticSymbol::create(TR_StackMemory,
                             TR::DataType,
                             uint32_t,
                             const char*);
...
template TR::AutomaticSymbol* OMR::AutomaticSymbol::create(TR_HeapMemory,
                                                           ...
                                                           uint32_t);
template TR::AutomaticSymbol*
OMR::AutomaticSymbol::create(TR_HeapMemory,
                             TR::DataType,
                             uint32_t,
                             const char*);
