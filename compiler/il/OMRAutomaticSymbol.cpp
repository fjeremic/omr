...
TR::SymbolReference *OMR::AutomaticSymbol::setClassSymbolReference(
...
TR::AutomaticSymbol *OMR::AutomaticSymbol::setPinningArrayPointer(
...
template <typename AllocatorType>
TR::AutomaticSymbol *OMR::AutomaticSymbol::createLocalObject(AllocatorType m,
                                                             int32_t arrayType,
                                                             TR::DataType d,
                                                             uint32_t s,
                                                             TR_FrontEnd *fe) {
...
template TR::AutomaticSymbol *OMR::AutomaticSymbol::createLocalObject(
    TR_HeapMemory m, int32_t arrayType, TR::DataType d, uint32_t s,
    TR_FrontEnd *fe);
template TR::AutomaticSymbol *OMR::AutomaticSymbol::createLocalObject(
...
template TR::AutomaticSymbol *OMR::AutomaticSymbol::createVariableSized(
    TR_HeapMemory m, uint32_t s);

template TR::AutomaticSymbol *OMR::AutomaticSymbol::createLocalObject(
    TR_StackMemory m, int32_t arrayType, TR::DataType d, uint32_t s,
    TR_FrontEnd *fe);
template TR::AutomaticSymbol *OMR::AutomaticSymbol::createLocalObject(
...
template TR::AutomaticSymbol *OMR::AutomaticSymbol::createVariableSized(
    TR_StackMemory m, uint32_t s);

template TR::AutomaticSymbol *OMR::AutomaticSymbol::createLocalObject(
    PERSISTENT_NEW_DECLARE m, int32_t arrayType, TR::DataType d, uint32_t s,
    TR_FrontEnd *fe);
template TR::AutomaticSymbol *OMR::AutomaticSymbol::createLocalObject(
...
template TR::AutomaticSymbol *OMR::AutomaticSymbol::createVariableSized(
    PERSISTENT_NEW_DECLARE m, uint32_t s);
...
template TR::AutomaticSymbol *OMR::AutomaticSymbol::create(
    PERSISTENT_NEW_DECLARE);
template TR::AutomaticSymbol *OMR::AutomaticSymbol::create(
    PERSISTENT_NEW_DECLARE, TR::DataType);
template TR::AutomaticSymbol *OMR::AutomaticSymbol::create(
    PERSISTENT_NEW_DECLARE, TR::DataType, uint32_t);
template TR::AutomaticSymbol *OMR::AutomaticSymbol::create(
    PERSISTENT_NEW_DECLARE, TR::DataType, uint32_t, const char *);
