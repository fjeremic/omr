...
void
OMR::VirtualMachineOperandArray::MergeInto(TR::VirtualMachineState* o,
                                           TR::IlBuilder* b)
{
...
void
OMR::VirtualMachineOperandArray::UpdateArray(TR::IlBuilder* b,
                                             TR::IlValue* array)
{
...
OMR::VirtualMachineOperandArray::MakeCopy()
{
  TR::VirtualMachineOperandArray* copy =
    (TR::VirtualMachineOperandArray*)TR::comp()->trMemory()->allocateHeapMemory(
...
void
OMR::VirtualMachineOperandArray::Move(TR::IlBuilder* b,
                                      int32_t dstIndex,
                                      int32_t srcIndex)
{
