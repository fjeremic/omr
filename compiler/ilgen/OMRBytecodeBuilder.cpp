  ...
  , _vmState(0)
{
  ...
  initialize(methodBuilder->details(),
             methodBuilder->methodSymbol(),
             methodBuilder->fe(),
...
OMR::BytecodeBuilder::AddFallThroughBuilder(TR::BytecodeBuilder* ftb)
{
  ...
  if (b != ftb)
    TraceIL(
      "IlBuilder[ %p ]:: fallThrough successor changed to [ %p ]\n", this, b);
...
OMR::BytecodeBuilder::setHandlerInfo(uint32_t catchType)
{
  ...
  catchBlock->setHandlerInfo(catchType,
                             comp()->getInlineDepth(),
                             -1,
...
void
OMR::BytecodeBuilder::IfCmpEqual(TR::BytecodeBuilder** dest,
                                 TR::IlValue* v1,
                                 TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpNotEqual(TR::BytecodeBuilder** dest,
                                    TR::IlValue* v1,
                                    TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpNotEqualZero(TR::BytecodeBuilder** dest,
                                        TR::IlValue* c)
{
  if (*dest == NULL)
    *dest = _methodBuilder->OrphanBytecodeBuilder(_bcIndex, _name);
...
void
OMR::BytecodeBuilder::IfCmpLessThan(TR::BytecodeBuilder** dest,
                                    TR::IlValue* v1,
                                    TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpUnsignedLessThan(TR::BytecodeBuilder** dest,
                                            TR::IlValue* v1,
                                            TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpLessOrEqual(TR::BytecodeBuilder** dest,
                                       TR::IlValue* v1,
                                       TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpUnsignedLessOrEqual(TR::BytecodeBuilder** dest,
                                               TR::IlValue* v1,
                                               TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpGreaterThan(TR::BytecodeBuilder** dest,
                                       TR::IlValue* v1,
                                       TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpUnsignedGreaterThan(TR::BytecodeBuilder** dest,
                                               TR::IlValue* v1,
                                               TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpGreaterOrEqual(TR::BytecodeBuilder** dest,
                                          TR::IlValue* v1,
                                          TR::IlValue* v2)
{
  if (*dest == NULL)
...
void
OMR::BytecodeBuilder::IfCmpUnsignedGreaterOrEqual(TR::BytecodeBuilder** dest,
                                                  TR::IlValue* v1,
                                                  TR::IlValue* v2)
{
  if (*dest == NULL)
