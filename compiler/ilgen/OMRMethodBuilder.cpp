...
OMR::MethodBuilder::MemoryManager::MemoryManager()
    : _segmentProvider(
          new (TR::Compiler->persistentAllocator())
              TR::SystemSegmentProvider(MEM_SEGMENT_SIZE,
                                        TR::Compiler->rawAllocator)),
      _memoryRegion(
          new (TR::Compiler->persistentAllocator())
...
void OMR::MethodBuilder::DefineName(const char* name) {
  _methodName = name;
}
...
void OMR::MethodBuilder::DefineMemory(const char* name,
                                      TR::IlType* dt,
                                      void* location) {
...
void OMR::MethodBuilder::DefineReturnType(TR::IlType* dt) {
  _returnType = dt;
}
