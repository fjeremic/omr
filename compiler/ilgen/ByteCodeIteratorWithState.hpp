...
protected:
  ...
  ///  operand stack slots are saved into locals; other blocks can then access the state of the operand stack by loading
  ///  those locals
  ...
  ///   first shifts operand stack by shiftCount, then copies the shifted elements underneath the shifted operand stack
  ///   values
