...
public:
  ...
  virtual bool isBytecodeBuilder()
  {
    return false;
  }

  virtual TR::VirtualMachineState* initialVMState()
  {
    return NULL;
  }
  virtual TR::VirtualMachineState* vmState()
  {
    return NULL;
  }
  ...
  void ForLoopUp(
    const char* indVar, TR::IlBuilder** body, TR::IlValue* initial, TR::IlValue* iterateWhile, TR::IlValue* increment)
  {
   ...
   */
  void Switch(const char* selectionVar, TR::IlBuilder** defaultBuilder, uint32_t numCases, JBCase** cases);
   ...
   */
  void Switch(const char* selectionVar, TR::IlBuilder** defaultBuilder, uint32_t numCases, ...);
   ...
   * @param cases array of pointers to JBCase instances corresponding to each case.
   */
  void TableSwitch(const char* selectionVar, TR::IlBuilder** defaultBuilder, bool generateBoundsCheck,
...
protected:
  ...
  virtual bool connectTrees(uint32_t* currentBlock)
  {
    return connectTrees();
  }
