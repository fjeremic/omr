...
public:
  ...
  public:
     ...
     *
     * @param conditionBuilder pointer to the builder used to generate the
     * condition value
  ...
  IlBuilder(TR::MethodBuilder *methodBuilder, TR::TypeDictionary *types)
      : TR::IlInjector(types), _client(0), _clientCallbackBuildIL(0),
        _methodBuilder(methodBuilder), _sequence(0), _sequenceAppender(0),
        _entryBlock(0), _exitBlock(0), _count(-1), _partOfSequence(false),
        _connectedTrees(false), _comesBack(true), _isHandler(false) {}
  ...
  TR::BytecodeBuilder *OrphanBytecodeBuilder(int32_t bcIndex = 0,
                                             char *name = NULL);
  ...
  TR::IlValue *AddWithOverflow(TR::IlBuilder **handler, TR::IlValue *left,
                               TR::IlValue *right);
  TR::IlValue *AddWithUnsignedOverflow(TR::IlBuilder **handler,
                                       TR::IlValue *left, TR::IlValue *right);
  TR::IlValue *Sub(TR::IlValue *left, TR::IlValue *right);
  TR::IlValue *SubWithOverflow(TR::IlBuilder **handler, TR::IlValue *left,
                               TR::IlValue *right);
  TR::IlValue *SubWithUnsignedOverflow(TR::IlBuilder **handler,
                                       TR::IlValue *left, TR::IlValue *right);
  TR::IlValue *Mul(TR::IlValue *left, TR::IlValue *right);
  TR::IlValue *MulWithOverflow(TR::IlBuilder **handler, TR::IlValue *left,
                               TR::IlValue *right);
  ...
  TR::IlValue *LoadIndirect(const char *type, const char *field,
                            TR::IlValue *object);
  void StoreIndirect(const char *type, const char *field, TR::IlValue *object,
                     TR::IlValue *value);
  ...
  void Transaction(TR::IlBuilder **persistentFailureBuilder,
   ...
   * should be revisited.
   */
  TR::IlValue *StructFieldInstanceAddress(const char *structName,
                                          const char *fieldName,
                                          TR::IlValue *obj);
  TR::IlValue *UnionFieldInstanceAddress(const char *unionName,
                                         const char *fieldName,
                                         TR::IlValue *obj);
   ...
   * @param ... arguments to pass to the function, provided as TR::IlValue
   * pointers
   * @returns the TR::IlValue corresponding to the called function's return
   * value or NULL if return type is None
   */
  ...
  /**
   * @brief Call a function by address using a list of arguments (and providing
   * a name)
   * @param name the name of the target function (used primarily in logs)
   * @param numArgs the number of actual arguments for the method
   * @param ... arguments to pass to the function, provided as TR::IlValue
   * pointers, with the first argument providing the function address
   * @returns the TR::IlValue corresponding to the called function's return
   * value or NULL if return type is None
   */
  ...
  /**
   * @brief Call a function by address using an array of arguments (and
   * providing a name)
   * @param name the name of the target function
   * @param numArgs the number of actual arguments for the method
   * @param argValues array of arguments to pass to the function, with the first
   * argument providing the function address
   * @returns the TR::IlValue corresponding to the called function's return
   * value or NULL if return type is None
   */
  TR::IlValue *ComputedCall(const char *name, int32_t numArgs,
  ...
  TR::IlValue *genCall(TR::SymbolReference *methodSymRef, int32_t numArgs,
                       TR::IlValue **paramValues, bool isDirectCall = true);
  void Goto(TR::IlBuilder **dest);
  void Goto(TR::IlBuilder *dest);
  void Return();
  void Return(TR::IlValue *value);
  virtual void ForLoop(bool countsUp, const char *indVar, TR::IlBuilder **body,
                       TR::IlBuilder **breakBuilder,
                       TR::IlBuilder **continueBuilder, TR::IlValue *initial,
                       TR::IlValue *iterateWhile, TR::IlValue *increment);

  void ForLoopUp(const char *indVar, TR::IlBuilder **body, TR::IlValue *initial,
                 TR::IlValue *iterateWhile, TR::IlValue *increment) {
    ForLoop(true, indVar, body, NULL, NULL, initial, iterateWhile, increment);
  }

  void ForLoopDown(const char *indVar, TR::IlBuilder **body,
                   TR::IlValue *initial, TR::IlValue *iterateWhile,
                   TR::IlValue *increment) {
    ForLoop(false, indVar, body, NULL, NULL, initial, iterateWhile, increment);
  }

  void ForLoopWithBreak(bool countsUp, const char *indVar, TR::IlBuilder **body,
                        TR::IlBuilder **breakBody, TR::IlValue *initial,
                        TR::IlValue *iterateWhile, TR::IlValue *increment) {
    ForLoop(countsUp, indVar, body, breakBody, NULL, initial, iterateWhile,
            increment);
  }

  void ForLoopWithContinue(bool countsUp, const char *indVar,
                           TR::IlBuilder **body, TR::IlBuilder **continueBody,
                           TR::IlValue *initial, TR::IlValue *iterateWhile,
                           TR::IlValue *increment) {
    ForLoop(countsUp, indVar, body, NULL, continueBody, initial, iterateWhile,
            increment);
  }

  virtual void WhileDoLoop(const char *exitCondition, TR::IlBuilder **body,
                           TR::IlBuilder **breakBuilder = NULL,
                           TR::IlBuilder **continueBuilder = NULL);
  void WhileDoLoopWithBreak(const char *exitCondition, TR::IlBuilder **body,
                            TR::IlBuilder **breakBuilder) {
    WhileDoLoop(exitCondition, body, breakBuilder);
  }

  void WhileDoLoopWithContinue(const char *exitCondition, TR::IlBuilder **body,
                               TR::IlBuilder **continueBuilder) {
    WhileDoLoop(exitCondition, body, NULL, continueBuilder);
  }

  virtual void DoWhileLoop(const char *exitCondition, TR::IlBuilder **body,
                           TR::IlBuilder **breakBuilder = NULL,
                           TR::IlBuilder **continueBuilder = NULL);
  void DoWhileLoopWithBreak(const char *exitCondition, TR::IlBuilder **body,
                            TR::IlBuilder **breakBuilder) {
    DoWhileLoop(exitCondition, body, breakBuilder);
  }
  void DoWhileLoopWithContinue(const char *exitCondition, TR::IlBuilder **body,
                               TR::IlBuilder **continueBuilder) {
    DoWhileLoop(exitCondition, body, NULL, continueBuilder);
  }

  /* @brief creates an AND nest of short-circuited conditions, for each term
   * pass a JBCondition instance */
  void IfAnd(TR::IlBuilder **allTrueBuilder, TR::IlBuilder **anyFalseBuilder,
             int32_t numTerms, JBCondition **terms);
  void IfAnd(TR::IlBuilder **allTrueBuilder, TR::IlBuilder **anyFalseBuilder,
             int32_t numTerms, ...);
  /* @brief creates an OR nest of short-circuited conditions, for each term pass
   * a JBCondition instance */
  void IfOr(TR::IlBuilder **anyTrueBuilder, TR::IlBuilder **allFalseBuilder,
            int32_t numTerms, JBCondition **terms);
  void IfOr(TR::IlBuilder **anyTrueBuilder, TR::IlBuilder **allFalseBuilder,
            int32_t numTerms, ...);
   ...
   */
  JBCondition *MakeCondition(TR::IlBuilder *conditionBuilder,
                             TR::IlValue *conditionValue);

  void IfCmpNotEqualZero(TR::IlBuilder **target, TR::IlValue *condition);
  void IfCmpNotEqualZero(TR::IlBuilder *target, TR::IlValue *condition);
  void IfCmpNotEqual(TR::IlBuilder **target, TR::IlValue *left,
                     TR::IlValue *right);
  void IfCmpNotEqual(TR::IlBuilder *target, TR::IlValue *left,
                     TR::IlValue *right);
  void IfCmpEqualZero(TR::IlBuilder **target, TR::IlValue *condition);
  void IfCmpEqualZero(TR::IlBuilder *target, TR::IlValue *condition);
  void IfCmpEqual(TR::IlBuilder **target, TR::IlValue *left,
                  TR::IlValue *right);
  void IfCmpEqual(TR::IlBuilder *target, TR::IlValue *left, TR::IlValue *right);
  void IfCmpLessThan(TR::IlBuilder **target, TR::IlValue *left,
                     TR::IlValue *right);
  void IfCmpLessThan(TR::IlBuilder *target, TR::IlValue *left,
                     TR::IlValue *right);
  void IfCmpUnsignedLessThan(TR::IlBuilder **target, TR::IlValue *left,
                             TR::IlValue *right);
  void IfCmpUnsignedLessThan(TR::IlBuilder *target, TR::IlValue *left,
                             TR::IlValue *right);
  void IfCmpLessOrEqual(TR::IlBuilder **target, TR::IlValue *left,
                        TR::IlValue *right);
  void IfCmpLessOrEqual(TR::IlBuilder *target, TR::IlValue *left,
                        TR::IlValue *right);
  void IfCmpUnsignedLessOrEqual(TR::IlBuilder **target, TR::IlValue *left,
                                TR::IlValue *right);
  void IfCmpUnsignedLessOrEqual(TR::IlBuilder *target, TR::IlValue *left,
                                TR::IlValue *right);
  void IfCmpGreaterThan(TR::IlBuilder **target, TR::IlValue *left,
                        TR::IlValue *right);
  void IfCmpGreaterThan(TR::IlBuilder *target, TR::IlValue *left,
                        TR::IlValue *right);
  void IfCmpUnsignedGreaterThan(TR::IlBuilder **target, TR::IlValue *left,
                                TR::IlValue *right);
  void IfCmpUnsignedGreaterThan(TR::IlBuilder *target, TR::IlValue *left,
                                TR::IlValue *right);
  void IfCmpGreaterOrEqual(TR::IlBuilder **target, TR::IlValue *left,
                           TR::IlValue *right);
  void IfCmpGreaterOrEqual(TR::IlBuilder *target, TR::IlValue *left,
                           TR::IlValue *right);
  void IfCmpUnsignedGreaterOrEqual(TR::IlBuilder **target, TR::IlValue *left,
                                   TR::IlValue *right);
  void IfCmpUnsignedGreaterOrEqual(TR::IlBuilder *target, TR::IlValue *left,
                                   TR::IlValue *right);

  void IfThenElse(TR::IlBuilder **thenPath, TR::IlBuilder **elsePath,
   ...
   * @param cases array of pointers to JBCase instances corresponding to each
   * case.
   */
  void Switch(const char *selectionVar, TR::IlBuilder **defaultBuilder,
              uint32_t numCases, JBCase **cases);

  /**
   * @brief Generates a lookup switch-case control flow structure (vararg
   * overload).
   *
   ...
   * @param defaultBuilder the builder for the default case.
   * @param numCases the number of cases.
   * @param ... the list of pointers to JBCase instances corresponding to each
   * case.
   */
  void Switch(const char *selectionVar, TR::IlBuilder **defaultBuilder,
              uint32_t numCases, ...);
   ...
   * @param selectionVar the variable to switch on.
   * @param defaultBuilder the builder for the default case.
   * @param generateBoundsCheck generate the bounds check or not for the range
   * of the cases
   * @param numCases the number of cases.
   * @param cases array of pointers to JBCase instances corresponding to each
   * case.
   */
  void TableSwitch(const char *selectionVar, TR::IlBuilder **defaultBuilder,
                   bool generateBoundsCheck, uint32_t numCases, JBCase **cases);

  /**
   * @brief Generates a table switch-case control flow structure (vararg
   * overload).
   *
   * Instead of taking an array of pointers to JBCase instances, this overload
   * takes a pointer to each instance as a separate varargs argument.
   ...
   * @param caseBuilder pointer to pointer to IlBuilder for the case
   * (automatically allocated if pointed-to pointer is null).
   * @param caseFallsThrough flag specifying whether the case falls-through to
   * the next case.
   * @return JBCase* pointer to instance of JBCase representing the specified
   * case.
   */
  JBCase *MakeCase(int32_t caseValue, TR::IlBuilder **caseBuilder,
   ...
   */
  TR::IlValue *Select(TR::IlValue *condition, TR::IlValue *trueValue,
  ...
  /**
   * @brief returns the client object associated with this object, allocating it
   * if necessary
   */
  void *client();
...
protected:
   ...
   * usually NULL, but client objects can set this via setBuildILCallback() to
   * be called when buildIL is called on this object
   */
  ...
  /**
   * @brief sequence of TR::Blocks and other TR::IlBuilder objects that should
   * execute when control reaches this IlBuilder
   */
  ...
  /**
   * @brief each IlBuilder object is like a mini-CFG, with its own unique entry
   * block
   */
  TR::Block *_entryBlock;

  /**
   * @brief each IlBuilder object is like a mini-CFG, with its own unique exit
   * block
   */
  TR::Block *_exitBlock;

  /**
   * @brief counter for how many TR::Blocks are needed to represent everything
   * inside this IlBuilder object
   */
  int32_t _count;

  /**
   * @brief has this IlBuilder object been made part of some other builder's
   * sequence
   */
  ...
  /**
   * @brief returns true if there is a control edge to this IlBuilder's exit
   * block
   */
  bool _comesBack;

  /**
   * @brief returns true if this IlBuilder object is a handler for an exception
   * edge
   */
  bool _isHandler;
  ...
  TR::IlValue *indirectLoadNode(TR::IlType *dt, TR::Node *addr,
  ...
  TR::IlValue *binaryOpFromNodes(TR::ILOpCodes op, TR::Node *leftNode,
                                 TR::Node *rightNode);
  TR::Node *binaryOpNodeFromNodes(TR::ILOpCodes op, TR::Node *leftNode,
                                  TR::Node *rightNode);
  TR::IlValue *binaryOpFromOpMap(OpCodeMapper mapOp, TR::IlValue *left,
                                 TR::IlValue *right);
  TR::IlValue *binaryOpFromOpCode(TR::ILOpCodes op, TR::IlValue *left,
                                  TR::IlValue *right);
  TR::Node *shiftOpNodeFromNodes(TR::ILOpCodes op, TR::Node *leftNode,
                                 TR::Node *rightNode);
  TR::IlValue *shiftOpFromNodes(TR::ILOpCodes op, TR::Node *leftNode,
                                TR::Node *rightNode);
  TR::IlValue *shiftOpFromOpMap(OpCodeMapper mapOp, TR::IlValue *left,
                                TR::IlValue *right);
  TR::IlValue *compareOp(TR_ComparisonTypes ct, bool needUnsigned,
                         TR::IlValue *left, TR::IlValue *right);
  TR::IlValue *convertTo(TR::DataType typeTo, TR::IlValue *v,
                         bool needUnsigned);

  void ifCmpCondition(TR_ComparisonTypes ct, bool isUnsignedCmp,
                      TR::IlValue *left, TR::IlValue *right, TR::Block *target);
  ...
  void pullInBuilderTrees(TR::IlBuilder *builder, uint32_t *currentBlock,
                          TR::TreeTop **firstTree, TR::TreeTop **newLastTree);

  // BytecodeBuilder needs this interface, but IlBuilders doesn't so just ignore
  // the parameter
  ...
  void appendExceptionHandler(TR::Block *blockThrowsException,
                              TR::IlBuilder **builder, uint32_t catchType);
  TR::IlValue *genOperationWithOverflowCHK(TR::ILOpCodes op, TR::Node *leftNode,
                                           TR::Node *rightNode,
                                           TR::IlBuilder **handler,
                                           TR::ILOpCodes overflow);
  virtual void setHandlerInfo(uint32_t catchType);
  TR::IlValue **processCallArgs(TR::Compilation *comp, int numArgs,
                                va_list args);
  JBCase **createCaseArray(uint32_t numCases, va_list arg);
  void generateSwitchCases(TR::Node *switchNode, TR::Node *defaultNode,
