...
public:
  ...
  virtual bool isMethodInProgress() const
  {
    return false;
  }
  ...
  bool sameAs(TR::IlGeneratorMethodDetails& other)
  {
    return false;
  }
...
protected:
  ...
  void* operator new(size_t size, TR::IlGeneratorMethodDetails* p)
  {
    return (void*)p;
  }
  void* operator new(size_t size, TR::IlGeneratorMethodDetails& p)
