...
TR::IlValue*
OMR::IlBuilder::indirectLoadNode(TR::IlType* dt,
                                 TR::Node* addr,
                                 bool isVectorLoad)
{
...
void
OMR::IlBuilder::StoreIndirect(const char* type,
                              const char* field,
                              TR::IlValue* object,
                              TR::IlValue* value)
{
  ...
  genTreeTop(TR::Node::createWithSymRef(
    storeOp, 2, loadValue(object), loadValue(value), 0, symRef));
}
...
OMR::IlBuilder::VectorLoad(const char* name)
{
  ...
  TraceIL("IlBuilder[ %p ]::%d is VectorLoad %s (%d)\n",
          ...
          returnValue->getID(),
          name,
          nameSymRef->getCPIndex());

  return returnValue;
}

TR::IlValue*
OMR::IlBuilder::LoadIndirect(const char* type,
                             const char* field,
                             TR::IlValue* object)
{
  TR::IlReference* fieldRef = _types->FieldReference(type, field);
  ...
  TR::IlValue* returnValue = newValue(
    fieldType,
    TR::Node::createWithSymRef(comp()->il.opCodeForIndirectLoad(fieldType),
                               1,
                               loadValue(object),
                               0,
                               symRef));
 ...
 */
TR::IlValue*
OMR::IlBuilder::StructFieldInstanceAddress(const char* structName,
 ...
 */
TR::IlValue*
OMR::IlBuilder::UnionFieldInstanceAddress(const char* unionName,
                                          const char* fieldName,
                                          TR::IlValue* obj)
{
  auto ptype = typeDictionary()->PointerTo(
...
OMR::IlBuilder::Negate(TR::IlValue* v)
{
  ...
  TR_ASSERT_FATAL(negateOp != TR::BadILOp,
                  "Builder [ %p ] cannot negate value %d of type %s",
                  this,
                  v->getID(),
                  dataType.toString());
...
TR::IlValue*
OMR::IlBuilder::convertTo(TR::DataType typeTo,
                          TR::IlValue* v,
                          bool needUnsigned)
{
  TR::DataType typeFrom = v->getDataType();
  ...
  TR_ASSERT_FATAL(
    ...
    "Builder [ %p ] unknown conversion requested for value %d %s to %s",
    this,
    v->getID(),
    typeFrom.toString(),
    typeTo.toString());
...
OMR::IlBuilder::ConvertBitsTo(TR::IlType* t, TR::IlValue* v)
{
  ...
  TR_ASSERT_FATAL(convertOpcode != TR::BadILOp &&
                    TR::DataType::getSize(typeTo) ==
                      TR::DataType::getSize(typeFrom),
                  "Builder [ %p ] requested bit conversion for value %d from "
                  "type of size %d (%s) to type of size %d (%s) (consider "
                  "using ConvertTo() to for narrowing/widening)",
                  this,
                  v->getID(),
                  TR::DataType::getSize(typeFrom),
                  typeFrom.toString(),
...
OMR::IlBuilder::Return()
{
  ...
  if (returnBuilder != NULL) {
    TR_ASSERT_FATAL(
      _methodBuilder->returnSymbol() == NULL,
...
OMR::IlBuilder::Sub(TR::IlValue* left, TR::IlValue* right)
{
  ...
  if (left->getDataType() == TR::Address) {
    ...
    right = Sub(TR::Compiler->target.is32Bit() ? ConstInt32(0) : ConstInt64(0),
                right);
    returnValue =
      binaryOpFromNodes(TR::Compiler->target.is32Bit() ? TR::aiadd : TR::aladd,
                        loadValue(left),
                        loadValue(right));
  } else {
...
static TR::ILOpCodes
addOpCode(TR::DataType type)
{
  return TR::ILOpCode::addOpCode(type, TR::Compiler->target.is64Bit());
}

static TR::ILOpCodes
unsignedAddOpCode(TR::DataType type)
{
 ...
 */
void
OMR::IlBuilder::appendExceptionHandler(TR::Block* blockThrowsException,
...
OMR::IlBuilder::setHandlerInfo(uint32_t catchType)
{
  ...
  catchBlock->setHandlerInfoWithOutBCInfo(catchType,
                                          comp()->getInlineDepth(),
                                          -1,
...
TR::Node*
OMR::IlBuilder::genOverflowCHKTreeTop(TR::Node* operationNode,
...
TR::IlValue*
OMR::IlBuilder::genOperationWithOverflowCHK(TR::ILOpCodes op,
                                            TR::Node* leftNode,
                                            TR::Node* rightNode,
                                            TR::IlBuilder** handler,
                                            TR::ILOpCodes overflow)
{
  ...
  appendExceptionHandler(
    blockWithOverflowCHK, handler, TR::Block::CanCatchOverflowCheck);
  return resultValue;
}
...
OMR::IlBuilder::getOpCode(TR::IlValue* leftValue, TR::IlValue* rightValue)
{
  ...
  if (leftValue->getDataType() == TR::Address) {
    TR_ASSERT_FATAL(
      ...
      "the right child type must be either TR::Int32 (on 32-bit ISA) or "
      "TR::Int64 (on 64-bit ISA) when the left child of Add is TR::Address\n");
...
TR::IlValue*
OMR::IlBuilder::AddWithOverflow(TR::IlBuilder** handler,
                                TR::IlValue* left,
                                TR::IlValue* right)
{
  TR::Node* leftNode = loadValue(left);
...
TR::IlValue*
OMR::IlBuilder::AddWithUnsignedOverflow(TR::IlBuilder** handler,
                                        TR::IlValue* left,
                                        TR::IlValue* right)
{
  TR::Node* leftNode = loadValue(left);
...
TR::IlValue*
OMR::IlBuilder::SubWithOverflow(TR::IlBuilder** handler,
                                TR::IlValue* left,
                                TR::IlValue* right)
{
  TR::Node* leftNode = loadValue(left);
  ...
  TR::IlValue* subValue = genOperationWithOverflowCHK(
    TR::ILOpCode::subtractOpCode(leftNode->getDataType()),
    leftNode,
    rightNode,
    handler,
    TR::OverflowCHK);
...
TR::IlValue*
OMR::IlBuilder::SubWithUnsignedOverflow(TR::IlBuilder** handler,
                                        TR::IlValue* left,
                                        TR::IlValue* right)
{
  TR::Node* leftNode = loadValue(left);
...
TR::IlValue*
OMR::IlBuilder::MulWithOverflow(TR::IlBuilder** handler,
                                TR::IlValue* left,
                                TR::IlValue* right)
{
  TR::Node* leftNode = loadValue(left);
  ...
  TR::IlValue* mulValue = genOperationWithOverflowCHK(
    TR::ILOpCode::multiplyOpCode(leftNode->getDataType()),
    leftNode,
    rightNode,
    handler,
    TR::OverflowCHK);
...
OMR::IlBuilder::UnsignedRem(TR::IlValue* left, TR::IlValue* right)
{
  ...
  if (returnType.isInt64()) {
    ...
    TR::IlValue* truncLeft =
      binaryOpFromOpCode(TR::ILOpCodes::lmul,
                         binaryOpFromOpCode(TR::ILOpCodes::ludiv, left, right),
                         right);
 ...
 */
void
OMR::IlBuilder::IfAnd(TR::IlBuilder** allTrueBuilder,
 ...
 */
void
OMR::IlBuilder::IfOr(TR::IlBuilder** anyTrueBuilder,
...
void
OMR::IlBuilder::integerizeAddresses(TR::IlValue** leftPtr,
                                    TR::IlValue** rightPtr)
{
...
TR::IlValue**
OMR::IlBuilder::processCallArgs(TR::Compilation* comp,
                                int numArgs,
                                va_list args)
{
...
OMR::IlBuilder::ComputedCall(const char* functionName, int32_t numArgs, ...)
{
  ...
  TR::SymbolReference* methodSymRef =
    symRefTab()->findOrCreateComputedStaticMethodSymbol(
 ...
 */
TR::IlValue*
OMR::IlBuilder::ComputedCall(const char* functionName,
                             int32_t numArgs,
 ...
 */
TR::IlValue*
OMR::IlBuilder::Call(TR::MethodBuilder* calleeMB,
                     int32_t numArgs,
                     TR::IlValue** argValues)
{
...
OMR::IlBuilder::Call(const char* functionName, int32_t numArgs, ...)
{
  ...
  TR::SymbolReference* methodSymRef =
    symRefTab()->findOrCreateStaticMethodSymbol(
      JITTED_METHOD_INDEX, -1, resolvedMethod);
  return genCall(methodSymRef, numArgs, argValues);
}

TR::IlValue*
OMR::IlBuilder::Call(const char* functionName,
                     int32_t numArgs,
                     TR::IlValue** argValues)
{
  TraceIL("IlBuilder[ %p ]::Call %s\n", this, functionName);
...
TR::IlValue*
OMR::IlBuilder::genCall(TR::SymbolReference* methodSymRef,
                        int32_t numArgs,
                        TR::IlValue** argValues,
                        bool isDirectCall /* true by default*/)
{
  TR::DataType returnType =
    methodSymRef->getSymbol()->castToMethodSymbol()->getMethod()->returnType();
...
OMR::IlBuilder::AtomicAdd(TR::IlValue* baseAddress, TR::IlValue* value)
{
  ...
  TR_ASSERT_FATAL(returnType == TR::Int32 ||
                    (returnType == TR::Int64 && TR::Compiler->target.is64Bit()),
  ...
  TR::Node* callNode;
  callNode = TR::Node::createWithSymRef(
    TR::ILOpCode::getDirectCall(returnType), 2, methodSymRef);
                            ...
                            TR::IlBuilder** transactionBuilder)
{
  ...
  *transactionBuilder = createBuilderIfNeeded(*transactionBuilder);
  ...
  TR::Node* tStartNode = TR::Node::create(TR::tstart,
                                          3,
                                          persistentFailureNode,
                                          transientFailureNode,
                                          transactionNode);
...
void
OMR::IlBuilder::IfCmpNotEqualZero(TR::IlBuilder** target,
...
void
OMR::IlBuilder::IfCmpNotEqual(TR::IlBuilder** target,
                              TR::IlValue* left,
                              TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpEqual(TR::IlBuilder** target,
                           TR::IlValue* left,
                           TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpLessThan(TR::IlBuilder** target,
                              TR::IlValue* left,
                              TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpUnsignedLessThan(TR::IlBuilder** target,
                                      TR::IlValue* left,
                                      TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpLessOrEqual(TR::IlBuilder** target,
                                 TR::IlValue* left,
                                 TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpUnsignedLessOrEqual(TR::IlBuilder** target,
                                         TR::IlValue* left,
                                         TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpGreaterThan(TR::IlBuilder** target,
                                 TR::IlValue* left,
                                 TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpUnsignedGreaterThan(TR::IlBuilder** target,
                                         TR::IlValue* left,
                                         TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpGreaterOrEqual(TR::IlBuilder** target,
                                    TR::IlValue* left,
                                    TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::IfCmpUnsignedGreaterOrEqual(TR::IlBuilder** target,
                                            TR::IlValue* left,
                                            TR::IlValue* right)
{
  *target = createBuilderIfNeeded(*target);
...
void
OMR::IlBuilder::ifCmpCondition(TR_ComparisonTypes ct,
                               bool isUnsignedCmp,
                               TR::IlValue* left,
                               TR::IlValue* right,
                               TR::Block* target)
                            ...
                            JBCase** cases)
{
  ...
  *defaultBuilder = createBuilderIfNeeded(*defaultBuilder);
  ...
  TR::Node* defaultNode =
    TR::Node::createCase(0, (*defaultBuilder)->getEntry()->getEntry());
  TR::Node* tableNode = TR::Node::create(
    TR::table, numCases + 2, loadValue(selectorValue), defaultNode);
                            ...
                            ...)
{
  ...
  TableSwitch(
    selectionVar, defaultBuilder, generateBoundsCheck, numCases, cases);
}

TR::IlBuilder::JBCase*
OMR::IlBuilder::MakeCase(int32_t caseValue,
...
TR::IlValue*
OMR::IlBuilder::Select(TR::IlValue* condition,
...
{
  JBCase** cases =
    (JBCase**)_comp->trMemory()->allocateHeapMemory(numCases * sizeof(JBCase*));
...
void
OMR::IlBuilder::generateSwitchCases(TR::Node* switchNode,
                                    TR::Node* defaultNode,
                                    TR::IlBuilder** defaultBuilder,
                                    uint32_t numCases,
                                    JBCase** cases)
...
void
OMR::IlBuilder::DoWhileLoop(const char* whileCondition,
                            TR::IlBuilder** body,
                            TR::IlBuilder** breakBuilder,
                            TR::IlBuilder** continueBuilder)
{
...
void
OMR::IlBuilder::WhileDoLoop(const char* whileCondition,
                            TR::IlBuilder** body,
                            TR::IlBuilder** breakBuilder,
                            TR::IlBuilder** continueBuilder)
{
