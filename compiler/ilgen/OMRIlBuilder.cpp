...
TR::IlValue* OMR::IlBuilder::indirectLoadNode(TR::IlType* dt,
                                              TR::Node* addr,
                                              bool isVectorLoad) {
...
void OMR::IlBuilder::StoreIndirect(const char* type,
                                   const char* field,
                                   TR::IlValue* object,
                                   TR::IlValue* value) {
...
TR::IlValue* OMR::IlBuilder::LoadIndirect(const char* type,
                                          const char* field,
                                          TR::IlValue* object) {
  TR::IlReference* fieldRef = _types->FieldReference(type, field);
  TR::SymbolReference* symRef = fieldRef->symRef();
...
TR::IlValue* OMR::IlBuilder::IndexAt(TR::IlType* dt,
                                     TR::IlValue* base,
                                     TR::IlValue* index) {
...
TR::IlValue* OMR::IlBuilder::convertTo(TR::DataType typeTo,
                                       TR::IlValue* v,
                                       bool needUnsigned) {
  TR::DataType typeFrom = v->getDataType();
...
TR::IlValue* OMR::IlBuilder::compareOp(TR_ComparisonTypes ct,
                                       bool needUnsigned,
                                       TR::IlValue* left,
                                       TR::IlValue* right) {
  TR::Node* leftNode = loadValue(left);
...
TR::IlValue** OMR::IlBuilder::processCallArgs(TR::Compilation* comp,
                                              int numArgs,
                                              va_list args) {
  TR::IlValue** argValues = (TR::IlValue**)comp->trMemory()->allocateHeapMemory(
 ...
 */
TR::IlValue* OMR::IlBuilder::Call(TR::MethodBuilder* calleeMB,
                                  int32_t numArgs,
                                  ...) {
  va_list args;
  va_start(args, numArgs);
...
TR::IlValue* OMR::IlBuilder::Call(const char* functionName,
                                  int32_t numArgs,
                                  ...) {
  TraceIL("IlBuilder[ %p ]::Call %s\n", this, functionName);
  va_list args;
...
void OMR::IlBuilder::IfCmpNotEqual(TR::IlBuilder** target,
                                   TR::IlValue* left,
                                   TR::IlValue* right) {
  *target = createBuilderIfNeeded(*target);
...
void OMR::IlBuilder::IfCmpEqual(TR::IlBuilder** target,
                                TR::IlValue* left,
                                TR::IlValue* right) {
  *target = createBuilderIfNeeded(*target);
...
void OMR::IlBuilder::IfCmpLessThan(TR::IlBuilder** target,
                                   TR::IlValue* left,
                                   TR::IlValue* right) {
  *target = createBuilderIfNeeded(*target);
...
void OMR::IlBuilder::IfCmpLessOrEqual(TR::IlBuilder** target,
                                      TR::IlValue* left,
                                      TR::IlValue* right) {
  *target = createBuilderIfNeeded(*target);
...
void OMR::IlBuilder::IfCmpGreaterThan(TR::IlBuilder** target,
                                      TR::IlValue* left,
                                      TR::IlValue* right) {
  *target = createBuilderIfNeeded(*target);
...
void OMR::IlBuilder::ifCmpCondition(TR_ComparisonTypes ct,
                                    bool isUnsignedCmp,
                                    TR::IlValue* left,
                                    TR::IlValue* right,
                                    TR::Block* target) {
...
void OMR::IlBuilder::ForLoop(bool countsUp,
                             const char* indVar,
