...
public:
   ...
   */
  void DefineField(const char* structName,
  ...
  void UnionField(const char* unionName,
                  const char* fieldName,
                  TR::IlType* type);
...
protected:
  ...
  typedef TR::typed_allocator<std::pair<const char* const, OMR::StructType*>,
    ...
    StructMapAllocator;
  typedef std::
    map<const char*, OMR::StructType*, StrComparator, StructMapAllocator>
      StructMap;
  ...
  typedef TR::typed_allocator<std::pair<const char* const, OMR::UnionType*>,
    ...
    UnionMapAllocator;
  typedef std::
    map<const char*, OMR::UnionType*, StrComparator, UnionMapAllocator>
      UnionMap;
