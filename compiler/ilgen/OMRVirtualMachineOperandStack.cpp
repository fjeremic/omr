...
void
OMR::VirtualMachineOperandStack::MergeInto(TR::VirtualMachineState* o,
                                           TR::IlBuilder* b)
{
  TR::VirtualMachineOperandStack* other =
...
void
OMR::VirtualMachineOperandStack::UpdateStack(TR::IlBuilder* b,
                                             TR::IlValue* stack)
{
...
OMR::VirtualMachineOperandStack::MakeCopy()
{
  TR::VirtualMachineOperandStack* copy =
    (TR::VirtualMachineOperandStack*)TR::comp()->trMemory()->allocateHeapMemory(
