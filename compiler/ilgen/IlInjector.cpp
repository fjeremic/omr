...
TR::CFG* OMR::IlInjector::cfg() {
  return _methodSymbol->getFlowGraph();
}

TR::Block* OMR::IlInjector::getCurrentBlock() {
...
void OMR::IlInjector::ifjump(TR::ILOpCodes op,
                             TR::Node* first,
                             TR::Node* second,
...
TR::Node* OMR::IlInjector::arrayLoad(TR::Node* base,
                                     TR::Node* index,
                                     TR::IlType* dt) {
  TR::Node* scaledIndex;
  TR::Node* element;
