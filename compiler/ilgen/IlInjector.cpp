...
OMR::IlInjector::arrayLoad(TR::Node* base, TR::Node* index, TR::IlType* dt)
{
  ...
  TR::SymbolReference* symRef =
    symRefTab()->findOrCreateArrayShadowSymbolRef(dt->getPrimitiveType(), base);
  TR::Node* load = TR::Node::createWithSymRef(
    TR::ILOpCode::indirectLoadOpCode(dt->getPrimitiveType()),
    1,
    element,
    0,
    symRef);
 ...
 * */
TR::Node*
OMR::IlInjector::createWithoutSymRef(TR::ILOpCodes opCode,
                                     uint32_t numArgs,
                                     ...)
{
  TR_ASSERT(numArgs > 0,
