...
public:
  ...
  virtual bool allowIlGenOptimizations()
  {
    return true;
  }
};
...
public:
  ...
  virtual TR_IlGenerator* getIlGenerator(TR::ResolvedMethodSymbol* methodSymbol, TR_FrontEnd* fe, TR::Compilation* comp,
...
public:
  PartialInliningIlGenRequest(
    TR::IlGeneratorMethodDetails& methodDetails, TR::ResolvedMethodSymbol* callerSymbol, TR_InlineBlocks* inlineBlocks)
