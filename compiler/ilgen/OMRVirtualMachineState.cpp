...
void OMR::VirtualMachineState::commit(TR::IlBuilder *b) {
  if (_clientCallbackCommit) (*_clientCallbackCommit)(client(), b->client());
}

void OMR::VirtualMachineState::reload(TR::IlBuilder *b) {
  if (_clientCallbackReload) (*_clientCallbackReload)(client(), b->client());
}
...
void OMR::VirtualMachineState::mergeInto(TR::VirtualMachineState *other,
                                         TR::IlBuilder *b) {
