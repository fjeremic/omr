...
const char* OMR::Z::CPU::getProcessorName(int32_t machineId) {
  const char* result = "";
...
OMR::Z::CPU::CPU() : OMR::CPU(), _supportedArch(z9) {}
...
bool OMR::Z::CPU::setSupportsMiscellaneousInstructionExtensions3Facility(
    bool value) {
  if (value) {
...
bool OMR::Z::CPU::setSupportsVectorPackedDecimalEnhancementFacility(
    bool value) {
  if (value) {
...
bool OMR::Z::CPU::isTargetWithinBranchRelativeRILRange(
    intptrj_t targetAddress,
    intptrj_t sourceAddress) {
  return (targetAddress ==
          sourceAddress +
              ((intptrj_t)((int32_t)((targetAddress - sourceAddress) / 2))) *
                  2) &&
         (targetAddress % 2 == 0);
}
