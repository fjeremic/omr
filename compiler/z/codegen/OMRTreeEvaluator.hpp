...
class OMR_EXTENSIBLE TreeEvaluator : public OMR::TreeEvaluator {
 public:
  ...
  static TR::Register *arraycmpHelper(
      TR::Node *node, TR::CodeGenerator *cg, bool isWideChar,
      bool isEqualCmp = false, int32_t cmpValue = 0,
      TR::LabelSymbol *compareTarget = NULL, TR::Node *ificmpNode = NULL,
      bool needResultReg = true, bool return102 = false,
  ...
  static TR::Register *evaluateNULLCHKWithPossibleResolve(
  ...
  static TR::Instruction *genLoadForObjectHeadersMasked(
