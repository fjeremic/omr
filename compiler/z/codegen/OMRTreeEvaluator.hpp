...
public:
  ...
  static TR::RegisterDependencyConditions* generateMemToMemElementCopy(TR::Node* node, TR::CodeGenerator* cg,
    TR::Register* byteSrcReg, TR::Register* byteDstReg, TR::Register* byteLenReg, TR_S390ScratchRegisterManager* srm,
    bool isForward, bool needsGuardedLoad, bool genStartICFLabel = false,
  ...
  static TR::Register* arraycmpHelper(TR::Node* node, TR::CodeGenerator* cg, bool isWideChar, bool isEqualCmp = false,
    int32_t cmpValue = 0, TR::LabelSymbol* compareTarget = NULL, TR::Node* ificmpNode = NULL, bool needResultReg = true,
    bool return102 = false, TR::InstOpCode::S390BranchCondition* returnCond = NULL);
  static TR::Register* arraycmpSIMDHelper(TR::Node* node, TR::CodeGenerator* cg, TR::LabelSymbol* compareTarget = NULL,
    TR::Node* ificmpNode = NULL, bool needResultReg = true, bool return102 = false);
  ...
  static TR::Instruction* genLoadForObjectHeaders(
