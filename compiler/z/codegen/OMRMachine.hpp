...
#define TR_PACKED_TO_DECIMAL_FLOAT_SIZE \
    8 ///< The source byte size in memory for a pd2df conversion (i.e. with CDSTR -- pd2df and pd2dd use same
      ///< instruction)
...
#define TR_PACKED_TO_DECIMAL_FLOAT_SIZE_ARCH11 \
    9 ///< The source byte size in memory for a pd2df conversion (i.e. with CDPT -- pd2df and pd2dd use same
      ///< instruction)
