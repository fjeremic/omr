...
#define TR_INTEGER_TO_PACKED_SIZE \
  8  ///< The result byte size in memory for a integer to packed conversion
     ///< (i.e. with CVD)
...
#define TR_PACKED_TO_INTEGER_SIZE \
  8  ///< The source byte size in memory for a packed to integer conversion
     ///< (i.e. with CVB)
#define TR_ASCII_TO_PACKED_RESULT_SIZE \
  16  ///< The result byte size in memory for an ascii to packed conversion
      ///< (i.e. with PKA)
...
#define TR_PACKED_TO_DECIMAL_DOUBLE_SIZE \
  8  ///< The source byte size in memory for a pd2dd conversion (i.e. with
     ///< CDSTR)
...
#define TR_PACKED_TO_DECIMAL_LONG_DOUBLE_SIZE_ARCH11 \
  18  ///< The source byte size in memory for a pd2de conversion (i.e. with
      ///< CXPT)
...
class OMR_EXTENSIBLE Machine : public OMR::Machine {
 ...
 public:
  ...
  TR::RealRegister *findBestLegalEvenRegister(
      uint64_t availRegMask = 0x0000ffff);
  TR::RealRegister *findBestLegalOddRegister(
      uint64_t availRegMask = 0x0000ffff);
  ...
  bool isLegalSecondOfFPRegister(TR::RealRegister *reg, bool allowBlocked,
                                 uint64_t availRegMask = 0x0000ffff,
                                 bool allowLocked = false);
  TR::RealRegister *findBestLegalSiblingFPRegister(
      bool isFirst, uint64_t availRegMask = 0x0000ffff);
  ...
  TR::RealRegister *findRegNotUsedInInstruction(
  ...
  TR_GlobalRegisterNumber setLastGlobalGPRRegisterNumber(
  ...
  TR_GlobalRegisterNumber setFirstGlobalGPRRegisterNumber(
      TR_GlobalRegisterNumber reg);

  TR_GlobalRegisterNumber getLast8BitGlobalGPRRegisterNumber() {
    return _last8BitGlobalGPRRegisterNumber;
  }
  TR_GlobalRegisterNumber setLast8BitGlobalGPRRegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setFirstGlobalFPRRegisterNumber(
      TR_GlobalRegisterNumber reg);
  ...
  TR_GlobalRegisterNumber setLastGlobalFPRRegisterNumber(
      TR_GlobalRegisterNumber reg);
  ...
  TR_GlobalRegisterNumber setFirstOverlappedGlobalFPRRegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setLastOverlappedGlobalFPRRegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setFirstGlobalVRFRegisterNumber(
      TR_GlobalRegisterNumber reg);
  ...
  TR_GlobalRegisterNumber setLastGlobalVRFRegisterNumber(
      TR_GlobalRegisterNumber reg);
  ...
  TR_GlobalRegisterNumber setFirstOverlappedGlobalVRFRegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setLastOverlappedGlobalVRFRegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setGlobalEnvironmentRegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setGlobalCAARegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setGlobalParentDSARegisterNumber(
      TR_GlobalRegisterNumber reg) {
    return _globalParentDSARegisterNumber = reg;
  }

  TR_GlobalRegisterNumber setGlobalReturnAddressRegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setGlobalEntryPointRegisterNumber(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setLastGlobalCCRRegisterNumber(
      TR_GlobalRegisterNumber reg);
  ...
  TR_GlobalRegisterNumber setLastVolatileNonLinkGPR(
      TR_GlobalRegisterNumber reg) {
  ...
  TR_GlobalRegisterNumber setLastVolatileNonLinkFPR(
      TR_GlobalRegisterNumber reg) {
