 ...
 */
uint8_t*
OMR::Z::Snippet::generatePICBinary(TR::CodeGenerator* cg,
                                   uint8_t* cursor,
 ...
 */
uint8_t*
OMR::Z::Snippet::generateLoadVMThreadInstruction(TR::CodeGenerator* cg,
                                                 uint8_t* cursor)
{
  return cursor;
}
 ...
 */
uint8_t*
OMR::Z::Snippet::generateRuntimeInstrumentationOnOffInstruction(
  TR::CodeGenerator* cg,
  uint8_t* cursor,
 ...
 */
uint32_t
OMR::Z::Snippet::getRuntimeInstrumentationOnOffInstructionLength(
  TR::CodeGenerator* cg,
  bool isPrivateLinkage)
{
  return 0;
