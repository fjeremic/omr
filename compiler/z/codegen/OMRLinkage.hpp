...
private:
  ...
  int32_t
    _largestOutgoingArgumentAreaSize; ///< Arguments for registers could be
                                      ///< saved in discontiguous area this size
                                      ///< does not include the discontiguous
                                      ///< register parm area size
...
public:
  ...
  virtual void* saveArguments(void* cursor,
                              bool genBinary,
                              bool InPreProlog = false,
...
public:
  ...
  TR::InstOpCode::Mnemonic getOpCodeForLinkage(TR::Node* child,
                                               bool isStore,
                                               bool isRegReg);
...
public:
  TR::Register* copyArgRegister(TR::Node* callNode,
                                TR::Node* child,
                                TR::Register* argRegister);
  TR::Register* pushLongArg32(TR::Node* callNode,
                              TR::Node* child,
  ...
  TR::Register* pushArg(TR::Node* callNode,
                        TR::Node* child,
                        int32_t numIntegerArgs,
                        int32_t numFloatArgs,
                        int32_t* stackOffsetPtr,
                        TR::RegisterDependencyConditions* dependencies,
                        TR::Register* argRegister = NULL);
  TR::Register* pushAggregateArg(TR::Node* callNode,
                                 TR::Node* child,
                                 int32_t numIntegerArgs,
                                 int32_t numFloatArgs,
                                 int32_t* stackOffsetPtr,
  ...
  TR::Register* pushJNIReferenceArg(
    ...
    TR::RegisterDependencyConditions* dependencies,
    TR::Register* argRegister = NULL);
  TR::Register* pushVectorArg(TR::Node* callNode,
                              TR::Node* child,
  ...
  virtual void setupRegisterDepForLinkage(TR::Node*,
                                          TR_DispatchType,
                                          ...
                                          TR::Register**,
                                          TR::Register*&);
  virtual void setupBuildArgForLinkage(TR::Node*,
                                       TR_DispatchType,
                                       TR::RegisterDependencyConditions*,
                                       bool,
                                       bool,
