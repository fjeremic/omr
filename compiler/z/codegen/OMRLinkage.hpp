...
#define ANYREGINDEX(i)                                                                                                \
  ((i >= TR::RealRegister::FirstFPR) ? ((i >= TR::RealRegister::FirstAssignableVRF) ? VRFREGINDEX(i) : FPREGINDEX(i)) \
                                     : REGINDEX(i))
...
public:
  ...
  bool setStackSizeCheckNeeded(bool v)
  {
    return _stackSizeCheckNeeded = v;
  }
  bool getStackSizeCheckNeeded()
  {
    return _stackSizeCheckNeeded;
  }

  bool setRaContextSaveNeeded(bool v)
  {
    return _raContextSaveNeeded = v;
  }
  bool getRaContextSaveNeeded()
  {
    return _raContextSaveNeeded;
  }

  bool setRaContextRestoreNeeded(bool v)
  {
    return _raContextSaveNeeded = v;
  }
  bool getRaContextRestoreNeeded()
  {
    return _raContextSaveNeeded;
  }
  ...
  virtual void buildVirtualDispatch(
    TR::Node* callNode, TR::RegisterDependencyConditions* dependencies, TR::Register* vftReg, uint32_t sizeOfArguments)
  {
...
public:
  ...
  void loadIntArgumentsFromStack(TR::Node* callNode, TR::RegisterDependencyConditions* dependencies,
    TR::DataType argType, int32_t stackOffset, int32_t argsSize, int32_t numIntegerArgs, TR::Register* stackRegister);

  int32_t isNeedsWidening()
  {
    return _properties & NeedsWidening;
  }
  int32_t isAllParmsOnStack()
  {
    return _properties & AllParmsOnStack;
  }
  int32_t isParmsInReverseOrder()
  {
    return _properties & ParmsInReverseOrder;
  }
  int32_t isSkipGPRsForFloatParms()
  {
    return _properties & SkipGPRsForFloatParms;
  }
  int32_t isPadFloatParms()
  {
    return _properties & PadFloatParms;
  }
  ...
  int64_t killAndAssignRegister(int64_t killMask, TR::RegisterDependencyConditions* deps, TR::Register** virtualReg,
    TR::RealRegister::RegNum regNum, TR::CodeGenerator* codeGen, bool isAllocate = false, bool isDummy = false);

  int64_t killAndAssignRegister(int64_t killMask, TR::RegisterDependencyConditions* deps, TR::Register** virtualReg,
    TR::RealRegister* realReg, TR::CodeGenerator* codeGen, bool isAllocate = false, bool isDummy = false);
  ...
  virtual int32_t getOffsetToRegSaveArea()
  {
    return _offsetToRegSaveArea;
  }
  ...
  int32_t getOffsetToLongDispSlot()
  {
    return _offsetToLongDispSlot;
  }
  ...
  virtual uint32_t setProperty(uint32_t p)
  {
    return _properties |= p;
  }
  virtual uint32_t setProperties(uint32_t p)
  {
    return _properties = p;
  }
  virtual uint32_t getProperties()
  {
    return _properties;
  }
  virtual uint32_t clearProperty(uint32_t p)
  {
    return _properties &= ~p;
  }
  uint32_t getRightToLeft()
  {
    return _properties & RightToLeft;
  }
  int32_t isFirstParmAtFixedOffset()
  {
    return _properties & FirstParmAtFixedOffset;
  }
  int32_t isSplitLongParm()
  {
    return _properties & SplitLongParm;
  }
  ...
  virtual TR::RealRegister::RegNum setLitPoolRegister(TR::RealRegister::RegNum r)
  {
  ...
  virtual int32_t getOffsetToFirstParm()
  {
  ...
  virtual uint32_t getOffsetToFirstLocal()
  {
    return _offsetToFirstLocal;
  }
...
protected:
  TR::Instruction* getLastPrologueInstruction()
  {
    return _lastPrologueInstr;
  }
  TR::Instruction* getFirstPrologueInstruction()
  {
    return _firstPrologueInstr;
  }
