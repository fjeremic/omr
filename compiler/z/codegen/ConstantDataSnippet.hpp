...
public:
  S390ConstantDataSnippet(TR::CodeGenerator *cg, TR::Node *, void *c,
                          uint16_t size);
  ...
  setUnresolvedDataSnippet(TR::UnresolvedDataSnippet *uds) {
...
public:
  S390ConstantInstructionSnippet(TR::CodeGenerator *cg, TR::Node *,
                                 TR::Instruction *);
...
public:
  S390WritableDataSnippet(TR::CodeGenerator *cg, TR::Node *, void *c,
                          uint16_t size);
