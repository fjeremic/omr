...
public:
  ...
  virtual uint32_t getConstantSize()
  {
    return _length;
  }
  virtual int32_t getDataAs1Byte()
  {
    return *((int8_t*)&_value);
  }
  virtual int32_t getDataAs2Bytes()
  {
    return *((int16_t*)&_value);
  }
  virtual int32_t getDataAs4Bytes()
  {
...
public:
  ...
  virtual Kind getKind()
  {
    return IsJNICallData;
  }
  virtual uint8_t* emitSnippetBody();
  virtual void print(TR::FILE*, TR_Debug*);
  void setBaseRegister(TR::Register* aValue)
  {
    _baseRegister = aValue;
  }
  ...
  void setRAMMethod(uintptrj_t aValue)
  {
    _ramMethod = aValue;
  }
  void setJNICallOutFrameFlags(uintptrj_t aValue)
  {
    _JNICallOutFrameFlags = aValue;
  }
  void setReturnFromJNICall(TR::LabelSymbol* aValue)
  {
    _returnFromJNICallLabel = aValue;
  }
  void setSavedPC(uintptrj_t aValue)
  {
    _savedPC = aValue;
  }
  void setTagBits(uintptrj_t aValue)
  {
    _tagBits = aValue;
  }

  void setPC(uintptrj_t aValue)
  {
    _pc = aValue;
  }
  void setLiterals(uintptrj_t aValue)
  {
    _literals = aValue;
  }
  void setJitStackFrameFlags(uintptrj_t aValue)
  {
    _jitStackFrameFlags = aValue;
  }

  void setConstReleaseVMAccessMask(uintptrj_t aValue)
  {
    _constReleaseVMAccessMask = aValue;
  }
  void setConstReleaseVMAccessOutOfLineMask(uintptrj_t aValue)
  {
    _constReleaseVMAccessOutOfLineMask = aValue;
  }
  void setTargetAddress(uintptrj_t aValue)
  {
    _targetAddress = aValue;
  }

  uint32_t getJNICallOutFrameDataOffset()
  {
    return 0;
  }
  uint32_t getRAMMethodOffset()
  {
    return 0;
  }
