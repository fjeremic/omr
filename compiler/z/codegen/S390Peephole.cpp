...
bool TR_S390PostRAPeephole::unnecessaryNILHReduction() {
  return false;
}
...
bool TR_S390PostRAPeephole::branchReduction() {
  return false;
}
...
bool swapOperands(TR::Register* trueReg,
                  TR::Register* compReg,
                  TR::Instruction* curr) {
  TR::InstOpCode::S390BranchCondition branchCond;
  uint8_t mask;
...
void insertLoad(TR::Compilation* comp,
                TR::CodeGenerator* cg,
                TR::Instruction* i,
                TR::Register* r) {
  switch (r->getKind()) {
...
bool TR_S390PostRAPeephole::DeadStoreToSpillReduction() {
  return false;
}

bool TR_S390PostRAPeephole::tryMoveImmediate() {
  return false;
}
