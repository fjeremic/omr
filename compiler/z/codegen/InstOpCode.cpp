...
void OMR::Z::InstOpCode::copyBinaryToBufferWithoutClear(
    uint8_t *cursor, TR::InstOpCode::Mnemonic i_opCode) {
...
void OMR::Z::InstOpCode::copyBinaryToBuffer(uint8_t *cursor,
...
uint8_t OMR::Z::InstOpCode::getInstructionLength(
    TR::InstOpCode::Mnemonic i_opCode) {
...
TR::InstOpCode::Mnemonic OMR::Z::InstOpCode::getLoadRegOpCodeFromNode(
