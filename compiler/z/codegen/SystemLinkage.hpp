...
public:
  SystemLinkage(
    TR::CodeGenerator* cg, TR_S390LinkageConventions elc = TR_S390LinkageDefault, TR_LinkageConventions lc = TR_System);

  TR::SystemLinkage* self();

  virtual int32_t getRegisterSaveOffset(TR::RealRegister::RegNum) = 0;

  int32_t setStackFrameSize(int32_t StackFrameSize)
  {
    return _StackFrameSize = StackFrameSize;
  }
  virtual int32_t getStackFrameSize()
  {
    return _StackFrameSize;
  }

  int16_t setGPRSaveMask(int16_t GPRSaveMask)
  {
    return _GPRSaveMask = GPRSaveMask;
  }
  int16_t getGPRSaveMask()
  {
    return _GPRSaveMask;
  }

  int16_t setFPRSaveMask(int16_t FPRSaveMask)
  {
    return _FPRSaveMask = FPRSaveMask;
  }
  int16_t getFPRSaveMask()
  {
    return _FPRSaveMask;
  }
  ...
  int32_t getGPRSaveAreaBeginOffset()
  {
    return _GPRSaveAreaBeginOffset;
  }
  int32_t setGPRSaveAreaEndOffset(int32_t GPRSaveAreaEndOffset)
  {
    return _GPRSaveAreaEndOffset = GPRSaveAreaEndOffset;
  }
  int32_t getGPRSaveAreaEndOffset()
  {
    return _GPRSaveAreaEndOffset;
  }
  ...
  int32_t getFPRSaveAreaBeginOffset()
  {
    return _FPRSaveAreaBeginOffset;
  }
  ...
  int32_t getOutgoingParmAreaBeginOffset()
  {
    return _OutgoingParmAreaBeginOffset;
  }
  ...
  int32_t getOutgoingParmAreaEndOffset()
  {
    return _OutgoingParmAreaEndOffset;
  }

  virtual int32_t setLocalsAreaBeginOffset(int32_t LocalsAreaBeginOffset)
  {
    return _LocalsAreaBeginOffset = LocalsAreaBeginOffset;
  }
  virtual int32_t getLocalsAreaBeginOffset()
  {
    return _LocalsAreaBeginOffset;
  }
  virtual int32_t setLocalsAreaEndOffset(int32_t LocalsAreaEndOffset)
  {
    return _LocalsAreaEndOffset = LocalsAreaEndOffset;
  }
  virtual int32_t getLocalsAreaEndOffset()
  {
    return _LocalsAreaEndOffset;
  }

  int32_t setNumUsedArgumentGPRs(int32_t numUsedArgumentGPRs)
  {
    return _numUsedArgumentGPRs = numUsedArgumentGPRs;
  }
  int32_t getNumUsedArgumentGPRs()
  {
    return _numUsedArgumentGPRs;
  }

  int32_t setNumUsedArgumentFPRs(int32_t numUsedArgumentFPRs)
  {
    return _numUsedArgumentFPRs = numUsedArgumentFPRs;
  }
  int32_t getNumUsedArgumentFPRs()
  {
    return _numUsedArgumentFPRs;
  }

  int32_t setNumUsedArgumentVFRs(int32_t numUsedArgumentVFRs)
  {
    return _numUsedArgumentVFRs = numUsedArgumentVFRs;
  }
  int32_t getNumUsedArgumentVFRs()
  {
    return _numUsedArgumentVFRs;
  }

  void setIncomingParmAreaBeginOffset(int32_t offset)
  {
    _incomingParmAreaBeginOffset = offset;
  }
  int32_t getIncomingParmAreaBeginOffset()
  {
    return _incomingParmAreaBeginOffset;
  }
  void setIncomingParmAreaEndOffset(int32_t offset)
  {
    _incomingParmAreaEndOffset = offset;
  }
  int32_t getIncomingParmAreaEndOffset()
  {
    return _incomingParmAreaEndOffset;
  }
  ...
  virtual uint32_t getIntArgOffset(int32_t index)
  {
    return 0;
  }
  ...
  virtual void generateInstructionsForCall(TR::Node* callNode, TR::RegisterDependencyConditions* dependencies,
    ...
    TR::LabelSymbol* returnFromJNICallLabel, TR::S390JNICallDataSnippet* jniCallDataSnippet, bool isJNIGCPoint = true);
  ...
  virtual TR::RealRegister::RegNum getAlternateStackPointerRegister()
  {
...
inline TR::SystemLinkage* toSystemLinkage(TR::Linkage* l)
{
