...
/* Instruction Format
 *
 * Note this is different than the IA32 approach - this uses nibbles for the
 OpCode length, not bytes since
 * some instructions are 3 nibbles long
 * It also has an extra length field - the length of the entire instruction (not
 just the opcode)
...
// Available static_cast<uint64_t>(0x0000000000000400ull) Available
// static_cast<uint64_t>(0x0000000000000800ull) Available
// static_cast<uint64_t>(0x0000000000001000ull)
...
#define S390OpProp_LongDispSupported \
  static_cast<uint64_t>(0x0000000000100000ull)
#define S390OpProp_IsExtendedImmediate \
  static_cast<uint64_t>(0x0000000000200000ull)
#define S390OpProp_UsesRegPairForTarget \
  static_cast<uint64_t>(0x0000000000400000ull)
#define S390OpProp_UsesRegPairForSource \
  static_cast<uint64_t>(0x0000000000800000ull)
#define S390OpProp_UsesRegRangeForTarget \
  static_cast<uint64_t>(0x0000000001000000ull)
...
// Available static_cast<uint64_t>(0x0000000008000000ull) Available
// static_cast<uint64_t>(0x0000000010000000ull)
...
#define S390OpProp_HasTwoMemoryReferences \
  static_cast<uint64_t>(0x0000004000000000ull)
#define S390OpProp_ImplicitlyUsesGPR0 \
  static_cast<uint64_t>(0x0000008000000000ull)
#define S390OpProp_ImplicitlyUsesGPR1 \
  static_cast<uint64_t>(0x0000010000000000ull)
#define S390OpProp_ImplicitlyUsesGPR2 \
  static_cast<uint64_t>(0x0000020000000000ull)
#define S390OpProp_ImplicitlySetsGPR0 \
  static_cast<uint64_t>(0x0000040000000000ull)
#define S390OpProp_ImplicitlySetsGPR1 \
  static_cast<uint64_t>(0x0000080000000000ull)
#define S390OpProp_ImplicitlySetsGPR2 \
  static_cast<uint64_t>(0x0000100000000000ull)
...
#define S390OpProp_HasExtendedMnemonic \
  static_cast<uint64_t>(0x0004000000000000ull)
...
// Available static_cast<uint64_t>(0x0020000000000000ull) Available
// static_cast<uint64_t>(0x0040000000000000ull) Available
// static_cast<uint64_t>(0x0080000000000000ull)
...
#define S390OpProp_ImplicitlySetsGPR3 \
  static_cast<uint64_t>(0x1000000000000000ull)
#define S390OpProp_ImplicitlySetsGPR4 \
  static_cast<uint64_t>(0x2000000000000000ull)
#define S390OpProp_ImplicitlySetsGPR5 \
  static_cast<uint64_t>(0x4000000000000000ull)
...
class InstOpCode : public OMR::InstOpCode {
 ...
 public:
  ...
  /**
   *  \brief
   *      Defines various metadata of an instruction including the name,
   * description, opcodes, format, the minimum architecture level set (ALS)
   * which introduced the instruction, and the various properties which model
   * the instruction in a way that the code generator understands.
   */
  struct OpCodeMetaData {
    ...
    /**
     *  \brief
     *      The fully qualified instruction name as defined by Principles of
     * Operation.
     */
    ...
    /**
     *  \brief
     *      The minimum architecture level set (ALS) which introduced this
     * instruction.
     */
    ...
    /**
     *  \brief
     *      The properties describing the behavior of this instruction to the
     * codegen.
     */
    uint64_t properties;
  };
  ...
  /**
   * \brief
   *    Gets the minimum architecture level set (ALS) which introduced this
   * instruction.
   *
   * \return
  ...
  uint64_t singleFPOp() {
    return metadata[_mnemonic].properties & S390OpProp_SingleFP;
  }
  uint64_t doubleFPOp() {
    return metadata[_mnemonic].properties & S390OpProp_DoubleFP;
  }
  uint64_t gprOp() {
    return (metadata[_mnemonic].properties &
            (S390OpProp_DoubleFP | S390OpProp_SingleFP)) == 0;
  }
  uint64_t fprOp() {
    return metadata[_mnemonic].properties &
           (S390OpProp_DoubleFP | S390OpProp_SingleFP);
  }

  uint64_t isBranchOp() {
    return metadata[_mnemonic].properties & S390OpProp_BranchOp;
  }
  uint64_t isTrap() {
    return (metadata[_mnemonic].properties & S390OpProp_Trap) != 0;
  }
  uint64_t isLoad() {
    return metadata[_mnemonic].properties & S390OpProp_IsLoad;
  }
  uint64_t isStore() {
    return metadata[_mnemonic].properties & S390OpProp_IsStore;
  }
  uint64_t isCall() {
    return metadata[_mnemonic].properties & S390OpProp_IsCall;
  }
  uint64_t isCompare() {
    return metadata[_mnemonic].properties & S390OpProp_IsCompare;
  }
  uint64_t isExtendedImmediate() {
    return metadata[_mnemonic].properties & S390OpProp_IsExtendedImmediate;
  }
  uint64_t usesTarget() {
    return metadata[_mnemonic].properties & S390OpProp_UsesTarget;
  }

  uint64_t is64bit() {
    return metadata[_mnemonic].properties & S390OpProp_Is64Bit;
  }
  uint64_t is32bit() {
    return metadata[_mnemonic].properties & S390OpProp_Is32Bit;
  }
  uint64_t is32to64bit() {
    return metadata[_mnemonic].properties & S390OpProp_Is32To64Bit;
  }

  uint64_t hasLongDispSupport() {
    return metadata[_mnemonic].properties & S390OpProp_LongDispSupported;
  }
  uint64_t usesRegPairForTarget() {
    return metadata[_mnemonic].properties & S390OpProp_UsesRegPairForTarget;
  }
  uint64_t usesRegPairForSource() {
    return metadata[_mnemonic].properties & S390OpProp_UsesRegPairForSource;
  }
  uint64_t usesRegRangeForTarget() {
    return metadata[_mnemonic].properties & S390OpProp_UsesRegRangeForTarget;
  }
  uint64_t canUseRegPairForTarget() {
    return usesRegPairForTarget() || usesRegRangeForTarget();
  }
  uint64_t shouldUseRegPairForTarget() { return usesRegPairForTarget(); }

  uint64_t implicitlyUsesGPR0() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlyUsesGPR0;
  }
  uint64_t implicitlyUsesGPR1() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlyUsesGPR1;
  }
  uint64_t implicitlyUsesGPR2() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlyUsesGPR2;
  }

  uint64_t implicitlySetsGPR0() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlySetsGPR0;
  }
  uint64_t implicitlySetsGPR1() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlySetsGPR1;
  }
  uint64_t implicitlySetsGPR2() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlySetsGPR2;
  }
  uint64_t implicitlySetsGPR3() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlySetsGPR3;
  }
  uint64_t implicitlySetsGPR4() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlySetsGPR4;
  }
  uint64_t implicitlySetsGPR5() {
    return metadata[_mnemonic].properties & S390OpProp_ImplicitlySetsGPR5;
  }

  uint64_t setsOperand1() {
    return metadata[_mnemonic].properties & S390OpProp_SetsOperand1;
  }
  uint64_t setsOperand2() {
    return metadata[_mnemonic].properties & S390OpProp_SetsOperand2;
  }
  uint64_t setsOperand3() {
    return metadata[_mnemonic].properties & S390OpProp_SetsOperand3;
  }
  uint64_t setsOperand4() {
    return metadata[_mnemonic].properties & S390OpProp_SetsOperand4;
  }

  uint64_t setsCC() {
    return (setsZeroFlag() || setsSignFlag() || setsOverflowFlag() ||
            setsCompareFlag() || setsCarryFlag() ||
            (metadata[_mnemonic].properties & S390OpProp_SetsCC));
  }
  uint64_t readsCC() {
    return metadata[_mnemonic].properties & S390OpProp_ReadsCC;
  }

  uint64_t setsZeroFlag() {
    return metadata[_mnemonic].properties & S390OpProp_SetsZeroFlag;
  }
  uint64_t setsSignFlag() {
    return metadata[_mnemonic].properties & S390OpProp_SetsSignFlag;
  }
  uint64_t setsOverflowFlag() {
    return metadata[_mnemonic].properties & S390OpProp_SetsOverflowFlag;
  }
  uint64_t setsCompareFlag() {
    return metadata[_mnemonic].properties & S390OpProp_SetsCompareFlag;
  }
  uint64_t setsCarryFlag() { return setsZeroFlag(); }

  uint64_t isRegCopy() {
    return metadata[_mnemonic].properties & S390OpProp_IsRegCopy;
  }
  uint64_t hasTwoMemoryReferences() {
    return metadata[_mnemonic].properties & S390OpProp_HasTwoMemoryReferences;
  }

  uint64_t readsFPC() {
    return metadata[_mnemonic].properties & S390OpProp_ReadsFPC;
  }
  uint64_t setsFPC() {
    return metadata[_mnemonic].properties & S390OpProp_SetsFPC;
  }

  uint64_t isLabel() { return _mnemonic == LABEL; }

  uint64_t usesM3() {
    return metadata[_mnemonic].properties & S390OpProp_UsesM3;
  }
  uint64_t usesM4() {
    return metadata[_mnemonic].properties & S390OpProp_UsesM4;
  }
  uint64_t usesM5() {
    return metadata[_mnemonic].properties & S390OpProp_UsesM5;
  }
  uint64_t usesM6() {
    return metadata[_mnemonic].properties & S390OpProp_UsesM6;
  }
  uint64_t hasExtendedMnemonic() {
    return metadata[_mnemonic].properties & S390OpProp_HasExtendedMnemonic;
  }
  uint64_t isVectorStringOp() {
    return metadata[_mnemonic].properties & S390OpProp_VectorStringOp;
  }
  uint64_t isVectorFPOp() {
    return metadata[_mnemonic].properties & S390OpProp_VectorFPOp;
  }

  /* Static */
  static void copyBinaryToBufferWithoutClear(uint8_t* cursor,
                                             Mnemonic i_opCode);
  static void copyBinaryToBuffer(uint8_t* cursor, Mnemonic i_opCode);
  static uint8_t getInstructionLength(
      Mnemonic i_opCode); /* Using a table that maps values of bit 0-1 to
                             instruction length from POP chapter 5,  topic:
                             Instruction formats (page 5.5)*/
  static uint8_t getInstructionFormat(Mnemonic i_opCode) {
    return metadata[i_opCode].format;
  }
  static const uint8_t* getOpCodeBinaryRepresentation(Mnemonic i_opCode) {
    return metadata[i_opCode].opcode;
  }

  /* Non-Static methods that calls static implementations */
  void copyBinaryToBufferWithoutClear(uint8_t* cursor) {
    copyBinaryToBufferWithoutClear(cursor, _mnemonic);
  }
  void copyBinaryToBuffer(uint8_t* cursor) {
    copyBinaryToBuffer(cursor, _mnemonic);
  }
  ...
  const uint8_t* getOpCodeBinaryRepresentation() {
    return getOpCodeBinaryRepresentation(_mnemonic);
  }

  /** \brief
   *    Gets the 20-bit displacement mnemonic which is equivalent to a 12-bit
   * displacement mnemonic.
   *
   *  \param op
   *     The 12-bit displacement mnemonic for which to find an equivalent 20-bit
   * displacement mnemonic.
   *
   *  \return
   *     The 20-bit displacement mnemonic if it exists, otherwise `BAD`
   * mnemonic.
   */
  static Mnemonic getEquivalentLongDisplacementMnemonic(Mnemonic op);

  /* Static methods for getting the correct opCode depending on platform (32bit,
   * 64bit, etc.) */
  ...
  static Mnemonic getLoadRegOpCodeFromNode(TR::CodeGenerator* cg,
                                           TR::Node* node);
