...
IsNotExtended,
    ...
    IsMII,
    IsVRIa,  ///< Is VRI (Vector Register-and-Immediate) Operation and extended
             ///< opCode field
    IsVRIb, IsVRIc, IsVRId, IsVRIe, IsVRIf, IsVRIg, IsVRIh, IsVRIi,
    IsVRRa,  ///< Is VRR (Vector Register-and-Register) Operation and extended
             ///< opCode field
    IsVRRb, IsVRRc, IsVRRd, IsVRRe, IsVRRf, IsVRRg, IsVRRh, IsVRRi,
    IsVRSa,  ///< Is VRS (Vector Register-and-Storage) Operation and extended
             ///< opCode field
    IsVRSb, IsVRSc, IsVRSd,
    IsVRV,   ///< Is VRV (Vector Register-and-Vector-Index) Operation and
             ///< extended opCode field
    IsVRX,   ///< Is VRX (register-and-index-storage) instruction eg VL V1,D2(X2
             ///< ,B2)
    IsVSI,   ///< Is VSI (register-and-storage) Operation and extended opCode
             ///< field
    ...
    IsOpCodeOnly,  ///< This is used for many instructions which only require
                   ///< the opcode
    IsNOP,
