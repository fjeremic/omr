...
extern bool storeHelperImmediateInstruction(TR::Node* valueChild,
                                            TR::CodeGenerator* cg,
                                            bool isReversed,
 ...
 * the prolog code.
 */
void* OMR::Z::Linkage::saveArguments(void* cursor,
                                     bool genBinary,
                                     bool InPreProlog,
                                     int32_t frameOffset,
...
TR::Register* OMR::Z::Linkage::pushLongArg32(
    TR::Node* callNode,
    TR::Node* child,
    int32_t numIntegerArgs,
    int32_t numFloatArgs,
    int32_t* stackOffsetPtr,
...
TR::Instruction* OMR::Z::Linkage::restorePreservedRegs(
    TR::RealRegister::RegNum firstUsedReg,
