...
TR::Instruction *OMR::Z::Instruction::getOutOfLineEXInstr() {
  ...
  case TR::InstOpCode::EX: {
    ...
    TR_ASSERT(cis != NULL, "Out of line EX instruction doesn't have a "
                           "constantInstructionSnippet\n");
    return cis->getInstruction();
  }
  case TR::InstOpCode::EXRL: {
    TR::S390ConstantInstructionSnippet *cis =
        (TR::S390ConstantInstructionSnippet *)((TR::S390RILInstruction *)self())
            ->getTargetSnippet();
    TR_ASSERT(cis != NULL, "Out of line EXRL instruction doesn't have a "
                           "constantInstructionSnippet\n");
    return cis->getInstruction();
  }
  default:
