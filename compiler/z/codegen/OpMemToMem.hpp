...
class MemToMemMacroOp {
 public:
  virtual TR::Instruction* generate(TR::Register* dstReg, TR::Register* srcReg,
    ...
    if (_srcRegTemp) _cg->stopUsingRegister(_srcRegTemp);
    if (_dstRegTemp) _cg->stopUsingRegister(_dstRegTemp);
...
class MemToMemTypedVarLenMacroOp : public MemToMemTypedMacroOp {
 ...
 protected:
  ...
  TR::RegisterDependencyConditions* addCoreDependencies(
      TR::RegisterDependencyConditions* baseDependencies);
  TR::Register* _lenReg;
...
class MemCpyAtomicMacroOp : public MemToMemTypedVarLenMacroOp {
 public:
  ...
  void cleanUpReg() {
    if (_trace) traceMsg(_cg->comp(), "MemCpyAtomicMacroOp: cleanUpReg\n");
