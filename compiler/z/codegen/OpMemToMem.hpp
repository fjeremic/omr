...
public:
  MemCpyConstLenMacroOp(TR::Node* rootNode, TR::Node* dstNode, TR::Node* srcNode, TR::CodeGenerator* cg, int64_t length,
...
public:
  ...
  TR::Register* getAlignedReg()
  {
    return _alignedReg;
  };
  TR::Register* getWorkReg()
  {
    return _workReg;
  };
  ...
  TR::Instruction* generateOneSTXthenSTYLoopLabel(TR::LabelSymbol*, TR::LabelSymbol*, int32_t, TR::InstOpCode::Mnemonic,
    TR::InstOpCode::Mnemonic, int32_t, TR::InstOpCode::Mnemonic, TR::InstOpCode::Mnemonic);
