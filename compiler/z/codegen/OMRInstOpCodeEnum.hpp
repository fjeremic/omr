...
ASSOCREGS, // Register Association
  ...
  MAYHR, // Multiply and Add Unnormalized, long HFP sources and high-order part
         // of extended HFP result
  MAYL, // Multiply and Add Unnormalized, long HFP sources and low-order part of
        // extended HFP result
  ...
  MYHR,  // Multiply Unnormalized, long HFP sources and high-order part of
         // extended HFP result
  MYL, // Multiply Unnormalized, long HFP sources and low-order part of extended
       // HFP result
