...
ASSOCREGS,  // Register Association
    ...
    MAY,   // Multiply and Add Unnormalized, long HFP sources and extended HFP
           // result
    MAYH, // Multiply and Add Unnormalized, long HFP sources and high-order part
          // of extended HFP result
    MAYHR, // Multiply and Add Unnormalized, long HFP sources and high-order
           // part of extended HFP result
    MAYL,  // Multiply and Add Unnormalized, long HFP sources and low-order part
           // of extended HFP result
    MAYLR, // Multiply and Add Unnormalized, long HFP sources and low-order part
           // of extended HFP result
    MAYR,  // Multiply and Add Unnormalized, long HFP sources and extended HFP
           // result
    MDTR,  // Multiply (DFP64)
    MXTR,  // Multiply (DFP128)
    MY,    // Multiply Unnormalized, long HFP sources and extended HFP result
    MYH,   // Multiply Unnormalized, long HFP sources and high-order part of
           // extended HFP result
    MYHR,  // Multiply Unnormalized, long HFP sources and high-order part of
           // extended HFP result
    MYL,   // Multiply Unnormalized, long HFP sources and low-order part of
           // extended HFP result
    MYLR,  // Multiply Unnormalized, long HFP sources and low-order part of
           // extended HFP result
