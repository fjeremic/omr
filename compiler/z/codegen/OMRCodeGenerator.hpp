...
class OMR_EXTENSIBLE CodeGenerator : public OMR::CodeGenerator {
 public:
  ...
  TR::list<TR::Register *> *setFirstTimeLiveOOLRegisterList(
  ...
  TR_S390ScratchRegisterManager *generateScratchRegisterManager(
      int32_t capacity = 8);
  ...
  TR::list<TR_OpaqueClassBlock *> *getPICsListForInterfaceSnippet(
      TR::S390ConstantDataSnippet *ifcSnippet);
  ...
  void StopUsingEscapedMemRefsRegisters(
  ...
  void collectConflictingAddressNodes(
  ...
  TR_S390OutOfLineCodeSection *findS390OutOfLineCodeSectionFromLabel(
  ...
  struct constantHashInfo {
    static CS2::HashValue Hash(
        const TR_S390ConstantDataSnippetKey &key,
    ...
    static bool Equal(const TR_S390ConstantDataSnippetKey &key1,
      ...
      if (key1.node != key2.node) return false;
      switch (key1.size) {
        case 4:
  ...
  TR::S390ConstantInstructionSnippet *createConstantInstruction(
  ...
  TR_S390OutOfLineCodeSection *findOutLinedInstructionsFromLabel(
      TR::LabelSymbol *label);
