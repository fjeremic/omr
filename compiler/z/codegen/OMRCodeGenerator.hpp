...
public:
  ...
  struct TR_BranchPreloadCallData
  {
    ...
    TR_BranchPreloadCallData(TR::Instruction* i,
                             TR::LabelSymbol* l,
                             TR::Block* b,
                             TR::SymbolReference* s,
                             int32_t f)
      : _callInstr(i)
      , _callLabel(l)
      , _callBlock(b)
  ...
  TR::Register* evaluateLengthMinusOneForMemoryOps(TR::Node*,
                                                   bool,
                                                   bool& lenMinusOne);
  ...
  void genMemCpy(TR::MemoryReference* targetMR,
                 TR::Node* targetNode,
                 TR::MemoryReference* sourceMR,
                 TR::Node* sourceNode,
                 int64_t copySize);
  void genMemClear(TR::MemoryReference* targetMR,
                   TR::Node* targetNode,
                   int64_t clearSize);
  ...
  bool loadAndStoreMayOverlap(TR::Node* store,
                              size_t storeSize,
                              TR::Node* load,
                              size_t loadSize,
  ...
  bool checkSimpleLoadStore(TR::Node* loadNode,
                            TR::Node* storeNode,
                            TR::Block* block);
   ...
   * is zero.
   */
  TR::Instruction* insertPad(TR::Node* node,
  ...
  TR::S390ConstantInstructionSnippet* createConstantInstruction(
    ...
    TR::Node* node,
    TR::Instruction* instr);
  TR::S390ConstantDataSnippet* findOrCreateConstant(TR::Node*,
                                                    void* c,
                                                    uint16_t size);
  TR::S390ConstantDataSnippet* findOrCreate2ByteConstant(TR::Node*,
                                                         int16_t c,
                                                         bool isWarm = 0);
  TR::S390ConstantDataSnippet* findOrCreate4ByteConstant(TR::Node*,
                                                         int32_t c,
                                                         bool isWarm = 0);
  TR::S390ConstantDataSnippet* findOrCreate8ByteConstant(TR::Node*,
                                                         int64_t c,
                                                         bool isWarm = 0);
  TR::S390ConstantDataSnippet* Create4ByteConstant(TR::Node*,
                                                   int32_t c,
                                                   bool writable);
  TR::S390ConstantDataSnippet* Create8ByteConstant(TR::Node*,
                                                   int64_t c,
                                                   bool writable);
  TR::S390ConstantDataSnippet* CreateConstant(TR::Node*,
                                              void* c,
                                              uint16_t size,
                                              bool writable);
  ...
  bool isActiveCompareCC(TR::InstOpCode::Mnemonic opcd,
                         TR::Register* tReg,
                         TR::Register* sReg);
   ...
   */
  bool signExtendedHighOrderBits(TR::Node* node,
   ...
   */
  bool clearHighOrderBits(TR::Node* node,
                          TR::Register* targetRegister,
                          uint32_t numberOfBits);
