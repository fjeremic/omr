...
public:
  ...
  void genCopyFromLiteralPool(TR::Node* node, int32_t bytesToCopy, TR::MemoryReference* targetMR, size_t litPoolOffset,
  ...
  void setCurrentCheckNodeBeingEvaluated(TR::Node* n)
  {
    _currentCheckNode = n;
  }
  TR::Node* getCurrentCheckNodeBeingEvaluated()
  {
    return _currentCheckNode;
  }
  ...
  {
    return _nextAvailableBlockIndex;
  }
  ...
  void setAccumulatorNodeUsage(int32_t n)
  {
    _accumulatorNodeUsage = n;
  }
  int32_t getAccumulatorNodeUsage()
  {
    return _accumulatorNodeUsage;
  }
  void incAccumulatorNodeUsage()
  {
    _accumulatorNodeUsage++;
  }
  ...
  int32_t getEstimatedExtentOfLitLoop()
  {
    return _extentOfLitPool;
  }
  ...
  void setEnableBranchPreload()
  {
    _cgFlags.set(S390CG_enableBranchPreload);
  }
  void setDisableBranchPreload()
  {
    _cgFlags.reset(S390CG_enableBranchPreload);
  }
  ...
  bool getExitPointsInMethod()
  {
    return _cgFlags.testAny(S390CG_doesExit);
  }
  ...
  {
    _cgFlags.set(S390CG_enableTLHPrefetching);
  }
  ...
  uint8_t getFCondMoveBranchOpCond()
  {
    return fCondMoveBranchOpCond;
  }
  ...
  uint8_t getRCondMoveBranchOpCond()
  {
    return 0xF - fCondMoveBranchOpCond;
  }
  ...
  TR::Block* getCurrentRABlock()
  {
    return _curRABlock;
  }
  void setCurrentRABlock(TR::Block* block)
  {
    _curRABlock = block;
  }
  ...
  TR_ConstHashCursor getConstantDataSnippets()
  {
    return _constantHashCur;
  }
  ...
  TR::Instruction* ccInstruction()
  {
    return _ccInstruction;
  }
  void setCCInstruction(TR::Instruction* cc)
  {
    _ccInstruction = cc;
  }
