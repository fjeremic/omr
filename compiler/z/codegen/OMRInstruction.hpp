...
class OMR_EXTENSIBLE Instruction : public OMR::Instruction {
 ...
 public:
  ...
  TR::RegisterDependencyConditions* setDependencyConditionsNoBookKeeping(
      TR::RegisterDependencyConditions* cond);
  TR::RegisterDependencyConditions* updateDependencyConditions(
      TR::RegisterDependencyConditions* cond);
  void resetDependencyConditions(
      TR::RegisterDependencyConditions* cond = NULL) {
    _conditions = cond;
  }
  ...
  virtual bool defsAnyRegister(
      TR::Register* reg);  // Includes looking into register pairs
 ...
 protected:
  ...
  virtual void assignRegistersAndDependencies(
