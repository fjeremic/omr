...
class OMR_EXTENSIBLE Instruction : public OMR::Instruction {
 ...
 public:
  ...
  bool matchesAnyRegister(TR::Register* reg,
  ...
  virtual void setMaskField(uint32_t* instruction,
                            int8_t mask,
                            int8_t nibbleIndex);
 ...
 protected:
  ...
  void block(TR::Register** sourceReg,
             int32_t _sourceRegSize,
             TR::Register** targetReg,
             int targetRegSize,
             TR::MemoryReference** sourceMem,
             TR::MemoryReference** targetMem);
  void unblock(TR::Register** sourceReg,
               int32_t sourceRegSize,
               TR::Register** targetReg,
               int targetRegSize,
               TR::MemoryReference** sourceMem,
