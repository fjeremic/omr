...
public:
  ...
  RegisterDependencyConditions(RegisterDependencyConditions* iConds,
                               ...
                               TR::CodeGenerator* cg)
    : OMR::RegisterDependencyConditionsConnector(iConds,
                                                 numNewPreConds,
                                                 numNewPostConds,
                                                 cg)
  {}
  ...
  RegisterDependencyConditions(TR_S390RegisterDependencyGroup* _preConditions,
                               ...
                               TR::CodeGenerator* cg)
    : OMR::RegisterDependencyConditionsConnector(_preConditions,
                                                 _postConditions,
                                                 numPreConds,
                                                 numPostConds,
                                                 cg)
...
generateRegisterDependencyConditions(uint16_t numPreConds,
                                     uint16_t numPostConds,
                                     TR::CodeGenerator* cg)
{
...
inline TR::RegisterDependencyConditions*
generateRegisterDependencyConditions(TR::CodeGenerator* cg,
                                     TR::Node* node,
                                     uint32_t extranum,
