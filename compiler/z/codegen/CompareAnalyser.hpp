...
class TR_S390CompareAnalyser : public TR_Analyser {
 ...
 public:
  ...
  TR::RegisterDependencyConditions *longOrderedCompareAndBranchAnalyser(
      TR::Node *root, TR::InstOpCode::Mnemonic branchOpCode,
      ...
      TR::LabelSymbol *trueLabel, TR::LabelSymbol *falseLabel,
      bool &internalControlFlowStarted);

  void longEqualityCompareAndBranchAnalyser(
