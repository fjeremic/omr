...
TR::Instruction* generateS390CompareAndBranchInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic compareOpCode,
  ...
  TR::LabelSymbol* branchDestination, bool needsCC = true, bool targetIsFarAndCold = false, TR::Instruction* preced = 0,
...
TR::Instruction* generateRXEInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* n,
  TR::Register* treg, TR::MemoryReference* mf, uint8_t mask3, TR::Instruction* preced = 0);
...
TR::Instruction* generateRegLitRefInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* n,
  TR::Register* treg, uintptrj_t imm, int32_t reloType = 0, TR::RegisterDependencyConditions* cond = 0,
...
TR::Instruction* generateRegLitRefInstruction(TR::CodeGenerator* cg, TR::InstOpCode::Mnemonic op, TR::Node* n,
  TR::Register* treg, uintptrj_t imm, TR::RegisterDependencyConditions* cond, TR::Instruction* preced = 0,
  TR::Register* base = 0, bool isPICCandidate = false);
