...
public:
  ...
  bool isUsedInMemRef()
  {
    return _flags.testAny(IsUsedInMemRef);
  }
  void setIsUsedInMemRef(bool b = true)
  {
    _flags.set(IsUsedInMemRef, b);
  }
  ...
  {
    return _flags.testAny(DependencySet);
  }
  ...
  {
    return _flags.testAny(AlreadySignExtended);
  }
  void setAlreadySignExtended()
  {
    _flags.set(AlreadySignExtended);
  }
  void resetAlreadySignExtended()
  {
    _flags.reset(AlreadySignExtended);
  }
