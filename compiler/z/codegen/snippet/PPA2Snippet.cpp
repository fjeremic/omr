...
TR::PPA2Snippet::PPA2Snippet(TR::CodeGenerator* cg,
...
uint8_t* TR::PPA2Snippet::emitSnippetBody() {
  ...
  *reinterpret_cast<int32_t*>(cursor) = 0x00000000;
  ...
  // Signed offset from PPA2 to compilation unit's primary Entry Point (at the
  // lowest address)
  *reinterpret_cast<int32_t*>(cursor) = 0x00000000;
  cursor += sizeof(int32_t);
...
uint32_t TR::PPA2Snippet::getLength(int32_t estimatedSnippetStart) {
