...
TR::SystemLinkage::initS390RealRegisterLinkage()
{
  ...
  for (icount = TR::RealRegister::FirstGPR;
       icount >= TR::RealRegister::LastAssignableGPR;
       icount++) {
    int32_t weight;
...
// Non-Java use
void
TR::SystemLinkage::initParamOffset(TR::ResolvedMethodSymbol* method,
                                   int32_t stackIndex,
 ...
 */
void
TR::SystemLinkage::generateInstructionsForCall(
  TR::Node* callNode,
 ...
 */
TR::Register*
TR::SystemLinkage::callNativeFunction(
  TR::Node* callNode,
  TR::RegisterDependencyConditions* deps,
  intptrj_t targetAddress,
  TR::Register* methodAddressReg,
...
void
TR::SystemLinkage::mapSingleAutomatic(TR::AutomaticSymbol* p,
                                      uint32_t& stackIndex)
{
  size_t align = 1;
