...
OMR::Z::TreeEvaluator::cconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  generateLoad32BitConstant(
    cg, node, node->getConst<uint16_t>(), tempReg, true);
  return tempReg;
}
...
OMR::Z::TreeEvaluator::labsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  generateRRInstruction(
    cg, TR::InstOpCode::LPGR, node, targetRegister, sourceRegister);
  node->setRegister(targetRegister);
...
OMR::Z::TreeEvaluator::dsqrtEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (firstChild->isSingleRefUnevaluated() &&
    ...
    generateRXEInstruction(cg,
                           ...
                           node,
                           targetRegister,
                           generateS390MemoryReference(firstChild, cg),
                           0);
  } else {
    TR::Register* opRegister = cg->evaluate(firstChild);
    generateRRInstruction(
      cg, TR::InstOpCode::SQDBR, node, targetRegister, opRegister);
    cg->decReferenceCount(firstChild);
  }
  node->setRegister(targetRegister);
  return targetRegister;
...
OMR::Z::TreeEvaluator::fsqrtEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  generateRRInstruction(
    cg, TR::InstOpCode::SQEBR, node, targetRegister, opRegister);
...
OMR::Z::TreeEvaluator::dnintEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  generateRRInstruction(
    cg, TR::InstOpCode::FIDBR, node, targetRegister, opRegister);
...
OMR::Z::TreeEvaluator::fnintEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  generateRRInstruction(
    cg, TR::InstOpCode::FIEBR, node, targetRegister, opRegister);
...
OMR::Z::TreeEvaluator::getpmEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* targetRegister = cg->allocateRegister();
  generateRRInstruction(
    cg, TR::InstOpCode::IPM, node, targetRegister, targetRegister);
