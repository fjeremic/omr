...
class OMR_EXTENSIBLE MemoryReference : public OMR::MemoryReference {
 ...
 public:
  ...
  void addInstrSpecificRelocation(TR::CodeGenerator* cg,
                                  TR::Instruction* instr,
                                  int32_t disp,
                                  uint8_t* cursor) {}  // J9 AOT only for now
...
TR::MemoryReference* generateS390MemoryReference(int32_t,
                                                 TR::CodeGenerator* cg);
TR::MemoryReference* generateS390MemoryReference(TR::Register*,
                                                 int32_t,
                                                 TR::CodeGenerator* cg,
                                                 const char* name = NULL);
TR::MemoryReference* generateS390MemoryReference(TR::Register*,
...
TR::MemoryReference* generateS390MemoryReference(TR::Node*,
                                                 TR::CodeGenerator*,
                                                 bool canUseRX = false);
TR::MemoryReference* generateS390MemoryReference(TR::MemoryReference&,
                                                 int32_t,
                                                 TR::CodeGenerator* cg);
TR::MemoryReference* generateS390MemoryReference(TR::Node*,
                                                 TR::SymbolReference*,
...
TR::MemoryReference* generateS390MemoryReference(int32_t,
                                                 ...
                                                 TR::Register*,
                                                 TR::Node* node = NULL);
TR::MemoryReference* generateS390MemoryReference(int64_t,
                                                 TR::DataType,
                                                 TR::CodeGenerator*,
                                                 TR::Register*,
                                                 TR::Node* node = NULL);
TR::MemoryReference* generateS390MemoryReference(float,
                                                 TR::DataType,
                                                 TR::CodeGenerator*,
                                                 TR::Node*);
TR::MemoryReference* generateS390MemoryReference(double,
                                                 TR::DataType,
                                                 TR::CodeGenerator*,
                                                 TR::Node*);
TR::MemoryReference* generateS390MemoryReference(TR::CodeGenerator* cg,
