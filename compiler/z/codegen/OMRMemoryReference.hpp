...
public:
  ...
  static bool needsAdjustDisp(TR::Instruction* instr,
  ...
  static bool shouldLabelForRAS(TR::SymbolReference* symRef,
                                TR::CodeGenerator* cg);
  int32_t calcDisplacement(uint8_t* cursor,
  ...
  void addInstrSpecificRelocation(TR::CodeGenerator* cg,
                                  TR::Instruction* instr,
                                  int32_t disp,
                                  uint8_t* cursor)
  {} // J9 AOT only for now
  ...
  bool tryBaseIndexDispl(TR::CodeGenerator* cg,
                         TR::Node* loadStore,
                         TR::Node* addressChild);
  ...
  void addToTemporaryNegativeOffset(TR::Node* node,
                                    int32_t offset,
                                    TR::CodeGenerator* cg);
  ...
  bool ZeroBasePtr_EvaluateSubtree(TR::Node* subTree,
                                   TR::CodeGenerator* cg,
                                   MemoryReference* mr);
  ...
  void populateAloadTree(TR::Node* subTree,
                         TR::CodeGenerator* cg,
  ...
  TR::Instruction* enforce4KDisplacementLimit(
    ...
    bool forceDueToAlignmentBump = false);
  TR::Instruction* enforceSSFormatLimits(TR::Node* node,
                                         TR::CodeGenerator* cg,
                                         TR::Instruction* preced);
  TR::Instruction* enforceRSLFormatLimits(TR::Node* node,
                                          TR::CodeGenerator* cg,
                                          TR::Instruction* preced);
  TR::Instruction* enforceVRXFormatLimits(TR::Node* node,
                                          TR::CodeGenerator* cg,
  ...
  int32_t generateBinaryEncoding(uint8_t* modRM,
                                 TR::CodeGenerator* cg,
                                 TR::Instruction* instr);
  int32_t estimateBinaryLength(int32_t currentEstimate,
                               TR::CodeGenerator* cg,
                               TR::Instruction* instr);
  ...
  void tryForceFolding(TR::Node* rootLoadOrStore,
                       TR::CodeGenerator* cg,
  ...
  void createPatchableDataInLitpool(TR::Node* node,
                                    TR::CodeGenerator* cg,
                                    TR::Register* tempReg,
...
TR::MemoryReference*
generateS390MemoryReference(int32_t, TR::CodeGenerator* cg);
TR::MemoryReference*
generateS390MemoryReference(TR::Register*,
                            int32_t,
                            TR::CodeGenerator* cg,
                            const char* name = NULL);
TR::MemoryReference*
generateS390MemoryReference(TR::Register*,
                            ...
                            TR::CodeGenerator* cg);
TR::MemoryReference*
generateS390MemoryReference(TR::Node*,
                            TR::CodeGenerator*,
                            bool canUseRX = false);
TR::MemoryReference*
generateS390MemoryReference(TR::MemoryReference&,
                            int32_t,
                            TR::CodeGenerator* cg);
TR::MemoryReference*
generateS390MemoryReference(TR::Node*,
                            ...
                            TR::CodeGenerator*);
TR::MemoryReference*
generateS390MemoryReference(TR::Snippet*,
                            TR::CodeGenerator*,
                            TR::Register*,
                            TR::Node*);
TR::MemoryReference*
generateS390MemoryReference(TR::Snippet*,
                            ...
                            TR::CodeGenerator*);
TR::MemoryReference*
generateS390MemoryReference(int32_t,
                            TR::DataType,
                            TR::CodeGenerator*,
                            TR::Register*,
                            TR::Node* node = NULL);
TR::MemoryReference*
generateS390MemoryReference(int64_t,
                            TR::DataType,
                            TR::CodeGenerator*,
                            TR::Register*,
                            TR::Node* node = NULL);
TR::MemoryReference*
generateS390MemoryReference(float, TR::DataType, TR::CodeGenerator*, TR::Node*);
TR::MemoryReference*
generateS390MemoryReference(double,
                            TR::DataType,
                            TR::CodeGenerator*,
                            TR::Node*);
TR::MemoryReference*
