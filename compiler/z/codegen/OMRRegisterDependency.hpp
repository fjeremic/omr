...
class TR_S390RegisterDependencyGroup {
 ...
 public:
  ...
  TR::Register* searchForRegister(TR::Register* vr,
                                  uint8_t flag,
  ...
  int32_t searchForRegisterPos(TR::Register* vr,
                               uint8_t flag,
                               uint32_t numberOfRegisters,
                               TR::CodeGenerator* cg) {
    for (int32_t i = 0; i < numberOfRegisters; i++) {
  ...
  void stopUsingDepRegs(uint32_t numberOfRegisters,
                        TR::Register* ret1,
                        TR::Register* ret2,
                        TR::CodeGenerator* cg) {
    for (uint32_t i = 0; i < numberOfRegisters; i++) {
...
class RegisterDependencyConditions : public OMR::RegisterDependencyConditions {
 ...
 public:
  ...
  void resolveSplitDependencies(TR::CodeGenerator* cg,
                                TR::Node* Noce,
                                TR::Node* child,
  ...
  void stopUsingDepRegs(TR::CodeGenerator* cg,
                        TR::Register* ret1 = NULL,
  ...
  void bookKeepingRegisterUses(TR::Instruction* instr,
                               TR::CodeGenerator* cg,
  ...
  bool doesPreConditionExist(TR::Register* vr,
                             TR::RealRegister::RegNum rr,
                             uint32_t flag,
                             bool overwriteAssignAny = false);
  bool doesPostConditionExist(TR::Register* vr,
                              TR::RealRegister::RegNum rr,
                              uint32_t flag,
                              bool overwriteAssignAny = false);
