...
TR_Debug* OMR::Z::Machine::getDebug() {
...
static bool boundNext(TR::Instruction* currentInstruction,
                      int32_t realNum,
                      TR::Register* virtReg) {
...
TR::RealRegister* OMR::Z::Machine::findBestFreeRegister(
  ...
  if (self()->cg()->enableRegisterPairAssociation() &&
    ...
    if ((virtualReg->getSiblingRegister()) &&
        ...
        self()->isLegalOddRegister((TR::RealRegister*)realSibling, ALLOWBLOCKED,
                                   availRegMask)) {
      uint64_t sibRegMask =
