...
void TR_LiveVariableInformation::initializeGenAndKillSetInfo(
    TR_BitVector** regularGenSetInfo,
...
void TR_LiveVariableInformation::findCommonedLoads(
    TR::Node* node,
    TR_BitVector* commonedLoads,
    bool movingForwardThroughTrees,
    vcount_t visitCount) {
...
void TR_LiveVariableInformation::findAllUseOfLocal(
    TR::Node* node,
    int32_t blockNum,
    TR_BitVector* genSetInfo,
    TR_BitVector* killSetInfo,
    TR_BitVector* commonedLoads,
    bool movingForwardThroughTrees,
    vcount_t visitCount) {
...
void TR_LiveVariableInformation::findUseOfLocal(TR::Node* node,
                                                int32_t blockNum,
                                                TR_BitVector** genSetInfo,
                                                TR_BitVector** killSetInfo,
                                                TR_BitVector* commonedLoads,
...
void TR_LiveVariableInformation::visitTreeForLocals(
    TR::Node* node,
    TR_BitVector** blockGenSetInfo,
    TR_BitVector* blockKillSetInfo,
    bool movingForwardThroughTrees,
    bool visitEntireTree,
    vcount_t visitCount,
    TR_BitVector* commonedLoads,
