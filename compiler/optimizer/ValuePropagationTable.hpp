...
const ValuePropagationPtr constraintHandlers[] = {
  ...
  constrainIntegerHighestOneBit, constrainIntegerLowestOneBit, constrainIntegerNumberOfLeadingZeros,
  constrainIntegerNumberOfTrailingZeros, constrainIntegerBitCount, constrainLongHighestOneBit,
  constrainLongLowestOneBit, constrainLongNumberOfLeadingZeros, constrainLongNumberOfTrailingZeros,
