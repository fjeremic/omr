...
private:
  bool _deferUseDefInfoInvalidation; // true if useDefInfo is invalidated during performWithUseDefInfo() but useDefInfo
                                     // is still used (conservatively) later on in the optimization.
