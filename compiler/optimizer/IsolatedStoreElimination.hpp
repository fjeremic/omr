...
private:
  bool _deferUseDefInfoInvalidation; // true if useDefInfo is invalidated during
                                     // performWithUseDefInfo() but useDefInfo
                                     // is still used (conservatively) later on
                                     // in the optimization.
  ...
  bool findStructuresAndNodesUsedIn(TR_UseDefInfo*,
                                    TR_Structure*,
                                    vcount_t,
                                    TR_BitVector*,
                                    TR_BitVector*,
                                    bool*);
  bool markNodesAndLocateSideEffectIn(TR::Node*,
                                      vcount_t,
                                      TR_BitVector*,
                                      TR_BitVector*);
