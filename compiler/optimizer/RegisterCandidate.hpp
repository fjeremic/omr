...
class TR_RegisterCandidate : public TR_Link<TR_RegisterCandidate> {
 public:
  ...
  void addAllBlocksInStructure(TR_Structure*,
                               TR::Compilation*,
  ...
  void processLiveOnEntryBlocks(TR::Block**,
                                int32_t*,
                                TR::Compilation*,
                                TR_Array<int32_t>&,
                                TR_Array<int32_t>&,
  ...
  void removeAssignedCandidateFromLoop(TR::Compilation*,
                                       TR_Structure*,
                                       int32_t,
                                       TR_BitVector*,
                                       TR_BitVector*,
  ...
  void recalculateWeight(TR::Block**,
                         int32_t*,
                         TR::Compilation*,
                         TR_Array<int32_t>&,
                         TR_Array<int32_t>&,
                         ...
                         TR_BitVector*,
                         TR_Array<TR::Block*>& startOfExtendedBB);
  bool prevBlockTooRegisterConstrained(TR::Compilation* comp,
                                       TR::Block*,
                                       TR_Array<int32_t>&,
                                       TR_Array<int32_t>&,
                                       TR_Array<int32_t>&);
...
class TR_RegisterCandidates {
 public:
  ...
  void computeAvailableRegisters(TR_RegisterCandidate*,
                                 int32_t,
                                 int32_t,
                                 TR::Block**,
                                 TR_BitVector*);
 ...
 private:
  bool candidatesOverlap(TR::Block*,
  ...
  TR_RegisterCandidate* reprioritizeCandidates(TR_RegisterCandidate*,
                                               TR::Block**,
                                               int32_t*,
                                               int32_t,
                                               TR::Block*,
...
class TR_GlobalRegister {
 public:
  ...
  void setCurrentRegisterCandidate(TR_RegisterCandidate* rc,
                                   vcount_t,
                                   TR::Block*,
                                   int32_t,
                                   TR::Compilation*,
  ...
  TR::Node* createStoreFromRegister(vcount_t,
                                    TR::TreeTop*,
                                    int32_t,
                                    TR::Compilation*,
                                    bool storeUnconditionally = false);
  TR::Node* createStoreToRegister(TR::TreeTop*,
                                  TR::Node*,
                                  vcount_t,
                                  TR::Compilation*,
