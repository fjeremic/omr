...
public:
  ...
  public:
    ...
    TR_BitVector& getCandidateBlocks()
    {
    ...
    {
      return iterator(_candidateBlocks);
    }
  };
  ...
  void addAllBlocksInStructure(
    TR_Structure*, TR::Compilation*, const char* description, vcount_t count = MAX_VCOUNT, bool recursiveCall = false);

  bool find(TR::Block* b);
  bool hasBlock(TR::Block* b)
  {
    return find(b) != 0;
  }
  ...
  TR::SymbolReference* getSplitSymbolReference()
  {
    return _splitSymRef;
  }
  ...
  TR::SymbolReference* getRestoreSymbolReference()
  {
    return _restoreSymRef;
  }
  ...
  TR_BitVector& getBlocksLiveOnEntry()
  {
    return _liveOnEntry;
  }
  TR_BitVector& getBlocksLiveOnExit()
  {
    return _liveOnExit;
  }
  TR::Symbol* getSymbol()
  ...
  bool canBeReprioritized()
  {
    return (_reprioritized > 0);
  }

  void setGlobalRegisterNumber(TR_GlobalRegisterNumber n)
  {
    _lowRegNumber = n;
  }
  ...
  void setReprioritized()
  {
    _reprioritized--;
  }
  void setMaxReprioritized(uint8_t n)
  {
    _reprioritized = n;
  }
  uint8_t getReprioritized()
  {
    return _reprioritized;
  }
  void processLiveOnEntryBlocks(TR::Block**, int32_t*, TR::Compilation*, TR_Array<int32_t>&, TR_Array<int32_t>&,
    TR_Array<int32_t>&, TR_BitVector*, TR_Array<TR::Block*>& startOfExtendedBB, bool removeUnusedLoops = false);
  ...
  List<TR::TreeTop>& getStores()
  {
    return _stores;
  }

  List<TR_Structure>& getLoopsWithHoles()
  {
    return _loopsWithHoles;
  }
  ...
  TR::Node* getMostRecentValue()
  {
    return _mostRecentValue;
  }
  void setMostRecentValue(TR::Node* node)
  {
    _mostRecentValue = node;
  }
  TR::Node* getLastLoad()
  {
    return _lastLoad;
  }
  void setLastLoad(TR::Node* node)
  {
    _lastLoad = node;
  }
  ...
  bool extendedLiveRange()
  {
    return _flags.testAny(extendLiveRange);
  }
  bool is8BitGlobalGPR()
  {
    return _flags.testAny(eightBitGlobalGPR);
  }
  bool initialBlocksWeightComputed()
  {
    return _flags.testAny(initialBlocksWeightComputedFlag);
  }
  bool getValueModified()
  {
    return _flags.testAny(valueModified);
  }
  bool isHighWordZero()
  {
  ...
  void setExtendedLiveRange(bool b)
  {
    _flags.set(extendLiveRange, b);
  }
  void setValueModified(bool b)
  {
    _flags.set(valueModified, b);
  }
  void setHighWordZero(bool b)
  {
...
private:
  ...
  bool isAllBlocks()
  {
    return _flags.testAny(allBlocks);
  }

  void setAllBlocks(bool b)
  {
    _flags.set(allBlocks, b);
  }
  void setIs8BitGlobalGPR(bool b)
  {
    _flags.set(eightBitGlobalGPR, b);
  }
...
public:
  ...
  TR_RegisterCandidate* getFirst()
  {
    return _candidates.getFirst();
  }
...
private:
  ...
  TR_RegisterCandidate* reprioritizeCandidates(TR_RegisterCandidate*, TR::Block**, int32_t*, int32_t, TR::Block*,
    TR::Compilation*, bool reprioritizeFP, bool onlyReprioritizeLongs, TR_BitVector* referencedBlocks,
    TR_Array<int32_t>& blockGPRCount, TR_Array<int32_t>& blockFPRCount, TR_Array<int32_t>& blockVRFCount, TR_BitVector*,
    bool);
  ...
  typedef TR::typed_allocator<std::pair<uint32_t const, TR_RegisterCandidate*>, TR::Region&>
    SymRefCandidateMapAllocator;
  typedef std::less<uint32_t> SymRefCandidateMapComparator;
  typedef std::map<uint32_t, TR_RegisterCandidate*, SymRefCandidateMapComparator, SymRefCandidateMapAllocator>
    SymRefCandidateMap;
...
public:
  ...
  TR_RegisterCandidate* getRegisterCandidateOnEntry()
  {
    return _rcOnEntry;
  }
  TR_RegisterCandidate* getRegisterCandidateOnExit()
  {
    return _rcOnExit;
  }
  TR_RegisterCandidate* getCurrentRegisterCandidate()
  {
    return _rcCurrent;
  }
  TR::TreeTop* getLastRefTreeTop()
  {
    return _lastRef;
  }
  ...
  void setRegisterCandidateOnExit(TR_RegisterCandidate* rc)
  {
    _rcOnExit = rc;
  }
  void setCurrentRegisterCandidate(
    TR_RegisterCandidate* rc, vcount_t, TR::Block*, int32_t, TR::Compilation*, bool resetOtherHalfOfLong = true);
  ...
  void setValue(TR::Node* n)
  {
    _value = n;
  }
  void setAutoContainsRegisterValue(bool b)
  {
    _autoContainsRegisterValue = b;
  }
  void setLastRefTreeTop(TR::TreeTop* tt)
  {
    _lastRef = tt;
  }
  void setReloadRegisterCandidateOnEntry(TR_RegisterCandidate* rc, bool flag = true)
  {
    if (rc == _rcOnEntry)
      _reloadOnEntry = flag;
  }
  bool getReloadRegisterCandidateOnEntry()
  {
    return _reloadOnEntry;
  }
  void setUnavailable(bool flag = true)
  {
    _unavailable = flag;
  }
  void setUnavailableResolved(bool flag = true)
  {
    _unavailableResolved = flag;
  }
  bool isUnavailable()
  {
    return _unavailable;
  }
  bool isUnavailableResolved()
  {
    return _unavailableResolved;
  }
