...
public:
  ...
  bool eliminateRedundantSupportedNodes(TR::Node*,
                                        ...
                                        ContainerType*,
                                        TR::Node**);
  TR::TreeTop* replaceOptimalSubNodes(TR::TreeTop* curTree,
                                      TR::Node*,
                                      TR::Node*,
                                      int32_t,
                                      TR::Node*,
                                      ...
                                      int32_t,
                                      vcount_t);
  void processReusedNode(TR::Node* node,
...
public:
  ...
  TR_ExceptionCheckMotion(TR::Compilation*,
                          TR::Optimizer*,
  ...
  bool analyzeNodeIfSuccessorsAnalyzed(TR::CFGNode*,
                                       TR_RegionStructure*,
                                       ContainerType*,
                                       ContainerType*);
  int32_t perform();
  void initializeGenAndKillSetInfo();
  void analyzeNodeToInitializeGenAndKillSets(TR::TreeTop*,
                                             vcount_t,
                                             TR_BlockStructure*);
  ...
  void removeFromList(ListElement<TR::Node>*,
                      List<TR::Node>*,
                      ListElement<TR::Node>*);
...
{
public:
  TR_RedundantExpressionAdjustment(TR::Compilation*,
                                   TR::Optimizer*,
                                   TR_Structure*,
