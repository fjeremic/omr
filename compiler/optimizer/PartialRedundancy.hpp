...
class TR_PartialRedundancy : public TR::Optimization {
 public:
  ...
  void eliminateRedundantComputations(TR::Block *, TR::Node **,
                                      ContainerType **, TR::TreeTop *);
  ...
  bool eliminateRedundantSupportedNodes(TR::Node *, TR::Node *, bool,
                                        TR::TreeTop *, int32_t, vcount_t,
                                        ContainerType *, ContainerType *,
                                        TR::Node **);
  TR::TreeTop *replaceOptimalSubNodes(TR::TreeTop *curTree, TR::Node *,
                                      TR::Node *, int32_t, TR::Node *,
                                      TR::Node *, bool, int32_t, vcount_t);
  void processReusedNode(TR::Node *node, TR::ILOpCodes newOpCode,
                         TR::SymbolReference *newSymRef, int newNumChildren);
  ...
  void calculateGlobalRegisterWeightsBasedOnStructure(TR_Structure *,
                                                      int32_t *);
...
class TR_ExceptionCheckMotion : public TR_DataFlowAnalysis {
 public:
  ...
  TR_ExceptionCheckMotion(TR::Compilation *, TR::Optimizer *,
                          TR_PartialRedundancy *);
  ...
  bool analyzeNodeIfSuccessorsAnalyzed(TR::CFGNode *, TR_RegionStructure *,
                                       ContainerType *, ContainerType *);
  int32_t perform();
  void initializeGenAndKillSetInfo();
  void analyzeNodeToInitializeGenAndKillSets(TR::TreeTop *, vcount_t,
                                             TR_BlockStructure *);
  ...
  void removeFromList(ListElement<TR::Node> *, List<TR::Node> *,
                      ListElement<TR::Node> *);
...
class TR_RedundantExpressionAdjustment
 ...
 public:
  TR_RedundantExpressionAdjustment(TR::Compilation *, TR::Optimizer *,
                                   TR_Structure *, TR_ExceptionCheckMotion *);
