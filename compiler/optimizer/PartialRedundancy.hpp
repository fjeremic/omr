...
public:
  ...
  ContainerType** getOptSetInfo()
  {
    return _optSetInfo;
  }
  ContainerType** getRednSetInfo()
  {
    return _rednSetInfo;
  }
  ContainerType** getOrigOptSetInfo()
  {
    return _origOptSetInfo;
  }
  ContainerType* getSymOptimalNodes()
  {
    return _symOptimalNodes;
  }
  ContainerType** getUnavailableSetInfo()
  {
    return _unavailableSetInfo;
  }
  int32_t* getGlobalRegisterWeights()
  {
    return _globalRegisterWeights;
  }
...
public:
  ...
  ContainerType** getActualOptSetInfo()
  {
    return _actualOptSetInfo;
  }
  ContainerType** getActualRednSetInfo()
  {
    return _actualRednSetInfo;
  }
  ContainerType** getOptimisticOptSetInfo()
  {
    return _optimisticOptSetInfo;
  }
  ContainerType** getOptimisticRednSetInfo()
  {
    return _optimisticRednSetInfo;
  }
  int32_t** getOrderedOptNumbersList()
  {
    return _orderedOptNumbersList;
  }
  List<TR::Node>** getOrderedOptList()
  {
    return _orderedOptList;
  }
  List<TR::Node>** getGenSetList()
  {
    return _regularGenSetInfo;
  }
  bool getTrySecondBestSolution()
  {
    return _trySecondBestSolution;
  }
  void setBlockFenceStatus(TR::Block*);
  int32_t areExceptionSuccessorsIdentical(TR::CFGNode*, TR::CFGNode*);
  TR_PartialRedundancy* getPartialRedundancy()
  {
    return _partialRedundancy;
  }
  ContainerType* getExprsUnaffectedByOrder()
  {
    return _exprsUnaffectedByOrder;
  }
  ...
  bool trace()
  {
    return _partialRedundancy->trace();
  }
