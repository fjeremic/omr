...
class TR_TranslateTable {
 ...
 protected:
  ...
  TR_TranslateTableData* createTable(uint32_t startA,
                                     uint32_t endA,
                                     uint32_t startB,
                                     uint32_t endB,
                                     uint8_t inputSize,
  ...
  TR_TranslateTableData* createTable(uint32_t startA,
                                     ...
                                     uint8_t outputSize,
                                     uint16_t defaultValue);
  TR_TranslateTableData* createTable(uint16_t startA,
                                     uint16_t endA,
                                     uint8_t inputSize,
                                     uint8_t outputSize,
                                     uint16_t defaultValue);
  ...
  TR_TranslateTableData* matchTable(uint8_t inputSize,
                                    uint8_t outputSize,
                                    void* array);
 ...
 private:
  ...
  TR_TranslateTableData* matchTable(uint32_t startA,
                                    uint32_t endA,
                                    uint32_t startB,
                                    uint32_t endB,
                                    uint8_t inputSize,
...
{
 public:
  TR_RangeTranslateTable(TR::Compilation*,
                         uint8_t,
                         uint8_t,
                         uint32_t,
                         uint32_t,
...
{
 public:
  TR_SetTranslateTable(TR::Compilation*,
                       uint8_t,
                       uint8_t,
