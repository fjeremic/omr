...
private:
  ...
  public:
    ...
    void setCoverage(CoverageKind coverage)
    {
      _coverage = coverage;
    }
    bool hasYieldPoint()
    {
      return _yieldPoint != NoYieldPoint;
    }
    bool hasSoftYieldPoint()
    {
      return _yieldPoint == SoftYieldPoint;
    }
    void setHardYieldPoint()
    {
      _yieldPoint = HardYieldPoint;
    }
    void setSoftYieldPoint()
    {
      _yieldPoint = SoftYieldPoint;
    }
    void removeYieldPoint()
    {
      _yieldPoint = NoYieldPoint;
    }

    void setReverseCoverageInfo(bool b)
    {
      _coveredOnBackwardPaths = b;
    }
    bool getReverseCoverageInfo()
    {
      return _coveredOnBackwardPaths;
    }
    bool isCoveredOnBackwardPaths()
    {
      return _coveredOnBackwardPaths;
    }
    ...
    {
      return _canHaveAYieldPoint;
    }
    void setCanHaveAYieldPoint(bool v)
    {
      _canHaveAYieldPoint = v;
    }

    void setVisitMarker(TR_StructureSubGraphNode* node)
    {
      _visitMarker = node;
    }
    ...
    List<TR_StructureSubGraphNode>& getChildren()
    {
      return _children;
    }
    List<TR_StructureSubGraphNode>& getParents()
    {
      return _parents;
    }
