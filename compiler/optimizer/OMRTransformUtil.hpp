...
class OMR_EXTENSIBLE TransformUtil {
 public:
  ...
  static TR::Node* scalarizeArrayCopy(TR::Compilation* comp,
                                      TR::Node* node,
                                      TR::TreeTop* tt,
                                      bool useElementType,
  ...
  static TR::Node* scalarizeAddressParameter(TR::Compilation* comp,
                                             TR::Node* address,
  ...
  static bool transformIndirectLoadChainAt(TR::Compilation*,
                                           TR::Node* node,
                                           TR::Node* baseExpression,
