...
#define MIN_PROFILED_CALL_FREQUENCY \
  (.65f)  // lowered this from .80f since opportunities were being missed in
          // WAS; in those cases getting rid of the call even in 65% of the
          // cases was beneficial probably due to the improved icache impact
...
class TR_InlinerBase : public TR_HasRandomGenerator {
 ...
 protected:
  ...
  TR_PrexArgInfo *buildPrexArgInfoForOutermostMethod(
      TR::ResolvedMethodSymbol *methodSymbol);
  ...
  int32_t scaleSizeBasedOnBlockFrequency(
      ...
      int32_t coldBorderFrequency =
          0);  // not virtual because we want base class always calling base
               // version of this
  virtual bool exceedsSizeThreshold(TR_CallSite *callSite, int bytecodeSize,
                                    TR::Block *callNodeBlock,
                                    TR_ByteCodeInfo &bcInfo,
                                    int32_t numLocals = 0,
                                    TR_ResolvedMethod *caller = 0,
...
class OMR_InlinerUtil : public TR::OptimizationUtil, public OMR_InlinerHelper {
 ...
 public:
  ...
  virtual TR_ResolvedMethod *findSingleJittedImplementer(
      TR_IndirectCallSite *callsite);
  virtual bool addTargetIfThereIsSingleImplementer(
      TR_IndirectCallSite *callsite);
  virtual TR_PrexArgInfo *createPrexArgInfoForCallTarget(
      TR_VirtualGuardSelection *guard, TR_ResolvedMethod *implementer);
  virtual TR_InnerPreexistenceInfo *createInnerPrexInfo(
 ...
 protected:
  ...
  virtual void refineInliningThresholds(
      TR::Compilation *comp, int32_t &callerWeightLimit,
...
class OMR_InlinerPolicy : public TR::OptimizationPolicy,
 ...
 public:
  ...
  virtual bool replaceSoftwareCheckWithHardwareCheck(
   ...
   */
  virtual bool isInlineableNativeMethod(
 ...
 protected:
  ...
  virtual bool alwaysWorthInlining(TR_ResolvedMethod *calleeMethod,
                                   TR::Node *callNode);
  virtual void determineInliningHeuristic(
      TR::ResolvedMethodSymbol *callerSymbol);
