...
{
public:
  TR_InlinerTracer(TR::Compilation* comp,
                   TR_FrontEnd* fe,
                   TR::Optimization* opt);
...
public:
  ...
  virtual bool perform(TR::Compilation* comp,
                       TR::Node* guardNode,
...
public:
  ...
  void getSymbolAndFindInlineTargets(TR_CallStack*,
                                     TR_CallSite*,
...
protected:
  ...
  void inlineFromGraph(TR_CallStack*,
                       TR_CallTarget* calltarget,
  ...
  int32_t scaleSizeBasedOnBlockFrequency(
    ...
    TR_ResolvedMethod* calleeResolvedMethod,
    TR::Node* callNode,
    int32_t coldBorderFrequency = 0); // not virtual because we want base class
                                      // always calling base version of this
  virtual bool exceedsSizeThreshold(TR_CallSite* callSite,
                                    int bytecodeSize,
  ...
  virtual bool inlineCallTargets(TR::ResolvedMethodSymbol*,
                                 TR_CallStack*,
  ...
  void replaceCallNode(TR::ResolvedMethodSymbol*,
                       TR::Node*,
                       rcount_t,
                       TR::TreeTop*,
                       TR::Node*,
  ...
  bool heuristicForUsingOSR(TR::Node*,
                            TR::ResolvedMethodSymbol*,
                            TR::ResolvedMethodSymbol*,
                            bool);

  TR::Node* createVirtualGuard(TR::Node*,
                               TR::ResolvedMethodSymbol*,
                               TR::TreeTop*,
                               int16_t,
                               TR_OpaqueClassBlock*,
...
private:
  void replaceCallNodeReferences(TR::Node*,
                                 TR::Node*,
                                 uint32_t,
                                 TR::Node*,
                                 TR::Node*,
...
protected:
  virtual bool analyzeCallSite(TR_CallStack*,
                               TR::TreeTop*,
                               TR::Node*,
                               TR::Node*);
...
public:
  ...
  static TR::TreeTop* storeValueInATemp(
    ...
    List<TR::SymbolReference>* moreTemps,
    bool behavesLikeTemp = true,
    TR::TreeTop** newStoreValueATreeTop = NULL,
  ...
  virtual void adjustMethodByteCodeSizeThreshold(
    TR::ResolvedMethodSymbol* callSymbol,
...
protected:
  ...
  virtual void calleeTreeTopPreMergeActions(
    ...
    TR_CallTarget* calltarget);
  virtual void refineInlineGuard(TR::Node* callNode,
                                 TR::Block*& block1,
                                 TR::Block*& block2,
...
public:
   ...
   */
  virtual bool isInlineableNativeMethod(TR::Compilation* comp,
                                        TR::ResolvedMethodSymbol* methodSymbol)
  {
    return false;
  }
...
protected:
  ...
  virtual TR_InlinerFailureReason checkIfTargetInlineable(
    ...
    TR::Compilation* comp);
  virtual bool suitableForRemat(TR::Compilation* comp,
                                TR::Node* node,
                                TR_VirtualGuardSelection* guard);
};
...
{
public:
  TR_TransformInlinedFunction(TR::Compilation*,
...
#define MAX_FIND_SIMPLE_CALL_REFERENCE_DEPTH 12
  ...
  TR::TreeTop* findSimpleCallReference(TR::TreeTop* callNodeTreeTop,
                                       TR::Node* callNode);
  bool findReturnValueInTree(TR::Node* rvStoreNode,
                             TR::Node* node,
                             TR::Compilation* comp);
...
{
public:
  TR_HandleInjectedBasicBlock(TR::Compilation*,
                              TR_InlinerTracer*,
                              TR::ResolvedMethodSymbol*,
                              List<TR::SymbolReference>&,
                              List<TR::SymbolReference>&,
...
private:
  ...
  void replaceNodesReferencedFromAbove(TR::Block*,
                                       TR::NodeChecklist& visitedNodes);
  void replaceNodesReferencedFromAbove(TR::TreeTop*,
                                       TR::Node*,
                                       TR::Node*,
                                       uint32_t,
                                       TR::NodeChecklist& visitedNodes);
  ...
  {
    MultiplyReferencedNode(TR::Node* node,
                           TR::TreeTop* tt,
