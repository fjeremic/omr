...
#ifdef J9_PROJECT_SPECIFIC
static void correctDecimalPrecision(TR::Node* store,
                                    TR::Node* child,
                                    TR::Compilation* comp) {
...
void TR_RedundantExpressionAdjustment::analyzeNode(TR::Node*,
                                                   vcount_t,
                                                   TR_BlockStructure*,
                                                   ContainerType*) {}
