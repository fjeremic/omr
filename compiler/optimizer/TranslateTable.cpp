...
uint8_t*
TR_TranslateTable::data()
{
  return _table->data;
}

TR_TranslateTable::TR_TranslateTableData*
TR_TranslateTable::table()
{
  return _table;
}

void
TR_TranslateTable::setTable(TR_TranslateTableData* match)
{
  _table = match;
}

void
TR_TranslateTable::dumpTable()
{
...
TR::SymbolReference*
TR_TranslateTable::createSymbolRef()
{
  if (!_symRef) {
...
int
TR_TranslateTable::tableSize(uint8_t inputSize, uint8_t outputSize)
{
...
TR_TranslateTable::TR_TranslateTableData*
TR_TranslateTable::createTable(uint32_t startA,
                               uint32_t endA,
                               uint8_t inputSize,
                               uint8_t outputSize,
...
TR_TranslateTable::TR_TranslateTableData*
TR_TranslateTable::createTable(uint16_t startA,
                               uint16_t endA,
                               uint8_t inputSize,
                               uint8_t outputSize,
                               uint16_t defaultValue)
{
  return createTable((uint32_t)startA,
                     (uint32_t)endA,
                     0,
                     0,
                     inputSize,
                               ...
                               uint16_t defaultValue)
{
  TR_TranslateTableData* match =
    matchTable(startA, endA, startB, endB, inputSize, outputSize, defaultValue);
  if (match) {
    _table = match;
    return _table;
  }
...
TR_TranslateTable::TR_TranslateTableData*
TR_TranslateTable::matchTable(uint32_t startA,
                              uint32_t endA,
                              uint32_t startB,
                              uint32_t endB,
                              uint8_t inputSize,
...
TR_TranslateTable::TR_TranslateTableData*
TR_TranslateTable::matchTable(uint8_t inputSize,
                              uint8_t outputSize,
                              void* array)
{
...
{
  createTable((uint16_t)0,
              tableSize(inputSize, outputSize),
              inputSize,
              outputSize,
              (uint16_t)0);
