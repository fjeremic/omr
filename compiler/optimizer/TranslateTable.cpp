...
TR_TranslateTable::TR_TranslateTableData* TR_TranslateTable::createTable(
    uint32_t startA, uint32_t endA, uint8_t inputSize, uint8_t outputSize,
    uint16_t defaultValue) {
  return createTable(startA, endA, 0, 0, inputSize, outputSize, defaultValue);
}

TR_TranslateTable::TR_TranslateTableData* TR_TranslateTable::createTable(
    uint16_t startA, uint16_t endA, uint8_t inputSize, uint8_t outputSize,
    uint16_t defaultValue) {
...
TR_TranslateTable::TR_TranslateTableData* TR_TranslateTable::createTable(
    uint16_t startA, uint16_t endA, uint16_t startB, uint16_t endB,
...
TR_TranslateTable::TR_TranslateTableData* TR_TranslateTable::createTable(
    uint32_t startA, uint32_t endA, uint32_t startB, uint32_t endB,
    uint8_t inputSize, uint8_t outputSize, uint16_t defaultValue) {
  ...
  // if required
  if (outputSize == 16) allocSize += allocSize;
