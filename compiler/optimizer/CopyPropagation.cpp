...
template <class T>
TR::Node* getNodeParent(TR::Node* lookForNode,
                        TR::Node* curNode,
                        vcount_t visitCount,
                        T& ci) {
...
int32_t TR_CopyPropagation::perform() {
...

  {
    ...
    for (TR::TreeTop* tree = comp()->getStartTree(); tree;
      ...
      if (storeLookup == storeMap.end()) {
        storeMap[rhsOfStoreDefNode] = new (trStackMemory())
            TR::deque<TR::Node*, TR::Region&>(trMemory()->currentStackRegion());
...
void TR_CopyPropagation::collectUseTrees(TR::TreeTop* tree,
                                         TR::Node* node,
...
void TR_CopyPropagation::adjustUseDefInfo(TR::Node* defNode,
                                          TR::Node* useNode,
...
bool TR_CopyPropagation::containsNode(TR::Node* node1,
                                      TR::Node* node2,
                                      bool searchClones) {
  vcount_t curVisit = comp()->getVisitCount();
