 ...
 * }
 *
 * So, what PRE would do to the loop is somewhat similar but still less
 powerful;
 * however PRE can do such optimizations even outside of loops and more
 importantly
...
public:
  ...
  bool storesBackMustBePlacedInExitBlock(TR::Block *, TR::Block *,
                                         TR_BitVector *);
  ...
  TR::SymbolReference *_stringSymRef, *_valueOfSymRef, *_tempStringSymRef,
      *_appendSymRef, *_toStringSymRef, *_initSymRef;
