            ...
            if (!value) {
...

                {
                    ...
                    if (!storeInfo->_origStoreExists) {
                        ...
                        TR::Node* store = TR::Node::createWithSymRef(comp()->il.opCodeForDirectStore(rc->getDataType()),
                            1, 1, regStoreNode->getFirstChild(), rc->getSymbolReference());
...
TR::Node* TR_GlobalRegister::createStoreToRegister(TR::TreeTop* prevTreeTop, TR::Node* node, vcount_t visitCount,
