...
void TR_GlobalRegisterAllocator::transformNode(
    ...
    TR::TreeTop* tt,
    TR::Block*& block,
    TR_Array<TR_GlobalRegister>& registers,
    TR_NodeMappings* extBlockNodeMapping) {
...
bool TR_GlobalRegisterAllocator::markCandidateForReloadInSuccessors(
    int32_t i,
    TR_GlobalRegister* extReg,
    TR_GlobalRegister* reg,
    TR::Block* block,
    bool traceIt) {
...
void TR_GlobalRegister::setCurrentRegisterCandidate(TR_RegisterCandidate* rc,
                                                    vcount_t visitCount,
                                                    TR::Block* currentBlock,
                                                    int32_t i,
                                                    TR::Compilation* comp,
                                                    bool resetOtherHalfOfLong) {
  if (_rcCurrent != rc) {
    bool liveOnSomeSucc = true;
...
TR::Node* TR_GlobalRegister::createStoreToRegister(
    ...
    vcount_t visitCount,
    TR::Compilation* comp,
    TR_GlobalRegisterAllocator* gra) {
...
bool TR_GlobalRegisterAllocator::isDependentStore(
    TR::Node* node,
    const TR_UseDefInfo::BitVector& defs,
    TR::SymbolReference* symRef,
    bool* seenLoad) {
