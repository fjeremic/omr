...
// that loop
//
static bool insideLoop(TR::Compilation* comp,
                       TR::Block* block1,
                       TR::Block* block2,
                       TR::Block* block3) {
  if (!comp->getFlowGraph()->getStructure())
...
//
static TR::Node* duplicateExact(TR::Node* node,
...
static void initializeFutureUseCounts(TR::Node* node,
                                      TR::Node* parent,
                                      vcount_t visitCount,
                                      TR::Compilation* comp,
                                      int32_t* heightArray) {
...
static bool isAndOfTwoFlags(TR::Compilation* comp,
                            TR::Node* andNode,
...
bool TR_Rematerialization::isRematerializable(TR::Node* parent,
                                              TR::Node* node,
...
bool TR_Rematerialization::examineNode(TR::TreeTop* treeTop,
                                       TR::Node* parent,
                                       TR::Node* node,
                                       vcount_t visitCount,
                                       TR_RematState* state,
...
int32_t TR_BlockSplitter::processNode(TR::Node* node,
                                      int32_t blockIndex,
