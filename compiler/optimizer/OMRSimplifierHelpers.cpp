...
TR::Node* _gotoSimplifier(TR::Node* node,
                          TR::Block* block,
                          TR::TreeTop* curTree,
                          TR::Optimization* s) {
...
void foldIntConstant(TR::Node* node,
                     int32_t value,
                     TR::Simplifier* s,
...
void foldUIntConstant(TR::Node* node,
                      uint32_t value,
                      TR::Simplifier* s,
                      bool anchorChildrenP) {
  if (!performTransformationSimplifier(node, s))
...
void foldLongIntConstant(TR::Node* node,
                         int64_t value,
                         TR::Simplifier* s,
                         bool anchorChildrenP) {
  if (!performTransformationSimplifier(node, s))
...
void foldByteConstant(TR::Node* node,
                      int8_t value,
                      TR::Simplifier* s,
                      bool anchorChildrenP) {
  if (!performTransformationSimplifier(node, s))
...
void foldShortIntConstant(TR::Node* node,
                          int16_t value,
                          TR::Simplifier* s,
                          bool anchorChildrenP) {
  if (!performTransformationSimplifier(node, s))
...
bool swapChildren(TR::Node* node,
                  TR::Node*& firstChild,
                  TR::Node*& secondChild,
                  TR::Simplifier* s) {
...
//
void orderChildren(TR::Node* node,
                   TR::Node*& firstChild,
                   TR::Node*& secondChild,
                   TR::Simplifier* s) {
...
TR::Node* foldRedundantAND(TR::Node* node,
...
//
bool branchToFollowingBlock(TR::Node* node,
                            TR::Block* block,
                            TR::Compilation* comp) {
...
// If the first child is a constant but the second isn't, swap them.
//
void makeConstantTheRightChild(TR::Node* node,
                               TR::Node*& firstChild,
                               TR::Node*& secondChild,
                               TR::Simplifier* s) {
...
TR::Node* replaceChild(int32_t childIndex,
                       TR::Node* node,
                       TR::Node* newChild,
                       TR::Simplifier* s) {
...
TR::Node* postWalkLowerTreeSimplifier(TR::TreeTop* tt,
                                      TR::Node* node,
                                      TR::Block* block,
                                      TR::Simplifier* s) {
...
void foldFloatConstantEmulate(TR::Node* node,
                              uint32_t value,
                              TR::Simplifier* s) {
...
void foldDoubleConstantEmulate(TR::Node* node,
                               uint64_t value,
                               TR::Simplifier* s) {
...
bool isIntegralExponentInRange(TR::Node* parent,
                               TR::Node* exponent,
...
TR::Node* reduceExpTwoAndGreaterToMultiplication(int32_t exponentValue,
                                                 TR::Node* baseNode,
                                                 TR::ILOpCodes multOp,
                                                 TR::Block* block,
                                                 TR::Simplifier* s,
...
TR::Node* replaceExpWithMult(TR::Node* node,
                             TR::Node* valueNode,
...
// conversionMap table!!!
bool decodeConversionOpcode(TR::ILOpCode op,
...
void stopUsingSingleNode(TR::Node* node,
                         bool removePadding,
                         TR::Simplifier* s) {
...
TR::Node* removeIfToFollowingBlock(TR::Node* node,
                                   TR::Block* block,
                                   TR::Simplifier* s) {
  if (branchToFollowingBlock(node, block, s->comp())) {
