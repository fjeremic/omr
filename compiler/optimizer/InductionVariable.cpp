...
bool TR_LoopStrider::foundLoad(TR::TreeTop* storeTreeTop,
                               TR::Node* node,
                               int32_t symRefNum,
                               vcount_t visitCount) {
...
TR::Node* TR_LoopStrider::getNewLoopIncrement(TR::Node* oldLoad,
                                              int32_t k,
                                              int32_t symRefNum) {
...
bool TR_LoopStrider::foundValue(TR::Node* node,
                                int32_t symRefNum,
                                vcount_t visitCount) {
  if (node->getVisitCount() == visitCount)
    return false;
...
TR::Node* TR_LoopStrider::genLoad(TR::Node* node,
...
TR::Node* TR_LoopStrider::findReplacingNode(TR::Node* node,
                                            bool usingAladd,
                                            int32_t k) {
...
TR::DataType TR_LoopStrider::findDataType(TR::Node* node,
                                          bool usingAladd,
                                          bool isInternalPointer) {
...
void TR_LoopStrider::addLoad(TR_StoreTreeInfo* info,
                             TR::Node* load,
                             int32_t index) {
...
static void orderSensitiveDescendantsRec(TR::Node* node,
 ...
 */
static void assertSubstPreservesEvalOrder(TR::Node* orig,
                                          TR::Node* replacement,
 ...
 */
void TR_LoopStrider::convertIV(TR::Node* bciNode,
                               TR::TreeTop* nextTT,
                               int32_t ivIn,
                               int32_t ivOut,
                               TR::ILOpCodes op) {
...
void TR_LoopStrider::replaceLoadsInSubtree(TR::Node* node,
                                           int32_t iv,
                                           TR::Node* defRHS,
                                           TR::SymbolReference* newSR,
                                           TR::NodeChecklist& exLoads,
 ...
 */
void TR_LoopStrider::widenComparison(TR::Node* node,
                                     int32_t iv,
                                     TR::Node* defRHS,
                                     TR::NodeChecklist& exLoads) {
...
TR::Node* TR_LoopStrider::duplicateMulTermNode(int32_t k,
                                               TR::Node* node,
                                               TR::DataType type) {
  TR_ASSERT(k < _numberOfLinearExprs,
            "index k %d exceeds _numberOfLinearExprs %d!\n", k,
...
//
static uint16_t countNodeOccurrencesInSubTree(TR::Node* root,
                                              TR::Node* node,
                                              vcount_t visitCount,
                                              TR::Compilation* comp) {
  uint16_t count = 0;
