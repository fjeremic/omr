...
template <class Container>
void TR_IntersectionDFSetAnalysis<Container*>::initializeCurrentGenKillSetInfo()
{
...
template <class Container>
Container* TR_IntersectionDFSetAnalysis<Container*>::initializeInfo(Container* info)
{
...
template <class Container>
Container* TR_IntersectionDFSetAnalysis<Container*>::inverseInitializeInfo(Container* info)
{
  Container* result = info;
  if (result == NULL)
    this->allocateContainer(&result, true);
