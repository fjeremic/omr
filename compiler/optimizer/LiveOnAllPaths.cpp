...
TR_LiveOnAllPaths::getKind()
{
  return LiveOnAllPaths;
}

TR_LiveOnAllPaths*
TR_LiveOnAllPaths::asLiveOnAllPaths()
{
  return this;
}

bool
TR_LiveOnAllPaths::supportsGenAndKillSets()
{
  return true;
}

int32_t
TR_LiveOnAllPaths::getNumberOfBits()
{
  return _liveVariableInfo->numLocals();
}

void
TR_LiveOnAllPaths::analyzeNode(TR::Node*,
                               vcount_t,
                               TR_BlockStructure*,
                               TR_BitVector*)
{}
...
bool
TR_LiveOnAllPaths::postInitializationProcessing()
{
  if (trace()) {
    int32_t i;
    for (i = 1; i < _numberOfNodes; ++i) {
...
void
TR_LiveOnAllPaths::initializeGenAndKillSetInfo()
{
  _liveVariableInfo->initializeGenAndKillSetInfo(_regularGenSetInfo,
                                                 _regularKillSetInfo,
...
void
TR_LiveOnAllPaths::analyzeTreeTopsInBlockStructure(
