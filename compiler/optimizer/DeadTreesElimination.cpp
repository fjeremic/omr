...
static bool fixUpTree(TR::Node* node,
                      TR::TreeTop* treeTop,
...
bool collectSymbolReferencesInNode(TR::Node* node,
                                   ...
                                   int32_t* numDeadSubNodes,
                                   vcount_t visitCount,
                                   TR::Compilation* comp,
                                   bool* seenInternalPointer,
                                   bool* seenArraylet,
...
static bool containsNode(TR::Node* containerNode,
                         TR::Node* node,
                         vcount_t visitCount,
                         TR::Compilation* comp,
                         int32_t* height,
...
static bool isSafeToReplaceNode(TR::Node* currentNode,
                                TR::TreeTop* curTreeTop,
...
typedef std::
    map<ncount_t, TR::TreeTop*, std::less<ncount_t>, ReadBarToTreeTopMapAlloc>
        ReadBarToTreeTopMap;
