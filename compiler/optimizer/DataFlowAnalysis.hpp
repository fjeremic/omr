...
class TR_BasicDFSetAnalysis {};
template <class Container>
class TR_BasicDFSetAnalysis<Container *>;
template <class Container>
class TR_ForwardDFSetAnalysis {};
template <class Container>
class TR_ForwardDFSetAnalysis<Container *>;
template <class Container>
class TR_IntersectionDFSetAnalysis {};
template <class Container>
class TR_IntersectionDFSetAnalysis<Container *>;
template <class Container>
class TR_UnionDFSetAnalysis {};
template <class Container>
class TR_UnionDFSetAnalysis<Container *>;
template <class Container>
class TR_BackwardDFSetAnalysis {};
template <class Container>
class TR_BackwardDFSetAnalysis<Container *>;
template <class Container>
class TR_BackwardIntersectionDFSetAnalysis {};
template <class Container>
class TR_BackwardIntersectionDFSetAnalysis<Container *>;
template <class Container>
class TR_BackwardUnionDFSetAnalysis {};
template <class Container>
...
class TR_BackwardIntersectionBitVectorAnalysis
 ...
 public:
  ...
  TR_BackwardIntersectionBitVectorAnalysis(TR::Compilation *comp, TR::CFG *cfg,
                                           TR::Optimizer *optimizer, bool trace)
      : TR_BackwardIntersectionDFSetAnalysis<TR_BitVector *>(
