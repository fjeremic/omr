...
class TR_DataFlowAnalysis {
 public:
  ...
  TR_DataFlowAnalysis(TR::Compilation* comp,
                      TR::CFG* cfg,
...
class TR_BasicDFSetAnalysis<Container*> : public TR_DataFlowAnalysis {
 public:
  TR_BasicDFSetAnalysis(TR::Compilation* comp,
                        TR::CFG* cfg,
                        TR::Optimizer* optimizer,
                        bool trace)
  ...
  struct ExtraAnalysisInfo {
    ...
    TR_ContainerNodeNumberPair* getContainerNodeNumberPair(
        TR_LinkHead<TR_ContainerNodeNumberPair>* list,
        int32_t n);
  ...
  virtual void allocateContainer(Container** result,
                                 bool isSparse = true,
                                 bool lock = false);
...
class TR_ForwardDFSetAnalysis<Container*>
 ...
 public:
  TR_ForwardDFSetAnalysis(TR::Compilation* comp,
                          TR::CFG* cfg,
                          TR::Optimizer* optimizer,
                          bool trace)
...
class TR_IntersectionDFSetAnalysis<Container*>
 ...
 public:
  TR_IntersectionDFSetAnalysis(TR::Compilation* comp,
                               TR::CFG* cfg,
                               TR::Optimizer* optimizer,
                               bool trace)
...
class TR_IntersectionBitVectorAnalysis
 ...
 public:
  ...
  TR_IntersectionBitVectorAnalysis(TR::Compilation* comp,
                                   TR::CFG* cfg,
                                   TR::Optimizer* optimizer,
                                   bool trace)
      : TR_IntersectionDFSetAnalysis<TR_BitVector*>(comp,
                                                    cfg,
                                                    optimizer,
                                                    trace) {}
...
class TR_UnionDFSetAnalysis<Container*>
    : public TR_ForwardDFSetAnalysis<Container*> {
 public:
  TR_UnionDFSetAnalysis(TR::Compilation* comp,
                        TR::CFG* cfg,
                        TR::Optimizer* optimizer,
                        bool trace)
      : TR_ForwardDFSetAnalysis<Container*>(comp, cfg, optimizer, trace) {}
...
class TR_UnionBitVectorAnalysis : public TR_UnionDFSetAnalysis<TR_BitVector*> {
 public:
  typedef TR_BitVector ContainerType;
  TR_UnionBitVectorAnalysis(TR::Compilation* comp,
                            TR::CFG* cfg,
                            TR::Optimizer* optimizer,
                            bool trace)
...
class TR_UnionSingleBitContainerAnalysis
 ...
 public:
  ...
  TR_UnionSingleBitContainerAnalysis(TR::Compilation* comp,
                                     TR::CFG* cfg,
                                     TR::Optimizer* optimizer,
                                     bool trace)
      : TR_UnionDFSetAnalysis<TR_SingleBitContainer*>(comp,
                                                      cfg,
                                                      optimizer,
                                                      trace) {}
};
...
class TR_ReachingDefinitions : public TR_UnionBitVectorAnalysis {
 public:
  TR_ReachingDefinitions(TR::Compilation* comp,
                         TR::CFG* cfg,
                         TR::Optimizer* optimizer,
                         TR_UseDefInfo*,
...
class TR_BackwardDFSetAnalysis<Container*>
    : public TR_BasicDFSetAnalysis<Container*> {
 public:
  TR_BackwardDFSetAnalysis(TR::Compilation* comp,
                           TR::CFG* cfg,
                           TR::Optimizer* optimizer,
                           bool trace)
      : TR_BasicDFSetAnalysis<Container*>(comp, cfg, optimizer, trace),
  ...
  bool analyzeNodeIfSuccessorsAnalyzed(TR_RegionStructure*,
                                       TR_BitVector&,
                                       TR_BitVector&);
...
class TR_BackwardIntersectionDFSetAnalysis<Container*>
 ...
 public:
  TR_BackwardIntersectionDFSetAnalysis(TR::Compilation* comp,
                                       TR::CFG* cfg,
                                       TR::Optimizer* optimizer,
                                       bool trace)
...
class TR_BackwardIntersectionBitVectorAnalysis
 ...
 public:
  typedef TR_BitVector ContainerType;
  TR_BackwardIntersectionBitVectorAnalysis(TR::Compilation* comp,
                                           TR::CFG* cfg,
                                           TR::Optimizer* optimizer,
                                           bool trace)
      : TR_BackwardIntersectionDFSetAnalysis<TR_BitVector*>(comp,
                                                            cfg,
                                                            optimizer,
                                                            trace) {}
};
...
class TR_BackwardUnionDFSetAnalysis<Container*>
    : public TR_BackwardDFSetAnalysis<Container*> {
 public:
  TR_BackwardUnionDFSetAnalysis(TR::Compilation* comp,
                                TR::CFG* cfg,
                                TR::Optimizer* optimizer,
                                bool trace)
      : TR_BackwardDFSetAnalysis<Container*>(comp, cfg, optimizer, trace) {}
...
class TR_BackwardUnionBitVectorAnalysis
 ...
 public:
  TR_BackwardUnionBitVectorAnalysis(TR::Compilation* comp,
                                    TR::CFG* cfg,
                                    TR::Optimizer* optimizer,
                                    bool trace)
      : TR_BackwardUnionDFSetAnalysis<TR_BitVector*>(comp,
                                                     cfg,
                                                     optimizer,
                                                     trace) {}
};
...
class TR_BackwardUnionSingleBitContainerAnalysis
 ...
 public:
  TR_BackwardUnionSingleBitContainerAnalysis(TR::Compilation* comp,
                                             ...
                                             TR::Optimizer* optimizer,
                                             bool trace)
      : TR_BackwardUnionDFSetAnalysis<TR_SingleBitContainer*>(comp,
                                                              cfg,
                                                              optimizer,
                                                              trace) {}
};
...
class TR_GlobalAnticipatability
 ...
 public:
  TR_GlobalAnticipatability(TR::Compilation* comp,
                            TR::Optimizer* optimizer,
                            TR_Structure*,
                            bool trace);
  ...
  virtual int32_t getNumberOfBits();
  virtual void analyzeNode(TR::Node*,
                           vcount_t,
                           TR_BlockStructure*,
                           TR_BitVector*);
  virtual TR_GlobalAnticipatability* asGlobalAnticipatability();
...
class TR_Earliestness : public TR_UnionBitVectorAnalysis {
 public:
  TR_Earliestness(TR::Compilation* comp,
                  TR::Optimizer* optimizer,
                  TR_Structure*,
                  bool trace);
...
class TR_Delayedness : public TR_IntersectionBitVectorAnalysis {
 public:
  TR_Delayedness(TR::Compilation* comp,
                 TR::Optimizer* optimizer,
                 TR_Structure*,
                 bool trace);
...
class TR_Latestness : public TR_BackwardIntersectionBitVectorAnalysis {
 public:
  TR_Latestness(TR::Compilation* comp,
                TR::Optimizer* optimizer,
                TR_Structure*,
                bool trace);
...
class TR_Isolatedness : public TR_BackwardIntersectionBitVectorAnalysis {
 public:
  TR_Isolatedness(TR::Compilation* comp,
                  TR::Optimizer* optimizer,
                  TR_Structure*,
                  bool trace);
...
class TR_LiveVariableInformation {
 public:
  ...
  void findCommonedLoads(TR::Node* node,
                         TR_BitVector* commonedLoads,
                         bool movingForwardThroughTrees,
                         vcount_t visitCount);
  void findAllUseOfLocal(TR::Node* node,
                         int32_t blockNum,
                         ...
                         bool movingForwardThroughTrees,
                         vcount_t visitCount);
  void findLocalUsesInBackwardsTreeWalk(TR::Node* node,
                                        int32_t blockNum,
                                        TR_BitVector* genSetInfo,
                                        TR_BitVector* killSetInfo,
                                        TR_BitVector* commonedLoads,
 ...
 protected:
  virtual void findUseOfLocal(TR::Node* node,
                              int32_t blockNum,
                              TR_BitVector** genSetInfo,
                              TR_BitVector** killSetInfo,
                              TR_BitVector* commonedLoads,
 ...
 private:
  void visitTreeForLocals(TR::Node* node,
...
class TR_Liveness : public TR_BackwardUnionBitVectorAnalysis {
 public:
  TR_Liveness(TR::Compilation* comp,
              TR::Optimizer* optimizer,
              TR_Structure*,
              bool ignoreOSRUses = false,
...
class TR_LiveOnAllPaths : public TR_BackwardIntersectionBitVectorAnalysis {
 public:
  TR_LiveOnAllPaths(TR::Compilation* comp,
                    TR::Optimizer* optimizer,
                    TR_Structure*,
