...
public:
  ...
  TR_Debug* getDebug()
  {
    return _comp->getDebug();
  }

  TR_Memory* trMemory()
  {
    return _comp->trMemory();
  }
  TR_StackMemory trStackMemory()
  {
    return _comp->trStackMemory();
  }
  TR_HeapMemory trHeapMemory()
  {
    return _comp->trHeapMemory();
  }
...
//
template <class Container>
class TR_ForwardDFSetAnalysis<Container*> : public TR_BasicDFSetAnalysis<Container*> {
public:
...
//
template <class Container>
class TR_UnionDFSetAnalysis<Container*> : public TR_ForwardDFSetAnalysis<Container*> {
public:
...
//
template <class Container>
class TR_BackwardDFSetAnalysis<Container*> : public TR_BasicDFSetAnalysis<Container*> {
public:
...
public:
  ...
  bool traceLiveVarInfo()
  {
    return _traceLiveVariableInfo;
  }
  ...
  TR_BitVector* liveCommonedLoads()
  {
    return _liveCommonedLoads;
  }
