...
void
TR_UnionDFSetAnalysis<Container*>::compose(Container* firstBitVector,
...
template<class Container>
void
TR_UnionDFSetAnalysis<Container*>::inverseCompose(Container* firstBitVector,
                                                  Container* secondBitVector)
{
  *firstBitVector &= *secondBitVector;
}
...
template<class Container>
void
TR_UnionDFSetAnalysis<Container*>::initializeInSetInfo()
{
...
template<class Container>
void
TR_UnionDFSetAnalysis<Container*>::initializeCurrentGenKillSetInfo()
{
...
template<class Container>
Container*
TR_UnionDFSetAnalysis<Container*>::initializeInfo(Container* info)
{
...
TR_UnionDFSetAnalysis<Container*>::getKind()
{
