...
#define NODES_PER_CHUNK 3
  class HashTable {
   public:
    ...
    void add(TR::Node *node, int32_t bucket) {
      if (!_buckets[bucket]) _buckets[bucket] = allocateChunk();
  ...
  bool countSupportedNodes(TR::Node *node, TR::Node *parent,
...
class TR_LocalAnalysis {
 public:
  ...
  ContainerType *getCheckSymbolReferences() {
    return _lainfo._checkSymbolReferences;
  }
  ...
  //
  static bool isSupportedOpCode(TR::ILOpCode &opCode, TR::Compilation *comp) {
    return opCode.isSupportedForPRE();
  }

  static bool isSupportedNodeForFieldPrivatization(TR::Node *node,
                                                   TR::Compilation *comp,
                                                   TR::Node *parent);
  static bool isSupportedNodeForPREPerformance(TR::Node *node,
                                               TR::Compilation *comp,
                                               TR::Node *parent);
  ...
  static bool isSupportedNode(TR::Node *node, TR::Compilation *comp,
                              TR::Node *parent,
                              bool isSupportedStoreNode = false);
 ...
 protected:
  ContainerType *allocateContainer(int32_t size) {
    return new (trStackMemory())
        TR_BitVector(size, trMemory(), stackAlloc, notGrowable);
  }
...
class TR_LocalTransparency : public TR_LocalAnalysis {
 public:
  ...
  void updateInfoForSupportedNodes(TR::Node *, ContainerType *, ContainerType *,
                                   ContainerType *, ContainerType *,
                                   ContainerType *, ContainerType *, vcount_t);
  void updateUsesAndDefs(TR::Node *, ContainerType *, ContainerType *,
                         ContainerType *, ContainerType *, ContainerType *,
                         vcount_t, ContainerType *, TR_BitVector *,
                         ContainerType *);
  void adjustInfoForAddressAdd(TR::Node *, TR::Node *, ContainerType *,
                               ContainerType *);
...
class TR_LocalAnticipatability : public TR_LocalAnalysis {
 public:
  TR_LocalAnticipatability(TR_LocalAnalysisInfo &, TR_LocalTransparency *,
                           bool trace);
  void analyzeBlock(TR::Block *, vcount_t, vcount_t, TR_BitVector *);
  bool updateAnticipatabilityForSupportedNodes(TR::Node *, ContainerType *,
                                               ContainerType *, TR::Block *,
                                               ContainerType *, ContainerType *,
                                               ContainerType *, TR_BitVector *,
                                               ContainerType *, vcount_t);
  void updateUsesAndDefs(TR::Node *, TR::Block *, ContainerType *,
                         ContainerType *, ContainerType *, ContainerType *,
                         TR_BitVector *, ContainerType *, vcount_t);
  bool adjustInfoForAddressAdd(TR::Node *, TR::Node *, ContainerType *,
                               ContainerType *, ContainerType *,
                               ContainerType *, TR::Block *);
  bool loadaddrAsLoad() { return _loadaddrAsLoad; }
