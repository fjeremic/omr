...
#define NODES_PER_CHUNK 3
  ...
  int hasOldExpressionOnRhs(TR::Node* node,
                            bool recalcContainsCall = true,
                            bool containsCallInStoreLhsSubTree = false);
  bool collectSupportedNodes(TR::Node*, TR::Node*);
  bool countSupportedNodes(TR::Node* node,
                           TR::Node* parent,
...
class TR_LocalAnalysis {
 public:
  ...
  static bool isSupportedNode(TR::Node* node,
                              TR::Compilation* comp,
                              TR::Node* parent,
                              bool isSupportedStoreNode = false);
...
class TR_LocalTransparency : public TR_LocalAnalysis {
 public:
  ...
  void updateInfoForSupportedNodes(TR::Node*,
                                   ContainerType*,
                                   ContainerType*,
                                   ContainerType*,
                                   ContainerType*,
                                   ...
                                   ContainerType*,
                                   vcount_t);
  void updateUsesAndDefs(TR::Node*,
                         ContainerType*,
                         ContainerType*,
                         ContainerType*,
                         ContainerType*,
                         ...
                         TR_BitVector*,
                         ContainerType*);
  void adjustInfoForAddressAdd(TR::Node*,
                               TR::Node*,
                               ContainerType*,
                               ContainerType*);
...
class TR_LocalAnticipatability : public TR_LocalAnalysis {
 public:
  TR_LocalAnticipatability(TR_LocalAnalysisInfo&,
                           TR_LocalTransparency*,
                           bool trace);
  void analyzeBlock(TR::Block*, vcount_t, vcount_t, TR_BitVector*);
  bool updateAnticipatabilityForSupportedNodes(TR::Node*,
                                               ContainerType*,
                                               ContainerType*,
                                               TR::Block*,
                                               ContainerType*,
  ...
  void updateUsesAndDefs(TR::Node*,
                         ...
                         ContainerType*,
                         vcount_t);
  bool adjustInfoForAddressAdd(TR::Node*,
                               TR::Node*,
                               ContainerType*,
                               ContainerType*,
                               ContainerType*,
