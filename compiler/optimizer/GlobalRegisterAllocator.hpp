...
class TR_LiveRangeSplitter : public TR::Optimization {
 public:
  ...
  void replaceAutosUsedIn(TR::TreeTop* currentTree,
                          TR::Node* node,
                          TR::Node* parent,
                          TR::Block* block,
  ...
  void placeStoresInLoopExits(TR::Node* node,
                              TR_StructureSubGraphNode* loop,
                              List<TR::Block>* blocksInLoop,
...
class TR_GlobalRegisterAllocator : public TR::Optimization {
 public:
  ...
  TR::Node* resolveTypeMismatch(TR::DataType inputOldType,
                                TR::Node* oldNode,
                                TR::Node* newNode);
 ...
 private:
  ...
  void findLoopsAndCorrespondingAutos(TR_StructureSubGraphNode*,
                                      vcount_t,
                                      SymRefCandidateMap&);
  ...
  TR_GlobalRegister* getGlobalRegisterWithoutChangingCurrentCandidate(
      ...
      TR_Array<TR_GlobalRegister>&,
      TR::Block*);
  void transformBlockExit(TR::TreeTop*,
                          TR::Node*,
                          TR::Block*,
                          TR_Array<TR_GlobalRegister>&,
                          TR::Block*);
  void transformMultiWayBranch(TR::TreeTop*,
                               TR::Node*,
                               TR::Block*,
                               TR_Array<TR_GlobalRegister>&,
                               bool regStarTransformDone = false);
  void addCandidateReloadsToEntry(TR::TreeTop*,
                                  TR_Array<TR_GlobalRegister>&,
                                  TR::Block*);
  void addRegLoadsToEntry(TR::TreeTop*,
                          TR_Array<TR_GlobalRegister>&,
                          TR::Block*);
  void addGlRegDepToExit(TR_Array<TR::Node*>&,
                         TR::Node*,
                         TR_Array<TR_GlobalRegister>&,
                         TR::Block*);
  ...
  TR::TreeTop* findPrevTreeTop(TR::TreeTop*&,
                               TR::Node*&,
                               TR::Block*,
                               TR::Block*);
  void prepareForBlockExit(TR::TreeTop*&,
                           TR::Node*&,
                           TR::Block*,
                           TR_Array<TR_GlobalRegister>&,
                           TR::Block*,
                           TR_Array<TR::Node*>&);
  bool markCandidateForReloadInSuccessors(int32_t,
                                          TR_GlobalRegister*,
                                          TR_GlobalRegister*,
                                          TR::Block*,
                                          bool);
  ...
  bool registerIsLiveAcrossEdge(TR::TreeTop*,
                                TR::Node*,
                                TR::Block*,
                                TR_GlobalRegister*,
                                TR::Block*&,
                                int32_t);
  TR::Block* createNewSuccessorBlock(TR::Block*,
                                     TR::Block*,
                                     TR::TreeTop*,
                                     TR::Node*,
  ...
  void findLoopsAndCreateAutosForSignExt(
      ...
      vcount_t visitCount);
  void createStoresForSignExt(TR::Node* node,
                              TR::Node* parent,
                              TR::Node* grandParent,
                              TR::TreeTop* treetop,
