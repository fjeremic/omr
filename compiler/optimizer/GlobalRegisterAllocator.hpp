...
struct TR_NodeTriple {
  ...
  TR_NodeTriple(TR::Node* node1, TR::Node* node2, TR::Node* node3, int32_t childNum)
    : _node1(node1)
    , _node2(node2)
    , _node3(node3)
    , _childNum(childNum)
...
public:
  ...
  void replaceAutosUsedIn(TR::TreeTop* currentTree, TR::Node* node, TR::Node* parent, TR::Block* block,
...
public:
  ...
  TR_BitVector* signExtensionRequired()
  {
    return _signExtAdjustmentReqd;
  }
  ...
  TR_BitVector* signExtensionNotRequired()
  {
    return _signExtAdjustmentNotReqd;
  }
...
private:
  ...
  void markAutosUsedIn(TR::Node*, TR::Node*, TR::Node*, TR::Node**, TR::Block*, List<TR::Block>*, vcount_t, int32_t,
    SymRefCandidateMap&, TR_BitVector*, TR_BitVector*, bool);
  ...
  void transformNode(
    TR::Node*, TR::Node*, int32_t, TR::TreeTop*, TR::Block*&, TR_Array<TR_GlobalRegister>&, TR_NodeMappings*);
  ...
  void transformMultiWayBranch(
    TR::TreeTop*, TR::Node*, TR::Block*, TR_Array<TR_GlobalRegister>&, bool regStarTransformDone = false);
  ...
  void addStoresForCatchBlockLoads(
    TR::TreeTop* appendPoint, TR_Array<TR_GlobalRegister>& extBlockRegisters, TR::Block* throwingBlock);
  TR::TreeTop* findPrevTreeTop(TR::TreeTop*&, TR::Node*&, TR::Block*, TR::Block*);
  void prepareForBlockExit(
    TR::TreeTop*&, TR::Node*&, TR::Block*, TR_Array<TR_GlobalRegister>&, TR::Block*, TR_Array<TR::Node*>&);
  ...
  /*
  void splitLiveRanges();
  void splitLiveRanges(TR_StructureSubGraphNode *structureNode, vcount_t visitCount, TR_RegisterCandidate
  **registerCandidates); void replaceAutosUsedIn(TR::Node *node, TR::Node *parent, TR::Block * block, List<TR::Block>
  *blocksInLoop, vcount_t visitCount, int32_t executionFrequency, TR_RegisterCandidate **registerCandidates,
