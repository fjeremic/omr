...
TR_Delayedness::getKind()
{
  return Delayedness;
}

TR_Delayedness*
TR_Delayedness::asDelayedness()
{
  return this;
}

int32_t
TR_Delayedness::getNumberOfBits()
{
  return _earliestness->_numberOfBits;
}

void
TR_Delayedness::analyzeNode(TR::Node*,
                            vcount_t,
                            TR_BlockStructure*,
                            ContainerType*)
{}

TR_Delayedness::TR_Delayedness(TR::Compilation* comp,
...
bool
TR_Delayedness::postInitializationProcessing()
{
...
//
void
TR_Delayedness::analyzeTreeTopsInBlockStructure(
