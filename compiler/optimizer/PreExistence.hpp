...
class TR_PrexArgument {
 ...
 private:
  ...
  bool _isTypeInfoForInlinedBody;  // The prex arg info only apply to the
                                   // inlined body but not on the taken side
};
