...
class TR_PrexArgument {
 ...
 public:
  ...
  TR_PrexArgument(ClassKind classKind,
...
class TR_PrexArgInfo {
 public:
  ...
  static TR_PrexArgInfo* enhance(TR_PrexArgInfo* dest,
                                 TR_PrexArgInfo* source,
                                 TR::Compilation* comp);
  ...
  TR_PrexArgInfo(int32_t numArgs, TR_Memory* m) : _numArgs(numArgs) {
    _args = (TR_PrexArgument**)m->allocateHeapMemory(sizeof(TR_PrexArgument*) *
                                                     numArgs);
