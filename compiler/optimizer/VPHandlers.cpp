...
static int32_t arrayElementSize(const char* signature,
                                int32_t len,
                                TR::Node* node,
                                OMR::ValuePropagation* vp) {
  if (signature[0] != '[')
...
static bool tryFoldCompileTimeLoad(OMR::ValuePropagation* vp,
                                   TR::Node* node,
                                   bool& isGlobal) {
  isGlobal = true;
...
bool canMoveLongOpChildDirectly(TR::Node* node,
                                int32_t numChild,
                                TR::Node* arithNode) {
...
bool reduceLongOpToIntegerOp(OMR::ValuePropagation* vp,
                             TR::Node* node,
...
static void constrainAConst(OMR::ValuePropagation* vp,
                            TR::Node* node,
                            bool isGlobal) {
  TR::VPConstraint* constraint = NULL;
    ...
    if (node->isClassPointerConstant()) {
      TR::VPConstraint* typeConstraint =
          TR::VPClass::create(vp,
                              TR::VPFixedClass::create(
                                  vp, (TR_OpaqueClassBlock*)node->getAddress()),
                              NULL, NULL, NULL,
...
static void constrainIntConst(OMR::ValuePropagation* vp,
                              TR::Node* node,
                              bool isGlobal) {
...
static void constrainLongConst(OMR::ValuePropagation* vp,
                               TR::Node* node,
                               bool isGlobal) {
...
bool simplifyJ9ClassFlags(OMR::ValuePropagation* vp,
                          TR::Node* node,
                          bool isLong) {
#ifdef J9_PROJECT_SPECIFIC
...
static const char* getFieldSignature(OMR::ValuePropagation* vp,
                                     TR::Node* node,
                                     int32_t& len) {
  TR::SymbolReference* symRef = node->getSymbolReference();
...
static TR::Node* findArrayLengthNode(OMR::ValuePropagation* vp,
                                     TR::Node* node,
...
static TR::Node* findArrayIndexNode(OMR::ValuePropagation* vp,
                                    TR::Node* node,
                                    int32_t stride) {
...
static void getLowHighLongs(TR::VPLongRange* range,
                            int64_t& low,
                            int64_t& high) {
...
bool can64BitUnsignedMultiplyOverflow(uint64_t a,
                                      uint64_t b,
                                      uint64_t maxValue) {
...
bool constrainIntegerDivisionRange(int64_t lhsLow,
                                   int64_t lhsHigh,
                                   int64_t rhsLow,
                                   int64_t rhsHigh,
                                   int64_t rangeMin,
...
TR::Node* removeRedundantREM(OMR::ValuePropagation* vp,
                             TR::Node* node,
                             TR::VPConstraint* nodeConstraint,
...
static TR::Node* distributeShift(OMR::ValuePropagation* vp,
                                 TR::Node* node,
                                 int32_t shiftAmount,
                                 TR::VPConstraint*& constraint) {
...
static TR::Node* constrainWidenToLong(OMR::ValuePropagation* vp,
                                      TR::Node* node,
                                      int64_t low,
                                      int64_t high,
                                      bool isUnsigned) {
...
static bool constrainWidenToInt(OMR::ValuePropagation* vp,
                                TR::Node*& node,
                                int32_t low,
                                int32_t high,
                                bool isUnsigned,
...
static void changeConditionalToGoto(OMR::ValuePropagation* vp,
                                    TR::Node* node,
...
static void removeConditionalBranch(OMR::ValuePropagation* vp,
                                    TR::Node* node,
                                    TR::CFGEdge* branchEdge) {
#ifdef J9_PROJECT_SPECIFIC
  createGuardSiteForRemovedGuard(vp->comp(), node);
...
//
static TR::Node* constrainIfcmpeqne(OMR::ValuePropagation* vp,
                                    TR::Node* node,
                                    bool branchOnEqual) {
  constrainChildren(vp, node);
...
void getLimits(OMR::ValuePropagation* vp,
               int32_t* zLow,
               int32_t* zHigh,
               TR::Node* symNode,
               bool isGlobal) {
...
TR::Node* makeNewRhsNode(OMR::ValuePropagation* vp,
                         TR::Node* node,
                         TR::Node* symNodeY,
                         int32_t constDiff) {
...
static TR::Node* simplifyInequality(OMR::ValuePropagation* vp,
                                    TR::Node* node,
                                    TR::Node* lhsChild,
                                    TR::Node* rhsChild,
                                    bool isGlobal,
...
//
static TR::Node* constrainCmpeqne(OMR::ValuePropagation* vp,
                                  TR::Node* node,
                                  bool testEqual) {
  constrainChildren(vp, node);
...
//
static TR::Node* constrainCmplessthan(OMR::ValuePropagation* vp,
                                      TR::Node* node,
                                      TR::Node* lhsChild,
                                      TR::Node* rhsChild,
                                      bool orEqual) {
...
void constrainNewlyFoldedConst(OMR::ValuePropagation* vp,
                               TR::Node* node,
                               bool isGlobal) {
  switch (node->getOpCodeValue()) {
    case TR::iconst:
...
// taken.
//
static int32_t handleNullCheck(OMR::ValuePropagation* vp,
                               TR::Node* node,
                               bool resolveChkToo) {
...
//
static bool handleResolveCheck(OMR::ValuePropagation* vp,
                               TR::Node* node,
                               bool nullChkToo) {
