...
TR_GlobalAnticipatability::getKind()
{
...
int32_t
TR_GlobalAnticipatability::getNumberOfBits()
{
  return _localTransparency.getNumNodes();
}

void
TR_GlobalAnticipatability::analyzeNode(TR::Node*,
                                       vcount_t,
                                       TR_BlockStructure*,
                                       TR_BitVector*)
{}
...
TR_GlobalAnticipatability::TR_GlobalAnticipatability(
  ...
  bool trace)
  : TR_BackwardIntersectionBitVectorAnalysis(comp,
                                             comp->getFlowGraph(),
                                             optimizer,
                                             trace)
...
bool
TR_GlobalAnticipatability::postInitializationProcessing()
{
...
static bool
isFieldAccess(TR::Node* nextNode)
{
...
static bool
nodeCanSurvive(TR::Node* nextNode,
               TR::Node* lastNodeFirstChild,
               TR::Node* lastNodeSecondChild,
               TR::Compilation* comp,
               bool trace)
{
...
extern bool
isExceptional(TR::Compilation*, TR::Node*); // in LocalAnalysis.cpp

bool
TR_GlobalAnticipatability::isExceptionalInBlock(TR::Node* node,
                                                int32_t blockNumber,
                                                ContainerType* alreadyInBlock,
                                                vcount_t visitCount)
{
...
bool
isRareEdge(TR::Compilation* comp, TR::CFGEdge* edge)
{
...
void
TR_GlobalAnticipatability::killBasedOnSuccTransparency(TR::Block* block)
{
  TR::Block* nextSucc;
  for (auto succEdge = block->getSuccessors().begin();
       succEdge != block->getSuccessors().end();
       ++succEdge) {
...
//
void
TR_GlobalAnticipatability::analyzeTreeTopsInBlockStructure(
