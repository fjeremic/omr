...
public:
  ...
  bool hasGlobalsValueNumbers()
  {
    return _hasGlobalsValueNumbers;
  }
  bool trace()
  {
    return _trace;
  ...
  int32_t getNumberOfValues()
  {
    return _nextValue;
  }

  /** Shareable nodes have value numbers 1 to N */
  int32_t getNumberOfShareableValues()
  {
    return _numberOfShareableValues;
  }

  /** Parameters have value numbers 1 to N */
  int32_t getNumberOfParmValues()
  {
    return _numberOfParms;
  }
