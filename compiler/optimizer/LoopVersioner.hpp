...
protected:
   ...
   */
    ...
    bool isConditionalTreeCandidateForElimination(TR::TreeTop* curTree) { return (!curTree->getNode()->getFirstChild()->getOpCode().isLoadConst() || !curTree->getNode()->getSecondChild()->getOpCode().isLoadConst()); };
