...
class TR_NodeParentSymRef {
 public:
  ...
  TR_NodeParentSymRef(TR::Node* node,
                      TR::Node* parent,
...
class TR_NodeParentSymRefWeightTuple {
 public:
  ...
  TR_NodeParentSymRefWeightTuple(TR::Node* node,
                                 TR::Node* parent,
                                 TR::SymbolReference* symRef,
                                 int32_t weight)
...
class TR_LoopVersioner : public TR_LoopTransformer {
 public:
  TR_LoopVersioner(TR::OptimizationManager* manager,
                   bool onlySpecialize = false,
                   bool refineAliases = false);
 ...
 protected:
  ...
  class LoopBodySearch {
   public:
    LoopBodySearch(TR::Compilation* comp,
                   TR::Region& memRegion,
  ...
  typedef TR::typed_allocator<std::pair<TR::Node* const, const Expr*>,
      ...
      NodeToExprAlloc;
  typedef std::
      map<TR::Node*, const Expr*, std::less<TR::Node*>, NodeToExprAlloc>
          NodeToExpr;
  ...
  typedef TR::typed_allocator<std::pair<TR::Node* const, LoopEntryPrep*>,
      ...
      NodePrepMapAlloc;
  typedef std::
      map<TR::Node*, LoopEntryPrep*, std::less<TR::Node*>, NodePrepMapAlloc>
          NodePrepMap;
  ...
  typedef TR::typed_allocator<std::pair<const Expr* const, PrivTemp>,
      ...
      PrivTempMapAlloc;
  typedef std::
      map<const Expr*, PrivTemp, std::less<const Expr*>, PrivTempMapAlloc>
          PrivTempMap;
  ...
  typedef TR::typed_allocator<std::pair<const Expr* const, TR::Node*>,
      ...
      EmitExprMemoAlloc;
  typedef std::
      map<const Expr*, TR::Node*, std::less<const Expr*>, EmitExprMemoAlloc>
          EmitExprMemo;
  ...
  class RemoveAsyncCheck : public LoopImprovement {
   public:
    ...
    RemoveAsyncCheck(TR_LoopVersioner* versioner,
                     LoopEntryPrep* prep,
  ...
  class RemoveNullCheck : public LoopImprovement {
   public:
    ...
    RemoveNullCheck(TR_LoopVersioner* versioner,
                    LoopEntryPrep* prep,
  ...
  class RemoveBoundCheck : public LoopImprovement {
   public:
    ...
    RemoveBoundCheck(TR_LoopVersioner* versioner,
                     LoopEntryPrep* prep,
  ...
  class RemoveSpineCheck : public LoopImprovement {
   public:
    ...
    RemoveSpineCheck(TR_LoopVersioner* versioner,
                     LoopEntryPrep* prep,
  ...
  class RemoveDivCheck : public LoopImprovement {
   public:
    ...
    RemoveDivCheck(TR_LoopVersioner* versioner,
                   LoopEntryPrep* prep,
  ...
  class RemoveWriteBarrier : public LoopImprovement {
   public:
    ...
    RemoveWriteBarrier(TR_LoopVersioner* versioner,
                       LoopEntryPrep* prep,
  ...
  class RemoveCheckCast : public LoopImprovement {
   public:
    ...
    RemoveCheckCast(TR_LoopVersioner* versioner,
                    LoopEntryPrep* prep,
  ...
  class RemoveArrayStoreCheck : public LoopImprovement {
   public:
    ...
    RemoveArrayStoreCheck(TR_LoopVersioner* versioner,
                          LoopEntryPrep* prep,
  ...
  class FoldConditional : public LoopImprovement {
   public:
    ...
    FoldConditional(TR_LoopVersioner* versioner,
                    LoopEntryPrep* prep,
  ...
  virtual void buildAliasRefinementComparisonTrees(List<TR::TreeTop>*,
                                                   List<TR::TreeTop>*,
                                                   List<TR::TreeTop>*,
                                                   List<TR::TreeTop>*,
  ...
  TR::Node* isDependentOnInductionVariable(TR::Node*,
                                           bool,
                                           bool&,
                                           TR::Node*&,
                                           TR::Node*&,
  ...
  bool boundCheckUsesUnchangedValue(TR::TreeTop*,
                                    TR::Node*,
                                    TR::SymbolReference*,
                                    TR_RegionStructure*);
  bool findStore(TR::TreeTop* start,
                 TR::TreeTop* end,
                 TR::Node* node,
                 TR::SymbolReference* symRef,
                 bool ignoreLoads = false,
                 bool lastTimeThrough = false);
  TR::Node* findLoad(TR::Node* node,
                     TR::SymbolReference* symRef,
                     vcount_t origVisitCount);
  void versionNaturalLoop(TR_RegionStructure*,
                          List<TR::Node>*,
                          List<TR::TreeTop>*,
                          List<TR::TreeTop>*,
                          List<TR::TreeTop>*,
  ...
  bool detectInvariantTrees(TR_RegionStructure* whileLoop,
                            List<TR::TreeTop>*,
                            bool,
                            bool*,
                            SharedSparseBitVector& reverseBranchInLoops);
  ...
  bool detectChecksToBeEliminated(TR_RegionStructure*,
                                  List<TR::Node>*,
                                  List<TR::TreeTop>*,
                                  List<int32_t>*,
                                  List<TR::TreeTop>*,
  ...
  void buildBoundCheckComparisonsTree(List<TR::TreeTop>*,
                                      List<TR::TreeTop>*,
                                      bool);
  ...
  bool buildSpecializationTree(List<TR::TreeTop>*,
                               List<TR::TreeTop>*,
                               List<TR::TreeTop>*,
                               List<TR::TreeTop>*,
                               List<TR::Node>*,
  ...
  void convertSpecializedLongsToInts(TR::Node*,
                                     vcount_t,
                                     TR::SymbolReference**);
  void collectAllExpressionsToBeChecked(List<TR::TreeTop>*,
                                        List<TR::TreeTop>*,
                                        List<TR::TreeTop>*,
                                        List<TR::TreeTop>*,
                                        TR::Node*,
  ...
  bool depsForLoopEntryPrep(TR::Node*,
                            ...
                            TR::NodeChecklist*,
                            bool);
  LoopEntryPrep* addLoopEntryPrepDep(LoopEntryPrep::Kind,
                                     TR::Node*,
                                     TR::list<LoopEntryPrep*, TR::Region&>*,
                                     TR::NodeChecklist*);
  ...
  TR::Block* createEmptyGoto(TR::Block* source,
                             TR::Block* dest,
                             TR::TreeTop* endTree);
  ...
  const Expr* substitutePrivTemps(TR::TreeTop* tt,
                                  TR::Node* node,
  ...
  LoopEntryPrep* createLoopEntryPrep(LoopEntryPrep::Kind,
                                     TR::Node*,
                                     TR::NodeChecklist* = NULL,
                                     LoopEntryPrep* = NULL);
  LoopEntryPrep* createChainedLoopEntryPrep(LoopEntryPrep::Kind,
                                            TR::Node*,
                                            LoopEntryPrep*);
