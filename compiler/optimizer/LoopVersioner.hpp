...
public:
  ...
  virtual TR_LoopVersioner* asLoopVersioner()
  {
    return this;
  }
...
protected:
  ...
  public:
    ...
    TR::Compilation* comp()
    {
      return _versioner->comp();
    }
    TR_FrontEnd* fe()
    {
      return _versioner->fe();
    }
  ...
  public:
     ...
     */
    TR::TreeTop* currentTreeTop()
    {
      return _currentTreeTop;
    }
  ...
  public:
    ...
    FoldConditional(
      TR_LoopVersioner* versioner, LoopEntryPrep* prep, TR::Node* conditionalNode, bool reverseBranch, bool original)
      : LoopImprovement(versioner, prep)
  ...
  bool shouldOnlySpecializeLoops()
  {
    return _onlySpecializingLoops;
  }
  void setOnlySpecializeLoops(bool b)
  {
    _onlySpecializingLoops = b;
  }
  ...
  bool checkProfiledGuardSuitability(
  ...
  bool detectChecksToBeEliminated(TR_RegionStructure*, List<TR::Node>*, List<TR::TreeTop>*, List<int32_t>*,
    List<TR::TreeTop>*, List<TR::TreeTop>*, List<int32_t>*, List<TR::TreeTop>*, List<TR::TreeTop>*, List<TR::TreeTop>*,
  ...
  void collectAllExpressionsToBeChecked(List<TR::TreeTop>*, List<TR::TreeTop>*, List<TR::TreeTop>*, List<TR::TreeTop>*,
    TR::Node*, List<TR::Node>*, TR::Block*, vcount_t);
  ...
  void recordCurrentBlock(TR::Block* b)
  {
    _currentBlock = b;
  }
  TR::Block* getCurrentBlock(TR::Block* b)
  {
    return _currentBlock;
  }
