...
bool TR_OrderBlocks::needBetterChoice(TR::CFG* cfg,
                                      TR::CFGNode* block,
                                      TR::CFGNode* bestSucc) {
...
bool TR_OrderBlocks::endPathAtBlock(TR::CFGNode* block,
                                    TR::CFGNode* bestSucc,
                                    TR::CFG* cfg) {
...
bool TR_OrderBlocks::peepHoleGotoToFollowing(TR::CFG* cfg,
                                             TR::Block* block,
...
//   block assumed to end in a goto
// returns TRUE if the pattern was found and replaced
bool TR_OrderBlocks::peepHoleGotoToGoto(TR::CFG* cfg,
                                        TR::Block* block,
                                        TR::Node* gotoNode,
                                        TR::Block* destOfGoto,
                                        char* title,
...
//   block assumed to end in a goto
// returns TRUE if the pattern was found and replaced
bool TR_OrderBlocks::peepHoleGotoToEmpty(TR::CFG* cfg,
                                         TR::Block* block,
                                         TR::Node* gotoNode,
                                         TR::Block* destOfGoto,
                                         char* title) {
...
static bool peepHoleGotoToLoopHeader(TR::CFG* cfg,
                                     TR::Block* block,
                                     TR::Block* dest,
                                     char* title) {
...
void TR_OrderBlocks::peepHoleGotoBlock(TR::CFG* cfg,
                                       TR::Block* block,
                                       char* title) {
...
void TR_OrderBlocks::removeRedundantBranch(TR::CFG* cfg,
                                           TR::Block* block,
                                           TR::Node* branchNode,
                                           TR::Block* takenBlock) {
...
bool TR_OrderBlocks::peepHoleBranchToLoopHeader(TR::CFG* cfg,
                                                TR::Block* block,
...
void TR_OrderBlocks::peepHoleBranchBlock(TR::CFG* cfg,
                                         TR::Block* block,
                                         char* title) {
  TR_ASSERT(
      block->endsInBranch(),
...
bool TR_OrderBlocks::peepHoleBranchToFollowing(TR::CFG* cfg,
                                               TR::Block* block,
                                               TR::Block* followingBlock,
                                               char* title) {
...
void TR_OrderBlocks::removeEmptyBlock(TR::CFG* cfg,
                                      TR::Block* block,
                                      char* title) {
