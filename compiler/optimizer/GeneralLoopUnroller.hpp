...
public:
  ...
  //
  static bool unroll(TR::Compilation* comp,
...
protected:
  TR_LoopUnroller(TR::Compilation* comp,
  ...
  static bool isWellFormedLoop(TR_RegionStructure* loop,
                               TR::Compilation*,
  ...
  bool cfgEdgeAlreadyExists(TR::Block* from,
                            TR::Block* to,
  ...
  void fixExitEdges(TR_Structure* s,
                    TR_Structure* clone,
...
private:
  ...
  void gatherStatistics(TR_Structure* str,
                        int32_t& numNodes,
                        int32_t& numBlocks,
                        int32_t& numBranches,
  ...
  void countNodesAndSubscripts(TR::Node* node,
                               int32_t& numNodes,
                               int32_t& numSubscripts,
                               LoopWeightProbe& lwp);
