...
struct TR_CallTarget : public TR_Link<TR_CallTarget> {
  ...
  TR::ResolvedMethodSymbol *_calleeSymbol;  // must have this by the time we
                                            // actually do the inlinining
...
struct TR_CallSite : public TR_Link<TR_CallSite> {
  ...
  static TR_CallSite *create(TR::TreeTop *callNodeTreeTop, TR::Node *parent,
                             TR::Node *callNode,
                             TR_OpaqueClassBlock *receiverClass,
                             TR::SymbolReference *symRef,
                             TR_ResolvedMethod *resolvedMethod,
                             TR::Compilation *comp, TR_Memory *trMemory,
...
class TR_IndirectCallSite : public TR_CallSite {
 ...
 protected:
  ...
  bool tryToRefineReceiverClassBasedOnResolvedTypeArgInfo(
      TR_InlinerBase *inliner);
  ...
  bool addTargetIfMethodIsNotOverridenInReceiversHierarchy(
      TR_InlinerBase *inliner);
