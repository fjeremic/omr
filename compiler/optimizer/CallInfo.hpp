...
struct TR_CallSite : public TR_Link<TR_CallSite>
{
  ...
  vcount_t
    _visitCount; // a woefully bad choice of name.  The number of times we have
                 // visited this callsite during inlining.  In theory, when you
                 // have multiple targets for a callsite, you will have multiple
