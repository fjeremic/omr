...
public:
  ...
  typedef TR::typed_allocator<std::pair<const int32_t, TR::Node*>, TR::Region&>
    HashTableAllocator;
  typedef std::
    multimap<int32_t, TR::Node*, std::less<int32_t>, HashTableAllocator>
      HashTable;
...
protected:
  ...
  TR::Node* replaceCopySymbolReferenceByOriginalIn(
    TR::SymbolReference*,
    /* TR::SymbolReference *,*/ TR::Node*,
    TR::Node*,
    TR::Node*,
    TR::Node*,
    int32_t);
  void examineNode(TR::Node*,
                   TR_BitVector&,
                   TR::Node*,
                   int32_t,
                   int32_t*,
  ...
  void makeNodeAvailableForCommoning(TR::Node*,
                                     TR::Node*,
                                     TR_BitVector&,
                                     bool*);
  ...
  void killAvailableExpressionsAtGCSafePoints(TR::Node*,
                                              TR::Node*,
                                              TR_BitVector&);
  ...
  bool isFirstReferenceToNode(TR::Node* parent,
                              int32_t index,
                              TR::Node* node,
                              vcount_t visitCount);

  bool isIfAggrToBCDOverride(TR::Node* parent,
                             TR::Node* rhsOfStoreDefNode,
                             TR::Node* nodeBeingReplaced);

  bool doCopyPropagationIfPossible(TR::Node*,
                                   TR::Node*,
                                   int32_t,
                                   TR::Node*,
                                   TR::SymbolReference*,
  ...
  typedef TR::typed_allocator<std::pair<uint32_t const, TR::Node*>, TR::Region&>
    StoreMapAllocator;
