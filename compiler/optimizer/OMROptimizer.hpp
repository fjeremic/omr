...
public:
  ...
  bool getAliasSetsAreValid()
  {
    return _aliasSetsAreValid;
  }
  void setAliasSetsAreValid(bool b, bool setForWCode = false);

  bool getInlineSynchronized()
  {
    return _inlineSynchronized;
  }
  void setInlineSynchronized(bool b)
  {
    _inlineSynchronized = b;
  }
  ...
  TR_UseDefInfo* getUseDefInfo()
  {
    return _useDefInfo;
  }
  TR_UseDefInfo* setUseDefInfo(TR_UseDefInfo* u);

  bool cantBuildGlobalsUseDefInfo()
  {
    return _cantBuildGlobalsUseDefInfo;
  }
  bool cantBuildLocalsUseDefInfo()
  {
    return _cantBuildLocalsUseDefInfo;
  }
  void setCantBuildGlobalsUseDefInfo(bool v)
  {
    _cantBuildGlobalsUseDefInfo = v;
  }
  void setCantBuildLocalsUseDefInfo(bool v)
  {
    _cantBuildLocalsUseDefInfo = v;
  }
  ...
  TR_ValueNumberInfo* getValueNumberInfo()
  {
    return _valueNumberInfo;
  }
  ...
  bool cachedExtendedBBInfoValid()
  {
    return _cachedExtendedBBInfoValid;
  }
  void setCachedExtendedBBInfoValid(bool b);

  TR::Block* getEnclosingFinallyBlock()
  {
    return _enclosingFinallyBlock;
  }
  ...
  List<TR::Node>& getClassPointerNodes()
  {
    return _classPointerNodes;
  }

  void dumpPostOptTrees();

#ifdef DEBUG
  int32_t getDumpGraphsIndex()
  {
    return _dumpGraphsIndex;
  }
  ...
  {
    return _optMessageIndex;
  }
  int32_t incOptMessageIndex()
  {
    return ++_optMessageIndex;
  }
  ...
  TR_BitVector* getSeenBlocksGRA()
  {
    return _seenBlocksGRA;
  }
  void setSeenBlocksGRA(TR_BitVector* bv)
  {
    _seenBlocksGRA = bv;
  }
  TR_BitVector* getResetExitsGRA()
  {
    return _resetExitsGRA;
  }
  void setResetExitsGRA(TR_BitVector* bv)
  {
    _resetExitsGRA = bv;
  }
  TR_BitVector* getSuccessorBitsGRA()
  {
    return _successorBitsGRA;
  }
  void setSuccessorBitsGRA(TR_BitVector* bv)
  {
    _successorBitsGRA = bv;
  }
