...
class Optimizer {
 ...
 public:
  ...
  void setRequestOptimization(OMR::Optimizations optNum,
                              bool value = true,
                              TR::Block* block = NULL);
  ...
  static bool areNodesEquivalent(TR::Node*,
                                 TR::Node*,
                                 TR::Compilation*,
                                 bool allowBCDSignPromotion = false);
  static bool areBCDAggrConstantNodesEquivalent(TR::Node*,
                                                TR::Node*,
                                                TR::Compilation*);
  bool areNodesEquivalent(TR::Node* node1,
                          TR::Node* node2,
                          bool allowBCDSignPromotion = false) {
