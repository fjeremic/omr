...
template <class Container>
void TR_BasicDFSetAnalysis<Container*>::initializeGenAndKillSetInfoForStructure(
    TR_Structure* s) {
    ...
    *this->_temp2 = *_currentRegularKillSetInfo;
    ...
    for (auto succ = successors.getFirst(); succ; succ = successors.getNext()) {
      ...
      *_currentRegularKillSetInfo = *this->_temp2;
      TR_LinkHead<typename TR_BasicDFSetAnalysis<
          Container*>::TR_ContainerNodeNumberPair>*_nodeGenSetInfo =
             normalSucc ? nodeInfo->_regularGenSetInfo
...
void TR_ForwardDFSetAnalysis<Container*>::initializeGenAndKillSetInfoForBlock(
  ...
  typename TR_BasicDFSetAnalysis<Container*>::TR_ContainerNodeNumberPair* pair =
      new (this->trStackMemory()) typename TR_BasicDFSetAnalysis<Container*>::
          TR_ContainerNodeNumberPair(this->_regularGenSetInfo[s->getNumber()],
                                     s->getNumber());
  analysisInfo->_regularGenSetInfo->add(pair);
