...
void
TR_BackwardUnionDFSetAnalysis<Container*>::compose(Container* firstBitVector,
...
template<class Container>
void
TR_BackwardUnionDFSetAnalysis<Container*>::inverseCompose(
...
template<class Container>
void
TR_BackwardUnionDFSetAnalysis<Container*>::initializeOutSetInfo()
{
  int32_t i;
...
template<class Container>
void
TR_BackwardUnionDFSetAnalysis<Container*>::initializeCurrentGenKillSetInfo()
{}

template<class Container>
Container*
TR_BackwardUnionDFSetAnalysis<Container*>::initializeInfo(Container* info)
{
...
template<class Container>
Container*
TR_BackwardUnionDFSetAnalysis<Container*>::inverseInitializeInfo(
  Container* info)
{
  Container* result = info;
  if (result == NULL)
...
TR_BackwardUnionDFSetAnalysis<Container*>::getKind()
{
