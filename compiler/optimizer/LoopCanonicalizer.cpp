...
void TR_LoopTransformer::detectWhileLoopsInSubnodesInOrder(
    ...
    List<TR_Structure>& doWhileLoops,
    TR_Structure* root,
    TR_StructureSubGraphNode* rootNode,
...
void TR_LoopCanonicalizer::findIncrements(
    ...
    int64_t& primaryInductionVarIncrement,
    bool& unknownIncrement) {
...
int32_t TR_LoopTransformer::checkLoopForPredictability(
    TR_Structure* loopStructure,
    TR::Block* loopInvariantBlock,
    TR::Node** numberOfIterations,
    bool returnIfNotPredictable) {
...
void TR_LoopTransformer::updateInfo(TR::Node* node,
                                    vcount_t visitCount,
