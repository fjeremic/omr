...
//
void
TR_AsyncCheckInsertion::insertAsyncCheck(TR::Block* block,
                                         TR::Compilation* comp,
                                         const char* counterPrefix)
{
  ...
  TR::DebugCounter::prependDebugCounter(
    comp, name, asyncTree->getNextTreeTop());
}
...
bool
TR_AsyncCheckInsertion::shouldPerform()
{
...
int32_t
TR_AsyncCheckInsertion::perform()
{
