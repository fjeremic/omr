...
void TR_UseDefInfo::prepareUseDefInfo(bool requiresGlobals,
                                      bool prefersGlobals,
                                      bool cannotOmitTrivialDefs,
                                      bool conversionRegsOnly) {
...
bool TR_UseDefInfo::assignAdjustedNodeIndex(TR::Block* block,
                                            TR::Node* node,
                                            TR::Node* parent,
                                            TR::TreeTop* treeTop,
                                            AuxiliaryData& aux,
...
void TR_UseDefInfo::insertData(TR::Block* block,
                               TR::Node* node,
                               TR::Node* parent,
                               TR::TreeTop* treeTop,
                               AuxiliaryData& aux,
...
void TR_UseDefInfo::buildUseDefs(TR::Node* node,
                                 void* vanalysisInfo,
...
bool TR_UseDefInfo::getUsesFromDef(BitVector& usesFromDef,
                                   int32_t defIndex,
                                   bool loadAsDef) {
