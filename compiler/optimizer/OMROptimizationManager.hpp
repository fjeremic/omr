...
public:
  ...
  OptimizationManager(TR::Optimizer* o,
  ...
  {
    return _flags.testAny(requiresGlobalsUseDefInfo | prefersGlobalsUseDefInfo |
                          requiresLocalsUseDefInfo);
  }
  ...
  bool getRequiresValueNumbering()
  {
    return _flags.testAny(
      requiresGlobalsValueNumbering | stronglyPrefersGlobalsValueNumbering |
  ...
  {
    return _flags.testAny(prefersGlobalsValueNumbering |
                          stronglyPrefersGlobalsValueNumbering);
  }
...
protected:
  ...
  TR::OptimizationPolicy* _optPolicy; // opt specific policy for project
                                      // specific optimization heuristic
  TR::OptimizationUtil*
    _optUtil; // opt specific utility for project specific optimization
