...
TR_Earliestness::getKind()
{
  return Earliestness;
}

TR_Earliestness*
TR_Earliestness::asEarliestness()
{
  return this;
}

int32_t
TR_Earliestness::getNumberOfBits()
{
  return _globalAnticipatability->_numberOfBits;
}

void
TR_Earliestness::analyzeNode(TR::Node*,
                             vcount_t,
                             TR_BlockStructure*,
                             TR_BitVector*)
{}
...
bool
TR_Earliestness::postInitializationProcessing()
{
  int32_t i;
...
//
void
TR_Earliestness::analyzeTreeTopsInBlockStructure(
