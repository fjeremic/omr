...
TR_StripMiner::TR_StripMiner(TR::OptimizationManager *manager)
    : TR_LoopTransformer(manager), _nodesInCFG(0), _endTree(NULL),
      _loopInfos(manager->trMemory()), _origBlockMapper(NULL),
      _mainBlockMapper(NULL), _preBlockMapper(NULL), _postBlockMapper(NULL),
