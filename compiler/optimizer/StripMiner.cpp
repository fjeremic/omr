...
void TR_StripMiner::redirect(TR::Block* source,
                             TR::Block* oldDest,
                             TR::Block* newDest) {
...
//
void TR_StripMiner::examineLoop(LoopInfo* li,
...
void TR_StripMiner::examineNode(LoopInfo* li,
                                TR::Node* parent,
                                TR::Node* node,
...
void TR_StripMiner::replaceLoopPivs(LoopInfo* li,
