...
TR_ValueNumberInfo::TR_ValueNumberInfo(TR::Compilation *comp)
    : _compilation(comp), _nodes(comp->allocator()),
      _valueNumbers(comp->allocator()), _nextInRing(comp->allocator()) {}

TR_ValueNumberInfo::TR_ValueNumberInfo(TR::Compilation *comp,
                                       TR::Optimizer *optimizer,
                                       bool requiresGlobals,
                                       bool prefersGlobals, bool noUseDefInfo)
    : _compilation(comp), _optimizer(optimizer),
      _trace(comp->getOption(TR_TraceValueNumbers)), _nodes(comp->allocator()),
      _valueNumbers(comp->allocator()), _nextInRing(comp->allocator()) {
...
bool TR_HashValueNumberInfo::VNHashKey::
operator==(const VNHashKey &other) const {
