...
extern void collectArraylengthNodes(TR::Node* node,
                                    vcount_t visitCount,
...
TR::Node* generateLenForArrayCopy(TR::Compilation* comp,
                                  int32_t elementSize,
                                  TR::Node* stride,
                                  TR::Node* srcObjNode,
                                  TR::Node* copyLenNode,
...
TR::Node* generateArrayAddressTree(TR::Compilation* comp,
                                   TR::Node* node,
                                   int32_t offHigh,
                                   TR::Node* offNode,
                                   TR::Node* objNode,
...
TR::TreeTop* OMR::ValuePropagation::createPrimitiveArrayNodeWithoutFlags(
    ...
    bool isOptimizedReferenceArraycopy) {
...
TR::Node* generateArrayletAddressTree(TR::Compilation* comp,
                                      TR::Node* vcallNode,
                                      TR::DataType type,
                                      TR::Node* off,
                                      TR::Node* obj,
...
void OMR::ValuePropagation::generateRTArrayNodeWithoutFlags(
    TR_RealTimeArrayCopy* rtArrayCopy,
    TR::TreeTop* dupArraycopyTree,
    TR::SymbolReference* srcRef,
    TR::SymbolReference* dstRef,
    TR::SymbolReference* srcOffRef,
    TR::SymbolReference* dstOffRef,
...
void createAndInsertTestBlock(TR::Compilation* comp,
                              TR::TreeTop* ifTree,
                              TR::TreeTop* tree,
                              TR::Block* insertAfterBlock,
                              TR::Block* dstBlock) {
  TR::CFG* cfg = comp->getFlowGraph();
...
void OMR::ValuePropagation::launchNode(TR::Node* node,
                                       TR::Node* parent,
                                       int32_t whichChild) {
