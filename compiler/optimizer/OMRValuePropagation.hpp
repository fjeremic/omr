...
class ArraycopyTransformation : public TR::Optimization {
 ...
 private:
  TR::TreeTop* createArrayNode(TR::TreeTop* tree,
                               TR::TreeTop* newTree,
  ...
  TR::TreeTop* specializeForLength(TR::TreeTop* tt,
                                   TR::Node* arraycopyNode,
 ...
 public:
  ...
  class ValueConstraint : public TREE_NODE<ValueConstraint> {
   public:
    ...
    void initialize(int32_t valueNumber,
                    Relationship* rel,
  ...
  TR::VPConstraint* addEdgeConstraint(TR::Node* node,
                                      ...
                                      TR::Node* relative = NULL);
  TR::VPConstraint* addConstraintToList(TR::Node* node,
                                        int32_t valueNumber,
                                        int32_t relative,
                                        TR::VPConstraint* constraint,
                                        ValueConstraints* valueConstraints,
  ...
  void mergeStoreRelationships(ValueConstraint* fromvc,
                               ValueConstraint* tovc,
                               bool preserveFrom = false);
  void mergeValueConstraints(ValueConstraint* fromvc,
                             ValueConstraint* tovc,
                             bool preserveFrom = false);
  ...
  void removeConstraint(int32_t valueNumber,
                        ValueConstraints& valueConstraints,
  ...
  Relationship* findValueConstraint(int32_t valueNumber,
                                    ValueConstraints& valueConstraints,
                                    int32_t relative = AbsoluteConstraint);
  Relationship* findEdgeConstraint(int32_t valueNumber,
                                   EdgeConstraints* edge,
                                   int32_t relative = AbsoluteConstraint);
  ...
  //
  TR::VPConstraint* getConstraint(TR::Node* node,
                                  bool& isGlobal,
                                  TR::Node* relative = NULL);
  TR::VPConstraint* mergeDefConstraints(TR::Node* node,
                                        int32_t relative,
                                        bool& isGlobal,
                                        bool forceMerge = false);
  TR::VPConstraint* applyGlobalConstraints(TR::Node* node,
                                           int32_t valueNumber,
                                           TR::VPConstraint* constraint,
                                           int32_t relative);
  void invalidateParmConstraintsIfNeeded(TR::Node* node,
                                         TR::VPConstraint* constraint);
  void checkTypeRelationship(TR::VPConstraint* lhs,
                             TR::VPConstraint* rhs,
                             int32_t& value,
                             bool isInstanceOf,
                             bool isCheckCast);
  ...
  bool hasBeenStored(int32_t valueNumber,
                     TR::Symbol* symbol,
                     ValueConstraints& valueConstraints);
  ...
  bool propagateConstraint(TR::Node* node,
                           int32_t valueNumber,
                           Relationship* first,
                           Relationship* rel,
                           ValueConstraints* valueConstraints);
  ...
  void replaceByConstant(TR::Node* node,
                         TR::VPConstraint* constraint,
                         bool isGlobal);
  ...
  bool canTransformArrayCopyCallForSmall(TR::Node* node,
                                         int32_t& srcLength,
                                         int32_t& dstLength,
                                         int32_t& stride,
                                         TR::DataType& type);
  ...
  TR::TreeTop* buildSameLeafTest(TR::Node* offset,
                                 TR::Node* len,
  ...
  void generateRTArrayNodeWithoutFlags(TR_RealTimeArrayCopy* rtArrayCopyTree,
  ...
  void printStructureInfo(TR_Structure* structure,
                          bool starting,
  ...
  bool removeConstraints(int32_t valueNumber,
                         ValueConstraints* valueConstraints);
  bool removeConstraints(int32_t valueNumber);
  bool removeStoreConstraints(ValueConstraints* vc,
                              int32_t valueNumber,
                              int32_t relative);
  ...
  struct InductionVariable : public TR_Link<InductionVariable> {
    InductionVariable(TR::Symbol* sym,
                      TR::Node* entryDef,
                      int32_t incrVN,
  ...
  struct CallInfo : public TR_Link<CallInfo> {
    CallInfo(OMR::ValuePropagation* vp,
  ...
  struct VirtualGuardInfo : public TR_Link<VirtualGuardInfo> {
    VirtualGuardInfo(OMR::ValuePropagation* vp,
