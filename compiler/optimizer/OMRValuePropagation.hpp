...
public:
  ...
  public:
    ValueConstraintIterator()
      : _list(NULL)
    {}
    ValueConstraintIterator(ValueConstraints& list)
    {
      reset(list);
    }
  ...
  bool canTransformArrayCopyCallForSmall(
    TR::Node* node, int32_t& srcLength, int32_t& dstLength, int32_t& stride, TR::DataType& type);
...
#ifdef J9_PROJECT_SPECIFIC
  void generateArrayTranslateNode(TR::TreeTop* vcallTree, TR::TreeTop* arrayTranslateTree, TR::SymbolReference* srcRef,
    TR::SymbolReference* dstRef, TR::SymbolReference* srcOffRef, TR::SymbolReference* dstOffRef,
    TR::SymbolReference* lenRef, TR::SymbolReference* tableRef, bool hasTable);
#endif
  TR::TreeTop* createConverterCallNodeAfterStores(TR::TreeTop* tree, TR::TreeTop* origTree, TR::SymbolReference* srcRef,
  ...
  {
    return _intersectionFailed;
  }
  void setIntersectionFailed(bool b)
  {
    _intersectionFailed = b;
  }
  ...
  List<TR::Node>* getArraylengthNodes()
  {
    return &_arraylengthNodes;
  }

  // Pre-existence handling
  //
  void enablePreexistence()
  {
    _usePreexistence = true;
  }
  bool usePreexistence()
  {
    return _usePreexistence;
  }
  ...
  {
    return _lastTimeThrough;
  }
  bool checksWereRemoved()
  {
    return _checksRemoved;
  }
  bool enableSimplifier()
  {
    return _enableSimplifier;
  }
  bool useDefInfoInvalid()
  {
    return _invalidateUseDefInfo;
  }
  bool valueNumberInfoInvalid()
  {
    return _invalidateValueNumberInfo;
  }
  bool getBestRun()
  {
    return _bestRun;
  }
  TR::Node* getCurrentParent()
  {
    return _currentParent;
  }
  bool chTableWasValid()
  {
    return _chTableWasValid;
  }
  bool chTableValidityChecked()
  {
    return _chTableValidityChecked;
  }
  //

  void setChecksRemoved()
  {
    _checksRemoved = true;
  }
  void setEnableSimplifier()
  {
    _enableSimplifier = true;
  }
  void setChTableWasValid(bool b)
  {
    _chTableWasValid = b;
  }
  void setChTableValidityChecked(bool b)
  {
    _chTableValidityChecked = b;
  }
  void invalidateUseDefInfo()
  {
    _invalidateUseDefInfo = true;
  }
  void invalidateValueNumberInfo()
  {
    _invalidateValueNumberInfo = true;
  }
  void setCurrentParent(TR::Node* n)
  {
    _currentParent = n;
  }
