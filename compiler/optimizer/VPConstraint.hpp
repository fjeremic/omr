...
class VPIntRange : public TR::VPIntConstraint {
 public:
  ...
  static TR::VPIntConstraint *create(
      OMR::ValuePropagation *vp, TR::DataTypes dt,
      TR_YesNoMaybe
          isUnsigned);  // Takes a TR::DataTypes instead of TR::DataType to work
                        // around ambiguous overloads
 ...
 public:
  VPClass(TR::VPClassType *type, TR::VPClassPresence *presence,
      ...
      : TR::VPConstraint(ClassPriority),
        ...
        _location(location) {}
  static TR::VPConstraint *create(OMR::ValuePropagation *vp,
                                  TR::VPClassType *type,
...
class VPKnownObject : public TR::VPFixedClass {
 ...
 public:
  ...
  static TR::VPKnownObject *createForJavaLangClass(
      OMR::ValuePropagation *vp, TR::KnownObjectTable::Index index) {
