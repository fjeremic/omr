...
public:
  ...
  static TR::VPConstraint *create(OMR::ValuePropagation *vp, const char *sig,
  ...
  TR::VPConstraint *intersect(TR::VPConstraint *other,
                              OMR::ValuePropagation *vp);
  virtual TR::VPConstraint *merge1(TR::VPConstraint *other,
                                   OMR::ValuePropagation *vp);
  virtual TR::VPConstraint *intersect1(TR::VPConstraint *other,
                                       OMR::ValuePropagation *vp);

  // Arithmetic operations
  //
  virtual TR::VPConstraint *add(TR::VPConstraint *other, TR::DataType type,
                                OMR::ValuePropagation *vp);
  virtual TR::VPConstraint *subtract(TR::VPConstraint *other, TR::DataType type,
                                     OMR::ValuePropagation *vp);
  ...
  virtual bool mustBeNotEqual(TR::VPConstraint *other,
                              OMR::ValuePropagation *vp);
  virtual bool mustBeLessThan(TR::VPConstraint *other,
                              OMR::ValuePropagation *vp);
  virtual bool mustBeLessThanOrEqual(TR::VPConstraint *other,
                                     OMR::ValuePropagation *vp);
...
enum MergePriorities
  ...
  */
  ...
  void setHasArtificialIncrement() {
    (_mergePriority = _mergePriority | 0x80000000);
  }
...
protected:
  ...
  class Tracer {
  public:
    Tracer(OMR::ValuePropagation *vp, TR::VPConstraint *self,
  ...
  type_t addWithOverflow(type_t a, type_t b, bool &overflow) {
    ...
    // The overflow flag is set when the arithmetic used to compute the sum
    // overflows. This happens exactly when both operand have the same sign and
    // the resulting value has the opposite sign to this. A non-negative result
    // from xoring two numbers indicates that their sign bits are either both
    // set, or both unset, meaning they have the same sign, while a negative
    // result from xoring two numbers means that exactly one of them has its sign
    // bit set, meaning the signs of the two numbers differ.
  ...
  template <typename type_t>
  type_t subWithOverflow(type_t a, type_t b, bool &overflow) {
    // About uintmax_t, see addWithOverflow above.
    type_t diff = uintmax_t(a) - uintmax_t(b);

    // The overflow flag is set when the arithmetic used to compute the
    // difference overflows. This happens exactly when both operand bounds have a
    // differing sign and the resulting value has the same sign as the first
    // operand. A non-negative result from xoring two numbers indicates that
    // their sign bits are either both set, or both unset, meaning they have the
    // same sign, while a negative result from xoring two numbers means that
    // exactly one of them has its sign bit set, meaning the signs of the two
    // numbers differ.
...
public:
  VPShortConstraint(int16_t v) : TR::VPConstraint(ShortPriority) {
    _low = v;
    _overflow = TR_no;
  }
  ...
  virtual int32_t getPrecision() {
    return getPrecisionFromValue(TR::getMaxSigned<TR::Int16>());
  }
...
private:
  TR::VPConstraint *getRange(int16_t, int16_t, bool, bool,
                             OMR::ValuePropagation *vp);
};
...
public:
  ...
  static TR::VPConstraint *createExclusion(OMR::ValuePropagation *vp,
                                           int16_t v);
  // unsigned createExclusion
  // static TR::VPConstraint *createExclusion(OMR::ValuePropagation *vp, int32_t
  // v);
...
public:
  VPShortRange(int16_t low, int16_t high)
      : TR::VPShortConstraint(low), _high(high) {}
  static TR::VPShortConstraint *create(OMR::ValuePropagation *vp, int16_t low,
                                       int16_t high,
                                       TR_YesNoMaybe canOverflow = TR_no);
  static TR::VPShortConstraint *create(OMR::ValuePropagation *vp);
  static TR::VPShortConstraint *createWithPrecision(OMR::ValuePropagation *vp,
                                                    int32_t precision,
...
public:
  VPIntConstraint(int32_t v) : TR::VPConstraint(IntPriority) {
    _low = v;
    _overflow = TR_no;
  }
  ...
  virtual TR::VPConstraint *merge1(TR::VPConstraint *other,
                                   OMR::ValuePropagation *vp);
  // unsigned intMerge
  // TR::VPConstraint *merge1(TR::VPConstraint *other, OMR::ValuePropagation
  // *vp, bool isUnsigned);
  virtual TR::VPConstraint *intersect1(TR::VPConstraint *other,
                                       OMR::ValuePropagation *vp);
  // unsigned intIntersect
  // TR::VPConstraint *intersect1(TR::VPConstraint *other, OMR::ValuePropagation
  // *vp, bool isUnsigned);
  virtual bool mustBeNotEqual(TR::VPConstraint *other,
                              OMR::ValuePropagation *vp);
  virtual bool mustBeLessThan(TR::VPConstraint *other,
  ...
  virtual TR::VPConstraint *subtract(TR::VPConstraint *other, TR::DataType type,
                                     OMR::ValuePropagation *vp);
  // unsigned add
  // TR::VPConstraint *add(TR::VPIntConstraint *other, OMR::ValuePropagation
  // *vp, bool isUnsigned);
  // unsigned subtract
  // TR::VPConstraint *subtract(TR::VPIntConstraint *other,
  ...
  virtual int32_t getPrecision() {
    return getPrecisionFromValue(TR::getMaxSigned<TR::Int32>());
  }
...
private:
  TR::VPConstraint *getRange(int32_t, int32_t, bool, bool,
                             OMR::ValuePropagation *vp);
};
...
public:
  VPIntRange(int32_t low, int32_t high)
      : TR::VPIntConstraint(low), _high(high) {}
  // static TR::VPIntConstraint *create(OMR::ValuePropagation *vp, int32_t low,
  // int32_t high);
  static TR::VPIntConstraint *create(OMR::ValuePropagation *vp, int32_t low,
                                     int32_t high,
                                     TR_YesNoMaybe canOverflow = TR_no);
  static TR::VPIntConstraint *
  create(OMR::ValuePropagation *vp, TR::DataTypes dt,
         TR_YesNoMaybe
             isUnsigned); // Takes a TR::DataTypes instead of TR::DataType to
                          // work around ambiguous overloads
  static TR::VPIntConstraint *createWithPrecision(OMR::ValuePropagation *vp,
                                                  TR::DataType dt,
                                                  int32_t precision,
...
public:
  VPLongConstraint(int64_t v) : TR::VPConstraint(LongPriority) {
    _low = v;
    _overflow = TR_no;
  }
  ...
  virtual int32_t getPrecision() {
    return getPrecisionFromValue(TR::getMaxSigned<TR::Int64>());
  }
...
private:
  TR::VPConstraint *getRange(int64_t, int64_t, bool, bool,
                             OMR::ValuePropagation *vp);
};
...
public:
  VPLongRange(int64_t low, int64_t high)
      : TR::VPLongConstraint(low), _high(high) {}
  static TR::VPLongConstraint *create(OMR::ValuePropagation *vp, int64_t low,
                                      int64_t high, bool powerOfTwo = false,
                                      TR_YesNoMaybe canOverflow = TR_no);
...
public:
  VPClass(TR::VPClassType *type, TR::VPClassPresence *presence,
          TR::VPPreexistentObject *preexistence, TR::VPArrayInfo *arrayInfo,
          TR::VPObjectLocation *location)
      : TR::VPConstraint(ClassPriority), _type(type), _presence(presence),
        _preexistence(preexistence), _arrayInfo(arrayInfo),
        _location(location) {}
  static TR::VPConstraint *
  create(OMR::ValuePropagation *vp, TR::VPClassType *type,
         TR::VPClassPresence *presence, TR::VPPreexistentObject *preexistence,
  ...
  virtual TR::VPConstraint *intersect1(TR::VPConstraint *other,
                                       OMR::ValuePropagation *vp);
  void typeIntersect(TR::VPClassPresence *&presence, TR::VPClassType *&type,
...
private:
  TR::VPClassType *_type; // Conditional on presence.  "If the reference is
                          // non-null, it has this type info"
...
public:
  ...
  static TR::VPClassType *create(OMR::ValuePropagation *vp,
                                 TR::SymbolReference *symRef, bool isFixedClass,
                                 bool isPointerToClass = false);
  static TR::VPClassType *create(OMR::ValuePropagation *vp, const char *sig,
                                 int32_t len, TR_ResolvedMethod *method,
                                 bool isFixed,
                                 TR_OpaqueClassBlock *j9class = 0);
...
public:
  ...
  static TR::VPResolvedClass *create(OMR::ValuePropagation *vp,
...
public:
  VPFixedClass(TR_OpaqueClassBlock *klass, TR::Compilation *comp,
               int32_t p = FixedClassPriority)
      : TR::VPResolvedClass(klass, comp, p) {}
  static TR::VPFixedClass *create(OMR::ValuePropagation *vp,
                                  TR_OpaqueClassBlock *klass);
...
protected:
  VPConstString(TR_OpaqueClassBlock *klass, TR::Compilation *comp,
                TR::SymbolReference *symRef)
      : TR::VPFixedClass(klass, comp, ConstStringPriority), _symRef(symRef) {}

public:
  static TR::VPConstString *create(OMR::ValuePropagation *vp,
                                   TR::SymbolReference *symRef);
  ...
  bool getFieldByName(TR::SymbolReference *fieldRef, void *&result,
                      TR::Compilation *);
...
public:
  ...
  static TR::VPUnresolvedClass *create(OMR::ValuePropagation *vp,
...
public:
  ...
  static TR::VPPreexistentObject *create(OMR::ValuePropagation *vp,
...
public:
  VPArrayInfo(int32_t lowBound, int32_t highBound, int32_t elementSize)
      : TR::VPConstraint(ArrayInfoPriority), _lowBound(lowBound),
        _highBound(highBound), _elementSize(elementSize) {}
  static TR::VPArrayInfo *create(OMR::ValuePropagation *vp, int32_t lowBound,
                                 int32_t highBound, int32_t elementSize);
...
public:
  ...
  static TR::VPObjectLocation *create(OMR::ValuePropagation *vp,
...
private:
  VPObjectLocation(VPObjectLocationKind kind)
      : TR::VPConstraint(ObjectLocationPriority), _kind(kind) {}
...
protected:
  VPKnownObject(TR_OpaqueClassBlock *klass, TR::Compilation *comp,
                TR::KnownObjectTable::Index index, bool isJavaLangClass)
      : TR::VPFixedClass(klass, comp, KnownObjectPriority), _index(index),
        _isJavaLangClass(isJavaLangClass) {}

  static TR::VPKnownObject *create(OMR::ValuePropagation *vp,
...
public:
  ...
  static TR::VPKnownObject *
  createForJavaLangClass(OMR::ValuePropagation *vp,
                         TR::KnownObjectTable::Index index) {
...
class VPImplementedInterface : public TR::VPConstraint
   ...
   static  TR::VPImplementedInterface *create(OMR::ValuePropagation *vp, char
*sig, int32_t len, TR_ResolvedMethod *method);
   ...
   virtual TR::VPConstraint *intersect1(TR::VPConstraint *other,
OMR::ValuePropagation *vp); virtual TR::VPConstraint *merge1 (TR::VPConstraint
*other, OMR::ValuePropagation *vp);
  ...
  VPMergedConstraints(ListElement<TR::VPConstraint> *first, TR_Memory *m)
      : TR::VPConstraint(MergedConstraintPriority),
        _type((first && first->getData()->asShortConstraint()
                   ? TR::Int16
                   : ((first && first->getData()->asLongConstraint())
                          ? TR::Int64
                          : TR::Int32))),
        _constraints(m) {
    _constraints.setListHead(first);
  }
  static TR::VPMergedConstraints *create(OMR::ValuePropagation *vp,
...
private:
  TR::VPConstraint *shortMerge(TR::VPConstraint *otherCur,
                               ListElement<TR::VPConstraint> *otherNext,
                               OMR::ValuePropagation *vp);
  TR::VPConstraint *shortIntersect(TR::VPConstraint *otherCur,
                                   ListElement<TR::VPConstraint> *otherNext,
                                   OMR::ValuePropagation *vp);

  // unsigned intMerge
  //   TR::VPConstraint *intMerge(TR::VPIntConstraint *otherCur,
  //   ListElement<TR::VPConstraint> *otherNext, OMR::ValuePropagation *vp, bool
  //   isUnsigned);
  TR::VPConstraint *intMerge(TR::VPConstraint *otherCur,
                             ListElement<TR::VPConstraint> *otherNext,
                             OMR::ValuePropagation *vp);
  TR::VPConstraint *intIntersect(TR::VPConstraint *otherCur,
                                 ListElement<TR::VPConstraint> *otherNext,
                                 OMR::ValuePropagation *vp);

  // unsigned intIntersect
  // TR::VPConstraint *intIntersect(TR::VPIntConstraint *otherCur,
  // ListElement<TR::VPConstraint> *otherNext, OMR::ValuePropagation *vp, bool
  // isUnsigned);
  TR::VPConstraint *longMerge(TR::VPConstraint *otherCur,
                              ListElement<TR::VPConstraint> *otherNext,
                              OMR::ValuePropagation *vp);
  TR::VPConstraint *longIntersect(TR::VPConstraint *otherCur,
                                  ListElement<TR::VPConstraint> *otherNext,
                                  OMR::ValuePropagation *vp);
...
public:
  VPRelation(int32_t incr, int32_t p) : TR::VPConstraint(p), _increment(incr) {}
  virtual TR::VPRelation *asRelation();
  int32_t increment() { return _increment; }

  virtual TR::VPConstraint *
  propagateAbsoluteConstraint(TR::VPConstraint *constraint, int32_t relative,
                              OMR::ValuePropagation *vp);
  virtual TR::VPConstraint *
  propagateRelativeConstraint(TR::VPRelation *other, int32_t relative,
...
public:
  ...
  static TR::VPGreaterThanOrEqual *create(OMR::ValuePropagation *vp,
                                          int32_t incr);
  virtual TR::VPConstraint *merge1(TR::VPConstraint *other,
                                   OMR::ValuePropagation *vp);
  virtual TR::VPConstraint *intersect1(TR::VPConstraint *other,
...
public:
  VPEqual(int32_t incr) : TR::VPRelation(incr, EqualPriority) {}
...
public:
  VPNotEqual(int32_t incr) : TR::VPRelation(incr, NotEqualPriority) {}
