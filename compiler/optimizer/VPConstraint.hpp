...
enum MergePriorities
  ...
  */
  ...
  int32_t priority()
  {
    return (_mergePriority & 0x7fffffff);
  }
  ...
  bool hasArtificialIncrement()
  {
    return ((_mergePriority & 0x80000000) != 0);
  }
...
public:
  ...
  virtual int32_t getPrecision()
  {
    return getPrecisionFromValue(_low);
  }
};
...
public:
  ...
  virtual int32_t getPrecision()
  {
    return getPrecisionFromRange(_low, _high);
  }
...
public:
  VPLongRange(int64_t low, int64_t high)
    ...
    , _high(high)
  {}
  static TR::VPLongConstraint* create(
    OMR::ValuePropagation* vp, int64_t low, int64_t high, bool powerOfTwo = false, TR_YesNoMaybe canOverflow = TR_no);
...
public:
  ...
  virtual bool hasMoreThanFixedClassInfo()
  {
    return false;
  }
...
public:
  ...
  TR_OpaqueClassBlock* getAssumptionClass()
  {
    return _assumptionClass;
  }
...
public:
  ...
  TR::KnownObjectTable::Index getIndex()
  {
    return _index;
  }
...
public:
  ...
  TR_ScratchList<TR::VPConstraint>* getList()
  {
    return &_constraints;
  }
  TR::DataType getType()
