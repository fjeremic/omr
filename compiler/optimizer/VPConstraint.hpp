...
class VPConstraint {
 public:
  ...
  //
  virtual TR::VPConstraint* add(TR::VPConstraint* other,
                                TR::DataType type,
                                OMR::ValuePropagation* vp);
  virtual TR::VPConstraint* subtract(TR::VPConstraint* other,
                                     TR::DataType type,
                                     OMR::ValuePropagation* vp);
...
enum MergePriorities
 ...
 protected:
  ...
  class Tracer {
   public:
    Tracer(OMR::ValuePropagation* vp,
...
class VPShortConstraint : public TR::VPConstraint {
 ...
 private:
  TR::VPConstraint* getRange(int16_t,
                             int16_t,
                             bool,
                             bool,
                             OMR::ValuePropagation* vp);
...
class VPIntConstraint : public TR::VPConstraint {
 ...
 private:
  TR::VPConstraint* getRange(int32_t,
                             int32_t,
                             bool,
                             bool,
                             OMR::ValuePropagation* vp);
...
class VPIntRange : public TR::VPIntConstraint {
 public:
  ...
  // int32_t high);
  static TR::VPIntConstraint* create(OMR::ValuePropagation* vp,
                                     int32_t low,
                                     int32_t high,
                                     TR_YesNoMaybe canOverflow = TR_no);
...
class VPLongConstraint : public TR::VPConstraint {
 ...
 private:
  TR::VPConstraint* getRange(int64_t,
                             int64_t,
                             bool,
                             bool,
                             OMR::ValuePropagation* vp);
...
class VPLongRange : public TR::VPLongConstraint {
 public:
  ...
  static TR::VPLongConstraint* create(OMR::ValuePropagation* vp,
                                      int64_t low,
                                      int64_t high,
...
class VPClass : public TR::VPConstraint {
 public:
  ...
  virtual TR::VPConstraint* intersect1(TR::VPConstraint* other,
                                       OMR::ValuePropagation* vp);
  void typeIntersect(TR::VPClassPresence*& presence,
                     TR::VPClassType*& type,
                     TR::VPConstraint* other,
                     OMR::ValuePropagation* vp);
  virtual bool mustBeEqual(TR::VPConstraint* other, OMR::ValuePropagation* vp);
...
class VPFixedClass : public TR::VPResolvedClass {
 public:
  VPFixedClass(TR_OpaqueClassBlock* klass,
               TR::Compilation* comp,
...
class VPConstString : public TR::VPFixedClass {
 protected:
  VPConstString(TR_OpaqueClassBlock* klass,
                TR::Compilation* comp,
                TR::SymbolReference* symRef)
 ...
 public:
  ...
  bool getFieldByName(TR::SymbolReference* fieldRef,
                      void*& result,
                      TR::Compilation*);
...
class VPArrayInfo : public TR::VPConstraint {
 public:
  ...
  static TR::VPArrayInfo* create(OMR::ValuePropagation* vp,
                                 int32_t lowBound,
                                 int32_t highBound,
                                 int32_t elementSize);
...
class VPKnownObject : public TR::VPFixedClass {
 ...
 protected:
  VPKnownObject(TR_OpaqueClassBlock* klass,
                TR::Compilation* comp,
