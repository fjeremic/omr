...
class LocalDeadStoreElimination : public TR::Optimization {
 ...
 private:
  ...
  TR::Node* getAnchorNode(TR::Node* parentNode,
                          int32_t nodeIndex,
                          TR::Node*,
                          TR::TreeTop*,
  ...
  void findLocallyAllocatedObjectUses(LDSBitVector&,
                                      TR::Node*,
                                      int32_t,
                                      TR::Node*,
                                      vcount_t);
  bool examineNewUsesForKill(TR::Node*,
                             TR::Node*,
                             List<TR::Node>*,
                             List<TR::Node>*,
                             TR::Node*,
  ...
  void setIsFirstReferenceToNode(TR::Node* parent,
                                 int32_t index,
                                 TR::Node* node);
