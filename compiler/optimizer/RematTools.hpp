...
class RematSafetyInformation {
  std::vector<TR::SparseBitVector,
              TR::typed_allocator<TR::SparseBitVector, TR::Allocator> >
      dependentSymRefs;
  std::vector<TR::TreeTop *, TR::typed_allocator<TR::TreeTop *, TR::Allocator> >
      argumentTreeTops;
  std::vector<TR::TreeTop *, TR::typed_allocator<TR::TreeTop *, TR::Allocator> >
      rematTreeTops;
  TR::Compilation *comp;
 ...
 public:
  RematSafetyInformation(TR::Compilation *comp)
      : dependentSymRefs(
            getTypedAllocator<TR::SparseBitVector>(comp->allocator())),
...
class RematTools {
  static TR_YesNoMaybe gatherNodesToCheck(
  ...
  static void walkNodesCalculatingRematSafety(
 ...
 public:
  ...
  static bool walkTreesCalculatingRematSafety(
  ...
  static void walkTreesCalculatingRematSafety(
      TR::Compilation *comp, TR::TreeTop *start, TR::TreeTop *end,
      TR::SparseBitVector &scanTargets, TR::SparseBitVector &unsafeSymRefs,
      bool trace);

  static bool walkTreeTopsCalculatingRematFailureAlternatives(
      TR::Compilation *comp, TR::TreeTop *start, TR::TreeTop *end,
      TR::list<TR::TreeTop *> &failedArgs, TR::SparseBitVector &scanTargets,
      RematSafetyInformation &rematInfo, TR_BitVector *blocksToVisit,
      bool trace);
  static void walkTreeTopsCalculatingRematFailureAlternatives(
      TR::Compilation *comp, TR::TreeTop *start, TR::TreeTop *end,
      TR::list<TR::TreeTop *> &failedArgs, TR::SparseBitVector &scanTargets,
