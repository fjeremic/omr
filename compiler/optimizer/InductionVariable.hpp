...
public:
  ...
  bool isLongInt()
  {
    return _symRef->getSymbol()->getDataType() == TR::Int64;
  }
  ...
  int32_t getDeltaOnBackEdge()
  {
    return _deltaOnBackEdge;
  }
  void setDeltaOnBackEdge(int32_t d)
  {
    _deltaOnBackEdge = d;
  }

  int32_t getDeltaOnExitEdge()
  {
    return _deltaOnExitEdge;
  }
  void setDeltaOnExitEdge(int32_t d)
  {
    _deltaOnExitEdge = d;
  }
  ...
  bool isOnlyIncrementValid()
  {
    return _onlyIncrementValid;
  }
  void setOnlyIncrementValid(bool v)
  {
    _onlyIncrementValid = v;
  }
...
public:
  ...
  TR::Block* getBranchBlock()
  {
    return _branchBlock;
  }
  TR::Node* getExitBound()
  {
    return _exitBound;
  }
  bool isUnsigned()
  {
    return ((TR::ILOpCode*)&_exitOp)->isUnsignedCompare();
  }
  ...
  int32_t getNumLoopExits()
  {
    return _numLoopExits;
  }
  void setNumLoopExits(int32_t v)
  {
    _numLoopExits = v;
  }
  ...
  {
    return _usesUnchangedValueInLoopTest;
  }
...
private:
  ...
  public:
    ...
    AnalysisInfo(TR_BitVector* loopLocalDefs, TR_BitVector* allDefs)
      ...
      , _allDefs(allDefs)
    {}
    TR_BitVector* getLoopLocalDefs()
    {
      return _loopLocalDefs;
    }
    TR_BitVector* getAllDefs()
    {
      return _allDefs;
    }
  ...
  TR::Node* getEntryValue(
    TR::Block* block, TR::SymbolReference* symRef, TR_BitVector* nodesDone, TR_Array<TR::Node*>& cachedVales);
