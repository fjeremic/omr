...
protected:
    ...
    uint32_t insertAnchoredNodes(TR_MovableStore* store, TR::Node* nodeCopy, TR::Node* nodeOrig,
        TR::Node* nodeParentCopy, int32_t childNum, TR_BitVector* needTempForCommonedLoads,
        TR_BitVector* blockingUsedSymbols, TR_BitVector* blockingCommonedSymbols, TR::Block* currentBlock,
