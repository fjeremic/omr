...
public:
  ...
  TR_InductionVariable* getIndVar()
  {
    return _indVar;
  }

  TR::SymbolReference* getIndVarSymRef()
  {
    return _indVarSymRef;
  }
...
public:
  ...
  TR_LRAddressTree* getFirstAddress()
  {
    return &_firstAddress;
  }

  TR_LRAddressTree* getSecondAddress()
  {
    return &_secondAddress;
  }

  TR_LRAddressTree* getThirdAddress()
  {
    return &_thirdAddress;
  }
...
public:
  ...
  TR_InductionVariable* getIndVar()
  {
    return getFirstAddress()->getIndVar();
  }

  TR_LRAddressTree* getStoreAddress()
  {
...
public:
  ...
  TR_LRAddressTree* getLoadAddress()
  {
...
public:
  ...
  TR_LRAddressTree* getHighLoadAddress()
  {
    return getSecondAddress();
  }
  TR_LRAddressTree* getLowLoadAddress()
  {
    return getThirdAddress();
  }
...
public:
  ...
  TR_LRAddressTree* getHighStoreAddress()
  {
    return getSecondAddress();
  }
  TR_LRAddressTree* getLowStoreAddress()
  {
    return getThirdAddress();
  }
  TR_LRAddressTree* getLoadAddress()
...
public:
  ...
  TR::Block* targetOfGotoBlock()
  {
    return _targetOfGotoBlock;
  }
  ...
  TR::Node* getFirstLoad()
  {
    return _firstLoad;
  }
  TR::Node* getSecondLoad()
  {
    return _secondLoad;
  }

  void setFirstLoad(TR::Node* n)
  {
    _firstLoad = n;
  }
  void setSecondLoad(TR::Node* n)
  {
    _secondLoad = n;
  }
...
public:
  ...
  bool compilerGeneratedTable()
  {
    return _compilerGeneratedTable;
  }

  int32_t getTermValue();

  TR::Node* getInputNode()
  {
    return _inputNode;
  }
  TR::Node* getOutputNode()
  {
    return _outputNode;
  }
  ...
  TR::Node* getResultUnconvertedNode()
  {
    return _resultUnconvertedNode;
  }
  TR::Node* getResultNode()
  {
    return _resultNode;
  }
...
public:
  ...
  virtual TR_LoopReducer* asLoopReducer()
  {
    return this;
  }
...
private:
  ...
  bool generateArraycmp(
    TR_RegionStructure* whileLoop, TR_InductionVariable* indVar, TR::Block* compareBlock, TR::Block* incrementBlock);
