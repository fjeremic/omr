...
TR::VPPreexistentObject *TR::VPConstraint::asPreexistentObject() {
  return NULL;
}
TR::VPArrayInfo *TR::VPConstraint::asArrayInfo() { return NULL; }
TR::VPObjectLocation *TR::VPConstraint::asObjectLocation() { return NULL; }
TR::VPMergedConstraints *TR::VPConstraint::asMergedConstraints() {
  return NULL;
}
TR::VPMergedConstraints *TR::VPConstraint::asMergedShortConstraints() {
  return NULL;
}
TR::VPMergedConstraints *TR::VPConstraint::asMergedIntConstraints() {
  return NULL;
}
TR::VPMergedConstraints *TR::VPConstraint::asMergedLongConstraints() {
  return NULL;
}
...
TR::VPGreaterThanOrEqual *TR::VPConstraint::asGreaterThanOrEqual() {
  return NULL;
}
TR::VPEqual *TR::VPConstraint::asEqual() { return NULL; }
TR::VPNotEqual *TR::VPConstraint::asNotEqual() { return NULL; }
TR::VPShortConstraint *TR::VPShortConstraint::asShortConstraint() {
  return this;
}
...
TR::VPUnresolvedClass *TR::VPUnresolvedClass::asUnresolvedClass() {
  return this;
}
...
TR::VPPreexistentObject *TR::VPPreexistentObject::asPreexistentObject() {
  return this;
}
...
TR::VPMergedConstraints *TR::VPMergedConstraints::asMergedConstraints() {
  return this;
}
TR::VPMergedConstraints *TR::VPMergedConstraints::asMergedShortConstraints() {
  return (_type.isInt16()) ? this : NULL;
}
TR::VPMergedConstraints *TR::VPMergedConstraints::asMergedIntConstraints() {
  return (_type.isInt32()) ? this : NULL;
}
TR::VPMergedConstraints *TR::VPMergedConstraints::asMergedLongConstraints() {
  return (_type.isInt64()) ? this : NULL;
}
TR::VPUnreachablePath *TR::VPUnreachablePath::asUnreachablePath() {
  return this;
}
TR::VPSync *TR::VPSync::asVPSync() { return this; }
TR::VPRelation *TR::VPRelation::asRelation() { return this; }
TR::VPLessThanOrEqual *TR::VPLessThanOrEqual::asLessThanOrEqual() {
  return this;
}
TR::VPGreaterThanOrEqual *TR::VPGreaterThanOrEqual::asGreaterThanOrEqual() {
  return this;
}
...
bool TR::VPConstraint::isSpecialClass(uintptrj_t klass) {
  if (klass == VP_SPECIALKLASS) return true;
  return false;
}
...
const char *TR::VPClass::getClassSignature(int32_t &len) {
  if (_type) return _type->getClassSignature(len);
  return NULL;
}

bool TR::VPClass::isNullObject() {
  if (_presence) return _presence->isNullObject();
  return false;
}

bool TR::VPClass::isNonNullObject() {
  if (_presence) return _presence->isNonNullObject();
  return false;
}

bool TR::VPClass::isPreexistentObject() {
  if (_preexistence) return _preexistence->isPreexistentObject();
  return false;
}

TR_OpaqueClassBlock *TR::VPClass::getClass() {
  if (_type) return _type->getClass();
  return NULL;
}

bool TR::VPClass::isFixedClass() {
  if (_type) return _type->isFixedClass();
  return false;
}

bool TR::VPClass::isConstString() {
  if (_type) return _type->isConstString();
  return false;
}

TR_YesNoMaybe TR::VPClass::isStackObject() {
  if (_location) return _location->isStackObject();
  return TR_maybe;
}

TR_YesNoMaybe TR::VPClass::isHeapObject() {
  if (_location) return _location->isHeapObject();
  return TR_maybe;
}
...
TR::VPResolvedClass::VPResolvedClass(TR_OpaqueClassBlock *klass,
  ...
  if (TR::VPConstraint::isSpecialClass((uintptrj_t)klass)) {
    ...
    _sig = TR::Compiler->cls.classSignature_DEPRECATED(comp, klass, _len,
                                                       comp->trMemory());
}

TR::VPResolvedClass::VPResolvedClass(TR_OpaqueClassBlock *klass,
                                     TR::Compilation *comp, int32_t p)
...
TR::VPClassType *TR::VPResolvedClass::getArrayClass(OMR::ValuePropagation *vp) {
  ...
  if (arrayClass) return TR::VPResolvedClass::create(vp, arrayClass);
  ...
  return TR::VPUnresolvedClass::create(vp, arraySig, _len + 1,
                                       vp->comp()->getCurrentMethod());
}
...
bool TR::VPResolvedClass::isJavaLangObject(OMR::ValuePropagation *vp) {
  ...
  if (javaLangObject) return javaLangObject == _class;
#endif
...
bool TR::VPClassType::isCloneableOrSerializable() {
  if (_len == 21 && !strncmp(_sig, "Ljava/lang/Cloneable;", 21)) return true;
  if (_len == 22 && !strncmp(_sig, "Ljava/io/Serializable;", 22)) return true;
  return false;
}
...
TR::VPClassType *TR::VPFixedClass::getArrayClass(OMR::ValuePropagation *vp) {
  TR_OpaqueClassBlock *arrayClass =
      vp->fe()->getArrayClassFromComponentClass(getClass());
  if (arrayClass) return TR::VPFixedClass::create(vp, arrayClass);
...
TR::VPClassType *TR::VPUnresolvedClass::getArrayClass(
...
TR::VPRelation *TR::VPLessThanOrEqual::getComplement(
    OMR::ValuePropagation *vp) {
  TR::VPRelation *rel = TR::VPGreaterThanOrEqual::create(vp, -increment());
  if (hasArtificialIncrement()) rel->setHasArtificialIncrement();
  return rel;
}

TR::VPRelation *TR::VPGreaterThanOrEqual::getComplement(
    OMR::ValuePropagation *vp) {
...
TR::VPConstraint *TR::VPConstraint::create(OMR::ValuePropagation *vp,
                                           const char *sig, int32_t len,
...
TR::VPShortConst *TR::VPShortConst::create(OMR::ValuePropagation *vp,
                                           int16_t v) {
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint && constraint->getShort() == v) return constraint;
  }
...
TR::VPIntConst *TR::VPIntConst::create(OMR::ValuePropagation *vp, int32_t v) {
  ...
  //
  if (v == 0) return vp->_constantZeroConstraint;
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint && constraint->getInt() == v) return constraint;
  }
...
TR::VPConstraint *TR::VPShortConst::createExclusion(OMR::ValuePropagation *vp,
                                                    int16_t v) {
  ...
  return TR::VPMergedConstraints::create(
      vp, TR::VPShortRange::create(vp, TR::getMinSigned<TR::Int16>(), v - 1),
      TR::VPShortRange::create(vp, v + 1, TR::getMaxSigned<TR::Int16>()));
}

TR::VPConstraint *TR::VPIntConst::createExclusion(OMR::ValuePropagation *vp,
                                                  int32_t v) {
  ...
  return TR::VPMergedConstraints::create(
      vp, TR::VPIntRange::create(vp, TR::getMinSigned<TR::Int32>(), v - 1),
...
TR::VPShortConstraint *TR::VPShortRange::create(OMR::ValuePropagation *vp,
  ...
  if (low == high) return TR::VPShortConst::create(vp, low);
...
TR::VPShortConstraint *TR::VPShortRange::createWithPrecision(
  ...
  constrainRangeByPrecision(TR::getMinSigned<TR::Int16>(),
                            TR::getMaxSigned<TR::Int16>(), precision, lo, hi,
                            isNonNegative);
  return TR::VPShortRange::create(vp, lo, hi);
}

TR::VPIntConstraint *TR::VPIntRange::create(OMR::ValuePropagation *vp,
  ...
  if (low == high) return TR::VPIntConst::create(vp, low);
...
TR::VPIntConstraint *TR::VPIntRange::create(OMR::ValuePropagation *vp,
  ...
  return TR::VPIntRange::createWithPrecision(vp, dt, VP_UNDEFINED_PRECISION,
                                             isUnsigned);
}

TR::VPIntConstraint *TR::VPIntRange::createWithPrecision(
    OMR::ValuePropagation *vp, TR::DataType dt, int32_t precision,
  ...
  if (dt == TR::Int32)
    constrainRangeByPrecision(TR::getMinSigned<TR::Int32>(),
                              TR::getMaxSigned<TR::Int32>(), precision, lo, hi,
                              isNonNegative);

  if (isUnsigned == TR_no) {
    if (dt == TR::Int8)
      constrainRangeByPrecision(TR::getMinSigned<TR::Int8>(),
                                TR::getMaxSigned<TR::Int8>(), precision, lo, hi,
                                isNonNegative);
    else if (dt == TR::Int16)
      constrainRangeByPrecision(TR::getMinSigned<TR::Int16>(),
                                TR::getMaxSigned<TR::Int16>(), precision, lo,
                                hi, isNonNegative);
  } else if (isUnsigned == TR_yes) {
    if (dt == TR::Int8)
      constrainRangeByPrecision(0, TR::getMaxUnsigned<TR::Int8>(), precision,
                                lo, hi, isNonNegative);
    else if (dt == TR::Int16)
      constrainRangeByPrecision(0, TR::getMaxUnsigned<TR::Int16>(), precision,
                                lo, hi, isNonNegative);
  } else {
    if (dt == TR::Int8)
      constrainRangeByPrecision(TR::getMinSigned<TR::Int8>(),
                                TR::getMaxUnsigned<TR::Int8>(), precision, lo,
                                hi, isNonNegative);
    else if (dt == TR::Int16)
      constrainRangeByPrecision(TR::getMinSigned<TR::Int16>(),
                                TR::getMaxUnsigned<TR::Int16>(), precision, lo,
                                hi, isNonNegative);
  }
...
TR::VPLongConst *TR::VPLongConst::create(OMR::ValuePropagation *vp, int64_t v) {
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint && constraint->_low == v) return constraint;
  }
  constraint = new (vp->trStackMemory()) TR::VPLongConst(v);
  vp->addConstraint(constraint, hash);
  return constraint;
}
TR::VPConstraint *TR::VPLongConst::createExclusion(OMR::ValuePropagation *vp,
                                                   int64_t v) {
  ...
  return TR::VPMergedConstraints::create(
      vp, TR::VPLongRange::create(vp, TR::getMinSigned<TR::Int64>(), v - 1),
      TR::VPLongRange::create(vp, v + 1, TR::getMaxSigned<TR::Int64>()));
}

TR::VPLongConstraint *TR::VPLongRange::create(OMR::ValuePropagation *vp,
  ...
  if (low == high) return TR::VPLongConst::create(vp, low);
  ...
  if (powerOfTwo) constraint->setIsPowerOfTwo();

  return constraint;
}

TR::VPConstraint *TR::VPClass::create(OMR::ValuePropagation *vp,
                                      TR::VPClassType *type,
...
TR::VPClassType *TR::VPClassType::create(OMR::ValuePropagation *vp,
                                         TR::SymbolReference *symRef,
                                         bool isFixedClass,
                                         bool isPointerToClass) {
  if (!symRef->isUnresolved()) {
    TR_OpaqueClassBlock *classObject =
        (TR_OpaqueClassBlock *)symRef->getSymbol()
            ->getStaticSymbol()
            ->getStaticAddress();
    if (isPointerToClass) classObject = *((TR_OpaqueClassBlock **)classObject);
    if (isFixedClass) return TR::VPFixedClass::create(vp, classObject);
...
TR::VPClassType *TR::VPClassType::create(OMR::ValuePropagation *vp,
  ...
  if (classObject) {
    ...
    if (classInfo && classInfo->isInitialized()) {
      if (isFixed) return TR::VPFixedClass::create(vp, classObject);
      return TR::VPResolvedClass::create(vp, classObject);
    }
  }
#endif
...
TR::VPResolvedClass *TR::VPResolvedClass::create(OMR::ValuePropagation *vp,
...
TR::VPFixedClass *TR::VPFixedClass::create(OMR::ValuePropagation *vp,
                                           TR_OpaqueClassBlock *klass) {
  // If the constraint does not already exist, create it
  //
  int32_t hash = (int32_t)((((uintptrj_t)klass) << 2) % VP_HASH_TABLE_SIZE);
...
TR::VPKnownObject *TR::VPKnownObject::create(OMR::ValuePropagation *vp,
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint && constraint->_index == index) return constraint;
  }
...
TR::VPConstString *TR::VPConstString::create(OMR::ValuePropagation *vp,
                                             TR::SymbolReference *symRef) {
#ifdef J9_PROJECT_SPECIFIC
  ...
  if (vpConstStringCriticalSection.hasVMAccess()) {
    uintptrj_t stringStaticAddr = (uintptrj_t)symRef->getSymbol()
                                      ->castToStaticSymbol()
                                      ->getStaticAddress();
    uintptrj_t string =
...
uint16_t TR::VPConstString::charAt(int32_t i, TR::Compilation *comp) {
  ...
  if (charAtCriticalSection.hasVMAccess()) {
    ...
    bool canRead = true;
    if (i < 0 || i >= len) canRead = false;
    if (canRead) result = TR::Compiler->cls.getStringCharacter(comp, string, i);
  }
#endif
  return result;
}

bool TR::VPConstString::getFieldByName(TR::SymbolReference *symRef, void *&val,
                                       TR::Compilation *comp) {
  return TR::Compiler->cls.getStringFieldByName(comp, _symRef, symRef, val);
}

TR::VPUnresolvedClass *TR::VPUnresolvedClass::create(
    OMR::ValuePropagation *vp, const char *sig, int32_t len,
    TR_ResolvedMethod *method) {
  // If the constraint does not already exist, create it
  //
  int32_t hash =
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint && constraint->_len == len &&
      ...
      if (!strncmp(constraint->_sig, sig, len)) return constraint;
    }
  }
  constraint =
...
TR::VPPreexistentObject *TR::VPPreexistentObject::create(
    OMR::ValuePropagation *vp, TR_OpaqueClassBlock *c) {
...
TR::VPArrayInfo *TR::VPArrayInfo::create(OMR::ValuePropagation *vp,
                                         int32_t lowBound, int32_t highBound,
                                         int32_t elementSize) {
  // If the constraint does not already exist, create it
  //
  ...
  constraint = new (vp->trStackMemory())
      TR::VPArrayInfo(lowBound, highBound, elementSize);
  vp->addConstraint(constraint, hash);
  return constraint;
}
...
TR::VPArrayInfo *TR::VPArrayInfo::create(OMR::ValuePropagation *vp, char *sig) {
  ...
  return TR::VPArrayInfo::create(vp, 0, TR::getMaxSigned<TR::Int32>() / stride,
                                 stride);
}

TR::VPMergedConstraints *TR::VPMergedConstraints::create(
    OMR::ValuePropagation *vp, TR::VPConstraint *first,
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint) {
      ...
      if (p->getData() == first) {
        p = p->getNextElement();
        if (p->getData() == second && !p->getNextElement()) return constraint;
      }
    }
  }
...
TR::VPObjectLocation *TR::VPObjectLocation::create(OMR::ValuePropagation *vp,
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint && constraint->_kind == kind) return constraint;
  }
...
TR::VPMergedConstraints *TR::VPMergedConstraints::create(
    OMR::ValuePropagation *vp, ListElement<TR::VPConstraint> *list) {
  // If the constraint does not already exist, create it
  //
  int32_t hash = 0;
  bool allUnsigned = true;
  if (!list) allUnsigned = false;

  ListElement<TR::VPConstraint> *p1, *p2;
  for (p1 = list; p1; p1 = p1->getNextElement()) {
    if (!p1->getData()->isUnsigned()) allUnsigned = false;
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint) {
      for (p1 = list, p2 = constraint->_constraints.getListHead();
        ...
        ;
      if (!p1 && !p2) return constraint;
    }
  }
  constraint =
      new (vp->trStackMemory()) TR::VPMergedConstraints(list, vp->trMemory());
  if (allUnsigned) constraint->setIsUnsigned(true);

  vp->addConstraint(constraint, hash);
  return constraint;
}

TR::VPUnreachablePath *TR::VPUnreachablePath::create(
    OMR::ValuePropagation *vp) {
...
TR::VPSync *TR::VPSync::create(OMR::ValuePropagation *vp, TR_YesNoMaybe v) {
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint && (constraint->syncEmitted() == v)) return constraint;
  }
...
TR::VPLessThanOrEqual *TR::VPLessThanOrEqual::create(OMR::ValuePropagation *vp,
                                                     int32_t incr) {
  // If the constraint does not already exist, create it
  //
  int32_t hash =
  ...
  for (entry = vp->_constraintsHashTable[hash]; entry; entry = entry->next) {
    ...
    if (constraint && constraint->increment() == incr) return constraint;
  }
...
TR::VPGreaterThanOrEqual *TR::VPGreaterThanOrEqual::create(
    OMR::ValuePropagation *vp, int32_t incr) {
  // If the constraint does not already exist, create it
  //
...
TR::VPNotEqual *TR::VPNotEqual::create(OMR::ValuePropagation *vp,
                                       int32_t incr) {
  // If the constraint does not already exist, create it
  //
  int32_t hash =
...
TR::VPConstraint *TR::VPConstraint::merge(TR::VPConstraint *other,
                                          OMR::ValuePropagation *vp) {
  ...
  //
  if (other->priority() > priority()) return other->merge1(this, vp);
  return merge1(other, vp);
}

TR::VPConstraint *TR::VPConstraint::merge1(TR::VPConstraint *other,
                                           OMR::ValuePropagation *vp) {
...
TR::VPConstraint *TR::VPShortConstraint::merge1(TR::VPConstraint *other,
                                                OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPShortConstraint *otherShort = other->asShortConstraint();
  if (otherShort) {
    if (otherShort->getLow() < getLow()) return otherShort->merge1(this, vp);
    if (otherShort->getHigh() <= getHigh()) return this;
...
TR::VPConstraint *TR::VPIntConstraint::merge1(TR::VPConstraint *other,
                                              OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (otherInt) {
    if (otherInt->getLow() < getLow()) return otherInt->merge1(this, vp);
    ...
    if (otherLong) {
      ...
      if ((int64_t)otherLong->getLow() <= (int64_t)(getHigh() + 1)) {
        ...
        if ((int64_t)otherLong->getLow() < (int64_t)getLow())
          return TR::VPMergedConstraints::create(
              vp,
              TR::VPIntRange::create(vp, (int32_t)otherLong->getLow(),
                                     (int32_t)otherLong->getHigh()),
              this);
        else
          return TR::VPMergedConstraints::create(
              vp, this,
...
TR::VPConstraint *TR::VPLongConstraint::merge1(TR::VPConstraint *other,
                                               OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPLongConstraint *otherLong = other->asLongConstraint();
  if (otherLong) {
    if (otherLong->getLow() < getLow()) return otherLong->merge1(this, vp);
    ...
    if (otherInt) {
      ...
      if ((int64_t)otherInt->getLow() <= (int64_t)(getHigh() + 1)) {
        ...
        if ((int64_t)otherInt->getLow() < (int64_t)getLow())
          return TR::VPMergedConstraints::create(
              vp,
              TR::VPLongRange::create(vp, otherInt->getLow(),
                                      otherInt->getHigh()),
              this);
        else
          return TR::VPMergedConstraints::create(
...
TR::VPConstraint *TR::VPClass::merge1(TR::VPConstraint *other,
                                      OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (other->asClass()) {
    ...
    if (_type) type = (TR::VPClassType *)_type->merge(otherType, vp);
  ...
  if (type || presence || preexistence || arrayInfo || location)
    return TR::VPClass::create(vp, type, presence, preexistence, arrayInfo,
                               location);
  return NULL;
}

TR::VPConstraint *TR::VPResolvedClass::merge1(TR::VPConstraint *other,
                                              OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (otherClass) {
    ...
    if (other->isNullObject()) return this;
  }
  return NULL;
}

TR::VPConstraint *TR::VPFixedClass::merge1(TR::VPConstraint *other,
                                           OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  if (other->asFixedClass()) return NULL;  // They can't be the same class
...
TR::VPConstraint *TR::VPKnownObject::merge1(TR::VPConstraint *other,
                                            OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
...
TR::VPConstraint *TR::VPConstString::merge1(TR::VPConstraint *other,
                                            OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  if (other->asConstString()) return NULL;  // can't be the same string

  TR::VPResolvedClass *otherClass = other->asResolvedClass();
  if (otherClass) {
    if (otherClass->getClass() == getClass()) return other;
  }
  return NULL;
}

TR::VPConstraint *TR::VPArrayInfo::merge1(TR::VPConstraint *other,
                                          OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (otherInfo->_lowBound < lowBound) lowBound = otherInfo->_lowBound;
  if (otherInfo->_highBound > highBound) highBound = otherInfo->_highBound;
  if (otherInfo->_elementSize != elementSize) elementSize = 0;
...
TR::VPConstraint *TR::VPObjectLocation::merge1(TR::VPConstraint *other,
                                               OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (_kind == otherInfo->_kind) return this;
...
TR::VPConstraint *TR::VPSync::merge1(TR::VPConstraint *other,
                                     OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPSync *otherSync = other->asVPSync();
  if (!otherSync) return NULL;
...
TR::VPConstraint *TR::VPMergedConstraints::merge1(TR::VPConstraint *other,
                                                  OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (_type.isInt16()) return shortMerge(otherCur, otherNext, vp);
  if (_type.isInt32()) return intMerge(otherCur, otherNext, vp);
  if (_type.isInt64()) return longMerge(otherCur, otherNext, vp);

  return NULL;
}

TR::VPConstraint *TR::VPMergedConstraints::shortMerge(
    TR::VPConstraint *other, ListElement<TR::VPConstraint> *otherNext,
    OMR::ValuePropagation *vp) {
  ...
  if (otherCur) {
    ...
    if (!lastResultEntry->getNextElement()) return lastResultEntry->getData();
            ...
            if (lastResult->getHigh() == TR::getMaxSigned<TR::Int32>() ||
              ...
              if ((int64_t)otherCur->getLow() <
                ...
                lastResultEntry = result.addAfter(
                    TR::VPIntRange::create(vp, (int32_t)otherCur->getLow(),
...
TR::VPConstraint *TR::VPLessThanOrEqual::merge1(TR::VPConstraint *other,
                                                OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPLessThanOrEqual *otherLE = other->asLessThanOrEqual();
  if (otherLE) {
    if (otherLE->increment() < increment()) return this;
    return other;
  }
  return NULL;
}

TR::VPConstraint *TR::VPGreaterThanOrEqual::merge1(TR::VPConstraint *other,
                                                   OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPGreaterThanOrEqual *otherGE = other->asGreaterThanOrEqual();
  if (otherGE) {
    if (otherGE->increment() > increment()) return this;
    return other;
  }
  return NULL;
}

TR::VPConstraint *TR::VPEqual::merge1(TR::VPConstraint *other,
                                      OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPGreaterThanOrEqual *otherGE = other->asGreaterThanOrEqual();
  if (otherGE) {
    if (otherGE->increment() <= increment()) return other;
    return NULL;
  }
  TR::VPLessThanOrEqual *otherLE = other->asLessThanOrEqual();
  if (otherLE) {
    if (otherLE->increment() >= increment()) return other;
    return NULL;
  }
  return NULL;
}
...
TR::VPConstraint *TR::VPConstraint::intersect(TR::VPConstraint *other,
                                              OMR::ValuePropagation *vp) {
  // If this is the same constraint, just return it
  //
  if (!other) {
...
TR::VPConstraint *TR::VPConstraint::intersect1(TR::VPConstraint *other,
                                               OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
...
TR::VPConstraint *TR::VPShortConstraint::intersect1(TR::VPConstraint *other,
                                                    OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  TR::VPLongConstraint *otherLong = other->asLongConstraint();
  if (otherShort) {
    if (otherShort->getLow() < getLow()) return otherShort->intersect(this, vp);
    if (otherShort->getHigh() <= getHigh()) return other;
...
TR::VPConstraint *TR::VPIntConstraint::intersect1(TR::VPConstraint *other,
  ...
  if (otherInt) {
    if (otherInt->getLow() < getLow()) return otherInt->intersect(this, vp);
    if (otherInt->getHigh() <= getHigh()) return other;
...
TR::VPConstraint *TR::VPLongConstraint::intersect1(TR::VPConstraint *other,
                                                   OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPLongConstraint *otherLong = other->asLongConstraint();
  if (otherLong) {
    if (otherLong->getLow() < getLow()) return otherLong->intersect(this, vp);
    if (otherLong->getHigh() <= getHigh()) return other;
    ...
    if (otherInt) {
      ...
      if ((int64_t)otherInt->getLow() <= (int64_t)getHigh()) {
        if ((int64_t)getHigh() > (int64_t)TR::getMaxSigned<TR::Int32>())
          return TR::VPLongRange::create(vp, otherInt->getLow(),
...
TR::VPClassType *TR::VPClassType::classTypesCompatible(
    TR::VPClassType *otherType, OMR::ValuePropagation *vp) {
...
void TR::VPClass::typeIntersect(TR::VPClassPresence *&presence,
                                TR::VPClassType *&type, TR::VPConstraint *other,
                                OMR::ValuePropagation *vp) {
  ...
  if (other->asClass()) {
    ...
    if (_presence) {
      if (otherClass->_presence) {
        presence = (TR::VPClassPresence *)_presence->intersect(
            otherClass->_presence, vp);
        if (!presence) constrainPresence = false;
      }
    } else
      presence = otherClass->_presence;

    if (!constrainPresence) return;

    if (presence && presence->isNullObject()) return;
    ...
    if (TR::VPConstraint::isSpecialClass((uintptrj_t)otherType->getClass()))
      ...
      if (!classTypeFound) type = type->classTypesCompatible(otherType, vp);
    } else
      type = otherType;
  }
}

TR::VPConstraint *TR::VPClass::intersect1(TR::VPConstraint *other,
                                          OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (thisClassObjectYes != otherClassObjectYes) {
    ...
    if (otherClassObjectYes) std::swap(classObj, nonClassObj);
    ...
    if (!presence && _presence && otherClass->_presence) return NULL;
    ...
    if (_arrayInfo) {
      if (otherClass->_arrayInfo) {
        arrayInfo = (TR::VPArrayInfo *)_arrayInfo->intersect(
            otherClass->_arrayInfo, vp);
    ...
    // If intersection of presence failed, return null
    if (!presence && _presence && other->asClassPresence()) return NULL;
    // If the result is null, just return null
    //
    if (presence && presence->isNullObject()) return presence;
...
TR::VPConstraint *TR::VPResolvedClass::intersect1(TR::VPConstraint *other,
                                                  OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (otherRes) {
    ...
    if (isJavaLangObject(vp)) return other;
    ...
    if (other->isNullObject()) return other;
    return TR::VPClass::create(vp, this, other->asClassPresence(), NULL, NULL,
                               NULL);
  } else if (other->asPreexistentObject())
    return TR::VPClass::create(vp, this, NULL, other->asPreexistentObject(),
                               NULL, NULL);
  else if (other->asArrayInfo())
    return TR::VPClass::create(vp, this, NULL, NULL, other->asArrayInfo(),
                               NULL);
  else if (other->asObjectLocation()) {
    ...
    if (classObject != TR_maybe) {
      location = TR::VPObjectLocation::create(
          vp, classObject == TR_yes ? TR::VPObjectLocation::ClassObject
...
TR::VPConstraint *TR::VPFixedClass::intersect1(TR::VPConstraint *other,
                                               OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (otherClass) {
    TR_OpaqueClassBlock *c1 = getClass();
    TR_OpaqueClassBlock *c2 = otherClass->getClass();
    if (vp->fe()->isInstanceOf(c1, c2, true, true, true) != TR_no) return this;
  } else if (other->asUnresolvedClass()) {
    // Make sure they are both arrays or both classes
    //
    int32_t len = 0, thisLen, otherLen;
...
TR::VPConstraint *TR::VPKnownObject::intersect1(TR::VPConstraint *other,
                                                OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
...
TR::VPConstraint *TR::VPConstString::intersect1(TR::VPConstraint *other,
                                                OMR::ValuePropagation *vp) {
#ifdef J9_PROJECT_SPECIFIC
  TRACER(vp, this, other);
  ...
  if (otherClass) {
    ...
    if (other->isNullObject() && !isNonNullObject()) return other;

    if (!other->isNullObject() || !isNonNullObject()) return this;
  } else if (other->asObjectLocation()) {
    TR::VPObjectLocation *location =
...
TR::VPConstraint *TR::VPUnresolvedClass::intersect1(TR::VPConstraint *other,
                                                    OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (other->asClassPresence()) {
    ...
    return TR::VPClass::create(
        vp, this, NULL, NULL, NULL,
        other->asObjectLocation());  // FIXME: unless rtresolve, should be on
                                     // heap
  return this;
}

TR::VPConstraint *TR::VPNullObject::intersect1(TR::VPConstraint *other,
                                               OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  if (isNullObject()) return this;
  if (other->asPreexistentObject())
    return TR::VPClass::create(vp, NULL, this, other->asPreexistentObject(),
                               NULL, NULL);
  if (other->asArrayInfo())
    return TR::VPClass::create(vp, NULL, this, NULL, other->asArrayInfo(),
                               NULL);
...
TR::VPConstraint *TR::VPNonNullObject::intersect1(TR::VPConstraint *other,
                                                  OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (other->asArrayInfo())
    return TR::VPClass::create(vp, NULL, this, NULL, other->asArrayInfo(),
                               NULL);
  if (other->asObjectLocation())
    return TR::VPClass::create(vp, NULL, this, NULL, NULL,
                               other->asObjectLocation());
  return NULL;
}

TR::VPConstraint *TR::VPPreexistentObject::intersect1(
    TR::VPConstraint *other, OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  if (other->asArrayInfo())
    return TR::VPClass::create(vp, NULL, NULL, this, other->asArrayInfo(),
                               NULL);
  if (other->asObjectLocation())
    return TR::VPClass::create(vp, NULL, NULL, this, NULL,
                               other->asObjectLocation());
  return NULL;
}

TR::VPConstraint *TR::VPArrayInfo::intersect1(TR::VPConstraint *other,
                                              OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
...
TR::VPConstraint *TR::VPObjectLocation::intersect1(TR::VPConstraint *other,
                                                   OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
...
TR::VPConstraint *TR::VPSync::intersect1(TR::VPConstraint *other,
                                         OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
...
TR::VPConstraint *TR::VPMergedConstraints::intersect1(
    TR::VPConstraint *other, OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (_type.isInt16()) return shortIntersect(otherCur, otherNext, vp);
  if (_type.isInt32()) return intIntersect(otherCur, otherNext, vp);
  if (_type.isInt64()) return longIntersect(otherCur, otherNext, vp);
  ...
  if (otherCur) {
    ...
    while (cur && otherCur) {
      ...
      if (curHigh < otherLow)
        ...
        lastResultEntry =
            result.addAfter(TR::VPShortRange::create(vp, resultLow, resultHigh),
                            lastResultEntry);

        // Reduce the two current ranges. If either is exhausted, move to the
        // next
        //
        if (resultHigh == TR::getMaxSigned<TR::Int16>()) break;
        curLow = otherLow = resultHigh + 1;
        if (curLow > curHigh) skipCur = true;
        if (otherLow > otherHigh) skipOtherCur = true;
      }
    ...
    lastResultEntry = result.getListHead();
    if (!lastResultEntry) return NULL;
  ...
  if (otherCur) {
    ...
    while (cur && otherCur) {
      ...
      if (curHigh < otherLow)
        ...
        // next
        //
        if (resultHigh == TR::getMaxSigned<TR::Int32>()) break;
        curLow = otherLow = resultHigh + 1;
        if (curLow > curHigh) skipCur = true;
        if (otherLow > otherHigh) skipOtherCur = true;
      }
  ...
  if (otherCur) {
    ...
    while (cur && otherCur) {
      ...
      if (curHigh < otherLow)
        ...
        lastResultEntry =
            result.addAfter(TR::VPLongRange::create(vp, resultLow, resultHigh),
                            lastResultEntry);

        // Reduce the two current ranges. If either is exhausted, move to the
        // next
        //
        if (resultHigh == TR::getMaxSigned<TR::Int64>()) break;
        curLow = otherLow = resultHigh + 1;
        if (curLow > curHigh) skipCur = true;
        if (otherLow > otherHigh) skipOtherCur = true;
      }
...
TR::VPConstraint *TR::VPLessThanOrEqual::intersect1(TR::VPConstraint *other,
                                                    OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPNotEqual *otherNE = other->asNotEqual();
  if (otherNE) {
    if (otherNE->increment() != increment()) return this;
...
TR::VPConstraint *TR::VPGreaterThanOrEqual::intersect1(
    TR::VPConstraint *other, OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
...
TR::VPConstraint *TR::VPNotEqual::intersect1(TR::VPConstraint *other,
                                             OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);

  TR::VPNotEqual *otherNE = other->asNotEqual();
  if (otherNE) {
    if (otherNE->increment() == 0) return other;
    return this;
  }
  return NULL;
}

TR::VPConstraint *TR::VPEqual::intersect1(TR::VPConstraint *other,
                                          OMR::ValuePropagation *vp) {
  TRACER(vp, this, other);
  ...
  if (other->asLessThanOrEqual()) return this;
  if (other->asGreaterThanOrEqual()) return this;
  TR::VPEqual *otherEQ = other->asEqual();
  if (otherEQ) {
    if (otherEQ->increment() != increment()) return NULL;
    return this;
  }
  return NULL;
}
...
TR::VPConstraint *TR::VPConstraint::add(TR::VPConstraint *other,
                                        TR::DataType type,
                                        OMR::ValuePropagation *vp) {
  return NULL;
}

TR::VPConstraint *TR::VPConstraint::subtract(TR::VPConstraint *other,
                                             TR::DataType type,
                                             OMR::ValuePropagation *vp) {
  return NULL;
}

TR::VPConstraint *TR::VPShortConstraint::add(TR::VPConstraint *other,
                                             TR::DataType dt,
                                             OMR::ValuePropagation *vp) {
  TR::VPShortConstraint *otherShort = other->asShortConstraint();
  if (!otherShort) return NULL;

  TR::DataType type(dt);

  if (!type.isInt16()) return NULL;
...
TR::VPConstraint *TR::VPIntConstraint::add(TR::VPConstraint *other,
                                           TR::DataType dt,
                                           OMR::ValuePropagation *vp) {
...
TR::VPConstraint *TR::VPShortConstraint::subtract(TR::VPConstraint *other,
                                                  TR::DataType dt,
                                                  OMR::ValuePropagation *vp) {
  TR::VPShortConstraint *otherShort = other->asShortConstraint();
...
TR::VPConstraint *TR::VPIntConstraint::subtract(TR::VPConstraint *other,
                                                TR::DataType dt,
                                                OMR::ValuePropagation *vp) {
  TR::VPIntConstraint *otherInt = other->asIntConstraint();
  if (!otherInt) return NULL;
...
TR::VPConstraint *TR::VPShortConstraint::getRange(int16_t low, int16_t high,
                                                  bool lowCanOverflow,
  ...
  if (lowCanOverflow && highCanOverflow) {  // Both sides overflow
    ...
    TR::VPConstraint *range1 = TR::VPShortRange::create(
        vp, TR::getMinSigned<TR::Int16>(), high, TR_yes);
    TR::VPConstraint *range2 = TR::VPShortRange::create(
        vp, low, TR::getMaxSigned<TR::Int16>(), TR_yes);
...
TR::VPConstraint *TR::VPIntConstraint::getRange(int32_t low, int32_t high,
                                                bool lowCanOverflow,
                                                bool highCanOverflow,
                                                OMR::ValuePropagation *vp) {
  // This function returns a VP constraint range, with the appropriate setting
...
TR::VPConstraint *TR::VPLongConstraint::add(TR::VPConstraint *other,
                                            TR::DataType dt,
                                            OMR::ValuePropagation *vp) {
  // TODO - handle add and subtract for merged constraints
  //
  TR::VPLongConstraint *otherLong = other->asLongConstraint();
  if (!otherLong) return NULL;

  TR::DataType type(dt);
  if (!type.isInt64()) return NULL;
...
TR::VPConstraint *TR::VPLongConstraint::subtract(TR::VPConstraint *other,
                                                 TR::DataType dt,
                                                 OMR::ValuePropagation *vp) {
  TR::VPLongConstraint *otherLong = other->asLongConstraint();
  if (!otherLong) return NULL;
...
TR::VPConstraint *TR::VPLongConstraint::getRange(int64_t low, int64_t high,
                                                 bool lowCanOverflow,
                                                 bool highCanOverflow,
                                                 OMR::ValuePropagation *vp) {
  // This function returns a VP constraint range, with the appropriate setting
  ...
  if (lowCanOverflow && highCanOverflow) {  // Both sides overflow
    ...
    // disjoint merged constraint
    TR::VPConstraint *range1 = TR::VPLongRange::create(
        vp, TR::getMinSigned<TR::Int64>(), high, TR_yes);
    TR::VPConstraint *range2 =
...
bool TR::VPConstraint::mustBeEqual(TR::VPConstraint *other,
                                   OMR::ValuePropagation *vp) {
  return false;
}

bool TR::VPShortConst::mustBeEqual(TR::VPConstraint *other,
                                   OMR::ValuePropagation *vp) {
...
bool TR::VPIntConst::mustBeEqual(TR::VPConstraint *other,
                                 OMR::ValuePropagation *vp) {
...
bool TR::VPLongConst::mustBeEqual(TR::VPConstraint *other,
                                  OMR::ValuePropagation *vp) {
  TR::VPLongConst *otherConst = other->asLongConst();
  return otherConst && otherConst->getLong() == getLong();
}

bool TR::VPClass::mustBeEqual(TR::VPConstraint *other,
                              OMR::ValuePropagation *vp) {
  if (isNullObject() && other->isNullObject()) return true;
  ...
  if (other) otherClass = other->asClass();
...
bool TR::VPNullObject::mustBeEqual(TR::VPConstraint *other,
                                   OMR::ValuePropagation *vp) {
  return other->isNullObject();
}

bool TR::VPConstString::mustBeEqual(TR::VPConstraint *other,
                                    OMR::ValuePropagation *vp) {
...
bool TR::VPKnownObject::mustBeEqual(TR::VPConstraint *other,
                                    OMR::ValuePropagation *vp) {
...
bool TR::VPKnownObject::mustBeNotEqual(TR::VPConstraint *other,
                                       OMR::ValuePropagation *vp) {
...
bool TR::VPConstString::mustBeNotEqual(TR::VPConstraint *other,
                                       OMR::ValuePropagation *vp) {
  if (other->getKnownObject())
...
bool TR::VPConstraint::mustBeNotEqual(TR::VPConstraint *other,
                                      OMR::ValuePropagation *vp) {
  if (isNullObject()) {
    if (other->isNonNullObject()) return true;
  } else if (isNonNullObject()) {
    if (other->isNullObject()) return true;
  }
  return false;
}
bool TR::VPShortConstraint::mustBeNotEqual(TR::VPConstraint *other,
                                           OMR::ValuePropagation *vp) {
  TR::VPShortConstraint *otherShort = other->asShortConstraint();
  if (otherShort) {
  ...
  if (otherList) {
    ...
    for (TR::VPConstraint *c = iter.getFirst(); c; c = iter.getNext()) {
      if (!mustBeNotEqual(c, vp)) return false;
    }
    return true;
  }
  return false;
...
bool TR::VPIntConstraint::mustBeNotEqual(TR::VPConstraint *other,
                                         OMR::ValuePropagation *vp) {
  TR::VPIntConstraint *otherInt = other->asIntConstraint();
  if (otherInt) {
...
bool TR::VPLongConstraint::mustBeNotEqual(TR::VPConstraint *other,
                                          OMR::ValuePropagation *vp) {
  TR::VPLongConstraint *otherLong = other->asLongConstraint();
  if (otherLong)
...
bool TR::VPMergedConstraints::mustBeNotEqual(TR::VPConstraint *other,
                                             OMR::ValuePropagation *vp) {
  if (!other->asMergedConstraints()) return other->mustBeNotEqual(this, vp);

  // Every item in this list must be not equal to the other list
  //
  ListIterator<TR::VPConstraint> iter(getList());
  for (TR::VPConstraint *c = iter.getFirst(); c; c = iter.getNext()) {
    if (!c->mustBeNotEqual(other, vp)) return false;
  }
  return true;
}

// FIXME: this is too conservative, can do more for non-fixed objects
bool TR::VPClass::mustBeNotEqual(TR::VPConstraint *other,
                                 OMR::ValuePropagation *vp) {
  if (isNullObject() && other->isNonNullObject()) return true;
  if (isNonNullObject() && other->isNullObject()) return true;
...
bool TR::VPNullObject::mustBeNotEqual(TR::VPConstraint *other,
                                      OMR::ValuePropagation *vp) {
  return other->isNonNullObject();
}

bool TR::VPNonNullObject::mustBeNotEqual(TR::VPConstraint *other,
                                         OMR::ValuePropagation *vp) {
  return other->isNullObject();
}

bool TR::VPConstraint::mustBeLessThan(TR::VPConstraint *other,
                                      OMR::ValuePropagation *vp) {
  return false;
}

bool TR::VPShortConstraint::mustBeLessThan(TR::VPConstraint *other,
                                           OMR::ValuePropagation *vp) {
...
bool TR::VPIntConstraint::mustBeLessThan(TR::VPConstraint *other,
                                         OMR::ValuePropagation *vp) {
  if (isUnsigned() && other->isUnsigned())
...
bool TR::VPLongConstraint::mustBeLessThan(TR::VPConstraint *other,
                                          OMR::ValuePropagation *vp) {
  return getHigh() < other->getLowLong();
}

bool TR::VPMergedConstraints::mustBeLessThan(TR::VPConstraint *other,
                                             OMR::ValuePropagation *vp) {
  if (_type.isInt16()) {
  ...
  if (_type.isInt64()) return getHighLong() < other->getLowLong();
...
bool TR::VPConstraint::mustBeLessThanOrEqual(TR::VPConstraint *other,
                                             OMR::ValuePropagation *vp) {
  return false;
}

bool TR::VPShortConstraint::mustBeLessThanOrEqual(TR::VPConstraint *other,
                                                  OMR::ValuePropagation *vp) {
  if (isUnsigned() && other->isUnsigned())
    return ((uint16_t)getHigh() <= (uint16_t)other->getLowShort());
  return getHigh() <= other->getLowShort();
...
bool TR::VPIntConstraint::mustBeLessThanOrEqual(TR::VPConstraint *other,
                                                OMR::ValuePropagation *vp) {
  if (isUnsigned() && other->isUnsigned())
    return ((uint32_t)getHigh() <= (uint32_t)other->getLowInt());
  return getHigh() <= other->getLowInt();
...
bool TR::VPLongConstraint::mustBeLessThanOrEqual(TR::VPConstraint *other,
                                                 OMR::ValuePropagation *vp) {
  return getHigh() <= other->getLowLong();
}

bool TR::VPMergedConstraints::mustBeLessThanOrEqual(TR::VPConstraint *other,
                                                    OMR::ValuePropagation *vp) {
  if (_type.isInt64()) return getHighLong() <= other->getLowLong();
  if (_constraints.getLastElement()->getData()->isUnsigned())
    return ((uint32_t)getHighInt() <= (uint32_t)other->getLowInt());
...
bool TR::VPLessThanOrEqual::mustBeLessThan() {
  if ((increment() == 0) || hasArtificialIncrement()) return (increment() < 0);
  return false;
}
...
TR::VPConstraint *TR::VPLessThanOrEqual::propagateAbsoluteConstraint(
  ...
  //
  if (vp->trace()) {
    traceMsg(vp->comp(), "      Propagating V <= value %d %+d and V is ",
             relative, increment());
  ...
  if (constraint->asLongConstraint()) {
    ...
    if (newBound > oldBound) return NULL;
...
TR::VPConstraint *TR::VPNotEqual::propagateAbsoluteConstraint(
  ...
  if (constraint->asLongConst()) {
    ...
    if (excludedValue != TR::getMinSigned<TR::Int64>())
      newConstraint = TR::VPLongRange::create(vp, TR::getMinSigned<TR::Int64>(),
                                              excludedValue - 1);
    if (excludedValue != TR::getMaxSigned<TR::Int64>()) {
      if (newConstraint)
        newConstraint = newConstraint->merge(
            TR::VPLongRange::create(vp, excludedValue + 1,
                                    TR::getMaxSigned<TR::Int64>()),
            vp);
      else
        newConstraint = TR::VPLongRange::create(vp, excludedValue + 1,
                                                TR::getMaxSigned<TR::Int64>());
    }
    ...
    if (excludedValue != TR::getMinSigned<TR::Int32>())
      newConstraint = TR::VPIntRange::create(vp, TR::getMinSigned<TR::Int32>(),
                                             excludedValue - 1);
...
TR::VPConstraint *TR::VPLessThanOrEqual::propagateRelativeConstraint(
    TR::VPRelation *other, int32_t relative, int32_t otherRelative,
    OMR::ValuePropagation *vp) {
  // x <= y + M and x >= z + N    ==> y >= z + (N-M)
  //
  if (!other->asGreaterThanOrEqual() && !other->asEqual()) return NULL;
  ...
  // again
  if (newIncr == TR::getMinSigned<TR::Int32>()) return NULL;

  if (increment() >= 0) {
    if (newIncr > other->increment()) return NULL;
  } else {
    if (newIncr < other->increment()) return NULL;
  }
  ...
  if (newIncr == other->increment()) {
    ...
    if (hasArtificialIncrement()) constraint->setHasArtificialIncrement();
  }

  if (vp->trace()) {
    traceMsg(vp->comp(),
             "      Propagating V <= value %d %+d and V >= value %d %+d",
             relative, increment(), otherRelative, other->increment());
    traceMsg(vp->comp(), " ... value %d >= value %d %+d\n", relative,
             otherRelative, newIncr);
  }
  return constraint;
}
...
TR::VPConstraint *TR::VPGreaterThanOrEqual::propagateRelativeConstraint(
  ...
  // x >= y + M and x <= z + N    ==> y <= z + (N-M)
  //
  if (!other->asLessThanOrEqual() && !other->asEqual()) return NULL;
...
void TR::VPConstraint::print(TR::Compilation *comp, TR::FILE *outFile,
                             int32_t relative) {
  if (outFile == NULL) return;
  trfprintf(outFile, "unknown constraint relative to value number %d",
            relative);
}
...
void TR::VPClass::print(TR::Compilation *comp, TR::FILE *outFile) {
  if (outFile == NULL) return;
  if (_type) _type->print(comp, outFile);
  if (getKnownObject() && !isNonNullObject())
    trfprintf(outFile, " (maybe NULL)");
  if (_presence) _presence->print(comp, outFile);
  if (_arrayInfo) _arrayInfo->print(comp, outFile);
  if (_location) _location->print(comp, outFile);
}
...
#ifdef J9_PROJECT_SPECIFIC
  {
    ...
    if (vpConstStringPrintCriticalSection.hasVMAccess()) {
      ...
      for (int32_t i = 0; i < len; ++i)
        trfprintf(outFile, "%c",
                  TR::Compiler->cls.getStringCharacter(comp, string, i));
      trfprintf(outFile, "\" ");
    } else
...
void TR::VPUnresolvedClass::print(TR::Compilation *comp, TR::FILE *outFile) {
  ...
  trfprintf(outFile, "unresolved class %.*s in method %.*s", _len, _sig,
            methodLen, methodName);
}
...
void TR::VPMergedConstraints::print(TR::Compilation *comp, TR::FILE *outFile) {
  ...
  for (p = _constraints.getListHead(); p; p = p->getNextElement()) {
    ...
    if (p->getNextElement()) trfprintf(outFile, ", ");
  }
  trfprintf(outFile, "}");
}
...
void TR::VPSync::print(TR::Compilation *comp, TR::FILE *outFile) {
  if (outFile == NULL) return;
  trfprintf(outFile, "sync has %s been emitted",
...
TR::VPConstraint::Tracer::Tracer(OMR::ValuePropagation *vpArg,
                                 ...
                                 TR::VPConstraint *other, const char *name)
