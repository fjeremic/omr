...
template <typename T>
inline void setCCAddSigned(T value,
                           T operand1,
                           T operand2,
                           TR::Node* node,
                           TR::Simplifier* s) {
...
template <typename T>
inline void setCCAddUnsigned(T value,
                             T operand1,
                             TR::Node* node,
                             TR::Simplifier* s) {
...
template <typename T>
inline void setCCSubSigned(T value,
                           T operand1,
                           T operand2,
                           TR::Node* node,
                           TR::Simplifier* s) {
...
template <typename T>
inline void setCCSubUnsigned(T value,
                             T operand1,
                             TR::Node* node,
                             TR::Simplifier* s) {
...
static void convertToTestUnderMask(TR::Node* node,
                                   TR::Block* block,
                                   TR::Simplifier* s) {
...
template <typename T>
inline void foldConstant(TR::Node* node,
                         T value,
                         TR::Simplifier* s,
...
static TR::Node* addSimplifierCommon(TR::Node* node,
                                     TR::Block* block,
                                     TR::Simplifier* s) {
...
template <class T>
static TR::Node* addSimplifier(TR::Node* node,
                               TR::Block* block,
                               TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
// reliably
static void normalizeConstantShiftAmount(TR::Node* node,
                                         int32_t shiftMask,
                                         TR::Node*& secondChild,
                                         TR::Simplifier* s) {
  if (secondChild->getOpCode().isLoadConst()) {
...
static void normalizeShiftAmount(TR::Node* node,
...
static void orderChildrenByHighWordZero(TR::Node* node,
                                        TR::Node*& firstChild,
                                        TR::Node*& secondChild,
                                        TR::Simplifier* s) {
  if (!secondChild->getOpCode().isLoadConst() &&
...
static TR::Node* foldDemotionConversion(TR::Node* node,
                                        TR::ILOpCodes opcode,
...
//
static bool reduceLongOp(TR::Node* node,
                         TR::Block* block,
                         TR::Simplifier* s,
...
static void fold2SmallerIntConstant(TR::Node* node,
                                    TR::Node* child,
                                    TR::DataType sdt,
                                    TR::DataType tdt,
                                    TR::Simplifier* s) {
...
static TR::Node* intDemoteSimplifier(TR::Node* node,
                                     TR::Block* block,
                                     TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
static TR::SymbolReference* getUniqueSymRef(TR::Node* node,
                                            bool& isLegal,
...
// 2. TODO: for cmp,
static void partialRedundantCompareElimination(TR::Node* node,
                                               TR::Block* block,
                                               TR::Simplifier* s) {
  // return;
...
static void longCompareNarrower(TR::Node* node,
                                TR::Simplifier* s,
                                TR::ILOpCodes intOp,
                                TR::ILOpCodes charOp,
...
static void transformToLongDivBy10Bitwise(TR::Node* origNode,
                                          TR::Node* node,
                                          TR::Simplifier* s) {
...
static int decomposeConstant(char bitPosition[],
                             char operationType[],
                             int64_t value,
                             int wordSize) {
  int32_t count = 0;
...
static void printTree(TR::Simplifier* s,
                      char bitPosition[],
                      char operationType[],
                      int from,
                      int to,
...
static void addSimplifierJavaPacked(TR::Node* node,
                                    TR::Block* block,
                                    TR::Simplifier* s) {
  return;
}

static void foldAddressConstant(TR::Node* node,
                                int64_t value,
                                TR::Simplifier* s,
                                bool anchorChildrenP) {
  if (!performTransformationSimplifier(node, s))
...
//
TR::Node* getQuotientUsingMagicNumberMultiply(TR::Node* node,
                                              TR::Block* block,
                                              TR::Simplifier* s) {
  TR::Node *firstChild = node->getFirstChild(),
           *secondChild = node->getSecondChild();
 ...
 */
static void changeConverts2Unsigned(TR::Node* node,
...
static void simplifyIntBranchArithmetic(TR::Node* node,
                                        TR::Node*& firstChild,
                                        TR::Node*& secondChild,
                                        TR::Simplifier* s) {
...
static void simplifyLongBranchArithmetic(TR::Node* node,
                                         TR::Node*& firstChild,
                                         TR::Node*& secondChild,
                                         TR::Simplifier* s) {
...
//
static bool conditionalBranchFold(int32_t takeBranch,
                                  TR::Node*& node,
                                  TR::Node* firstChild,
                                  TR::Node* secondChild,
                                  TR::Block* block,
...
//
static TR::Node* binaryNanFloatOp(TR::Node* node,
                                  TR::Node* firstChild,
                                  TR::Node* secondChild,
                                  TR::Simplifier* s) {
...
// If either child is a NaN replace this node with that child.
//
static TR::Node* binaryNanDoubleOp(TR::Node* node,
                                   TR::Node* firstChild,
                                   TR::Node* secondChild,
                                   TR::Simplifier* s) {
...
static bool isLegalToMerge(TR::Node* node,
                           TR::Block* block,
                           TR::Block* nextBlock,
...
static void intCompareNarrower(TR::Node* node,
                               TR::Simplifier* s,
...
static void unsignedIntCompareNarrower(TR::Node* node,
                                       TR::Simplifier* s,
                                       TR::ILOpCodes ushortOp,
...
static bool containsLoad(TR::Node* node,
                         TR::SymbolReference* symRef,
                         vcount_t visitCount) {
...
static bool canMovePastTree(TR::TreeTop* tree,
                            TR::SymbolReference* symRef,
                            TR::Compilation* c,
...
static bool containsNode(TR::Node* tree,
                         TR::Node* searchNode,
                         vcount_t visitCount) {
  if (tree == searchNode)
    return true;
...
template <typename T>
static bool checkAndReplaceRotation(TR::Node* node,
                                    TR::Block* block,
                                    TR::Simplifier* s) {
...
// Table!
//
static TR::Node* longToFloatHelper(uint64_t absValue,
                                   bool isUnsignedOperation,
                                   TR::Node* node,
                                   TR::Simplifier* s) {
  TR::Node* firstChild = node->getFirstChild();
...
//
static TR::Node* longToDoubleHelper(uint64_t absValue,
                                    bool isUnsignedOperation,
                                    TR::Node* node,
                                    TR::Simplifier* s) {
  TR::Node* firstChild = node->getFirstChild();
...
static bool isOperationFPCompliant(TR::Node* parent,
...
//
static void bitwiseToLogical(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
...
TR::Node* lstoreSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  return node;
...
TR::Node* directLoadSimplifier(TR::Node* node,
                               TR::Block* block,
                               TR::Simplifier* s) {
...
TR::Node* indirectLoadSimplifier(TR::Node* node,
                                 TR::Block* block,
                                 TR::Simplifier* s) {
...
TR::Node* indirectStoreSimplifier(TR::Node* node,
                                  TR::Block* block,
                                  TR::Simplifier* s) {
...
TR::Node* astoreSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* directStoreSimplifier(TR::Node* node,
                                TR::Block* block,
                                TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* vsetelemSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
...
TR::Node* ifdCallSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* treetopSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
...
TR::Node* anchorSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lconstSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  setIsHighWordZero(node, s);
  return node;
...
TR::Node* ilfdabsSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
//    lconst 0xF0F0F0
//
TR::Node* removeRedundantIntegralOrPattern1(TR::Node* node,
                                            TR::Block* block,
                                            TR::Simplifier* s) {
...
//    iconst 0xF0F0F0F0
//
TR::Node* removeRedundantIntegralOrPattern2(TR::Node* node,
                                            TR::Block* block,
                                            TR::Simplifier* s) {
  TR::Node* parentOr = node;
  TR::Node* firstChild = parentOr->getFirstChild();
...
//
template <class T>
inline TR::Node* sqrtSimplifier(TR::Node* node,
                                TR::Block* block,
                                TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* ificmpeqSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* ificmpneSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* ificmpltSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* ificmpleSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* ificmpgtSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* ificmpgeSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* iflcmpeqSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* iflcmpneSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* iflcmpltSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* iflcmpleSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* iflcmpgtSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* iflcmpgeSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
  if (removeIfToFollowingBlock(node, block, s) == NULL)
...
TR::Node* normalizeCmpSimplifier(TR::Node* node,
                                 TR::Block* block,
                                 TR::Simplifier* s) {
  if (node->getOpCode().isBranch() &&
      (removeIfToFollowingBlock(node, block, s) == NULL))
...
TR::Node* ifacmpeqSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  if (removeIfToFollowingBlock(node, block, s) == NULL)
    return NULL;
...
//
TR::Node* ifacmpneSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  if (removeIfToFollowingBlock(node, block, s) == NULL)
    return NULL;
...
TR::Node* ifCmpWithEqualitySimplifier(TR::Node* node,
                                      TR::Block* block,
                                      TR::Simplifier* s) {
  if (removeIfToFollowingBlock(node, block, s) == NULL)
    return NULL;
...
TR::Node* ifCmpWithoutEqualitySimplifier(TR::Node* node,
                                         TR::Block* block,
                                         TR::Simplifier* s) {
  if (removeIfToFollowingBlock(node, block, s) == NULL)
    return NULL;
...
TR::Node* icmpeqSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* icmpneSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* icmpltSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* icmpleSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* icmpgtSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* icmpgeSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lcmpeqSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lcmpneSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lcmpltSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lcmpleSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lcmpgtSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lcmpgeSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lucmpltSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lucmpleSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lucmpgtSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lucmpgeSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* acmpeqSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* acmpneSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* bcmpeqSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* bcmpneSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* bcmpltSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* bcmpleSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* bcmpgtSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* bcmpgeSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* scmpeqSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* scmpneSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* scmpltSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* scmpleSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* scmpgtSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* scmpgeSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* sucmpeqSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* sucmpneSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* sucmpltSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* sucmpgeSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* sucmpgtSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* sucmpleSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* passThroughSimplifier(TR::Node* node,
                                TR::Block* block,
                                TR::Simplifier* s) {
...
TR::Node* endBlockSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
...
TR::Node* ternarySimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
//
TR::Node* switchSimplifier(TR::Node* node,
                           TR::Block* block,
                           bool isTableSwitch,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
static void foldUnsignedLongIntConstant(TR::Node* node,
                                        uint64_t value,
                                        TR::Simplifier* s,
                                        bool anchorChildrenP) {
  if (!performTransformationSimplifier(node, s))
...
static void foldUByteConstant(TR::Node* node,
                              uint8_t value,
                              TR::Simplifier* s,
                              bool anchorChildrenP) {
  if (!performTransformationSimplifier(node, s))
...
static void foldCharConstant(TR::Node* node,
                             uint16_t value,
                             TR::Simplifier* s,
                             bool anchorChildrenP) {
  if (!performTransformationSimplifier(node, s))
...
TR::Node* checkcastSimplifier(TR::Node* node,
                              TR::Block* block,
                              TR::Simplifier* s) {
...
TR::Node* checkcastAndNULLCHKSimplifier(TR::Node* node,
                                        TR::Block* block,
                                        TR::Simplifier* s) {
...
TR::Node* variableNewSimplifier(TR::Node* node,
                                TR::Block* block,
                                TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
//
TR::Node* ibits2fSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lbits2dSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* fbits2iSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* dbits2lSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* ifxcmpoSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  if (removeIfToFollowingBlock(node, block, s) == NULL)
    return NULL;
...
TR::Node* ifxcmnoSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  if (removeIfToFollowingBlock(node, block, s) == NULL)
    return NULL;
...
// Lookup switch
//
TR::Node* lookupSwitchSimplifier(TR::Node* node,
                                 TR::Block* block,
                                 TR::Simplifier* s) {
...
// Table switch
//
TR::Node* tableSwitchSimplifier(TR::Node* node,
                                TR::Block* block,
                                TR::Simplifier* s) {
...
// nullchk operator
//
TR::Node* nullchkSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
...
//
TR::Node* divchkSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
...
// Bound check
//
TR::Node* bndchkSimplifier(TR::Node* node,
                           TR::Block* block,
                           TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
//
TR::Node* arraycopybndchkSimplifier(TR::Node* node,
                                    TR::Block* block,
                                    TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
//
TR::Node* bndchkwithspinechkSimplifier(TR::Node* node,
                                       TR::Block* block,
                                       TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* imaxminSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lmaxminSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* fmaxminSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* dmaxminSimplifier(TR::Node* node,
                            TR::Block* block,
                            TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* computeCCSimplifier(TR::Node* node,
                              TR::Block* block,
                              TR::Simplifier* s) {
...
TR::Node* arraysetSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
//
TR::Node* bitOpMemSimplifier(TR::Node* node,
                             TR::Block* block,
                             TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
//
TR::Node* bitOpMemNDSimplifier(TR::Node* node,
                               TR::Block* block,
                               TR::Simplifier* s) {
  return node;
}
...
//
TR::Node* arrayCmpWithPadSimplifier(TR::Node* node,
                                    TR::Block* block,
                                    TR::Simplifier* s) {
  simplifyChildren(node, block, s);
...
TR::Node* lowerTreeSimplifier(TR::Node* node,
                              TR::Block* block,
                              TR::Simplifier* s) {
...
TR::Node* arrayLengthSimplifier(TR::Node* node,
                                TR::Block* block,
                                TR::Simplifier* s) {
  simplifyChildren(node, block, s);
