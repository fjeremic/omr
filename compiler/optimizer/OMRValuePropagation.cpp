...
void collectArraylengthNodes(TR::Node* node,
                             vcount_t visitCount,
...
void OMR::ValuePropagation::mergeRelationships(
    TR_LinkHead<Relationship>& fromList,
...
void OMR::ValuePropagation::printStructureInfo(TR_Structure* s,
                                               bool starting,
                                               bool lastTimeThrough) {
...
static TR::Node* addressSizedConst(TR::Compilation* comp,
                                   TR::Node* n,
                                   intptrj_t val) {
...
static void changeBranchToGoto(OMR::ValuePropagation* vp,
                               TR::Node* guardNode,
                               TR::Block* guard) {
...
void constrainRangeByPrecision(const int64_t low,
                               const int64_t high,
