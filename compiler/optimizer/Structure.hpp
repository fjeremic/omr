...
public:
  ...
  virtual TR_BlockStructure* asBlock()
  {
    return NULL;
  }
  virtual TR_RegionStructure* asRegion()
  {
    return NULL;
  }
  ...
  TR_RegionStructure* getParent()
  {
    return _parent;
  }
  TR_RegionStructure* setParent(TR_RegionStructure* b)
  {
    return (_parent = b);
  }

  TR_StructureSubGraphNode* getSubGraphNode()
  {
    return _graphNode;
  }
  void setSubGraphNode(TR_StructureSubGraphNode* node)
  {
    _graphNode = node;
  }
  ...
  void setAnalysisInfo(void* newInfo)
  {
    _analysisInfo = newInfo;
  }
  ...
  //
  virtual bool containsImproperRegion()
  {
    return _containsImproperRegion;
  }
  ...
  bool hasBeenAnalyzedBefore()
  {
    return _analyzedBefore;
  }
...
public:
  ...
  {
    return _block->isLoopInvariantBlock();
  }
  void setAsLoopInvariantBlock(bool b)
  {
    _block->setAsLoopInvariantBlock(b);
  }

  bool isCreatedByVersioning()
  {
    return _block->isCreatedByVersioning();
  }
  void setCreatedByVersioning(bool b)
  {
    _block->setCreatedByVersioning(b);
  }
  ...
  void setDuplicatedBlock(TR_BlockStructure* r)
  {
    _versionedStructure = r;
  }
...
public:
  ...
  TR::RegisterMappedSymbol* getLocal()
  {
    return _local;
  }
  void setLocal(TR::RegisterMappedSymbol* s)
  {
    _local = s;
  }
  TR::VPConstraint* getEntry()
  {
    return _entry;
  }
  TR::VPConstraint* getIncr()
  {
    return _incr;
  }
  TR::VPConstraint* getExit()
  {
    return _exit;
  }
  void setEntry(TR::VPConstraint* entry)
  {
    _entry = entry;
  }
  void setExit(TR::VPConstraint* exit)
  {
    _exit = exit;
  }
  void setIncr(TR::VPConstraint* incr)
  {
    _incr = incr;
  }
...
public:
  ...
  TR_StructureSubGraphNode* getEntry()
  {
    return _entryNode;
  }
  ...
  void setVersionedLoop(TR_RegionStructure* r)
  {
    _versionedStructure = r;
  }
  ...
  void clearInductionVariables()
  {
    _inductionVariables.setFirst(NULL);
  }
  TR_InductionVariable* findMatchingIV(TR::SymbolReference* symRef);

  TR_PrimaryInductionVariable* getPrimaryInductionVariable()
  {
    return _piv;
  }
  ...
  bool isInvertible()
  {
    return _regionFlags.testAny(_isInvertible);
  }
  void setAsInvertible(bool b)
  {
    _regionFlags.set(_isInvertible, b);
  }
  ...
  TR_BitVector* getInvariantExpressions()
  {
    return _invariantExpressions;
  }
  ...
  float getFrequencyEntryFactor()
  {
    return _frequencyEntryFactor;
  }
  void setFrequencyEntryFactor(float factor)
  {
    _frequencyEntryFactor = factor;
  }
...
public:
  ...
  SubNodeList::iterator begin()
  {
    return _subNodes.begin();
  }
  SubNodeList::iterator end()
  {
    return _subNodes.end();
  }
  ...
  public:
    ...
    TR_StructureSubGraphNode* getFirst()
    {
      return getCurrent();
    }
    void reset()
