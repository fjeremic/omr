...
public:
  ...
  virtual void addExternalEdge(TR_Structure* from,
                               int32_t toNumber,
...
toStructureSubGraphNode(TR::CFGNode* node)
{
#if DEBUG
...
public:
  ...
  TR_InductionVariable(TR::RegisterMappedSymbol* s,
                       TR::VPConstraint* entry,
                       TR::VPConstraint* exit,
...
public:
  ...
  //
  TR::CFGEdge* addExitEdge(TR_StructureSubGraphNode* from,
                           int32_t to,
