...
bool OMR::LocalCSE::shouldCopyPropagateNode(TR::Node* parent,
                                            TR::Node* node,
                                            int32_t childNum,
                                            TR::Node* storeNode) {
...
bool OMR::LocalCSE::isFirstReferenceToNode(TR::Node* parent,
                                           int32_t index,
                                           TR::Node* node,
                                           vcount_t visitCount) {
...
void OMR::LocalCSE::doCommoningIfAvailable(TR::Node* node,
                                           TR::Node* parent,
                                           int32_t childNum,
                                           bool& doneCommoning) {
...
bool OMR::LocalCSE::doCopyPropagationIfPossible(TR::Node* node,
                                                TR::Node* parent,
                                                int32_t childNum,
                                                TR::Node* storeNode,
                                                TR::SymbolReference* symRef,
...
//
void OMR::LocalCSE::commonNode(TR::Node* parent,
                               int32_t childNum,
                               TR::Node* node,
...
//
bool OMR::LocalCSE::areSyntacticallyEquivalent(TR::Node* node1,
                                               TR::Node* node2,
                                               bool* remove) {
