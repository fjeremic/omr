...
private:
  ...
  bool isLoadNodeSuitableForPropagation(TR::Node* useNode,
                                        TR::Node* storeNode,
                                        TR::Node* loadNode);
  ...
  bool isCorrectToPropagate(TR::Node*,
                            TR::Node*,
                            TR::list<TR::Node*>&,
                            TR::SparseBitVector&,
                            int32_t,
                            const TR_UseDefInfo::BitVector&,
                            TR_UseDefInfo*);
  bool isCorrectToReplace(TR::Node*,
                          TR::Node*,
                          const TR_UseDefInfo::BitVector&,
                          TR_UseDefInfo*);
  bool isRedefinedBetweenStoreTreeAnd(TR::list<TR::Node*>& checkNodes,
                                      ...
                                      const TR_UseDefInfo::BitVector&,
                                      TR_UseDefInfo*);
  bool recursive_isRedefinedBetweenStoreTreeAnd(TR::list<TR::Node*>& checkNodes,
                                                TR::SparseBitVector&,
                                                TR::Node* storeNode,
                                                TR::TreeTop* exitTree,
                                                int32_t regNumber,
  ...
  bool containsLoadOfSymbol(TR::Node* node,
  ...
  //
  void collectUseTrees(TR::TreeTop* tree,
                       TR::Node* node,
  ...
  typedef std::
    map<TR::Node*, TR::TreeTop*, StoreTreeMapComparator, StoreTreeMapAllocator>
      StoreTreeMap;
  ...
  typedef std::
    map<TR::Node*, TR::TreeTop*, UseTreeMapComparator, UseTreeMapAllocator>
      UseTreeMap;
