...
public:
  ...
  TR_TreeRefInfo* getDep()
  {
    return _dep;
  }
  TR_TreeRefInfo* getAnchor()
  {
    return _anchor;
  }
...
public:
  ...
  List<TR::Node>* getFirstRefNodesList()
  {
    return &_firstRefNodes;
  }
  List<TR::Node>* getMidRefNodesList()
  {
    return &_midRefNodes;
  }
  List<TR::Node>* getLastRefNodesList()
  {
    return &_lastRefNodes;
  }

  TR_BitVector* getDefSym()
  {
    return _defSym;
  }
  TR_BitVector* getUseSym()
  {
    return _useSym;
  }
  TR_BitVector* setDefSym(TR_BitVector* vec)
  {
    return _defSym = vec;
  }
  TR_BitVector* setUseSym(TR_BitVector* vec)
  {
    return _useSym = vec;
  }
  void resetSyms()
