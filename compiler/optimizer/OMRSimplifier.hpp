...
public:
  ...
  // of the change.
  //
  bool conditionalToUnconditional(TR::Node*& node,
                                  TR::Block* block,
                                  int takeBranch);
  ...
  void anchorOrderDependentNodesInSubtree(TR::Node* node,
                                          TR::Node* replacement,
   ...
   */
  virtual bool isLegalToUnaryCancel(TR::Node* node,
                                    TR::Node* firstChild,
                                    TR::ILOpCodes opcode)
  {
    return true;
   ...
   */
  virtual void setNodePrecisionIfNeeded(TR::Node* baseNode,
                                        TR::Node* node,
