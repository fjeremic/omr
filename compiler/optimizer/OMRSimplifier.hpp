...
public:
  ...
  TR_RegionStructure* containingStructure()
  {
    return _containingStructure;
  }
  bool reassociate()
  {
    return _reassociate;
   ...
   * NULL otherwise
   */
  virtual TR::Node* unaryCancelOutWithChild(
    TR::Node* node, TR::Node* firstChild, TR::TreeTop* anchorTree, TR::ILOpCodes opcode, bool anchorChildren = true);
