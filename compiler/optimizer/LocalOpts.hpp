...
public:
  ...
  int32_t performChecksAndTreesMovement(TR::Block*,
                                        TR::Block*,
                                        TR::Block*,
                                        TR::TreeTop*,
                                        vcount_t,
  ...
  TR::Block* breakFallThrough(TR::Block* faller,
                              TR::Block* fallee,
...
private:
  ...
  void renumberExitEdges(TR_RegionStructure* region,
                         int32_t oldN,
                         int32_t newN);
  void redirectPredecessors(TR::Block* block,
                            TR::Block* destBlock,
...
public:
  ...
  virtual int32_t performOnBlock(TR::Block*);
  int32_t process(TR::TreeTop*, TR::TreeTop*);
  void reduceArraysetStores(TR::Block*,
                            TR_BitVector*,
                            TR_BitVector*,
                            TR_BitVector*);
  bool optimizeArraysetIfPossible(TR::Node*,
                                  TR::Node*,
                                  TR::TreeTop*,
                                  TR::Node*,
                                  TR_BitVector*,
...
public:
  ...
  bool replacePassThroughIfPossible(TR::Node*,
                                    TR::Node*,
                                    TR::Node*,
                                    TR::Node*,
                                    bool*,
  ...
  bool replaceNullCheckIfPossible(TR::Node* cursorNode,
                                  TR::Node* objectRef,
                                  TR::Node* prevNode,
...
public:
  ...
  void findSymsUsedInIndirectAccesses(TR::Node*,
                                      List<TR::Node>*,
                                      List<List<TR::Node>>*);
  ...
  bool examineNode(TR::TreeTop*,
                   TR::Node*,
                   TR::Node*,
                   vcount_t,
                   TR_RematState*,
                   TR_RematAdjustments&);
  void rematerializeNode(TR::TreeTop*,
                         TR::Node*,
                         TR::Node*,
                         vcount_t,
                         List<TR::Node>*,
  ...
  void rematerializeAddresses(TR::Node* indirectNode,
                              TR::TreeTop* treeTop,
                              vcount_t visitCount);
  bool isRematerializable(TR::Node* parent,
                          TR::Node* node,
...
private:
  ...
  int32_t processNode(TR::Node* node,
                      int32_t blockIndex,
...
private:
  ...
  void processIndirectCall(TR::Node* node,
                           TR::TreeTop* treeTop,
                           vcount_t visitCount);
  void processIndirectLoad(TR::Node* node,
                           TR::TreeTop* treeTop,
                           vcount_t visitCount);
...
public:
  ...
  static void postProcessTreetop(TR::TreeTop* treeTop,
                                 ...
                                 char* optDetails,
                                 TR::Compilation* comp);
  static void processCommonedChild(TR::Node* child,
                                   TR::TreeTop* treeTop,
                                   List<TR::TreeTop>& commonedTreeTopList,
                                   char* optDetails,
                                   TR::Compilation* comp);
