...
TR::DataType TR_RegisterCandidate::getType() {
...
void TR_RegisterCandidate::removeAssignedCandidateFromLoop(
    ...
    TR_Structure* loop,
    int32_t regNum,
    TR_BitVector* liveOnEntryUsage,
    TR_BitVector* liveOnExitUsage,
    bool trace) {
  List<TR::Block> blocksInLoop(comp->trMemory());
  loop->getBlocks(&blocksInLoop);
  ListIterator<TR::Block> blocksIt(&blocksInLoop);
...
bool TR_RegisterCandidates::candidatesOverlap(
    ...
    TR_RegisterCandidate* candidateOnExit,
    bool trace) {
...
TR_RegisterCandidate* TR_RegisterCandidates::reprioritizeCandidates(
    ...
    TR::Compilation* comp,
    bool reprioritizeFP,
    bool onlyReprioritizeLongs,
    TR_BitVector* referencedBlocks,
    TR_Array<int32_t>& blockGPRCount,
    TR_Array<int32_t>& blockFPRCount,
    TR_Array<int32_t>& blockVRFCount,
    TR_BitVector* successorBits,
    bool trace) {
...
static void scanPressureSimulatorCacheForConflicts(
    ...
    TR_Array<TR_BitVector>& entryExitConflicts,
    int32_t firstRegister,
    int32_t lastRegister,
    TR_BitVector* spilledRegs,
    TR::Compilation* comp,
    TR::Block** all_blocks) {
