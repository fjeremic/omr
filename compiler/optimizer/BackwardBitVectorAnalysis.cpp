...
void
TR_BackwardDFSetAnalysis<Container*>::initializeDFSetAnalysis()
{
...
template<class Container>
bool
TR_BackwardDFSetAnalysis<Container*>::canGenAndKillForStructure(
...
template<class Container>
void
TR_BackwardDFSetAnalysis<Container*>::initializeGenAndKillSetInfoForBlock(
  TR_BlockStructure* s)
{
...
template<class Container>
void
TR_BackwardDFSetAnalysis<Container*>::initializeGenAndKillSetInfo(
...
template<class Container>
void
TR_BackwardDFSetAnalysis<Container*>::initializeGenAndKillSetInfoForRegion(
...
template<class Container>
bool
TR_BackwardDFSetAnalysis<Container*>::analyzeRegionStructure(
  TR_RegionStructure* regionStructure,
  bool checkForChange)
{
  typename TR_BasicDFSetAnalysis<Container*>::ExtraAnalysisInfo* analysisInfo =
  ...
  for (edge = ei.getCurrent(); edge != NULL; edge = ei.getNext()) {
    ...
    int32_t toStructureNumber = edge->getTo()->getNumber();
    Container* outBitVector =
      analysisInfo->getContainer(analysisInfo->_outSetInfo, toStructureNumber);
...
template<class Container>
bool
TR_BackwardDFSetAnalysis<Container*>::analyzeNodeIfSuccessorsAnalyzed(
  TR_RegionStructure* regionStructure,
  TR_BitVector& pendingList,
  TR_BitVector& exitNodes)
{
...
template<class Container>
bool
TR_BackwardDFSetAnalysis<Container*>::analyzeBlockStructure(
...
template<class Container>
void
TR_BackwardDFSetAnalysis<Container*>::analyzeNode(
  TR::Node* node,
  vcount_t visitCount,
  TR_BlockStructure* blockStructure,
...
template<class Container>
void
TR_BackwardDFSetAnalysis<Container*>::analyzeTreeTopsInBlockStructure(
  TR_BlockStructure* blockStructure)
{
  TR::Block* block = blockStructure->getBlock();
...
template<class Container>
void
TR_BackwardDFSetAnalysis<Container*>::compose(Container*, Container*)
{}

template<class Container>
TR_DataFlowAnalysis::Kind
TR_BackwardDFSetAnalysis<Container*>::getKind()
{
