...
class TR_LoopTransformer : public TR::Optimization {
 ...
 public:
  ...
  virtual bool examineTreeForInductionVariableUse(TR::Block *loopInvariantBlock,
                                                  ...
                                                  TR::SymbolReference **) {
    TR_ASSERT(0,
              "Should be overridden in the subclass that makes use of this "
              "function\n");
    return true;
  }
  ...
  TR_TransformerDefUseState getSymbolDefUseStateInSubTree(
      TR::Node *node, TR::RegisterMappedSymbol *indVarSym);
  TR_TransformerDefUseState getSymbolDefUseStateInBlock(
...
class TR_LoopCanonicalizer : public TR_LoopTransformer {
 ...
 protected:
  void eliminateRedundantInductionVariablesFromLoop(
