...
public:
  ...
  void initializeSymbolsWrittenAndReadExactlyOnce(
    int32_t symRefCount,
    TR_BitVectorGrowable growableOrNot)
  {
...
private:
  ...
  void collectSymbolsWrittenAndReadExactlyOnce(TR_Structure*,
                                               vcount_t,
                                               updateInfo_tables&);
...
public:
  ...
  TR::Node* containsOnlyInductionVariableAndAdditiveConstant(TR::Node*,
                                                             int32_t);
  bool isSymbolReferenceWrittenNumberOfTimesInStructure(TR_Structure*,
                                                        int32_t,
                                                        int32_t*,
                                                        int32_t);
                                                  ...
                                                  TR::SymbolReference**)
  {
    TR_ASSERT(
      0,
      "Should be overridden in the subclass that makes use of this function\n");
    return true;
  }
...
private:
  ...
  void findIncrements(TR::Node* currentNode,
                      vcount_t visitCount,
                      TR::SymbolReference* derivedInductionVar,
                      TR::SymbolReference* primaryInductionVar,
                      int64_t& derivedInductionVarIncrement,
...
public:
  ...
  bool checkIfSymbolIsReadInKnownTree(TR::Node*,
                                      int32_t,
                                      TR::TreeTop*,
                                      TR::NodeChecklist&);
};
