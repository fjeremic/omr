...
class TR_LoopReplicator : public TR_LoopTransformer {
 public:
  ...
  void gatherRestOfLoop(TR_RegionStructure* region,
                        TR::Block* b,
                        TR_Queue<TR::Block>& n);
  ...
  TR::Block* nextCandidate(TR::Block* X,
  ...
  TR::Block* bestSuccessor(TR_RegionStructure* r,
                           TR::Block* b,
                           TR::CFGEdge** edge);
  ...
  TR_StructureSubGraphNode* findNodeInHierarchy(TR_RegionStructure* r,
                                                int32_t num);
  void nextSuccessor(TR_RegionStructure* r,
                     TR::Block** cand,
                     TR::CFGEdge** edge);
  void fixUpLoopEntry(LoopInfo* lInfo, TR::Block* loopHeader);
  bool isBackEdgeOrLoopExit(TR::CFGEdge* e,
                            TR_RegionStructure* region,
  ...
  void gatherTargets(TR_Queue<TR::Block>& q,
                     TR_Queue<TR::Block>& sn,
                     LoopInfo* l);
