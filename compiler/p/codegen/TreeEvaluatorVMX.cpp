...
TR::Register* OMR::Power::TreeEvaluator::arraysetEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (constFill) {
    ...
    case 4: {
      uint64_t word = (uint64_t)(fillNode->getOpCodeValue() == TR::fconst ? fillNode->getFloatBits() & 0xffffffff
  ...
  if (dofastPath) {
    ...
    generateTrg1Src1ImmInstruction(
      cg, lenNode->getOpCode().isInt() ? TR::InstOpCode::cmpli4 : TR::InstOpCode::cmpli8, node, condReg, lenReg, 0);
    ...
    if (1 == fillNodeSize) {
      ...
      generateMemSrc1Instruction(
        cg, TR::InstOpCode::stb, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 0, 1, cg), fillReg);
    ...
    if (1 == fillNodeSize || 2 == fillNodeSize) {
      generateTrg1Src1ImmInstruction(
        cg, lenNode->getOpCode().isInt() ? TR::InstOpCode::cmpli4 : TR::InstOpCode::cmpli8, node, condReg, lenReg, 2);
      ...
      generateMemSrc1Instruction(
        cg, TR::InstOpCode::sth, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 0, 2, cg), fillReg);
    ...
    if (1 == fillNodeSize || 2 == fillNodeSize || 4 == fillNodeSize) {
      generateTrg1Src1ImmInstruction(
        cg, lenNode->getOpCode().isInt() ? TR::InstOpCode::cmpli4 : TR::InstOpCode::cmpli8, node, condReg, lenReg, 4);
      ...
      generateMemSrc1Instruction(
        cg, TR::InstOpCode::stw, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 0, 4, cg), fillReg);
    ...
    generateMemSrc1Instruction(
      cg, dblStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 0, 8, cg), dblFillReg);
    generateMemSrc1Instruction(
      cg, dblStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 8, 8, cg), dblFillReg);
    generateMemSrc1Instruction(
      cg, dblStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 16, 8, cg), dblFillReg);
    generateMemSrc1Instruction(
      cg, dblStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 24, 8, cg), dblFillReg);
    generateMemSrc1Instruction(
      cg, dblStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 32, 8, cg), dblFillReg);
    generateMemSrc1Instruction(
      cg, dblStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 40, 8, cg), dblFillReg);
    generateMemSrc1Instruction(
      cg, dblStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 48, 8, cg), dblFillReg);
    generateMemSrc1Instruction(
      cg, dblStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 56, 8, cg), dblFillReg);
  ...
  } else // regular word store path
  {
    ...
    generateLabelInstruction(cg, TR::InstOpCode::label, node, label3); // L3
    generateMemSrc1Instruction(
      cg, wdStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 0, 4, cg), fillReg);
    generateMemSrc1Instruction(
      cg, wdStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 4, 4, cg), fillReg);
    generateMemSrc1Instruction(
      cg, wdStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 8, 4, cg), fillReg);
    generateMemSrc1Instruction(
      cg, wdStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 12, 4, cg), fillReg);
    generateMemSrc1Instruction(
      cg, wdStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 16, 4, cg), fillReg);
    generateMemSrc1Instruction(
      cg, wdStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 20, 4, cg), fillReg);
    generateMemSrc1Instruction(
      cg, wdStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 24, 4, cg), fillReg);
    generateMemSrc1Instruction(
      cg, wdStoreOp, node, new (cg->trHeapMemory()) TR::MemoryReference(addrReg, 28, 4, cg), fillReg);
