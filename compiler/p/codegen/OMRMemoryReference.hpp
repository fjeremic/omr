...
public:
  ...
  TR::Register* getModBase()
  {
    return _modBase;
  }
  TR::Register* setModBase(TR::Register* r)
  {
    return (_modBase = r);
  }
  ...
  TR::PPCPairedRelocation* getStaticRelocation()
  {
    return _staticRelocation;
  }
