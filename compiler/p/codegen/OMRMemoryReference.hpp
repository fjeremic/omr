...
class OMR_EXTENSIBLE MemoryReference : public OMR::MemoryReference {
 ...
 public:
  ...
  void setOffsetRequiresWordAlignment(TR::Node* node,
                                      TR::CodeGenerator* cg,
  ...
  void accessStaticItem(TR::Node* node,
  ...
  void forceIndexedForm(TR::Node* node,
                        TR::CodeGenerator* cg,
  ...
  void consolidateRegisters(TR::Register* reg,
                            TR::Node* subTree,
                            bool m,
                            TR::CodeGenerator* cg);
  ...
  uint8_t* generateBinaryEncoding(TR::Instruction* ci,
                                  uint8_t* modRM,
                                  TR::CodeGenerator* cg);
};
}  // namespace Power
