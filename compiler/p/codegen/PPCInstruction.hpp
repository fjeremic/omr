...
public:
  PPCAlignmentNopInstruction(TR::InstOpCode::Mnemonic op,
                             TR::Node* n,
                             uint32_t alignment,
...
public:
  ...
  PPCImmInstruction(TR::InstOpCode::Mnemonic op,
                    TR::Node* n,
                    uint32_t imm,
                    TR::CodeGenerator* codeGen,
                    uint32_t bf = 0)
...
public:
  PPCImm2Instruction(TR::InstOpCode::Mnemonic op,
                     TR::Node* n,
                     uint32_t imm,
                     uint32_t imm2,
                     TR::CodeGenerator* codeGen)
...
public:
  PPCSrc1Instruction(TR::InstOpCode::Mnemonic op,
                     TR::Node* n,
                     TR::Register* sreg,
                     uint32_t imm,
                     TR::Instruction* precedingInstruction,
...
public:
  PPCLabelInstruction(TR::InstOpCode::Mnemonic op,
                      TR::Node* n,
                      TR::LabelSymbol* sym,
                      TR::CodeGenerator* codeGen)
    : TR::Instruction(op, n, codeGen)
...
public:
  PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op,
                                  TR::Node* n,
                                  TR::LabelSymbol* sym,
                                  TR::Register* cr,
                                  TR::CodeGenerator* codeGen,
...
public:
  PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op,
                                     TR::Node* n,
                                     TR::LabelSymbol* sym,
                                     TR::Register* cr,
                                     TR::RegisterDependencyConditions* cond,
  ...
  PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op,
                                     ...
                                     TR::CodeGenerator* codeGen,
                                     bool likeliness)
    : PPCConditionalBranchInstruction(op,
                                      n,
                                      sym,
                                      cr,
...
public:
  PPCAdminInstruction(TR::InstOpCode::Mnemonic op,
                      TR::Node* n,
                      TR::Node* fenceNode,
                      TR::CodeGenerator* codeGen)
    : TR::Instruction(op, n, codeGen)
...
public:
  PPCTrg1Instruction(TR::InstOpCode::Mnemonic op,
                     TR::Node* n,
                     TR::Register* reg,
                     TR::CodeGenerator* codeGen)
    : TR::Instruction(op, n, codeGen)
...
public:
  PPCTrg1ImmInstruction(TR::InstOpCode::Mnemonic op,
                        TR::Node* n,
                        TR::Register* treg,
                        uint32_t imm,
                        TR::CodeGenerator* codeGen)
...
public:
  PPCSrc2Instruction(TR::InstOpCode::Mnemonic op,
                     TR::Node* n,
                     TR::Register* s1reg,
                     TR::Register* s2reg,
                     TR::CodeGenerator* codeGen)
...
public:
  PPCTrg1Src1Instruction(TR::InstOpCode::Mnemonic op,
                         TR::Node* n,
                         TR::Register* treg,
                         TR::Register* sreg,
                         TR::CodeGenerator* codeGen);
...
public:
  PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op,
                            TR::Node* n,
                            TR::Register* treg,
                            TR::Register* sreg,
                            uintptrj_t imm,
    ...
    , _source1Immediate(imm)
  {
    ...
    cond->addPostCondition(
      cr0reg, TR::RealRegister::cr0, DefinesDependentRegister);
...
public:
  PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op,
                            TR::Node* n,
                            TR::CodeGenerator* codeGen,
...
public:
  ...
  PPCVirtualGuardNOPInstruction(TR::Node* node,
                                ...
                                TR::Instruction* precedingInstruction,
                                TR::CodeGenerator* codeGen)
    : PPCDepLabelInstruction(TR::InstOpCode::vgdnop,
                             node,
                             label,
                             cond,
                             precedingInstruction,
 ...
 *
 *************************************************************************/
inline TR::PPCImmInstruction*
toPPCImmInstruction(TR::Instruction* i)
{
#if defined(DEBUG) || defined(PROD_WITH_ASSUMES)
