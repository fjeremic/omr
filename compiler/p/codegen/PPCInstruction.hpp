...
public:
    ...
    PPCImmInstruction(
        TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm, TR::CodeGenerator* codeGen, uint32_t bf = 0)
        : TR::Instruction(op, n, codeGen)
...
public:
    PPCImm2Instruction(
        TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm, uint32_t imm2, TR::CodeGenerator* codeGen)
...
public:
    ...
    void insertShiftAmount(uint32_t* instruction)
    {
        ...
        {
            *instruction
                |= ((_source1Immediate & 0x1f) << TR::RealRegister::pos_SH) | ((_source1Immediate & 0x20) >> 4);
        } else {
...
public:
    ...
    PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
        TR::Register* cr0reg, uint32_t imm, uint64_t m, TR::Instruction* precedingInstruction,
        TR::CodeGenerator* codeGen)
