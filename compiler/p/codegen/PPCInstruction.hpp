...
class PPCAlignmentNopInstruction : public TR::Instruction {
  ...
  void setAlignment(uint32_t alignment) {
    TR_ASSERT_FATAL(
        (alignment % PPC_INSTRUCTION_LENGTH) == 0,
        "Alignment must be a multiple of the nop instruction length");
    _alignment = alignment != 0 ? alignment : PPC_INSTRUCTION_LENGTH;
  }

public:
  PPCAlignmentNopInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                             uint32_t alignment, TR::CodeGenerator *codeGen)
...
public:
  ...
  PPCImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
      ...
      : TR::Instruction(op, n, codeGen), _sourceImmediate(imm),
  ...
  PPCImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
                    TR_ExternalRelocationTargetKind relocationKind,
                    TR::SymbolReference *sr, TR::CodeGenerator *codeGen,
                    uint32_t bf = 0)
      : TR::Instruction(op, n, codeGen), _sourceImmediate(imm),
  ...
  void insertImmediateField(uint32_t *instruction) {
    if (getOpCode().useAlternateFormatx()) {
      ...
      TR_ASSERT(getOpCodeValue() == TR::InstOpCode::mtfsfi,
                "Wrong usage of U field");
...
public:
  PPCImm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
                     uint32_t imm2, TR::CodeGenerator *codeGen)
      : PPCImmInstruction(op, n, imm, codeGen), _sourceImmediate2(imm2) {}

  PPCImm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
                     uint32_t imm2, TR::Instruction *precedingInstruction,
                     TR::CodeGenerator *codeGen)
  ...
  void insertImmediateField2(uint32_t *instruction) {
    ...
    } else if (_sourceImmediate2 > 7 &&
               _sourceImmediate2 <= 15) // W = 0, BF = immediate-8
    {
...
public:
  PPCSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
  ...
  virtual void
  registersGoLive(TR::CodeGenerator::TR_RegisterPressureState *state) {
    state->addVirtualRegister(getSource1Register());
  }
  virtual void
  registersGoDead(TR::CodeGenerator::TR_RegisterPressureState *state) {
...
public:
  ...
  setDependencyConditions(TR::RegisterDependencyConditions *cond) {
...
public:
  PPCLabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                      TR::LabelSymbol *sym, TR::CodeGenerator *codeGen)
  ...
  virtual bool isPatchBarrier() {
    return getOpCodeValue() == TR::InstOpCode::label && _symbol &&
...
public:
  PPCDepLabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                         TR::LabelSymbol *sym,
                         TR::RegisterDependencyConditions *cond,
                         TR::CodeGenerator *codeGen)
...
public:
  PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
      ...
      : PPCLabelInstruction(op, n, sym, codeGen), _conditionRegister(cr),
        ...
        _exceptBranch(false), _haveHint(true), _likeliness(likeliness) {
    useRegister(cr);
  }
  ...
  PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
      ...
      : PPCLabelInstruction(op, n, sym, codeGen), _conditionRegister(cr),
        _estimatedBinaryLocation(0), _farRelocation(false),
        _exceptBranch(false), _haveHint(false), _likeliness(false) {
    useRegister(cr);
  }
  ...
  PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                                  ...
                                  TR::CodeGenerator *codeGen, bool likeliness)
      : PPCLabelInstruction(op, n, sym, precedingInstruction, codeGen),
        _conditionRegister(cr), _estimatedBinaryLocation(0),
        _exceptBranch(false), _farRelocation(false), _haveHint(true),
  ...
  PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
      ...
      : PPCLabelInstruction(op, n, sym, precedingInstruction, codeGen),
        _conditionRegister(cr), _estimatedBinaryLocation(0),
        _exceptBranch(false), _farRelocation(false), _haveHint(false),
        _likeliness(false) {
    useRegister(cr);
  }
...
class PPCDepConditionalBranchInstruction
    : public PPCConditionalBranchInstruction {
  TR::RegisterDependencyConditions *_conditions;

public:
  PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                                     TR::LabelSymbol *sym, TR::Register *cr,
                                     TR::RegisterDependencyConditions *cond,
                                     TR::CodeGenerator *codeGen,
                                     bool likeliness)
  ...
  PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                                     ...
                                     TR::CodeGenerator *codeGen,
                                     bool likeliness)
      : PPCConditionalBranchInstruction(op, n, sym, cr, precedingInstruction,
                                        codeGen, likeliness),
        _conditions(cond) {
    cond->bookKeepingRegisterUses(this, codeGen);
  }
...
public:
  PPCAdminInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                      TR::Node *fenceNode, TR::CodeGenerator *codeGen)
...
public:
  PPCDepImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n, uint32_t imm,
                       TR::RegisterDependencyConditions *cond,
                       TR::CodeGenerator *codeGen)
...
public:
  PPCDepImmSymInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                          uintptrj_t imm,
                          TR::RegisterDependencyConditions *cond,
                          TR::SymbolReference *sr, TR::Snippet *s,
                          TR::CodeGenerator *codeGen)
      : PPCDepInstruction(op, n, cond, codeGen), _addrImmediate(imm),
...
public:
  PPCTrg1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                     TR::Register *reg, TR::CodeGenerator *codeGen)
...
public:
  PPCTrg1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
...
public:
  PPCSrc2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                     TR::Register *s1reg, TR::Register *s2reg,
                     TR::CodeGenerator *codeGen)
      : TR::Instruction(op, n, codeGen), _source1Register(s1reg),
...
public:
  PPCTrg1Src1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
...
public:
  PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                            TR::Register *treg, TR::Register *sreg,
  ...
  PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                            ...
                            TR::Instruction *precedingInstruction,
                            TR::CodeGenerator *codeGen)
      : PPCTrg1Src1Instruction(op, n, treg, sreg, precedingInstruction,
                               codeGen),
        _source1Immediate(imm){};

  PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                            TR::Register *treg, TR::Register *sreg,
                            TR::Register *cr0reg, uintptrj_t imm,
                            TR::CodeGenerator *codeGen)
      : PPCTrg1Src1Instruction(op, n, treg, sreg, codeGen),
        _source1Immediate(imm) {
    TR::RegisterDependencyConditions *cond = new (codeGen->trHeapMemory())
        TR::RegisterDependencyConditions(0, 1, codeGen->trMemory());
    cond->addPostCondition(cr0reg, TR::RealRegister::cr0,
  ...
  void insertShiftAmount(uint32_t *instruction) {
    ...
    // The low order 5 bits of a long shift amount are in the shift field.  The
    // high order bit is in bit 30.
    {
...
public:
  PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                             TR::Register *treg, TR::Register *sreg,
                             uint32_t imm, uint64_t m,
                             TR::Instruction *precedingInstruction,
                             TR::CodeGenerator *codeGen)
      : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, imm, precedingInstruction,
                                  codeGen),
        _mask(m) {}
  ...
  PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                             ...
                             uint32_t imm, uint64_t m,
                             TR::CodeGenerator *codeGen)
      : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, imm, codeGen), _mask(m) {}

  PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                             TR::Register *treg, TR::Register *sreg,
                             TR::Register *cr0reg, uint32_t imm, uint64_t m,
                             TR::CodeGenerator *codeGen)
  ...
  PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                             ...
                             TR::Instruction *precedingInstruction,
                             TR::CodeGenerator *codeGen)
      : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, cr0reg, imm,
                                  precedingInstruction, codeGen),
        _mask(m) {}
...
public:
  PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
  ...
  PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                         ...
                         TR::Instruction *precedingInstruction,
                         TR::CodeGenerator *codeGen)
      : PPCTrg1Src1Instruction(op, n, treg, s1reg, precedingInstruction,
                               codeGen),
        _source2Register(s2reg) {
    useRegister(s2reg);
  }
  ...
  PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                         TR::Register *treg, TR::Register *s1reg,
                         TR::Register *s2reg, TR::Register *cr0reg,
                         TR::Instruction *precedingInstruction,
                         TR::CodeGenerator *codeGen)
      : PPCTrg1Src1Instruction(op, n, treg, s1reg, precedingInstruction,
                               codeGen),
...
public:
  PPCTrg1Src2ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                            TR::Register *treg, TR::Register *s1reg,
                            TR::Register *s2reg, int64_t m,
                            TR::CodeGenerator *codeGen)
      : PPCTrg1Src2Instruction(op, n, treg, s1reg, s2reg, codeGen), _mask(m) {}
  ...
  PPCTrg1Src2ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                            ...
                            TR::Instruction *precedingInstruction,
                            TR::CodeGenerator *codeGen)
      : PPCTrg1Src2Instruction(op, n, treg, s1reg, s2reg, precedingInstruction,
                               codeGen),
        _mask(m) {}
...
public:
  PPCTrg1Src3Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                         TR::Register *treg, TR::Register *s1reg,
...
public:
  PPCMemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
  ...
  virtual TR::Register *getSourceRegister(uint32_t i) {
    switch (i) {
    case 0:
      return (_memoryReference->getBaseRegister() == NULL)
                 ? _memoryReference->getIndexRegister()
...
public:
  PPCMemSrc1Instruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
...
public:
  PPCTrg1MemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                        TR::Register *treg, TR::MemoryReference *mf,
                        TR::CodeGenerator *codeGen,
                        int32_t hint = PPCOpProp_NoHint);
  ...
  virtual TR::Register *getTargetRegister(uint32_t i) {
    ...
    if ((i == 1) && isUpdate()) {
      ...
      if (getMemoryReference()->getConditions()) {
        return (
            getMemoryReference()->getConditions()->getTargetRegister(i, cg()));
      }
    }
    return NULL;
  }
...
// across basic block boundaries then we use PPCControlFlowInstruction as a
...
public:
  PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
      ...
      : TR::Instruction(op, n, codeGen), _numSources(0), _numTargets(0),
        _label(NULL), _opCode2(TR::InstOpCode::bad), _conditions(deps),
  ...
  PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                            ...
                            bool useRegPairForResult = false,
                            bool useRegPairForCond = false)
      : TR::Instruction(op, n, preceedingInstruction, codeGen), _numSources(0),
        _numTargets(0), _label(NULL), _opCode2(TR::InstOpCode::bad),
...
public:
  PPCVirtualGuardNOPInstruction(TR::Node *node, TR_VirtualGuardSite *site,
                                TR::RegisterDependencyConditions *cond,
                                TR::LabelSymbol *label,
                                TR::CodeGenerator *codeGen)
      : PPCDepLabelInstruction(TR::InstOpCode::vgdnop, node, label, cond,
                               codeGen),
        _site(site) {}
...
#if defined(DEBUG) || defined(PROD_WITH_ASSUMES)
  TR_ASSERT(i->getPPCImmInstruction() != NULL,
            "trying to downcast to an PPCImmInstruction");
#endif
