...
class PPCSrc1Instruction : public PPCImmInstruction {
 ...
 public:
  ...
  virtual TR::Register *getSourceRegister(uint32_t i) {
    if (i == 0) return _source1Register;
    return NULL;
  }
  ...
  virtual void registersGoLive(
      TR::CodeGenerator::TR_RegisterPressureState *state) {
    state->addVirtualRegister(getSource1Register());
  }
  virtual void registersGoDead(
      TR::CodeGenerator::TR_RegisterPressureState *state) {
...
class PPCDepInstruction : public TR::Instruction {
 ...
 public:
  ...
  TR::RegisterDependencyConditions *setDependencyConditions(
      TR::RegisterDependencyConditions *cond) {
...
class PPCConditionalBranchInstruction : public PPCLabelInstruction {
 ...
 public:
  ...
  virtual TR::Register *getSourceRegister(uint32_t i) {
    if (i == 0) return _conditionRegister;
    return NULL;
  }
...
class PPCTrg1Instruction : public TR::Instruction {
 ...
 public:
  ...
  virtual TR::Register *getTargetRegister(uint32_t i) {
    if (i == 0) return _target1Register;
    return NULL;
  }
...
class PPCControlFlowInstruction : public TR::Instruction {
 ...
 public:
  ...
  virtual TR::Register *getSourceRegister(uint32_t i) {
    if (i >= _numSources || _isSourceImmediate[i]) return NULL;
  ...
  virtual uint32_t getSourceImmediate(uint32_t i) {
    if (i >= _numSources || !_isSourceImmediate[i]) return 0;
  ...
  TR::LabelSymbol *setLabelSymbol(TR::LabelSymbol *sym) {
    _label = sym;
    if (sym) sym->setDirectlyTargeted();
    return sym;
  }
