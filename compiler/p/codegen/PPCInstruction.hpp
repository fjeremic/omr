...
public:
  ...
  PPCImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm,
    TR_ExternalRelocationTargetKind relocationKind, TR::CodeGenerator* codeGen, uint32_t bf = 0)
    : TR::Instruction(op, n, codeGen)
    , _sourceImmediate(imm)
  ...
  PPCImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm,
    TR_ExternalRelocationTargetKind relocationKind, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen,
    uint32_t bf = 0)
    : TR::Instruction(op, n, precedingInstruction, codeGen)
    , _sourceImmediate(imm)
    , _reloKind(relocationKind)
  ...
  PPCImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm,
    TR_ExternalRelocationTargetKind relocationKind, TR::SymbolReference* sr, TR::CodeGenerator* codeGen,
    uint32_t bf = 0)
    : TR::Instruction(op, n, codeGen)
    , _sourceImmediate(imm)
    , _reloKind(relocationKind)
  ...
  void insertMaskField(uint32_t* instruction)
  {
    ...
    TR_ASSERT(getOpCodeValue() == TR::InstOpCode::mtfsf || getOpCodeValue() == TR::InstOpCode::mtfsfl
        || getOpCodeValue() == TR::InstOpCode::mtfsfw,
      "Wrong usage of FLM field");
...
public:
  PPCImm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm, uint32_t imm2, TR::CodeGenerator* codeGen)
    : PPCImmInstruction(op, n, imm, codeGen)
  ...
  uint32_t getSourceImmediate2()
  {
    return _sourceImmediate2;
  }
  uint32_t setSourceImmediate2(uint32_t si)
  {
    return (_sourceImmediate2 = si);
  }
...
public:
  ...
  PPCSrc1Instruction(
    TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* sreg, uint32_t imm, TR::CodeGenerator* codeGen)
    : PPCImmInstruction(op, n, imm, codeGen)
    , _source1Register(sreg)
  {
    useRegister(sreg);
  ...
  TR::Register* setSource1Register(TR::Register* sr)
  {
    return (_source1Register = sr);
  }
...
public:
  PPCDepInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* n, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* codeGen)
    : TR::Instruction(op, n, codeGen)
    , _conditions(cond)
  {
...
public:
  ...
  {
    return getOpCodeValue() == TR::InstOpCode::label && _symbol && _symbol->isTargeted() != TR_no;
  }
...
public:
  ...
  PPCDepLabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym,
    TR::RegisterDependencyConditions* cond, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
...
public:
  PPCConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* cr,
    TR::CodeGenerator* codeGen, bool likeliness)
    : PPCLabelInstruction(op, n, sym, codeGen)
  ...
  PPCConditionalBranchInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* cr, TR::CodeGenerator* codeGen)
    : PPCLabelInstruction(op, n, sym, codeGen)
    , _conditionRegister(cr)
    , _estimatedBinaryLocation(0)
    , _farRelocation(false)
  ...
  TR::Register* getConditionRegister()
  {
    return _conditionRegister;
  }
  TR::Register* setConditionRegister(TR::Register* cr)
  {
    return (_conditionRegister = cr);
  }
  ...
  bool reverseLikeliness()
  {
    return (_likeliness = !_likeliness);
  }
  bool getLikeliness()
  {
    return _likeliness;
  ...
  bool isExceptBranchOp()
  {
    return _exceptBranch;
  }
  bool setExceptBranchOp()
  {
    return _exceptBranch = true;
  }
...
public:
  PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* cr,
    ...
    : PPCConditionalBranchInstruction(op, n, sym, cr, codeGen, likeliness)
    , _conditions(cond)
  {
    cond->bookKeepingRegisterUses(this, codeGen);
  }
  ...
  PPCDepConditionalBranchInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::LabelSymbol* sym, TR::Register* cr,
    TR::RegisterDependencyConditions* cond, TR::CodeGenerator* codeGen)
    : PPCConditionalBranchInstruction(op, n, sym, cr, codeGen)
    , _conditions(cond)
  {
    cond->bookKeepingRegisterUses(this, codeGen);
  }
...
public:
  ...
  bool isDebugFence()
  {
    return (_fenceNode != NULL && _fenceNode->getOpCodeValue() == TR::dbgFence);
  }
...
public:
  PPCDepImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uint32_t imm, TR::RegisterDependencyConditions* cond,
    TR::CodeGenerator* codeGen)
    : PPCDepInstruction(op, n, cond, codeGen)
    , _sourceImmediate(imm)
  {}
...
public:
  PPCDepImmSymInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, uintptrj_t imm,
    TR::RegisterDependencyConditions* cond, TR::SymbolReference* sr, TR::Snippet* s, TR::CodeGenerator* codeGen)
    : PPCDepInstruction(op, n, cond, codeGen)
    , _addrImmediate(imm)
    , _symbolReference(sr)
    , _snippet(s)
...
public:
  ...
  PPCTrg1Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* reg, TR::Instruction* precedingInstruction,
    TR::CodeGenerator* codeGen)
    : TR::Instruction(op, n, precedingInstruction, codeGen)
    , _target1Register(reg)
  {
  ...
  {
    return (_target1Register = r);
  }

  TR::Register* getPrimaryTargetRegister()
  {
    return _target1Register;
  }
...
public:
  PPCTrg1ImmInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, uint32_t imm, TR::CodeGenerator* codeGen)
    : PPCTrg1Instruction(op, n, treg, codeGen)
    , _sourceImmediate(imm) {};

  PPCTrg1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, uint32_t imm,
    TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
    : PPCTrg1Instruction(op, n, treg, precedingInstruction, codeGen)
    , _sourceImmediate(imm) {};
  ...
  void insertImmediateField(uint32_t* instruction)
  {
    if (!isVMX()) {
      ...
      } else if (getOpCodeValue() == TR::InstOpCode::setb || getOpCodeValue() == TR::InstOpCode::mcrfs) {
...
public:
  PPCSrc2Instruction(
    TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* s1reg, TR::Register* s2reg, TR::CodeGenerator* codeGen)
    : TR::Instruction(op, n, codeGen)
  ...
  TR::Register* setSource2Register(TR::Register* sr)
  {
    return (_source2Register = sr);
  }
  virtual TR::Register* getSourceRegister(uint32_t i)
  {
    if (i == 0)
...
public:
  PPCTrg1Src1Instruction(
    TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* codeGen);
...
public:
  PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
    uintptrj_t imm, TR::CodeGenerator* codeGen)
    : PPCTrg1Src1Instruction(op, n, treg, sreg, codeGen)
    , _source1Immediate(imm) {};

  PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
    uintptrj_t imm, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
    : PPCTrg1Src1Instruction(op, n, treg, sreg, precedingInstruction, codeGen)
    , _source1Immediate(imm) {};

  PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
    TR::Register* cr0reg, uintptrj_t imm, TR::CodeGenerator* codeGen)
    : PPCTrg1Src1Instruction(op, n, treg, sreg, codeGen)
    , _source1Immediate(imm)
  {
    TR::RegisterDependencyConditions* cond
      = new (codeGen->trHeapMemory()) TR::RegisterDependencyConditions(0, 1, codeGen->trMemory());
  ...
  PPCTrg1Src1ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
    TR::Register* cr0reg, uintptrj_t imm, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
    : PPCTrg1Src1Instruction(op, n, treg, sreg, precedingInstruction, codeGen)
    , _source1Immediate(imm)
  {
    TR::RegisterDependencyConditions* cond
  ...
  virtual Kind getKind()
  {
    return IsTrg1Src1Imm;
  }

  uint32_t getSourceImmediate()
  {
    return (uint32_t)_source1Immediate;
  }
  uint32_t setSourceImmediate(uint32_t si)
  {
    return (_source1Immediate = si);
  }

  uintptrj_t getSourceImmPtr()
  {
    return _source1Immediate;
  }
  ...
  void insertShiftAmount(uint32_t* instruction)
  {
    ...
    // is in bit 30.
    {
      *instruction |= ((_source1Immediate & 0x1f) << TR::RealRegister::pos_SH) | ((_source1Immediate & 0x20) >> 4);
    } else {
...
public:
  PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
    uint32_t imm, uint64_t m, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
    : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, imm, precedingInstruction, codeGen)
    , _mask(m)
  {}

  PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
    uint32_t imm, uint64_t m, TR::CodeGenerator* codeGen)
    : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, imm, codeGen)
    , _mask(m)
  {}

  PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
    TR::Register* cr0reg, uint32_t imm, uint64_t m, TR::CodeGenerator* codeGen)
    : PPCTrg1Src1ImmInstruction(op, n, treg, sreg, cr0reg, imm, codeGen)
    , _mask(m)
  {}

  PPCTrg1Src1Imm2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* sreg,
    TR::Register* cr0reg, uint32_t imm, uint64_t m, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
  ...
  virtual Kind getKind()
  {
    return IsTrg1Src1Imm2;
  }

  int32_t getMask()
  {
    return (_mask & 0xffffffff);
  }
  int32_t setMask(uint32_t mi)
  {
    return (int32_t)(_mask = (uint64_t)mi);
  }
  int64_t getLongMask()
  {
    return _mask;
  }
  int64_t setLongMask(uint64_t mi)
  {
    return _mask = mi;
  }
...
public:
  PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
    ...
    : PPCTrg1Src1Instruction(op, n, treg, s1reg, codeGen)
    , _source2Register(s2reg)
  {
    useRegister(s2reg);
  }
  ...
  PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
    TR::Register* s2reg, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
  ...
  PPCTrg1Src2Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
    TR::Register* s2reg, TR::Register* cr0reg, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
    : PPCTrg1Src1Instruction(op, n, treg, s1reg, precedingInstruction, codeGen)
    , _source2Register(s2reg)
  {
    useRegister(s2reg);
...
public:
  PPCTrg1Src2ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
    TR::Register* s2reg, int64_t m, TR::CodeGenerator* codeGen)
    : PPCTrg1Src2Instruction(op, n, treg, s1reg, s2reg, codeGen)
    , _mask(m)
  {}

  PPCTrg1Src2ImmInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
    TR::Register* s2reg, int64_t m, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
  ...
  int32_t setMask(uint32_t mi)
  {
    return (uint32_t)(_mask = (uint64_t)mi);
  }
  int64_t getLongMask()
  {
    return _mask;
...
public:
  PPCTrg1Src3Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
    TR::Register* s2reg, TR::Register* s3reg, TR::CodeGenerator* codeGen)
    : PPCTrg1Src2Instruction(op, n, treg, s1reg, s2reg, codeGen)
  ...
  PPCTrg1Src3Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Register* treg, TR::Register* s1reg,
    TR::Register* s2reg, TR::Register* s3reg, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
    : PPCTrg1Src2Instruction(op, n, treg, s1reg, s2reg, precedingInstruction, codeGen)
    , _source3Register(s3reg)
  {
    useRegister(s3reg);
  ...
  TR::Register* getSource3Register()
  {
    return _source3Register;
  }
  TR::Register* setSource3Register(TR::Register* sr)
  {
    return (_source3Register = sr);
  }
...
public:
  ...
  virtual TR::Register* getMemoryBase()
  {
    return getMemoryReference()->getBaseRegister();
  }
  virtual TR::Register* getMemoryIndex()
  {
    return getMemoryReference()->getIndexRegister();
  }
  virtual int32_t getOffset()
  {
    return getMemoryReference()->getOffset(*TR::comp());
  }
...
public:
  PPCMemSrc1Instruction(
    TR::InstOpCode::Mnemonic op, TR::Node* n, TR::MemoryReference* mf, TR::Register* sreg, TR::CodeGenerator* codeGen);
...
public:
  ...
  bool haveHint()
  {
    return getHint() != PPCOpProp_NoHint;
  };
  int32_t getHint()
  {
    return _hint;
...
public:
  PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::CodeGenerator* codeGen,
  ...
  {
    if (deps != NULL)
      deps->bookKeepingRegisterUses(this, codeGen);
  }
  PPCControlFlowInstruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::Instruction* preceedingInstruction,
    TR::CodeGenerator* codeGen, TR::RegisterDependencyConditions* deps = NULL, bool useRegPairForResult = false,
  ...
  {
    return _useRegPairForResult;
  }
  bool useRegPairForCond()
  {
    return _useRegPairForCond;
  }
  virtual Kind getKind()
  {
  ...
  bool isSourceImmediate(uint32_t i)
  {
    return _isSourceImmediate[i];
  }
  virtual TR::Register* getSourceRegister(uint32_t i)
  {
  ...
  TR::InstOpCode& getOpCode2()
  {
    return _opCode2;
  }
  TR::InstOpCode::Mnemonic getOpCode2Value()
  {
    return _opCode2.getOpCodeValue();
  }
  TR::InstOpCode::Mnemonic setOpCode2Value(TR::InstOpCode::Mnemonic op)
  {
    return (_opCode2.setOpCodeValue(op));
  }

  TR::InstOpCode& getOpCode3()
  {
    return _opCode3;
  }
  TR::InstOpCode::Mnemonic getOpCode3Value()
  {
    return _opCode3.getOpCodeValue();
  }
  TR::InstOpCode::Mnemonic setOpCode3Value(TR::InstOpCode::Mnemonic op)
  {
    return (_opCode3.setOpCodeValue(op));
  }

  TR::InstOpCode& getCmpOp()
  {
    return _cmpOp;
  }
  TR::InstOpCode::Mnemonic getCmpOpValue()
  {
    return _cmpOp.getOpCodeValue();
  }
  TR::InstOpCode::Mnemonic setCmpOpValue(TR::InstOpCode::Mnemonic op)
  {
...
public:
  PPCVirtualGuardNOPInstruction(TR::Node* node, TR_VirtualGuardSite* site, TR::RegisterDependencyConditions* cond,
    TR::LabelSymbol* label, TR::CodeGenerator* codeGen)
    : PPCDepLabelInstruction(TR::InstOpCode::vgdnop, node, label, cond, codeGen)
    , _site(site)
  {}

  PPCVirtualGuardNOPInstruction(TR::Node* node, TR_VirtualGuardSite* site, TR::RegisterDependencyConditions* cond,
    TR::LabelSymbol* label, TR::Instruction* precedingInstruction, TR::CodeGenerator* codeGen)
    : PPCDepLabelInstruction(TR::InstOpCode::vgdnop, node, label, cond, precedingInstruction, codeGen)
    , _site(site)
  {}
