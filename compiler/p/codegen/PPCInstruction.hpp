...
public:
    ...
    void insertMaskField(uint32_t* instruction)
    {
        ...
        TR_ASSERT(getOpCodeValue() == TR::InstOpCode::mtfsf || getOpCodeValue() == TR::InstOpCode::mtfsfl || getOpCodeValue() == TR::InstOpCode::mtfsfw, "Wrong usage of FLM field");
...
public:
    ...
    void insertSource1Register(uint32_t* instruction)
    {
        ...
        if (getOpCode().useAlternateFormatx()) {
            TR_ASSERT(getOpCodeValue() == TR::InstOpCode::mtfsf || getOpCodeValue() == TR::InstOpCode::mtfsfl || getOpCodeValue() == TR::InstOpCode::mtfsfw, "Wrong usage of AltFormatx");
...
public:
    ...
    virtual TR::Register* getSourceRegister(uint32_t i)
    {
        switch (i) {
        case 0:
            return (_memoryReference->getBaseRegister() == NULL) ? _memoryReference->getIndexRegister() : _memoryReference->getBaseRegister();
        case 1:
