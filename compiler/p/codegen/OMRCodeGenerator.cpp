...
void OMR::Power::CodeGenerator::apply16BitLoadLabelRelativeRelocation(
    TR::Instruction* liInstruction,
    TR::LabelSymbol* startLabel,
    TR::LabelSymbol* endLabel,
    int32_t deltaToStartLabel) {
...
void OMR::Power::CodeGenerator::apply64BitLoadLabelRelativeRelocation(
    TR::Instruction* lastInstruction,
    TR::LabelSymbol* label) {
...
bool OMR::Power::CodeGenerator::doRematerialization() {
  return true;
}
...
TR::Register* addConstantToLong(TR::Node* node,
                                TR::Register* srcReg,
                                int64_t value,
                                TR::Register* trgReg,
                                TR::CodeGenerator* cg) {
...
TR::Register* addConstantToInteger(TR::Node* node,
                                   TR::Register* trgReg,
                                   TR::Register* srcReg,
                                   int32_t value,
                                   TR::CodeGenerator* cg) {
