...
public:
  ...
  uint8_t getCcrFieldIndex()
  {
    return ccrFieldIndex;
  }
  uint8_t setCcrFieldIndex(uint8_t cfi)
  {
    return (ccrFieldIndex = cfi);
  }
  TR_BackingStore* getOriginal()
  {
    return original;
  }
  TR_BackingStore* setOriginal(TR_BackingStore* o)
  {
    return (original = o);
  }
};
