...
public:
  ...
  TR::InstOpCode& getOpCode()
  {
    return _opcode;
  }
  TR::InstOpCode::Mnemonic getOpCodeValue()
  {
    return _opcode.getOpCodeValue();
  }
  TR::InstOpCode::Mnemonic getRecordFormOpCode()
  {
    return _opcode.getRecordFormOpCodeValue();
  }
  TR::InstOpCode::Mnemonic setOpCodeValue(TR::InstOpCode::Mnemonic op)
  {
    return _opcode.setOpCodeValue(op);
  }

  void remove();

  virtual TR::Register* getTrg1Register()
  {
    return NULL;
  }
  ...
  virtual uint32_t getSourceImmediate()
  {
    return 0;
  }
  ...
  virtual bool usesCountRegister()
  {
    return _opcode.usesCountRegister();
  }
  ...
  bool isRecordForm()
  {
    return _opcode.isRecordForm();
  }
  bool hasRecordForm()
  {
    return _opcode.hasRecordForm();
  }
  bool singleFPOp()
  {
    return _opcode.singleFPOp();
  }
  bool doubleFPOp()
  {
    return _opcode.doubleFPOp();
  }
  bool gprOp()
  {
    return _opcode.gprOp();
  }
  bool fprOp()
  {
    return _opcode.fprOp();
  }
  bool useAlternateFormat()
  {
    return _opcode.useAlternateFormat();
  }
  bool useAlternateFormatx()
  {
    return _opcode.useAlternateFormatx();
  }
  bool readsCarryFlag()
  {
    return _opcode.readsCarryFlag();
  }
  bool setsCarryFlag()
  {
    return _opcode.setsCarryFlag();
  }
  bool setsOverflowFlag()
  {
    return _opcode.setsOverflowFlag();
  }
  bool isUpdate()
  {
    return _opcode.isUpdate();
  }
  bool isTrap()
  {
    return _opcode.isTrap();
  }
  bool isTMAbort()
  {
    return _opcode.isTMAbort();
  }
  bool isRegCopy()
  {
    return _opcode.isRegCopy();
  }
  bool isDoubleWord()
  {
    return _opcode.isDoubleWord();
  }
  bool isRotateOrShift()
  {
    return _opcode.isRotateOrShift();
  }
  bool isCompare()
  {
    return _opcode.isCompare();
  }
  bool isLongRunningFPOp()
  {
    return _opcode.isLongRunningFPOp();
  }
  bool isFXMult()
  {
    return _opcode.isFXMult();
  }
  bool isCRLogical()
  {
    return _opcode.isCRLogical();
  }

  virtual bool isLoad()
  {
    return _opcode.isLoad();
  }
  virtual bool isStore()
  {
    return _opcode.isStore();
  }
  virtual bool isBranchOp()
  {
    return _opcode.isBranchOp();
  }
  virtual bool isExceptBranchOp()
  {
    return false;
  }
  ...
  {
    return _opcode.getOpCodeValue() == TR::InstOpCode::label;
  }
  virtual bool isAdmin()
  {
    return _opcode.isAdmin();
  }
  ...
  {
    return _opcode.isFloat();
  }
  virtual bool isVMX()
  {
    return _opcode.isVMX();
  }
  virtual bool isVSX()
  {
    return _opcode.isVSX();
  }
  virtual bool isSyncSideEffectFree()
  {
    return _opcode.isSyncSideEffectFree();
  }
  virtual bool isCall();

  virtual bool isAsyncBranch()
  {
    return _asyncBranch;
  }
  virtual bool setAsyncBranch()
  {
    return (_asyncBranch = true);
  }
  ...
  virtual TR::Register* getPrimaryTargetRegister()
  {
    return NULL;
  }
...
// for assertion checking
  ...
  void setWillBePatched(bool v = true)
  {
    v ? _index |= WillBePatched : _index &= ~WillBePatched;
  }
