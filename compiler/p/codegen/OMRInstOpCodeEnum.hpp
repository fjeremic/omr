...
bad,          // Illegal Opcode
  ...
  tabortdgei_r, // Transactional Memory abort dword if greater than or equal to
                // immediate
  ...
  tabortdlei_r, // Transactional Memory abort dword if less than or equal to
                // immediate
  tabortdlge_r, // Transactional Memory abort dword if logically greater than or
                // equal to
  ...
  tabortwlge_r, // Transactional Memory abort if logically greater than or equal
                // to
  ...
  // vmul10ecuq,       // vector multiply-by-10 extended & write carry unsigned
  // qword vmul10uq,         // vector multiply-by-10 unsigned qword vmul10euq,
  // // vector multiply-by-10 extended unsigned qword vmulesw,          //
  // Vector Multiply Even Signed Word vmuleuw,          // Vector Multiply Even
  // Unsigned Word vmulosw,          // Vector Multiply Odd Signed Word vmulouw,
  // // Vector Multiply Odd Unsigned Word vnegw,            // vector negate
  // word vnegd,            // vector negate DWord vprtybw,          // vector
  // parity byte word vprtybd,          // vector parity byte DWord vprtybq, //
  // vector parity byte qword vmr,              // vector move register
  vor,     // vector or
  ...
  xsrdpic, // VSX Scalar Round to Double-Precision exact using Current rounding
           // mode
