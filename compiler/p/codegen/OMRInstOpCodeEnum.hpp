...
bad,            // Illegal Opcode
    ...
    tabortdlge_r,  // Transactional Memory abort dword if logically greater than
                   // or equal to
    tabortdlgei_r, // Transactional Memory abort dword if logically greater than
                   // or equal to immediate
    tabortdlgt_r,  // Transactional Memory abort dword if logically greater than
    tabortdlgti_r, // Transactional Memory abort dword if logically greater than
                   // immediate
    tabortdlle_r,  // Transactional Memory abort dword if logically less than or
                   // equal to
    tabortdllei_r, // Transactional Memory abort dword if logically less than or
                   // equal to immediate
    ...
    tabortwlle_r,  // Transactional Memory abort if logically less than or equal
                   // to
    tabortwllei_r, // Transactional Memory abort if logically less than or equal
                   // to immediate
