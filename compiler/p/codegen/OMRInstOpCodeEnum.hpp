...
bad,             // Illegal Opcode
    ...
    mftexasru,   // Move from upper 32 bits of transaction exception and summary
                 // register to gpr
    ...
    // stop,             // The thread is placed into power-saving mode and
    ...
    tabortdeqi_r,  // Transactional Memory abort dword if equal to immediate
                   // value
    tabortdge_r,   // Transactional Memory abort dword if greater than or equal
                   // to
    tabortdgei_r,  // Transactional Memory abort dword if greater than or equal
                   // to immediate
    ...
    tabortdlei_r,  // Transactional Memory abort dword if less than or equal to
                   // immediate
    tabortdlge_r,  // Transactional Memory abort dword if logically greater than
                   // or equal to
    tabortdlgei_r,  // Transactional Memory abort dword if logically greater
                    // than or equal to immediate
    tabortdlgt_r,  // Transactional Memory abort dword if logically greater than
    tabortdlgti_r,  // Transactional Memory abort dword if logically greater
                    // than immediate
    tabortdlle_r,  // Transactional Memory abort dword if logically less than or
                   // equal to
    tabortdllei_r,  // Transactional Memory abort dword if logically less than
                    // or equal to immediate
    tabortdllt_r,   // Transactional Memory abort dword if logically less than
    tabortdllti_r,  // Transactional Memory abort dword if logically less than
                    // immediate
    ...
    tabortdneqi_r,  // Transactional Memory abort dword if not equal to
                    // immediate
    ...
    tabortwgei_r,   // Transactional Memory abort if greater than or equal to
                    // immediate
    ...
    tabortwlei_r,   // Transactional Memory abort if less than or equal to
                    // immediate
    tabortwlge_r,   // Transactional Memory abort if logically greater than or
                    // equal to
    tabortwlgei_r,  // Transactional Memory abort if logically greater than or
                    // equal to immediate
    tabortwlgt_r,   // Transactional Memory abort if logically greater than
    tabortwlgti_r,  // Transactional Memory abort if logically greater than
                    // immediate
    tabortwlle_r,  // Transactional Memory abort if logically less than or equal
                   // to
    tabortwllei_r,  // Transactional Memory abort if logically less than or
                    // equal to immediate
    tabortwllt_r,   // Transactional Memory abort if logically less than
    tabortwllti_r,  // Transactional Memory abort if logically less than
                    // immediate
    ...
    flcmpl,    // compare float and set result
               // -1(less,unordered),0(equal),1(greater)
    flcmpg,    // compare float and set result
    ...
    // vclzlsbb,         // vector count leading zero least-significant bits
    // byte vctzlsbb,         // vector count trailing zero least-significant
    // bits byte vctzb,            // vector count trailing zeros Byte vctzh, //
    // vector count trailing zeros Hword vctzw,            // vector count
    // trailing zeros Word vctzd,            // vector count trailing zeros
    // Dword vextractub,       // vector extract unsigned Byte vextractuh, //
    // vector extract unsigned Hword vextractuw,       // vector extract
    // unsigned Word vextractd,        // vector extract Dword vextsb2w, //
    // vector extend sign byte to Word vextsh2w,         // vector extend sign
    // hword to Word vextsb2d,         // vector extend sign byte to Dword
    ...
    // vmul10ecuq,       // vector multiply-by-10 extended & write carry
    // unsigned qword vmul10uq,         // vector multiply-by-10 unsigned qword
    ...
    // vsubecuq,         // Vector Subtract Extended & write Carry Unsigned
    // Qword vsubeuqm,         // Vector Subtract Extended Unsigned Qword Modulo
    ...
    xscvdpsxds,  // VSX Scalar Convert Double-Precision to Signed Integer
                 // Doubleword Saturate
    xscvdpsxws,  // VSX Scalar Convert Double-Precision to Signed Integer Word
                 // Saturate
    ...
    xsnmsubadp,  // VSX Scalar Negative Multiply-Subtract Type A
                 // Double-Precision
    xsnmsubmdp,  // VSX Scalar Negative Multiply-Subtract Type M
                 // Double-Precision
                 // xsnabsqp,         // VSX Scalar Negative Absolute QP
                 // xsnegqp,          // VSX Scalar Negate QP
    xsrdpic,     // VSX Scalar Round to Double-Precision exact using Current
                 // rounding mode
    ...
    // xscmpgedp,        // VSX Scalar Compare Greater Than or Equal
    // Double-Precision xscmpnedp,        // VSX Scalar Compare Not Equal
    // Double-Precision xscmpexpdp,       // VSX Scalar Compare Exponents DP
    xscvsxddp,  // VSX Scalar Convert Signed Integer Doubleword to
                // Double-Precision
    ...
    xvcmpgedp_r,  // VSX Vector Compare Greater Than Or Equal To
                  // Double-Precision
    ...
    xvnmsubadp,   // VSX Vector Negative Multiply-Subtract Type-A
                  // Double-Precision
    xvnmsubmdp,   // VSX Vector Negative Multiply-Subtract Type-M
                  // Double-Precision
    ...
    xscvdpspn,    // Scalar Convert Double-Precision to Single-Precision format
                  // Non-signalling
    xscvdpuxds,   // Scalar Convert Double-Precision to Unsigned Fixed-Point
                  // Doubleword Saturate
    xscvdpuxws,  // Scalar Convert Double-Precision to Unsigned Fixed-Point Word
                 // Saturate
    xscvspdp,    // Scalar Convert Single-Precision to Double-Precision (p=1)
    xscvspdpn,   // Convert Single-Precision to Double-Precision format
                 // Non-signalling
    xscvsxdsp,   // Scalar Convert Signed Fixed-Point Doubleword to
                 // Single-Precision
    xscvuxddp,   // Scalar Convert Unsigned Fixed-Point Doubleword to
                 // Double-Precision
    xscvuxdsp,   // Scalar Convert Unsigned Fixed-Point Doubleword to
                 // Single-Precision
    ...
    xvcmpgesp_r,  // Vector Compare Greater Than or Equal To Single-Precision &
                  // record CR6
    ...
    xvcvdpsxds,   // Vector Convert Double-Precision to Signed Fixed-Point
                  // Doubleword Saturate
    xvcvdpsxws,   // Vector Convert Double-Precision to Signed Fixed-Point Word
                  // Saturate
    xvcvdpuxds,   // Vector Convert Double-Precision to Unsigned Fixed-Point
                  // Doubleword Saturate
    xvcvdpuxws,  // Vector Convert Double-Precision to Unsigned Fixed-Point Word
                 // Saturate
    xvcvspdp,    // Vector Convert Single-Precision to Double-Precision
    xvcvspsxds,  // Vector Convert Single-Precision to Signed Fixed-Point
                 // Doubleword Saturate
    xvcvspsxws,  // Vector Convert Single-Precision to Signed Fixed-Point Word
                 // Saturate
    xvcvspuxds,  // Vector Convert Single-Precision to Unsigned Fixed-Point
                 // Doubleword Saturate
    xvcvspuxws,  // Vector Convert Single-Precision to Unsigned Fixed-Point Word
                 // Saturate
    xvcvsxddp,   // Vector Convert Signed Fixed-Point Doubleword to
                 // Double-Precision
    xvcvsxdsp,   // Vector Convert Signed Fixed-Point Doubleword to
                 // Single-Precision
    ...
    xvcvuxddp,   // Vector Convert Unsigned Fixed-Point Doubleword to
                 // Double-Precision
    xvcvuxdsp,   // Vector Convert Unsigned Fixed-Point Doubleword to
                 // Single-Precision
    ...
    xvrdpic,  // Vector Round to Double-Precision Integer using Current rounding
              // mode
    ...
    xvrspic,  // Vector Round to Single-Precision Integer using Current rounding
              // mode
