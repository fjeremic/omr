...
void
TR_PPCOutOfLineCodeSection::generatePPCOutOfLineCodeSectionDispatch()
{
  ...
  new (_cg->trHeapMemory())
    TR::PPCLabelInstruction(TR::InstOpCode::label, _callNode, _entryLabel, _cg);
  ...
  if (_targetReg) {
    ...
    generateTrg1Src1Instruction(
      _cg, TR::InstOpCode::mr, _callNode, _targetReg, resultReg);
  }
...
void
TR_PPCOutOfLineCodeSection::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
