...
TR_PPCOutOfLineCodeSection::TR_PPCOutOfLineCodeSection(
...
void TR_PPCOutOfLineCodeSection::generatePPCOutOfLineCodeSectionDispatch() {
  ...
  new (_cg->trHeapMemory()) TR::PPCLabelInstruction(
      TR::InstOpCode::label, _callNode, _entryLabel, _cg);
  ...
  if (_targetReg) {
    ...
    generateTrg1Src1Instruction(_cg, TR::InstOpCode::mr, _callNode, _targetReg,
                                resultReg);
  }
  ...
  generateLabelInstruction(_cg, TR::InstOpCode::label, _callNode,
                           TR::LabelSymbol::create(_cg->trHeapMemory(), _cg));
...
void TR_PPCOutOfLineCodeSection::assignRegisters(
