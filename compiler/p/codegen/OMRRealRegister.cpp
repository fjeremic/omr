...
TR_RegisterMask OMR::Power::RealRegister::getAvailableRegistersMask(
    TR_RegisterKinds rk) {
  if (rk == TR_GPR)
...
const uint8_t OMR::Power::RealRegister::fullRegBinaryEncodings
    [OMR::Power::RealRegister::NumRegisters] = {
        0x00,  // NoReg
        0x00,  // r0
        0x01,  // r1
        0x02,  // r2
