...
class OMR_EXTENSIBLE TreeEvaluator : public OMR::TreeEvaluator {
 public:
  ...
  static TR::Register* dloadHelper(TR::Node* node,
                                   TR::CodeGenerator* cg,
                                   TR::Register* reg,
  ...
  static TR::Register* commonByteLoadEvaluator(TR::Node* node,
                                               bool signExtend,
                                               TR::CodeGenerator* cg);
  ...
  static TR::Register* dualMulHelper64(TR::Node* node,
                                       ...
                                       TR::Node* lumulhNode,
                                       TR::CodeGenerator* cg);
  static TR::Register* dualMulHelper32(TR::Node* node,
                                       TR::Node* lmulNode,
                                       TR::Node* lumulhNode,
                                       TR::CodeGenerator* cg);
  ...
  static TR::Register* vicmpallHelper(TR::Node* node,
                                      TR::CodeGenerator* cg,
                                      TR::InstOpCode::Mnemonic op,
                                      int nBit);
  static TR::Register* vicmpanyHelper(TR::Node* node,
                                      TR::CodeGenerator* cg,
                                      TR::InstOpCode::Mnemonic op,
                                      int nBit);
  ...
  static TR::Register* vdcmpallHelper(TR::Node* node,
                                      TR::CodeGenerator* cg,
                                      TR::InstOpCode::Mnemonic op);
  static TR::Register* vdcmpanyHelper(TR::Node* node,
                                      TR::CodeGenerator* cg,
                                      TR::InstOpCode::Mnemonic op);
  ...
  static TR::Register* inlineVectorTernaryOp(TR::Node* node,
                                             TR::CodeGenerator* cg,
                                             TR::InstOpCode::Mnemonic op);
  static bool inlineVectorCompareBranch(TR::Node* node,
                                        TR::CodeGenerator* cg,
                                        bool isHint,
                                        bool likeliness);
  ...
  static void postSyncConditions(TR::Node* node,
                                 TR::CodeGenerator* cg,
                                 TR::Register* dataReg,
  ...
  static void genBranchSequence(TR::Node* node,
                                TR::Register* src1Reg,
                                TR::Register* src2Reg,
                                TR::Register* trgReg,
  ...
  static bool stopUsingCopyReg(TR::Node* node,
                               TR::Register*& reg,
                               TR::CodeGenerator* cg);
 ...
 private:
  static TR::Register* int2dbl(TR::Node* node,
                               TR::Register* srcReg,
                               bool canClobber,
                               TR::CodeGenerator* cg);
