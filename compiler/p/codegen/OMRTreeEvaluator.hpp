...
public:
  ...
  static TR::Register *dloadHelper(TR::Node *node, TR::CodeGenerator *cg,
                                   TR::Register *reg,
  ...
  static TR::Register *commonByteLoadEvaluator(TR::Node *node, bool signExtend,
                                               TR::CodeGenerator *cg);
  ...
  static TR::Register *aloadEvaluator(TR::Node *node,
                                      TR::CodeGenerator *cg); // ibm@59591
  ...
  static TR::Register *astoreEvaluator(TR::Node *node,
                                       TR::CodeGenerator *cg); // ibm@59591
  ...
  static TR::Register *dualMulHelper64(TR::Node *node, TR::Node *lmulNode,
                                       TR::Node *lumulhNode,
                                       TR::CodeGenerator *cg);
  static TR::Register *dualMulHelper32(TR::Node *node, TR::Node *lmulNode,
                                       TR::Node *lumulhNode,
                                       TR::CodeGenerator *cg);
  ...
  static TR::Register *fRegStoreEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *gprRegLoadEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *gprRegStoreEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  ...
  static TR::Register *arraycopyEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *setmemoryEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *arraytranslateAndTestEvaluator(TR::Node *node,
                                                      TR::CodeGenerator *cg);
  static TR::Register *reverseLoadEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *reverseStoreEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *arraycmpEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *compareIntsForEquality(TR::Node *node,
                                              TR::CodeGenerator *cg);
  static TR::Register *compareIntsForEquality(TR::InstOpCode::Mnemonic branchOp,
                                              TR::LabelSymbol *dstLabel,
                                              TR::Node *node,
                                              TR::CodeGenerator *cg,
                                              bool isHint = false,
                                              bool likeliness = false);
  static TR::Register *compareIntsForOrder(TR::InstOpCode::Mnemonic branchOp,
                                           TR::Node *node,
                                           TR::CodeGenerator *cg,
                                           bool isSigned);
  static TR::Register *compareIntsForOrder(TR::InstOpCode::Mnemonic branchOp,
                                           ...
                                           bool isHint = false,
                                           bool likeliness = false);
  static TR::Register *compareLongsForEquality(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *
  compareLongsForEquality(TR::InstOpCode::Mnemonic branchOp,
                          TR::LabelSymbol *dstLabel, TR::Node *node,
                          TR::CodeGenerator *cg, bool isHint = false,
                          bool likeliness = false);
  static TR::Register *
  compareLongsForOrder(TR::InstOpCode::Mnemonic branchOp,
                       TR::InstOpCode::Mnemonic reversedBranchOp,
                       TR::Node *node, TR::CodeGenerator *cg, bool isSigned);
  static TR::Register *
  compareLongsForOrder(TR::InstOpCode::Mnemonic branchOp,
                       TR::InstOpCode::Mnemonic reversedBranchOp,
                       TR::LabelSymbol *dstLabel, TR::Node *node,
                       TR::CodeGenerator *cg, bool isSigned,
                       bool isHint = false, bool likeliness = false);

  static TR::Register *cmpsetEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *integerHighestOneBit(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *integerLowestOneBit(TR::Node *node,
                                           TR::CodeGenerator *cg);
  ...
  static TR::Register *conditionalHelperEvaluator(TR::Node *node,
                                                  TR::CodeGenerator *cg);
  ...
  static TR::Register *vicmpallHelper(TR::Node *node, TR::CodeGenerator *cg,
                                      TR::InstOpCode::Mnemonic op, int nBit);
  static TR::Register *vicmpanyHelper(TR::Node *node, TR::CodeGenerator *cg,
                                      TR::InstOpCode::Mnemonic op, int nBit);
  ...
  static TR::Register *getvelemDirectMoveHelper(TR::Node *node,
                                                TR::CodeGenerator *cg);
  static TR::Register *getvelemMemoryMoveHelper(TR::Node *node,
                                                TR::CodeGenerator *cg);
  ...
  static TR::Register *vdcmpallHelper(TR::Node *node, TR::CodeGenerator *cg,
                                      TR::InstOpCode::Mnemonic op);
  static TR::Register *vdcmpanyHelper(TR::Node *node, TR::CodeGenerator *cg,
                                      TR::InstOpCode::Mnemonic op);
  ...
  static TR::Register *inlineVectorTernaryOp(TR::Node *node,
                                             TR::CodeGenerator *cg,
                                             TR::InstOpCode::Mnemonic op);
  static bool inlineVectorCompareBranch(TR::Node *node, TR::CodeGenerator *cg,
                                        bool isHint, bool likeliness);
  static TR::Register *
  inlineVectorCompareAllOrAnyOp(TR::Node *node, TR::CodeGenerator *cg,
  ...
  static TR::Register *xfRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *xdRegLoadEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  generateNullTestInstructions(TR::CodeGenerator *cg, TR::Register *trgReg,
                               TR::Node *node,
                               bool nullPtrSymRefRequired = false);

  // Common evaluator routines
  static void postSyncConditions(TR::Node *node, TR::CodeGenerator *cg,
                                 TR::Register *dataReg,
  ...
  static void
  preserveTOCRegister(TR::Node *node, TR::CodeGenerator *cg,
                      TR::RegisterDependencyConditions *dependencies);
  static void
  restoreTOCRegister(TR::Node *node, TR::CodeGenerator *cg,
                     TR::RegisterDependencyConditions *dependencies);
  static TR::Register *
  retrieveTOCRegister(TR::Node *node, TR::CodeGenerator *cg,
                      TR::RegisterDependencyConditions *dependencies);

  static void genBranchSequence(TR::Node *node, TR::Register *src1Reg,
                                TR::Register *src2Reg, TR::Register *trgReg,
                                TR::InstOpCode::Mnemonic branchOpCode,
                                TR::InstOpCode::Mnemonic cmpOpCode,
                                TR::CodeGenerator *cg);

  static bool stopUsingCopyReg(TR::Node *node, TR::Register *&reg,
                               TR::CodeGenerator *cg);
...
private:
  static TR::Register *int2dbl(TR::Node *node, TR::Register *srcReg,
                               bool canClobber, TR::CodeGenerator *cg);
