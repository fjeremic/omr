...
class OMR_EXTENSIBLE TreeEvaluator : public OMR::TreeEvaluator {
 public:
  ...
  static TR::Register *compareLongsForEquality(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *compareLongsForEquality(
      TR::InstOpCode::Mnemonic branchOp, TR::LabelSymbol *dstLabel,
      TR::Node *node, TR::CodeGenerator *cg, bool isHint = false,
      bool likeliness = false);
  static TR::Register *compareLongsForOrder(
  ...
  static TR::Register *compareLongsForOrder(
      ...
      TR::Node *node, TR::CodeGenerator *cg, bool isSigned, bool isHint = false,
      bool likeliness = false);
  ...
  static TR::Register *inlineVectorCompareAllOrAnyOp(
