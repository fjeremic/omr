...
public:
  ...
  TR::RealRegister *assignOneRegister(TR::Instruction *currentInstruction,
                                      TR::Register *virtReg, bool excludeGPR0);
  ...
  TR::RealRegister **
  cloneRegisterFileByType(TR::RealRegister **registerFileClone,
                          TR::RealRegister **registerFile, int32_t start,
                          int32_t end, TR_RegisterKinds kind,
