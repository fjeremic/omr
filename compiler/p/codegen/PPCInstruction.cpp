...
void
TR::PPCLabelInstruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
  TR::Compilation* comp = cg()->comp();
  if (TR::Instruction::getDependencyConditions()) {
    TR::Instruction::getDependencyConditions()->assignPostConditionRegisters(
  ...
  if (isBranchOp() && !usesCountRegister() &&
  ...
  if (((isBranchOp() && !usesCountRegister()) ||
       isVirtualGuardNOPInstruction()) &&
      getLabelSymbol()->isStartOfColdInstructionStream()) {
    // This may be an unconditional branch to the OOL code.  This can occur when
    // the array is provably discontiguous but the BNDCHKwithSpineCHK node
    // couldn't be folded away.
    //

    // Switch to the outlined instruction stream and assign registers.
    //
    TR_PPCOutOfLineCodeSection* oi =
      cg()->findOutLinedInstructionsFromLabel(getLabelSymbol());
    TR_ASSERT(oi,
              "Could not find PPCOutOfLineCodeSection stream from label.  "
              "instr=%p, label=%p\n",
              this,
              getLabelSymbol());
...
void
TR::PPCDepInstruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
...
bool
TR::PPCDepInstruction::refsRegister(TR::Register* reg)
{
  return _conditions->refsRegister(reg);
}

bool
TR::PPCDepInstruction::defsRegister(TR::Register* reg)
{
  return _conditions->defsRegister(reg);
}

bool
TR::PPCDepInstruction::defsRealRegister(TR::Register* reg)
{
  return _conditions->defsRealRegister(reg);
}

bool
TR::PPCDepInstruction::usesRegister(TR::Register* reg)
{
...
void
TR::PPCDepLabelInstruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
  getDependencyConditions()->assignPostConditionRegisters(
    this, kindToBeAssigned, cg());
...
bool
TR::PPCDepLabelInstruction::refsRegister(TR::Register* reg)
{
  return _conditions->refsRegister(reg);
}

bool
TR::PPCDepLabelInstruction::defsRegister(TR::Register* reg)
{
  return _conditions->defsRegister(reg);
}

bool
TR::PPCDepLabelInstruction::defsRealRegister(TR::Register* reg)
{
  return _conditions->defsRealRegister(reg);
}

bool
TR::PPCDepLabelInstruction::usesRegister(TR::Register* reg)
{
  return _conditions->usesRegister(reg);
}
...
void
TR::PPCConditionalBranchInstruction::assignRegisters(
...
bool
TR::PPCConditionalBranchInstruction::refsRegister(TR::Register* reg)
{
...
bool
TR::PPCConditionalBranchInstruction::defsRegister(TR::Register* reg)
{
  return (false);
}

bool
TR::PPCConditionalBranchInstruction::defsRealRegister(TR::Register* reg)
{
  return (false);
}

bool
TR::PPCConditionalBranchInstruction::usesRegister(TR::Register* reg)
{
  if (getConditionRegister() == reg)
    return (true);
  return (false);
...
void
TR::PPCDepConditionalBranchInstruction::assignRegisters(
  TR_RegisterKinds kindToBeAssigned)
{
  TR::Register* virtualRegister = getConditionRegister();
...
bool
TR::PPCDepConditionalBranchInstruction::refsRegister(TR::Register* reg)
{
...
bool
TR::PPCDepConditionalBranchInstruction::defsRegister(TR::Register* reg)
{
  return _conditions->defsRegister(reg);
}

bool
TR::PPCDepConditionalBranchInstruction::defsRealRegister(TR::Register* reg)
{
  return _conditions->defsRealRegister(reg);
}

bool
TR::PPCDepConditionalBranchInstruction::usesRegister(TR::Register* reg)
{
...
TR::PPCImmInstruction::getPPCImmInstruction()
{
  return this;
}
#endif
...
// check within "toPPCImmInstruction"
#if defined(DEBUG) || defined(PROD_WITH_ASSUMES)
TR::PPCImm2Instruction*
TR::PPCImm2Instruction::getPPCImm2Instruction()
{
  return this;
}
#endif
...
bool
TR::PPCSrc1Instruction::refsRegister(TR::Register* reg)
{
...
void
TR::PPCSrc1Instruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
...
bool
TR::PPCSrc1Instruction::defsRegister(TR::Register* reg)
{
  return false;
}

bool
TR::PPCSrc1Instruction::defsRealRegister(TR::Register* reg)
{
  return false;
}

bool
TR::PPCSrc1Instruction::usesRegister(TR::Register* reg)
{
  if (reg == getSource1Register()) {
    return true;
  }
...
TR::PPCDepImmInstruction::getPPCDepImmInstruction()
{
  return this;
}
...
bool
TR::PPCTrg1Instruction::refsRegister(TR::Register* reg)
{
...
bool
TR::PPCTrg1Instruction::defsRegister(TR::Register* reg)
{
...
bool
TR::PPCTrg1Instruction::defsRealRegister(TR::Register* reg)
{
  if (reg == getTargetRegister()->getAssignedRegister() ||
      TR::Instruction::defsRealRegister(reg)) {
    return true;
  }
  return false;
}
...
bool
TR::PPCTrg1Instruction::usesRegister(TR::Register* reg)
{
  return TR::Instruction::usesRegister(reg);
}

void
TR::PPCTrg1Instruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
                                        ...
                                        bool excludeGPR0)
{
  ...
  if (excludeGPR0 && (assignedRegister != NULL) &&
      (toRealRegister(assignedRegister) ==
       machine->getRealRegister(TR::RealRegister::gr0))) {
    TR::RealRegister* alternativeRegister;

    if ((alternativeRegister = machine->findBestFreeRegister(
           this, kindOfRegister, excludeGPR0, false, virtualRegister)) ==
        NULL) {
      cg()->setRegisterAssignmentFlag(TR_RegisterSpilled);
      alternativeRegister =
        machine->freeBestRegister(this, virtualRegister, NULL, excludeGPR0);
    }
    ...
    if (assignedRegister == NULL) {
      assignedRegister =
        machine->assignOneRegister(this, virtualRegister, excludeGPR0);
    }
  }
...
TR::PPCTrg1Src1Instruction::PPCTrg1Src1Instruction(TR::InstOpCode::Mnemonic op,
                                                   TR::Node* n,
                                                   TR::Register* treg,
                                                   TR::Register* sreg,
                                                   TR::CodeGenerator* cg)
...
{
  useRegister(sreg);
  if (op == TR::InstOpCode::addi || op == TR::InstOpCode::addis ||
      op == TR::InstOpCode::addi2) {
...
bool
TR::PPCTrg1Src1Instruction::refsRegister(TR::Register* reg)
{
  if (reg == getSource1Register() ||
      TR::PPCTrg1Instruction::refsRegister(reg)) {
    return true;
  }
  return false;
}
...
bool
TR::PPCTrg1Src1Instruction::defsRegister(TR::Register* reg)
{
  return TR::PPCTrg1Instruction::defsRegister(reg);
}

bool
TR::PPCTrg1Src1Instruction::defsRealRegister(TR::Register* reg)
{
  return TR::PPCTrg1Instruction::defsRealRegister(reg);
}

bool
TR::PPCTrg1Src1Instruction::usesRegister(TR::Register* reg)
{
  if (reg == getSource1Register() ||
      TR::PPCTrg1Instruction::usesRegister(reg)) {
    return true;
  }
  return false;
}
...
void
TR::PPCTrg1Src1Instruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
  ...
  if (getOpCodeValue() == TR::InstOpCode::addi ||
      getOpCodeValue() == TR::InstOpCode::addis ||
      getOpCodeValue() == TR::InstOpCode::addi2)
    excludeGPR0 = true;
  ...
  if (excludeGPR0 && (assignedRegister != NULL) &&
    ...
    if ((alternativeRegister = machine->findBestFreeRegister(
           this, kindOfRegister, excludeGPR0, false, sourceVirtual)) == NULL) {
      cg()->setRegisterAssignmentFlag(TR_RegisterSpilled);
      alternativeRegister =
        machine->freeBestRegister(this, sourceVirtual, NULL, excludeGPR0);
    }
    machine->coerceRegisterAssignment(
      this,
      sourceVirtual,
    ...
    if (assignedRegister == NULL) {
      assignedRegister =
        machine->assignOneRegister(this, sourceVirtual, excludeGPR0);
    }
  }
...
bool
TR::PPCSrc2Instruction::refsRegister(TR::Register* reg)
{
...
bool
TR::PPCSrc2Instruction::defsRegister(TR::Register* reg)
{
  return false;
}

bool
TR::PPCSrc2Instruction::defsRealRegister(TR::Register* reg)
{
  return false;
}

bool
TR::PPCSrc2Instruction::usesRegister(TR::Register* reg)
{
  if (reg == getSource1Register() || reg == getSource2Register()) {
    return true;
  }
...
void
TR::PPCSrc2Instruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
  ...
  if (assignedRegister == NULL) {
    assignedRegister =
      machine->assignOneRegister(this, virtualRegister1, false);
  }
  ...
  if (assignedRegister == NULL) {
    assignedRegister =
      machine->assignOneRegister(this, virtualRegister2, false);
  }
  setSource1Register(assignedRegister);
...
bool
TR::PPCTrg1Src2Instruction::refsRegister(TR::Register* reg)
{
  if (reg == getTargetRegister() || reg == getSource1Register() ||
...
bool
TR::PPCTrg1Src2Instruction::defsRegister(TR::Register* reg)
{
...
bool
TR::PPCTrg1Src2Instruction::defsRealRegister(TR::Register* reg)
{
  if (reg == getTargetRegister()->getAssignedRegister()) {
    return true;
  }
...
bool
TR::PPCTrg1Src2Instruction::usesRegister(TR::Register* reg)
{
  if (reg == getSource1Register() || reg == getSource2Register()) {
    return true;
  }
...
void
TR::PPCTrg1Src2Instruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
...
bool
TR::PPCTrg1Src3Instruction::refsRegister(TR::Register* reg)
{
  if (reg == getTargetRegister() || reg == getSource1Register() ||
      reg == getSource2Register() || reg == getSource3Register()) {
    return true;
  }
  return false;
}
...
bool
TR::PPCTrg1Src3Instruction::usesRegister(TR::Register* reg)
{
  if (reg == getSource1Register() || reg == getSource2Register() ||
...
void
TR::PPCTrg1Src3Instruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
...
TR::PPCMemInstruction::PPCMemInstruction(TR::InstOpCode::Mnemonic op,
                                         TR::Node* n,
...
bool
TR::PPCMemInstruction::refsRegister(TR::Register* reg)
{
  return getMemoryReference()->refsRegister(reg);
}

bool
TR::PPCMemInstruction::usesRegister(TR::Register* reg)
{
  return getMemoryReference()->refsRegister(reg);
}

void
TR::PPCMemInstruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
...
TR::PPCMemSrc1Instruction::PPCMemSrc1Instruction(TR::InstOpCode::Mnemonic op,
                                                 TR::Node* n,
                                                 TR::MemoryReference* mf,
                                                 TR::Register* sreg,
                                                 TR::CodeGenerator* cg)
...
TR::Register*
TR::PPCMemSrc1Instruction::getMemoryDataRegister()
{
  return getSourceRegister();
}

bool
TR::PPCMemSrc1Instruction::refsRegister(TR::Register* reg)
{
...
bool
TR::PPCMemSrc1Instruction::defsRegister(TR::Register* reg)
{
  return false;
}

bool
TR::PPCMemSrc1Instruction::defsRealRegister(TR::Register* reg)
{
  return false;
}

bool
TR::PPCMemSrc1Instruction::usesRegister(TR::Register* reg)
{
  if (getMemoryReference()->refsRegister(reg) == true ||
      reg == getSourceRegister()) {
    return true;
...
void
TR::PPCMemSrc1Instruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
  ...
  bool excludeGPR0 =
    mref->isUsingStaticTOC() && (mref->getUnresolvedSnippet() == NULL) &&
  ...
  sourceVirtual->unblock();
  mBaseReal =
    (mBaseVirtual == NULL) ? NULL : toRealRegister(mref->getModBase());
  ...
  if (excludeGPR0 && (assignedRegister != NULL) &&
    ...
    if ((alternativeRegister =
           machine->findBestFreeRegister(this,
                                         sourceVirtual->getKind(),
                                         excludeGPR0,
                                         false,
                                         sourceVirtual)) == NULL) {
      cg()->setRegisterAssignmentFlag(TR_RegisterSpilled);
...
TR::Register*
TR::PPCMemSrc1Instruction::getSourceRegisterForStmw(uint32_t i)
{
...
TR::PPCTrg1MemInstruction::PPCTrg1MemInstruction(TR::InstOpCode::Mnemonic op,
                                                 TR::Node* n,
                                                 TR::Register* treg,
                                                 TR::MemoryReference* mf,
                                                 TR::CodeGenerator* cg,
...
bool
TR::PPCTrg1MemInstruction::encodeMutexHint()
{
  return TR::Compiler->target.cpu.id() >= TR_PPCp6 &&
         (getOpCodeValue() == TR::InstOpCode::lwarx ||
          getOpCodeValue() == TR::InstOpCode::ldarx);
}

TR::Register*
TR::PPCTrg1MemInstruction::getTargetRegisterForLmw(uint32_t i)
{
  // Index 0:   maps to base register of stmw
  // Index 1-N: map to the N stored registers of stmw
  // Index >N:  NULL
...
TR::Register*
TR::PPCTrg1MemInstruction::getMemoryDataRegister()
{
  return getTargetRegister();
}

bool
TR::PPCTrg1MemInstruction::refsRegister(TR::Register* reg)
{
  if (reg == getTargetRegister() ||
...
bool
TR::PPCTrg1MemInstruction::usesRegister(TR::Register* reg)
{
  if (getMemoryReference()->refsRegister(reg) == true) {
    return true;
  }
...
void
TR::PPCTrg1MemInstruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
  TR::MemoryReference* mref = getMemoryReference();
  TR::Register* targetVirtual = getTargetRegister();
  TR::Register* mBaseVirtual = mref->getModBase();
...
bool
TR::PPCControlFlowInstruction::refsRegister(TR::Register* reg)
{
  int numTargets;
  int numSources;
  int i;
...
bool
TR::PPCControlFlowInstruction::defsRegister(TR::Register* reg)
{
  int numTargets;
  int i;
  numTargets = getNumTargets();
...
bool
TR::PPCControlFlowInstruction::defsRealRegister(TR::Register* reg)
{
  int numTargets;
  int i;
  numTargets = getNumTargets();
...
bool
TR::PPCControlFlowInstruction::usesRegister(TR::Register* reg)
{
  int numSources;
  int i;
  numSources = getNumSources();
...
void
TR::PPCControlFlowInstruction::assignRegisters(
  TR_RegisterKinds kindToBeAssigned)
{
  TR::Machine* machine = cg()->machine();
  ...
  for (i = 0; i < numSources; i++) {
    if (!isSourceImmediate(i)) {
      ...
      if (assignedRegister == NULL) {
        assignedRegister =
          machine->assignOneRegister(this, sourceVirtual, false);
      }
  ...
  switch (getOpCode().getOpCodeValue()) {
      ...
      if (getOpCode2Value() == TR::InstOpCode::beq) {
        ...
        cg()->traceRAInstruction(
          cursor = generateLabelInstruction(
            cg(), TR::InstOpCode::label, currentNode, label2, cursor));
      } else {
        cg()->traceRAInstruction(
          cursor = generateLabelInstruction(
            cg(), TR::InstOpCode::label, currentNode, label2, cursor));
    ...
    case TR::InstOpCode::setblong:
      ...
      cg()->traceRAInstruction(
        cursor = generateLabelInstruction(
          cg(), TR::InstOpCode::label, currentNode, label1, cursor));
      cg()->traceRAInstruction(
        cursor = generateConditionalBranchInstruction(cg(),
                                                      getOpCode3Value(),
                                                      currentNode,
    ...
    case TR::InstOpCode::setbool:
      if (TR::Compiler->target.cpu.id() >= TR_PPCp9 &&
          getCmpOpValue() == TR::InstOpCode::fcmpu &&
          (getOpCode2Value() == TR::InstOpCode::blt ||
           getOpCode2Value() == TR::InstOpCode::bgt)) {

        /* Used with: dcmpgt, dcmplt, fcmpgt and fcmplt*/
        /* Determine relationship between the two inputs, translate correct
        return value into GT bit of the Target Condition Register, clear the LT
        field of the target condition register and finally set the result. */

        int64_t imm = (TR::RealRegister::CRCC_LT << TR::RealRegister::pos_RT |
        ...
        if (getOpCode2Value() != TR::InstOpCode::bgt)
          cg()->traceRAInstruction(
            cursor = generateTrg1Src2ImmInstruction(cg(),
                                                    TR::InstOpCode::cror,
                                                    currentNode,
                                                    getTargetRegister(0),
                                                    getTargetRegister(0),
    ...
    case TR::InstOpCode::d2i:
      ...
      if (TR::Compiler->target.cpu.id() < TR_PPCp8) {
        tempMR = new (cg()->trHeapMemory())
          TR::MemoryReference(cg()->getStackPointerRegister(), -8, 8, cg());
        cg()->traceRAInstruction(
      ...
      if (TR::Compiler->target.cpu.id() >= TR_PPCp8)
        ...
        cg()->traceRAInstruction(
          cursor = generateTrg1MemInstruction(
            ...
            getTargetRegister(2),
            new (cg()->trHeapMemory())
              TR::MemoryReference(currentNode, *tempMR, 4, 4, cg()),
            cursor));
      cg()->traceRAInstruction(
        cursor = generateLabelInstruction(
          cg(), TR::InstOpCode::label, currentNode, label2, cursor));
      ...
      if (TR::Compiler->target.is64Bit()) {
        ...
        cg()->traceRAInstruction(
          cursor = generateTrg1MemInstruction(
            ...
            getTargetRegister(2),
            new (cg()->trHeapMemory())
              TR::MemoryReference(currentNode, *tempMR, 0, 4, cg()),
            cursor));
        cg()->traceRAInstruction(
          cursor = generateTrg1MemInstruction(
            cg(),
  ...
  if (_conditions != NULL)
    _conditions->assignPreConditionRegisters(
      this->getPrev(), kindToBeAssigned, cg());
}
