...
void TR::PPCLabelInstruction::assignRegisters(
...
void TR::PPCDepLabelInstruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
  getDependencyConditions()->assignPostConditionRegisters(
      this, kindToBeAssigned, cg());
...
void TR::PPCConditionalBranchInstruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
...
bool TR::PPCConditionalBranchInstruction::refsRegister(TR::Register *reg) {
  if (getConditionRegister() == reg) return (true);
  return (false);
}
...
void TR::PPCDepConditionalBranchInstruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
  TR::Register *virtualRegister = getConditionRegister();
...
bool TR::PPCDepConditionalBranchInstruction::defsRealRegister(
    TR::Register *reg) {
  return _conditions->defsRealRegister(reg);
}
...
void TR::PPCSrc1Instruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
...
void TR::PPCTrg1Instruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
...
TR::PPCTrg1Src1Instruction::PPCTrg1Src1Instruction(TR::InstOpCode::Mnemonic op,
                                                   ...
                                                   TR::Register *sreg,
                                                   TR::CodeGenerator *cg)
    : TR::PPCTrg1Instruction(op, n, treg, cg), _source1Register(sreg) {
  useRegister(sreg);
...
TR::PPCTrg1Src1Instruction::PPCTrg1Src1Instruction(
    TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
    TR::Register *sreg, TR::Instruction *precedingInstruction,
    TR::CodeGenerator *cg)
...
void TR::PPCTrg1Src1Instruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
  ...
  if (excludeGPR0 && (assignedRegister != NULL) &&
    ...
    if ((alternativeRegister = machine->findBestFreeRegister(
             this, kindOfRegister, excludeGPR0, false, sourceVirtual)) ==
        NULL) {
      cg()->setRegisterAssignmentFlag(TR_RegisterSpilled);
      alternativeRegister =
...
void TR::PPCSrc2Instruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
...
void TR::PPCTrg1Src2Instruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
...
void TR::PPCTrg1Src3Instruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
...
TR::PPCMemInstruction::PPCMemInstruction(TR::InstOpCode::Mnemonic op,
                                         ...
                                         TR::CodeGenerator *cg)
    : TR::Instruction(op, n, cg), _memoryReference(mf) {
...
TR::PPCMemInstruction::PPCMemInstruction(TR::InstOpCode::Mnemonic op,
                                         ...
                                         TR::CodeGenerator *cg)
    : TR::Instruction(op, n, precedingInstruction, cg), _memoryReference(mf) {
  if (getOpCode().offsetRequiresWordAlignment()) {
    mf->setOffsetRequiresWordAlignment(n, cg, getPrev());
  }
  mf->bookKeepingRegisterUses(this, cg);
...
TR::PPCMemSrc1Instruction::PPCMemSrc1Instruction(TR::InstOpCode::Mnemonic op,
                                                 ...
                                                 TR::Register *sreg,
                                                 TR::CodeGenerator *cg)
    : TR::PPCMemInstruction(op, n, mf, cg), _sourceRegister(sreg) {
  useRegister(sreg);
...
TR::PPCMemSrc1Instruction::PPCMemSrc1Instruction(
    TR::InstOpCode::Mnemonic op, TR::Node *n, TR::MemoryReference *mf,
    TR::Register *sreg, TR::Instruction *precedingInstruction,
    TR::CodeGenerator *cg)
...
void TR::PPCMemSrc1Instruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
  ...
  bool excludeGPR0 = mref->isUsingStaticTOC() &&
                     ...
                     (mref->getTOCOffset() > UPPER_IMMED ||
                      mref->getTOCOffset() < LOWER_IMMED);
  ...
  if (excludeGPR0 && (assignedRegister != NULL) &&
    ...
    if ((alternativeRegister = machine->findBestFreeRegister(
             this, sourceVirtual->getKind(), excludeGPR0, false,
             sourceVirtual)) == NULL) {
      cg()->setRegisterAssignmentFlag(TR_RegisterSpilled);
      alternativeRegister =
          machine->freeBestRegister(this, sourceVirtual, NULL, excludeGPR0);
...
TR::PPCTrg1MemInstruction::PPCTrg1MemInstruction(
    ...
    : TR::PPCTrg1Instruction(op, n, treg, cg), _memoryReference(mf) {
...
TR::PPCTrg1MemInstruction::PPCTrg1MemInstruction(
    TR::InstOpCode::Mnemonic op, TR::Node *n, TR::Register *treg,
    TR::MemoryReference *mf, TR::Instruction *precedingInstruction,
    TR::CodeGenerator *cg, int32_t hint)
    : TR::PPCTrg1Instruction(op, n, treg, precedingInstruction, cg),
      _memoryReference(mf) {
  // If we set the hints, the instructions have to be lwarx or ldarx
  // Also control that the hints are set correctly for the type of instruction
...
void TR::PPCTrg1MemInstruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
  TR::MemoryReference *mref = getMemoryReference();
  TR::Register *targetVirtual = getTargetRegister();
  TR::Register *mBaseVirtual = mref->getModBase();
  ...
  if (targetVirtual == mref->getBaseRegister()) excludeGPR0 = true;
...
void TR::PPCControlFlowInstruction::assignRegisters(
    TR_RegisterKinds kindToBeAssigned) {
  TR::Machine *machine = cg()->machine();
  ...
  for (i = 0; i < numSources; i++) {
    if (!isSourceImmediate(i)) getSourceRegister(i)->block();
  }
  for (i = 0; i < numTargets; i++) {
  ...
  switch (getOpCode().getOpCodeValue()) {
    case TR::InstOpCode::iflong:
      if (isSourceImmediate(2)) {
        if (currentNode->getOpCode().isUnsigned())
          cg()->traceRAInstruction(cursor = generateTrg1Src1ImmInstruction(
                                       cg(), TR::InstOpCode::cmpli4,
                                       currentNode, getTargetRegister(0),
                                       getSourceRegister(0),
                                       getSourceImmediate(2), cursor));
        else
          cg()->traceRAInstruction(cursor = generateTrg1Src1ImmInstruction(
                                       cg(), TR::InstOpCode::cmpi4, currentNode,
                                       getTargetRegister(0),
                                       getSourceRegister(0),
                                       getSourceImmediate(2), cursor));
      } else {
        if (currentNode->getOpCode().isUnsigned())
          cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                       cg(), TR::InstOpCode::cmpl4, currentNode,
                                       getTargetRegister(0),
                                       getSourceRegister(0),
          ...
          cg()->traceRAInstruction(
              cursor = generateTrg1Src2Instruction(
                  cg(), TR::InstOpCode::cmp4, currentNode, getTargetRegister(0),
                  getSourceRegister(0), getSourceRegister(2), cursor));
      }
      if (getOpCode2Value() == TR::InstOpCode::bne)
        cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                     cg(), TR::InstOpCode::bne, currentNode,
                                     getLabelSymbol(), getTargetRegister(0),
                                     cursor));
      else
        cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                     cg(), TR::InstOpCode::bne, currentNode,
                                     label2, getTargetRegister(0), cursor));
      if (isSourceImmediate(3))
        cg()->traceRAInstruction(cursor = generateTrg1Src1ImmInstruction(
                                     cg(), TR::InstOpCode::cmpli4, currentNode,
                                     getTargetRegister(0), getSourceRegister(1),
                                     getSourceImmediate(3), cursor));
      else
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), TR::InstOpCode::cmpl4, currentNode,
                                     getTargetRegister(0), getSourceRegister(1),
      ...
      if (getOpCode2Value() == TR::InstOpCode::beq) {
        cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                     cg(), getOpCode2Value(), currentNode,
                                     getLabelSymbol(), getTargetRegister(0),
                                     cursor));
        cg()->traceRAInstruction(
            cursor = generateLabelInstruction(cg(), TR::InstOpCode::label,
                                              currentNode, label2, cursor));
      } else {
        cg()->traceRAInstruction(
            cursor = generateLabelInstruction(cg(), TR::InstOpCode::label,
                                              currentNode, label2, cursor));
    ...
    case TR::InstOpCode::setblong:
      ...
      cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                   cg(), getOpCode2Value(), currentNode,
                                   getTargetRegister(0), getSourceRegister(0),
                                   getSourceRegister(2), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                   cg(), TR::InstOpCode::li, currentNode,
                                   getTargetRegister(1), 1, cursor));
      cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                   cg(), TR::InstOpCode::bne, currentNode,
                                   label1, getTargetRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                   cg(), TR::InstOpCode::cmpl4, currentNode,
                                   getTargetRegister(0), getSourceRegister(1),
                                   getSourceRegister(3), cursor));
      cg()->traceRAInstruction(
          cursor = generateLabelInstruction(cg(), TR::InstOpCode::label,
                                            currentNode, label1, cursor));
      cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                   cg(), getOpCode3Value(), currentNode, label2,
                                   getTargetRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                   cg(), TR::InstOpCode::li, currentNode,
                                   getTargetRegister(1), 0, cursor));
      cg()->traceRAInstruction(
          cursor = generateLabelInstruction(cg(), TR::InstOpCode::label,
                                            currentNode, label2, cursor));
      break;
    case TR::InstOpCode::setbool:
      if (TR::Compiler->target.cpu.id() >= TR_PPCp9 &&
        ...
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), TR::InstOpCode::fcmpu, currentNode,
                                     getTargetRegister(0), getSourceRegister(0),
                                     getSourceRegister(1), cursor));

        if (getOpCode2Value() != TR::InstOpCode::bgt)
          cg()->traceRAInstruction(
              cursor = generateTrg1Src2ImmInstruction(
                  cg(), TR::InstOpCode::cror, currentNode, getTargetRegister(0),
                  getTargetRegister(0), getTargetRegister(0),
                  getSourceImmediate(2), cursor));

        cg()->traceRAInstruction(cursor = generateTrg1Src2ImmInstruction(
                                     cg(), TR::InstOpCode::crxor, currentNode,
                                     getTargetRegister(0), getTargetRegister(0),
                                     getTargetRegister(0), imm, cursor));
        cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                     cg(), TR::InstOpCode::setb, currentNode,
                                     getTargetRegister(1), getTargetRegister(0),
                                     cursor));

      } else {
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), getCmpOpValue(), currentNode,
                                     getTargetRegister(0), getSourceRegister(0),
                                     getSourceRegister(1), cursor));
        cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                     cg(), TR::InstOpCode::li, currentNode,
    ...
    case TR::InstOpCode::setbflt:
      ...
      cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                   ...
                                   getTargetRegister(1), 1, cursor));
      cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                   cg(), getOpCode2Value(), currentNode, label2,
                                   getTargetRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                   cg(), getOpCode3Value(), currentNode, label2,
                                   getTargetRegister(0), cursor));
    ...
    case TR::InstOpCode::lcmp:
      cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                   cg(), TR::InstOpCode::cmp4, currentNode,
                                   getTargetRegister(0), getSourceRegister(0),
                                   getSourceRegister(2), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                   cg(), TR::InstOpCode::li, currentNode,
                                   getTargetRegister(1), 1, cursor));
      cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                   cg(), TR::InstOpCode::bgt, currentNode,
                                   label2, getTargetRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                   cg(), TR::InstOpCode::li, currentNode,
                                   getTargetRegister(1), -1, cursor));
      cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                   cg(), TR::InstOpCode::blt, currentNode,
                                   label2, getTargetRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                   cg(), TR::InstOpCode::cmpl4, currentNode,
                                   getTargetRegister(0), getSourceRegister(1),
    ...
    case TR::InstOpCode::flcmpl:
      ...
      cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                   ...
                                   getTargetRegister(1), 0, cursor));
      cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                   cg(), TR::InstOpCode::beq, currentNode,
                                   label2, getTargetRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                   cg(), TR::InstOpCode::li, currentNode,
                                   getTargetRegister(1), -1, cursor));
    ...
    case TR::InstOpCode::idiv:
      cg()->traceRAInstruction(cursor = generateTrg1Src1ImmInstruction(
                                   ...
                                   -1, cursor));
      cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                   cg(), TR::InstOpCode::neg, currentNode,
                                   getTargetRegister(1), getSourceRegister(0),
                                   cursor));
      if (TR::Compiler->target.cpu.id() >= TR_PPCgp)
        // use PPC AS branch hint
        cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                     cg(), TR::InstOpCode::beq,
                                     PPCOpProp_BranchUnlikely, currentNode,
                                     label2, getTargetRegister(0), cursor));
      else
        cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                     cg(), TR::InstOpCode::beq, currentNode,
                                     label2, getTargetRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                   cg(), TR::InstOpCode::divw, currentNode,
                                   getTargetRegister(1), getSourceRegister(0),
                                   getSourceRegister(1), cursor));
      cg()->traceRAInstruction(
          cursor = generateLabelInstruction(cg(), TR::InstOpCode::label,
    ...
    case TR::InstOpCode::irem:
      ...
      if (TR::Compiler->target.cpu.id() >= TR_PPCp9) {
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), TR::InstOpCode::modsw, currentNode,
                                     getTargetRegister(1), getSourceRegister(0),
                                     getSourceRegister(1), cursor));
      } else {
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     ...
                                     getSourceRegister(1), cursor));
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), TR::InstOpCode::mullw, currentNode,
                                     getTargetRegister(1), getSourceRegister(1),
                                     getTargetRegister(1), cursor));
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), TR::InstOpCode::subf, currentNode,
                                     getTargetRegister(1), getTargetRegister(1),
                                     getSourceRegister(0), cursor));
      }
      cg()->traceRAInstruction(
          cursor = generateLabelInstruction(cg(), TR::InstOpCode::label,
                                            currentNode, label2, cursor));
    ...
    case TR::InstOpCode::ldiv:
      cg()->traceRAInstruction(cursor = generateTrg1Src1ImmInstruction(
                                   cg(), TR::InstOpCode::cmpi8, currentNode,
                                   getTargetRegister(0), getSourceRegister(1),
                                   -1, cursor));
      cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                   cg(), TR::InstOpCode::neg, currentNode,
      ...
      if (TR::Compiler->target.cpu.id() >= TR_PPCgp)
        ...
        cg()->traceRAInstruction(cursor = generateConditionalBranchInstruction(
                                     ...
                                     label2, getTargetRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                   cg(), TR::InstOpCode::divd, currentNode,
                                   getTargetRegister(1), getSourceRegister(0),
                                   getSourceRegister(1), cursor));
      cg()->traceRAInstruction(
          cursor = generateLabelInstruction(cg(), TR::InstOpCode::label,
    ...
    case TR::InstOpCode::lrem:
      ...
      if (TR::Compiler->target.cpu.id() >= TR_PPCp9) {
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), TR::InstOpCode::modsd, currentNode,
                                     getTargetRegister(1), getSourceRegister(0),
                                     getSourceRegister(1), cursor));
      } else {
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     ...
                                     getSourceRegister(1), cursor));
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), TR::InstOpCode::mulld, currentNode,
                                     getTargetRegister(1), getSourceRegister(1),
                                     getTargetRegister(1), cursor));
        cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                     cg(), TR::InstOpCode::subf, currentNode,
    ...
    case TR::InstOpCode::d2i:
      cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                   ...
                                   getSourceRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                   cg(), TR::InstOpCode::fctiwz, currentNode,
                                   getTargetRegister(1), getSourceRegister(0),
                                   cursor));
      cg()->traceRAInstruction(cursor = generateTrg1ImmInstruction(
                                   cg(), TR::InstOpCode::li, currentNode,
                                   getTargetRegister(2), 0, cursor));

      if (TR::Compiler->target.cpu.id() < TR_PPCp8) {
        tempMR = new (cg()->trHeapMemory())
            TR::MemoryReference(cg()->getStackPointerRegister(), -8, 8, cg());
        cg()->traceRAInstruction(cursor = generateMemSrc1Instruction(
                                     cg(), TR::InstOpCode::stfd, currentNode,
      ...
      if (TR::Compiler->target.cpu.id() >= TR_PPCp8)
        cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                     cg(), TR::InstOpCode::mfvsrwz, currentNode,
                                     getTargetRegister(2), getTargetRegister(1),
                                     cursor));
      else
        cg()->traceRAInstruction(
            cursor = generateTrg1MemInstruction(
                cg(), TR::InstOpCode::lwz, currentNode, getTargetRegister(2),
                new (cg()->trHeapMemory())
    ...
    case TR::InstOpCode::d2l:
      cg()->traceRAInstruction(cursor = generateTrg1Src2Instruction(
                                   ...
                                   getSourceRegister(0), cursor));
      cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                   cg(), TR::InstOpCode::fctidz, currentNode,
                                   getTargetRegister(1), getSourceRegister(0),
                                   cursor));
      ...
      if (TR::Compiler->target.is64Bit()) {
        if (TR::Compiler->target.cpu.id() >= TR_PPCp8 &&
          ...
          cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                       cg(), TR::InstOpCode::mfvsrd,
                                       currentNode, getTargetRegister(2),
                                       getTargetRegister(1), cursor));
        else
          cg()->traceRAInstruction(cursor = generateTrg1MemInstruction(
                                       cg(), TR::InstOpCode::ld, currentNode,
        ...
        cg()->traceRAInstruction(
            cursor = generateTrg1MemInstruction(
                cg(), TR::InstOpCode::lwz, currentNode, getTargetRegister(3),
                new (cg()->trHeapMemory())
                    TR::MemoryReference(currentNode, *tempMR, 4, 4, cg()),
                cursor));
      }
    ...
    case TR::InstOpCode::iternary: {
      ...
      if (useRegPairForResult()) {
        ...
        cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                     cg(), getOpCode2Value(), currentNode,
                                     getTargetRegister(2), getSourceRegister(2),
                                     cursor));
      } else {
        cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                     cg(), getOpCode2Value(), currentNode,
      ...
      if (useRegPairForResult()) {
        if (useRegPairForCond()) {
          cg()->traceRAInstruction(cursor = generateTrg1Src1ImmInstruction(
                                       cg(), TR::InstOpCode::cmpi4, currentNode,
                                       getTargetRegister(0),
                                       getSourceRegister(5), 0, cursor));
          cg()->traceRAInstruction(
              cursor = generateConditionalBranchInstruction(
                  cg(), TR::InstOpCode::bne, currentNode, label2,
                  getTargetRegister(0), cursor));
        }
      } else {
        if (useRegPairForCond()) {
      ...
      if (useRegPairForResult()) {
        cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                     cg(), getOpCode2Value(), currentNode,
                                     getTargetRegister(1), getSourceRegister(3),
                                     cursor));
        cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                     cg(), getOpCode2Value(), currentNode,
                                     getTargetRegister(2), getSourceRegister(4),
                                     cursor));
      } else {
        cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(
                                     cg(), getOpCode2Value(), currentNode,
                                     getTargetRegister(1), getSourceRegister(2),
                                     cursor));
      }
      cg()->traceRAInstruction(
          cursor = generateLabelInstruction(cg(), TR::InstOpCode::label,
  ...
  if (_conditions != NULL)
    _conditions->assignPreConditionRegisters(this->getPrev(), kindToBeAssigned,
                                             cg());
}
