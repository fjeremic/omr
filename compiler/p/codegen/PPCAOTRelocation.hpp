...
public:
  ...
  PPCRelocation(TR::Instruction *src, uint8_t *trg,
...
public:
  PPCPairedRelocation(TR::Instruction *src1, TR::Instruction *src2,
                      uint8_t *trg, TR_ExternalRelocationTargetKind k,
                      TR::Node *node)
...
// This class has nothing to do with AOT, but for the lack of more appropriate
// locations this class is defined here.
//
// PPC Specific Relocation: update the immediate fields of a pair of ppc
// instructions with the absolute address of a label (extended to 64bit as
// well).  For example:
//   lis  gr3, addr_hi
...
public:
  PPCPairedLabelAbsoluteRelocation(TR::Instruction *src1, TR::Instruction *src2,
                                   TR::Instruction *src3, TR::Instruction *src4,
                                   TR::LabelSymbol *label)
      : TR::LabelRelocation(0, label), _instr1(src1), _instr2(src2),
        _instr3(src3), _instr4(src4) {}
...
typedef TR::PPCPairedLabelAbsoluteRelocation
    TR_PPCPairedLabelAbsoluteRelocation;
