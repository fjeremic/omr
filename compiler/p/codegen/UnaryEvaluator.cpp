...
TR::Register *
OMR::Power::TreeEvaluator::iconstEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::Power::TreeEvaluator::aconstEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::Power::TreeEvaluator::lconstEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::Power::TreeEvaluator::libmFuncEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg) {
...
TR::Register *
OMR::Power::TreeEvaluator::strcmpEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::Power::TreeEvaluator::strcFuncEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg) {
...
TR::Register *
OMR::Power::TreeEvaluator::dfloorEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Node *firstChild = node->getFirstChild();
