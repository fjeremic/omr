                                           ...
                                           TR::CodeGenerator* cg)
{
      ...
      cg->fe()->isUnloadAssumptionRequired(
        cg->fe()
          ->createResolvedMethod(
            cg->trMemory(), (TR_OpaqueMethodBlock*)node->getAddress(), method)
          ->classOfMethod(),
        method);
  ...
  if (isClass &&
    ...
    loadAddressConstantInSnippet(cg,
                                 node,
                                 address,
                                 trgReg,
                                 NULL,
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  if ((highValue >= LOWER_IMMED && highValue <= UPPER_IMMED) ||
    ...
    generateTrg1Src1ImmInstruction(
      cg, TR::InstOpCode::addi2, node, highReg, lowReg, difference);
  }
...
TR::Register*
OMR::Power::TreeEvaluator::inegEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg;
  ...
  generateTrg1Src1Instruction(
    cg, TR::InstOpCode::neg, node, trgReg, sourceRegister);
...
TR::Register*
OMR::Power::TreeEvaluator::lnegEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::Power::TreeEvaluator::iabsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg = cg->allocateRegister();
  ...
  generateTrg1Src1ImmInstruction(
    cg, TR::InstOpCode::srawi, node, trgReg, sourceRegister, 31);
  generateTrg1Src2Instruction(
    cg, TR::InstOpCode::XOR, node, tmpReg, sourceRegister, trgReg);
  generateTrg1Src2Instruction(
    cg, TR::InstOpCode::subfc, node, trgReg, trgReg, tmpReg);
...
TR::Register*
OMR::Power::TreeEvaluator::labsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (TR::Compiler->target.is64Bit()) {
    ...
    generateTrg1Src1ImmInstruction(
      cg, TR::InstOpCode::sradi, node, trgReg, sourceRegister, 63);
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::XOR, node, tmpReg, sourceRegister, trgReg);
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::subfc, node, trgReg, trgReg, tmpReg);
    ...
    generateTrg1Src2Instruction(cg,
                                ...
                                tempReg);
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::subfc, node, lowReg, tempReg, lowReg);
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::subfe, node, highReg, tempReg, highReg);
...
TR::Register*
OMR::Power::TreeEvaluator::fabsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg;
  ...
  TR::Register* sourceRegister = cg->evaluate(firstChild);
  generateTrg1Src1Instruction(
    cg, TR::InstOpCode::fabs, node, trgReg, sourceRegister);
  cg->decReferenceCount(firstChild);
  return node->setRegister(trgReg);
}

TR::Register*
OMR::Power::TreeEvaluator::dabsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg;
...
TR::Register*
OMR::Power::TreeEvaluator::b2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (node->isUnneededConversion() ||
    ...
    generateTrg1Src1Instruction(
      cg, TR::InstOpCode::extsb, node, trgReg, cg->evaluate(child));
  }
  node->setRegister(trgReg);
...
TR::Register*
OMR::Power::TreeEvaluator::b2aEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
...
TR::Register*
OMR::Power::TreeEvaluator::s2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg = 0;

  TR_ASSERT(node->getOpCodeValue() == TR::s2i,
            "s2iEvaluator called for a %s node",
    ...
    if (!trgReg && child->getOpCode().isMemoryReference() &&
      ...
      if (node->getFirstChild()->getOpCodeValue() == TR::irsload) {
        ...
        generateTrg1MemInstruction(
          cg, TR::InstOpCode::lhbrx, node, trgReg, tempMR);
        generateTrg1Src1Instruction(
          cg, TR::InstOpCode::extsh, node, trgReg, trgReg);
      } else
#endif
        generateTrg1MemInstruction(
          cg, TR::InstOpCode::lha, node, trgReg, tempMR);
      ...
      if (!trgReg) {
        ...
        if (child->getReferenceCount() == 1) {
          ...
          trgReg = cg->allocateRegister();
          generateTrg1Src1Instruction(
            cg, TR::InstOpCode::extsh, node, trgReg, trgRegOld);
        }
...
TR::Register*
OMR::Power::TreeEvaluator::b2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  if (TR::Compiler->target.is64Bit()) {
    TR::Register* trgReg = cg->allocateRegister();
  ...
  } else // 32 bit target
  {
    ...
    TR::RegisterPair* trgReg = cg->allocateRegisterPair(lowReg, highReg);
    generateTrg1Src1Instruction(
      cg, TR::InstOpCode::extsb, node, lowReg, cg->evaluate(child));
    generateTrg1Src1ImmInstruction(
      cg, TR::InstOpCode::srawi, node, highReg, trgReg->getLowOrder(), 31);
    node->setRegister(trgReg);
    cg->decReferenceCount(child);
    return trgReg;
  }
...
// also handles i2l
TR::Register*
OMR::Power::TreeEvaluator::s2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  if (TR::Compiler->target.is64Bit()) {
...
// also handles su2l
TR::Register*
OMR::Power::TreeEvaluator::iu2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  if (TR::Compiler->target.is64Bit()) {
  ...
  } else // 32 bit target
  {
    ...
    generateTrg1ImmInstruction(
      cg, TR::InstOpCode::li, node, trgReg->getHighOrder(), 0);
    node->setRegister(trgReg);
    cg->decReferenceCount(child);
    return trgReg;
  }
...
TR::Register*
OMR::Power::TreeEvaluator::su2aEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
...
TR::Register*
OMR::Power::TreeEvaluator::su2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* sourceRegister = NULL;
  TR::Register* trgReg = cg->allocateRegister();
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    generateTrg1Src1Imm2Instruction(
      cg, TR::InstOpCode::rlwinm, node, trgReg, cg->evaluate(child), 0, 0xffff);
    cg->decReferenceCount(child);
  }
  return node->setRegister(trgReg);
}
...
TR::Register*
OMR::Power::TreeEvaluator::s2aEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
...
// also handles s2b
TR::Register*
OMR::Power::TreeEvaluator::i2bEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
...
TR::Register*
OMR::Power::TreeEvaluator::i2cEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* sourceRegister = NULL;
  TR::Register* trgReg = cg->allocateRegister();
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    TR::MemoryReference* tempMR =
      new (cg->trHeapMemory()) TR::MemoryReference(child, 2, cg);
    tempMR->addToOffset(
      node, TR::Compiler->target.cpu.isBigEndian() ? 2 : 0, cg);
    generateTrg1MemInstruction(cg, TR::InstOpCode::lhz, node, trgReg, tempMR);
    tempMR->decNodeReferenceCounts(cg);
  } else {
    generateTrg1Src1Imm2Instruction(
...
TR::Register*
OMR::Power::TreeEvaluator::i2sEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg = cg->allocateRegister();
  ...
  if (TR::Compiler->target.cpu.id() !=
    ...
    generateTrg1Src1Instruction(
      cg, TR::InstOpCode::extsh, node, trgReg, cg->evaluate(child));
    cg->decReferenceCount(child);
  }
...
TR::Register*
OMR::Power::TreeEvaluator::i2aEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
    return TR::TreeEvaluator::s2lEvaluator(node, cg);
  else
...
TR::Register*
OMR::Power::TreeEvaluator::iu2aEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
    return TR::TreeEvaluator::iu2lEvaluator(node, cg);
  else
...
TR::Register*
OMR::Power::TreeEvaluator::l2bEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg;
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    trgReg = cg->allocateRegister();
    tempMR->addToOffset(
      node, TR::Compiler->target.cpu.isBigEndian() ? 7 : 0, cg);
    ...
    if (child->getReferenceCount() == 1 || !cg->useClobberEvaluate()) {
      ...
      if (TR::Compiler->target.is64Bit())
        ...
        generateTrg1Src1Instruction(
          cg, TR::InstOpCode::mr, node, trgReg, temp->getLowOrder());
    }
    node->setRegister(trgReg);
    cg->decReferenceCount(child);
  }
...
// is this used?
TR::Register*
OMR::Power::TreeEvaluator::l2buEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg = cg->allocateRegister();
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    cg->decReferenceCount(child);
    generateTrg1Src1Imm2Instruction(
      cg, TR::InstOpCode::rlwinm, node, trgReg, tempReg, 0, 0xff);
  }
...
TR::Register*
OMR::Power::TreeEvaluator::l2cEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* temp;
  TR::Register* trgReg = cg->allocateRegister();
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    TR::MemoryReference* tempMR =
      new (cg->trHeapMemory()) TR::MemoryReference(child, 2, cg);
    tempMR->addToOffset(
      node, TR::Compiler->target.cpu.isBigEndian() ? 6 : 0, cg);
    generateTrg1MemInstruction(cg, TR::InstOpCode::lhz, node, trgReg, tempMR);
    tempMR->decNodeReferenceCounts(cg);
  } else {
    if (TR::Compiler->target.is64Bit())
...
TR::Register*
OMR::Power::TreeEvaluator::l2sEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg = cg->allocateRegister();
...
TR::Register*
OMR::Power::TreeEvaluator::l2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg;
  TR::Register* temp;
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    tempMR->addToOffset(
      node, TR::Compiler->target.cpu.isBigEndian() ? 4 : 0, cg);
...
TR::Register*
OMR::Power::TreeEvaluator::l2aEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Compilation* comp = cg->comp();
  if (TR::Compiler->target.is64Bit()) {
...
TR::Register*
OMR::Power::TreeEvaluator::su2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* sourceRegister = NULL;
  if (TR::Compiler->target.is64Bit()) {
  ...
  } else // 32 bit target
  {
    ...
    if (child->getReferenceCount() == 1 &&
      ...
      TR::MemoryReference* tempMR =
        new (cg->trHeapMemory()) TR::MemoryReference(child, 2, cg);
      generateTrg1MemInstruction(
        cg, TR::InstOpCode::lhz, node, trgReg->getLowOrder(), tempMR);
      tempMR->decNodeReferenceCounts(cg);
    } else {
      generateTrg1Src1Imm2Instruction(cg,
                                      TR::InstOpCode::rlwinm,
...
TR::Register*
OMR::Power::TreeEvaluator::bu2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg;
  ...
  if (child->getOpCode().isMemoryReference()) {
    ...
    if (!trgReg && child->getOpCode().isMemoryReference() && trgReg == NULL) {
      ...
      trgReg = cg->allocateRegister();
      generateTrg1Src1Imm2Instruction(
        cg, TR::InstOpCode::rlwinm, node, trgReg, cg->evaluate(child), 0, 0xff);
    }
  }
...
TR::Register*
OMR::Power::TreeEvaluator::bu2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg;
  ...
  } else // 32 bit target
  {
    ...
    if (child->getOpCode().isMemoryReference()) {
      ...
      generateTrg1Src1Imm2Instruction(
        cg, TR::InstOpCode::rlwinm, node, lowReg, cg->evaluate(child), 0, 0xff);
    }
...
TR::Register*
OMR::Power::TreeEvaluator::bu2aEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
...
TR::Register*
OMR::Power::TreeEvaluator::a2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
    return TR::TreeEvaluator::l2iEvaluator(node, cg);
  else
...
TR::Register*
OMR::Power::TreeEvaluator::a2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
    return TR::TreeEvaluator::passThroughEvaluator(node, cg);
  else
...
TR::Register*
OMR::Power::TreeEvaluator::a2bEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
...
TR::Register*
OMR::Power::TreeEvaluator::a2sEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is64Bit())
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  generateTrg1Src1Instruction(
    cg, TR::InstOpCode::fcfid, node, trgReg, trgReg); // trgReg = trunc(x)
  generateTrg1Src2Instruction(cg,
                              TR::InstOpCode::fadd,
                              node,
                              tmp2Reg,
  ...
  generateTrg1Src3Instruction(
    cg, TR::InstOpCode::fsel, node, trgReg, tmp3Reg, trgReg, tmp2Reg);

  // if x is a NaN or out of range  (i.e. fabs(x)>2**52), then floor(x) = x,
  // otherwise the value computed above

  generateTrg1Src1Instruction(
    cg, TR::InstOpCode::fabs, node, tmp4Reg, srcReg); // tmp4  = fabs(x)
  ...
  generateTrg1Src3Instruction(
    cg, TR::InstOpCode::fsel, node, trgReg, tmp5Reg, trgReg, srcReg);
