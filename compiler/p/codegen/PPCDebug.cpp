...
void TR_Debug::print(TR::FILE* pOutFile, TR::PPCTrg1Src1ImmInstruction* instr)
{
    ...
    if (op == TR::InstOpCode::subfic || op == TR::InstOpCode::addi || op == TR::InstOpCode::addi2 || op == TR::InstOpCode::addic || op == TR::InstOpCode::addic_r || op == TR::InstOpCode::addis || op == TR::InstOpCode::mulli)
