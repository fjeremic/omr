...
public:
  ...
  void setUpCursor(int32_t c)
  {
    _upCursor = c;
  }

  int32_t getUpCursorAfterPermanentEntries()
  {
    return _upCursorAfterPermanentEntries;
  }
  void setUpCursorAfterPermanentEntries(int32_t c)
  {
    _upCursorAfterPermanentEntries = c;
  }
  int32_t getDownCursor()
  {
    return _downCursor;
  }
  void setDownCursor(int32_t d)
  {
    _downCursor = d;
  }
  int32_t getDownCursorAfterPermanentEntries()
  {
    return _downCursorAfterPermanentEntries;
  }
  void setDownCursorAfterPermanentEntries(int32_t d)
  {
    _downCursorAfterPermanentEntries = d;
  }
  void setPermanentEntriesAddtionComplete(bool b)
  {
    _permanentEntriesAddtionComplete = b;
  };
  bool getPermanentEntriesAddtionComplete()
  {
    return _permanentEntriesAddtionComplete;
  }
  ...
  void setTOCSize(uint32_t tocSize)
  {
    _tocSize = tocSize;
  }

  struct TR_tocHashEntry* getHashMap()
  {
    return _hashMap;
  }
  void setHashMap(TR_tocHashEntry* m)
  {
    _hashMap = m;
  }

  int32_t getLastFloatCursor()
  {
    return _lastFloatCursor;
  }
  void setLastFloatCursor(int32_t c)
  {
    _lastFloatCursor = c;
  }
  ...
  void setHashTop(int32_t c)
  {
    _hashTop = c;
  }

  int32_t getCollisionCursor()
  {
    return _collisionCursor;
  }
  void setCollisionCursor(int32_t c)
  {
    _collisionCursor = c;
  }

  int8_t* getNameAStart()
  {
    return _nameAStart;
  };
  void setNameAStart(int8_t* p)
  {
    _nameAStart = p;
  }

  int8_t* getNameACursor()
  {
    return _nameACursor;
  }
  void setNameACursor(int8_t* p)
  {
    _nameACursor = p;
  }

  int64_t getNameASize()
  {
    return _nameASize;
  }
  void setNameASize(int64_t s)
  {
    _nameASize = s;
  }

  TR::Monitor* getTOCMonitor() const
  {
    return _tocMonitor;
  }
  void setTOCMonitor(TR::Monitor* m)
  {
    _tocMonitor = m;
  }
};
