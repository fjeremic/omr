...
static void
switchDispatch(TR::Node* node, bool fromTableEval, TR::CodeGenerator* cg);
static bool
isGlDepsUnBalanced(TR::Node* node, TR::CodeGenerator* cg);
static void
lookupScheme1(TR::Node* node,
              bool unbalanced,
              bool fromTableEval,
              TR::CodeGenerator* cg);
static void
lookupScheme2(TR::Node* node,
              bool unbalanced,
              bool fromTableEval,
              TR::CodeGenerator* cg);
static void
lookupScheme3(TR::Node* node, bool unbalanced, TR::CodeGenerator* cg);
static void
lookupScheme4(TR::Node* node, TR::CodeGenerator* cg);
...
TR::Register*
OMR::Power::TreeEvaluator::compareIntsForOrder(
  ...
  bool likeliness)
{
  ...
  if (secondChild->getOpCode().isLoadConst()) {
    ...
    if (isSigned) {
      ...
      if (value >= LOWER_IMMED && value <= UPPER_IMMED) {
        generateTrg1Src1ImmInstruction(
          cg, TR::InstOpCode::cmpi4, node, condReg, src1Reg, value);
      } else {
      ...
      if (node->getOpCodeValue() == TR::ifbucmplt ||
        ...
        generateTrg1Src1Imm2Instruction(
          cg, TR::InstOpCode::rlwinm, node, tReg, src1Reg, 0, 0xff);
        value &= (uint64_t)0xff;
        ...
        newReg = true;
        generateTrg1Src1Imm2Instruction(
          cg, TR::InstOpCode::rlwinm, node, tReg, src1Reg, 0, 0xffff);
      ...
      if (value <= (uint64_t)0xFFFF)
        generateTrg1Src1ImmInstruction(
          cg, TR::InstOpCode::cmpli4, node, condReg, tReg, value);
      else {
        ...
        if (node->getOpCodeValue() == TR::ifbucmplt ||
          ...
          sNewReg = true;
          generateTrg1Src1Imm2Instruction(
            cg, TR::InstOpCode::rlwinm, node, secondReg, secondReg, 0, 0xff);
        } else if (node->getOpCodeValue() == TR::ifsucmplt ||
                   node->getOpCodeValue() == TR::ifsucmple ||
                   node->getOpCodeValue() == TR::ifsucmpgt ||
                   node->getOpCodeValue() == TR::ifsucmpge) {
          ...
          sNewReg = true;
          generateTrg1Src1Imm2Instruction(
            cg, TR::InstOpCode::rlwinm, node, secondReg, secondReg, 0, 0xffff);
        } else
          secondReg = cg->evaluate(secondChild);

        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::cmpl4, node, condReg, tReg, secondReg);
    ...
    if (node->getOpCodeValue() == TR::ifbucmplt ||
      ...
      generateTrg1Src1Imm2Instruction(
        cg, TR::InstOpCode::rlwinm, node, src2Reg, src2Reg, 0, 0xff);
    } else if (node->getOpCodeValue() == TR::ifsucmplt ||
               node->getOpCodeValue() == TR::ifsucmple ||
               node->getOpCodeValue() == TR::ifsucmpgt ||
               node->getOpCodeValue() == TR::ifsucmpge) {
      ...
      src2Reg = cg->gprClobberEvaluate(secondChild);
      generateTrg1Src1Imm2Instruction(
        cg, TR::InstOpCode::rlwinm, node, src2Reg, src2Reg, 0, 0xffff);
    } else {
      tReg = src1Reg;
    ...
    if (isSigned)
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::cmp4, node, condReg, tReg, src2Reg);
    else
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::cmpl4, node, condReg, tReg, src2Reg);
...
static void
fixDepsForLongCompare(TR::RegisterDependencyConditions* deps,
...
static TR::Register*
compareLongsForOrderWithAnalyser(TR::InstOpCode::Mnemonic branchOp,
                                 ...
                                 bool likeliness)
{
  ...
  if (firstHighZero && secondHighZero) {
    ...
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::cmpl4, node, condReg, src1Low, src2Low);
    ...
    if (deps) {
      ...
      if (isHint && TR::Compiler->target.cpu.id() >= TR_PPCgp)
        generateConditionalBranchInstruction(
          cg, branchOp, likeliness, node, destinationLabel, condReg);
      else
        generateConditionalBranchInstruction(
          cg, branchOp, node, destinationLabel, condReg);
    }
  } else {
    if (deps == NULL)
...
TR::Register*
OMR::Power::TreeEvaluator::compareLongsForOrder(
  TR::InstOpCode::Mnemonic branchOp,
  TR::InstOpCode::Mnemonic reversedBranchOp,
  TR::LabelSymbol* dstLabel,
  TR::Node* node,
  ...
  bool likeliness)
{
  ...
  if (TR::Compiler->target.is64Bit()) {
    ...
    if (secondChild->getOpCode().isLoadConst() &&
      ...
      if (isSigned)
        generateTrg1Src1ImmInstruction(
          cg, TR::InstOpCode::cmpi8, node, condReg, src1Reg, value);
      else
        generateTrg1Src1ImmInstruction(
          cg, TR::InstOpCode::cmpli8, node, condReg, src1Reg, value);
    } else {
      if (isSigned)
  ...
  } else // 32 bit target
  {
    ...
    if ((firstChild->isHighWordZero() || secondChild->isHighWordZero()) &&
        !(secondChild->getOpCode().isLoadConst() &&
          secondChild->getRegister() == NULL)) {
      return compareLongsForOrderWithAnalyser(branchOp,
                                              reversedBranchOp,
                                              condReg,
                                              dstLabel,
                                              deps,
...
static TR::InstOpCode::Mnemonic
cmp2branch(TR::ILOpCodes op, TR::CodeGenerator* cg)
{
  switch (op) {
    case TR::icmpeq:
    case TR::acmpeq:
...
static TR::InstOpCode::Mnemonic
cmp2cmp(TR::ILOpCodes op, TR::CodeGenerator* cg)
{
  switch (op) {
    case TR::icmpeq:
    case TR::icmpne:
...
static TR::InstOpCode::Mnemonic
cmp2cmpi(TR::ILOpCodes op, TR::CodeGenerator* cg)
{
  switch (op) {
    case TR::icmpeq:
    case TR::icmpne:
  ...
  TR::Register* resultReg =
    two_reg
      ...
      : (type.getDataType() == TR::Float
           ...
           : (type.getDataType() == TR::Double ? cg->allocateRegister(TR_FPR)
  ...
  if (firstChild->getOpCode().isBooleanCompare() &&
    ...
    if (compare_type.isIntegral() || compare_type.isAddress()) {
      ...
      if (useImmediateCompare) {
        generateTrg1Src1ImmInstruction(
          cg,
          cmp2cmpi(firstChild->getOpCodeValue(), cg),
          node,
          ccr,
          cmp1Reg,
          value);
      ...
      generateConditionalBranchInstruction(
        cg, branch_opcode, node, doneLabel, ccr);
      if (two_reg) {
        generateTrg1Src1Instruction(cg,
                                    move_opcode,
                                    node,
      ...
      cmp2Reg = cg->evaluate(firstChild->getSecondChild());
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::fcmpu, node, ccr, cmp1Reg, cmp2Reg);
      ...
      if (branch_opcode2 != TR::InstOpCode::bad)
        generateConditionalBranchInstruction(
          cg, branch_opcode2, node, doneLabel, ccr);
    ...
    generateDepLabelInstruction(
      cg, TR::InstOpCode::label, node, doneLabel, dep);
...
TR::Register*
OMR::Power::TreeEvaluator::compareIntsForEquality(
  TR::InstOpCode::Mnemonic branchOp,
  TR::LabelSymbol* dstLabel,
  TR::Node* node,
  TR::CodeGenerator* cg,
  ...
  bool likeliness)
{
  ...
  if (firstChild->getOpCodeValue() == TR::b2i &&
    ...
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::cmpl4, node, condReg, src1Reg, src2Reg);
    ...
    if (node->getNumChildren() == 3) {
      ...
      generateDepConditionalBranchInstruction(
        cg, opCode, node, label, condReg, conditions);
    }
  ...
  bool likeliness)
{
    ...
    if (firstShiftAmountNode->getOpCode().isLoadConst() &&
      ...
      if (firstShiftValue > 32 && secondShiftValue > 32) {
        ...
        generateTrg1Src1ImmInstruction(cg,
                                       ...
                                       node,
                                       firstShiftResultReg,
                                       firstShiftSourceReg->getHighOrder(),
                                       firstShiftValue - 32);
        firstChild->setRegister(firstShiftResultReg);
        generateTrg1Src1ImmInstruction(cg,
                                       TR::InstOpCode::srawi,
                                       node,
                                       secondShiftResultReg,
                                       secondShiftSourceReg->getHighOrder(),
                                       secondShiftValue - 32);
        ...
        if (node->getOpCode().isIf()) {
          ...
          TR::Node::recreate(
            node,
            node->getOpCode().isCompareTrueIfEqual() ? TR::icmpeq : TR::icmpne);
        }
        return TR::TreeEvaluator::compareIntsForEquality(
  ...
  if (TR::Compiler->target.is64Bit()) {
...

    {
      ...
      if (isSigned)
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::cmp8, node, condReg, src1Reg, src2Reg);
      else
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::cmpl8, node, condReg, src1Reg, src2Reg);
    }
                                             ...
                                             TR::CodeGenerator* cg)
{
  TR::TreeEvaluator::compareLongsForOrder(
    TR::InstOpCode::blt, TR::InstOpCode::bgt, node, cg, true);
  return NULL;
}
...
{
  TR::TreeEvaluator::compareLongsForOrder(
    TR::InstOpCode::bge, TR::InstOpCode::ble, node, cg, true);
  return NULL;
}
...
{
  TR::TreeEvaluator::compareLongsForOrder(
    TR::InstOpCode::bgt, TR::InstOpCode::blt, node, cg, true);
  return NULL;
}
...
{
  TR::TreeEvaluator::compareLongsForOrder(
    TR::InstOpCode::ble, TR::InstOpCode::bge, node, cg, true);
  return NULL;
}
...
{
  TR::TreeEvaluator::compareLongsForOrder(
    TR::InstOpCode::blt, TR::InstOpCode::bgt, node, cg, false);
  return NULL;
}
...
{
  TR::TreeEvaluator::compareLongsForOrder(
    TR::InstOpCode::bge, TR::InstOpCode::ble, node, cg, false);
  return NULL;
}
...
{
  TR::TreeEvaluator::compareLongsForOrder(
    TR::InstOpCode::bgt, TR::InstOpCode::blt, node, cg, false);
  return NULL;
}
...
{
  TR::TreeEvaluator::compareLongsForOrder(
    TR::InstOpCode::ble, TR::InstOpCode::bge, node, cg, false);
  return NULL;
}
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  if (secondChild->getOpCode().isLoadConst() &&
    ...
    if (secondChild->getOpCode().isLoadConst() &&
      ...
      TR::Register* src2Reg = cg->evaluate(secondChild);
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::subf, node, temp1Reg, src2Reg, src1Reg);
      killTemp1 = true;
    }
  }
  generateTrg1Src1Instruction(
    cg, TR::InstOpCode::cntlzw, node, temp2Reg, temp1Reg);
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  if (TR::Compiler->target.is64Bit()) {
    ...
    generateTrg1Src1ImmInstruction(
      cg, TR::InstOpCode::xori, node, trgReg, temp2Reg, 1);
  } else {
    generateTrg1Src1ImmInstruction(
      cg, TR::InstOpCode::addic, node, temp2Reg, temp1Reg, -1);
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::subfe, node, trgReg, temp2Reg, temp1Reg);
  }
...
void
OMR::Power::TreeEvaluator::genBranchSequence(
  TR::Node* node,
  TR::Register* src1Reg,
  TR::Register* src2Reg,
  TR::Register* trgReg,
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  if (secondChild->getOpCode().isLoadConst() &&
    ...
    if (value == 0) {
      ...
      if (value > 0) {
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::OR, node, temp1Reg, temp2Reg, src1Reg);
      } else // if (value < 0)
      {
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::AND, node, temp1Reg, temp2Reg, src1Reg);
      }
      cg->stopUsingRegister(temp2Reg);
    }
    ...
    TR::Register* src2Reg = cg->evaluate(secondChild);
    TR::TreeEvaluator::genBranchSequence(node,
                                         src1Reg,
                                         src2Reg,
                                         trgReg,
                                         TR::InstOpCode::blt,
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  if (secondChild->getOpCode().isLoadConst() &&
    ...
    if (value == 0) {
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::srawi, node, temp1Reg, src1Reg, 31);
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::addic, node, trgReg, temp1Reg, 1);
    } else {
      TR::Register* temp2Reg = addConstantToInteger(node, src1Reg, -value, cg);
      if (value > 0) {
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::nor, node, temp1Reg, temp2Reg, src1Reg);
      } else // if (value < 0)
      {
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::nand, node, temp1Reg, temp2Reg, src1Reg);
      }
      cg->stopUsingRegister(temp2Reg);
      generateShiftRightLogicalImmediate(cg, node, trgReg, temp1Reg, 31);
    }
                                           ...
                                           TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit()) {
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmp4, TR::InstOpCode::beq, node, cg);
  }
  ...
  generateTrg1Src1Instruction(
    cg, TR::InstOpCode::cntlzd, node, temp2Reg, temp1Reg);
                                           ...
                                           TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit()) {
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmp4, TR::InstOpCode::bne, node, cg);
  }
                                           ...
                                           TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit())
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmp4, TR::InstOpCode::blt, node, cg);
                                           ...
                                           TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit())
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmp4, TR::InstOpCode::ble, node, cg);
                                           ...
                                           TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit())
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmp4, TR::InstOpCode::bge, node, cg);
  ...
  if (secondChild->getOpCode().isLoadConst() &&
    ...
    if (value == 0) {
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::sradi, node, temp1Reg, src1Reg, 63);
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::addic, node, trgReg, temp1Reg, 1);
    } else if (value == 1) {
      TR::Register* temp2Reg = cg->allocateRegister();
      generateTrg1Src1Instruction(
        cg, TR::InstOpCode::neg, node, temp1Reg, src1Reg);
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::andc, node, temp2Reg, temp1Reg, src1Reg);
                                           ...
                                           TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit())
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmp4, TR::InstOpCode::bgt, node, cg);
                                            ...
                                            TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit())
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmpl4, TR::InstOpCode::blt, node, cg);
                                            ...
                                            TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit())
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmpl4, TR::InstOpCode::ble, node, cg);
                                            ...
                                            TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit())
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmpl4, TR::InstOpCode::bge, node, cg);
                                            ...
                                            TR::CodeGenerator* cg)
{
  if (TR::Compiler->target.is32Bit())
    return compareLongAndSetOrderedBoolean(
      TR::InstOpCode::cmpl4, TR::InstOpCode::bgt, node, cg);
...
TR::Register*
OMR::Power::TreeEvaluator::lcmpEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg = cg->allocateRegister();
  TR::Node* firstChild = node->getFirstChild();
  TR::Register* src1Reg = cg->evaluate(firstChild);
  ...
  if (TR::Compiler->target.is64Bit()) {
    if (secondChild->getOpCode().isLoadConst() &&
      ...
      if (TR::Compiler->target.cpu.id() >= TR_PPCp9) {
        TR::Register* condReg = cg->allocateRegister(TR_CCR);
        generateTrg1Src1ImmInstruction(
          cg, TR::InstOpCode::cmpi8, node, condReg, src1Reg, 0);
        generateTrg1Src1Instruction(
          cg, TR::InstOpCode::setb, node, trgReg, condReg);
        cg->stopUsingRegister(condReg);
      } else {
        temp1Reg = cg->allocateRegister();

        generateTrg1Src1ImmInstruction(
          cg, TR::InstOpCode::sradi, node, trgReg, src1Reg, 63);
        generateTrg1Src1ImmInstruction(
          cg, TR::InstOpCode::addic, node, temp1Reg, src1Reg, -1);
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::adde, node, trgReg, trgReg, trgReg);
      ...
      if (TR::Compiler->target.cpu.id() >= TR_PPCp9) {
        ...
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::subfc, node, temp3Reg, src1Reg, src2Reg);
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::subfe, node, trgReg, temp2Reg, temp1Reg);
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::subfc, node, temp2Reg, temp3Reg, trgReg);
        generateTrg1Src1Instruction(
          cg, TR::InstOpCode::subfze, node, trgReg, trgReg);
    ...
    if (secondChild->getOpCode().isLoadConst() &&
      ...
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::srawi, node, temp1Reg, src1Reg->getHighOrder(), 31);
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::subfic, node, temp2Reg, src1Reg->getLowOrder(), 0);
      generateTrg1Src1Instruction(
        cg, TR::InstOpCode::subfze, node, temp3Reg, src1Reg->getHighOrder());
      generateShiftRightLogicalImmediate(cg, node, temp2Reg, temp3Reg, 31);
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::OR, node, trgReg, temp1Reg, temp2Reg);
...
static void
collectGlDeps(TR::Node* node, TR_BitVector* vector)
{
  int32_t ii;
              ...
              TR::CodeGenerator* cg)
{
  ...
  if (two_reg) {
    ...
    TR::addDependency(conditions,
                      ...
                      cg);
    TR::addDependency(
      conditions, selector->getLowOrder(), TR::RealRegister::NoReg, TR_GPR, cg);
  } else
    TR::addDependency(
      conditions, selector, TR::RealRegister::NoReg, TR_GPR, cg);

  TR::addDependency(
    conditions, cndRegister, TR::RealRegister::NoReg, TR_CCR, cg);

  acond = conditions;
  if (secondChild->getNumChildren() > 0 && !unbalanced) {
    cg->evaluate(secondChild->getFirstChild());
    acond = acond->clone(cg,
  ...
  for (int i = 2; i < total; i++) {
    ...
    if (isInt64) {
      ...
      if (TR::Compiler->target.is64Bit()) {
        generateTrg1Src1ImmInstruction(
          cg, TR::InstOpCode::cmpi8, node, cndRegister, selector, value);
      } else {
        generateTrg1Src1ImmInstruction(cg,
                                       TR::InstOpCode::cmpi4,
                                       node,
                                       ...
                                       0);
        generateConditionalBranchInstruction(
          cg, TR::InstOpCode::bne, node, toDefaultLabel, cndRegister);
        generateTrg1Src1ImmInstruction(cg,
                                       TR::InstOpCode::cmpi4,
                                       node,
                                       cndRegister,
  ...
  generateDepLabelInstruction(
    ...
    TR::InstOpCode::b,
    node,
    secondChild->getBranchDestination()->getNode()->getLabel(),
    acond);
              ...
              TR::CodeGenerator* cg)
{
  ...
  if (two_reg) {
    ...
    TR::addDependency(
      conditions, valRegister, TR::RealRegister::NoReg, TR_GPR, cg);
    TR::addDependency(
      conditions, selector, TR::RealRegister::NoReg, TR_GPR, cg);
  }
  ...
  if (isInt64) {
    if (two_reg) {
      loadConstant(
        cg, node, (int32_t)(preInt >> 32), valRegister->getHighOrder());
  ...
  for (int i = 2; i < total; i++) {
    ...
    if (isInt64) {
      if (TR::Compiler->target.is64Bit()) {
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::cmp8, node, cndRegister, selector, valRegister);
      } else {
        generateTrg1Src2Instruction(cg,
                                    TR::InstOpCode::cmp4,
                                    node,
      ...
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::cmp4, node, cndRegister, selector, valRegister);
    }
    ...
    if (i < total - 1) {
      int32_t diff =
        fromTableEval ? 1 : (node->getChild(i + 1)->getCaseConstant() - preInt);
      preInt += diff;
      if (!isInt64)
        generateTrg1Src1ImmInstruction(cg,
                                       TR::InstOpCode::addi2,
...
lookupScheme3(TR::Node* node, bool unbalanced, TR::CodeGenerator* cg)
{
  ...
  TR::addDependency(
    conditions, addrRegister, TR::RealRegister::NoReg, TR_GPR, cg);
  if (isInt64 && TR::Compiler->target.is64Bit()) {
    ...
    TR::addDependency(
      conditions, dataRegister, TR::RealRegister::NoReg, TR_GPR, cg);
    TR::addDependency(
      conditions, selector, TR::RealRegister::NoReg, TR_GPR, cg);
  }
    ...
    if (offset != PTOC_FULL_INDEX) {
      ...
      if (offset < LOWER_IMMED || offset > UPPER_IMMED) {
        ...
        generateTrg1MemInstruction(cg,
                                   ...
                                   new (cg->trHeapMemory()) TR::MemoryReference(
                                     addrRegister, LO_VALUE(offset), 8, cg));
      } else {
        generateTrg1MemInstruction(cg,
                                   TR::InstOpCode::Op_load,
                                   node,
                                   addrRegister,
                                   new (cg->trHeapMemory()) TR::MemoryReference(
                                     cg->getTOCBaseRegister(), offset, 8, cg));
      }
      ...
      if (isInt64)
        generateTrg1MemInstruction(
          ...
          node,
          dataRegister,
          new (cg->trHeapMemory()) TR::MemoryReference(addrRegister, 0, 8, cg));
      else
        generateTrg1MemInstruction(
          cg,
          TR::InstOpCode::lwz,
          node,
          dataRegister,
          new (cg->trHeapMemory()) TR::MemoryReference(addrRegister, 0, 4, cg));
    } else {
      if (cg->needRelocationsForLookupEvaluationData()) {
        ...
        loadAddressConstant(
          cg, false, node, cg->hiValue(address) << 16, addrRegister);
  ...
  {
    rel1 = generateTrg1ImmInstruction(cg,
                                      TR::InstOpCode::lis,
                                      node,
                                      addrRegister,
  ...
  for (int32_t ii = 2; ii < total; ii++) {
    ...
    if (isInt64) {
      if (TR::Compiler->target.is64Bit()) {
        generateTrg1Src2Instruction(
          cg, TR::InstOpCode::cmp8, node, cndRegister, selector, dataRegister);
      } else {
        generateTrg1Src2Instruction(cg,
                                    TR::InstOpCode::cmp4,
                                    node,
      ...
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::cmp4, node, cndRegister, selector, dataRegister);
    }
...
lookupScheme4(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  TR::addDependency(
    conditions, addrRegister, TR::RealRegister::NoReg, TR_GPR, cg);
  TR::addDependency(
    conditions, pivotRegister, TR::RealRegister::NoReg, TR_GPR, cg);
  if (two_reg) {
    TR::addDependency(conditions,
                      dataRegister->getHighOrder(),
                      TR::RealRegister::NoReg,
  ...
  TR::addDependency(
    conditions, lowRegister, TR::RealRegister::NoReg, TR_GPR, cg);
  TR::addDependency(
    conditions, highRegister, TR::RealRegister::NoReg, TR_GPR, cg);
  TR::addDependency(
    conditions, cndRegister, TR::RealRegister::NoReg, TR_CCR, cg);
  conditions->getPreConditions()->getRegisterDependency(0)->setExcludeGPR0();
  conditions->getPostConditions()->getRegisterDependency(0)->setExcludeGPR0();
  ...
  if (secondChild->getNumChildren() > 0) {
    cg->evaluate(secondChild->getFirstChild());
    conditions = conditions->clone(cg,
                                   generateRegisterDependencyConditions(
                                     cg, secondChild->getFirstChild(), 0));
  }
    ...
    if (offset != PTOC_FULL_INDEX) {
      ...
      if (offset < LOWER_IMMED || offset > UPPER_IMMED) {
        ...
        generateTrg1MemInstruction(cg,
                                   ...
                                   addrRegister,
                                   new (cg->trHeapMemory()) TR::MemoryReference(
                                     pivotRegister, LO_VALUE(offset), 8, cg));
      } else {
        generateTrg1MemInstruction(cg,
                                   TR::InstOpCode::Op_load,
                                   node,
      ...
      loadAddressConstant(cg,
                          cg->needRelocationsForLookupEvaluationData(),
                          node,
                          address,
                          addrRegister);
    }
  } else {
    rel1 = generateTrg1ImmInstruction(
      cg, TR::InstOpCode::lis, node, pivotRegister, cg->hiValue(address));
    rel2 = generateTrg1Src1ImmInstruction(cg,
                                          TR::InstOpCode::addi2,
                                          node,
                                          addrRegister,
                                          pivotRegister,
  ...
  generateTrg1Src2Instruction(
    cg, TR::InstOpCode::add, node, pivotRegister, highRegister, lowRegister);
  ...
  if (isInt64) {
    if (two_reg) {
      ...
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::addi, node, pivotRegister, pivotRegister, 4);
      generateTrg1MemInstruction(cg,
                                 TR::InstOpCode::lwzx,
                                 node,
                                 dataRegister->getLowOrder(),
  ...
  if (isInt64) {
    if (two_reg) {
      generateTrg1Src2Instruction(cg,
                                  ...
                                  selector->getHighOrder());
      generateConditionalBranchInstruction(
        cg, TR::InstOpCode::bne, node, searchLabel, cndRegister);
      generateTrg1Src2Instruction(cg,
                                  cmp_opcode,
                                  node,
                                  cndRegister,
      ...
      generateTrg1Src2Instruction(
        cg, cmp_opcode, node, cndRegister, dataRegister, selector);
    }
  } else {
    generateTrg1Src2Instruction(
      cg, cmp_opcode, node, cndRegister, dataRegister, selector);
  ...
  if (disableNewLookupScheme4) {
    ...
    generateTrg1Src1ImmInstruction(
      cg, TR::InstOpCode::addi2, node, pivotRegister, pivotRegister, 20);
  } else {
    // New code
    cg->fixedLoadLabelAddressIntoReg(node, dataRegister, linkLabel);
    generateLabelInstruction(cg, TR::InstOpCode::label, node, linkLabel);
    generateTrg1Src1ImmInstruction(
      cg, TR::InstOpCode::addi2, node, pivotRegister, pivotRegister, 16);
  }

  generateTrg1Src2Instruction(
    cg, TR::InstOpCode::add, node, dataRegister, pivotRegister, dataRegister);
  ...
  generateConditionalBranchInstruction(
    cg, TR::InstOpCode::bgt, node, biggerLabel, cndRegister);
  generateTrg1Src2Instruction(
    cg, cmp_opcode, node, cndRegister, pivotRegister, highRegister);
  generateConditionalBranchInstruction(
    cg,
    TR::InstOpCode::beq,
    node,
    ...
    cndRegister);
  generateTrg1Src1ImmInstruction(
    cg, TR::InstOpCode::addi2, node, lowRegister, pivotRegister, 4);
  ...
  generateTrg1Src2Instruction(
    cg, cmp_opcode, node, cndRegister, pivotRegister, lowRegister);
  generateConditionalBranchInstruction(
    cg,
    TR::InstOpCode::beq,
    node,
    ...
    cndRegister);
  generateTrg1Src1ImmInstruction(
    cg, TR::InstOpCode::addi2, node, highRegister, pivotRegister, -4);

  generateDepLabelInstruction(
    cg, TR::InstOpCode::b, node, backLabel, conditions);
...
TR::Register*
OMR::Power::TreeEvaluator::tableEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (!node->isSafeToSkipTableBoundCheck()) {
    if (numCases > UPPER_IMMED) {
      ...
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::cmpl4, node, ccReg, sReg, tReg);
    } else
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::cmpli4, node, ccReg, sReg, numCases);
...

  {
    if (TR::Compiler->target.is64Bit()) {
      ...
      if (tReg == NULL) {
        tReg = cg->allocateRegister();
        TR::addDependency(
          conditions, tReg, TR::RealRegister::NoReg, TR_GPR, cg);
      }
      ...
      generateTrg1Src2Instruction(
        cg, TR::InstOpCode::add, node, reg1, reg1, tReg);
    } else {
  ...
  bool nullPtrSymRefRequired)
{
  ...
  if (cg->getHasResumableTrapHandler()) {
    if (TR::Compiler->target.is64Bit())
      gcPoint = generateSrc1Instruction(
        cg, TR::InstOpCode::tdeqi, node, trgReg, NULLVALUE);
    else
      gcPoint = generateSrc1Instruction(
        cg, TR::InstOpCode::tweqi, node, trgReg, NULLVALUE);
    ...
    if (TR::Compiler->target.is64Bit())
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::cmpli8, node, condReg, trgReg, NULLVALUE);
    else
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::cmpli4, node, condReg, trgReg, NULLVALUE);
    if (TR::Compiler->target.cpu.id() >= TR_PPCgp)
      // use PPC AS branch hint
      gcPoint =
        generateDepConditionalBranchInstruction(cg,
                                                TR::InstOpCode::beql,
...
TR::Register*
OMR::Power::TreeEvaluator::evaluateNULLCHKWithPossibleResolve(
  TR::Node* node,
  bool needsResolve,
  TR::CodeGenerator* cg)
{
  ...
  if (valueToCheck->getOpCode().isBooleanCompare() &&
    ...
    if (valueToCheck->getOpCode().isCompareForOrder()) {
      if (valueToCheck->getChild(0)->getOpCode().is8Byte() ||
        ...
        TR::InstOpCode::Mnemonic branchOp =
          cmp2branch(valueToCheck->getOpCode().getOpCodeForReverseBranch(), cg);
        ...
        TR::TreeEvaluator::compareLongsForOrder(
          ...
          valueToCheck,
          cg,
          valueToCheck->getOpCode().isUnsignedCompare(),
          true,
          PPCOpProp_BranchUnlikely);
      } else {
        // switch branches since we want to go to OOL on node evaluating to 0
    ...
    if (TR::Compiler->target.is64Bit())
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::cmpi8, node, condReg, value, 0);
    else
      generateTrg1Src1ImmInstruction(
        cg, TR::InstOpCode::cmpi4, node, condReg, value, 0);
    if (TR::Compiler->target.cpu.id() >= TR_PPCgp) // Use PPC AS branch hint.
      ...
      generateConditionalBranchInstruction(
        cg, TR::InstOpCode::beq, node, slowPathLabel, condReg);
...
static TR::Register*
generateMaxMin(TR::Node* node, TR::CodeGenerator* cg, bool max)
{
  TR::Node* child = node->getFirstChild();
  ...
  if (cg->canClobberNodesRegister(child)) {
    ...
    if (two_reg) {
      generateTrg1Src1Instruction(
        cg, move_op, node, trgReg->getLowOrder(), reg->getLowOrder());
      generateTrg1Src1Instruction(
        cg, move_op, node, trgReg->getHighOrder(), reg->getHighOrder());
    } else {
...
TR::Register*
OMR::Power::TreeEvaluator::maxEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return generateMaxMin(node, cg, true);
}

TR::Register*
OMR::Power::TreeEvaluator::minEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return generateMaxMin(node, cg, false);
}

TR::Register*
OMR::Power::TreeEvaluator::igotoEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
                                            ...
                                            TR::CodeGenerator* cg)
{
  ...
  if ((opCode == TR::ificmno) || (opCode == TR::ificmnno) ||
      (opCode == TR::iflcmno) || (opCode == TR::iflcmnno)) {
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::add, node, res, rs1, rs2); // compare negative
    generateTrg1Src2Instruction(cg, TR::InstOpCode::eqv, node, tmp, rs1, rs2);
  } else {
    generateTrg1Src2Instruction(
      cg, TR::InstOpCode::subf, node, res, rs2, rs1); // compare
  ...
  generateTrg1Src1ImmInstruction(cg,
                                 nodeIs64Bit ? TR::InstOpCode::cmpi8
                                             : TR::InstOpCode::cmpi4,
                                 node,
                                 cr,
                                 res,
