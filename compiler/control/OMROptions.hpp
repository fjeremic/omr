...
class OMR_EXTENSIBLE Options {
 ...
 public:
  ...
  static TR::OptionSet* findOptionSet(TR_Memory*,
                                      int32_t index,
                                      int32_t lineNum,
                                      TR_ResolvedMethod*,
                                      TR_Hotness,
  ...
  static TR::OptionSet* findOptionSet(int32_t index,
                                      int32_t lineNum,
                                      const char*,
                                      TR_Hotness,
                                      bool);
  ...
  static char* processOptionsJIT(char* jitOptions,
                                 void* feBase,
                                 TR_FrontEnd* fe);
  static char* processOptionsAOT(char* aotOptions,
                                 void* feBase,
                                 TR_FrontEnd* fe);
  static char* processOptions(char* options,
                              char* envOptions,
                              void* feBase,
                              TR_FrontEnd* fe,
  ...
  static char* latePostProcess(TR::Options* options,
                               void* jitConfig,
                               bool isAOT);
  static char* processOptions(char* options,
                              char* moreOptions,
  ...
  const char* debugCounterInsertedFormat(TR_Memory* mem,
                                         const char* name,
                                         const char* format) {
 ...
 private:
  ...
  static char* processOptionSet(char* options,
                                char* envOptions,
                                TR::Options* jitBase,
                                bool isAOT);
  static char* processOptionSet(char* options,
  ...
  static char* processOptionSet(char* options,
                                ...
                                void* jitBase,
                                bool isAOT);
  static char* processOption(char* option,
  ...
  static void safelyCloseLogs(TR::Options* options,
 ...
 private:
  ...
  static char* setVerboseBitsInJitPrivateConfig(char* option,
                                                void* base,
  ...
  //
  static char* setSamplingJProfilingBits(char* option,
                                         void* base,
                                         TR::OptionTable* entry);
  ...
  //
  static char* disableOptimization(char* option,
                                   void* base,
                                   TR::OptionTable* entry);
  static char* enableOptimization(char* option,
                                  void* base,
                                  TR::OptionTable* entry);

  // Trace an optimization
  //
  static char* traceOptimization(char* option,
                                 void* base,
                                 TR::OptionTable* entry);
  static char* dontTraceOptimization(char* option,
                                     void* base,
                                     TR::OptionTable* entry);
  ...
  //
  static char* set32BitNumeric(char* option,
                               void* base,
                               TR::OptionTable* entry);
   ...
   * parameter
   */
  static char* set32BitNumericInJitConfig(char* option,
                                          void* base,
                                          TR::OptionTable* entry);
  ...
  //
  static char* set32BitHexadecimal(char* option,
                                   void* base,
                                   TR::OptionTable* entry);
  ...
  //
  static char* setStaticNumericKBAdjusted(char* option,
                                          void* base,
                                          TR::OptionTable* entry);
  ...
  // from the 'private' base (derived from the 'base' passed in) to that value.
  //
  static char* setStringForPrivateBase(char* option,
                                       void* base,
                                       TR::OptionTable* entry);
  ...
  //
  static char* set32BitSignedNumeric(char* option,
                                     void* base,
                                     TR::OptionTable* entry);
  ...
  //
  static char* setStaticString(char* option,
                               void* base,
                               TR::OptionTable* entry);
   ...
   */
  static char* setStringInJitConfig(char* option,
                                    void* base,
                                    TR::OptionTable* entry);
  ...
  //
  static char* setAddressEnumerationBits(char* option,
                                         void* base,
                                         TR::OptionTable* entry);
 ...
 public:
  static char* setBitsFromStringSet(char* option,
                                    void* base,
                                    TR::OptionTable* entry);
  static char* clearBitsFromStringSet(char* option,
                                      void* base,
                                      TR::OptionTable* entry);

  static char* configureOptReporting(char* option,
                                     void* base,
                                     TR::OptionTable* entry);
  ...
  bool counterIsEnabled(const char* name,
                        int8_t fidelity,
