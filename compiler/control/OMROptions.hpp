...
enum TR_CompilationOptions {
  ...
  TR_DisableVSSStackCompaction = 0x00100000 + 17, // never compact variable size symbols -- if not force or disable then
...
public:
  ...
  bool isExclude()
  {
    return _filterType <= TR_FILTER_EXCLUDE_MAX;
  }
  char getFilterType()
  {
    return _filterType;
  ...
  int32_t getSampleLevel()
  {
    return _sampleInfo;
  }

  char getSampleProfiled()
  {
    return _sampleProfiled;
  }
  void setSampleCount(int32_t n)
  {
    _sampleInfo = (int16_t)n;
  }
  void setSampleLevel(int32_t n)
  {
    _sampleInfo = (int16_t)n;
  }
  void setSampleProfiled(char p)
  {
    _sampleProfiled = p;
  }
  ...
  TR_FilterBST* getChild(int32_t c)
  {
    return _child[c];
  }
  void setChild(int32_t c, TR_FilterBST* node)
  {
    _child[c] = node;
  }

  TR_FilterBST* getNext()
  {
    return _child[0];
  }
  TR_FilterBST** getNextSlot()
  {
    return &_child[0];
  }
  void setNext(TR_FilterBST* next)
  {
    _child[0] = next;
  }
  ...
  TR::SimpleRegex* getRegex()
  {
    return _regex;
  }
  void setRegex(TR::SimpleRegex* regex)
  {
    _regex = regex;
  }
...
#define FILTER_HASH_SIZE 211
  ...
  uint32_t hasNameFilter()
  {
    return flags & HasNameFilter;
  }
  uint32_t hasClassNameSigFilter()
  {
    return flags & HasClassNameSigFilter;
  }
  uint32_t hasNameSigFilter()
  {
    return flags & HasNameSigFilter;
  }
  uint32_t hasRegexFilter()
  {
    return flags & HasRegexFilter;
  }
  uint32_t defaultExclude()
  {
    return flags & DefaultExclude;
  }

  void setHasNameFilter()
  {
    flags |= HasNameFilter;
  }
  void setHasClassNameSigFilter()
  {
    flags |= HasClassNameSigFilter;
  }
  void setHasNameSigFilter()
  {
    flags |= HasNameSigFilter;
  }
  void setHasRegexFilter()
  {
    flags |= HasRegexFilter;
  }
...
public:
  ...
  static void setIsFullyInitialized()
  {
  ...
  char* getBlockShufflingSequence()
  {
    return _blockShufflingSequence;
  }
  ...
  int32_t getCustomStrategySize()
  {
    return _customStrategySize;
  }
  int32_t* getCustomStrategy()
  {
    return _customStrategy;
  }

  TR::OptionSet* getFirstOptionSet()
  {
    return _optionSets;
  }

  char* getSuffixLogsFormat()
  {
    return _suffixLogsFormat;
  }
  ...
  {
    return !_verboseOptionFlags.isEmpty();
  }
  ...
  bool getTraceCGOption(uint32_t mask)
  {
    return (_cgTrace & mask) != 0;
  }
  bool getAnyTraceCGOption()
  {
    return (_cgTrace != 0);
  }
  ...
  bool getTraceLRA(uint32_t mask)
  {
    return (_traceLRA & mask) != 0;
  }
  ...
  bool getEnableGPU(uint32_t mask)
  {
    return (_enableGPU & mask) != 0;
  }
  ...
  static bool canJITCompile()
  {
    return _canJITCompile;
  }
  static void setCanJITCompile(bool f);
  bool allowRecompilation()
  {
    return _allowRecompilation;
  }
  static void disableSamplingThread()
  {
    _samplingFrequency = 0;
  }
  static int32_t getSamplingFrequency()
  {
    return _samplingFrequency;
  }

  static int32_t getMaxPeekedBytecodeSize()
  {
    return _maxPeekedBytecodeSize;
  }
  ...
  int32_t getFirstOptIndex()
  {
    return _firstOptIndex;
  }
  int32_t getLastOptIndex()
  {
    return _lastOptIndex;
  }
  int32_t getLastOptSubIndex()
  {
    return _lastOptSubIndex;
  }
  ...
  int32_t getStoreSinkingLastOpt()
  {
    return _storeSinkingLastOpt;
  }
  ...
  int32_t getMinFirstOptTransformationIndex()
  {
    return -1;
  }
  int32_t getMaxLastOptTransformationIndex()
  {
    return INT_MAX;
  }

  int32_t getLargeNumberOfLoops()
  {
    return _largeNumberOfLoops;
  }
  bool isDisabled(OMR::Optimizations o)
  {
    return _disabledOptimizations[o];
  }
  ...
  {
    return _traceOptimizations[o];
  }
  void enableTracing(OMR::Optimizations o)
  {
    _traceOptimizations[o] = true;
  }
  bool tracingOptimization()
  {
    return _tracingOptimization;
  }
  int32_t getMaxUnloadedAddressRanges()
  {
    return _maxUnloadedAddressRanges;
  }
  int32_t getMaxStaticPICSlots(TR_Hotness h)
  {
    return (h >= hot) ? _hotMaxStaticPICSlots : _maxStaticPICSlots;
  }
  int32_t getMaxNumPrexAssumptions()
  {
    return _maxNumPrexAssumptions;
  }
  int32_t getMaxNumVisitedSubclasses()
  {
    return _maxNumVisitedSubclasses;
  }
  ...
  int32_t getEnableDLTBytecodeIndex()
  {
    return _enableDLTBytecodeIndex;
  }
  int32_t getDisableDLTBytecodeIndex()
  {
    return _disableDLTBytecodeIndex;
  }
  int32_t getDLTOptLevel()
  {
    return _dltOptLevel;
  }
  int32_t getProfilingCount()
  {
    return _profilingCount;
  }
  int32_t getProfilingFrequency()
  {
    return _profilingFrequency;
  }
  int32_t insertDebuggingCounters()
  {
    return _insertDebuggingCounters;
  }
  int32_t getLastSearchCount()
  {
    return _lastSearchCount;
  }

  int32_t getAotrtDebugLevel()
  {
    return _newAotrtDebugLevel;
  }
  ...
  int64_t getDebugCounterWarmupSeconds()
  {
    return _debugCounterWarmupSeconds;
  }
  ...
  TR::SimpleRegex* getDisabledOpts()
  {
    return _disabledOpts;
  }
  TR::SimpleRegex* getDisabledInlineSites()
  {
    return _disabledInlineSites;
  }
  TR::SimpleRegex* getOptsToTrace()
  {
    return _optsToTrace;
  }
  TR::SimpleRegex* getDontInline()
  {
    return _dontInline;
  }
  TR::SimpleRegex* getOnlyInline()
  {
    return _onlyInline;
  }
  TR::SimpleRegex* getTryToInline()
  {
    return _tryToInline;
  }
  TR::SimpleRegex* getBreakOnOpts()
  {
    return _breakOnOpts;
  }
  TR::SimpleRegex* getSlipTrap()
  {
    return _slipTrap;
  }
  TR::SimpleRegex* getLockReserveClass()
  {
    return _lockReserveClass;
  }
  TR::SimpleRegex* getBreakOnCreate()
  {
    return _breakOnCreate;
  }
  TR::SimpleRegex* getDebugOnCreate()
  {
    return _debugOnCreate;
  }
  TR::SimpleRegex* getBreakOnThrow()
  {
    return _breakOnThrow;
  }
  TR::SimpleRegex* getBreakOnPrint()
  {
    return _breakOnPrint;
  }
  TR::SimpleRegex* getTraceForCodeMining()
  {
    return _traceForCodeMining;
  }
  TR::SimpleRegex* getVerboseOptTransformationsRegex()
  {
    return _verboseOptTransformationsRegex;
  }
  TR::SimpleRegex* getPackedTestRegex()
  {
    return _packedTest;
  }
  ...
  TR::SimpleRegex* getDisabledIdiomPatterns()
  {
    return _disabledIdiomPatterns;
  }
  ...
  int32_t getBigCalleeThreshold() const
  {
    return _bigCalleeThreshold;
  }
  ...
  int32_t getMaxSzForVPInliningWarm() const
  {
    return _maxSzForVPInliningWarm;
  }
  ...
  void setTarget();
  void setAllowRecompilation(bool b)
  {
    _allowRecompilation = b;
  }
  void setQuickStart();
  ...
  int32_t getInitialCount()
  {
    return _initialCount;
  }
  void setInitialCount(int32_t n)
  {
    _initialCount = n;
  }
  int32_t getInitialBCount()
  {
    return _initialBCount;
  }
  void setInitialBCount(int32_t n)
  {
    _initialBCount = n;
  }
  int32_t getInitialMILCount()
  {
    return _initialMILCount;
  }
  void setInitialMILCount(int32_t n)
  {
    _initialMILCount = n;
  }
  int32_t getInitialColdRunCount()
  {
    return _initialColdRunCount;
  }
  int32_t getInitialColdRunBCount()
  {
    return _initialColdRunBCount;
  }
  int32_t getMaxSpreadCountLoopless()
  {
    return _maxSpreadCountLoopless;
  }
  int32_t getMaxSpreadCountLoopy()
  {
    return _maxSpreadCountLoopy;
  }
  ...
  void setGCRCount(int32_t v)
  {
    _GCRCount = v;
  }
  int32_t getGCRDecCount()
  {
    return _GCRDecCount;
  }
  int32_t getGCRResetCount()
  {
    return _GCRResetCount;
  }
  bool getInsertGCRTrees()
  {
    return _insertGCRTrees;
  }
  void setInsertGCRTrees()
  {
    _insertGCRTrees = true;
  }
  int32_t getStackPCDumpNumberOfBuffers()
  {
    return _stackPCDumpNumberOfBuffers;
  }
  int32_t getStackPCDumpNumberOfFrames()
  {
    return _stackPCDumpNumberOfFrames;
  }
  int32_t get390StackBufferSize()
  {
    return _test390StackBuffer;
  }
  int32_t get390LitPoolBufferSize()
  {
    return _test390LitPoolBuffer;
  }
  int32_t getInitialSCount()
  {
    return _initialSCount;
  }
  int32_t getEnableSCHintFlags()
  {
    return _enableSCHintFlags;
  }
  ...
  int32_t getInlineCntrAllBucketSize()
  {
    return _inlineCntrAllBucketSize;
  }
  int32_t getDelayCompile()
  {
    return _delayCompile;
  }
  int32_t getMaxInlinedCalls()
  {
    return _maxInlinedCalls;
  }
  ...
  int32_t getTrivialInlinerMaxSize() const
  {
    return _trivialInlinerMaxSize;
  }
  void setTrivialInlinerMaxSize(int32_t n)
  {
    _trivialInlinerMaxSize = n;
  }
  ...
  int32_t getInlinerBorderFrequency()
  {
    return _inlinerBorderFrequency;
  }
  void setInlinerBorderFrequency(int32_t n)
  {
    _inlinerBorderFrequency = n;
  }
  ...
  int32_t getInlinerCGBorderFrequency()
  {
    return _inlinerCGBorderFrequency;
  }
  void setInlinerCGBorderFrequency(int32_t n)
  {
    _inlinerCGBorderFrequency = n;
  }
  ...
  int32_t getLabelTargetNOPLimit()
  {
    return _labelTargetNOPLimit;
  }

  int32_t getMaxLimitedGRACandidates()
  {
    return _maxLimitedGRACandidates;
  }
  int32_t getMaxLimitedGRARegs()
  {
    return _maxLimitedGRARegs;
  }
...
public:
  ...
  static size_t getScratchSpaceLimit()
  {
  ...
  static size_t getScratchSpaceLowerBound()
  {
    return _scratchSpaceLowerBound;
  }
  ...
  static int32_t getAggressivityLevel()
  {
    return _aggressivenessLevel;
  }
  static int32_t getDeterministicMode()
  {
  ...
  uintptr_t getHeapTop()
  {
    return _heapTop;
  }

  void setGcCardSize(uintptr_t g)
  {
    _gcCardSize = g;
  }
  void setHeapBase(uintptr_t g)
  {
    _heapBase = g;
  }
  void setHeapTop(uintptr_t g)
  {
    _heapTop = g;
  }
  ...
  uintptr_t getHeapSizeForBarrierRange0()
  {
    return _heapSizeForBarrierRange0;
  }
  ...
  uintptr_t getHeapBaseForBarrierRange0()
  {
    return _heapBaseForBarrierRange0;
  }

  void setActiveCardTableBase(uintptr_t b)
  {
    _activeCardTableBase = b;
  }
  uintptr_t getActiveCardTableBase()
  {
    return _activeCardTableBase;
  }
  ...
  inline bool realTimeGC()
  {
    return _realTimeGC;
  }

  static void setSharedClassCache(bool c)
  {
    _sharedClassCache = c;
  }
  inline static bool sharedClassCache()
  {
    return _sharedClassCache;
  }

  static TR_Hotness getInitialHotnessLevel(bool methodHasLoops);

  bool getOptLevelDowngraded() const
  {
    return _optLevelDowngraded;
  }
  static char* getCompilationStrategyName()
  {
    return _compilationStrategyName;
  }
  ...
  static bool isQuickstartDetected()
  {
    return _quickstartDetected;
  }
  void disableCHOpts(); // disable CHOpts, but also IPA and prex which depend on the chtable

  const char* getObjectFileName()
  {
...
private:
  ...
  class OptionFlagArray {
    ...
    inline uint64_t& word(int flagIndex)
    {
      return _words[flagIndex / 64];
    }
  ...
  public:
    ...
    void set(int flagIndex)
    {
      word(flagIndex) |= bit(flagIndex);
    }
    void reset(int flagIndex)
    {
      word(flagIndex) &= ~bit(flagIndex);
    }

    bool isSet(Enum flagIndex)
    {
      return isSet((int)flagIndex);
    }
    void set(Enum flagIndex)
    {
      set((int)flagIndex);
    }
    void reset(Enum flagIndex)
    {
      reset((int)flagIndex);
    }

    void maskWord(int wordIndex, uint64_t mask)
    {
  ...
  static char* processOption(
    char* option, TR::OptionTable* table, void* base, int32_t numEntries, TR::OptionSet* optionSet);
...
private:
  ...
  static char* setVerboseBitsHelper(
...
public:
  ...
  TR_MCTLogs* next() const
  {
    return _next;
  }
  void setNext(TR_MCTLogs* l)
  {
    _next = l;
  }
  int32_t getID() const
