...
enum TR_CompilationOptions
{
  ...
  TR_DisableOutlinedNew =
    0x00200000 + 18, // Expand object allocation logic inline instead of using a
                     // fast jit helper
  ...
  TR_DisableDecimalFormatPeephole =
    0x04000000 + 18, // optimize DecimalFormat.format(BigDecimal.doubleValue())
  ...
  TR_DisableClearCodeCacheFullFlag =
    0x00000200 + 21, // Disable the re-enabling of the code cache when a method
                     // body is freed after the cache has become full
...
public:
  ...
  static int32_t
    _queueWeightThresholdForAppThreadYield; // used only for LINUX; app threads
                                            // will sleep sometimes
