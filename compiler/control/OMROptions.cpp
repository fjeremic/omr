...
#define SET_OPTION_BIT(x) \
  TR::Options::setBit, offsetof(OMR::Options, _options[(x)&TR_OWM]), (static_cast<uintptrj_t>((x) & ~TR_OWM))
#define RESET_OPTION_BIT(x) \
  TR::Options::resetBit, offsetof(OMR::Options, _options[(x)&TR_OWM]), (static_cast<uintptrj_t>((x) & ~TR_OWM))
...
TR::OptionTable OMR::Options::_jitOptions[] = {
  ...
  { "abstractTimeToReduceInliningAggressiveness=",
    ...
    (intptrj_t)&OMR::Options::_abstractTimeToReduceInliningAggressiveness, 0, "F%d", NOT_IN_SUBSET },
  ...
  { "alwaysFatalAssert", "I\tAlways execute fatal assertion for testing purposes", SET_OPTION_BIT(TR_AlwaysFatalAssert),
    "F" },
  ...
  { "aot", "O\tahead-of-time compilation", SET_OPTION_BIT(TR_AOT), "F", NOT_IN_SUBSET },
  ...
  { "aotrtDebugLevel=", "R<nnn>\tprint aotrt debug output according to level", TR::Options::set32BitNumeric,
    offsetof(OMR::Options, _newAotrtDebugLevel), 0, " %d" },
  ...
  { "assumeStrictFP", "C\talways assume strictFP semantics", SET_OPTION_BIT(TR_StrictFP), "F" },
  { "bcount=", "O<nnn>\tnumber of invocations before compiling methods with loops", TR::Options::setCount,
    offsetof(OMR::Options, _initialBCount), 0, " %d" },
  ...
  { "bigCalleeFreqCutoffAtHot=",
    "O<nnn>\tInliner threshold for block frequncy for cold callees for opt level higher then warm",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _bigCalleeFreqCutoffAtHot), 40, " %d" },
  { "bigCalleeFreqCutoffAtWarm=",
    "O<nnn>\tInliner threshold for block frequncy for cold callees for opt level less of equal to warm",
  ...
  { "bigCalleeThreshold=", "O<nnn>\tInliner threshold", TR::Options::set32BitNumeric,
    offsetof(OMR::Options, _bigCalleeThreshold), 0, " %d" },
  ...
  { "blockShufflingSequence=",
    "D<string>\tDescription of the particular block shuffling operations to perform; see source code for more details",
  ...
  { "breakOnEntry", "D\tinsert entry breakpoint instruction in generated code", SET_OPTION_BIT(TR_EntryBreakPoints),
    "F" },
  { "breakOnJ2IThunk", "D\tbreak before executing a jit-to-interpreter thunk", SET_OPTION_BIT(TR_BreakOnJ2IThunk), "P",
    NOT_IN_SUBSET },
  ...
  { "compilationStrategy=", "O<strategyname>\tname of the compilation strategy to use", TR::Options::setStaticString,
    (intptrj_t)(&OMR::Options::_compilationStrategyName), 0, "F%s", NOT_IN_SUBSET },
  { "compilationThreads=", "R<nnn>\tnumber of compilation threads to use", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_numUsableCompilationThreads, 0, "F%d", NOT_IN_SUBSET },
  ...
  { "count=", "O<nnn>\tnumber of invocations before compiling methods without loops", TR::Options::setCount,
    offsetof(OMR::Options, _initialCount), 0, " %d" },
  ...
  { "countPercentageForEarlyCompilation=", "M<nnn>\tNumber 1..100", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_countPercentageForEarlyCompilation, 0, "F%d", NOT_IN_SUBSET },
  { "counts=",
  ...
  { "cpuUsageCircularBufferUpdateFrequencySec=", "O<nnn>\tFrequency of the CPU Usage Array update",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_cpuUsageCircularBufferUpdateFrequencySec, 0, "F%d",
    NOT_IN_SUBSET },
  ...
  { "debugCounters=",
    "D{regex}\tEnable dynamic debug counters with names matching regex (unless they fail to meet some other criterion)",
    TR::Options::setRegex, offsetof(OMR::Options, _enabledDynamicCounterNames), 0, "F" },
  { "debugCounterWarmupSeconds=",
    "D<nnn>\tDebug counters will be reset to zero after nnn seconds, so only increments after this point will end up "
    "in the final report",
  ...
  { "delayCompile=", "I<nnn>\tAmount of time in ms before compile is started", TR::Options::set32BitSignedNumeric,
    offsetof(OMR::Options, _delayCompile), 0, "F%d" },
  { "delayToEnableIdleCpuExploitation=", "M<nnn>\t", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_delayToEnableIdleCpuExploitation, 0, "F%d", NOT_IN_SUBSET },
  ...
  { "disableAndSimplification", "O\tdisable and simplification", TR::Options::disableOptimization, andSimplification, 0,
    "P" },
  { DisableAnnotations, "O\tdisable annotation support", RESET_OPTION_BIT(TR_EnableAnnotations), "F" },
  { "disableAOTAtCheapWarm", "O\tdisable AOT with cheap warm opt level", SET_OPTION_BIT(TR_DisableAotAtCheapWarm), "F",
    NOT_IN_SUBSET },
  { "disableAOTBytesCompression", "O\tdisable compressing AOT bytes", SET_OPTION_BIT(TR_DisableAOTBytesCompression),
    "F" },
  { "disableAOTCheckCastInlining", "O\tdisable AOT check cast inlining", SET_OPTION_BIT(TR_DisableAOTCheckCastInlining),
    "F" },
  ...
  { "disableBranchOnCount", "O\tdisable branch on count instructions for s390", SET_OPTION_BIT(TR_DisableBranchOnCount),
    "F" },
  ...
  { "disableCheckcastAndProfiledGuardCoalescer", "O\tdisable checkcast and profiled guard  coalescion optimization ",
  ...
  { "disableColdBlockMarker", "O\tdisable detection of cold blocks", TR::Options::disableOptimization, coldBlockMarker,
    0, "P" },
  ...
  { "disableConverterReducer", "O\tdisable reuducing converters methods to intrinisic arrayTranslate",
  ...
  { "disableDecimalFormatPeephole", "O\tdisable optimizing DecimalFormat.format(BigDecimal.doubleValue())",
  ...
  { "disableDirectToJNIInline", "O\tdisable direct calls to JNI methods from jitted methods (but still create thunks)",
  ...
  { "disableDLTBytecodeIndex=", "O<nnn>\tprevent DLT compilation at the specified bytecode index",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _disableDLTBytecodeIndex), 0, " %d" },
  ...
  { "disableDoubleWordStackAlignment", "O\tdisable double word java stack alignement on z",
  ...
  { "disableEnhancedClobberEval", "O\tdisable passthrough clobber eval", SET_OPTION_BIT(TR_DisableEnhancedClobberEval),
    "F" },
  ...
  { DisableFastStringIndexOfString, "O\tdisable fast String.indexOf", SET_OPTION_BIT(TR_DisableFastStringIndexOf),
    "F" },
  { "disableFieldPrivatization", "O\tdisable field privatization", TR::Options::disableOptimization, fieldPrivatization,
    0, "P" },
  ...
  { "disableGlobalVP", "O\tdisable global value propagation", TR::Options::disableOptimization, globalValuePropagation,
    0, "P" },
  ...
  { "disableGuardedCallArgumentRemat",
    "O\tdon't rematerialize a guarded virtual call's arguments on the cold path; instead, leave the expressions on the "
    "mainline path",
    SET_OPTION_BIT(TR_DisableGuardedCallArgumentRemat), "F" },
  { "disableGuardedCountingRecompilation",
    "O\tdisable GCR.  If you don't know what that is, I don't have room to explain it here.",
  ...
  { "disableInlineIsInstance", "O\tdisable isInstance   inline fast helper", SET_OPTION_BIT(TR_DisableInlineIsInstance),
    "F" },
  ...
  { "disableInlinerFanIn", "O\tdisable fan in as a consideration for inlining", SET_OPTION_BIT(TR_DisableInlinerFanIn),
    "F" },
  ...
  { DisableInliningOfNativesString, "O\tdisable inlining of natives", SET_OPTION_BIT(TR_DisableInliningOfNatives),
    "F" },
  { "disableInnerPreexistence", "O\tdisable inner preexistence", TR::Options::disableOptimization, innerPreexistence, 0,
    "P" },
  ...
  { "disableLocalCSE", "O\tdisable local common subexpression elimination", TR::Options::disableOptimization, localCSE,
    0, "P" },
  ...
  { "disableLocalReordering", "O\tdisable local reordering", TR::Options::disableOptimization, localReordering, 0,
    "P" },
  { "disableLocalVP", "O\tdisable local value propagation", TR::Options::disableOptimization, localValuePropagation, 0,
    "P" },
  ...
  { "disableMCSBypass",
    "O\tdisable allocating JNI global references to skip some levels of indirection when accessing a MutableCallSite's "
    "target MethodHandle in jitted code",
  ...
  { "disableMoreOpts", "O\tapply noOpt optimization level and disable codegen optimizations",
    TR::Options::disableMoreOpts, offsetof(OMR::Options, _optLevel), noOpt, "P" },
  ...
  { "disableMutableCallSiteGuards",
    "O\tdisable virtual guards for calls to java.lang.invoke.MutableCallSite.getTarget().invokeExact(...) (including "
    "invokedynamic)",
  ...
  { "disablePrefetchInsertion", "O\tdisable prefetch insertion", TR::Options::disableOptimization, prefetchInsertion, 0,
    "P" },
  ...
  { "disableRedundantMonitorElimination", "O\tdisable redundant monitor elimination", TR::Options::disableOptimization,
  ...
  { "disableRefinedAliases",
    "O\tdisable collecting side-effect summaries from compilations to improve aliasing info in subsequent compilations",
  ...
  { "disableRematerialization", "O\tdisable rematerialization", TR::Options::disableOptimization, rematerialization, 0,
    "P" },
  ...
  { "disableSequenceSimplification", "O\tdisable arithmetic sequence simplification", TR::Options::disableOptimization,
  ...
  { "disableStaticFinalFieldFolding", "O\tdisable generic static final field folding", TR::Options::disableOptimization,
  ...
  { "disableTOCForConsts", "O\tdisable use of the TOC for constants and floats materialization",
    SET_OPTION_BIT(TR_DisableTOCForConsts), "F" },
  { "disableTraceRegDeps", "O\tdisable printing of register dependancies for each instruction in trace file",
  ...
  { "disableTreeSimplification", "O\tdisable tree simplification", TR::Options::disableOptimization, treeSimplification,
    0, "P" },
  ...
  { "disableUpdateJITBytesSize",
    "M\tDon't send VM size of IProfiler Entires and Hints that could have been persisted if the SCC wasn't full",
  ...
  { "disableUseDefForShadows", "I\ttemporary, disables usedef for shadows.", SET_OPTION_BIT(TR_DisableUseDefForShadows),
    "F" },
  ...
  { "disableWrtBarSrcObjCheck", "O\tdisable to not check srcObj location for wrtBar in gc",
  ...
  { "disableZ13LoadAndMask", "O\tdisable load-and-mask instruction generation on z13",
    SET_OPTION_BIT(TR_DisableZ13LoadAndMask), "F" },
  { "disableZ13LoadImmediateOnCond", "O\tdisable load halfword immediate on condition instruction generation on z13",
  ...
  { "disableZonedToDFPReduction", "O\tdisable strength reduction of zoned decimal arithmetic to DFP arithmetic",
  ...
  { "dontAddHWPDataToIProfiler", "O\tDont add HW Data to IProfiler", SET_OPTION_BIT(TR_DontAddHWPDataToIProfiler), "F",
    NOT_IN_SUBSET },
  ...
  { "dontLowerCountsForAotCold", "M\tDo not lower counts for cold aot runs", RESET_OPTION_BIT(TR_LowerCountsForAotCold),
    "F", NOT_IN_SUBSET },
  ...
  { "dumbInlinerBytecodeSizeMaxCutoff=", "O<nnn>\tmethods above the threshold will not inline other methods",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _dumbInlinerBytecodeSizeMaxCutoff), 0, " %d" },
  { "dumbInlinerBytecodeSizeMinCutoff=", "O<nnn>\tmethods below the threshold will inline other methods",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _dumbInlinerBytecodeSizeMinCutoff), 0, " %d" },
  ...
  { "enableBasicBlockHoisting", "O\tenable basic block hoisting", TR::Options::enableOptimization, basicBlockHoisting,
    0, "P" },
  { "enableBlockShuffling", "O\tenable random rearrangement of blocks", TR::Options::enableOptimization, blockShuffling,
    0, "P" },
  ...
  { "enableDeterministicOrientedCompilation", "O\tenable deteministic oriented compilation",
  ...
  { "enableDLTBytecodeIndex=", "O<nnn>\tforce attempted DLT compilation to use specified bytecode index",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _enableDLTBytecodeIndex), 0, " %d" },
  ...
  { "enableGuardedCountingRecompilation",
    "O\tenable GCR.  If you don't know what that is, I don't have room to explain it here.",
  ...
  { "enableJVMPILineNumbers", "M\tenable output of line numbers via JVMPI", SET_OPTION_BIT(TR_EnableJVMPILineNumbers),
    "F" },
  { "enableLabelTargetNOPs", "O\tenable inserting NOPs before label targets", SET_OPTION_BIT(TR_EnableLabelTargetNOPs),
    "F" },
  ...
  { "enableMutableCallSiteGuards",
    "O\tenable virgual guards for calls to java.lang.invoke.MutableCallSite.getTarget().invokeExact(...) (including "
    "invokedynamic)",
  ...
  { "enableNewX86PrefetchTLH", "O\tenable new X86 TLH prefetch algorithm", SET_OPTION_BIT(TR_EnableNewX86PrefetchTLH),
    "F" },
  ...
  { "enableRefinedAliases",
    "O\tenable collecting side-effect summaries from compilations to improve aliasing info in subsequent compilations",
  ...
  { "enableSnapshotBlockOpts", "O\tenable block ordering/redirecting optimizations in the presences of snapshot nodes",
  ...
  { "enableThisLiveRangeExtension", "R\tenable this live range extesion to the end of the method",
  ...
  { "enableYieldVMAccess", "O\tenable yielding of VM access when GC is waiting", SET_OPTION_BIT(TR_EnableYieldVMAccess),
    "F" },
  ...
  { "extractExitsByInvalidatingStructure",
    "O\tInstead of running exit extraction normally, detect nodes that would be extracted, and invalidate structure if "
    "there are any",
  ...
  { "GCRdecCount=",
    "R<nnn>\tthe value by which the counter is decremented by guarded counting recompilations (postitive value)",
  ...
  { "hcrPatchClassPointers",
    "I\tcreate runtime assumptions for patching pointers to classes, even though they are now updated in-place",
    SET_OPTION_BIT(TR_HCRPatchClassPointers), "F" },
  { "help", " \tdisplay this help information", TR::Options::helpOption, 0, 0, NULL, NOT_IN_SUBSET },
  { "help=", " {regex}\tdisplay help for options whose names match {regex}", TR::Options::helpOption, 1, 0, NULL,
    NOT_IN_SUBSET },
  ...
  { "hotMaxStaticPICSlots=",
    " <nnn>\tmaximum number of polymorphic inline cache slots pre-populated from profiling info for hot and above.  A "
    "negative value -N means use N times the maxStaticPICSlots setting.",
...
#ifdef DEBUG
  { "ignoreUnimp", "D\tdo not fail compilation for unimpemented opcodes", TR::Options::setDebug,
  ...
  { "initialOptLevel=noOpt", "O\thint to perform first time compilations at noOpt optlevel", TR::Options::set32BitValue,
    offsetof(OMR::Options, _initialOptLevel), noOpt, "F", NOT_IN_SUBSET },
  ...
  { "inlineCntrCalleeTooBigBucketSize=",
    ...
    offsetof(OMR::Options, _inlineCntrCalleeTooBigBucketSize), 0, " %d", NOT_IN_SUBSET },
  { "inlineCntrCalleeTooDeepBucketSize=",
    "R<nnn>\tThe unit used to categorize uninlined calls when the recursively computed size of the callee is too big",
  ...
  { "inlineCntrColdAndNotTinyBucketSize=",
    ...
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrColdAndNotTinyBucketSize), 0, " %d",
    NOT_IN_SUBSET },
  ...
  { "inlineCntrRanOutOfBudgetBucketSize=",
    ...
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrRanOutOfBudgetBucketSize), 0, " %d",
    NOT_IN_SUBSET },
  { "inlineCntrWarmCalleeHasTooManyNodesBucketSize=",
    ...
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrWarmCalleeHasTooManyNodesBucketSize), 0, " %d",
    NOT_IN_SUBSET },
  { "inlineCntrWarmCalleeTooBigBucketSize=",
    "R<nnn>\tThe unit used to categorize uninlined calls when the warm callee is too big", TR::Options::set32BitNumeric,
    offsetof(OMR::Options, _inlineCntrWarmCalleeTooBigBucketSize), 0, " %d", NOT_IN_SUBSET },
  { "inlineCntrWarmCallerHasTooManyNodesBucketSize=",
    ...
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlineCntrWarmCallerHasTooManyNodesBucketSize), 0, " %d",
    NOT_IN_SUBSET },
  ...
  { "inlinerArgumentHeuristicFractionBeyondWarm=",
    ...
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerArgumentHeuristicFractionBeyondWarm), 0, " %d" },
  { "inlinerArgumentHeuristicFractionUpToWarm=",
    ...
    "heuristic kicks in",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerArgumentHeuristicFractionUpToWarm), 0, " %d" },
  { "inlinerBorderFrequency=", "O<nnn>\tblock frequency threshold for not inlining at warm",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerBorderFrequency), 0, " %d" },
  { "inlinerCGBorderFrequency=", "O<nnn>\tblock frequency threshold for not inlining at warm",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerCGBorderFrequency), 0, " %d" },
  { "inlinerCGColdBorderFrequency=", "O<nnn>\tblock frequency threshold for not inlining at warm",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerCGColdBorderFrequency), 0, " %d" },
  { "inlinerCGVeryColdBorderFrequency=", "O<nnn>\tblock frequency threshold for not inlining at warm",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerCGVeryColdBorderFrequency), 0, " %d" },
  { "inlinerColdBorderFrequency=", "O<nnn>\tblock frequency threshold for not inlining at warm",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerColdBorderFrequency), 0, " %d" },
  ...
  { "inlinerVeryColdBorderFrequency=", "O<nnn>\tblock frequency threshold for not inlining at warm",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerVeryColdBorderFrequency), 0, " %d" },
  { "inlinerVeryColdBorderFrequencyAtCold=", "O<nnn>\tblock frequency threshold for not inlining at cold",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _inlinerVeryColdBorderFrequencyAtCold), 0, " %d" },
  { "inlinerVeryLargeCompiledMethodAdjustFactor=", "O<nnn>\tFactor to multiply the perceived size of the method",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_inlinerVeryLargeCompiledMethodAdjustFactor, 0, "F%d",
    NOT_IN_SUBSET },
  ...
  { "interpreterSamplingDivisorInStartupMode=",
    ...
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_interpreterSamplingDivisorInStartupMode, 0, " %d",
    NOT_IN_SUBSET },
  ...
  { "labelTargetNOPLimit=",
    "C<nnn>\t(labelTargetAddress&0xff) > _labelTargetNOPLimit are padded out with NOPs until the next 256 byte "
    "boundary",
  ...
  { "lockVecRegs=", "M<nn>\tThe number of vector register to lock (from end) Range: 0-32",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_numVecRegsToLock, 0, "F%d", NOT_IN_SUBSET },
  ...
  { "maxBytesToLeaveAllocatedInSharedPool=", "R<nnn>\tnumber of memory segments to leave allocated",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_maxBytesToLeaveAllocatedInSharedPool, 0, "F%d",
    NOT_IN_SUBSET },
  ...
  { "maxLimitedGRACandidates=", "C<nnn>\tThe max number of candidates to consider for limited GRA",
    ...
    "F%d" },
  { "maxLimitedGRARegs=", "C<nnn>\tThe max number of registers to assign for limited GRA", TR::Options::set32BitNumeric,
  ...
  { "maxSleepTimeMsForCompThrottling=", "M<nnn>\tUpper bound for sleep time during compilation throttling (ms)",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_maxSleepTimeMsForCompThrottling, 0, "F%d",
    NOT_IN_SUBSET },
  ...
  { "minBytesToLeaveAllocatedInSharedPool=", "R<nnn>\tnumber of memory segments to leave allocated",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_minBytesToLeaveAllocatedInSharedPool, 0, "F%d",
    NOT_IN_SUBSET },
  { "minNumberOfTreeTopsInsideTMMonitor=", "R<nnn>\tMinimal number of tree tops needed for TM monitor",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_minimalNumberOfTreeTopsInsideTMMonitor, 0, "P%d",
    NOT_IN_SUBSET },
  ...
  { "minSleepTimeMsForCompThrottling=", "M<nnn>\tLower bound for sleep time during compilation throttling (ms)",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_minSleepTimeMsForCompThrottling, 0, "F%d",
    NOT_IN_SUBSET },
  { "noAotSecondRunDetection", "M\tdo not do second run detection for AOT", SET_OPTION_BIT(TR_NoAotSecondRunDetection),
    "F", NOT_IN_SUBSET },
#ifdef DEBUG
  ...
  { "numIProfiledCallsToTriggerLowPriComp=", "M<nnn>", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_numIProfiledCallsToTriggerLowPriComp, 0, "F%d", NOT_IN_SUBSET },
  ...
  { "profilingCompNodecountThreshold=",
    ...
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_profilingCompNodecountThreshold, 0, "F%d",
    NOT_IN_SUBSET },
  ...
  { "qsziMaxToTrackLowPriComp=", "M<nnn>", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_qsziMaxToTrackLowPriComp, 0, "F%d", NOT_IN_SUBSET },
  { "queueWeightThresholdForAppThreadYield=",
    ...
    (intptrj_t)&OMR::Options::_queueWeightThresholdForAppThreadYield, 0, "F%d", NOT_IN_SUBSET },
  { "queueWeightThresholdForStarvation=", "M<nnn>\tThreshold for applying (or not) starvation decisions",
    TR::Options::setStaticNumeric, (intptrj_t)&OMR::Options::_queueWeightThresholdForStarvation, 0, "F%d",
    NOT_IN_SUBSET },
  ...
  { "randomize", "D\tRandomize certain decisions and thresholds to improve test coverage", SET_OPTION_BIT(TR_Randomize),
    "F" },
  ...
  { "sampleDensityBaseThreshold=", "M<nnn>\t", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_sampleDensityBaseThreshold, 0, "F%d", NOT_IN_SUBSET },
  { "sampleDensityIncrementThreshold=", "M<nnn>\t", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_sampleDensityIncrementThreshold, 0, "F%d", NOT_IN_SUBSET },
  { "sampleInterval=",
  ...
  { "scount=", "O<nnn>\tnumber of invocations before loading relocatable method in shared cache", TR::Options::setCount,
    offsetof(OMR::Options, _initialSCount), 1, " %d" },
  ...
  { "stackPCDumpNumberOfBuffers=", "O<nnn>\t The number of gc cycles for which we collect top stack pcs",
    TR::Options::setCount, offsetof(OMR::Options, _stackPCDumpNumberOfBuffers), 0, " %d" },
  { "stackPCDumpNumberOfFrames=", "O<nnn>\t The number of top stack pcs we collect during each cycle",
    TR::Options::setCount, offsetof(OMR::Options, _stackPCDumpNumberOfFrames), 0, " %d" },
  ...
  { "startupMethodDontDowngradeThreshold=",
    "O<nnn> Certain methods below this threshold will not be downgraded during startup", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_startupMethodDontDowngradeThreshold, 0, "F%d", NOT_IN_SUBSET },
  { "staticDebugCounters",
    "D\tEnable static versions of all enabled dynamic debug counters (unless staticDebugCounters={regex} is specified)",
  ...
  { "storeSinkingLastOpt=", "C<nnn>\tLast store sinking optimization to perform", TR::Options::set32BitNumeric,
    offsetof(OMR::Options, _storeSinkingLastOpt), static_cast<uintptrj_t>(-1), "F%d" },
  ...
  { "strictFPCompares", "C\tassume strictFP semantics for floating point compares only",
  ...
  { "suffixLogs", "O\tadd the date/time/pid suffix to the file name of the logs", SET_OPTION_BIT(TR_EnablePIDExtension),
    "F" },
  { "suffixLogsFormat=", "O\tadd the suffix in specified format to the file name of the logs", TR::Options::setString,
    offsetof(OMR::Options, _suffixLogsFormat), 0, "P%s" },
  ...
  { "tocSize=", "C<nnn>\tnumber of KiloBytes allocated for table of constants", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_tocSizeInKB, 0, "P%d (KB)", NOT_IN_SUBSET },
  ...
  { "traceBasicBlockHoisting", "L\ttrace basic block hoisting", TR::Options::traceOptimization, basicBlockHoisting, 0,
    "P" },
  { "traceBasicBlockPeepHole", "L\ttrace basic blocks peepHole", TR::Options::traceOptimization, basicBlockPeepHole, 0,
    "P" },
  ...
  { "traceBCDCodeGen", "L\ttrace binary coded decimal code generations", SET_TRACECG_BIT(TR_TraceCGBinaryCodedDecimal),
    "P" },
  { "traceBin", "L\tdump binary instructions",
    SET_TRACECG_BIT(TR_TraceCGPostBinaryEncoding | TR_TraceCGMixedModeDisassembly), "P" },
  { "traceBlockFrequencyGeneration", "L\ttrace block frequency generation", SET_OPTION_BIT(TR_TraceBFGeneration), "P" },
  { "traceBlockShuffling", "L\ttrace random rearrangement of blocks", TR::Options::traceOptimization, blockShuffling, 0,
    "P" },
  ...
  { "traceColdBlockMarker", "L\ttrace detection of cold blocks", TR::Options::traceOptimization, coldBlockMarker, 0,
    "P" },
  { "traceColdBlockOutlining", "L\ttrace outlining of cold blocks", TR::Options::traceOptimization, coldBlockOutlining,
    0, "P" },
  ...
  { "traceCompactNullChecks", "L\ttrace compact null checks", TR::Options::traceOptimization, compactNullChecks, 0,
    "P" },
  { "traceDeadTreeElimination", "L\ttrace dead tree elimination", TR::Options::traceOptimization, deadTreesElimination,
    0, "P" },
  ...
  { "traceFieldPrivatization", "L\ttrace field privatization", TR::Options::traceOptimization, fieldPrivatization, 0,
    "P" },
  { "traceForCodeMining=", "L{regex}\tadd instruction annotations for code mining", TR::Options::setRegex,
    offsetof(OMR::Options, _traceForCodeMining), 0, "P" },
...
#endif
  { "traceILDeadCode", "L\ttrace Instruction Level Dead Code (basic)", TR::Options::setBitsFromStringSet,
  ...
  { "traceIsolatedSE", "L\ttrace isolated store elimination", TR::Options::traceOptimization, isolatedStoreElimination,
    0, "P" },
  ...
  { "traceLabelTargetNOPs", "L\ttrace inserting of NOPs before label targets", SET_OPTION_BIT(TR_TraceLabelTargetNOPs),
    "F" },
  ...
  { "traceLocalCSE", "L\ttrace local common subexpression elimination", TR::Options::traceOptimization, localCSE, 0,
    "P" },
  { "traceLocalDSE", "L\ttrace local dead store elimination", TR::Options::traceOptimization, localDeadStoreElimination,
    0, "P" },
  ...
  { "traceLoopCanonicalization", "L\ttrace loop canonicalization", TR::Options::traceOptimization, loopCanonicalization,
    0, "P" },
  ...
  { "traceOSRDefAnalysis", "L\ttrace OSR reaching defintions analysis", TR::Options::traceOptimization, osrDefAnalysis,
    0, "P" },
#ifdef J9_PROJECT_SPECIFIC
  ...
  { "tracePostBinaryEncoding", "L\tdump instructions (code cache addresses, real registers) after binary encoding",
    SET_TRACECG_BIT(TR_TraceCGPostBinaryEncoding), "P" },
  { "tracePostInstructionSelection", "L\tdump instructions (virtual registers) after instruction selection",
    SET_TRACECG_BIT(TR_TraceCGPostInstructionSelection), "P" },
  { "tracePostRegisterAssignment", "L\tdump instructions (real registers) after register assignment",
    SET_TRACECG_BIT(TR_TraceCGPostRegisterAssignment), "P" },
  { "tracePRE", "L\ttrace partial redundancy elimination", TR::Options::traceOptimization, partialRedundancyElimination,
    0, "P" },
  { "tracePrefetchInsertion", "L\ttrace prefetch insertion", TR::Options::traceOptimization, prefetchInsertion, 0,
    "P" },
  { "tracePREForSubNodeReplacement", "L\ttrace partial redundancy elimination focussed on optimal subnode replacement",
    SET_OPTION_BIT(TR_TracePREForOptimalSubNodeReplacement), "P" },
  { "tracePreInstructionSelection", "L\tdump trees prior to instruction selection",
...
#endif
  { "traceRA", "L\ttrace register assignment (basic)", TR::Options::setBitsFromStringSet,
    offsetof(OMR::Options, _raTrace), TR_TraceRABasic, "F" },
  ...
  { "traceReachability", "L\ttrace all analyses based on the reachability engine", SET_OPTION_BIT(TR_TraceReachability),
    "P" },
  ...
  { "traceRegisterState", "L\ttrace bit vector denoting assigned registers after register allocation",
  ...
  { "traceRelocatableDataDetailsRT", "L\ttrace relocation data details when relocating relocatable code",
    SET_OPTION_BIT(TR_TraceRelocatableDataDetailsRT), "P" },
  { "traceRelocatableDataRT", "L\ttrace relocation data when relocating relocatable code",
    SET_OPTION_BIT(TR_TraceRelocatableDataRT), "P" },
  { "traceReloCG", "L\ttrace relocation data details with generation info when generating relocatable code",
  ...
  { "traceSequenceSimplification", "L\ttrace arithmetic sequence simplification", TR::Options::traceOptimization,
    expressionsSimplification, 0, "P" },
  { "traceSpillCosts", "L\ttrace spill costs (basic) only show its activation", TR::Options::setBitsFromStringSet,
  ...
  { "traceStaticFinalFieldFolding", "L\ttrace generic static final field folding", TR::Options::traceOptimization,
    staticFinalFieldFolding, 0, "P" },
  { "traceStringBuilderTransformer", "L\ttrace StringBuilder tranfsofermer optimization",
  ...
  { "traceTempUsageMore", "L\ttrace usage of temps, showing each temp used", SET_OPTION_BIT(TR_TraceTempUsageMore),
    "P" },
  ...
  { "traceTreeSimplification", "L\ttrace tree simplification", TR::Options::traceOptimization, treeSimplification, 0,
    "P" },
  { "traceTreeSimplification=", "L{regex}\tlist of additional options: mulDecompose", TR::Options::setBitsFromStringSet,
  ...
  { "traceTrivialBlockExtension", "L\ttrace trivial block extension", TR::Options::traceOptimization,
    trivialBlockExtension, 0, "P" },
  { "traceTrivialDeadTreeRemoval", "L\ttrace trivial dead tree removal", SET_OPTION_BIT(TR_TraceTrivialDeadTreeRemoval),
    "P" },
  ...
  { "traceVarHandleTransformer", "L\ttrace VarHandle transformer", TR::Options::traceOptimization, varHandleTransformer,
    0, "P" }, // Java specific option
  { "traceVFPSubstitution", "L\ttrace replacement of virtual frame pointer with actual register in memrefs",
    SET_OPTION_BIT(TR_TraceVFPSubstitution), "F" },
  { "traceVIP", "L\ttrace variable initializer propagation (constant propagation of read-only variables)",
  ...
  { "trivialInlinerMaxSize=", "O<nnn>\tmax size of a method that will be inlined by trivial inliner",
    TR::Options::set32BitNumeric, offsetof(OMR::Options, _trivialInlinerMaxSize), 0, " %d" },
  { "trustAllInterfaceTypeInfo",
    "O\tGive Java interface type information the same level of trust afforded to class info.  The Java spec is much "
    "more lackadasical about interface type safety, and requires us to be conservative.",
  ...
  { "turnOffSelectiveNoOptServerIfNoStartupHint", "M\t", SET_OPTION_BIT(TR_TurnOffSelectiveNoOptServerIfNoStartupHint),
    "F", NOT_IN_SUBSET },
  { "unleashStaticFieldFolding",
    "O\tbypass the class white-list, and allow static final fields to be folded aggressively",
  ...
  { "virtualMemoryCheckFrequencySec=",
    "O<nnn>\tFrequency of the virtual memory check (only applicable for 32 bit systems)", TR::Options::setStaticNumeric,
    (intptrj_t)&OMR::Options::_virtualMemoryCheckFrequencySec, 0, "F%d", NOT_IN_SUBSET },
...
char* OMR::Options::setNumeric(char* option, void* base, TR::OptionTable* entry)
{
  *((intptrj_t*)((char*)base + entry->parm1)) = (intptrj_t)TR::Options::getNumericValue(option);
  return option;
}

char* OMR::Options::set32BitNumeric(char* option, void* base, TR::OptionTable* entry)
{
  *((int32_t*)((char*)base + entry->parm1)) = (int32_t)TR::Options::getNumericValue(option);
  return option;
}

char* OMR::Options::set32BitNumericInJitConfig(char* option, void* base, TR::OptionTable* entry)
{
  return TR::Options::set32BitNumeric(option, _feBase, entry);
}

char* OMR::Options::set64BitSignedNumeric(char* option, void* base, TR::OptionTable* entry)
{
  int64_t sign = 1;
  if (*option == '-') {
    sign = -1;
...
char* OMR::Options::set32BitHexadecimal(char* option, void* base, TR::OptionTable* entry)
{
  *((int32_t*)((char*)base + entry->parm1)) = getHexadecimalValue(option);
  return option;
}

char* OMR::Options::set32BitSignedNumeric(char* option, void* base, TR::OptionTable* entry)
{
  int32_t sign = 1;
  if (*option == '-') {
    sign = -1;
...
char* OMR::Options::setStaticNumeric(char* option, void* base, TR::OptionTable* entry)
{
  *((int32_t*)entry->parm1) = (int32_t)TR::Options::getNumericValue(option);
  return option;
}

char* OMR::Options::setStaticNumericKBAdjusted(char* option, void* base, TR::OptionTable* entry)
{
  *((size_t*)entry->parm1) = (size_t)(TR::Options::getNumericValue(option) * 1024);
  return option;
}

char* OMR::Options::setStaticHexadecimal(char* option, void* base, TR::OptionTable* entry)
{
  *((uintptrj_t*)entry->parm1) = getHexadecimalValue(option);
  return option;
}

char* OMR::Options::setStatic32BitValue(char* option, void* base, TR::OptionTable* entry)
{
...
char* OMR::Options::setString(char* option, void* base, TR::OptionTable* entry)
{
  char* p;
  int32_t parenNest = 0;
  for (p = option; *p; p++) {
...
char* OMR::Options::setStringInJitConfig(char* option, void* base, TR::OptionTable* entry)
{
  return TR::Options::setString(option, _feBase, entry);
}

char* OMR::Options::setStringForPrivateBase(char* option, void* base, TR::OptionTable* entry)
{
#ifdef J9_PROJECT_SPECIFIC
...
char* OMR::Options::setStaticString(char* option, void* base, TR::OptionTable* entry)
{
    ...
    if (*position == '{') {
      for (; *position; ++position) {
        if (*position == '}') {
          ++position;
          break;
        } else if (*position == ',') { // replace ',' seperators with spaces so addDebug can parse them properly
          *position = ' ';
        }
      }
    }
...
char* OMR::Options::setStaticRegex(char* option, void* base, TR::OptionTable* entry)
{
  TR::SimpleRegex* regex = TR::SimpleRegex::create(option);
...
char* OMR::Options::latePostProcess(TR::Options* options, void* jitConfig, bool isAOT)
{
  char* rc = 0;
  ...
  if (!optionSet) {
    ...
    if (!(TR::Options::getCmdLineOptions() && TR::Options::getCmdLineOptions()->getOption(TR_DisableRampupImprovements)
      ...
      if (TR::Options::_smallMethodBytecodeSizeThresholdForCold == -1) // not yet set
        ...
        TR::Options::_smallMethodBytecodeSizeThresholdForCold = std::max<int32_t>(
          8, (TR::Compiler->target.numberOfProcessors() != 0 ? 32 / TR::Compiler->target.numberOfProcessors() : 8));
#endif
    ...
    if (TR::Options::sharedClassCache()) // If AOT shared classes is used
    {
      ...
      if (self()->getOption(TR_UseHigherMethodCounts)) {
        self()->setOption(TR_DisableDelayRelocationForAOTCompilations,
          true); // If scount has not been changed on the command line, adjust it here
        if (self()->getInitialSCount() == TR_INITIAL_SCOUNT) {
...
char* OMR::Options::processOptionsJIT(char* jitOptions, void* feBase, TR_FrontEnd* fe)
{
...
char* OMR::Options::processOptionsAOT(char* aotOptions, void* feBase, TR_FrontEnd* fe)
{
...
void OMR::Options::jitPreProcess()
{
  ...
  if (TR::isJ9()) {
    ...
    self()->setOption(
      TR_DisableThunkTupleJ2I); // JSR292:TODO: Figure out how to do this without confusing startPCIfAlreadyCompiled
...
TR::OptionSet* OMR::Options::findOptionSet(
  TR_Memory* trMemory, int32_t index, int32_t lineNum, TR_ResolvedMethod* vmMethod, TR_Hotness hotnessLevel, bool isAOT)
{
...
char* OMR::Options::processOptions(
  char* options, char* envOptions, void* feBase, TR_FrontEnd* fe, TR::Options* cmdLineOptions)
{
...
char* OMR::Options::processOptions(char* options, char* envOptions, TR::Options* cmdLineOptions)
{
...
char* OMR::Options::processOptionSet(char* options, char* envOptions, TR::Options* jitBase, bool isAOT)
{
...
char* OMR::Options::processOptionSet(char* options, char* envOptions, TR::OptionSet* optionSet)
{
...
char* OMR::Options::processOptionSet(char* options, TR::OptionSet* optionSet, void* jitBase, bool isAOT)
{
...
char* OMR::Options::processOption(
  char* startOption, TR::OptionTable* table, void* base, int32_t numEntries, TR::OptionSet* optionSet)
{
...
bool OMR::Options::jitPostProcess()
{
  ...
  if (_logFileName) {
    ...
    TR_VerboseLog::write(
      "<JIT: the log file option must be specified when a trace options is used: log=<filename>)>\n");
    return false;
  }
...
{
  TR_ASSERT(
    _jitCmdLineOptions == this || _aotCmdLineOptions == this, "getFixedOptLevel should be called on cmdlineoptions");
  return _optLevel;
}
...
{
  TR_ASSERT(
    _jitCmdLineOptions == this || _aotCmdLineOptions == this, "setFixedOptLevel should be called on cmdlineoptions");
  _optLevel = optLevel;
}
  ...
  } else // no counts string specified
  {
    ...
    if (_initialCount == -1) // Count was not set by user
    {
      if (startupTimeMatters) {
        ...
        if (TR::Compiler->target.isWindows() && TR::Compiler->target.is32Bit() && TR::Options::isQuickstartDetected()
    ...
    if (_initialMILCount == -1)
      _initialMILCount
        = std::min(startupTimeMatters ? TR_QUICKSTART_INITIAL_MILCOUNT : TR_DEFAULT_INITIAL_MILCOUNT, _initialBCount);
...
char* OMR::Options::setStaticBool(char* option, void* base, TR::OptionTable* entry)
{
...
char* OMR::Options::setAddressEnumerationBits(char* option, void* base, TR::OptionTable* entry)
{
  if (!_debug)
    TR::Options::createDebug();
...
OMR::Options::TR_OptionStringToBit OMR::Options::_optionStringToBitMapping[] = {
  ...
  { "deps", TR_TraceRADependencies }, { "details", TR_TraceRADetails }, { "preRA", TR_TraceRAPreAssignmentInstruction },
  { "spillTemps", TR_TraceRASpillTemps }, { "states", TR_TraceRARegisterStates }, { "listing", TR_TraceRAListing },

  // Instruction Level GRA named trace Options
  { "basic", TR_TraceGRABasic }, { "listing", TR_TraceGRAListing },
...
char* OMR::Options::setBitsFromStringSet(char* option, void* base, TR::OptionTable* entry)
{
  int i;
  if (!_debug)
    TR::Options::createDebug();
  ...
  if (entry->parm2 != 0) {
    ...
    *((int32_t*)((char*)base + entry->parm1)) = 0x1; // enable basic tracing is any set is provided
    ...
    if (!regex)
      ...
      if (*((int32_t*)((char*)base + entry->parm1)) == 0x00000000)
        TR_VerboseLog::write(
          "<JIT: Register assignment tracing options not found.  No additional tracing option was set.>");
    }
  }
...
char* OMR::Options::configureOptReporting(char* option, void* base, TR::OptionTable* entry)
{
  if (!_debug)
    TR::Options::createDebug();
...
char* OMR::Options::setVerboseBitsInJitPrivateConfig(char* option, void* base, TR::OptionTable* entry)
{
#ifdef J9_PROJECT_SPECIFIC
...
char* OMR::Options::setVerboseBits(char* option, void* base, TR::OptionTable* entry)
{
...
char* OMR::Options::setVerboseBitsHelper(
  char* option, VerboseOptionFlagArray* verboseOptionFlags, uintptrj_t defaultVerboseFlags)
{
...
char* OMR::Options::set32BitValue(char* option, void* base, TR::OptionTable* entry)
{
  *((int32_t*)((char*)base + entry->parm1)) = (int32_t)entry->parm2;
  return option;
}

char* OMR::Options::enableOptimization(char* option, void* base, TR::OptionTable* entry)
{
  ((TR::Options*)base)->_disabledOptimizations[entry->parm1] = false;
  return option;
}

char* OMR::Options::dontTraceOptimization(char* option, void* base, TR::OptionTable* entry)
{
  ((TR::Options*)base)->_traceOptimizations[entry->parm1] = false;
  return option;
}

char* OMR::Options::disableOptimization(char* option, void* base, TR::OptionTable* entry)
{
  ((TR::Options*)base)->_disabledOptimizations[entry->parm1] = true;
  return option;
}

char* OMR::Options::traceOptimization(char* option, void* base, TR::OptionTable* entry)
{
...
char* OMR::Options::helpOption(char* option, void* base, TR::OptionTable* entry)
{
  if (!_debug)
    TR::Options::createDebug();
...
char* OMR::Options::disableMoreOpts(char* option, void* base, TR::OptionTable* entry)
{
  TR::Options::processOptionSet(NoOptString
    "," DisableAllocationInliningString "," DisableInlineCheckCastString "," DisableInlineIfInstanceOfString
    "," DisableInlineInstanceOfString "," DisableInlineMonEntString "," DisableInlineMonExitString
    "," DisableInliningOfNativesString "," DisableNewInstanceImplOptString "," DisableFastStringIndexOfString,
    0, _currentOptionSet);
...
char* OMR::Options::breakOnLoad(char* option, void* base, TR::OptionTable* entry)
{
