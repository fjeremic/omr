...
public:
  ...
  int getUseSampling() const
  {
    return _flags.testAny(UseSampling);
  }
  void setUseSampling(bool b)
  {
    _flags.set(UseSampling, b);
  }
  ...
  void setOptLevelDowngraded(bool b)
  {
    _flags.set(OptLevelDowngraded, b);
  }
  ...
  bool isLogCompilation() const
  {
    return _flags.testAny(LogCompilation);
  }
  ...
  void setAddToUpgradeQueue()
  {
    _flags.set(AddToUpgradeQueue);
  }
  void resetAddToUpgradeQueue()
  {
    _flags.set(AddToUpgradeQueue, false);
  }

  bool inUse() const
  {
    return _flags.testAny(InUse);
  }
  ...
  int32_t getPerceivedCPUUtil() const
  {
    return _perceivedCPUUtil;
  }
  void setPerceivedCPUUtil(int32_t v)
  {
    _perceivedCPUUtil = v;
  }

  void setDisableCHOpts(bool b = true)
  {
    _flags.set(DisableCHOpts, b);
  }
  bool disableCHOpts()
  {
    return _flags.testAny(DisableCHOpts);
  }
  void setDisableGCR(bool b = true)
  {
    _flags.set(DisableGCR, b);
  }
  bool disableGCR()
  {
    return _flags.testAny(DisableGCR);
  }
  ...
  bool isExplicitCompilation()
  {
    return _flags.testAny(IsExplicitCompilation);
  }
  ...
  bool getIsStackAllocated() const
  {
    return _flags.testAny(IsStackAllocated);
  }
  void setIsStackAllocated()
  {
    _flags.set(IsStackAllocated, true);
  }
  bool getIsAotLoad() const
  {
    return _flags.testAny(IsAotLoad);
  }
  void setIsAotLoad(bool b)
  {
    _flags.set(IsAotLoad, b);
  }
  ...
  void setDontFailOnPurpose(bool b)
  {
    _flags.set(DontFailOnPurpose, b);
  }
  ...
  bool isHwpDoReducedWarm()
  {
    return _hwpDoReducedWarm;
  }
  void setIsHwpDoReducedWarm(bool b)
  {
    _hwpDoReducedWarm = b;
  }

  bool isInducedByDLT() const
  {
    return _flags.testAny(InducedByDLT);
  }
  void setInducedByDLT(bool b)
  {
    _flags.set(InducedByDLT, b);
  }

  // --------------------------------------------------------------------------
  // GPU
  //
  void setIsGPUCompilation(bool b = true)
  {
    _flags.set(IsGPUCompilation, b);
  }
  ...
  bool isGPUParallelStream()
  {
    return _flags.testAny(IsGPUParallelStream);
  }
  ...
  void setGPUResult(int32_t result)
  {
    _gpuResult = result;
  }
  int32_t getGPUResult()
  {
    return _gpuResult;
  }
...
public:
  ...
  static void setVerbose(int32_t v)
  {
    _verbose = v;
  }
  ...
  static TR::CompilationInfo* getCompilationInfo()
  {
    return _compInfo;
  }
