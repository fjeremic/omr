...
class TR_OptimizationPlan {
 public:
  ...
  enum {  // list of flags
    ...
    DowngradedDueToSamplingJProfiling =
        0x00400000,  // Compilation was downgraded to cold just because we
                     // wanted to do JProfiling
 ...
 private:
  ...
  int32_t _perceivedCPUUtil;  // percentage*10 (so that we can use fractional
                              // values) Will be set only for recompilations.
                              // <=0 means no info
