...
public:
  ...
  TR::SimpleRegex* getOptLevelRegex()
  {
    return _optLevelRegex;
  }
  ...
  void setNext(OptionSet* n)
  {
    _next = n;
  }
  void setOptions(TR::Options* o)
  {
    _options = o;
  }
  void setIndex(intptrj_t i)
  {
    _methodRegex = (TR::SimpleRegex*)(2 * i + 1);
  }
  void setMethodRegex(TR::SimpleRegex* r)
  {
    _methodRegex = r;
  }
  void setOptLevelRegex(TR::SimpleRegex* r)
  {
    _optLevelRegex = r;
  }
  void setStart(int32_t n)
  {
    _start = n;
  }
  void setEnd(int32_t n)
  {
    _end = n;
  }
