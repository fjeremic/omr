...
static void lookupScheme1(TR::CodeGenerator* cg,
                          TR::Node* node,
                          bool unbalanced);
static void lookupScheme2(TR::CodeGenerator* cg,
                          TR::Node* node,
                          bool unbalanced);
static void lookupScheme3(TR::CodeGenerator* cg,
                          TR::Node* node,
                          bool unbalanced);
...
TR::Instruction* OMR::ARM::TreeEvaluator::compareIntsForEquality(
    TR_ARMConditionCode branchType,
    TR::Node* node,
    TR::CodeGenerator* cg,
...
static TR::Register* icmpHelper(TR::Node* node,
