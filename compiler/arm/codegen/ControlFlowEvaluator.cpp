...
TR::Register *
OMR::ARM::TreeEvaluator::ificmpeqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ificmpltEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ificmpgeEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ificmpgtEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ificmpleEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ifiucmpltEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ifiucmpgeEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ifiucmpgtEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ifiucmpleEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::iflcmpeqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Node *firstChild = node->getFirstChild();
  TR::Node *secondChild = node->getSecondChild();
...
static TR::Register *
compareLongAndSetOrderedBoolean(TR_ARMConditionCode branchOp, TR::Node *node,
                                TR::CodeGenerator *cg) {
  TR::Node *firstChild = node->getFirstChild();
  TR::Node *secondChild = node->getSecondChild();
  TR::Register *src1Reg = cg->evaluate(firstChild);
...
TR::Register *
OMR::ARM::TreeEvaluator::iflcmpltEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Node *firstChild = node->getFirstChild();
  TR::Node *secondChild = node->getSecondChild();
  TR::Register *src1Reg = cg->evaluate(firstChild);
...
TR::Register *
OMR::ARM::TreeEvaluator::iflcmpgeEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Node *firstChild = node->getFirstChild();
  TR::Node *secondChild = node->getSecondChild();
  TR::Register *src1Reg = cg->evaluate(firstChild);
...
TR::Register *
OMR::ARM::TreeEvaluator::iflucmpltEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::Node *firstChild = node->getFirstChild();
  TR::Node *secondChild = node->getSecondChild();
  TR::Register *src1Reg = cg->evaluate(firstChild);
...
TR::Register *
OMR::ARM::TreeEvaluator::iflucmpgeEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::Node *firstChild = node->getFirstChild();
  TR::Node *secondChild = node->getSecondChild();
  TR::Register *src1Reg = cg->evaluate(firstChild);
...
TR::Register *
OMR::ARM::TreeEvaluator::iflcmpgtEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  return compareLongsForOrder(ARMConditionCodeGT, node, cg);
}

TR::Register *
OMR::ARM::TreeEvaluator::iflcmpleEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  return compareLongsForOrder(ARMConditionCodeLE, node, cg);
}

TR::Register *
OMR::ARM::TreeEvaluator::iflucmpgtEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  return compareLongsForOrder(ARMConditionCodeHI, node, cg);
}

TR::Register *
OMR::ARM::TreeEvaluator::iflucmpleEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  return compareLongsForOrder(ARMConditionCodeLS, node, cg);
}

TR::Register *
OMR::ARM::TreeEvaluator::ifacmpeqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *OMR::ARM::TreeEvaluator::ZEROCHKEvaluator(TR::Node *node,
  ...
  //
  TR_ARMOutOfLineCodeSection *outlinedHelperCall = new (cg->trHeapMemory())
      TR_ARMOutOfLineCodeSection(node, TR::call, NULL, slowPathLabel,
                                 restartLabel, cg);
...
TR::Register *
OMR::ARM::TreeEvaluator::resolveAndNULLCHKEvaluator(TR::Node *node,
                                                    TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ArrayCopyBNDCHKEvaluator(TR::Node *node,
                                                  TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ArrayStoreCHKEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::ArrayCHKEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
