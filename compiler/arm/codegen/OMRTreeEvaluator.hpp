...
public:
  ...
  static TR::Register* commonStoreEvaluator(TR::Node* node,
                                            ...
                                            int32_t memSize,
                                            TR::CodeGenerator* cg);
  static TR::Register* commonConstEvaluator(TR::Node* node,
                                            int32_t value,
                                            TR::CodeGenerator* cg);
#if J9_PROJECT_SPECIFIC
  static void VMwrtbarEvaluator(TR::Node* node,
                                TR::Register* srcReg,
                                TR::Register* dstReg,
                                TR::Register* flagReg,
                                bool needDeps,
...
generateSignOrZeroExtend(TR::Node* node,
                         ...
                         TR::CodeGenerator* cg);
void
simplifyANDRegImm(TR::Register* trgReg, TR::Register* srcReg, int32_t value);
static TR::Register*
