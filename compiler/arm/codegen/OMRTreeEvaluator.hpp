...
public:
  ...
  static TR::Register *checkcastAndNULLCHKEvaluator(TR::Node *node,
                                                    TR::CodeGenerator *cg);
#endif
  static TR::Register *newObjectEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *commonLoadEvaluator(TR::Node *node,
                                           TR_ARMOpCodes memoryToRegisterOp,
                                           int32_t memSize,
                                           TR::CodeGenerator *cg);
  static TR::Register *commonStoreEvaluator(TR::Node *node,
                                            TR_ARMOpCodes memToRegOp,
                                            int32_t memSize,
                                            TR::CodeGenerator *cg);
  static TR::Register *commonConstEvaluator(TR::Node *node, int32_t value,
                                            TR::CodeGenerator *cg);
#if J9_PROJECT_SPECIFIC
  static void VMwrtbarEvaluator(TR::Node *node, TR::Register *srcReg,
                                TR::Register *dstReg, TR::Register *flagReg,
                                bool needDeps, TR::CodeGenerator *cg);
  static TR::Register *VMmonentEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *VMmonexitEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
#endif
  // VM-dependent routines
#if J9_PROJECT_SPECIFIC
  static TR::Register *VMcheckcastEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *VMifInstanceOfEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *VMinstanceOfEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  ...
  static TR::Instruction *generateVFTMaskInstruction(TR::CodeGenerator *cg,
                                                     TR::Node *node,
                                                     TR::Register *dstReg,
                                                     TR::Register *srcReg,
  ...
  compareIntsForEquality(TR_ARMConditionCode branchType, TR::Node *node,
...
protected:
  static TR::Register *conversionAnalyser(TR::Node *node,
                                          TR_ARMOpCodes memoryToRegisterOp,
                                          bool needSignExtend, int dstBits,
                                          TR::CodeGenerator *cg);
};
...
void simplifyANDRegImm(TR::Register *trgReg, TR::Register *srcReg,
                       int32_t value);
