...
int32_t
TR::ARMConstantDataSnippet::addConstantRequest(void* v,
                                               TR::DataType type,
                                               ...
                                               bool isUnloadablePicSite)
{
  ...
  switch (type) {
    ...
    default:
      ...
      // is %d.\n", type);
      TR_ASSERT(
        0, "Only address constants are supported. Data type is %d.\n", type);
  }
...
bool
TR::ARMConstantDataSnippet::getRequestorsFromNibble(TR::Instruction* nibble,
                                                    TR::Instruction** q,
                                                    bool remove)
{
...
uint8_t*
TR::ARMConstantDataSnippet::emitSnippetBody()
{
...
uint32_t
TR::ARMConstantDataSnippet::getLength()
{
#if 0
...
#if DEBUG
void
TR::ARMConstantDataSnippet::print(TR::FILE* outFile)
{
  if (outFile == NULL)
    return;
