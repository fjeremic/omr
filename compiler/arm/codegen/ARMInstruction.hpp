...
public:
    ...
    ARMImmSymInstruction(TR_ARMOpCodes op, TR::Node* node, uint32_t imm, TR::RegisterDependencyConditions* cond,
        TR::SymbolReference* sr, TR::CodeGenerator* cg, TR::Snippet* s = NULL,
...
public:
    ...
    ARMSrc2Instruction(
        TR_ARMOpCodes op, TR::Node* node, TR::Register* s1reg, TR_ARMOperand2* s2op, TR::CodeGenerator* cg)
...
public:
    ...
    ARMTrg1Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* treg,
        TR::CodeGenerator* cg)
        : TR::Instruction(precedingInstruction, op, node, cg)
        , _target1Register(treg)
    {
...
public:
    ...
    ARMTrg2Src1Instruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* t1reg, TR::Register* t2reg,
        TR::Register* sreg, TR::CodeGenerator* cg)
        : TR::ARMTrg1Src2Instruction(op, node, cg)
...
public:
    ...
    ARMMemInstruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mf, bool memRead,
        TR::CodeGenerator* cg)
...
public:
    ...
    ARMTrg1MemSrc1Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node,
...
public:
    ...
    ARMMultipleMoveInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node,
