...
public:
  ...
  ARMImmInstruction(
    TR_ARMOpCodes op, TR::Node* node, TR::RegisterDependencyConditions* cond, uint32_t imm, TR::CodeGenerator* cg)
  ...
  ARMImmInstruction(
    TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, uint32_t imm, TR::CodeGenerator* cg)
  ...
  ARMImmInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node,
  ...
  ARMImmInstruction(TR_ARMOpCodes op, TR::Node* node, uint32_t imm, TR_ExternalRelocationTargetKind relocationKind,
    TR::CodeGenerator* cg)
  ...
  ARMImmInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, uint32_t imm,
...
public:
  ...
  ARMLabelInstruction(TR_ARMOpCodes op, TR::Node* node, TR::RegisterDependencyConditions* cond, TR::LabelSymbol* sym,
    TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cond, cg)
    , _symbol(sym)
    , _t1reg(NULL)
  ...
  ARMLabelInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::LabelSymbol* sym,
    TR::CodeGenerator* cg, TR::Register* t1reg = NULL, TR::Register* s1reg = NULL)
    : TR::Instruction(precedingInstruction, op, node, cg)
    , _symbol(sym)
    , _t1reg(t1reg)
    , _s1reg(s1reg)
  ...
  ARMLabelInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node,
  ...
  TR::Register* getTarget1Register()
  {
    return _t1reg;
  }
  ...
  TR::Register* getSource1Register()
  {
    return _s1reg;
  }
...
public:
  ...
  ARMConditionalBranchInstruction(
    TR_ARMOpCodes op, TR::Node* node, TR::LabelSymbol* sym, TR_ARMConditionCode cc, TR::CodeGenerator* cg)
  ...
  ARMConditionalBranchInstruction(TR_ARMOpCodes op, TR::Node* node, TR::RegisterDependencyConditions* cond,
  ...
  ARMConditionalBranchInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node,
    TR::LabelSymbol* sym, TR_ARMConditionCode cc, TR::CodeGenerator* cg)
  ...
  int32_t getEstimatedBinaryLocation()
  {
    return _estimatedBinaryLocation;
  }
  ...
  bool getFarRelocation()
  {
    return _farRelocation;
  }
  bool setFarRelocation(bool b)
  {
    return (_farRelocation = b);
  }
...
public:
  ARMAdminInstruction(TR_ARMOpCodes op, TR::Node* node, TR::Node* fenceNode, TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
    , _fenceNode(fenceNode)
  {}

  ARMAdminInstruction(TR_ARMOpCodes op, TR::Node* node, TR::Node* fenceNode, TR::RegisterDependencyConditions* cond,
    TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cond, cg)
    , _fenceNode(fenceNode)
  {}
  ...
  ARMAdminInstruction(
    TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Node* fenceNode, TR::CodeGenerator* cg)
    : TR::Instruction(precedingInstruction, op, node, cg)
    , _fenceNode(fenceNode)
  {}

  ARMAdminInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Node* fenceNode,
...
public:
  ...
  ARMImmSymInstruction(TR_ARMOpCodes op, TR::Node* node, uint32_t imm, TR::RegisterDependencyConditions* cond,
    TR::SymbolReference* sr, TR::CodeGenerator* cg, TR::Snippet* s = NULL, TR_ARMConditionCode cc = ARMConditionCodeAL);

  ARMImmSymInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, uint32_t imm,
  ...
  TR::Snippet* setCallSnippet(TR::Snippet* s)
  {
    return (_snippet = s);
  }
...
public:
  ...
  ARMTrg1Src2Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::CodeGenerator* cg)
    : TR::Instruction(precedingInstruction, op, node, cg)
    , _target1Register(0)
    , _source1Register(0)
    , _source2Operand(0)
  ...
  ARMTrg1Src2Instruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR::Register* s1reg,
  ...
  ARMTrg1Src2Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* treg,
  ...
  ARMTrg1Src2Instruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR::Register* s1reg, TR::Register* s2reg,
    TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
    , _target1Register(treg)
    , _source1Register(s1reg)
  ...
  TR_ARMOperand2* getSource2Operand()
  {
    return _source2Operand;
  }
...
public:
  ARMLoadStartPCInstruction(TR::Node* node, TR::Register* treg, TR::SymbolReference* symRef, TR::CodeGenerator* cg)
    : TR::ARMTrg1Src2Instruction(ARMOp_sub, node, treg, cg->machine()->getRealRegister(TR::RealRegister::gr15),
      new (cg->trHeapMemory()) TR_ARMOperand2(0xde, 24), cg)
  ...
  ARMLoadStartPCInstruction(TR::Instruction* precedingInstruction, TR::Node* node, TR::Register* treg,
    ...
    : TR::ARMTrg1Src2Instruction(precedingInstruction, ARMOp_sub, node, treg,
      cg->machine()->getRealRegister(TR::RealRegister::gr15), new (cg->trHeapMemory()) TR_ARMOperand2(0xde, 0), cg)
    , /* The value 0xde does not mean anything. It will be replaced in the binary encoding phase. */
    _symbolReference(symRef)
  {}
...
public:
  ...
  ARMSrc2Instruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* s1reg, TR_ARMOperand2* s2op, TR::CodeGenerator* cg)
  ...
  ARMSrc2Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* s1reg,
    TR_ARMOperand2* s2op, TR::CodeGenerator* cg)
...
public:
  ...
  ARMTrg1Src1Instruction(
    TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR_ARMOperand2* sop, TR::CodeGenerator* cg)
    : TR::ARMTrg1Src2Instruction(op, node, cg)
  {
  ...
  ARMTrg1Src1Instruction(TR_ARMOpCodes op, TR::Node* node, TR::RegisterDependencyConditions* cond, TR::Register* treg,
  ...
  ARMTrg1Src1Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* treg,
    TR_ARMOperand2* sop, TR::CodeGenerator* cg)
    : TR::ARMTrg1Src2Instruction(precedingInstruction, op, node, cg)
  {
    setTarget1Register(treg);
  ...
  ARMTrg1Src1Instruction(
    TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
    : TR::ARMTrg1Src2Instruction(op, node, cg)
  {
    TR_ARMOperand2* sop = new (cg->trHeapMemory()) TR_ARMOperand2(ARMOp2Reg, sreg);
    setTarget1Register(treg);
...
public:
  ...
  ARMTrg1Instruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
    , _target1Register(treg)
  {
    treg->incTotalUseCount();
  ...
  ARMTrg1Instruction(
    TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR::CodeGenerator* cg)
    : TR::Instruction(precedingInstruction, op, node, cg)
    , _target1Register(treg)
  {
    treg->incTotalUseCount();
...
public:
  ...
  ARMTrg2Src1Instruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* t1reg, TR::Register* t2reg, TR::Register* sreg,
    TR::CodeGenerator* cg)
    : TR::ARMTrg1Src2Instruction(op, node, cg)
  ...
  ARMTrg2Src1Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* t1reg,
    TR::Register* t2reg, TR::Register* sreg, TR::CodeGenerator* cg)
    : TR::ARMTrg1Src2Instruction(precedingInstruction, op, node, cg)
    , _target2Register(t2reg)
  {
    setTarget1Register(t1reg);
  ...
  TR::Register* getTarget2Register()
  {
    return _target2Register;
  }
...
public:
  ...
  ARMMulInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::CodeGenerator* cg)
    : TR::Instruction(precedingInstruction, op, node, cg)
    , _targetLoRegister(0)
    , _targetHiRegister(0)
    , _source1Register(0)
  ...
  ARMMulInstruction(TR_ARMOpCodes op, TR::Node* node, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cond, cg)
    , _targetLoRegister(0)
    , _targetHiRegister(0)
    , _source1Register(0)
  ...
  ARMMulInstruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* tregLo, TR::Register* s1reg, TR::Register* s2reg,
    TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
  ...
  ARMMulInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* tregLo,
    TR::Register* s1reg, TR::Register* s2reg, TR::CodeGenerator* cg)
    : TR::Instruction(precedingInstruction, op, node, cg)
    , _targetLoRegister(tregLo)
    , _targetHiRegister(0)
  ...
  ARMMulInstruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* tregHi, TR::Register* tregLo, TR::Register* s1reg,
  ...
  ARMMulInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* tregHi,
  ...
  TR::Register* getTargetLoRegister()
  {
    return _targetLoRegister;
  }
  ...
  TR::Register* getTargetHiRegister()
  {
    return _targetHiRegister;
  }
  ...
  TR::Register* getSource2Register()
  {
...
public:
  ...
  ARMMemInstruction(
    TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mf, bool memRead, TR::CodeGenerator* cg)
  ...
  ARMMemInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* treg,
    TR::MemoryReference* mf, bool memRead, TR::CodeGenerator* cg)
...
public:
  ...
  ARMMemSrc1Instruction(
    TR_ARMOpCodes op, TR::Node* node, TR::MemoryReference* mf, TR::Register* sreg, TR::CodeGenerator* cg)
    : TR::ARMMemInstruction(op, node, sreg, mf, true, cg)
  {}

  ARMMemSrc1Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node,
...
public:
  ...
  ARMTrg1MemInstruction(
    TR_ARMOpCodes op, TR::Node* node, TR::Register* sreg, TR::MemoryReference* mf, TR::CodeGenerator* cg)
    : TR::ARMMemInstruction(op, node, sreg, mf, false, cg)
  {}

  ARMTrg1MemInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* sreg,
...
public:
  ...
  ARMTrg1MemSrc1Instruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mf,
    TR::Register* sreg, TR::CodeGenerator* cg)
    : TR::ARMMemInstruction(op, node, treg, mf, false, cg)
    , _source1Register(sreg)
  {}

  ARMTrg1MemSrc1Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* treg,
    TR::MemoryReference* mf, TR::Register* sreg, TR::CodeGenerator* cg)
...
public:
  ...
  ARMControlFlowInstruction(
    TR_ARMOpCodes op, TR::Node* node, TR::RegisterDependencyConditions* deps, TR::CodeGenerator* cg)
  ...
  int32_t getNumSources()
  {
    return _numSources;
  }
  TR::Register* getSourceRegister(int32_t i)
  {
    return _sourceRegisters[i];
  }
  ...
  TR::Register* getTargetRegister(int32_t i)
  {
  ...
  TR_ARMOpCode& getOpCode2()
  {
    return _opCode2;
  }
  TR_ARMOpCodes getOpCode2Value()
  {
    return _opCode2.getOpCodeValue();
  }
  ...
  TR_ARMOpCode& getOpCode3()
  {
    return _opCode3;
  }
  TR_ARMOpCodes getOpCode3Value()
  {
    return _opCode3.getOpCodeValue();
  }
  ...
  TR_ARMOpCode& getCmpOp()
  {
    return _cmpOp;
  }
  TR_ARMOpCodes getCmpOpValue()
  {
    return _cmpOp.getOpCodeValue();
  }
...
public:
  ...
  ARMMultipleMoveInstruction(TR_ARMOpCodes op, TR::Node* node, TR::Register* mbr, uint16_t rl, TR::CodeGenerator* cg)
    : TR::Instruction(op, node, cg)
  ...
  ARMMultipleMoveInstruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::Register* mbr,
    uint16_t rl, TR::CodeGenerator* cg)
    : TR::Instruction(precedingInstruction, op, node, cg)
    , _memoryBaseRegister(mbr)
    , _registerList(rl)
    , _writeBack(false)
  ...
  virtual Kind getKind()
  {
    return IsMultipleMove;
  }

  TR::Register* getMemoryBaseRegister()
  {
    return _memoryBaseRegister;
  }
  ...
  uint16_t getRegisterList()
  {
    return _registerList;
  }
  uint16_t setRegisterList(uint16_t rl)
  {
    return (_registerList = rl);
  }

  bool setWriteBack()
  {
    return (_writeBack = true);
  }
  bool isWriteBack()
  {
    return _writeBack;
