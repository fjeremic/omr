...
struct ARMLinkageProperties {
  ...
  uint32_t getNumIntArgRegs() const
  {
    return _numIntegerArgumentRegisters;
  }

  uint32_t getNumFloatArgRegs() const
  {
  ...
  void setEndianness(bool isBigEndian)
  {
...
protected:
  ...
  // never JNI.
  int32_t buildARMLinkageArgs(TR::Node* callNode, TR::RegisterDependencyConditions* dependencies, TR::Register*& vftReg,
    TR_LinkageConventions conventions, bool isVirtualOrJNI);
};
} // namespace ARM
} // namespace OMR
