...
TR::TreeEvaluator::badILOpEvaluator, // TR::BadILOp
  ...
  TR::TreeEvaluator::integerHighestOneBit, TR::TreeEvaluator::integerLowestOneBit,
  TR::TreeEvaluator::integerNumberOfLeadingZeros, TR::TreeEvaluator::integerNumberOfTrailingZeros,
  TR::TreeEvaluator::integerBitCount, TR::TreeEvaluator::longHighestOneBit, TR::TreeEvaluator::longLowestOneBit,
  TR::TreeEvaluator::longNumberOfLeadingZeros, TR::TreeEvaluator::longNumberOfTrailingZeros,
