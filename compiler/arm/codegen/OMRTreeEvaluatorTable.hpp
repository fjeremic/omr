...
TR::TreeEvaluator::badILOpEvaluator,   // TR::BadILOp
  ...
  TR::TreeEvaluator::unImpOpEvaluator, // TR::newvalue (should be lowered before
                                       // evaluation)
  ...
  TR::TreeEvaluator::
    arraytranslateAndTestEvaluator,     // TR::arraytranslateAndTest
  ...
  TR::TreeEvaluator::integerBitCount, TR::TreeEvaluator::longHighestOneBit,
  TR::TreeEvaluator::longLowestOneBit,
  TR::TreeEvaluator::longNumberOfLeadingZeros,
  TR::TreeEvaluator::longNumberOfTrailingZeros, TR::TreeEvaluator::longBitCount,
