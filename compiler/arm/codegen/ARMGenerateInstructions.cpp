...
TR::Instruction* generateInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, TR::Instruction* prev)
{
  if (prev)
...
TR::Instruction* generateAdminInstruction(
  TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, TR::Node* fenceNode, TR::Instruction* prev)
{
  if (prev)
...
TR::Instruction* generateAdminInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
...
TR::Instruction* generateImmInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, uint32_t imm,
  TR::RegisterDependencyConditions* cond, TR::Instruction* prev)
...
TR::Instruction* generateImmInstruction(
  TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, uint32_t imm, TR::Instruction* prev)
...
TR::Instruction* generateImmInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, uint32_t imm,
  TR_ExternalRelocationTargetKind relocationKind, TR::SymbolReference* sr, TR::Instruction* prev)
{
  if (prev)
...
TR::Instruction* generateImmSymInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, uint32_t imm,
  TR::RegisterDependencyConditions* cond, TR::SymbolReference* sr, TR::Snippet* s, TR::Instruction* prev,
...
TR::Instruction* generateMemSrc1Instruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
...
TR::Instruction* generateTrg1MemInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, TR::Register* treg,
  TR::MemoryReference* mf, TR::Instruction* prev)
{
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
  TR_ARMOpCode opCode(op);
  if (opCode.isVFPOp()) {
...
TR::Instruction* generateTrg1MemSrc1Instruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
...
TR::Instruction* generateTrg1ImmInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, TR::Register* treg,
  uint32_t base, uint32_t rotate, TR::Instruction* prev)
{
...
TR::Instruction* generateSrc1ImmInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
...
TR::Instruction* generateSrc2Instruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, TR::Register* s1reg,
...
TR::Instruction* generateTrg1Src1Instruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
  ...
  if (op == ARMOp_fmrs || op == ARMOp_fmsr) {
    ...
    if (prev)
      return new (cg->trHeapMemory()) TR::ARMTrg1Src2Instruction(
        prev, op, node, (op == ARMOp_fmrs) ? treg : s1reg, (op == ARMOp_fmrs) ? s1reg : treg, operand, cg);
    else
      return new (cg->trHeapMemory()) TR::ARMTrg1Src2Instruction(
        op, node, (op == ARMOp_fmrs) ? treg : s1reg, (op == ARMOp_fmrs) ? s1reg : treg, operand, cg);
  } else {
...
TR::Instruction* generateTrg1Src1ImmInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
...
TR::Instruction* generateTrg1Src2Instruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
...
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
TR::Instruction* generateTrg2Src1Instruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
...
TR::Instruction* generateTrg1Src2MulInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
  TR::Register* treg, TR::Register* s1reg, TR::Register* s2reg, TR::Instruction* prev)
{
  if (prev)
...
TR::Instruction* generateTrg2Src2MulInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node,
...
TR::Instruction* generateLabelInstruction(TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, TR::LabelSymbol* sym,
  TR::Instruction* prev, TR::Register* trgReg, TR::Register* src1Reg)
{
  if (prev)
...
TR::ARMControlFlowInstruction* generateControlFlowInstruction(
  TR::CodeGenerator* cg, TR_ARMOpCodes op, TR::Node* node, TR::RegisterDependencyConditions* cond)
{
  if (cond)
