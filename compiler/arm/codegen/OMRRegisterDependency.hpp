...
struct TR_ARMRegisterDependency {
  ...
  TR::RealRegister::RegNum getRealRegister()
  {
  ...
  uint32_t assignFlags(uint8_t f)
  {
    return _flags = f;
  }
  uint32_t setFlags(uint8_t f)
  {
    return (_flags |= f);
  }
  uint32_t resetFlags(uint8_t f)
  {
    return (_flags &= ~f);
  }

  uint32_t getDefsRegister()
  {
    return _flags & DefinesDependentRegister;
  }
  uint32_t setDefsRegister()
  {
    return (_flags |= DefinesDependentRegister);
  }
  uint32_t resetDefsRegister()
  {
    return (_flags &= ~DefinesDependentRegister);
  }

  uint32_t getRefsRegister()
  {
    return _flags & ReferencesDependentRegister;
  }
  uint32_t setRefsRegister()
  {
    return (_flags |= ReferencesDependentRegister);
  }
  ...
  uint32_t getUsesRegister()
  {
    return _flags & UsesDependentRegister;
  }

  uint32_t getExcludeGPR0()
  {
    return _flags & ExcludeGPR0InAssigner;
  }
  uint32_t setExcludeGPR0()
  {
    return (_flags |= ExcludeGPR0InAssigner);
  }
  uint32_t resetExcludeGPR0()
  {
    return (_flags &= ~ExcludeGPR0InAssigner);
  }
...
public:
  ...
  TR_ARMRegisterDependencyGroup* getPreConditions()
  {
  ...
  uint32_t setAddCursorForPre(uint8_t a)
  {
  ...
  uint32_t setAddCursorForPost(uint8_t a)
  {
  ...
  TR_ARMRegisterDependencyGroup* getPostConditions()
  {
