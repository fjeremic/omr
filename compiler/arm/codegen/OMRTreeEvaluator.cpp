...
TR::Instruction *
loadAddressConstantFixed(TR::CodeGenerator *cg, TR::Node *node, intptrj_t value,
                         TR::Register *trgReg, TR::Instruction *cursor,
                         uint8_t *targetAddress, uint8_t *targetAddress2,
                         int16_t typeAddress, bool doAOTRelocation) {
  TR::Compilation *comp = cg->comp();
...
TR::Register *
OMR::ARM::TreeEvaluator::awrtbariEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::MemoryReference *tempMR =
      new (cg->trHeapMemory()) TR::MemoryReference(node, 4, cg);
...
TR::Register *
OMR::ARM::TreeEvaluator::integerHighestOneBit(TR::Node *node,
                                              TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
TR::Register *
OMR::ARM::TreeEvaluator::integerLowestOneBit(TR::Node *node,
                                             TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
TR::Register *
OMR::ARM::TreeEvaluator::integerNumberOfLeadingZeros(TR::Node *node,
                                                     TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
TR::Register *
OMR::ARM::TreeEvaluator::integerNumberOfTrailingZeros(TR::Node *node,
                                                      TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::longHighestOneBit(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::longNumberOfLeadingZeros(TR::Node *node,
                                                  TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
TR::Register *
OMR::ARM::TreeEvaluator::longNumberOfTrailingZeros(TR::Node *node,
                                                   TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::reverseLoadEvaluator(TR::Node *node,
                                              TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::reverseStoreEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::arraytranslateAndTestEvaluator(TR::Node *node,
                                                        TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::arraytranslateEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::arraysetEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::arraycmpEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR_UNIMPLEMENTED();
  return NULL;
}
...
TR::Register *
OMR::ARM::TreeEvaluator::arraycopyEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::asynccheckEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg) {
...
#if J9_PROJECT_SPECIFIC
TR::Register *
OMR::ARM::TreeEvaluator::instanceofEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg) {
  return VMinstanceOfEvaluator(node, cg);
}

TR::Register *
OMR::ARM::TreeEvaluator::checkcastEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  return OMR::ARM::TreeEvaluator::VMcheckcastEvaluator(node, cg);
}

TR::Register *
OMR::ARM::TreeEvaluator::checkcastAndNULLCHKEvaluator(TR::Node *node,
                                                      TR::CodeGenerator *cg) {
  return OMR::ARM::TreeEvaluator::VMcheckcastEvaluator(node, cg);
}

TR::Register *
OMR::ARM::TreeEvaluator::newObjectEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  return VMnewEvaluator(node, cg);
}

TR::Register *
OMR::ARM::TreeEvaluator::newArrayEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::anewArrayEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  if (cg->comp()->suppressAllocationInlining()) {
    TR::ILOpCodes opCode = node->getOpCodeValue();
    TR::Node::recreate(node, TR::acall);
...
TR::Register *
OMR::ARM::TreeEvaluator::multianewArrayEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg) {
  TR::ILOpCodes opCode = node->getOpCodeValue();
  TR::Node::recreate(node, TR::acall);
  TR::Register *targetRegister = directCallEvaluator(node, cg);
...
TR::Register *
OMR::ARM::TreeEvaluator::directCallEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg) {
  TR::SymbolReference *symRef = node->getSymbolReference();
...
// TR::calli
TR::Register *
OMR::ARM::TreeEvaluator::indirectCallEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  TR::SymbolReference *symRef = node->getSymbolReference();
  TR::MethodSymbol *callee = symRef->getSymbol()->castToMethodSymbol();
  TR::Linkage *linkage = cg->getLinkage(callee->getLinkageConvention());
...
TR::Register *
OMR::ARM::TreeEvaluator::exceptionRangeFenceEvaluator(TR::Node *node,
                                                      TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::loadaddrEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::aRegLoadEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::iRegLoadEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Register *globalReg = node->getRegister();
...
TR::Register *
OMR::ARM::TreeEvaluator::lRegLoadEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Register *globalReg = node->getRegister();
...
TR::Register *
OMR::ARM::TreeEvaluator::iRegStoreEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
...
TR::Register *
OMR::ARM::TreeEvaluator::lRegStoreEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::Node *child = node->getFirstChild();
  TR::Register *globalReg = cg->evaluate(child);
  child->decReferenceCount();
...
TR::Register *
OMR::ARM::TreeEvaluator::GlRegDepsEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  int i;
...
TR::Register *
OMR::ARM::TreeEvaluator::passThroughEvaluator(TR::Node *node,
                                              TR::CodeGenerator *cg) {
