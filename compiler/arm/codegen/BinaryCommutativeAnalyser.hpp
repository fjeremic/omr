...
class TR_ARMBinaryCommutativeAnalyser : public TR_Analyser {
 ...
 public:
  TR_ARMBinaryCommutativeAnalyser(TR::CodeGenerator *cg)
      : _cg(cg), reversedOperands(false) {}

  void genericAnalyser(TR::Node *root, TR_ARMOpCodes regToRegOpCode,
                       TR_ARMOpCodes copyOpCode,
                       bool nonClobberingDestination = false);

  void genericLongAnalyser(TR::Node *root, TR_ARMOpCodes lowRegToRegOpCode,
