...
void
TR_ARMOutOfLineCodeSection::generateARMOutOfLineCodeSectionDispatch()
{
  ...
  if (_targetReg) {
    ...
    generateTrg1Src1Instruction(
      _cg, ARMOp_mov, _callNode, _targetReg, resultReg);
  }
  ...
  generateLabelInstruction(
    _cg, ARMOp_label, _callNode, generateLabelSymbol(_cg));
...
void
TR_ARMOutOfLineCodeSection::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
