...
public:
  ...
  Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node, TR::CodeGenerator* cg);

  Instruction(TR_ARMOpCodes op, TR::Node* node, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg);

  Instruction(TR::Instruction* precedingInstruction, TR_ARMOpCodes op, TR::Node* node,
  ...
  TR_ARMOpCode& getOpCode()
  {
    return _opcode;
  }
  TR_ARMOpCodes getOpCodeValue()
  {
    return _opcode.getOpCodeValue();
  }
  TR_ARMOpCodes getRecordFormOpCode()
  {
    return _opcode.getRecordFormOpCodeValue();
  }
  TR_ARMOpCodes setOpCodeValue(TR_ARMOpCodes op)
  {
  ...
  TR_ARMConditionCode getConditionCode()
  {
    return _conditionCode;
  }
  TR_ARMConditionCode setConditionCode(TR_ARMConditionCode conds)
  {
    return (_conditionCode = conds);
  }
  ...
  virtual bool setWriteBack()
  {
    return false;
  }
  virtual bool isWriteBack()
  {
    return false;
  }
  ...
  {
    return _opcode.getOpCodeValue() == ARMOp_label;
  }
