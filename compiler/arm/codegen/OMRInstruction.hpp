...
// for assertion checking
  ...
  // @@ virtual bool  usesCountRegister()                        {return
  // _opcode.usesCountRegister();}
  /* @@
  ...
  */
  ...
  // @@ virtual bool     is4ByteLoad()      {return (getOpCodeValue() ==
  // TR::InstOpCode::lwz);}
  ...
  // @@ virtual bool     isSyncSideEffectFree()  {return
  // _opcode.isSyncSideEffectFree();}
  // @@ virtual bool     isCall();

  /*
   * Maps to TIndex in Instruction. Here we set values specific to PPC CodeGen.
   *
   * A 32-bit field where the lower 24-bits contain an integer that represents
   * an approximate ordering of instructions.
   *
