...
// currently TR doesn't have a generic component for real register, so derive
// from OMR directly
...
class OMR_EXTENSIBLE RealRegister : public OMR::RealRegister {
 protected:
  ...
  RealRegister(TR_RegisterKinds rk, uint16_t w, RegState s, RegNum rn,
               RegMask m, TR::CodeGenerator *cg)
      : OMR::RealRegister(rk, w, s, (uint16_t)0, rn, m,
                          cg) /* , _useVSR(false) */ {}
