...
static TR::Register*
moveToFloatRegister(TR::Node* node, TR::Register* srcReg, TR::CodeGenerator* cg)
{
...
static TR::Register*
moveToDoubleRegister(TR::Node* node,
                     TR::Register* srcReg,
                     TR::CodeGenerator* cg)
{
  if (srcReg->getKind() == TR_FPR) {
  ...
  } else // GPR
  {
    ...
    generateTrg1Src2Instruction(
      cg, ARMOp_fmdrr, node, trgReg, pair->getLowOrder(), pair->getHighOrder());
    return trgReg;
  }
}

static TR::Register*
moveFromFloatRegister(TR::Node* node,
                      TR::Register* srcReg,
                      TR::CodeGenerator* cg)
{
...
static TR::Register*
moveFromDoubleRegister(TR::Node* node,
                       TR::Register* srcReg,
                       TR::CodeGenerator* cg)
{
...
static bool
resultCanStayInFloatRegister(TR::Node* checkNode, TR::Node* node)
{
  bool result = true;
  TR::Node* child = NULL;
                         ...
                         TR::CodeGenerator* cg)
{
  ...
  } else // 1 child
  {
    generateTrg1Src1Instruction(
      cg, opCode, node, floatTrgReg, moveToFloatRegister(node, src1Reg, cg));
  }
                         ...
                         TR::CodeGenerator* cg)
{
  ...
  {
    generateTrg1Src1Instruction(
      cg, opCode, node, doubleTrgReg, moveToDoubleRegister(node, src1Reg, cg));
  }
...
static TR::Register*
callLong2DoubleHelper(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  generateImmSymInstruction(
    ...
    cg->symRefTab()->findOrCreateRuntimeHelper(
      TR_ARMlong2Double, false, false, false));
...
static TR::Register*
callLong2FloatHelper(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* srcReg = cg->evaluate(child);
  TR::RegisterDependencyConditions* dependencies = new (cg->trHeapMemory())
  ...
  generateImmSymInstruction(
    ...
    dependencies,
    cg->symRefTab()->findOrCreateRuntimeHelper(
      TR_ARMlong2Float, false, false, false));
...
static TR::Register*
callDouble2LongHelper(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  ...
  TR::addDependency(
    dependencies, NULL, TR::RealRegister::gr2, TR_GPR, cg); // Block r2
  dependencies->stopAddingConditions();
  ...
  generateImmSymInstruction(
    ...
    dependencies,
    cg->symRefTab()->findOrCreateRuntimeHelper(
      TR_ARMdouble2Long, false, false, false));
...
static TR::Register*
callFloat2LongHelper(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  ...
  generateImmSymInstruction(
    ...
    dependencies,
    cg->symRefTab()->findOrCreateRuntimeHelper(
      TR_ARMfloat2Long, false, false, false));
...
static TR::Register*
callDoubleRemainderHelper(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
  ...
  if (!noFPRA) {
    if ((src1Reg->getKind() == TR_FPR) &&
      ...
      generateTrg1Src1Instruction(
        cg, ARMOp_fcpyd, firstChild, tempReg, src1Reg);
      src1Reg = tempReg;
    }
    if ((src2Reg->getKind() == TR_FPR) &&
      ...
      TR::Register* tempReg = cg->allocateRegister(TR_FPR);
      generateTrg1Src1Instruction(
        cg, ARMOp_fcpyd, secondChild, tempReg, src2Reg);
      src2Reg = tempReg;
    }
  }
  ...
  if (TR::Compiler->target.cpu.isLittleEndian()) {
    ...
    TR::addDependency(
      dependencies, src2Reg->getLowOrder(), TR::RealRegister::gr2, TR_GPR, cg);
    TR::addDependency(
      dependencies, src2Reg->getHighOrder(), TR::RealRegister::gr3, TR_GPR, cg);
    ...
    TR::addDependency(
      dependencies, src2Reg->getHighOrder(), TR::RealRegister::gr2, TR_GPR, cg);
    TR::addDependency(
      dependencies, src2Reg->getLowOrder(), TR::RealRegister::gr3, TR_GPR, cg);
  ...
  generateImmSymInstruction(
    ...
    node,
    (uintptr_t)cg->symRefTab()
      ->findOrCreateRuntimeHelper(TR_ARMdoubleRemainder, false, false, false)
      ->getMethodAddress(),
    dependencies,
    cg->symRefTab()->findOrCreateRuntimeHelper(
...
static TR::Register*
callFloatRemainderHelper(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
  TR::Node* secondChild = node->getSecondChild();
  TR::Register* src1Reg = cg->evaluate(firstChild);
  ...
  if (!noFPRA) {
    if ((src1Reg->getKind() == TR_FPR) &&
      ...
      TR::Register* tempReg = cg->allocateRegister(TR_FPR);
      generateTrg1Src1Instruction(
        cg, ARMOp_fcpys, firstChild, tempReg, src1Reg);
      src1Reg = tempReg;
    }
    if ((src2Reg->getKind() == TR_FPR) &&
        !cg->canClobberNodesRegister(secondChild, 0)) {
      TR::Register* tempReg = cg->allocateRegister(TR_FPR);
      generateTrg1Src1Instruction(
        cg, ARMOp_fcpys, secondChild, tempReg, src2Reg);
      src2Reg = tempReg;
    }
  }
  ...
  generateImmSymInstruction(
    ...
    dependencies,
    cg->symRefTab()->findOrCreateRuntimeHelper(
      TR_ARMfloatRemainder, false, false, false));
...
TR::Register*
OMR::ARM::TreeEvaluator::ibits2fEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
...
TR::Register*
OMR::ARM::TreeEvaluator::fbits2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
...
TR::Register*
OMR::ARM::TreeEvaluator::lbits2dEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
...
TR::Register*
OMR::ARM::TreeEvaluator::dbits2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* target = NULL;
  TR::Register* srcReg = NULL;
...
TR::Register*
OMR::ARM::TreeEvaluator::fconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  generateTrg1Src1ImmInstruction(
    cg, ARMOp_add, node, tempReg, machineIPReg, 8, 0);
  TR::MemoryReference* tempMR =
...
TR::Register*
OMR::ARM::TreeEvaluator::dconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  // Use PC relative to get to the constant data, loading data at Snippet area
  // is too far Example:
  ...
  generateTrg1Src1ImmInstruction(
    cg, ARMOp_add, node, tempReg, machineIPReg, 12, 0);
  TR::MemoryReference* tempMR =
    new (cg->trHeapMemory()) TR::MemoryReference(machineIPReg, NULL, cg);
  ...
  if (TR::Compiler->target.cpu.isLittleEndian()) {
    ...
    generateImmInstruction(
      cg, ARMOp_dd, node, (int32_t)((i64 >> 32) & 0xffffffff));
  } else {
    generateImmInstruction(
      cg, ARMOp_dd, node, (int32_t)((i64 >> 32) & 0xffffffff));
    generateImmInstruction(cg, ARMOp_dd, node, (int32_t)i64);
...
TR::Register*
OMR::ARM::TreeEvaluator::floadEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg = NULL;
//#define STAYINFP
#ifdef STAYINFP
  ...
  if (noFPRA) {
    if (resultCanStayInFloatRegister(
          cg->getCurrentEvaluationTreeTop()->getNode(), node)) {
      traceMsg(
        cg->comp(), "Result of node %p can stay in FP reg in fload.\n", node);
...
TR::Register*
OMR::ARM::TreeEvaluator::dloadEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg = NULL;
  TR::Register* doubleTrgReg = cg->allocateRegister(TR_FPR);
  TR::MemoryReference* tempMR =
  ...
  if (noFPRA) {
    if (resultCanStayInFloatRegister(
          cg->getCurrentEvaluationTreeTop()->getNode(), node)) {
      traceMsg(
        cg->comp(), "Result of node %p can stay in FP reg in dload.\n", node);
      trgReg = doubleTrgReg;
    } else {
      trgReg = moveFromDoubleRegister(node, doubleTrgReg, cg);
      cg->stopUsingRegister(doubleTrgReg);
...
TR::Register*
OMR::ARM::TreeEvaluator::fstoreEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
...
TR::Register*
OMR::ARM::TreeEvaluator::dstoreEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
  TR::Register* sourceReg = cg->evaluate(firstChild);
    ...
    if (sourceReg->getKind() == TR_GPR) {
      ...
      if (TR::Compiler->target.cpu.isBigEndian()) {
        generateMemSrc1Instruction(
          cg, ARMOp_str, node, lowMR, sourceReg->getHighOrder());
        generateMemSrc1Instruction(
          cg, ARMOp_str, node, highMR, sourceReg->getLowOrder());
      } else {
        generateMemSrc1Instruction(
          cg, ARMOp_str, node, lowMR, sourceReg->getLowOrder());
        generateMemSrc1Instruction(
          cg, ARMOp_str, node, highMR, sourceReg->getHighOrder());
      }
    } else if (sourceReg->getKind() == TR_FPR) {
      TR::MemoryReference* tempMR =
        new (cg->trHeapMemory()) TR::MemoryReference(node, 8, cg);
...
TR::Register*
OMR::ARM::TreeEvaluator::ifstoreEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* secondChild = node->getSecondChild();
...
TR::Register*
OMR::ARM::TreeEvaluator::idstoreEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* secondChild = node->getSecondChild();
  TR::Register* sourceReg = cg->evaluate(secondChild);
...
TR::Register*
OMR::ARM::TreeEvaluator::freturnEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (returnRegister->getKind() == TR_GPR) {
    TR::addDependency(deps,
                      returnRegister,
                      cg->getProperties().getIntegerReturnRegister(),
                      TR_GPR,
                      cg);
...
TR::Register*
OMR::ARM::TreeEvaluator::dreturnEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* returnRegister = cg->evaluate(node->getFirstChild());
  TR::RegisterDependencyConditions* deps = new (cg->trHeapMemory())
    TR::RegisterDependencyConditions(2, 2, cg->trMemory());
  ...
  if (returnRegister->getKind() == TR_GPR) {
    TR::addDependency(deps,
                      returnRegister->getLowOrder(),
                      cg->getProperties().getLongLowReturnRegister(),
                      TR_GPR,
                      cg);
    TR::addDependency(deps,
                      returnRegister->getHighOrder(),
                      cg->getProperties().getLongHighReturnRegister(),
                      TR_GPR,
                      cg);
  } else if (returnRegister->getKind() == TR_FPR) {
                         ...
                         TR::CodeGenerator* cg)
{
  ...
  if (addNode->getDataType() == TR::Float) {
    if (noFPRA) {
      ...
      generateTrg1Src1Instruction(
        cg, ARMOp_fmrs, addNode, trgRegister, floatTrgReg);
      cg->stopUsingRegister(floatTrgReg);
    } else {
      generateTrg1Src2Instruction(
        cg, OpCode, addNode, trgRegister, source1Register, source2Register);
    }
  } else {
    // TR::Double
    if (noFPRA) {
      ...
      generateTrg2Src1Instruction(cg,
                                  ARMOp_fmrrd,
                                  addNode,
                                  trgRegister->getLowOrder(),
                                  trgRegister->getHighOrder(),
                                  doubleTrgReg);
      cg->stopUsingRegister(doubleTrgReg);
    } else {
      generateTrg1Src2Instruction(
...
TR::Register*
OMR::ARM::TreeEvaluator::faddEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::daddEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::dsubEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::fsubEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::fmulEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return singlePrecisionEvaluator(node, ARMOp_fmuls, cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::dmulEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return doublePrecisionEvaluator(node, ARMOp_fmuld, cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::fdivEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return singlePrecisionEvaluator(node, ARMOp_fdivs, cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::ddivEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return doublePrecisionEvaluator(node, ARMOp_fdivd, cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::fremEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::dremEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::fabsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return singlePrecisionEvaluator(node, ARMOp_fabss, cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::dabsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return doublePrecisionEvaluator(node, ARMOp_fabsd, cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::fnegEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (firstChild->getReferenceCount() < 2 && !firstChild->getRegister() &&
    ...
    if (noFPRA) {
      ...
      generateTrg1Src2Instruction(
        cg, ARMOp_fnmuls, node, floatTrgReg, src1Register, src2Register);
      result = floatTrgReg;
    }
    cg->decReferenceCount(firstChild);
  } else {
...
TR::Register*
OMR::ARM::TreeEvaluator::dnegEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (firstChild->getReferenceCount() < 2 && !firstChild->getRegister() &&
    ...
    if (noFPRA) {
      ...
      generateTrg1Src2Instruction(
        cg, ARMOp_fnmuld, node, doubleTrgReg, src1Register, src2Register);
      result = doubleTrgReg;
    }
    cg->decReferenceCount(firstChild);
  } else {
...
TR::Register*
OMR::ARM::TreeEvaluator::i2fEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::i2dEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::l2fEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::l2dEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::f2dEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
  TR::Register* src1Reg = NULL;
...
TR::Register*
OMR::ARM::TreeEvaluator::f2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  // Supports f2iu
  TR::Node* firstChild = node->getFirstChild();
  TR::Register* src1Reg = NULL;
...
TR::Register*
OMR::ARM::TreeEvaluator::d2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  // Supports d2iu
  TR::Node* firstChild = node->getFirstChild();
  TR::Register* src1Reg = NULL;
  ...
  if (firstChild->getReferenceCount() == 1 &&
    ...
    src1Reg = cg->evaluate(firstChild);
    generateTrg1Src1Instruction(
      cg, opcode, node, floatTrgReg, moveToDoubleRegister(node, src1Reg, cg));
    cg->decReferenceCount(firstChild);
  }
...
// also handles f2c
TR::Register*
OMR::ARM::TreeEvaluator::d2cEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
// also handles f2s
TR::Register*
OMR::ARM::TreeEvaluator::d2sEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
// also handles f2b
TR::Register*
OMR::ARM::TreeEvaluator::d2bEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::f2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::d2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::d2fEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
  TR::Register* src1Reg = NULL;
  TR::Register* trgReg = NULL;
  ...
  if (deps) {
    ...
    if (unordered)
      generateConditionalBranchInstruction(
        cg, node, ARMConditionCodeVS, label, deps);
  } else {
...
static TR::Register*
setboolFloatEvaluator(TR::Node* node,
                      TR_ARMOpCodes opCode,
                      TR_ARMConditionCode cond,
                      TR::CodeGenerator* cg,
                      bool isDouble,
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  bool unordered = (node->getOpCodeValue() == TR::iffcmpequ ||
                    node->getOpCodeValue() == TR::ifdcmpequ);
  ifFloatEvaluator(node,
                   isDouble ? ARMOp_fcmpd : ARMOp_fcmps,
                   ARMConditionCodeEQ,
                   cg,
                   isDouble,
                   unordered);
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  ifFloatEvaluator(node,
                   isDouble ? ARMOp_fcmpd : ARMOp_fcmps,
                   unordered ? ARMConditionCodeLT : ARMConditionCodeCC,
                   cg,
                   isDouble,
                   false);
  return NULL;
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  ifFloatEvaluator(node,
                   isDouble ? ARMOp_fcmpd : ARMOp_fcmps,
                   unordered ? ARMConditionCodeCS : ARMConditionCodeGE,
                   cg,
                   isDouble,
                   false);
  return NULL;
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  ifFloatEvaluator(node,
                   isDouble ? ARMOp_fcmpd : ARMOp_fcmps,
                   unordered ? ARMConditionCodeHI : ARMConditionCodeGT,
                   cg,
                   isDouble,
                   false);
  return NULL;
                                           ...
                                           TR::CodeGenerator* cg)
{
  ...
  ifFloatEvaluator(node,
                   isDouble ? ARMOp_fcmpd : ARMOp_fcmps,
                   unordered ? ARMConditionCodeLE : ARMConditionCodeLS,
                   cg,
                   isDouble,
                   false);
  return NULL;
...
TR::Register*
OMR::ARM::TreeEvaluator::dcmpneEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  // ARMConditionCodeNE may imply unordered, but looks like it is not used in
  // common code
...
TR::Register*
OMR::ARM::TreeEvaluator::dcmpltEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  // ARMConditionCodeCC is for LT and ARMConditionCodeLT is for LTU
...
TR::Register*
OMR::ARM::TreeEvaluator::dcmpgeEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  // ARMConditionCodeGE is for GE and ARMConditionCodeCS is for GEU
...
TR::Register*
OMR::ARM::TreeEvaluator::dcmpgtEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  // ARMConditionCodeGT is for GT and ARMConditionCodeHI is for GTU
...
TR::Register*
OMR::ARM::TreeEvaluator::dcmpleEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  // ARMConditionCodeLS is for LE and ARMConditionCodeLE is for LEU
...
TR::Register*
OMR::ARM::TreeEvaluator::dcmplEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (noFPRA) {
    ...
    generateSrc2Instruction(
      cg, isDouble ? ARMOp_fcmpd : ARMOp_fcmps, node, src1Reg, src2Reg);
  }
  // Move the FPSCR flags back to the APSR
  generateInstruction(cg, ARMOp_fmstat, node);
  ...
  cursor = generateTrg1Src1ImmInstruction(
    cg, ARMOp_add, node, trgReg, trgReg, 1, 0, cursor);
  if (isGType)
  ...
  cursor = generateTrg1Src1ImmInstruction(
    cg, ARMOp_sub, node, trgReg, trgReg, 1, 0, cursor);
  if (isGType)
...
static TR::Register*
generateFloatMaxMin(TR::Node* node, TR::CodeGenerator* cg, bool max)
{
  TR::Node* firstChild = node->getFirstChild();
  ...
  generateSrc2Instruction(
    cg, (isFloat) ? ARMOp_fcmps : ARMOp_fcmpd, node, trgFloatReg, trgFloatReg);
  generateInstruction(cg, ARMOp_fmstat, node);
  generateConditionalBranchInstruction(
    cg, node, ARMConditionCodeVS, doneLabel, deps);

  // Check for NaN
  cursor = generateSrc2Instruction(cg,
                                   (isFloat) ? ARMOp_fcmps : ARMOp_fcmpd,
                                   node,
                                   childFloatReg,
                                   childFloatReg);
  cursor = generateInstruction(cg, ARMOp_fmstat, node, cursor);
  cursor = generateTrg1Src1Instruction(cg,
                                       (isFloat) ? ARMOp_fcpys : ARMOp_fcpyd,
                                       node,
                                       trgFloatReg,
                                       childFloatReg,
                                       cursor);
  ...
  cursor = generateConditionalBranchInstruction(
    cg, node, ARMConditionCodeVS, doneLabel, deps, cursor);

  // TODO: Special case firstChild is -0.0, secondChild is 0.0, compare it in
  // general register
  if (isFloat) {
    cursor = generateSrc1ImmInstruction(cg,
                                        ARMOp_cmp,
                                        node,
                                        max ? trgReg : childReg,
                                        0x80,
    ...
    cursor = generateSrc1ImmInstruction(cg,
                                        ARMOp_cmp,
                                        node,
                                        max ? trgReg->getLowOrder()
                                            : childReg->getLowOrder(),
                                        0,
                                        0,
                                        cursor);
   ...
   */
  cursor = generateSrc1ImmInstruction(cg,
                                      (isFloat) ? ARMOp_fcmpzs : ARMOp_fcmpzd,
                                      node,
                                      max ? childFloatReg : trgFloatReg,
                                      0,
                                      0,
                                      cursor); // Dummy 0
  cursor->setConditionCode(ARMConditionCodeEQ);
    ...
    if (cg->canClobberNodesRegister(firstChild)) {
      if (isFloat) {
        cursor = generateTrg1Src1Instruction(
          cg, ARMOp_fmrs, node, reg, trgFloatReg, cursor);
      } else {
        cursor = generateTrg2Src1Instruction(cg,
                                             ARMOp_fmrrd,
                                             node,
                                             reg->getLowOrder(),
                                             reg->getHighOrder(),
...
TR::Register*
OMR::ARM::TreeEvaluator::fmaxEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return generateFloatMaxMin(node, cg, true);
}

TR::Register*
OMR::ARM::TreeEvaluator::fminEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
