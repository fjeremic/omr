...
class OMR_EXTENSIBLE MemoryReference : public OMR::MemoryReference {
 ...
 public:
  ...
  MemoryReference(TR::Register *br, TR::Register *ir, uint8_t scale,
                  TR::CodeGenerator *cg);
  ...
  void setBaseModifiable() {
    _flag |= TR_ARMMemoryReferenceControl_Base_Modifiable;
  }
  ...
  void setIndexModifiable() {
    _flag |= TR_ARMMemoryReferenceControl_Index_Modifiable;
  }
  ...
  void setImmediatePreIndexed() {
    _flag |= TR_ARMMemoryReferenceControl_Immediate_Pre_Indexed;
  }
  void clearImmediatePreIndexed() {
    _flag &= ~TR_ARMMemoryReferenceControl_Immediate_Pre_Indexed;
  }
  ...
  void clearPostIndexed() {
    _flag &= ~TR_ARMMemoryReferenceControl_Post_Indexed;
  }
  ...
  MemoryReference(TR::MemoryReference &mr, int32_t n, uint32_t len,
                  TR::CodeGenerator *cg);
  ...
  uint8_t *encodeLargeARMConstant(uint32_t *wcursor, uint8_t *cursor,
