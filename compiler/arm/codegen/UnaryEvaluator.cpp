...
TR::Register*
OMR::ARM::TreeEvaluator::iconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return commonConstEvaluator(node, node->getInt(), cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::sconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return commonConstEvaluator(node, node->getShortInt(), cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::bconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return commonConstEvaluator(node, node->getByte(), cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::cconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  return commonConstEvaluator(node, node->getConst<uint16_t>(), cg);
}

TR::Register*
OMR::ARM::TreeEvaluator::commonConstEvaluator(TR::Node* node,
                                              int32_t value,
                                              TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::aconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::lconstEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (constantIsImmed8r(difference, &base, &rotate)) {
    ...
    generateTrg1Src1ImmInstruction(
      cg, ARMOp_add, node, highReg, lowReg, base, rotate);
  } else {
    armLoadConstant(node, lowValue, lowReg, cg);
...
TR::Register*
OMR::ARM::TreeEvaluator::inegEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg = cg->allocateRegister();
  ...
  generateTrg1Src1ImmInstruction(
    cg, ARMOp_rsb, node, trgReg, sourceRegister, 0, 0);
  firstChild->decReferenceCount();
  return node->setRegister(trgReg);
}

TR::Register*
OMR::ARM::TreeEvaluator::lnegEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* firstChild = node->getFirstChild();
  TR::Register* lowReg = cg->allocateRegister();
  TR::Register* highReg = cg->allocateRegister();
  ...
  TR::Register* sourceRegister = cg->evaluate(firstChild);
  generateTrg1Src1ImmInstruction(
    cg, ARMOp_rsb_r, node, lowReg, sourceRegister->getLowOrder(), 0, 0);
  generateTrg1Src1ImmInstruction(
    cg, ARMOp_rsc, node, highReg, sourceRegister->getHighOrder(), 0, 0);
  node->setRegister(trgReg);
  firstChild->decReferenceCount();
  return trgReg;
}
...
TR::Register*
OMR::ARM::TreeEvaluator::iabsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* trgReg = cg->allocateRegister();
  TR::Node* firstChild = node->getFirstChild();
...
TR::Register*
OMR::ARM::TreeEvaluator::labsEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Register* lowReg = cg->allocateRegister();
  TR::Register* highReg = cg->allocateRegister();
  ...
  generateTrg1Src1Instruction(cg,
                              ...
                              new (cg->trHeapMemory()) TR_ARMOperand2(
                                ARMOp2RegASRImmed, srcReg->getHighOrder(), 31));
  generateTrg1Src2Instruction(
    cg, ARMOp_eor, node, lowReg, srcReg->getLowOrder(), tmpReg);
  generateTrg1Src2Instruction(
    cg, ARMOp_eor, node, highReg, srcReg->getHighOrder(), tmpReg);
...
TR::Register*
OMR::ARM::TreeEvaluator::i2sEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
// also handles su2i
TR::Register*
OMR::ARM::TreeEvaluator::i2cEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::i2bEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::b2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::Register*
OMR::ARM::TreeEvaluator::b2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
...
TR::Register*
OMR::ARM::TreeEvaluator::c2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* sourceRegister = NULL;
  TR::Register* trgReg = cg->allocateRegisterPair(cg->gprClobberEvaluate(child),
...
TR::Register*
OMR::ARM::TreeEvaluator::l2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* trgReg;
  TR::Register* temp;
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    if (child->getReferenceCount() == 1 || !cg->useClobberEvaluate()) {
      ...
      generateTrg1Src1Instruction(
        cg, ARMOp_mov, node, trgReg, temp->getLowOrder());
      child->decReferenceCount();
    }
  }
  node->setRegister(trgReg);
...
TR::Register*
OMR::ARM::TreeEvaluator::iu2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* sourceRegister = NULL;
  TR::Register* trgReg = cg->allocateRegisterPair(cg->gprClobberEvaluate(child),
...
TR::Register*
OMR::ARM::TreeEvaluator::su2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* sourceRegister = NULL;
  TR::Register* trgReg = cg->allocateRegisterPair(cg->gprClobberEvaluate(child),
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    generateTrg1MemInstruction(
      cg, ARMOp_ldrh, node, trgReg->getLowOrder(), tempMR);
    tempMR->decNodeReferenceCounts();
  } else {
    generateTrg1Src1Instruction(cg,
                                ARMOp_mov,
                                ...
                                trgReg->getLowOrder(),
                                new (cg->trHeapMemory()) TR_ARMOperand2(
                                  ARMOp2RegLSLImmed, cg->evaluate(child), 16));
    generateTrg1Src1Instruction(
      cg,
      ARMOp_mov,
      node,
...
TR::Register*
OMR::ARM::TreeEvaluator::bu2iEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    child->decReferenceCount();
    generateTrg1Src1ImmInstruction(
      cg, ARMOp_and, node, trgReg, cg->evaluate(child), 0xff, 0);
  }
...
TR::Register*
OMR::ARM::TreeEvaluator::bu2lEvaluator(TR::Node* node, TR::CodeGenerator* cg)
{
  TR::Node* child = node->getFirstChild();
  TR::Register* sourceRegister = NULL;
  TR::Register* trgReg = cg->allocateRegisterPair(cg->gprClobberEvaluate(child),
  ...
  if (child->getReferenceCount() == 1 &&
    ...
    generateTrg1MemInstruction(
      cg, ARMOp_ldrb, node, trgReg->getLowOrder(), tempMR);
    tempMR->decNodeReferenceCounts();
  } else {
    generateTrg1Src1ImmInstruction(
      cg, ARMOp_and, node, trgReg->getLowOrder(), cg->evaluate(child), 0xff, 0);
  }
  generateTrg1ImmInstruction(cg, ARMOp_mov, node, trgReg->getHighOrder(), 0, 0);
