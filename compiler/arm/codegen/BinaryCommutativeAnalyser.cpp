...
void TR_ARMBinaryCommutativeAnalyser::genericAnalyser(
  TR::Node* root, TR_ARMOpCodes regToRegOpCode, TR_ARMOpCodes copyOpCode, bool nonClobberingDestination)
{
  TR::Node* firstChild;
  TR::Node* secondChild;
...
void TR_ARMBinaryCommutativeAnalyser::genericLongAnalyser(TR::Node* root, TR_ARMOpCodes lowRegToRegOpCode,
  TR_ARMOpCodes highRegToRegOpCode, TR_ARMOpCodes lowMemToRegOpCode, TR_ARMOpCodes highMemToRegOpCode,
...
void TR_ARMBinaryCommutativeAnalyser::integerAddAnalyser(TR::Node* root, TR_ARMOpCodes regToRegOpCode)
{
  TR::Node* firstChild;
  TR::Node* secondChild;
  if (cg()->whichChildToEvaluate(root) == 0) {
