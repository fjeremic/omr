...
void
TR_ARMBinaryCommutativeAnalyser::genericAnalyser(TR::Node* root,
...
void
TR_ARMBinaryCommutativeAnalyser::genericLongAnalyser(
  TR::Node* root,
...
void
TR_ARMBinaryCommutativeAnalyser::integerAddAnalyser(
  TR::Node* root,
  TR_ARMOpCodes regToRegOpCode)
{
  TR::Node* firstChild;
...
void
TR_ARMBinaryCommutativeAnalyser::longAddAnalyser(TR::Node* root)
{
  TR::Node* firstChild;
  TR::Node* secondChild;
  if (cg()->whichChildToEvaluate(root) == 0) {
