...
TR::TreeEvaluator::badILOpEvaluator,                // TR::BadILOp
    ...
    TR::TreeEvaluator::
        FloatingPointAndVectorBinaryArithmeticEvaluator, // TR::vadd
    TR::TreeEvaluator::
        FloatingPointAndVectorBinaryArithmeticEvaluator, // TR::vsub
    TR::TreeEvaluator::
        FloatingPointAndVectorBinaryArithmeticEvaluator, // TR::vmul
    TR::TreeEvaluator::
        FloatingPointAndVectorBinaryArithmeticEvaluator, // TR::vdiv
    TR::TreeEvaluator::unImpOpEvaluator,                 // TR::vrem
    TR::TreeEvaluator::
        FloatingPointAndVectorBinaryArithmeticEvaluator, // TR::vand
    TR::TreeEvaluator::
        FloatingPointAndVectorBinaryArithmeticEvaluator, // TR::vor
    TR::TreeEvaluator::
        FloatingPointAndVectorBinaryArithmeticEvaluator, // TR::vxor
    ...
    TR::TreeEvaluator::badILOpEvaluator,      // TR::newvalue (should be lowered
                                              // before evaluation)
    ...
    TR::TreeEvaluator::integerPairMulEvaluator, // TR::lmulh   // NOTE: These
                                                // use the mul (not mulh)
                                                // evaluators
    TR::TreeEvaluator::integerPairMulEvaluator, // TR::lumulh  // for historical
                                                // reasons
