...
TR::TreeEvaluator::badILOpEvaluator,              // TR::BadILOp
  ...
  TR::TreeEvaluator::badILOpEvaluator, // TR::newvalue (should be lowered before
                                       // evaluation)
  ...
  TR::TreeEvaluator::integerPairMulEvaluator, // TR::lmulh   // NOTE: These use
                                              // the mul (not mulh) evaluators
