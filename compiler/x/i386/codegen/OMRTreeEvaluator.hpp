...
public:
  ...
  static TR::Register *conditionalHelperEvaluator(TR::Node *node,
                                                  TR::CodeGenerator *cg);
  static TR::Register *integerPairReturnEvaluator(TR::Node *node,
                                                  TR::CodeGenerator *cg);
  static TR::Register *integerPairDualMulEvaluator(TR::Node *node,
                                                   TR::CodeGenerator *cg);
  static TR::Register *integerPairMulEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairAddEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairSubEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairDivEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairRemEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairNegEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairAbsEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairShlEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairRolEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairShrEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerPairUshrEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg);
  static TR::Register *integerPairByteswapEvaluator(TR::Node *node,
                                                    TR::CodeGenerator *cg);
  static TR::Register *integerPairMinMaxEvaluator(TR::Node *node,
                                                  TR::CodeGenerator *cg);
...
private:
  static TR::Register *performLload(TR::Node *node,
  ...
  static TR::Register *
  compareLongAndSetOrderedBoolean(TR::Node *node, TR_X86OpCodes highSetOpCode,
                                  TR_X86OpCodes lowSetOpCode,
                                  TR::CodeGenerator *cg);

  static void compareLongsForOrder(TR::Node *node,
