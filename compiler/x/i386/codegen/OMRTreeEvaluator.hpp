...
private:
  ...
  static TR::Register* longArithmeticCompareRegisterWithImmediate(TR::Node* node, TR::Register* cmpRegister,
    TR::Node* immedChild, TR_X86OpCodes firstBranchOpCode, TR_X86OpCodes secondBranchOpCode, TR::CodeGenerator* cg);
  ...
  static void compareLongsForOrder(TR::Node* node, TR_X86OpCodes highOrderBranchOp,
