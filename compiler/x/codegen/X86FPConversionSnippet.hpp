...
public:
  X86FPConversionSnippet(TR::CodeGenerator *codeGen, TR::Node *node,
                         TR::LabelSymbol *restartlab,
                         TR::LabelSymbol *snippetlab,
                         TR::SymbolReference *helperSymRef)
      : TR::X86RestartSnippet(codeGen, node, restartlab, snippetlab,
                              helperSymRef->canCauseGC()),
...
public:
  X86FPConvertToIntSnippet(TR::LabelSymbol *restartlab,
      ...
      : TR::X86FPConversionSnippet(codeGen, convertInstr->getNode(), restartlab,
                                   snippetlab, helperSymRef),
...
public:
  ...
  X86FPConvertToLongSnippet(TR::LabelSymbol *restartlab,
                            ...
                            TR::CodeGenerator *codeGen)
      : TR::X86FPConversionSnippet(codeGen, clobInstr->getNode(), restartlab,
                                   snippetlab, helperSymRef),
        _loadHighInstruction(loadHighInstr), _loadLowInstruction(loadLowInstr),
        _clobberInstruction(clobInstr), _lowRegister(0), _highRegister(0),
        _doubleRegister(0), _action(0) {}
