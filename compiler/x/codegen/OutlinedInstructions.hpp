...
public:
  ...
  // For calls
  //
  TR_OutlinedInstructions(TR::Node *callNode, TR::ILOpCodes callOp,
                          TR::Register *targetReg, TR::LabelSymbol *entryLabel,
                          TR::LabelSymbol *restartLabel, TR::CodeGenerator *cg);
...
public:
  ...
  void
  assignRegistersOnOutlinedPath(TR_RegisterKinds kindsToBeAssigned,
                                TR::X86VFPSaveInstruction *vfpSaveInstruction);

  OMR::RegisterUsage *
  findInRegisterUsageList(TR::list<OMR::RegisterUsage *> *rul,
                          TR::Register *virtReg);
...
/**
   ...
   @brief This class is used to switch to outlined code generation in the manner
   of the RAII idiom.

   The main use of this class is to generate instruction in the outlined code
   region, for example, cold paths codes.
*/
class TR_OutlinedInstructionsGenerator {
public:
  /**
  ...
  */
  TR_OutlinedInstructionsGenerator(TR::LabelSymbol *entryLabel, TR::Node *node,
                                   TR::CodeGenerator *cg);
  /**
