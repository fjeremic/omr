...
public:
  TR::LabelSymbol* getEntryLabel()
  {
    return _entryLabel;
  }
  void setEntryLabel(TR::LabelSymbol* sym)
  {
    _entryLabel = sym;
  }

  TR::LabelSymbol* getRestartLabel()
  {
    return _restartLabel;
  }
  void setRestartLabel(TR::LabelSymbol* sym)
  {
    _restartLabel = sym;
  }
  ...
  void setFirstInstruction(TR::Instruction* ins)
  {
    _firstInstruction = ins;
  }
  ...
  void setAppendInstruction(TR::Instruction* ins)
  {
    _appendInstruction = ins;
  }

  void setPostDependencyMergeList(TR::RegisterDependencyConditions* deps)
  {
    _postDependencyMergeList = deps;
  }
  TR::RegisterDependencyConditions* getPostDependencyMergeList()
  {
    return _postDependencyMergeList;
  }
  ...
  void setBlock(TR::Block* b)
  {
    _block = b;
  }

  TR::list<OMR::RegisterUsage*>* getOutlinedPathRegisterUsageList()
  {
    return _outlinedPathRegisterUsageList;
  }
  void setOutlinedPathRegisterUsageList(TR::list<OMR::RegisterUsage*>* rul)
  {
    _outlinedPathRegisterUsageList = rul;
  }

  TR::list<OMR::RegisterUsage*>* getMainlinePathRegisterUsageList()
  {
    return _mainlinePathRegisterUsageList;
  }
  void setMainlinePathRegisterUsageList(TR::list<OMR::RegisterUsage*>* rul)
  {
    _mainlinePathRegisterUsageList = rul;
  }

  TR_RegisterAssignerState* getRegisterAssignerStateAtMerge()
  {
    return _registerAssignerStateAtMerge;
  }
  void setRegisterAssignerStateAtMerge(TR_RegisterAssignerState* ras)
  {
    _registerAssignerStateAtMerge = ras;
  }

  bool hasBeenRegisterAssigned()
  {
    return _hasBeenRegisterAssigned;
  }
  void setHasBeenRegisterAssigned(bool r)
  {
    _hasBeenRegisterAssigned = r;
  }
...
public:
  ...
  */
  inline TR_OutlinedInstructions* obtain()
  {
    return _oi;
  }
  inline TR_OutlinedInstructions* operator->()
  {
    return obtain();
  }
