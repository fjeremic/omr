...
public:
    ...
    void apply32BitLoadLabelRelativeRelocation(TR::Instruction* movInstruction, TR::LabelSymbol* startLabel,
...
public:
    ...
    bool useSSEForSinglePrecision() { return _flags.testAny(UseSSEForSinglePrecision); }
    void setUseSSEForSinglePrecision() { _flags.set(UseSSEForSinglePrecision); }

    bool useSSEForDoublePrecision() { return _flags.testAny(UseSSEForDoublePrecision); }
    ...
    bool targetSupportsSoftwarePrefetches() { return _flags.testAny(TargetSupportsSoftwarePrefetches); }
