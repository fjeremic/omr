...
public:
  ...
  bool enabledXSAVE()
  {
    return testFeatureFlags2(TR_OSXSAVE);
  }
  bool hasBuiltInFPU()
  {
    return testFeatureFlags(TR_BuiltInFPU);
  }
  ...
  bool hasAPICHardware()
  {
    return testFeatureFlags(TR_APICHardware);
  }
  bool hasMemoryTypeRangeRegisters()
  {
    return testFeatureFlags(TR_MemoryTypeRangeRegisters);
  }
  bool supportsPageGlobalFlag()
  {
    return testFeatureFlags(TR_PageGlobalFlag);
  }
  ...
  bool hasACPIRegisters()
  {
    return testFeatureFlags(TR_ACPIRegisters);
  }
  ...
  bool supportsSSE()
  {
    return testFeatureFlags(TR_SSE);
  }
  bool supportsSSE2()
  {
    return testFeatureFlags(TR_SSE2);
  }
  bool supportsSSE3()
  {
    return testFeatureFlags2(TR_SSE3);
  }
  bool supportsSSSE3()
  {
    return testFeatureFlags2(TR_SSSE3);
  }
  bool supportsSSE4_1()
  {
    return testFeatureFlags2(TR_SSE4_1);
  }
  bool supportsSSE4_2()
  {
    return testFeatureFlags2(TR_SSE4_2);
  }
  bool supportsAVX()
  {
    return testFeatureFlags2(TR_AVX) && enabledXSAVE();
  }
  bool supportsAVX2()
  {
    return testFeatureFlags8(TR_AVX2) && enabledXSAVE();
  }
  bool supportsBMI1()
  {
    return testFeatureFlags8(TR_BMI1) && enabledXSAVE();
  }
  bool supportsBMI2()
  {
    return testFeatureFlags8(TR_BMI2) && enabledXSAVE();
  }
  bool supportsFMA()
  {
    return testFeatureFlags2(TR_FMA) && enabledXSAVE();
  }
  bool supportsCLMUL()
  {
    return testFeatureFlags2(TR_CLMUL);
  }
  bool supportsAESNI()
  {
    return testFeatureFlags2(TR_AESNI);
  }
  bool supportsPOPCNT()
  {
    return testFeatureFlags2(TR_POPCNT);
  }
  bool supportsSelfSnoop()
  {
    return testFeatureFlags(TR_SelfSnoop);
  }
  bool supportsTM()
  {
    return testFeatureFlags8(TR_RTM);
  }
  bool supportsHyperThreading()
  {
    return testFeatureFlags(TR_HyperThreading);
  }
  bool supportsHLE()
  {
    return testFeatureFlags8(TR_HLE);
  }
  bool hasThermalMonitor()
  {
    return testFeatureFlags(TR_ThermalMonitor);
  }
  ...
  {
    return (
      isIntelPentium() || isIntelP6() || isIntelPentium4() || isIntelCore2() || isIntelTulsa() || isIntelNehalem());
  }
  ...
  bool isGenuineIntel()
  {
    return _vendorFlags.testAny(TR_GenuineIntel);
  }
  bool isAuthenticAMD()
  {
    return _vendorFlags.testAny(TR_AuthenticAMD);
  }
  ...
  int32_t getX86Architecture()
  {
    return (_processorDescription & 0x000000ff);
  }
...
public:
  ...
  TR::RealRegister* getFrameRegister()
  {
    return _frameRegister;
  }
  ...
  {
    return _dataSnippetList.empty() ? false : true;
  }
  ...
  int32_t getPicSlotCount()
  {
    return _PicSlotCount;
  }
  void setPicSlotCount(int32_t c)
  {
    _PicSlotCount = c;
  }
  int32_t incPicSlotCountBy(int32_t i)
  {
    return (_PicSlotCount += i);
  }
  ...
  void apply32BitLoadLabelRelativeRelocation(
    TR::Instruction* movInstruction, TR::LabelSymbol* startLabel, TR::LabelSymbol* endLabel, int32_t deltaToStartLabel);
  ...
  //
  virtual uint8_t* generatePadding(uint8_t* cursor, intptrj_t length, TR::Instruction* neighborhood = NULL,
   ...
   */
  template <typename T>
  inline TR::X86ConstantDataSnippet* findOrCreateConstantDataSnippet(TR::Node* node, T data)
  {
  ...
  void setVFPState(const TR_VFPState& newState)
  {
    _vfpState = newState;
  }
...
private:
  ...
  enum TR_X86CodeGeneratorFlags {
    ...
    = 0x00004000, ///< target processor and OS both support software prefetch instructions
...
public:
  ...
  void setEnableRematerialisation()
  {
    _flags.set(EnableRematerialisation);
  }
  void resetEnableRematerialisation()
  {
    _flags.reset(EnableRematerialisation);
  }
  ...
  void setEnableRegisterWeights()
  {
    _flags.set(EnableRegisterWeights);
  }
  ...
  void setUseSSEForSinglePrecision()
  {
    _flags.set(UseSSEForSinglePrecision);
  }
  ...
  void setUseSSEForDoublePrecision()
  {
    _flags.set(UseSSEForDoublePrecision);
  }
  ...
  void setEnableTLHPrefetching()
  {
    _flags.set(EnableTLHPrefetching);
  }
  ...
  void setGenerateMasmListingSyntax()
  {
    _flags.set(GenerateMasmListingSyntax);
  }
  ...
  virtual bool supportsDirectJNICallsForAOT()
  {
    return true;
  }
  ...
  void setEnableImplicitDivideCheck()
  {
    _flags.set(EnableImplicitDivideCheck);
  }

  bool mapAutosTo8ByteSlots()
  {
    return _flags.testAny(MapAutosTo8ByteSlots);
  }
  void setMapAutosTo8ByteSlots()
  {
    _flags.set(MapAutosTo8ByteSlots);
  }
  ...
  TR_X86OpCodes getXMMDoubleLoadOpCode()
  {
    return _xmmDoubleLoadOpCode;
  }
  void setXMMDoubleLoadOpCode(TR_X86OpCodes o)
  {
    _xmmDoubleLoadOpCode = o;
  }
  ...
  void setPushPreservedRegisters()
  {
    _flags.set(PushPreservedRegisters);
  }
