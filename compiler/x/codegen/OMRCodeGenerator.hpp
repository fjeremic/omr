...
private:
  ...
  enum TR_X86CodeGeneratorFlags
  {
    ...
    EnableSinglePrecisionMethods =
      0x00000008, ///< support changing FPCW to single precision for individual
                  ///< methods
    ...
    MapAutosTo8ByteSlots =
      0x00000400, ///< don't round up sizes of autos to an 8-byte slot size when
                  ///< the stack is mapped
    ...
    PushPreservedRegisters =
      0x00020000 ///< we've chosen to save/restore preserved regs using push/pop
