...
void OMR::X86::TreeEvaluator::insertPrecisionAdjustment(TR::Register *reg,
  ...
  if ((node->getOpCode().isDouble() && (node->getOpCodeValue() != TR::f2d)) ||
    ...
    diagnostic("insertPrecisionAdjustment() ==> invalid node type for "
...
TR::Register *
OMR::X86::TreeEvaluator::floatingPointStoreEvaluator(TR::Node *node,
                                                     TR::CodeGenerator *cg) {
...
TR::Register *
OMR::X86::TreeEvaluator::fpReturnEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::X86::TreeEvaluator::fpUnaryMaskEvaluator(TR::Node *node,
                                              TR::CodeGenerator *cg) {
  ...
  if (value->getKind() != TR_FPR) // Legacy supported for X87, to be deleted
  {
    ...
    if (result != value) {
      generateFPST0STiRegRegInstruction(value->isSinglePrecision() ? FLDRegReg
                                                                   : DLDRegReg,
...
TR::Register *OMR::X86::TreeEvaluator::fpSqrtEvaluator(TR::Node *node,
  ...
  if (value->getKind() != TR_FPR) // Legacy supported for X87, to be deleted
  {
    ...
    generateRegRegInstruction(value->isSinglePrecision() ? SQRTSSRegReg
                                                         : SQRTSDRegReg,
                              node, result, value, cg);
  }
...
TR::Register *OMR::X86::TreeEvaluator::fpRemEvaluator(TR::Node *node,
  ...
  if (cg->useSSEForDoublePrecision()) // Note: both float and double helpers use
                                      // SSE2
  {
...
TR::Register *OMR::X86::TreeEvaluator::fpConvertToLong(
  ...
  if (child->getOpCode().isDouble() && cg->useSSEForDoublePrecision()) {
    ...
    TR_OutlinedInstructions *outlinedHelperCall = new (cg->trHeapMemory())
        TR_OutlinedInstructions(node, TR::lcall, targetRegister, CallLabel,
                                reStartLabel, cg);
...
TR::Register *
OMR::X86::TreeEvaluator::fRegLoadEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Compilation *comp = cg->comp();
...
TR::Register *
OMR::X86::TreeEvaluator::dRegLoadEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Compilation *comp = cg->comp();
  TR::Register *globalReg = node->getRegister();
  if (globalReg == NULL) {
...
TR::Register *
OMR::X86::TreeEvaluator::fRegStoreEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::Node *child = node->getFirstChild();
...
TR::Register *
OMR::X86::TreeEvaluator::dRegStoreEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::Node *child = node->getFirstChild();
  int32_t globalRegNum = node->getGlobalRegisterNumber();
  TR::Machine *machine = cg->machine();
...
TR::Register *
OMR::X86::TreeEvaluator::compareFloatAndBranchEvaluator(TR::Node *node,
                                                        TR::CodeGenerator *cg) {
...
TR::Register *
OMR::X86::TreeEvaluator::compareFloatAndSetEvaluator(TR::Node *node,
                                                     TR::CodeGenerator *cg) {
  bool useFCOMIInstructions =
      TR::TreeEvaluator::canUseFCOMIInstructions(node, cg);
  TR::Register *accRegister = TR::TreeEvaluator::compareFloatOrDoubleForOrder(
...
TR::Register *
OMR::X86::TreeEvaluator::compareDoubleAndSetEvaluator(TR::Node *node,
                                                      TR::CodeGenerator *cg) {
  bool useFCOMIInstructions =
      TR::TreeEvaluator::canUseFCOMIInstructions(node, cg);
  TR::Register *accRegister = TR::TreeEvaluator::compareFloatOrDoubleForOrder(
...
TR::Register *
OMR::X86::TreeEvaluator::compareFloatEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  bool useFCOMIInstructions =
      TR::TreeEvaluator::canUseFCOMIInstructions(node, cg);
  TR::Register *accRegister = TR::TreeEvaluator::compareFloatOrDoubleForOrder(
...
TR::Register *
OMR::X86::TreeEvaluator::compareDoubleEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg) {
  bool useFCOMIInstructions =
      TR::TreeEvaluator::canUseFCOMIInstructions(node, cg);
  TR::Register *accRegister = TR::TreeEvaluator::compareFloatOrDoubleForOrder(
