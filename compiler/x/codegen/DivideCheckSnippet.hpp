...
public:
  X86DivideCheckSnippet(TR::LabelSymbol *restartLabel,
                        ...
                        TR::LabelSymbol *divideLabel, TR::ILOpCode &divOp,
                        TR::DataType type,
                        TR::X86RegRegInstruction *divideInstruction,
                        TR::CodeGenerator *cg)
      : TR::X86RestartSnippet(cg, divideInstruction->getNode(), restartLabel,
                              snippetLabel, true),
        _divOp(divOp), _type(type), _divideLabel(divideLabel),
