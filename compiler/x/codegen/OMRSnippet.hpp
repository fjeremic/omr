...
inline const char* commentString()
{
  return TR::Compiler->target.isLinux() ? "#" : ";";
}
inline const char* hexPrefixString()
{
  return TR::Compiler->target.isLinux() ? "0x" : "0";
}
inline const char* hexSuffixString()
{
  return TR::Compiler->target.isLinux() ? "" : "h";
}
inline const char* dbString()
{
  return TR::Compiler->target.isLinux() ? ".byte" : "db";
}
inline const char* dwString()
{
  return TR::Compiler->target.isLinux() ? ".short" : "dw";
}
inline const char* ddString()
{
  return TR::Compiler->target.isLinux() ? ".int" : "dd";
}
inline const char* dqString()
{
  return TR::Compiler->target.isLinux() ? ".quad" : "dq";
}
