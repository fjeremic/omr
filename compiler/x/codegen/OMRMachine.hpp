...
class TR_RegisterAssignerState {
 ...
 public:
  ...
  void capture();
  void install();
  TR::RegisterDependencyConditions *createDependenciesFromRegisterState(
...
class OMR_EXTENSIBLE Machine : public OMR::Machine {
 ...
 public:
  ...
  TR::RealRegister *findBestFreeGPRegister(
  ...
  TR::RealRegister *reverseGPRSpillState(
  ...
  void coerceGPRegisterAssignment(
