...
public:
  ...
  TR::Register** getRegisterAssociations()
  {
    return _registerAssociations;
  }
  ...
  TR::RealRegister* freeBestGPRegister(TR::Instruction* currentInstruction, TR::Register* virtReg,
    TR_RegisterSizes requestedRegSize = TR_WordReg, TR::RealRegister::RegNum targetRegister = TR::RealRegister::NoReg,
  ...
  void coerceGPRegisterAssignment(
    TR::Instruction* currentInstruction, TR::Register* virtualRegister, TR_RegisterSizes requestedRegSize = TR_WordReg);
  ...
  int32_t getFPTopOfStack()
  {
    return _fpTopOfStack;
  }
  TR_X86FPStackRegister* getFPTopOfStackPtr()
  {
    return (_fpTopOfStack > TR_X86FPStackRegister::fpStackEmpty && _fpTopOfStack < TR_X86FPStackRegister::fpStackFull)
  ...
  bool isFPStackFull()
  {
    return (_fpTopOfStack + 1 == TR_X86FPStackRegister::fpStackFull) ? true : false;
  }
  bool isFPRTopOfStack(TR::Register* virtReg);

  uint8_t fpGetNumberOfLiveFPRs()
  {
    return _fpTopOfStack + 1;
  }
  uint8_t fpGetNumberOfLiveXMMRs()
  {
    return 0;
  }
  ...
  int32_t* getFPStackShape()
  {
    return _fpStackShape;
  }
