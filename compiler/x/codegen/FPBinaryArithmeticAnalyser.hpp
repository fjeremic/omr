...
public:
    ...
    TR_X86OpCodes getRegRegOp() { return getOpsReversed() ? _opCodePackage[_package][kOpReg2Reg1] : _opCodePackage[_package][kOpReg1Reg2]; }

    TR_X86OpCodes getRegMemOp() { return getOpsReversed() ? _opCodePackage[_package][kOpReg2Mem1] : _opCodePackage[_package][kOpReg1Mem2]; }

    TR_X86OpCodes getRegConvSOp() { return getOpsReversed() ? _opCodePackage[_package][kOpReg2ConvS1] : _opCodePackage[_package][kOpReg1ConvS2]; }

    TR_X86OpCodes getRegConvIOp() { return getOpsReversed() ? _opCodePackage[_package][kOpReg2ConvI1] : _opCodePackage[_package][kOpReg1ConvI2]; }
