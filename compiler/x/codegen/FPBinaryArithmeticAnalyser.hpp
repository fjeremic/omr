...
public:
  ...
  uint8_t getOpsReversed()
  {
    return (_actionMap[_inputs] & kReverse) ? 1 : 0;
  }
  ...
  bool isOpRegReg()
  {
    return (_actionMap[_inputs] & kReg1Reg2) ? true : false;
  }
  bool isOpRegMem()
  {
    return (_actionMap[_inputs] & kReg1Mem2) ? true : false;
  }
  bool isOpRegConv()
  {
