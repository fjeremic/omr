...
uint8_t*
TR::X86DataSnippet::emitSnippetBody()
{
...
void
TR::X86DataSnippet::printValue(TR::FILE* pOutFile, TR_Debug* debug)
{
  if (pOutFile == NULL)
    return;
...
void
TR::X86DataSnippet::print(TR::FILE* pOutFile, TR_Debug* debug)
{
  if (pOutFile == NULL)
    return;
  ...
  debug->printSnippetLabel(
    pOutFile, getSnippetLabel(), bufferPos, debug->getName(this));
