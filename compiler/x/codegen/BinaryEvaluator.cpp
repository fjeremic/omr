...
extern TR::Register* intOrLongClobberEvaluate(TR::Node* node,
                                              bool nodeIs64Bit,
                                              TR::CodeGenerator* cg);
...
//
static void forceSize(TR::Node* node,
                      TR::Register* reg,
                      bool is64Bit,
                      TR::CodeGenerator* cg) {
...
inline TR::Register* evaluateAndForceSize(TR::Node* node,
                                          bool is64Bit,
                                          TR::CodeGenerator* cg) {
...
TR::X86RegInstruction* OMR::X86::TreeEvaluator::generateRegisterShift(
    TR::Node* node,
    TR_X86OpCodes immShiftOpCode,
    TR_X86OpCodes regShiftOpCode,
    TR::CodeGenerator* cg) {
  bool nodeIs64Bit = TR::TreeEvaluator::getNodeIs64Bit(node, cg);
  TR::Register* targetRegister = NULL;
  TR::Node* firstChild = node->getFirstChild();
