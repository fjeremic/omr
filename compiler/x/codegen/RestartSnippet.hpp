...
public:
  X86RestartSnippet(
    TR::CodeGenerator* cg, TR::Node* n, TR::LabelSymbol* restartlab, TR::LabelSymbol* snippetlab, bool isGCSafePoint)
  ...
  void setForceLongRestartJump()
  {
    _forceLongRestartJump = true;
  }
  bool getForceLongRestartJump()
  {
    return _forceLongRestartJump;
  }
  ...
  uint32_t estimateRestartJumpLength(TR_X86OpCodes branchOp, int32_t estimatedSnippetLocation, TR::LabelSymbol* label)
  {
