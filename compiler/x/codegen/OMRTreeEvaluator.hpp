...
public:
  ...
  static TR::Instruction* insertLoadConstant(TR::Node* node, TR::Register* target, intptrj_t value,
  ...
  static uint8_t shiftMask(bool is64Bit)
  {
    return is64Bit ? 0x3f : 0x1f;
  }
  ...
  static uint8_t rotateMask(bool is64Bit)
  {
    return is64Bit ? 0x3f : 0x1f;
  }
  ...
  static TR::Register* loadConstant(TR::Node* node, intptrj_t value, TR_RematerializableTypes t, TR::CodeGenerator* cg,
...
protected:
  ...
  static TR::Register* conversionAnalyser(
  ...
  static TR::Register* generateBranchOrSetOnFPCompare(
  ...
  static TR::Register* compareFloatOrDoubleForOrder(
    TR::Node*, TR_X86OpCodes, TR_X86OpCodes, TR_X86OpCodes, TR_X86OpCodes, TR_X86OpCodes, bool, TR::CodeGenerator*);
  ...
  static TR::Register* generateLEAForLoadAddr(TR::Node* node, TR::MemoryReference* memRef, TR::SymbolReference* symRef,
