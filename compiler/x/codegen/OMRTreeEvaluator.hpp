...
class OMR_EXTENSIBLE TreeEvaluator : public OMR::TreeEvaluator {
 public:
  ...
  static TR::Register *compareFloatAndBranchEvaluator(TR::Node *node,
                                                      TR::CodeGenerator *cg);
  static TR::Register *compareDoubleAndBranchEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg);
  static TR::Register *compareFloatAndSetEvaluator(TR::Node *node,
                                                   TR::CodeGenerator *cg);
  static TR::Register *compareDoubleAndSetEvaluator(TR::Node *node,
                                                    TR::CodeGenerator *cg);
  ...
  static TR::Register *compareFloatEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *compareDoubleEvaluator(TR::Node *node,
                                              TR::CodeGenerator *cg);
  ...
  static TR::Register *integerRegLoadEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  ...
  static TR::Register *arraycopyEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *overflowCHKEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *ibyteswapEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *zccAddSubEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *sbyteswapEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  typedef TR::Register *(*EvaluatorComputesCarry)(TR::Node *node,
                                                  TR::CodeGenerator *codeGen,
                                                  bool computesCarry);
  // routines for integers (or addresses) that can fit in one register
  // (see also the integerPair*Evaluator functions)
  static TR::Register *integerStoreEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *integerReturnEvaluator(TR::Node *node,
                                              TR::CodeGenerator *cg);
  static TR::Register *integerMulEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *integerMulhEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *integerDualMulEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerAddEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *integerSubEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *integerDualAddOrSubEvaluator(TR::Node *node,
                                                    TR::CodeGenerator *cg);
  static TR::Register *integerDivOrRemEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg);
  static TR::Register *integerNegEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *integerAbsEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *integerShrEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *integerShlEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *integerRolEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *integerUshrEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *integerCmpeqEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *integerCmpneEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *integerCmpltEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *integerCmpgeEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *integerCmpgtEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *integerCmpleEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *unsignedIntegerCmpltEvaluator(TR::Node *node,
                                                     TR::CodeGenerator *cg);
  static TR::Register *unsignedIntegerCmpgeEvaluator(TR::Node *node,
                                                     TR::CodeGenerator *cg);
  static TR::Register *unsignedIntegerCmpgtEvaluator(TR::Node *node,
                                                     TR::CodeGenerator *cg);
  static TR::Register *unsignedIntegerCmpleEvaluator(TR::Node *node,
                                                     TR::CodeGenerator *cg);
  static TR::Register *integerIfCmpeqEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerIfCmpneEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerIfCmpltEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerIfCmpgeEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerIfCmpgtEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *integerIfCmpleEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  static TR::Register *unsignedIntegerIfCmpltEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg);
  static TR::Register *unsignedIntegerIfCmpgeEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg);
  static TR::Register *unsignedIntegerIfCmpgtEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg);
  static TR::Register *unsignedIntegerIfCmpleEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg);
  ...
  static TR::Register *fpUnaryMaskEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  ...
  static TR::Register *floatingPointStoreEvaluator(TR::Node *node,
                                                   TR::CodeGenerator *cg);

  // For ILOpCode that can be translated to single SSE/AVX instructions
  static TR::Register *FloatingPointAndVectorBinaryArithmeticEvaluator(
      TR::Node *node, TR::CodeGenerator *cg);

  // SIMD evaluators
  static TR::Register *SIMDRegLoadEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *SIMDRegStoreEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *SIMDloadEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *SIMDstoreEvaluator(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static TR::Register *SIMDsplatsEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *SIMDgetvelemEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);

  static TR::Register *icmpsetEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *bztestnsetEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);

  // VM dependent routines
  static TR::Register *VMmergenewEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static bool VMinlineCallEvaluator(TR::Node *node, bool isIndirect,
                                    TR::CodeGenerator *cg);
  static TR::Instruction *VMtestForReferenceArray(TR::Node *,
                                                  TR::Register *objectReg,
                                                  TR::CodeGenerator *cg);
  static bool genNullTestSequence(TR::Node *node, TR::Register *opReg,
                                  TR::Register *targetReg,
                                  TR::CodeGenerator *cg);
  static TR::Instruction *insertLoadConstant(
  ...
  static TR::Instruction *insertLoadMemory(
      TR::Node *node, TR::Register *target, TR::MemoryReference *sourceMR,
      TR_RematerializableTypes type, TR::CodeGenerator *cg,
      TR::Instruction *currentInstruction = NULL);

  static void padUnresolvedDataReferences(TR::Node *node,
                                          TR::SymbolReference &symRef,
                                          TR::CodeGenerator *cg);

  static void insertPrecisionAdjustment(TR::Register *reg, TR::Node *node,
                                        TR::CodeGenerator *cg);

  static TR::Register *coerceFPRToXMMR(TR::Node *node, TR::Register *fpRegister,
                                       TR::CodeGenerator *cg);
  static TR::Register *coerceXMMRToFPR(TR::Node *node, TR::Register *fpRegister,
                                       TR::CodeGenerator *cg);
  ...
  // zEmulator int and long rotates are also always masked by 0x3f but it is
  // correct to mask int rotates by 0x1f as the part of the rotate above 31 is a
  // nop essentially and should be masked off
  ...
  static TR::Block *getOverflowCatchBlock(TR::Node *node,
                                          TR::CodeGenerator *cg);

  static void genArithmeticInstructionsForOverflowCHK(TR::Node *node,
                                                      TR::CodeGenerator *cg);

  static TR::Register *performCall(TR::Node *node, bool isIndirect,
                                   bool spillFPRegs, TR::CodeGenerator *cg);

  static TR::Register *loadConstant(TR::Node *node, intptrj_t value,
                                    TR_RematerializableTypes t,
                                    TR::CodeGenerator *cg,
                                    TR::Register *targetRegister = NULL);

 protected:
  static TR::Register *performHelperCall(TR::Node *node,
                                         TR::SymbolReference *helperSymRef,
                                         TR::ILOpCodes helperCallOpCode,
                                         bool spillFPRegs,
                                         TR::CodeGenerator *cg);
  static TR::Register *performIload(TR::Node *node,
                                    TR::MemoryReference *sourceMR,
                                    TR::CodeGenerator *cg);
  static TR::Register *performFload(TR::Node *node,
                                    TR::MemoryReference *sourceMR,
                                    TR::CodeGenerator *cg);
  static TR::Register *performDload(TR::Node *node,
                                    TR::MemoryReference *sourceMR,
                                    TR::CodeGenerator *cg);
  static TR::Register *negEvaluatorHelper(TR::Node *node,
                                          TR_X86OpCodes RegInstr,
                                          TR::CodeGenerator *cg);
  static TR::Register *logicalEvaluator(TR::Node *node, TR_X86OpCodes package[],
                                        TR::CodeGenerator *cg);
  static TR::Register *fpBinaryArithmeticEvaluator(TR::Node *node, bool isFloat,
                                                   TR::CodeGenerator *cg);
  static TR::Register *bcmpEvaluator(TR::Node *node, TR_X86OpCodes setOp,
                                     TR::CodeGenerator *cg);
  static TR::Register *cmp2BytesEvaluator(TR::Node *node, TR_X86OpCodes setOp,
                                          TR::CodeGenerator *cg);

  static TR::Register *loadMemory(TR::Node *node, TR::MemoryReference *sourceMR,
  ...
  static TR::Register *conversionAnalyser(TR::Node *node,
                                          ...
                                          TR::CodeGenerator *cg);
  static TR::Register *fpConvertToInt(TR::Node *node,
                                      TR::SymbolReference *helperSymRef,
                                      TR::CodeGenerator *cg);
  static TR::Register *fpConvertToLong(TR::Node *node,
                                       TR::SymbolReference *helperSymRef,
                                       TR::CodeGenerator *cg);
  static TR::Register *generateBranchOrSetOnFPCompare(TR::Node *node,
                                                      TR::Register *accRegister,
                                                      bool generateBranch,
                                                      TR::CodeGenerator *cg);
  static TR::Register *generateFPCompareResult(TR::Node *node,
                                               TR::Register *accRegister,
                                               TR::CodeGenerator *cg);
  static bool canUseFCOMIInstructions(TR::Node *node, TR::CodeGenerator *cg);
  static TR::Register *compareFloatOrDoubleForOrder(
      TR::Node *, TR_X86OpCodes, TR_X86OpCodes, TR_X86OpCodes, TR_X86OpCodes,
      TR_X86OpCodes, bool, TR::CodeGenerator *);
  ...
  static TR::Register *signedIntegerDivOrRemAnalyser(TR::Node *node,
                                                     TR::CodeGenerator *cg);
  static TR::Register *dstoreEvaluatorHelper(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::X86MemInstruction *generateMemoryShift(
      TR::Node *node, TR_X86OpCodes immShiftOpCode,
      TR_X86OpCodes regShiftOpCode, TR::CodeGenerator *cg);
  static TR::X86RegInstruction *generateRegisterShift(
      TR::Node *node, TR_X86OpCodes immShiftOpCode,
      TR_X86OpCodes regShiftOpCode, TR::CodeGenerator *cg);
  static TR::Instruction *compareGPMemoryToImmediate(TR::Node *node,
                                                     TR::MemoryReference *mr,
                                                     int32_t value,
                                                     TR::CodeGenerator *cg);
  static void compareGPRegisterToImmediate(TR::Node *node,
                                           TR::Register *cmpRegister,
                                           int32_t value,
                                           TR::CodeGenerator *cg);
  static void compareGPRegisterToImmediateForEquality(TR::Node *node,
                                                      TR::Register *cmpRegister,
                                                      int32_t value,
                                                      TR::CodeGenerator *cg);
  static void compareGPRegisterToConstantForEquality(TR::Node *node,
                                                     int32_t value,
                                                     TR::Register *cmpRegister,
                                                     TR::CodeGenerator *cg);
  ...
  static void compareIntegersForOrder(TR::Node *node, TR::Node *firstChild,
                                      TR::Node *secondChild,
                                      TR::CodeGenerator *cg);
  ...
  static TR::Register *integerEqualityHelper(TR::Node *node,
                                             TR_X86OpCodes setOp,
                                             TR::CodeGenerator *cg);
  static TR::Register *integerOrderHelper(TR::Node *node, TR_X86OpCodes setOp,
                                          TR::CodeGenerator *cg);
  static TR::Register *evaluateNULLCHKWithPossibleResolve(
      TR::Node *node, bool needResolution, TR::CodeGenerator *cg);
  static TR::Register *commonFPRemEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg,
                                            bool isDouble);
  static TR::Register *generateLEAForLoadAddr(TR::Node *node,
                                              TR::MemoryReference *memRef,
                                              TR::SymbolReference *symRef,
                                              TR::CodeGenerator *cg,
                                              bool isInternalPointer);

  static bool constNodeValueIs32BitSigned(TR::Node *node, intptrj_t *value,
                                          TR::CodeGenerator *cg);

  static TR::Register *intOrLongClobberEvaluate(TR::Node *node,
                                                bool nodeIs64Bit,
                                                TR::CodeGenerator *cg);
  ...
  static TR_X86OpCodes _logicalOpPackage[numLogicalOpPackages]
                                        [numLogicalOpForms];

  static bool generateIAddOrSubForOverflowCheck(TR::Node *compareNode,
                                                TR::CodeGenerator *cg);
  static bool generateLAddOrSubForOverflowCheck(TR::Node *compareNode,
                                                TR::CodeGenerator *cg);

  static TR::Register *SSE2ArraycmpEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  static TR::Register *SSE2ArraycmpLenEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg);

  static bool stopUsingCopyRegAddr(TR::Node *node, TR::Register *&reg,
                                   TR::CodeGenerator *cg);
  static bool stopUsingCopyRegInteger(TR::Node *node, TR::Register *&reg,
                                      TR::CodeGenerator *cg);
};
