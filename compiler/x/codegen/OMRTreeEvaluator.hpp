...
public:
  ...
  static TR::Register* VMmergenewEvaluator(TR::Node* node,
                                           TR::CodeGenerator* cg);
  static bool VMinlineCallEvaluator(TR::Node* node,
                                    bool isIndirect,
                                    TR::CodeGenerator* cg);
  static TR::Instruction* VMtestForReferenceArray(TR::Node*,
                                                  TR::Register* objectReg,
                                                  TR::CodeGenerator* cg);
  static bool genNullTestSequence(TR::Node* node,
                                  TR::Register* opReg,
  ...
  static void insertPrecisionAdjustment(TR::Register* reg,
                                        TR::Node* node,
                                        TR::CodeGenerator* cg);

  static TR::Register* coerceFPRToXMMR(TR::Node* node,
                                       TR::Register* fpRegister,
                                       TR::CodeGenerator* cg);
  static TR::Register* coerceXMMRToFPR(TR::Node* node,
                                       TR::Register* fpRegister,
                                       TR::CodeGenerator* cg);
  ...
  static TR::Register* loadConstant(TR::Node* node,
                                    intptrj_t value,
...
protected:
  ...
  static TR::Register* negEvaluatorHelper(TR::Node* node,
                                          ...
                                          TR::CodeGenerator* cg);
  static TR::Register* logicalEvaluator(TR::Node* node,
                                        TR_X86OpCodes package[],
                                        TR::CodeGenerator* cg);
  static TR::Register* fpBinaryArithmeticEvaluator(TR::Node* node,
                                                   bool isFloat,
                                                   TR::CodeGenerator* cg);
  static TR::Register* bcmpEvaluator(TR::Node* node,
                                     TR_X86OpCodes setOp,
                                     TR::CodeGenerator* cg);
  static TR::Register* cmp2BytesEvaluator(TR::Node* node,
                                          TR_X86OpCodes setOp,
                                          TR::CodeGenerator* cg);

  static TR::Register* loadMemory(TR::Node* node,
                                  TR::MemoryReference* sourceMR,
                                  TR_RematerializableTypes type,
  ...
  static TR::Register* compareFloatOrDoubleForOrder(TR::Node*,
                                                    TR_X86OpCodes,
                                                    TR_X86OpCodes,
                                                    TR_X86OpCodes,
                                                    TR_X86OpCodes,
  ...
  static void compareIntegersForOrder(TR::Node* node,
                                      TR::Node* firstChild,
                                      TR::Node* secondChild,
                                      TR::CodeGenerator* cg);
  ...
  static TR::Register* integerEqualityHelper(TR::Node* node,
                                             TR_X86OpCodes setOp,
                                             TR::CodeGenerator* cg);
  static TR::Register* integerOrderHelper(TR::Node* node,
                                          TR_X86OpCodes setOp,
                                          TR::CodeGenerator* cg);
  ...
  static bool constNodeValueIs32BitSigned(TR::Node* node,
                                          intptrj_t* value,
                                          TR::CodeGenerator* cg);
  ...
  static bool stopUsingCopyRegAddr(TR::Node* node,
                                   TR::Register*& reg,
                                   TR::CodeGenerator* cg);
  static bool stopUsingCopyRegInteger(TR::Node* node,
                                      TR::Register*& reg,
                                      TR::CodeGenerator* cg);
};
}
