...
public:
  ...
  {}
  int32_t getPatchGrowth()
  {
    return _patchGrowth;
  }
  int32_t getEncodingGrowth()
  {
    return _encodingGrowth;
  }
};
...
public:
  ...
  TR_X86OpCode& getOpCode()
  {
    return _opcode;
  }
  TR_X86OpCodes getOpCodeValue()
  {
  ...
  //
  virtual TR::X86ImmInstruction* getX86ImmInstruction()
  {
    return NULL;
  }
...
public:
  ...
  struct VEX {
    VEX()
    {
      TR_ASSERT(false, "INVALID VEX PREFIX");
    }
  };
};
