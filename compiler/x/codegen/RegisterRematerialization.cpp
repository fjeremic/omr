...
//
static TR_RematerializationInfo *
generateRematerializationInfo(TR::Node *node, TR::MemoryReference *mr,
                              TR_RematerializableTypes type,
                              TR::Instruction *instr, TR::CodeGenerator *cg);

static TR_RematerializationInfo *
generateRematerializationInfo(TR::Node *node, intptrj_t constant,
                              TR_RematerializableTypes type,
                              TR::Instruction *instr, TR::CodeGenerator *cg);

static TR_RematerializationInfo *
generateRematerializationInfo(TR::Node *node, TR::SymbolReference *symRef,
                              TR_RematerializableTypes type,
                              TR::Instruction *instr, TR::CodeGenerator *cg);
