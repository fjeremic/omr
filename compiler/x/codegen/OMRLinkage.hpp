...
class OMR_EXTENSIBLE Linkage : public OMR::Linkage {
 public:
  ...
  void mapSingleAutomatic(TR::AutomaticSymbol* p,
                          uint32_t size,
                          uint32_t& stackIndex);
  ...
  //
  uint8_t* loadArguments(TR::Node* callNode,
                         uint8_t* cursor,
                         bool calculateSizeOnly,
                         int32_t* sizeOfFlushArea,
                         bool isReturnAddressOnStack);

  uint8_t* storeArguments(TR::Node* callNode,
                          uint8_t* cursor,
                          bool calculateSizeOnly,
                          int32_t* sizeOfFlushArea);
 ...
 protected:
  ...
  void associatePreservedRegisters(TR::RegisterDependencyConditions* deps,
                                   TR::Register* returnRegister);
  void coerceFPReturnValueToXMMR(TR::Node*,
