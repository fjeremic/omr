...
public:
  ...
  TR::RegisterDependency *
  getRegisterDependency(TR_X86RegisterDependencyIndex index) {
...
class RegisterDependencyConditions : public OMR::RegisterDependencyConditions {
  ...
  unionDependencies(TR_X86RegisterDependencyGroup *deps,
                    TR_X86RegisterDependencyIndex cursor, TR::Register *vr,
                    TR::RealRegister::RegNum rr, TR::CodeGenerator *cg,
                    uint8_t flag, bool isAssocRegDependency);
  TR_X86RegisterDependencyIndex
  unionRealDependencies(TR_X86RegisterDependencyGroup *deps,
                        TR_X86RegisterDependencyIndex cursor, TR::Register *vr,
                        TR::RealRegister::RegNum rr, TR::CodeGenerator *cg,
                        uint8_t flag, bool isAssocRegDependency);
...
public:
  ...
  TR_X86RegisterDependencyIndex
  setNumPreConditions(TR_X86RegisterDependencyIndex n, TR_Memory *m) {
  ...
  TR_X86RegisterDependencyIndex
  setNumPostConditions(TR_X86RegisterDependencyIndex n, TR_Memory *m) {
  ...
  TR_X86RegisterDependencyIndex
  setAddCursorForPre(TR_X86RegisterDependencyIndex a) {
  ...
  TR_X86RegisterDependencyIndex
  setAddCursorForPost(TR_X86RegisterDependencyIndex a) {
...
TR::RegisterDependencyConditions *
generateRegisterDependencyConditions(TR::Node *, TR::CodeGenerator *,
                                     TR_X86RegisterDependencyIndex = 0,
                                     List<TR::Register> * = 0);
TR::RegisterDependencyConditions *
generateRegisterDependencyConditions(TR_X86RegisterDependencyIndex,
                                     TR_X86RegisterDependencyIndex,
                                     TR::CodeGenerator *);
