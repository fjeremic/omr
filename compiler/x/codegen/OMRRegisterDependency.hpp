...
public:
    ...
    TR::RegisterDependency* getRegisterDependency(TR_X86RegisterDependencyIndex index) { return &_dependencies[index]; }
...
public:
    ...
    void blockPreConditionRegisters() { _preConditions->blockRegisters(_numPreConditions); }

    void unblockPreConditionRegisters() { _preConditions->unblockRegisters(_numPreConditions); }

    void blockPostConditionRegisters() { _postConditions->blockRegisters(_numPostConditions); }

    void unblockPostConditionRegisters() { _postConditions->unblockRegisters(_numPostConditions); }
    ...
    void printDependencyConditions(TR_X86RegisterDependencyGroup* conditions,
        TR_X86RegisterDependencyIndex numConditions, char* prefix, FILE* pOutFile);
#endif
};
} // namespace X86
} // namespace OMR
