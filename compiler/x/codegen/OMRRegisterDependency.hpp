...
public:
  ...
  void setDependencyInfo(TR_X86RegisterDependencyIndex index, TR::Register* vr, TR::RealRegister::RegNum rr,
    TR::CodeGenerator* cg, uint8_t flag = UsesDependentRegister, bool isAssocRegDependency = false);
  ...
  void orderGlobalRegsOnFPStack(TR::Instruction* cursor, TR_RegisterKinds kindsToBeAssigned,
    TR_X86RegisterDependencyIndex numberOfRegisters, List<TR::Register>* poppedRegisters, TR::CodeGenerator* cg);
  ...
  {
    _mayNeedToPopFPRegisters = b;
  }
  bool getMayNeedToPopFPRegisters()
  {
    return _mayNeedToPopFPRegisters;
  }
...
class RegisterDependencyConditions : public OMR::RegisterDependencyConditions {
  ...
  TR_X86RegisterDependencyIndex unionDependencies(TR_X86RegisterDependencyGroup* deps,
    TR_X86RegisterDependencyIndex cursor, TR::Register* vr, TR::RealRegister::RegNum rr, TR::CodeGenerator* cg,
    uint8_t flag, bool isAssocRegDependency);
  TR_X86RegisterDependencyIndex unionRealDependencies(TR_X86RegisterDependencyGroup* deps,
    TR_X86RegisterDependencyIndex cursor, TR::Register* vr, TR::RealRegister::RegNum rr, TR::CodeGenerator* cg,
    uint8_t flag, bool isAssocRegDependency);
...
public:
  ...
  RegisterDependencyConditions(TR::Node* node, TR::CodeGenerator* cg,
    TR_X86RegisterDependencyIndex additionalRegDeps = 0, List<TR::Register>* = 0);
  ...
  TR_X86RegisterDependencyGroup* getPreConditions()
  {
  ...
  TR_X86RegisterDependencyIndex setAddCursorForPre(TR_X86RegisterDependencyIndex a)
  {
  ...
  TR_X86RegisterDependencyIndex setAddCursorForPost(TR_X86RegisterDependencyIndex a)
  {
  ...
  TR_X86RegisterDependencyGroup* getPostConditions()
  {
  ...
  void printDependencyConditions(TR_X86RegisterDependencyGroup* conditions, TR_X86RegisterDependencyIndex numConditions,
...
TR::RegisterDependencyConditions* generateRegisterDependencyConditions(
  TR::Node*, TR::CodeGenerator*, TR_X86RegisterDependencyIndex = 0, List<TR::Register>* = 0);
TR::RegisterDependencyConditions* generateRegisterDependencyConditions(
  TR_X86RegisterDependencyIndex, TR_X86RegisterDependencyIndex, TR::CodeGenerator*);
