...
void TR::X86FPConvertToLongSnippet::analyseLongConversion()
{
    ...
    //
    TR_ASSERT(((_loadHighInstruction && _loadHighInstruction->getTargetRegister()) && (_loadLowInstruction && _loadLowInstruction->getTargetRegister()) && (_clobberInstruction && _clobberInstruction->getSourceRegister())),
