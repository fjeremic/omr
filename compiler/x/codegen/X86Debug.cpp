...
int32_t TR_Debug::printIntConstant(TR::FILE* pOutFile,
                                   int64_t value,
                                   int8_t radix,
...
int32_t TR_Debug::printDecimalConstant(TR::FILE* pOutFile,
                                       int64_t value,
                                       int8_t width,
                                       bool padWithZeros) {
...
int32_t TR_Debug::printHexConstant(TR::FILE* pOutFile,
                                   int64_t value,
                                   int8_t width,
                                   bool padWithZeros) {
...
void TR_Debug::printFPRegisterComment(TR::FILE* pOutFile,
                                      TR::Register* source,
                                      TR::Register* target) {
...
void TR_Debug::printRegRegInstruction(TR::FILE* pOutFile,
                                      const char* opCode,
...
void TR_Debug::printRegMemInstruction(TR::FILE* pOutFile,
                                      const char* opCode,
                                      TR::RealRegister* reg,
...
void TR_Debug::printRegImmInstruction(TR::FILE* pOutFile,
                                      const char* opCode,
                                      TR::RealRegister* reg,
                                      int32_t imm) {
  trfprintf(pOutFile, "%s\t", opCode);
...
void TR_Debug::printMemRegInstruction(TR::FILE* pOutFile,
                                      const char* opCode,
                                      TR::RealRegister* base,
                                      int32_t offset,
                                      TR::RealRegister* reg) {
...
void TR_Debug::printMemImmInstruction(TR::FILE* pOutFile,
                                      const char* opCode,
                                      TR::RealRegister* base,
                                      int32_t offset,
                                      int32_t imm) {
...
void TR_Debug::printLabelInstruction(TR::FILE* pOutFile,
                                     const char* opCode,
