...
void TR_Debug::printRegRegInstruction(TR::FILE* pOutFile, const char* opCode, TR::RealRegister* reg1, TR::RealRegister* reg2)
{
...
void TR_Debug::printRegMemInstruction(TR::FILE* pOutFile, const char* opCode, TR::RealRegister* reg, TR::RealRegister* base, int32_t offset)
{
    trfprintf(pOutFile, "%s\t", opCode);
    print(pOutFile, reg);
    if (base) {
...
void TR_Debug::printMemRegInstruction(TR::FILE* pOutFile, const char* opCode, TR::RealRegister* base, int32_t offset, TR::RealRegister* reg)
{
    trfprintf(pOutFile, "%s\t", opCode);
    trfprintf(pOutFile, "[");
    print(pOutFile, base);
...
void TR_Debug::printMemImmInstruction(TR::FILE* pOutFile, const char* opCode, TR::RealRegister* base, int32_t offset, int32_t imm)
{
    trfprintf(pOutFile, "%s\t", opCode);
    trfprintf(pOutFile, "[");
    print(pOutFile, base);
