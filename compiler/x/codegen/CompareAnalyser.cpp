...
void TR_X86CompareAnalyser::longOrderedCompareAndBranchAnalyser(TR::Node* root, TR_X86OpCodes lowBranchOpCode,
    ...
    if (getCmpReg1Reg2()) {
        ...
        if (firstHighZero) {
            ...
            generateRegRegInstruction(
                CMP4RegReg, root, firstRegister->getHighOrder(), secondRegister->getHighOrder(), cg());
        }
