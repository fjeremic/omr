...
TR::Register *
OMR::X86::TreeEvaluator::integerReturnEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg) {
  TR::Compilation *comp = cg->comp();
...
TR::Register *
OMR::X86::TreeEvaluator::iternaryEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::X86::TreeEvaluator::integerIfCmpeqEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg) {
#ifdef J9_PROJECT_SPECIFIC
...
TR::Register *
OMR::X86::TreeEvaluator::integerIfCmpneEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg) {
  TR::Compilation *comp = cg->comp();
...
TR::Register *
OMR::X86::TreeEvaluator::integerIfCmpltEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg) {
...
TR::Register *
OMR::X86::TreeEvaluator::integerIfCmpgeEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg) {
  if (TR::TreeEvaluator::getNodeIs64Bit(node, cg)
          ? TR::TreeEvaluator::generateLAddOrSubForOverflowCheck(node, cg)
          : TR::TreeEvaluator::generateIAddOrSubForOverflowCheck(node, cg)) {
...
TR::Register *
OMR::X86::TreeEvaluator::integerIfCmpgtEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareIntegersForOrder(node, cg);
...
TR::Register *
OMR::X86::TreeEvaluator::integerIfCmpleEvaluator(TR::Node *node,
                                                 TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareIntegersForOrder(node, cg);
...
TR::Register *
OMR::X86::TreeEvaluator::ifbcmpeqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::X86::TreeEvaluator::ifbcmpltEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::X86::TreeEvaluator::ifbucmpltEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareBytesForOrder(node, cg);
  generateConditionalJumpInstruction(JB4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifbcmpgeEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareBytesForOrder(node, cg);
  generateConditionalJumpInstruction(JGE4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifbucmpgeEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareBytesForOrder(node, cg);
  generateConditionalJumpInstruction(JAE4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifbcmpgtEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareBytesForOrder(node, cg);
  generateConditionalJumpInstruction(JG4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifbucmpgtEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareBytesForOrder(node, cg);
  generateConditionalJumpInstruction(JA4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifbcmpleEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareBytesForOrder(node, cg);
  generateConditionalJumpInstruction(JLE4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifbucmpleEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareBytesForOrder(node, cg);
  generateConditionalJumpInstruction(JBE4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifscmpeqEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::Node *secondChild = node->getSecondChild();
...
TR::Register *
OMR::X86::TreeEvaluator::ifscmpltEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
...
TR::Register *
OMR::X86::TreeEvaluator::ifscmpgeEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compare2BytesForOrder(node, cg);
  generateConditionalJumpInstruction(JGE4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifscmpgtEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compare2BytesForOrder(node, cg);
  generateConditionalJumpInstruction(JG4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifscmpleEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compare2BytesForOrder(node, cg);
  generateConditionalJumpInstruction(JLE4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifsucmpeqEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compareIntegersForEquality(node, cg);
  generateConditionalJumpInstruction(
...
TR::Register *
OMR::X86::TreeEvaluator::ifsucmpltEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compare2BytesForOrder(node, cg);
  generateConditionalJumpInstruction(JB4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifsucmpgeEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compare2BytesForOrder(node, cg);
  generateConditionalJumpInstruction(JAE4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifsucmpgtEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compare2BytesForOrder(node, cg);
  generateConditionalJumpInstruction(JA4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::ifsucmpleEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg) {
  TR::TreeEvaluator::compare2BytesForOrder(node, cg);
  generateConditionalJumpInstruction(JBE4, node, cg, true);
  return NULL;
...
TR::Register *
OMR::X86::TreeEvaluator::integerCmpeqEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerEqualityHelper(node, SETE1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::integerCmpneEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerEqualityHelper(node, SETNE1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::integerOrderHelper(TR::Node *node, TR_X86OpCodes setOp,
                                            TR::CodeGenerator *cg) {
  TR::Register *targetRegister = cg->allocateRegister();
  node->setRegister(targetRegister);
  TR::TreeEvaluator::compareIntegersForOrder(node, cg);
...
TR::Register *
OMR::X86::TreeEvaluator::integerCmpltEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerOrderHelper(node, SETL1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::integerCmpgeEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerOrderHelper(node, SETGE1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::integerCmpgtEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerOrderHelper(node, SETG1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::integerCmpleEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerOrderHelper(node, SETLE1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::unsignedIntegerCmpltEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerOrderHelper(node, SETB1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::unsignedIntegerCmpgeEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerOrderHelper(node, SETAE1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::unsignedIntegerCmpgtEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg) {
  return TR::TreeEvaluator::integerOrderHelper(node, SETA1Reg, cg);
}

TR::Register *
OMR::X86::TreeEvaluator::unsignedIntegerCmpleEvaluator(TR::Node *node,
                                                       TR::CodeGenerator *cg) {
...
TR::Register *OMR::X86::TreeEvaluator::scmpeqEvaluator(TR::Node *node,
  ...
  generateRegInstruction(node->getOpCodeValue() == TR::scmpeq ? SETE1Reg
                                                              : SETNE1Reg,
...
TR::Register *
OMR::X86::TreeEvaluator::cmp2BytesEvaluator(TR::Node *node, TR_X86OpCodes setOp,
                                            TR::CodeGenerator *cg) {
  TR::Register *targetRegister = cg->allocateRegister();
  TR::TreeEvaluator::compare2BytesForOrder(node, cg);
  generateRegInstruction(setOp, node, targetRegister, cg);
...
TR::Register *OMR::X86::TreeEvaluator::sucmpeqEvaluator(TR::Node *node,
  ...
  generateRegInstruction(node->getOpCodeValue() == TR::sucmpeq ? SETE1Reg
                                                               : SETNE1Reg,
                         node, targetRegister, cg);
  generateRegRegInstruction(MOVZXReg4Reg1, node, targetRegister, targetRegister,
                            cg);
...
static bool virtualGuardHelper(TR::Node *node, TR::CodeGenerator *cg) {
  ...
  if (cg->needClassAndMethodPointerRelocations()) {
    ...
    default:
      TR_ASSERT_FATAL(0,
                      "AOT guard in node but not one of known guards supported "
                      "for AOT. Guard: %d",
                      reloKind);
      break;
    }
