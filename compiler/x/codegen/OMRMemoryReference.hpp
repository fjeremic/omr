...
public:
  ...
  MemoryReference(TR::MemoryReference& mr,
                  intptrj_t n,
                  TR::CodeGenerator* cg,
  ...
  void checkAndDecReferenceCount(TR::Node* node,
                                 rcount_t refCount,
                                 TR::CodeGenerator* cg);

  void populateMemoryReference(TR::Node* subTree,
                               TR::CodeGenerator* cg,
                               TR::Node* parent = NULL);

  TR::Register* evaluate(TR::Node* subTree,
                         TR::CodeGenerator* cg,
                         TR::Node* parent = NULL);
  ...
  void addMetaDataForCodeAddress(uint32_t addressTypes,
                                 uint8_t* cursor,
                                 TR::Node* node,
                                 TR::CodeGenerator* cg);
  ...
  uint8_t rexBits()
  {
    ...
    if (_indexRegister)
      rxbBits |=
        toRealRegister(_indexRegister)->rexBits(TR::RealRegister::REX_X, false);
...
TR::MemoryReference*
generateX86MemoryReference(intptrj_t, TR::CodeGenerator* cg);
TR::MemoryReference*
...
generateX86MemoryReference(TR::Register* br,
                           ...
                           TR::CodeGenerator* cg);
TR::MemoryReference*
generateX86MemoryReference(TR::Node*,
                           TR::CodeGenerator* cg,
                           bool canRematerializeAddressAdds = true);
TR::MemoryReference*
generateX86MemoryReference(TR::MemoryReference&,
                           intptrj_t,
                           TR::CodeGenerator* cg);
TR::MemoryReference*
generateX86MemoryReference(TR::MemoryReference&,
                           ...
                           TR::CodeGenerator* cg);
TR::MemoryReference*
generateX86MemoryReference(TR::SymbolReference*, TR::CodeGenerator* cg);
TR::MemoryReference*
generateX86MemoryReference(TR::SymbolReference*,
                           intptrj_t,
                           TR::CodeGenerator* cg);
TR::MemoryReference*
generateX86MemoryReference(TR::X86DataSnippet*, TR::CodeGenerator* cg);
TR::MemoryReference*
generateX86MemoryReference(TR::LabelSymbol*, TR::CodeGenerator* cg);
