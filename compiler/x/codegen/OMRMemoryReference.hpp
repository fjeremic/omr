...
public:
  ...
  TR::Register* getAddressRegister()
  {
    return NULL;
  }
  ...
  bool getFlags()
  {
    return _flags.getValue() != 0;
  }
  void setFlags(uint8_t f)
  {
    _flags.setValue(0xff, f);
  }
  ...
  bool isForceSIBByte()
  {
    return _flags.testAny(MemRef_ForceSIBByte);
  }
  void setForceSIBByte()
  {
    _flags.set(MemRef_ForceSIBByte);
  }
  ...
  bool inUpcastingMode()
  {
    return _flags.testAny(MemRef_UpcastingMode);
  }
  ...
  void setProcessAsFPVolatile()
  {
    _flags.set(MemRef_ProcessAsFPVolatile);
  }
  ...
  void setRequiresLockPrefix()
  {
    return _flags.set(MemRef_RequiresLockPrefix);
  }
  ...
  bool ignoreVolatile()
  {
    return _flags.testAny(MemRef_IgnoreVolatile);
  }
  void setIgnoreVolatile()
  {
    _flags.set(MemRef_IgnoreVolatile);
  }
  ...
  uint8_t setStride(uint8_t s)
  {
    return (_stride = s);
  }
  uint8_t getStrideMultiplier()
  {
    return 1 << _stride;
  }
...
TR::MemoryReference* generateX86MemoryReference(
  TR::Register* br, TR::Register* ir, uint8_t s, intptrj_t disp, TR::CodeGenerator* cg);
TR::MemoryReference* generateX86MemoryReference(
...
TR::MemoryReference* generateX86MemoryReference(
  TR::MemoryReference&, intptrj_t, TR_ScratchRegisterManager*, TR::CodeGenerator* cg);
