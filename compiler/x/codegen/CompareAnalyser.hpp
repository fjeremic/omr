...
class TR_X86CompareAnalyser : public TR_Analyser {
 ...
 public:
  ...
  void integerCompareAnalyser(TR::Node *root, TR_X86OpCodes regRegOpCode,
                              TR_X86OpCodes regMemOpCode,
                              TR_X86OpCodes memRegOpCode);

  void integerCompareAnalyser(TR::Node *root, TR::Node *firstChild,
                              TR::Node *secondChild,
  ...
  void longOrderedCompareAndBranchAnalyser(
