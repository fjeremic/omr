...
class X86PaddingSnippetInstruction : public TR::X86PaddingInstruction {
 ...
 public:
  ...
  TR::UnresolvedDataSnippet *setUnresolvedSnippet(
...
class X86PatchableCodeAlignmentInstruction
 ...
 public:
  ...
  static TR_AtomicRegion spinLoopAtomicRegions[];  // For any patching done
                                                   // using a 2-byte self-loop
  static TR_AtomicRegion
      CALLImm4AtomicRegions[];  // For patching the displacement of a 5-byte
                                // call instruction
};
...
class AMD64Imm64Instruction : public TR::Instruction {
 ...
 public:
  ...
  AMD64Imm64Instruction(TR::RegisterDependencyConditions *cond, uint64_t imm,
      ...
      : TR::Instruction(cond, op, precedingInstruction, cg),
        _sourceImmediate(imm) {
    if (cond) cond->createRegisterAssociationDirective(this, cg);
  }
...
TR::X86RegInstruction *generateRegInstruction(
    TR_X86OpCodes op, TR::Node *, TR::Register *reg1,
...
TR::X86ImmInstruction *generateImmInstruction(
    ...
    TR::RegisterDependencyConditions *cond, TR::CodeGenerator *cg);
TR::X86ImmInstruction *generateImmInstruction(
    TR_X86OpCodes op, TR::Node *node, int32_t imm, TR::CodeGenerator *cg,
    int32_t reloKind = TR_NoRelocation);
TR::X86ImmInstruction *generateImmInstruction(
...
TR::X86MemImmSymInstruction *generateMemImmSymInstruction(
    TR_X86OpCodes op, TR::Node *, TR::MemoryReference *mr, int32_t imm,
    TR::SymbolReference *sr, TR::CodeGenerator *cg);
...
TR::X86LabelInstruction *generateLabelInstruction(
    TR_X86OpCodes op, TR::Node *, TR::LabelSymbol *sym,
    TR::RegisterDependencyConditions *cond, TR::CodeGenerator *cg);
TR::X86LabelInstruction *generateLabelInstruction(
...
TR::X86LabelInstruction *generateLabelInstruction(TR::Instruction *i,
                                                  ...
                                                  TR::CodeGenerator *cg);
TR::X86LabelInstruction *generateLabelInstruction(
    TR_X86OpCodes op, TR::Node *, TR::LabelSymbol *sym, TR::Node *glRegDep,
...
inline TR::X86LabelInstruction *generateLabelInstruction(
    TR_X86OpCodes op, TR::Node *node, TR::LabelSymbol *sym, TR::Node *glRegDep,
    List<TR::Register> *popRegs, TR::CodeGenerator *cg) {
...
TR::X86LabelInstruction *generateConditionalJumpInstruction(
    TR_X86OpCodes op, TR::Node *ifNode, TR::CodeGenerator *cg,
...
TR::X86VirtualGuardNOPInstruction *generateVirtualGuardNOPInstruction(
    TR::Node *, TR_VirtualGuardSite *site,
...
TR::X86RegImmInstruction *generateRegImmInstruction(
    TR_X86OpCodes op, TR::Node *, TR::Register *reg1, int32_t imm,
    TR::RegisterDependencyConditions *cond, TR::CodeGenerator *cg);
TR::X86RegImmInstruction *generateRegImmInstruction(
    TR_X86OpCodes op, TR::Node *, TR::Register *reg1, int32_t imm,
    TR::CodeGenerator *cg, int32_t reloKind = TR_NoRelocation);
...
TR::X86RegRegRegInstruction *generateRegRegRegInstruction(
    TR_X86OpCodes op, TR::Node *, TR::Register *reg1, TR::Register *reg2,
    TR::Register *reg3, TR::RegisterDependencyConditions *deps,
    TR::CodeGenerator *cg);
TR::X86RegRegRegInstruction *generateRegRegRegInstruction(
    TR_X86OpCodes op, TR::Node *, TR::Register *reg1, TR::Register *reg2,
...
TR::X86RegRegMemInstruction *generateRegRegMemInstruction(
    TR_X86OpCodes op, TR::Node *, TR::Register *reg1, TR::Register *reg2,
    TR::MemoryReference *mr, TR::RegisterDependencyConditions *deps,
    TR::CodeGenerator *cg);
TR::X86RegRegMemInstruction *generateRegRegMemInstruction(
    TR_X86OpCodes op, TR::Node *, TR::Register *reg1, TR::Register *reg2,
    TR::MemoryReference *mr, TR::CodeGenerator *cg);
...
TR::X86ImmSnippetInstruction *generateImmSnippetInstruction(
    TR_X86OpCodes op, TR::Node *, int32_t imm, TR::UnresolvedDataSnippet *,
    TR::CodeGenerator *cg);
...
TR::X86ImmSymInstruction *generateHelperCallInstruction(
    TR::Node *, TR_RuntimeHelper, TR::RegisterDependencyConditions *,
    TR::CodeGenerator *cg);
...
TR::X86FPReturnInstruction *generateFPReturnInstruction(
    TR_X86OpCodes op, TR::Node *, TR::RegisterDependencyConditions *,
    TR::CodeGenerator *cg);

TR::X86FPReturnImmInstruction *generateFPReturnImmInstruction(
    TR_X86OpCodes cp, TR::Node *, int32_t imm,
    TR::RegisterDependencyConditions *, TR::CodeGenerator *cg);
