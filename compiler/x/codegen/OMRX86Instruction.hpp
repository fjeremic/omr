...
public:
  ...
  {
    TR_ASSERT(
      0 <= index && index < _numRelocations,
      "X86MemTableInstruction::getRelocation - index %d is out of range (0-%d)",
      index,
      _numRelocations);
...
inline TR::X86ImmInstruction*
toIA32ImmInstruction(TR::Instruction* i)
{
...
generateMemInstruction(TR::Instruction*,
                       TR_X86OpCodes op,
                       TR::MemoryReference* mr,
                       TR::CodeGenerator* cg);
...
generateRegImmInstruction(TR::Instruction*,
                          TR_X86OpCodes op,
                          TR::Register* reg1,
                          int32_t imm,
                          TR::CodeGenerator* cg,
...
generateRegMemInstruction(TR::Instruction*,
                          TR_X86OpCodes op,
                          TR::Register* reg1,
                          TR::MemoryReference* mr,
                          TR::CodeGenerator* cg);
TR::X86RegRegInstruction*
generateRegRegInstruction(TR::Instruction*,
                          TR_X86OpCodes op,
                          TR::Register* reg1,
                          TR::Register* reg2,
                          TR::CodeGenerator* cg);
...
TR::Instruction*
generateInstruction(TR_X86OpCodes,
                    TR::Node*,
                    TR::RegisterDependencyConditions* cond,
                    TR::CodeGenerator* cg);
TR::Instruction*
...
generateLabelInstruction(TR_X86OpCodes op,
                         ...
                         TR::CodeGenerator* cg);
TR::X86LabelInstruction*
generateLabelInstruction(TR::Instruction* i,
                         TR_X86OpCodes op,
                         TR::LabelSymbol* sym,
                         TR::CodeGenerator* cg);
TR::X86LabelInstruction*
...
TR::X86LabelInstruction*
generateJumpInstruction(TR_X86OpCodes op,
                        TR::Node* jumpNode,
                        TR::CodeGenerator* cg,
...
TR::X86LabelInstruction*
generateConditionalJumpInstruction(TR_X86OpCodes op,
                                   TR::Node* ifNode,
                                   TR::CodeGenerator* cg,
                                   bool needsVMThreadRegister = false);
...
generateVirtualGuardNOPInstruction(TR::Node*,
                                   TR_VirtualGuardSite* site,
                                   TR::RegisterDependencyConditions* deps,
                                   TR::CodeGenerator* cg);
TR::X86VirtualGuardNOPInstruction*
...
generateMemImmInstruction(TR_X86OpCodes op,
                          ...
                          int32_t reloKind = TR_NoRelocation);
TR::X86MemImmInstruction*
generateMemImmInstruction(TR::Instruction*,
                          TR_X86OpCodes op,
                          TR::MemoryReference* mr,
                          int32_t imm,
                          TR::CodeGenerator* cg,
...
TR::X86ImmSymInstruction*
generateHelperCallInstruction(TR::Node*,
                              TR_RuntimeHelper,
                              TR::RegisterDependencyConditions*,
                              TR::CodeGenerator* cg);
TR::X86ImmSymInstruction*
generateHelperCallInstruction(TR::Instruction*,
                              TR_RuntimeHelper,
                              TR::CodeGenerator* cg);
...
generateFPReturnImmInstruction(TR_X86OpCodes cp,
                               TR::Node*,
                               int32_t imm,
                               TR::RegisterDependencyConditions*,
                               TR::CodeGenerator* cg);
