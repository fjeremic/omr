...
extern int32_t memoryBarrierRequired(TR_X86OpCode& op,
...
class X86PaddingInstruction : public TR::Instruction {
 ...
 public:
  ...
  X86PaddingInstruction(uint8_t length,
  ...
  X86PaddingInstruction(TR::Instruction* precedingInstruction,
                        uint8_t length,
                        TR::CodeGenerator* cg)
...
class X86PaddingSnippetInstruction : public TR::X86PaddingInstruction {
 ...
 public:
  X86PaddingSnippetInstruction(uint8_t length,
                               TR::Node* node,
                               TR::CodeGenerator* cg)
...
class X86AlignmentInstruction : public TR::Instruction {
 ...
 public:
  ...
  X86AlignmentInstruction(TR::Node* node,
                          uint8_t boundary,
                          TR::CodeGenerator* cg)
      : TR::Instruction(node, BADIA32Op, cg),
        _boundary(boundary),
...
class X86ImmInstruction : public TR::Instruction {
 ...
 public:
  X86ImmInstruction(TR::Node* node,
                    TR_X86OpCodes op,
                    TR::CodeGenerator* cg,
...
class X86MemInstruction : public TR::Instruction {
 ...
 public:
  X86MemInstruction(TR::Node* node,
                    TR_X86OpCodes op,
                    TR::CodeGenerator* cg,
                    TR::Register* srcReg = NULL)
...
class X86MemTableInstruction : public TR::X86MemInstruction {
 ...
 public:
  X86MemTableInstruction(TR_X86OpCodes op,
                         TR::Node* node,
                         TR::MemoryReference* mr,
                         ncount_t numEntries,
                         TR::CodeGenerator* cg)
...
class X86VFPDedicateInstruction : public TR::X86RegMemInstruction {
 ...
 public:
  X86VFPDedicateInstruction(TR::Instruction* precedingInstruction,
                            ...
                            TR::CodeGenerator* cg)
      : TR::X86RegMemInstruction(precedingInstruction,
                                 LEARegMem(),
                                 framePointerReg,
                                 memref(cg),
                                 cg) {}

  X86VFPDedicateInstruction(TR::RealRegister* framePointerReg,
                            TR::Node* node,
                            TR::CodeGenerator* cg)
      : TR::X86RegMemInstruction(LEARegMem(),
                                 node,
                                 framePointerReg,
                                 memref(cg),
                                 cg) {}
...
class X86VFPCallCleanupInstruction : public TR::Instruction {
 ...
 public:
  ...
  X86VFPCallCleanupInstruction(int32_t adjustment,
                               TR::Node* node,
                               TR::CodeGenerator* cg)
      : _stackPointerAdjustment(adjustment),
        TR::Instruction(node, AdjustFramePtr, cg) {}
...
TR::Instruction* generateInstruction(TR_X86OpCodes,
                                     TR::Node*,
                                     TR::RegisterDependencyConditions* cond,
                                     TR::CodeGenerator* cg);
