...
public:
    ...
    X86RegInstruction(TR::RegisterDependencyConditions* cond, TR::Register* reg, TR::Node* node, TR_X86OpCodes op,
        TR::CodeGenerator* cg)
        : TR::Instruction(cond, node, op, cg)
        , _targetRegister(reg)
    {
    ...
    X86RegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* reg, TR::RegisterDependencyConditions* cond,
        TR::CodeGenerator* cg);
...
public:
    ...
    X86RegRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op, TR::Register* treg,
...
public:
    X86RegImmSymInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* reg, int32_t imm, TR::SymbolReference* sr,
        TR::CodeGenerator* cg);
...
public:
    ...
    X86MemImmSymInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op, TR::MemoryReference* mr,
...
public:
    X86MemRegImmInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr, TR::Register* sreg, int32_t imm,
        TR::CodeGenerator* cg);
...
public:
    X86RegMemImmInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg, TR::MemoryReference* mr, int32_t imm,
        TR::CodeGenerator* cg);
...
public:
    AMD64RegImm64SymInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* reg, uint64_t imm,
        TR::SymbolReference* sr, TR::CodeGenerator* cg);

    AMD64RegImm64SymInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op, TR::Register* reg,
...
TR::X86ImmInstruction* generateImmInstruction(
    TR_X86OpCodes op, TR::Node* node, int32_t imm, TR::CodeGenerator* cg, int32_t reloKind = TR_NoRelocation);
TR::X86ImmInstruction* generateImmInstruction(TR::Instruction* prev, TR_X86OpCodes op, int32_t imm,
    TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg);
TR::X86ImmInstruction* generateImmInstruction(
