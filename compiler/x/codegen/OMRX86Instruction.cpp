...
TR::X86LabelInstruction::X86LabelInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::LabelSymbol* sym, TR::CodeGenerator* cg, bool b)
...
TR::X86LabelInstruction::X86LabelInstruction(
  TR::Instruction* precedingInstruction, TR_X86OpCodes op, TR::LabelSymbol* sym, TR::CodeGenerator* cg, bool b)
  : TR::Instruction(op, precedingInstruction, cg)
{
  initialize(sym, b);
}

TR::X86LabelInstruction::X86LabelInstruction(TR_X86OpCodes op, TR::Node* node, TR::LabelSymbol* sym,
...
TR::X86LabelInstruction::X86LabelInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::LabelSymbol* sym, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg, bool b)
      ...
      if (snippet && (devirtSnippet = snippet->getGuardedDevirtualSnippet())) {
        ...
        if (classObjectRegister != NULL && !classObjectRegister->getRealRegister()) {
          ...
          if (assignedClassObjectRegister == NULL
            ...
            if ((assignedClassObjectRegister = machine->findBestFreeGPRegister(this, classObjectRegister, TR_WordReg))
              != NULL) {
...
TR::X86FenceInstruction::X86FenceInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Node* fenceNode, TR::CodeGenerator* cg)
  : TR::Instruction(node, op, cg)
  , _fenceNode(fenceNode)
{}

TR::X86FenceInstruction::X86FenceInstruction(
  TR::Instruction* precedingInstruction, TR_X86OpCodes op, TR::Node* node, TR::CodeGenerator* cg)
  : TR::Instruction(op, precedingInstruction, cg)
  , _fenceNode(node)
{}
...
TR::X86ImmInstruction::X86ImmInstruction(
  TR_X86OpCodes op, TR::Node* node, int32_t imm, TR::CodeGenerator* cg, int32_t reloKind)
  : TR::Instruction(node, op, cg)
...
TR::X86ImmInstruction::X86ImmInstruction(
  TR::Instruction* precedingInstruction, TR_X86OpCodes op, int32_t imm, TR::CodeGenerator* cg, int32_t reloKind)
  : TR::Instruction(op, precedingInstruction, cg)
  , _sourceImmediate(imm)
  , _adjustsFramePointerBy(0)
  , _reloKind(reloKind)
...
TR::X86ImmInstruction::X86ImmInstruction(TR_X86OpCodes op, TR::Node* node, int32_t imm,
...
TR::X86ImmInstruction::X86ImmInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op, int32_t imm,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg, int32_t reloKind)
  : TR::Instruction(cond, op, precedingInstruction, cg)
  , _sourceImmediate(imm)
  , _adjustsFramePointerBy(0)
...
TR::X86ImmSnippetInstruction::X86ImmSnippetInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86ImmSymInstruction::X86ImmSymInstruction(
  TR_X86OpCodes op, TR::Node* node, int32_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
  : TR::X86ImmInstruction(imm, node, op, cg)
  , _symbolReference(sr)
{}

TR::X86ImmSymInstruction::X86ImmSymInstruction(
  TR::Instruction* precedingInstruction, TR_X86OpCodes op, int32_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
  : TR::X86ImmInstruction(imm, op, precedingInstruction, cg)
  , _symbolReference(sr)
{}

TR::X86ImmSymInstruction::X86ImmSymInstruction(TR_X86OpCodes op, TR::Node* node, int32_t imm, TR::SymbolReference* sr,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
  : TR::X86ImmInstruction(cond, imm, node, op, cg)
  , _symbolReference(sr)
{}

TR::X86ImmSymInstruction::X86ImmSymInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op, int32_t imm,
...
TR::X86RegInstruction::X86RegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* reg, TR::CodeGenerator* cg)
  : TR::Instruction(node, op, cg)
  , _targetRegister(reg)
{
  useRegister(reg);
...
TR::X86RegInstruction::X86RegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op, TR::Register* reg,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
  : TR::Instruction(cond, op, precedingInstruction, cg)
  , _targetRegister(reg)
{
...
TR::X86RegRegInstruction::X86RegRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86RegRegInstruction::X86RegRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg, TR::Register* sreg,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
...
void TR::X86RegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  ...
  if (kindsToBeAssigned & getTargetRegister()->getKindAsMask()) {
    ...
    TR_RegisterSizes firstRequestedRegSize
      = getOpCode().hasByteTarget() ? TR_ByteReg : getOpCode().hasXMMTarget() ? TR_QuadWordReg : TR_WordReg;

    TR_RegisterSizes secondRequestedRegSize
      = getOpCode().hasByteSource() ? TR_ByteReg : getOpCode().hasXMMSource() ? TR_QuadWordReg : TR_WordReg;
    ...
    if (secondRegister->decFutureUseCount() == 0 && assignedSecondRegister->getState() != TR::RealRegister::Locked) {
...
TR::X86RegImmInstruction::X86RegImmInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* treg, int32_t imm, TR::CodeGenerator* cg, int32_t reloKind)
  : TR::X86RegInstruction(treg, node, op, cg)
  , _sourceImmediate(imm)
  , _reloKind(reloKind)
{}

TR::X86RegImmInstruction::X86RegImmInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86RegImmInstruction::X86RegImmInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg, int32_t imm,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg, int32_t reloKind)
  : TR::X86RegInstruction(cond, treg, node, op, cg)
  , _sourceImmediate(imm)
  , _reloKind(reloKind)
...
void TR::X86RegImmInstruction::adjustVFPState(TR_VFPState* state, TR::CodeGenerator* cg)
{
  ...
  if (state->_register == targetReal) {
    ...
    default:
      if (cg->getDebug())
        TR_ASSERT(0, "Can't compute VFP adjustment due to instruction %s: %s %s, %d", cg->getDebug()->getName(this),
          cg->getDebug()->getMnemonicName(&getOpCode()), cg->getDebug()->getName(getTargetRegister()),
          getSourceImmediate());
      else
...
TR::X86RegImmSymInstruction::X86RegImmSymInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86RegRegImmInstruction::X86RegRegImmInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::Register* treg, TR::Register* sreg, int32_t imm, TR::CodeGenerator* cg)
...
TR::X86RegRegRegInstruction::X86RegRegRegInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* treg, TR::Register* slreg, TR::Register* srreg, TR::CodeGenerator* cg)
...
TR::X86RegRegRegInstruction::X86RegRegRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::Register* treg, TR::Register* slreg, TR::Register* srreg, TR::CodeGenerator* cg)
...
TR::X86RegRegRegInstruction::X86RegRegRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg,
...
void TR::X86RegRegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  ...
  if (kindsToBeAssigned & getTargetRegister()->getKindAsMask()) {
    ...
    if (thirdRegister == getTargetRegister()) {
      if (secondRegister->getFutureUseCount() == 0 && assignedSecondRegister->getState() != TR::RealRegister::Locked) {
        cg()->traceRegFreed(secondRegister, assignedSecondRegister);
        secondRegister->setAssignedRegister(NULL);
        assignedSecondRegister->setState(TR::RealRegister::Unlatched);
      }
      if (firstRegister->getFutureUseCount() == 0 && assignedFirstRegister->getState() != TR::RealRegister::Locked) {
        cg()->traceRegFreed(firstRegister, assignedFirstRegister);
        firstRegister->setAssignedRegister(NULL);
        assignedFirstRegister->setState(TR::RealRegister::Unlatched);
      }
    ...
    if (firstRegister == getTargetRegister()) {
      ...
      if (thirdRegister->getFutureUseCount() == 0 && assignedThirdRegister->getState() != TR::RealRegister::Locked) {
        cg()->traceRegFreed(thirdRegister, assignedThirdRegister);
        thirdRegister->setAssignedRegister(NULL);
        assignedThirdRegister->setState(TR::RealRegister::Unlatched);
      }
...
TR::X86MemInstruction::X86MemInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr, TR::CodeGenerator* cg, TR::Register* sreg)
  : TR::Instruction(node, op, cg)
  , _memoryReference(mr)
{
...
TR::X86MemInstruction::X86MemInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::MemoryReference* mr, TR::CodeGenerator* cg, TR::Register* sreg)
  : TR::Instruction(op, precedingInstruction, cg)
  , _memoryReference(mr)
{
  mr->useRegisters(this, cg);
...
TR::X86MemInstruction::X86MemInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg, TR::Register* sreg)
  : TR::Instruction(cond, node, op, cg)
  , _memoryReference(mr)
{
  mr->useRegisters(this, cg);
...
TR::X86CallMemInstruction::X86CallMemInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
  : TR::X86MemInstruction(cond, mr, node, op, cg)
  , _adjustsFramePointerBy(0)
{}

TR::X86CallMemInstruction::X86CallMemInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86CallMemInstruction::X86CallMemInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr, TR::CodeGenerator* cg)
...
TR::X86MemImmInstruction::X86MemImmInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr, int32_t imm, TR::CodeGenerator* cg, int32_t reloKind)
  : TR::X86MemInstruction(mr, node, op, cg)
  , _sourceImmediate(imm)
  , _reloKind(reloKind)
{}

TR::X86MemImmInstruction::X86MemImmInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86MemImmSymInstruction::X86MemImmSymInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr,
  int32_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
  : TR::X86MemImmInstruction(imm, mr, node, op, cg)
  , _symbolReference(sr)
{}

TR::X86MemImmSymInstruction::X86MemImmSymInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86MemRegInstruction::X86MemRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86MemRegInstruction::X86MemRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr,
...
TR::X86MemRegImmInstruction::X86MemRegImmInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86RegMemInstruction::X86RegMemInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86RegMemInstruction::X86RegMemInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg,
  TR::MemoryReference* mr, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
  : TR::X86RegInstruction(cond, treg, node, op, cg)
  , _memoryReference(mr)
{
...
TR::X86RegMemImmInstruction::X86RegMemImmInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::Register* treg, TR::MemoryReference* mr, int32_t imm, TR::CodeGenerator* cg)
...
TR::X86RegRegMemInstruction::X86RegRegMemInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* slreg,
  TR::Register* srreg, TR::MemoryReference* mr, TR::CodeGenerator* cg)
...
TR::X86FPRegInstruction::X86FPRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* reg, TR::CodeGenerator* cg)
...
TR::X86FPRegRegInstruction::X86FPRegRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg,
  TR::Register* sreg, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
  : TR::X86RegRegInstruction(op, node, treg, sreg, cond, cg)
{}

TR::X86FPRegRegInstruction::X86FPRegRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
  : TR::X86RegRegInstruction(sreg, treg, op, precedingInstruction, cg)
{}
...
TR::X86FPST0ST1RegRegInstruction::X86FPST0ST1RegRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg,
  TR::Register* sreg, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
  : TR::X86FPRegRegInstruction(op, node, treg, sreg, cond, cg)
{}

TR::X86FPST0ST1RegRegInstruction::X86FPST0ST1RegRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
...
TR::X86FPSTiST0RegRegInstruction::X86FPSTiST0RegRegInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg, bool forcePop)
  : TR::X86FPRegRegInstruction(sreg, treg, node, op, cg)
{
  _forcePop = forcePop;
}

TR::X86FPSTiST0RegRegInstruction::X86FPSTiST0RegRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::X86FPST0STiRegRegInstruction::X86FPST0STiRegRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
  : TR::X86FPRegRegInstruction(sreg, treg, op, precedingInstruction, cg)
{}
...
TR::X86FPArithmeticRegRegInstruction::X86FPArithmeticRegRegInstruction(TR::Instruction* precedingInstruction,
  TR_X86OpCodes op, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
  : TR::X86FPRegRegInstruction(sreg, treg, op, precedingInstruction, cg)
{}
...
void TR::X86FPArithmeticRegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  ...
  if (kindsToBeAssigned & TR_X87_Mask) {
    ...
    TR_ASSERT(
      result & kSourceOnFPStack, "TR::X86FPArithmeticRegRegInstruction::assignRegisters ==> source not on FP stack!");

    TR_ASSERT(
      result & kTargetOnFPStack, "TR::X86FPArithmeticRegRegInstruction::assignRegisters ==> target not on FP stack!");
...
void TR::X86FPCompareRegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  ...
  if (kindsToBeAssigned & TR_X87_Mask) {
    ...
    TR_ASSERT(
      result & kSourceOnFPStack, "TR::X86FPCompareRegRegInstruction::assignRegisters ==> source not on FP stack!");

    TR_ASSERT(
      result & kTargetOnFPStack, "TR::X86FPCompareRegRegInstruction::assignRegisters ==> target not on FP stack!");
    ...
    if (result & (kSourceCanBePopped | kTargetCanBePopped)) {
      ...
      if ((result & (kSourceCanBePopped | kTargetCanBePopped)) == (kSourceCanBePopped | kTargetCanBePopped)) {
        ...
        //
        TR_ASSERT(0,
          "TR::X86FPCompareRegRegInstruction::assignRegisters() ==> source operand should not be dead after compare!");
      }
...
bool TR::X86FPCompareRegRegInstruction::swapOperands()
{
  ...
  if ( // !debug("saveFXCHs")       ||
    ...
    swappedOp == TR::iffcmple || swappedOp == TR::ifdcmple || swappedOp == TR::fcmple || swappedOp == TR::dcmple
    || swappedOp == TR::iffcmpgtu || swappedOp == TR::ifdcmpgtu || swappedOp == TR::fcmpgtu || swappedOp == TR::dcmpgtu
    ||
    // the following cases lead to complicated tests if using FCOMI,
    // or lead to code growth (extra CMP) if using FCOM.
    swappedOp == TR::iffcmplt || swappedOp == TR::ifdcmplt || swappedOp == TR::fcmplt || swappedOp == TR::dcmplt
    || swappedOp == TR::iffcmpgeu || swappedOp == TR::ifdcmpgeu || swappedOp == TR::fcmpgeu
  ...
  if (cursor != NULL) {
    ...
    TR_ASSERT(0,
      "\nTR::X86FPCompareRegRegInstruction::swapOperands() ==> branch or set instruction not found for FP "
      "comparison!\n");
  }
...
TR::X86FPCompareEvalInstruction::X86FPCompareEvalInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* accRegister, TR::CodeGenerator* cg)
  : TR::Instruction(node, op, cg)
  , _accRegister(accRegister)
{}

TR::X86FPCompareEvalInstruction::X86FPCompareEvalInstruction(TR_X86OpCodes op, TR::Node* node,
...
void TR::X86FPCompareEvalInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  ...
  if (kindsToBeAssigned & TR_GPR_Mask) {
    ...
    TR_ASSERT(accRegister != NULL,
      "TR::X86FPCompareEvalInstruction::assignRegisters() ==> _accRegister has not been assigned!\n");
    ...
    case TR::fcmpgtu:
      TR_ASSERT(
        0, "TR::X86FPCompareEvalRegInstruction::assignRegisters() ==> shouldn't be able to generate this condition!\n");
      break;
...
TR::X86FPRemainderRegRegInstruction::X86FPRemainderRegRegInstruction(TR_X86OpCodes op, TR::Node* node,
...
TR::X86FPMemRegInstruction::X86FPMemRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::MemoryReference* mr, TR::Register* sreg, TR::CodeGenerator* cg)
  : TR::X86MemRegInstruction(sreg, mr, op, precedingInstruction, cg)
{}
...
TR::X86FPRegMemInstruction::X86FPRegMemInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::Register* treg, TR::MemoryReference* mr, TR::CodeGenerator* cg)
  : TR::X86RegMemInstruction(mr, treg, op, precedingInstruction, cg)
{}
...
TR::AMD64RegImm64SymInstruction::AMD64RegImm64SymInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
...
TR::Instruction* generateInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86MemInstruction* generateMemInstruction(
  TR::Instruction* precedingInstruction, TR_X86OpCodes op, TR::MemoryReference* mr, TR::CodeGenerator* cg)
{
...
TR::X86MemImmSymInstruction* generateMemImmSymInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr,
  int32_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
{
  return new (cg->trHeapMemory()) TR::X86MemImmSymInstruction(op, node, mr, imm, sr, cg);
}

TR::X86ImmInstruction* generateImmInstruction(TR_X86OpCodes op, TR::Node* node, int32_t imm, TR::CodeGenerator* cg)
{
...
TR::X86RegInstruction* generateRegInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* treg, TR::CodeGenerator* cg)
{
  return new (cg->trHeapMemory()) TR::X86RegInstruction(op, node, treg, cg);
}

TR::X86RegInstruction* generateRegInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* treg, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86LabelInstruction* generateLabelInstruction(
  TR::Instruction* pred, TR_X86OpCodes op, TR::LabelSymbol* sym, TR::CodeGenerator* cg)
{
...
TR::X86LabelInstruction* generateLabelInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::LabelSymbol* sym, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86LabelInstruction* generateLabelInstruction(TR_X86OpCodes opCode, TR::Node* node, TR::LabelSymbol* label,
  TR::Node* glRegDep, List<TR::Register>* popRegisters, bool evaluateGlRegDeps, TR::CodeGenerator* cg)
{
  ...
  TR::X86LabelInstruction* instr = generateLabelInstruction(
    opCode, node, label, generateRegisterDependencyConditions(glRegDep, cg, 0, popRegisters), cg);
...
TR::X86LabelInstruction* generateJumpInstruction(
  TR_X86OpCodes opCode, TR::Node* jumpNode, TR::CodeGenerator* cg, bool needsVMThreadRegister, bool evaluateGlRegDeps)
{
  ...
  (jumpNode->getNumChildren() > 0) ? inst
    = generateLabelInstruction(opCode, jumpNode, destinationLabel, jumpNode->getFirstChild(), 0, evaluateGlRegDeps, cg)
...
TR::X86LabelInstruction* generateConditionalJumpInstruction(
  TR_X86OpCodes opCode, TR::Node* ifNode, TR::CodeGenerator* cg, bool needsVMThreadRegister)
{
  TR::Compilation* comp = cg->comp();
  TR::X86LabelInstruction* inst;
  ...
  if (ifNode->getNumChildren() == 3) {
    ...
    if (!popRegisters.isEmpty()) {
      ...
      for (TR::Register* popRegister = popRegsIt.getFirst(); popRegister != NULL; popRegister = popRegsIt.getNext()) {
        generateFPSTiST0RegRegInstruction(FSTRegReg, ifNode, popRegister, popRegister, cg);
...
TR::X86RegImmInstruction* generateRegImmInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg, int32_t imm,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86RegImmInstruction* generateRegImmInstruction(
  TR::Instruction* instr, TR_X86OpCodes op, TR::Register* treg, int32_t imm, TR::CodeGenerator* cg, int32_t reloKind)
{
...
TR::X86RegImmSymInstruction* generateRegImmSymInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* treg, int32_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
{
...
TR::X86RegMemInstruction* generateRegMemInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg,
  TR::MemoryReference* mr, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86RegMemInstruction* generateRegMemInstruction(
  TR::Instruction* instr, TR_X86OpCodes op, TR::Register* treg, TR::MemoryReference* mr, TR::CodeGenerator* cg)
{
...
TR::X86RegRegInstruction* generateRegRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* treg,
  TR::Register* sreg, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86RegRegInstruction* generateRegRegInstruction(
  TR::Instruction* instr, TR_X86OpCodes op, TR::Register* treg, TR::Register* sreg, TR::CodeGenerator* cg)
{
...
TR::X86RegRegRegInstruction* generateRegRegRegInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* reg1, TR::Register* reg2, TR::Register* reg3, TR::CodeGenerator* cg)
{
  return new (cg->trHeapMemory()) TR::X86RegRegRegInstruction(op, node, reg1, reg2, reg3, cg);
}

TR::X86RegRegRegInstruction* generateRegRegRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* reg1,
...
TR::X86RegRegMemInstruction* generateRegRegMemInstruction(TR_X86OpCodes op, TR::Node* node, TR::Register* reg1,
...
TR::X86MemImmInstruction* generateMemImmInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op,
  TR::MemoryReference* mr, int32_t imm, TR::CodeGenerator* cg, int32_t reloKind)
{
...
TR::X86MemRegInstruction* generateMemRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr,
  TR::Register* sreg, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86ImmSymInstruction* generateImmSymInstruction(TR_X86OpCodes op, TR::Node* node, int32_t imm,
  TR::SymbolReference* sr, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86ImmSnippetInstruction* generateImmSnippetInstruction(
  TR_X86OpCodes op, TR::Node* node, int32_t imm, TR::UnresolvedDataSnippet* snippet, TR::CodeGenerator* cg)
{
...
TR::X86RegMemImmInstruction* generateRegMemImmInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* reg, TR::MemoryReference* mr, int32_t imm, TR::CodeGenerator* cg)
{
...
TR::X86CallMemInstruction* generateCallMemInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr,
  TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
  ...
  TR::Instruction* cursor, TR_RuntimeHelper index, TR::CodeGenerator* cg)
{
  ...
  return new (cg->trHeapMemory())
    TR::X86ImmSymInstruction(cursor, CALLImm4, (uintptrj_t)helperSymRef->getMethodAddress(), helperSymRef, cg);
}
  ...
  TR::Node* node, TR_RuntimeHelper index, TR::RegisterDependencyConditions* dependencies, TR::CodeGenerator* cg)
{
  ...
  return generateImmSymInstruction(
    CALLImm4, node, (uintptrj_t)helperSymRef->getMethodAddress(), helperSymRef, dependencies, cg);
}
...
void TR::X86VFPCallCleanupInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if (kindsToBeAssigned & TR_GPR_Mask) {
    TR_ASSERT(cg()->internalControlFlowNestingDepth() >= 1,
      "TR::X86VFPCallCleanupInstruction %s must only be used inside internal control flow",
...
TR::X86FPRegInstruction* generateFPRegInstruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* reg, TR::CodeGenerator* cg)
{
...
TR::X86FPCompareEvalInstruction* generateFPCompareEvalInstruction(TR_X86OpCodes op, TR::Node* node,
  TR::Register* accRegister, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
{
...
TR::X86FPRemainderRegRegInstruction* generateFPRemainderRegRegInstruction(TR_X86OpCodes op, TR::Node* node,
  TR::Register* treg, TR::Register* sreg, TR::Register* accReg, TR::RegisterDependencyConditions* cond,
  TR::CodeGenerator* cg)
{
...
TR::AMD64RegImm64Instruction* generateRegImm64Instruction(
  TR_X86OpCodes op, TR::Node* node, TR::Register* treg, uint64_t imm, TR::CodeGenerator* cg, int32_t reloKind)
{
...
TR::AMD64Imm64SymInstruction* generateImm64SymInstruction(
  TR::Instruction* precedingInstruction, TR_X86OpCodes op, uint64_t imm, TR::SymbolReference* sr, TR::CodeGenerator* cg)
{
