...
TR::X86FPRemainderRegRegInstruction::X86FPRemainderRegRegInstruction(
    ...
    TR::Register* sreg,
    TR::CodeGenerator* cg)
    : TR::X86FPST0ST1RegRegInstruction(precedingInstruction,
                                       op,
                                       treg,
                                       sreg,
                                       cg) {}
...
TR::Instruction* generateInstruction(TR::Instruction* prev,
                                     TR_X86OpCodes op,
                                     TR::CodeGenerator* cg) {
  return new (cg->trHeapMemory()) TR::Instruction(op, prev, cg);
}

TR::Instruction* generateInstruction(TR_X86OpCodes op,
                                     TR::Node* node,
                                     TR::CodeGenerator* cg) {
...
TR::X86ImmInstruction* generateImmInstruction(TR_X86OpCodes op,
                                              TR::Node* node,
                                              int32_t imm,
                                              TR::CodeGenerator* cg) {
...
TR::X86RegInstruction* generateRegInstruction(TR_X86OpCodes op,
                                              TR::Node* node,
                                              TR::Register* treg,
                                              TR::CodeGenerator* cg) {
...
TR::X86RegImmInstruction* generateRegImmInstruction(TR::Instruction* instr,
                                                    TR_X86OpCodes op,
                                                    TR::Register* treg,
                                                    int32_t imm,
                                                    TR::CodeGenerator* cg,
...
TR::X86RegImmInstruction* generateRegImmInstruction(TR_X86OpCodes op,
                                                    TR::Node* node,
                                                    TR::Register* treg,
                                                    int32_t imm,
                                                    TR::CodeGenerator* cg,
...
TR::X86MemImmInstruction* generateMemImmInstruction(TR_X86OpCodes op,
                                                    TR::Node* node,
                                                    TR::MemoryReference* mr,
                                                    int32_t imm,
                                                    TR::CodeGenerator* cg,
...
TR::AMD64RegImm64Instruction* generateRegImm64Instruction(TR_X86OpCodes op,
                                                          TR::Node* node,
                                                          TR::Register* treg,
                                                          uint64_t imm,
                                                          TR::CodeGenerator* cg,
