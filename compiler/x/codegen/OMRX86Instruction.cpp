...
//
TR::RealRegister*
assign8BitGPRegister(TR::Instruction* instr,
                     TR::Register* virtReg,
                     TR::CodeGenerator* cg)
{
  ...
  if (candidate->getRegisterNumber() > TR::RealRegister::Last8BitGPR) {
    if ((candidate = machine->findBestFreeGPRegister(
           instr, virtReg, TR_ByteReg)) == NULL) {
    ...
    machine->coerceGPRegisterAssignment(
      instr, virtReg, candidate->getRegisterNumber());
...
//
TR::RealRegister*
assignGPRegister(TR::Instruction* instr,
                 TR::Register* virtReg,
...
////////////////////////////////////////////////////////////////////////////////
void
TR::X86LabelInstruction::initialize(TR::LabelSymbol* sym, bool b)
{
  _symbol = sym;
...
TR::X86LabelInstruction::getX86LabelInstruction()
{
  return this;
}

TR::Snippet*
TR::X86LabelInstruction::getSnippetForGC()
{
  return getLabelSymbol() ? getLabelSymbol()->getSnippet() : NULL;
}

void
TR::X86LabelInstruction::assignOutlinedInstructions(
  ...
  TR::X86LabelInstruction* labelInstruction)
{
  ...
  TR_OutlinedInstructions* oi =
    cg()->findOutlinedInstructionsFromLabel(labelInstruction->getLabelSymbol());
  TR_ASSERT(oi,
...
//
void
TR::X86LabelInstruction::addPostDepsToOutlinedInstructionsBranch()
{
...
void
TR::X86LabelInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
...
TR::X86FenceInstruction::X86FenceInstruction(TR_X86OpCodes op,
                                             TR::Node* node,
                                             TR::Node* fenceNode,
                                             TR::CodeGenerator* cg)
  : TR::Instruction(node, op, cg)
...
TR::X86ImmInstruction::getX86ImmInstruction()
{
  return this;
}
#endif
...
TR::Snippet*
TR::X86ImmSnippetInstruction::getSnippetForGC()
{
  ...
  , _targetRegister(reg)
{
  ...
  if (cg->enableRematerialisation() && reg->isDiscardable() &&
    ...
    TR::ClobberingInstruction* clob =
      new (cg->trHeapMemory()) TR::ClobberingInstruction(this, cg->trMemory());
...
TR::X86RegInstruction::getX86RegInstruction()
{
  return this;
}

bool
TR::X86RegInstruction::refsRegister(TR::Register* reg)
{
...
bool
TR::X86RegInstruction::defsRegister(TR::Register* reg)
{
...
bool
TR::X86RegInstruction::usesRegister(TR::Register* reg)
{
  if (reg == getTargetRegister()) {
    return true;
  } else if (getDependencyConditions()) {
...
void
TR::X86RegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if (getDependencyConditions()) {
...
bool
TR::X86RegRegInstruction::refsRegister(TR::Register* reg)
{
...
bool
TR::X86RegRegInstruction::defsRegister(TR::Register* reg)
{
  if ((reg == getTargetRegister() && getOpCode().modifiesTarget()) ||
...
bool
TR::X86RegRegInstruction::usesRegister(TR::Register* reg)
{
...
void
TR::X86RegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if (getDependencyConditions()) {
    if ((cg()->getAssignmentDirection() == cg()->Backward)) {
      getTargetRegister()->block();
...
void
TR::X86RegImmInstruction::adjustVFPState(TR_VFPState* state,
                                         TR::CodeGenerator* cg)
{
...
bool
TR::X86RegRegRegInstruction::refsRegister(TR::Register* reg)
{
  if (reg == getTargetRegister() || reg == getSourceRegister() ||
...
bool
TR::X86RegRegRegInstruction::defsRegister(TR::Register* reg)
{
  if (reg == getTargetRegister() && getOpCode().modifiesTarget()) {
    return true;
  } else if (getDependencyConditions()) {
...
bool
TR::X86RegRegRegInstruction::usesRegister(TR::Register* reg)
{
  if ((reg == getTargetRegister() && getOpCode().usesTarget()) ||
...
void
TR::X86RegRegRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if ((cg()->getAssignmentDirection() == cg()->Backward)) {
    if (getDependencyConditions()) {
      getTargetRegister()->block();
...
void
padUnresolvedReferenceInstruction(TR::Instruction* instr,
                                  TR::MemoryReference* mr,
                                  TR::CodeGenerator* cg)
{
  mr->getUnresolvedDataSnippet()->setDataReferenceInstruction(instr);
  generateBoundaryAvoidanceInstruction(
    TR::X86BoundaryAvoidanceInstruction::unresolvedAtomicRegions,
    8,
    8,
    instr,
    cg);
...
bool
TR::X86MemInstruction::refsRegister(TR::Register* reg)
{
...
bool
TR::X86MemInstruction::defsRegister(TR::Register* reg)
{
  if (getDependencyConditions()) {
    return getDependencyConditions()->defsRegister(reg);
  } else {
...
bool
TR::X86MemInstruction::usesRegister(TR::Register* reg)
{
  if (getMemoryReference()->refsRegister(reg)) {
    return true;
  } else if (getDependencyConditions()) {
...
TR::Snippet*
TR::X86MemInstruction::getSnippetForGC()
{
  return getMemoryReference()->getUnresolvedDataSnippet();
}

void
TR::X86MemInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if (getDependencyConditions()) {
...
void
TR::X86MemTableInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
...
void
TR::X86CallMemInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if ((cg()->getAssignmentDirection() == cg()->Backward)) {
    if (getDependencyConditions()) {
      getMemoryReference()->blockRegisters();
...
TR::X86MemRegInstruction::X86MemRegInstruction(TR_X86OpCodes op,
                                               ...
                                               TR::Register* sreg,
                                               TR::CodeGenerator* cg)
  : TR::X86MemInstruction(mr, node, op, cg, sreg)
  , _sourceRegister(sreg)
{
  useRegister(sreg);
}
...
bool
TR::X86MemRegInstruction::refsRegister(TR::Register* reg)
{
...
bool
TR::X86MemRegInstruction::defsRegister(TR::Register* reg)
{
...
bool
TR::X86MemRegInstruction::usesRegister(TR::Register* reg)
{
  if (getMemoryReference()->refsRegister(reg) || reg == getSourceRegister()) {
    return true;
  } else if (getDependencyConditions()) {
...
void
TR::X86MemRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if ((cg()->getAssignmentDirection() == cg()->Backward)) {
    if (getDependencyConditions()) {
      getSourceRegister()->block();
    ...
    if (kindsToBeAssigned & getSourceRegister()->getKindAsMask()) {
      ...
      if (cg()->enableRematerialisation() &&
        ...
        if (debug("dumpRemat")) {
          diagnostic(
            "---> Deactivating %s discardable register %s at instruction %p\n",
            cg()->getDebug()->toString(
              getSourceRegister()->getRematerializationInfo()),
            cg()->getDebug()->getName(getSourceRegister()),
            this);
        }
...
bool
TR::X86RegMemInstruction::refsRegister(TR::Register* reg)
{
...
bool
TR::X86RegMemInstruction::usesRegister(TR::Register* reg)
{
  if ((reg == getTargetRegister() && getOpCode().usesTarget()) ||
...
TR::Snippet*
TR::X86RegMemInstruction::getSnippetForGC()
{
  return getMemoryReference()->getUnresolvedDataSnippet();
}

void
TR::X86RegMemInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if (getDependencyConditions()) {
    if (cg()->getAssignmentDirection() == cg()->Backward) {
      getTargetRegister()->block();
...
bool
TR::X86RegRegMemInstruction::refsRegister(TR::Register* reg)
{
...
// check refsRegister
bool
TR::X86RegRegMemInstruction::usesRegister(TR::Register* reg)
{
  if (getMemoryReference()->refsRegister(reg) || reg == getTargetRegister() ||
      reg == getSource2ndRegister()) {
    return true;
...
void
TR::X86RegRegMemInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if ((cg()->getAssignmentDirection() == cg()->Backward)) {
    if (getDependencyConditions()) {
      getMemoryReference()->blockRegisters();
...
void
TR::X86FPRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if (kindsToBeAssigned & TR_X87_Mask) {
...
void
TR::X86FPST0ST1RegRegInstruction::assignRegisters(
  TR_RegisterKinds kindsToBeAssigned)
{
  ...
  if (kindsToBeAssigned & TR_X87_Mask) {
    ...
    machine->fpCoerceRegistersToTopOfStack(
      this->getPrev(), targetRegister, sourceRegister, true);
...
void
TR::X86FPSTiST0RegRegInstruction::assignRegisters(
  TR_RegisterKinds kindsToBeAssigned)
{
...
void
TR::X86FPST0STiRegRegInstruction::assignRegisters(
  TR_RegisterKinds kindsToBeAssigned)
{
  ...
  if (kindsToBeAssigned & TR_X87_Mask) {
    ...
    if (result & (kSourceCanBePopped | kTargetCanBePopped)) {
      ...
      if ((result & (kSourceCanBePopped | kTargetCanBePopped)) ==
          (kSourceCanBePopped | kTargetCanBePopped)) {
        machine->fpCoerceRegistersToTopOfStack(
          this->getPrev(), targetRegister, sourceRegister, false);
...
TR_X86OpCodes
getBranchOrSetOpCodeForFPComparison(TR::ILOpCodes cmpOp,
...
void
TR::X86FPRemainderRegRegInstruction::assignRegisters(
  TR_RegisterKinds kindsToBeAssigned)
{
...
void
TR::X86FPMemRegInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if (kindsToBeAssigned & TR_GPR_Mask) {
    getMemoryReference()->assignRegisters(this, cg());
  }
...
void
TR::X86FPRegMemInstruction::assignRegisters(TR_RegisterKinds kindsToBeAssigned)
{
  if (kindsToBeAssigned & TR_GPR_Mask) {
    getMemoryReference()->assignRegisters(this, cg());
  }
...
void
TR::X86VFPDedicateInstruction::assignRegisters(
  TR_RegisterKinds kindsToBeAssigned)
{
  if (kindsToBeAssigned & getTargetRegister()->getKindAsMask()) {
...
void
TR::X86VFPReleaseInstruction::assignRegisters(
  TR_RegisterKinds kindsToBeAssigned)
{
  if (kindsToBeAssigned &
...
void
TR::X86BoundaryAvoidanceInstruction::assignRegisters(
  TR_RegisterKinds kindsToBeAssigned)
{
...
generateMemInstruction(TR_X86OpCodes op,
                       TR::Node* node,
                       TR::MemoryReference* mr,
                       TR::CodeGenerator* cg)
{
...
TR::X86MemInstruction*
generateMemInstruction(TR::Instruction* precedingInstruction,
                       TR_X86OpCodes op,
                       TR::MemoryReference* mr,
                       TR::CodeGenerator* cg)
{
...
generateMemTableInstruction(TR_X86OpCodes op,
                            TR::Node* node,
                            TR::MemoryReference* mr,
                            ncount_t numEntries,
                            TR::CodeGenerator* cg)
...
TR::X86ImmInstruction*
generateImmInstruction(TR::Instruction* prev,
                       TR_X86OpCodes op,
                       int32_t imm,
                       TR::CodeGenerator* cg)
{
...
TR::X86RegInstruction*
generateRegInstruction(TR::Instruction* prev,
                       TR_X86OpCodes op,
                       TR::Register* reg1,
                       TR::CodeGenerator* cg)
{
...
{
  return new (cg->trHeapMemory())
    TR::X86PatchableCodeAlignmentInstruction(atomicRegions, patchableCode, cg);
}
...
generatePaddingInstruction(uint8_t length,
                           TR::Node* node,
                           TR::CodeGenerator* cg)
{
...
generatePaddingSnippetInstruction(uint8_t length,
                                  TR::Node* node,
                                  TR::CodeGenerator* cg)
{
  return new (cg->trHeapMemory())
...
generateAlignmentInstruction(TR::Node* node,
                             uint8_t boundary,
                             TR::CodeGenerator* cg)
{
  return new (cg->trHeapMemory())
...
TR::X86LabelInstruction*
generateJumpInstruction(TR_X86OpCodes opCode,
                        TR::Node* jumpNode,
                        TR::CodeGenerator* cg,
...
TR::X86LabelInstruction*
generateConditionalJumpInstruction(TR_X86OpCodes opCode,
                                   TR::Node* ifNode,
                                   TR::CodeGenerator* cg,
                                   bool needsVMThreadRegister)
{
  ...
  if (ifNode->getNumChildren() == 3) {
    ...
    inst = generateLabelInstruction(
      opCode, ifNode, destinationLabel, glRegDep, &popRegisters, cg);
    ...
    if (!popRegisters.isEmpty()) {
      ...
      for (TR::Register* popRegister = popRegsIt.getFirst();
        ...
        generateFPSTiST0RegRegInstruction(
          FSTRegReg, ifNode, popRegister, popRegister, cg);
...
generateFenceInstruction(TR_X86OpCodes op,
                         TR::Node* node,
                         TR::Node* fenceNode,
                         TR::CodeGenerator* cg)
{
...
generateVirtualGuardNOPInstruction(TR::Node* node,
...
TR::X86VirtualGuardNOPInstruction*
generateVirtualGuardNOPInstruction(TR::Instruction* i,
                                   TR::Node* node,
                                   TR_VirtualGuardSite* site,
                                   TR::RegisterDependencyConditions* deps,
                                   TR::LabelSymbol* label,
...
bool
TR::X86VirtualGuardNOPInstruction::usesRegister(TR::Register* reg)
{
...
bool
TR::X86VirtualGuardNOPInstruction::defsRegister(TR::Register* reg)
{
  return usesRegister(reg);
}
bool
TR::X86VirtualGuardNOPInstruction::refsRegister(TR::Register* reg)
{
  return usesRegister(reg);
}
#endif
...
TR::X86RegImmInstruction*
generateRegImmInstruction(TR::Instruction* instr,
                          TR_X86OpCodes op,
                          TR::Register* treg,
                          int32_t imm,
                          TR::CodeGenerator* cg,
...
generateRegImmSymInstruction(TR_X86OpCodes op,
                             TR::Node* node,
                             TR::Register* treg,
                             int32_t imm,
                             TR::SymbolReference* sr,
...
TR::X86RegMemInstruction*
generateRegMemInstruction(TR::Instruction* instr,
                          TR_X86OpCodes op,
                          TR::Register* treg,
                          TR::MemoryReference* mr,
                          TR::CodeGenerator* cg)
...
generateMemImmInstruction(TR_X86OpCodes op,
                          TR::Node* node,
                          TR::MemoryReference* mr,
                          int32_t imm,
                          TR::CodeGenerator* cg,
...
generateImmSnippetInstruction(TR_X86OpCodes op,
                              TR::Node* node,
                              int32_t imm,
                              TR::UnresolvedDataSnippet* snippet,
                              TR::CodeGenerator* cg)
...
generateRegMemImmInstruction(TR_X86OpCodes op,
                             TR::Node* node,
                             TR::Register* reg,
                             TR::MemoryReference* mr,
                             int32_t imm,
...
generateRegRegImmInstruction(TR_X86OpCodes op,
                             TR::Node* node,
                             TR::Register* treg,
                             TR::Register* sreg,
                             int32_t imm,
...
TR::X86ImmSymInstruction*
generateHelperCallInstruction(TR::Instruction* cursor,
                              ...
                              TR::CodeGenerator* cg)
{
  ...
  return new (cg->trHeapMemory())
    TR::X86ImmSymInstruction(cursor,
                             CALLImm4,
...
TR::X86ImmSymInstruction*
generateHelperCallInstruction(TR::Node* node,
                              TR_RuntimeHelper index,
                              ...
                              TR::CodeGenerator* cg)
{
  TR::SymbolReference* helperSymRef =
    cg->symRefTab()->findOrCreateRuntimeHelper(index, false, false, false);
  cg->resetIsLeafMethod();
  return generateImmSymInstruction(CALLImm4,
                                   node,
                                   (uintptrj_t)helperSymRef->getMethodAddress(),
                                   helperSymRef,
                                   dependencies,
...
void
TR::X86VFPCallCleanupInstruction::assignRegisters(
  TR_RegisterKinds kindsToBeAssigned)
{
  if (kindsToBeAssigned & TR_GPR_Mask) {
...
TR::X86VFPSaveInstruction*
generateVFPSaveInstruction(TR::Node* node, TR::CodeGenerator* cg)
{
...
TR::X86VFPReleaseInstruction*
generateVFPReleaseInstruction(
  TR::Instruction* precedingInstruction,
  TR::X86VFPDedicateInstruction* dedicateInstruction,
  TR::CodeGenerator* cg)
{
  return new (cg->trHeapMemory())
    TR::X86VFPReleaseInstruction(precedingInstruction, dedicateInstruction, cg);
}
...
TR::X86VFPCallCleanupInstruction*
generateVFPCallCleanupInstruction(int32_t adjustment,
                                  TR::Node* node,
                                  TR::CodeGenerator* cg)
{
  return new (cg->trHeapMemory())
...
generateFPRegInstruction(TR_X86OpCodes op,
                         TR::Node* node,
                         TR::Register* reg,
                         TR::CodeGenerator* cg)
{
...
generateFPST0ST1RegRegInstruction(TR_X86OpCodes op,
                                  TR::Node* node,
                                  TR::Register* treg,
                                  TR::Register* sreg,
                                  TR::CodeGenerator* cg)
...
generateFPST0STiRegRegInstruction(TR_X86OpCodes op,
                                  TR::Node* node,
                                  TR::Register* treg,
                                  TR::Register* sreg,
                                  TR::CodeGenerator* cg)
...
generateFPSTiST0RegRegInstruction(TR_X86OpCodes op,
                                  TR::Node* node,
                                  TR::Register* treg,
                                  TR::Register* sreg,
                                  TR::CodeGenerator* cg,
...
generateFPArithmeticRegRegInstruction(TR_X86OpCodes op,
                                      TR::Node* node,
                                      TR::Register* treg,
                                      TR::Register* sreg,
                                      TR::CodeGenerator* cg)
...
generateFPCompareRegRegInstruction(TR_X86OpCodes op,
                                   TR::Node* node,
                                   TR::Register* treg,
                                   TR::Register* sreg,
                                   TR::CodeGenerator* cg)
...
generateFPCompareEvalInstruction(TR_X86OpCodes op,
                                 TR::Node* node,
                                 TR::Register* accRegister,
                                 TR::CodeGenerator* cg)
{
...
generateFPRemainderRegRegInstruction(TR_X86OpCodes op,
                                     TR::Node* node,
                                     TR::Register* treg,
                                     TR::Register* sreg,
                                     TR::CodeGenerator* cg)
...
{
  return new (cg->trHeapMemory())
    TR::X86FPRemainderRegRegInstruction(op, node, treg, sreg, accReg, cond, cg);
}

TR::X86FPMemRegInstruction*
generateFPMemRegInstruction(TR_X86OpCodes op,
                            TR::Node* node,
                            TR::MemoryReference* mr,
                            TR::Register* sreg,
                            TR::CodeGenerator* cg)
...
generateFPRegMemInstruction(TR_X86OpCodes op,
                            TR::Node* node,
                            TR::Register* treg,
                            TR::MemoryReference* mr,
                            TR::CodeGenerator* cg)
...
{
  return new (cg->trHeapMemory())
    TR::AMD64RegImm64SymInstruction(precedingInstruction, op, reg, imm, sr, cg);
}
