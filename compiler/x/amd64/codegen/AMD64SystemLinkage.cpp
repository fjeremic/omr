    ...
    : TR::AMD64SystemLinkage(cg)
{
    ...
    //
    _properties._properties = EightBytePointers | EightByteParmSlots | CallerCleanup | IntegersInRegisters | LongsInRegisters | FloatsInRegisters | LinkageRegistersAssignedByCardinalPosition | CallerFrameAllocatesSpaceForLinkageRegs | ReservesOutgoingArgsInPrologue;
    ...
    : TR::AMD64SystemLinkage(cg)
{
    ...
    // ReservesOutgoingArgsInPrologue is needed.
    //
    _properties._properties = EightBytePointers | EightByteParmSlots | CallerCleanup | IntegersInRegisters | LongsInRegisters | FloatsInRegisters | ReservesOutgoingArgsInPrologue;
...
void TR::AMD64ABILinkage::mapIncomingParms(
