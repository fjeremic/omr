...
class AMD64Win64FastCallLinkage : public virtual TR::AMD64SystemLinkage {
  ...
  // be preserved by called function. RSI                       Nonvolatile   Must be preserved by called function. RBX
  // Nonvolatile   Must be preserved by called function. RBP                       Nonvolatile   Can be used as a frame
  // pointer. Must be preserved by called function. RSP                       Nonvolatile   Stack Pointer. XMM0 Volatile
  // First FP argument. XMM1                      Volatile      Second FP argument. XMM2                      Volatile
  // Third FP argument. XMM3                      Volatile      Fourth FP argument. XMM4:XMM5                 Volatile
  // Must be preserved as required by caller. XMM6:XMM15 (low 64 bits)  Nonvolatile   Must be preserved by called
  // function. XMM6:XMM15 (high 64 bits) Volatile      Must be preserved as required by caller.
  //
