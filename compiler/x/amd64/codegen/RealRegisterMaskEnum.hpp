...
noRegMask = 0x00000000,
  ...
  xmm8Mask = 0x00000100 << XMMRMaskOffset, xmm9Mask = 0x00000200 << XMMRMaskOffset,
  xmm10Mask = 0x00000400 << XMMRMaskOffset, xmm11Mask = 0x00000800 << XMMRMaskOffset,
  xmm12Mask = 0x00001000 << XMMRMaskOffset, xmm13Mask = 0x00002000 << XMMRMaskOffset,
  xmm14Mask = 0x00004000 << XMMRMaskOffset, xmm15Mask = 0x00008000 << XMMRMaskOffset,
