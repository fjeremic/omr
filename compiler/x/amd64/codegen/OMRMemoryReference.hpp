...
public:
  ...
  void setPreferRIPRelative(bool b)
  {
    _preferRIPRelative = b;
  }
...
public: // Constructors
  ...
  MemoryReference(
    TR::SymbolReference* symRef, intptrj_t displacement, TR::CodeGenerator* cg, TR_ScratchRegisterManager* srm = NULL);
...
#else
  bool needsAddressLoadInstruction(intptrj_t rip)
  {
    return false;
  }
  void finishInitialization(TR::CodeGenerator* cg, TR_ScratchRegisterManager* srm) {}
