                                             ...
                                             TR::CodeGenerator* cg)
{
  ...
  if (node->getFirstChild()->getOpCode().isLoadConst()) {
    ...
    generateRegImmInstruction(
      MOV8RegImm4, node, targetRegister, node->getFirstChild()->getInt(), cg);
    ...
    return TR::TreeEvaluator::conversionAnalyser(
      node, regMemOpCode, regRegOpCode, cg);
  }
}
                                              ...
                                              TR::CodeGenerator* cg)
{
  if (node->getFirstChild()->getOpCode().isLoadConst()) {
    ...
    generateRegImmInstruction(MOV4RegImm4,
                              node,
                              targetRegister,
...
{
  return TR::TreeEvaluator::conversionAnalyser(
    node, MOVSXReg8Mem1, MOVSXReg8Reg1, cg);
}
...
{
  return TR::TreeEvaluator::conversionAnalyser(
    node, MOVZXReg8Mem1, MOVZXReg8Reg1, cg);
}
...
{
  return TR::TreeEvaluator::conversionAnalyser(
    node, MOVSXReg8Mem2, MOVSXReg8Reg2, cg);
}
...
{
  return TR::TreeEvaluator::conversionAnalyser(
    node, MOVZXReg8Mem2, MOVZXReg8Reg2, cg);
}
                                              ...
                                              TR::CodeGenerator* cg)
{
  ...
  generateRegRegInstruction(
    MOVSXReg4Reg1, node, isNotEqualReg, isNotEqualReg, cg);
...
{
  return l2fd(node,
              toRealRegister(cg->allocateSinglePrecisionRegister(TR_FPR)),
              CVTSI2SSRegMem8,
              CVTSI2SSRegReg8,
              cg);
}
...
{
  return l2fd(node,
              toRealRegister(cg->allocateRegister(TR_FPR)),
              CVTSI2SDRegMem8,
              CVTSI2SDRegReg8,
              cg);
}
