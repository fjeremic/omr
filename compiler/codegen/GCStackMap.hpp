...
public:
  ...
  {
    return _pinningArrayPtr;
  }
  void setPinningArrayPointer(TR::AutomaticSymbol* pinningArrayPointer)
  {
    _pinningArrayPtr = pinningArrayPointer;
  }
  TR::AutomaticSymbol* getInternalPointerAuto()
  {
    return _internalPtrAuto;
  }
  void setInternalPointerAuto(TR::AutomaticSymbol* internalPointerAuto)
  {
    TR_ASSERT(!internalPointerAuto || internalPointerAuto->isInternalPointerAuto(), "should be internal pointerauto");
    _internalPtrAuto = internalPointerAuto;
  }
  int32_t getInternalPtrRegNum()
  {
    return _internalPtrRegNum;
  }
...
public:
  ...
  int32_t getNumDistinctPinningArrays()
  {
    return _numDistinctPinningArrays;
  }
  void setNumDistinctPinningArrays(int32_t n)
  {
    _numDistinctPinningArrays = n;
  }

  int32_t getNumInternalPointers()
  {
    return _numInternalPtrs;
  }
  void setNumInternalPointers(int32_t n)
  {
    _numInternalPtrs = n;
  }
...
public:
  ...
  int32_t getMapSizeInBytes()
  {
    return (_numberOfSlotsMapped + 7) >> 3;
  }

  uint8_t* getLiveMonitorBits()
  {
    return _liveMonitorBits;
  }

  uint32_t getLowestCodeOffset()
  {
    return _lowestCodeOffset;
  }
  uint32_t setLowestCodeOffset(uint32_t n)
  {
    return (_lowestCodeOffset = n);
  }

  TR_ByteCodeInfo& getByteCodeInfo()
  {
    return _byteCodeInfo;
  }
  void setByteCodeInfo(TR_ByteCodeInfo bci)
  {
    _byteCodeInfo = bci;
  }
  ...
  void setRegisterBits(uint32_t bits)
  {
    _registerMap.setRegisterBits(bits);
  }
  void resetRegistersBits(uint32_t bits)
  {
    _registerMap.resetRegisterBits(bits);
  }
  uint32_t getRegisterMap()
  {
    return _registerMap.getMap();
  }
