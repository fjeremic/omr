...
public:
  ...
  TR_RematerializationInfo(TR::Instruction* instr, TR_RematerializableTypes type, intptrj_t constant)
    : _definition(instr)
    , _type(type)
    , _constant(constant)
    , _NodeForwardDeclinition(NULL)
  ...
  intptrj_t getConstant()
  {
    return _constant;
  }
  intptrj_t setConstant(intptrj_t c)
  {
    return (_constant = c);
  }
  ...
  TR::Node* getNodeForwardDeclinition()
  {
    return _NodeForwardDeclinition;
  }
  ...
  TR_RematerializableTypes getDataType()
  {
    return _type;
  }
  ...
  bool isIndirect()
  {
    return _flags.testAny(IsIndirect);
  }
  void setIndirect()
  {
    _flags.set(IsIndirect);
  }

  bool isStore()
  {
    return _flags.testAny(IsStore);
  }
  void setStore()
  {
    _flags.set(IsStore);
  ...
  bool isActive()
  {
    return _flags.testAny(IsActive);
  }
  void setActive()
  {
    _flags.set(IsActive);
  ...
  void resetActive()
  {
    _flags.reset(IsActive);
  }

  bool isRematerialized()
  {
    return _flags.testAny(IsRematerialized);
  }
  void setRematerialized()
  {
    _flags.set(IsRematerialized);
  }
  void resetRematerialized()
  {
    _flags.reset(IsRematerialized);
  }
#if defined(DEBUG)
