...
public:
   ...
   *    binary encoding phase has completed.  Linkage implementors should
   ...
   * point.
   *
   *    If this API returns 0 then `entryPointFromInterpetedMethod` must also
   * return 0.
   *
   ...
   * point.
   *
   *    If this API returns 0 then `entryPointFromCompiledMethod` must also
   * return 0.
   *
