...
public:
  ...
  void setNodeCount(int32_t n)
  {
    _numOwningNodes = n;
  }
  int32_t incNodeCount()
  {
    return ++_numOwningNodes;
  }
  ...
  void addByteRegisterAssociation()
  {
    _association |= 0x80000000;
  }

  TR_LiveRegisterInfo* getNext()
  {
    return _next;
  }
  TR_LiveRegisterInfo* getPrev()
  {
    return _prev;
  }

  void setNext(TR_LiveRegisterInfo* n)
  {
    _next = n;
  }
  void setPrev(TR_LiveRegisterInfo* p)
  {
    _prev = p;
  }
...
#if defined(TR_TARGET_POWER)
  uint64_t getInterference()
  {
    return _interference;
  }
  void addInterference(uint64_t i)
  {
    _interference |= i;
  }
#else
  ...
  void addInterference(uint32_t i)
  {
    _interference |= i;
  }
#endif
...
public:
  ...
  TR_LiveRegisterInfo* getFirstLiveRegister()
  {
    return _head;
  }

  int32_t getNumberOfLiveRegisters()
  {
    return _numLiveRegisters;
  }
  int32_t decNumberOfLiveRegisters()
  {
    return _numLiveRegisters--;
  }
