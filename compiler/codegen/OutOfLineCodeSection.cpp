...
void
TR_OutOfLineCodeSection::swapInstructionListsWithCompilation()
{
  TR::Instruction* temp;
...
//
void
TR_OutOfLineCodeSection::preEvaluatePersistentHelperArguments()
{
  TR_ASSERT(_callNode,
...
void
TR_OutOfLineCodeSection::evaluateNodesWithFutureUses(TR::Node* node)
{
