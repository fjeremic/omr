...
bool OMR::TreeEvaluator::instanceOfOrCheckCastNeedSuperTest(TR::Node* node, TR::CodeGenerator* cg)
{
  ...
  if (castClassSymRef->isUnresolved()) {
    ...
    //
    if (castClassSym && (clazz = (TR_OpaqueClassBlock*)castClassSym->getStaticAddress())
      && !TR::Compiler->cls.isClassArray(cg->comp(), clazz) && !TR::Compiler->cls.isInterfaceClass(cg->comp(), clazz)
...
bool OMR::TreeEvaluator::nodeIsIAddOverflowCheck(TR::Node* node, TR_ArithmeticOverflowCheckNodes* u)
{
  ...
  static TR_Pattern* pattern = pb.choice(pb(TR::ificmpge), pb(TR::ificmplt),
    pb.children(
      pb(TR::iand,
        pb(TR::ixor, pb(TR::iadd, u, u->operationNode, pb(u, u->leftChild), pb(u, u->rightChild)), pb(u, u->leftChild)),
...
bool OMR::TreeEvaluator::nodeIsISubOverflowCheck(TR::Node* node, TR_ArithmeticOverflowCheckNodes* u)
{
  ...
  static TR_Pattern* pattern = pb.choice(pb(TR::ificmpge), pb(TR::ificmplt),
    pb.children(
      pb(TR::iand,
        pb(TR::ixor, pb(TR::isub, u, u->operationNode, pb(u, u->leftChild), pb(u, u->rightChild)), pb(u, u->leftChild)),
...
bool OMR::TreeEvaluator::nodeIsLAddOverflowCheck(TR::Node* node, TR_ArithmeticOverflowCheckNodes* u)
{
  ...
  static TR_Pattern* pattern = pb.choice(pb(TR::iflcmpge), pb(TR::iflcmplt),
    pb.children(
      pb(TR::land,
        pb(TR::lxor, pb(TR::ladd, u, u->operationNode, pb(u, u->leftChild), pb(u, u->rightChild)), pb(u, u->leftChild)),
...
bool OMR::TreeEvaluator::nodeIsLSubOverflowCheck(TR::Node* node, TR_ArithmeticOverflowCheckNodes* u)
{
  ...
  static TR_Pattern* pattern = pb.choice(pb(TR::iflcmpge), pb(TR::iflcmplt),
    pb.children(
      pb(TR::land,
        pb(TR::lxor, pb(TR::lsub, u, u->operationNode, pb(u, u->leftChild), pb(u, u->rightChild)), pb(u, u->leftChild)),
  ...
  if (node->getFutureUseCount() > 0) {
    ...
    if (actualLoadOrStoreChild->getOpCode().isStore() || actualLoadOrStoreChild->getOpCode().isLoadConst()
      ...
      if (comp->getOption(TR_TraceCG)) {
        traceMsg(comp,
          "avoiding escaping commoned subtree %p [RealLoad/Store: %p], but processing its children: node is ", node,
