...
bool OMR::TreeEvaluator::instanceOfOrCheckCastNeedSuperTest(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    if (!TR::TreeEvaluator::isStaticClassSymRef(castClassSymRef)) {
        ...
        if (cg->supportsInliningOfIsInstance() && node->getOpCodeValue() == TR:: instanceof && node->getSecondChild()->getOpCodeValue() != TR::loadaddr)
            return true;
        else
            return false;
    }
    ...
    if (castClassSymRef->isUnresolved()) {
        ...
        //
        if (castClassSym && (clazz = (TR_OpaqueClassBlock*)castClassSym->getStaticAddress()) && !TR::Compiler->cls.isClassArray(cg->comp(), clazz) && !TR::Compiler->cls.isInterfaceClass(cg->comp(), clazz) && !TR::Compiler->cls.isClassFinal(cg->comp(), clazz) && helperSym->preservesAllRegisters() && !cg->comp()->getOption(TR_OptimizeForSpace))
            return true;
    }
    return false;
}
...
bool OMR::TreeEvaluator::nodeIsIAddOverflowCheck(TR::Node* node, TR_ArithmeticOverflowCheckNodes* u)
{
    ...
    static TR_Pattern* pattern = pb.choice(pb(TR::ificmpge), pb(TR::ificmplt), pb.children(pb(TR::iand, pb(TR::ixor, pb(TR::iadd, u, u->operationNode, pb(u, u->leftChild), pb(u, u->rightChild)), pb(u, u->leftChild)), pb(TR::ixor, pb(u, u->operationNode), pb(u, u->rightChild))), pb.iconst(0)));
...
bool OMR::TreeEvaluator::nodeIsISubOverflowCheck(TR::Node* node, TR_ArithmeticOverflowCheckNodes* u)
{
    ...
    TR_PatternBuilder pb(comp);
    static TR_Pattern* pattern = pb.choice(pb(TR::ificmpge), pb(TR::ificmplt), pb.children(pb(TR::iand, pb(TR::ixor, pb(TR::isub, u, u->operationNode, pb(u, u->leftChild), pb(u, u->rightChild)), pb(u, u->leftChild)), pb(TR::ixor, pb(u, u->leftChild), pb(u, u->rightChild))), pb.iconst(0)));
    return pattern->matches(node, (TR::Node**)u, comp);
}
...
bool OMR::TreeEvaluator::nodeIsLAddOverflowCheck(TR::Node* node, TR_ArithmeticOverflowCheckNodes* u)
{
    ...
    TR_PatternBuilder pb(comp);
    static TR_Pattern* pattern = pb.choice(pb(TR::iflcmpge), pb(TR::iflcmplt), pb.children(pb(TR::land, pb(TR::lxor, pb(TR::ladd, u, u->operationNode, pb(u, u->leftChild), pb(u, u->rightChild)), pb(u, u->leftChild)), pb(TR::lxor, pb(u, u->operationNode), pb(u, u->rightChild))), pb.lconst(0)));
    return pattern->matches(node, (TR::Node**)u, comp);
}
...
bool OMR::TreeEvaluator::nodeIsLSubOverflowCheck(TR::Node* node, TR_ArithmeticOverflowCheckNodes* u)
{
    ...
    TR_PatternBuilder pb(comp);
    static TR_Pattern* pattern = pb.choice(pb(TR::iflcmpge), pb(TR::iflcmplt), pb.children(pb(TR::land, pb(TR::lxor, pb(TR::lsub, u, u->operationNode, pb(u, u->leftChild), pb(u, u->rightChild)), pb(u, u->leftChild)), pb(TR::lxor, pb(u, u->leftChild), pb(u, u->rightChild))), pb.lconst(0)));
    return pattern->matches(node, (TR::Node**)u, comp);
}
...
void OMR::TreeEvaluator::evaluateNodesWithFutureUses(TR::Node* node, TR::CodeGenerator* cg)
{
    ...
    if (node->getFutureUseCount() > 0) {
        ...
        if (actualLoadOrStoreChild->getOpCode().isStore() || actualLoadOrStoreChild->getOpCode().isLoadConst() || actualLoadOrStoreChild->getOpCode().isArrayRef() || (actualLoadOrStoreChild->getOpCode().isLoad() && actualLoadOrStoreChild->getSymbolReference() && (actualLoadOrStoreChild->getSymbolReference()->getSymbol()->isArrayShadowSymbol() || actualLoadOrStoreChild->getSymbolReference()->getSymbol()->isArrayletShadowSymbol()))) {
