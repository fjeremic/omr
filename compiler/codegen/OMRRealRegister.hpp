...
public:
  ...
  bool getIsFreeOnExit()
  {
    return _realRegFlags.testAny(isFreeOnExit);
  }
  void setIsFreeOnExit(bool b = true)
  {
    _realRegFlags.set(isFreeOnExit, b);
  }

  bool getIsAssignedOnce()
  {
    return _realRegFlags.testAny(isAssignedOnce);
  }
  ...
  RegMask getRealRegisterMask()
  {
    return _registerMask;
  }
  RegMask setRealRegisterMask(RegMask m)
  {
    return _registerMask = m;
  }
  ...
  RegNum setRegisterNumber(RegNum rn)
  {
    return _registerNumber = rn;
  }
