...
void OMR::CodeGenerator::freeSpill(TR_BackingStore* spill,
                                   int32_t dataSize,
                                   int32_t offset) {
...
void OMR::CodeGenerator::processReference(TR::Node* reference,
                                          TR::Node* parent,
                                          TR::TreeTop* treeTop) {
...
void OMR::CodeGenerator::simulateMemoryReference(
    TR_SimulatedMemoryReference* memref,
    TR::Node* node,
    TR_RegisterPressureState* state,
    TR_RegisterPressureSummary* summary) {
...
void OMR::CodeGenerator::getNumberOfTemporaryRegistersUsedByCall(
    TR::Node* node,
    TR_RegisterPressureState* state,
    uint32_t& numGPRTemporaries,
    uint32_t& numFPRTemporaries,
