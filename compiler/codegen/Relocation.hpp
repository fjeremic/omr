...
class LabelRelative12BitRelocation : public TR::LabelRelocation {
 ...
 public:
  ...
  LabelRelative12BitRelocation(uint8_t* p,
                               TR::LabelSymbol* l,
...
class LabelRelative16BitRelocation : public TR::LabelRelocation {
 ...
 public:
  ...
  LabelRelative16BitRelocation(uint8_t* p,
                               TR::LabelSymbol* l,
                               int8_t divisor,
...
class LoadLabelRelative16BitRelocation : public TR::Relocation {
 ...
 public:
  ...
  LoadLabelRelative16BitRelocation(TR::Instruction* i,
                                   TR::LabelSymbol* start,
                                   TR::LabelSymbol* end,
                                   int32_t delta)
      : TR::Relocation(NULL),
        _lastInstruction(i),
...
class LoadLabelRelative32BitRelocation : public TR::Relocation {
 ...
 public:
  ...
  LoadLabelRelative32BitRelocation(TR::Instruction* i,
                                   TR::LabelSymbol* start,
                                   TR::LabelSymbol* end,
                                   int32_t delta)
      : TR::Relocation(NULL),
...
class IteratedExternalRelocation
 ...
 public:
  ...
  IteratedExternalRelocation(uint8_t* target,
