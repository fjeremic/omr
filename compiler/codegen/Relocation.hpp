...
#define AOTcgDiag0(comp, s) \
  if (AOTcgDiagOn) dumpOptDetails(comp, s)
#define AOTcgDiag1(comp, s, p1) \
  if (AOTcgDiagOn) dumpOptDetails(comp, s, p1)
#define AOTcgDiag2(comp, s, p1, p2) \
  if (AOTcgDiagOn) dumpOptDetails(comp, s, p1, p2)
#define AOTcgDiag3(comp, s, p1, p2, p3) \
  if (AOTcgDiagOn) dumpOptDetails(comp, s, p1, p2, p3)
#define AOTcgDiag4(comp, s, p1, p2, p3, p4) \
  if (AOTcgDiagOn) dumpOptDetails(comp, s, p1, p2, p3, p4)
#define AOTcgDiag5(comp, s, p1, p2, p3, p4, p5) \
  if (AOTcgDiagOn) dumpOptDetails(comp, s, p1, p2, p3, p4, p5)
#define AOTcgDiag6(comp, s, p1, p2, p3, p4, p5, p6) \
  if (AOTcgDiagOn) dumpOptDetails(comp, s, p1, p2, p3, p4, p5, p6)
#else
...
class IteratedExternalRelocation
 ...
 public:
  ...
  TR_ExternalRelocationTargetKind setTargetKind(
      TR_ExternalRelocationTargetKind k) {
    return (_kind = k);
  }
