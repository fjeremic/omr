...
#define ELFClass ELFCLASS32;
   ...
   */
  void initializeTextSection(uint32_t shName,
   ...
   */
  void initializeDynSymSection(uint32_t shName,
                               ELFOffset shOffset,
                               uint32_t shSize,
                               uint32_t shLink);
   ...
   * @param[in] shSize the section header size
   */
  void initializeStrTabSection(uint32_t shName,
                               ELFOffset shOffset,
                               uint32_t shSize);
   ...
   * @param[in] shSize the section header size
   */
  void initializeDynStrSection(uint32_t shName,
                               ELFOffset shOffset,
                               uint32_t shSize);
   ...
   * @param[in] shSize the section header size
   */
  void initializeRelaSection(uint32_t shName,
                             ELFOffset shOffset,
                             uint32_t shSize);
