...
public:
  ...
  uint32_t getPrePrologueSize()
  {
    return _prePrologueSize;
  }
  uint32_t setPrePrologueSize(uint32_t s)
  {
    return (_prePrologueSize = s);
  }

  TR_BitVector* getLiveLocals()
  {
    return _liveLocals;
  }
  TR_BitVector* setLiveLocals(TR_BitVector* v)
  {
    return (_liveLocals = v);
  }
  ...
  TR::Block* getCurrentEvaluationBlock()
  {
    return _currentEvaluationBlock;
  }
  ...
  int32_t getNextAvailableBlockIndex()
  {
    return -1;
  }
  ...
  bool buildInterpreterEntryPoint()
  {
    return false;
  }
  ...
  bool supportsUnneededLabelRemoval()
  {
    return true;
  }
  ...
  TR::CodeGenPhase& getCodeGeneratorPhase()
  {
    return _codeGenPhase;
  }
  ...
  bool materializesHeapBase()
  {
    return true;
  }
  bool canFoldLargeOffsetInAddressing()
  {
    return false;
  }
  ...
  TR::Instruction* generateDebugCounter(const char* name, TR::Register* deltaReg,
    TR::RegisterDependencyConditions& cond, int8_t fidelity = TR::DebugCounter::Undetermined, int32_t staticDelta = 1,
  ...
  TR::Linkage* getLinkage()
  {
    return _bodyLinkage;
  }
  TR::Linkage* setLinkage(TR::Linkage* l)
  {
    return (_bodyLinkage = l);
  }
  ...
  //
  bool getGRACompleted()
  {
    return _flags4.testAny(GRACompleted);
  }
  void setGRACompleted()
  {
    _flags4.set(GRACompleted);
  }
  ...
  void setSupportsProfiledInlining()
  {
    _flags4.set(SupportsProfiledInlining);
  }
  bool supportsInliningOfIsInstance()
  {
    return false;
  }
  bool supportsPassThroughCopyToNewVirtualRegister()
  {
    return false;
  }
  ...
  //
  int16_t getMinShortForLongCompareNarrower()
  {
    return SHRT_MIN;
  }
  int8_t getMinByteForLongCompareNarrower()
  {
    return SCHAR_MIN;
  }
  ...
  bool supportsNegativeFusedMultiplyAdd()
  {
    return false;
  }
  ...
  bool canBeAffectedByStoreTagStalls()
  {
    return false;
  }
  ...
  bool codegenSupportsUnsignedIntegerDivide()
  {
    return false;
  }
  ...
  //
  bool getSupportsNewObjectAlignment()
  {
    return false;
  }
  bool getSupportsTenuredObjectAlignment()
  {
    return false;
  }
  ...
  TR_GCStackMap* getMethodStackMap()
  {
    return _methodStackMap;
  }
  ...
  // IA32 only?
  uint32_t getRegisterMapInfoBitsMask()
  {
    return 0;
  }
  ...
  //
  uint32_t getLargestOutgoingArgSize()
  {
    return _largestOutgoingArgSize;
  }
  ...
  int32_t getFrameSizeInBytes()
  {
    return _frameSizeInBytes;
  }
  int32_t setFrameSizeInBytes(int32_t fs)
  {
    return (_frameSizeInBytes = fs);
  }

  int32_t getRegisterSaveDescription()
  {
    return _registerSaveDescription;
  }
  ...
  TR_InterferenceGraph* getLocalsIG()
  {
    return _localsIG;
  }
  ...
  bool isLeafMethod()
  {
    return _flags1.testAny(IsLeafMethod);
  }
  void setIsLeafMethod()
  {
    _flags1.set(IsLeafMethod);
  }
  void resetIsLeafMethod()
  {
    _flags1.reset(IsLeafMethod);
  }
  ...
  uint32_t getEstimatedCodeLength()
  {
    return _estimatedCodeLength;
  }
  ...
  uint8_t* getBinaryBufferStart()
  {
    return _binaryBufferStart;
  }
  uint8_t* setBinaryBufferStart(uint8_t* b)
  {
    return (_binaryBufferStart = b);
  }
  ...
  int32_t getEstimatedSnippetStart()
  {
    return _estimatedSnippetStart;
  }
  ...
  uint32_t getPreJitMethodEntrySize()
  {
    return _preJitMethodEntrySize;
  }
  ...
  uint32_t getJitMethodEntryPaddingSize()
  {
    return _jitMethodEntryPaddingSize;
  }
  ...
  void setCodeCache(TR::CodeCache* codeCache)
  {
  ...
  uint8_t* allocateCodeMemory(
    uint32_t warmCodeSizeInBytes, uint32_t coldCodeSizeInBytes, uint8_t** coldCode, bool isMethodHeaderNeeded = true);
  ...
  void commitToCodeCache()
  {
    _committedToCodeCache = true;
  }
  bool committedToCodeCache()
  {
    return _committedToCodeCache;
  }
   ...
   */
  bool hasCodeCacheSwitched() const
  {
    return _codeCacheSwitched;
  }
  ...
  //
  TR::Register* getVMThreadRegister()
  {
    return _vmThreadRegister;
  }
  ...
  TR::RealRegister* getRealVMThreadRegister()
  {
    return _realVMThreadRegister;
  }
  ...
  TR_GlobalRegisterNumber getFirstGlobalGPR()
  {
    return 0;
  }
  TR_GlobalRegisterNumber getLastGlobalGPR()
  {
    return _lastGlobalGPR;
  }
  ...
  TR_GlobalRegisterNumber getFirstGlobalFPR()
  {
  ...
  TR_GlobalRegisterNumber getLastGlobalFPR()
  {
    return _lastGlobalFPR;
  }
  ...
  TR_GlobalRegisterNumber getFirstGlobalVRF()
  {
    return _firstGlobalVRF;
  }
  TR_GlobalRegisterNumber setFirstGlobalVRF(TR_GlobalRegisterNumber n)
  {
    return (_firstGlobalVRF = n);
  }
  TR_GlobalRegisterNumber getLastGlobalVRF()
  {
    return _lastGlobalVRF;
  }
  ...
  bool hasGlobalVRF()
  {
    return _firstGlobalVRF != -1 && _lastGlobalVRF != -1;
  }
  ...
  uint16_t getNumberOfGlobalFPRs()
  {
    return _lastGlobalFPR - _lastGlobalGPR;
  }
  uint16_t getNumberOfGlobalVRFs()
  {
    return _lastGlobalVRF - _firstGlobalVRF;
  }

  uint8_t getGlobalGPRPartitionLimit()
  {
    return _globalGPRPartitionLimit;
  }
  ...
  uint8_t getGlobalFPRPartitionLimit()
  {
    return _globalFPRPartitionLimit;
  }
  ...
  bool isGlobalGPR(TR_GlobalRegisterNumber n)
  {
    return n <= _lastGlobalGPR;
  }
  ...
  TR_BitVector* getGlobalFPRsPreservedAcrossCalls()
  {
    return NULL;
  }

  int32_t getFirstBit(TR_BitVector& bv);
  TR_GlobalRegisterNumber pickRegister(TR_RegisterCandidate*, TR::Block**, TR_BitVector& availableRegisters,
    TR_GlobalRegisterNumber& highRegisterNumber, TR_LinkHead<TR_RegisterCandidate>* candidates);
  ...
  TR_GlobalRegisterNumber findCoalescenceRegisterForParameter(
    TR::Node* callNode, TR_RegisterCandidate* rc, uint32_t childIndex, bool* isUnpreferred);
  ...
  virtual bool willBeEvaluatedAsCallByCodeGen(TR::Node* node, TR::Compilation* comp)
  {
    return true;
  }
  ...
  TR_Array<TR::Register*>& getRegisterArray()
  {
  ...
  // Debug
  //
  TR::RegisterIterator* getGPRegisterIterator()
  {
    return _gpRegisterIterator;
  }
  ...
  TR::RegisterIterator* getFPRegisterIterator()
  {
    return _fpRegisterIterator;
  }
  ...
  void clearRegisterAssignmentFlags()
  {
    _regAssignFlags.clear();
  }

  // --------------------------------------------------------------------------
  // Spill
  //
  TR::list<TR_BackingStore*>& getSpill4FreeList()
  {
    return _spill4FreeList;
  }
  TR::list<TR_BackingStore*>& getSpill8FreeList()
  {
    return _spill8FreeList;
  }
  TR::list<TR_BackingStore*>& getSpill16FreeList()
  {
    return _spill16FreeList;
  }
  ...
  TR::list<TR_BackingStore*>& getAllSpillList()
  {
    return _allSpillList;
  }
  ...
  int32_t setCurrentPathDepth(int32_t d)
  {
    return _currentPathDepth = d;
  }
  int32_t getCurrentPathDepth()
  {
    return _currentPathDepth;
  }
  ...
  // Relocations
  //
  TR::list<TR::Relocation*>& getRelocationList()
  {
    return _relocationList;
  }
  ...
  TR::list<TR::Snippet*>& getSnippetList()
  {
    return _snippetList;
  }
  ...
  bool isSnippetMatched(TR::Snippet* snippet, int32_t snippetKind, TR::SymbolReference* symRef)
  {
    return false;
  }
...
public:
  ...
  void lockFreeSpillList()
  {
    _enabledFlags.set(LockFreeSpillList);
  }
  void unlockFreeSpillList()
  {
    _enabledFlags.reset(LockFreeSpillList);
  }
  ...
  bool hasCCInfo()
  {
    return (_flags2.testAny(HasCCInfo));
  }
  void setHasCCInfo(bool v)
  {
    _flags2.set(HasCCInfo, v);
  }
  bool hasCCOverflow()
  {
    return (_flags2.testAny(HasCCOverflow));
  }
  void setHasCCOverflow(bool v)
  {
    _flags2.set(HasCCOverflow, v);
  }
  bool hasCCSigned()
  {
    return (_flags2.testAny(HasCCSigned));
  }
  void setHasCCSigned(bool v)
  {
    _flags2.set(HasCCSigned, v);
  }
  bool hasCCZero()
  {
    return (_flags2.testAny(HasCCZero));
  }
  void setHasCCZero(bool v)
  {
    _flags2.set(HasCCZero, v);
  }
  bool hasCCCarry()
  {
    return (_flags2.testAny(HasCCCarry));
  }
  void setHasCCCarry(bool v)
  {
    _flags2.set(HasCCCarry, v);
  }

  bool hasCCCompare()
  {
    return (_flags3.testAny(HasCCCompare));
  }
  void setHasCCCompare(bool v)
  {
    _flags3.set(HasCCCompare, v);
  }

  bool requiresCarry()
  {
    return (_flags3.testAny(RequiresCarry));
  }
  void setRequiresCarry(bool v)
  {
    _flags3.set(RequiresCarry, v);
  }
  bool computesCarry()
  {
    return (_flags3.testAny(ComputesCarry));
  }
  void setComputesCarry(bool v)
  {
    _flags3.set(ComputesCarry, v);
  }
  ...
  void setShouldBuildStructure()
  {
    _enabledFlags.set(ShouldBuildStructure);
  }
  ...
  bool supportsLengthMinusOneForMemoryOpts()
  {
    return false;
  }
  ...
  bool getSupportsBitOpCodes()
  {
    return false;
  }

  bool getMappingAutomatics()
  {
    return _flags1.testAny(MappingAutomatics);
  }
  void setMappingAutomatics()
  {
    _flags1.set(MappingAutomatics);
  }
  ...
  bool supportsDirectJNICallsForAOT()
  {
    return false;
  }

  void setSupportsDirectJNICalls()
  {
    _flags1.set(SupportsDirectJNICalls);
  }

  bool getSupportsGlRegDeps()
  {
    return _flags1.testAny(SupportsGlRegDeps);
  }
  void setSupportsGlRegDeps()
  {
    _flags1.set(SupportsGlRegDeps);
  }
  ...
  void setSupportsVectorRegisters()
  {
    _flags1.set(SupportsVectorRegisters);
  }
  ...
  bool getDisableLongGRA()
  {
    return _flags1.testAny(DisableLongGRA);
  }
  void setDisableLongGRA()
  {
    _flags1.set(DisableLongGRA);
  }

  bool getDisableFpGRA()
  {
    return _flags2.testAny(DisableFpGRA);
  }
  void setDisableFpGRA()
  {
    _flags2.set(DisableFpGRA);
  }

  bool usesRegisterMaps()
  {
    return _flags1.testAny(UsesRegisterMaps);
  }
  void setUsesRegisterMaps()
  {
    _flags1.set(UsesRegisterMaps);
  }

  bool getSupportsDivCheck()
  {
    return _flags1.testAny(SupportsDivCheck);
  }
  void setSupportsDivCheck()
  {
    _flags1.set(SupportsDivCheck);
  }
  ...
  void setSupportsDynamicANewArray()
  {
    _flags2.set(SupportsDynamicANewArray);
  }
  ...
  void setSupportsArrayTranslateTRxx()
  {
    _flags2.set(SupportsArrayTranslate);
  }
  ...
  bool getSupportsArraySet()
  {
    return _flags1.testAny(SupportsArraySet);
  }
  void setSupportsArraySet()
  {
    _flags1.set(SupportsArraySet);
  }

  bool getSupportsArrayCmp()
  {
    return _flags1.testAny(SupportsArrayCmp);
  }
  void setSupportsArrayCmp()
  {
    _flags1.set(SupportsArrayCmp);
  }
  ...
  void setSupportsArrayCmpSign()
  {
    _flags3.set(SupportsArrayCmpSign);
  }
  ...
  void setSupportsSearchCharString()
  {
    _flags3.set(SupportsSearchCharString);
  }
  ...
  void setSupportsDoubleWordCAS()
  {
    _flags3.set(SupportsDoubleWordCAS);
  }
  ...
  void setSupportsDoubleWordSet()
  {
    _flags3.set(SupportsDoubleWordSet);
  }
  ...
  void setSupportsAtomicLoadAndAdd()
  {
    _flags4.set(SupportsAtomicLoadAndAdd);
  }

  bool getSupportsTM()
  {
    return _flags4.testAny(SupportsTM);
  }
  void setSupportsTM()
  {
    _flags4.set(SupportsTM);
  }

  bool getSupportsLM()
  {
    return _flags4.testAny(SupportsLM);
  }
  void setSupportsLM()
  {
    _flags4.set(SupportsLM);
  }
  ...
  bool getSupportsAutoSIMD()
  {
    return _flags4.testAny(SupportsAutoSIMD);
  }
  void setSupportsAutoSIMD()
  {
    _flags4.set(SupportsAutoSIMD);
  }
  ...
  void setJNILinkageCalleeCleanup()
  {
    _flags1.set(JNILinkageCalleeCleanup);
  }
  ...
  void setHasResumableTrapHandler()
  {
    _flags1.set(HasResumableTrapHandler);
  }
  ...
  void setPerformsChecksExplicitly()
  {
    _flags1.set(PerformsExplicitChecks);
  }
  ...
  void setSupportsCompactedLocals()
  {
    _flags1.set(SupportsCompactedLocals);
  }
  ...
  void setSupportsReadOnlyLocks()
  {
    _flags2.set(SupportsReadOnlyLocks);
  }
  ...
  void setSupportsTestUnderMask()
  {
    _flags4.set(SupportsTestUnderMask);
  }
  ...
  void incOutOfLineColdPathNestedDepth()
  {
    _outOfLineColdPathNestedDepth++;
  }
  void decOutOfLineColdPathNestedDepth()
  {
    _outOfLineColdPathNestedDepth--;
  }

  bool getMethodModifiedByRA()
  {
    return _flags2.testAny(MethodModifiedByRA);
  }
  void setMethodModifiedByRA()
  {
    _flags2.set(MethodModifiedByRA);
  }
  void resetMethodModifiedByRA()
  {
    _flags2.reset(MethodModifiedByRA);
  }

  bool getEnforceStoreOrder()
  {
    return _flags2.testAny(EnforceStoreOrder);
  }
  void setEnforceStoreOrder()
  {
    _flags2.set(EnforceStoreOrder);
  }
  ...
  void setMultiplyIsDestructive()
  {
    _flags3.set(MultiplyIsDestructive);
  }

  bool getIsInOOLSection()
  {
    return _flags4.testAny(IsInOOLSection);
  }
