...
public:
   ...
   */
  bool
  supportsNonHelper(TR::SymbolReferenceTable::CommonNonhelperSymbol symbol) {
    return false;
  }
  ...
  friend void OMR::CodeGenPhase::performEmitSnippetsPhase(TR::CodeGenerator *,
                                                          TR::CodeGenPhase *);
  friend void
  OMR::CodeGenPhase::performCleanUpFlagsPhase(TR::CodeGenerator *cg,
                                              TR::CodeGenPhase *phase);
  ...
  int32_t
  whichChildToEvaluate(TR::Node *node); // Decide which child of the given node
  ...
  void
  setLastInstructionBeforeCurrentEvaluationTreeTop(TR::Instruction *instr) {
  ...
  //
  TR::Instruction *
  generateDebugCounter(const char *name, int32_t delta = 1,
                       int8_t fidelity = TR::DebugCounter::Undetermined);
  TR::Instruction *
  generateDebugCounter(const char *name, TR::Register *deltaReg,
                       int8_t fidelity = TR::DebugCounter::Undetermined);
  TR::Instruction *
  generateDebugCounter(TR::Instruction *cursor, const char *name,
                       int32_t delta = 1,
                       int8_t fidelity = TR::DebugCounter::Undetermined,
  ...
  generateDebugCounter(TR::Instruction *cursor, const char *name,
                       ...
                       int32_t staticDelta = 1);
  TR::Instruction *
  generateDebugCounter(const char *name, TR::RegisterDependencyConditions &cond,
                       int32_t delta = 1,
                       int8_t fidelity = TR::DebugCounter::Undetermined,
  ...
  generateDebugCounter(const char *name, TR::Register *deltaReg,
                       ...
                       int32_t staticDelta = 1, TR::Instruction *cursor = NULL);
  TR::Instruction *
  generateDebugCounter(const char *name, TR_ScratchRegisterManager &srm,
                       int32_t delta = 1,
                       int8_t fidelity = TR::DebugCounter::Undetermined,
                       int32_t staticDelta = 1, TR::Instruction *cursor = NULL);
  TR::Instruction *
  ...
  TR::Instruction *
  generateDebugCounterBump(TR::Instruction *cursor,
  ...
  int genStoreForSymListArray(TR_Array<List<TR::SymbolReference>> *symListArray,
                              ...
                              TR::TreeTop *&insertionPoint, TR::Node *callNode,
                              TR::Node *osrBufferNode,
  ...
  setFirstOverlappedGlobalFPR(TR_GlobalRegisterNumber n) {
  ...
  TR_GlobalRegisterNumber
  setLastOverlappedGlobalFPR(TR_GlobalRegisterNumber n) {
  ...
  TR_GlobalRegisterNumber
  setFirstOverlappedGlobalVRF(TR_GlobalRegisterNumber n) {
  ...
  TR_GlobalRegisterNumber
  setLastOverlappedGlobalVRF(TR_GlobalRegisterNumber n) {
  ...
  TR_GlobalRegisterNumber
  getLinkageGlobalRegisterNumber(int8_t linkageRegisterIndex,
                                 TR::DataType type) {
    return -1;
  }
  ...
  TR_GlobalRegisterNumber
  pickRegister(TR_RegisterCandidate *, TR::Block **,
  ...
  TR_RegisterCandidate *findCoalescenceForRegisterCopy(TR::Node *node,
                                                       ...
                                                       bool *isUnpreferred);
  TR_GlobalRegisterNumber
  findCoalescenceRegisterForParameter(TR::Node *callNode,
                                      TR_RegisterCandidate *rc,
  ...
  TR::list<TR::Register *> *
  setSpilledRegisterList(TR::list<TR::Register *> *r) {
  ...
  TR_BackingStore *allocateSpill(int32_t size, bool containsCollectedReference,
                                 int32_t *offset, bool reuse = true);
  TR_BackingStore *
  allocateInternalPointerSpill(TR::AutomaticSymbol *pinningArrayPointer);
  ...
  TR::list<OMR::RegisterUsage *> *
  setReferencedRegisterList(TR::list<OMR::RegisterUsage *> *r) {
  ...
  int32_t
  setEstimatedLocationsForDataSnippetLabels(int32_t estimatedSnippetStart) {
    return 0;
  }
...
public:
  ...
  static int32_t
  defaultArrayTranslateMinimumNumberOfIterations(const char *methodName);
   ...
   */
  void
  redoTrampolineReservationIfNecessary(TR::Instruction *callInstr,
