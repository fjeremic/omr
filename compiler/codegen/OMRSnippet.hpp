...
public:
  ...
  void setCodeGenerator(TR::CodeGenerator* cg)
  {
    _cg = cg;
  }
  ...
  void setNode(TR::Node* node)
  {
    _node = node;
  }

  TR::LabelSymbol* getSnippetLabel()
  {
...
public:
  ...
  void setBlock(TR::Block* block)
  {
    _block = block;
  }

  bool needsExceptionTableEntry()
  {
    return _flags.testAll(TO_MASK32(NeedsExceptionTableEntry));
  }
  void setNeedsExceptionTableEntry()
  {
    _flags.set(TO_MASK32(NeedsExceptionTableEntry));
  }
  void resetNeedsExceptionTableEntry()
  {
    _flags.reset(TO_MASK32(NeedsExceptionTableEntry));
  }

  TR::SnippetGCMap& gcMap()
  {
    return _gcMap;
  }
