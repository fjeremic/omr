...
typedef TR::Register *(*TR_TreeEvaluatorFunctionPointer)(
    TR::Node *node, TR::CodeGenerator *codeGen);
...
class OMR_EXTENSIBLE TreeEvaluator {
 public:
  ...
  static bool instanceOfOrCheckCastNeedEqualityTest(TR::Node *castClassNode,
                                                    TR::CodeGenerator *cg);
  static bool instanceOfOrCheckCastNeedSuperTest(TR::Node *castClassNode,
                                                 TR::CodeGenerator *cg);

  static TR_GlobalRegisterNumber getHighGlobalRegisterNumberIfAny(
  ...
  static TR::Register *compressedRefsEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg);
  ...
  static bool nodeIsIArithmeticOverflowCheck(
      TR::Node *node, TR_ArithmeticOverflowCheckNodes *u);
  static bool nodeIsLArithmeticOverflowCheck(
      TR::Node *node, TR_ArithmeticOverflowCheckNodes *u);
  static bool nodeIsIAddOverflowCheck(TR::Node *node,
                                      TR_ArithmeticOverflowCheckNodes *u);
  static bool nodeIsISubOverflowCheck(TR::Node *node,
                                      TR_ArithmeticOverflowCheckNodes *u);
  static bool nodeIsLAddOverflowCheck(TR::Node *node,
                                      TR_ArithmeticOverflowCheckNodes *u);
  static bool nodeIsLSubOverflowCheck(TR::Node *node,
                                      TR_ArithmeticOverflowCheckNodes *u);
  static void evaluateNodesWithFutureUses(TR::Node *node,
                                          TR::CodeGenerator *cg);
  static void initializeStrictlyFutureUseCounts(TR::Node *node,
                                                vcount_t visitCount,
                                                TR::CodeGenerator *cg);
