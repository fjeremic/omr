...
public:
  ...
  static TR_GlobalRegisterNumber
  getHighGlobalRegisterNumberIfAny(TR::Node *node, TR::CodeGenerator *cg);
  ...
  static bool
  nodeIsIArithmeticOverflowCheck(TR::Node *node,
                                 TR_ArithmeticOverflowCheckNodes *u);
  static bool
  nodeIsLArithmeticOverflowCheck(TR::Node *node,
                                 TR_ArithmeticOverflowCheckNodes *u);
