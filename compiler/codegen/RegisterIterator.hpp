...
public:
   ...
   */
  RegisterIterator(TR::Machine *machine, int32_t firstRegIndex,
                   int32_t lastRegIndex)
      : _machine(machine), _firstRegIndex(firstRegIndex),
        _lastRegIndex(lastRegIndex), _cursor(firstRegIndex){};
