...
OMR::CodeGenerator::CodeGenerator()
    : _compilation(TR::comp()),
      ...
      _stackOfArtificiallyInflatedNodes(
          self()->comp() ? self()->comp()->trMemory() : 0,
          16),
...
TR_FrontEnd* OMR::CodeGenerator::fe() {
  return self()->comp()->fe();
}

TR_Debug* OMR::CodeGenerator::getDebug() {
...
bool OMR::CodeGenerator::generateCodeFromIL() {
  return false;
}
...
void OMR::CodeGenerator::lowerTreesWalk(TR::Node* parent,
                                        TR::TreeTop* treeTop,
                                        vcount_t visitCount) {
...
bool OMR::CodeGenerator::canClobberNodesRegister(TR::Node* node,
                                                 uint16_t count,
...
bool OMR::CodeGenerator::getSupportsTLE() {
 ...
 */
bool OMR::CodeGenerator::getSupportsIbyteswap() {
  return false;
}
 ...
 */
bool OMR::CodeGenerator::getSupportsBitPermute() {
  return false;
}
...
void OMR::CodeGenerator::apply16BitLoadLabelRelativeRelocation(TR::Instruction*,
                                                               TR::LabelSymbol*,
                                                               TR::LabelSymbol*,
                                                               int32_t) {
  TR_ASSERT(0,
...
void OMR::CodeGenerator::apply32BitLoadLabelRelativeRelocation(TR::Instruction*,
                                                               TR::LabelSymbol*,
                                                               TR::LabelSymbol*,
                                                               int32_t) {
  TR_ASSERT(0,
...
bool OMR::CodeGenerator::nodeMatches(TR::Node* addr1,
                                     TR::Node* addr2,
                                     bool addressesUnderSameTreeTop) {
...
bool OMR::CodeGenerator::additionsMatch(TR::Node* addr1,
                                        TR::Node* addr2,
                                        bool addressesUnderSameTreeTop) {
  bool foundMatch = false;
...
bool OMR::CodeGenerator::addressesMatch(TR::Node* addr1,
                                        TR::Node* addr2,
                                        bool addressesUnderSameTreeTop) {
  bool foundMatch = false;
...
void OMR::CodeGenerator::compute32BitMagicValues(int32_t d,
                                                 int32_t* m,
                                                 int32_t* s) {
...
void OMR::CodeGenerator::compute64BitMagicValues(int64_t d,
                                                 int64_t* m,
                                                 int64_t* s) {
  int p, first, last, mid;
...
bool OMR::CodeGenerator::supportsJitMethodEntryAlignment() {
  return true;
}

uint32_t OMR::CodeGenerator::getJitMethodEntryAlignmentBoundary() {
  return 1;
}
...
void OMR::CodeGenerator::startRecordingRegisterUsage() {
  self()->setReferencedRegisterList(
      new (self()->trHeapMemory()) TR::list<OMR::RegisterUsage*>(
          getTypedAllocator<OMR::RegisterUsage*>(self()->comp()->allocator())));
