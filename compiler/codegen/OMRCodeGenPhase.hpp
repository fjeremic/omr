...
typedef void (*CodeGenPhaseFunctionPointer)(TR::CodeGenerator*,
                                            TR::CodeGenPhase*);
...
#include "codegen/CodeGenPhaseEnum.hpp"
   ...
   * Derive class must provide own implementation if more phases are being added
   * to the enums
   */
   ...
   */
  static void performUncommonCallConstNodesPhase(TR::CodeGenerator* cg,
                                                 TR::CodeGenPhase*);
  static void performReserveCodeCachePhase(TR::CodeGenerator* cg,
                                           TR::CodeGenPhase*);
  static void performLowerTreesPhase(TR::CodeGenerator* cg, TR::CodeGenPhase*);
  static void performSetupForInstructionSelectionPhase(TR::CodeGenerator* cg,
                                                       TR::CodeGenPhase*);
  static void performInstructionSelectionPhase(TR::CodeGenerator* cg,
                                               TR::CodeGenPhase*);
  static void performCreateStackAtlasPhase(TR::CodeGenerator* cg,
                                           TR::CodeGenPhase*);
  static void performRegisterAssigningPhase(TR::CodeGenerator* cg,
                                            TR::CodeGenPhase*);
  ...
  static void performBinaryEncodingPhase(TR::CodeGenerator* cg,
                                         TR::CodeGenPhase*);
  static void performEmitSnippetsPhase(TR::CodeGenerator* cg,
                                       TR::CodeGenPhase*);
  static void performProcessRelocationsPhase(TR::CodeGenerator* cg,
                                             TR::CodeGenPhase*);

  static void performInliningReportPhase(TR::CodeGenerator* cg,
                                         TR::CodeGenPhase*);
  static void performFindAndFixCommonedReferencesPhase(TR::CodeGenerator* cg,
                                                       TR::CodeGenPhase*);
  static void performRemoveUnusedLocalsPhase(TR::CodeGenerator* cg,
                                             TR::CodeGenPhase*);
  static void performCleanUpFlagsPhase(TR::CodeGenerator* cg,
                                       TR::CodeGenPhase* phase);
  static void performInsertDebugCountersPhase(TR::CodeGenerator* cg,
                                              TR::CodeGenPhase* phase);
  static void performExpandInstructionsPhase(TR::CodeGenerator* cg,
                                             TR::CodeGenPhase* phase);
