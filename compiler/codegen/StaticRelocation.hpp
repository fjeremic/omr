...
/**
 * @brief The StaticRelocation class contains the information required to create
 * a static relocation in code generated for use in a statically compiled
 * context.
 */
...
public:
   ...
   * @param relocationType The type of the relocation, namely whether that
   * relocation is absolute or relative.
   */
  StaticRelocation(uint8_t *location, const char *symbol,
                   StaticRelocationSize size,
                   StaticRelocationType relocationType)
      : _location(location), _symbol(symbol), _size(size),
  ...
  /**
   * @brief symbol Returns the name of the symbol to be targetted by the
   * relocation.
  ...
  /**
   * @brief type Returns the type of the relocation, namely whether that
   * relocation is absolute or relative.
