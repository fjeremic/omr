...
uint8_t fprCount(TR::DataType type) {
  return type.isFloatingPoint() ? 1 : 0;
}
uint8_t vrfCount(TR::DataType type) {
  return type.isVector() ? 1 : 0;
}

void initializeRegisterPressureSimulator();

void simulateBlockEvaluation(TR::Block* block,
                             TR_RegisterPressureState* state,
                             TR_RegisterPressureSummary* summary);
void simulateTreeEvaluation(TR::Node* node,
                            TR_RegisterPressureState* state,
                            TR_RegisterPressureSummary* summary);
...
void simulateMemoryReference(TR_SimulatedMemoryReference* memref,
                             ...
                             TR_RegisterPressureState* state,
                             TR_RegisterPressureSummary* summary);
void simulationPrePass(TR::TreeTop* tt,
                       TR::Node* node,
                       TR_RegisterPressureState* state,
                       TR_RegisterPressureSummary* summary);
