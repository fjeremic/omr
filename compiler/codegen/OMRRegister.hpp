...
public:
   ...
   */
  TR_BackingStore* getBackingStorage()
  {
    return _backingStorage;
  }
  ...
  TR::Register* getAssignedRegister()
  {
    return _assignedRegister;
  }
  ...
  TR::Register* getSiblingRegister()
  {
    return _siblingRegister;
  }
  ...
  TR::Instruction* getStartOfRange()
  {
    return _startOfRange;
  }
  TR::Instruction* setStartOfRange(TR::Instruction* i)
  {
    return _startOfRange = i;
  }
  TR::Instruction* getEndOfRange()
  {
    return _endOfRange;
  }
  TR::Instruction* setEndOfRange(TR::Instruction* i)
  {
    return _endOfRange = i;
  }
  TR::Node* getStartOfRangeNode()
  {
    return _startOfRangeNode;
  }
  ...
  ncount_t getFutureUseCount()
  {
    return _futureUseCount;
  }
  ncount_t setFutureUseCount(ncount_t fuc)
  {
  ...
  ncount_t getOutOfLineUseCount()
  {
    return _outOfLineUseCount;
  }
  ...
  uint32_t getAssociation()
  {
    return _association;
  }
  uint32_t setAssociation(uint32_t a)
  {
    return (_association = a);
  }

  TR_RegisterKinds getKind()
  {
    return _kind;
  }
  TR_RegisterKinds setKind(TR_RegisterKinds rk)
  {
    return (_kind = rk);
  }
  TR_RegisterKinds getKindAsMask()
  {
    return TR_RegisterKinds(1 << _kind);
  }
  ...
  {
    _flags.setValue(0xffffffff, f);
  }

  /*
   * Methods for getting/setting flag masks
   */
  bool isPlaceholderReg()
  {
    return _flags.testAny(PlaceholderReg);
  }
  void setPlaceholderReg()
  {
    _flags.set(PlaceholderReg);
  }
  void resetPlaceholderReg()
  {
    _flags.reset(PlaceholderReg);
  }
  ...
  {
    return _flags.testAny(IsSinglePrecision);
  }
  void setIsSinglePrecision(bool b = true)
  {
    _flags.set(IsSinglePrecision, b);
  }
