...
public:
  ...
  TR::SymbolReference* getDataSymbolReference()
  {
    return _dataSymbolReference;
  }
  TR::SymbolReference* setDataSymbolReference(TR::SymbolReference* sr)
  {
    return (_dataSymbolReference = sr);
  }

  TR::Instruction* getDataReferenceInstruction()
  {
    return _dataReferenceInstruction;
  }
  ...
  {
    return _addressOfDataReference;
  }
  uint8_t* setAddressOfDataReference(uint8_t* p)
  {
    return (_addressOfDataReference = p);
  }

  bool isUnresolvedStore()
  {
    return _flags.testAll(TO_MASK32(IsUnresolvedStore));
  }
  void setUnresolvedStore()
  {
    _flags.set(TO_MASK32(IsUnresolvedStore));
  }
  void resetUnresolvedStore()
  {
    _flags.reset(TO_MASK32(IsUnresolvedStore));
  }
