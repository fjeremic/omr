...
class UnresolvedDataSnippet : public TR::Snippet {
 public:
  ...
  static TR::UnresolvedDataSnippet *create(TR::CodeGenerator *cg,
                                           TR::Node *node,
                                           TR::SymbolReference *s, bool isStore,
                                           bool canCauseGC);
 ...
 protected:
  ...
  static_assert((int32_t)NextSnippetFlag <=
                    (int32_t)TR::Snippet::MaxSnippetFlag,
