...
void* SimpleRegex::Component::operator new(size_t size,
...
bool SimpleRegex::Simple::matchesRemainder(const char* s,
...
bool SimpleRegex::Simple::match(const char* s,
                                bool isCaseSensitive,
                                bool useLocale) {
  int i;
...
bool SimpleRegex::Regex::match(const char* s,
                               bool isCaseSensitive,
                               bool useLocale) {
  int32_t rc = false;
...
bool SimpleRegex::match(TR::SimpleRegex* regex,
                        const char* s,
                        bool isCaseSensitive) {
...
bool SimpleRegex::matchIgnoringLocale(TR::SimpleRegex* regex,
                                      const char* s,
                                      bool isCaseSensitive) {
