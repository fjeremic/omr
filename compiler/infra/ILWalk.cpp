...
void TR::TreeTopIteratorImpl::stepForward() {
  TR_ASSERT(_current, "Cannot stepForward a TreeTopIterator that has already "
                      "moved beyond the first or last tree of the method");
  _current = _current->getNextTreeTop();
}

void TR::TreeTopIteratorImpl::stepBackward() {
  TR_ASSERT(_current, "Cannot stepBackward a TreeTopIterator that has already "
                      "moved beyond the first or last tree of the method");
...
TR::NodeIterator::NodeIterator(TR::TreeTop *start, TR::Compilation *comp,
                               const char *name)
    : TreeTopIteratorImpl(start, comp, name), _checklist(comp),
...
TR::AllBlockIterator::AllBlockIterator(TR::CFG *cfg, TR::Compilation *comp,
                                       const char *name)
    : BlockIterator(comp, name), _cfg(cfg),
...
void TR::AllBlockIterator::stepForward() {
  TR_ASSERT(_currentBlock, "Cannot stepForward an AllBlockIterator that has "
...
TR::TreeTopOrderExtendedBlockIterator::TreeTopOrderExtendedBlockIterator(
    ...
    : BlockIterator(comp, name), _currBlock(comp->getStartBlock()),
