...
{
  TR_ASSERT(
    currentBlock(), "cannot stepForward a ReversePostorderSnapshotBlockIterator that has already finished its walk");
  do
    --_currentIndex;
...
{
  TR_ASSERT(
    _currBlock != NULL, "Cannot increment an TreeTopOrderExtendedBlockIterator that has already finished iterating");
