...
class TreeTopIteratorImpl {
 ...
 protected:
  ...
  TreeTopIteratorImpl(TR::TreeTop* start,
                      TR::Compilation* comp,
...
class TreeTopIterator : public TreeTopIteratorImpl {
 ...
 public:
  TreeTopIterator(TR::TreeTop* start,
                  TR::Compilation* comp,
                  const char* name = NULL)
...
class PreorderNodeIterator : public NodeIterator {
 ...
 public:
  PreorderNodeIterator(TR::TreeTop* start,
                       TR::Compilation* comp,
                       const char* name = NULL);
...
class PostorderNodeIterator : public NodeIterator {
 ...
 public:
  PostorderNodeIterator(TR::TreeTop* start,
                        TR::Compilation* comp,
                        const char* name = NULL);
...
class NodeOccurrenceIterator : public NodeIterator {
 protected:
  NodeOccurrenceIterator(TR::TreeTop* start,
                         TR::Compilation* comp,
                         const char* name = NULL)
...
class PreorderNodeOccurrenceIterator : public NodeOccurrenceIterator {
 ...
 public:
  PreorderNodeOccurrenceIterator(TR::TreeTop* start,
                                 TR::Compilation* comp,
                                 const char* name = NULL);
...
class PostorderNodeOccurrenceIterator : public NodeOccurrenceIterator {
 ...
 public:
  PostorderNodeOccurrenceIterator(TR::TreeTop* start,
                                  TR::Compilation* comp,
                                  const char* name = NULL);
