...
public:
  ...
  TR::Node* currentNode();
  bool isAt(TR::TreeTop* tt)
  {
    return _current == tt;
  }
  void jumpTo(TR::TreeTop* tt)
  {
    _current = tt;
  }

  bool isAt(TreeTopIteratorImpl& other)
  {
    return isAt(other.currentTree());
  }
  bool isAt(PreorderNodeIterator& other);

public: // operators
  bool operator==(TR::TreeTop* tt)
  {
    return isAt(tt);
  }
  bool operator!=(TR::TreeTop* tt)
...
protected:
  struct WalkState {
    ...
    bool operator==(struct WalkState& other)
    {
      return equals(other);
    }
    bool operator!=(struct WalkState& other)
...
public:
  ...
  bool isAt(TR::TreeTop* tt)
  {
    return Super::isAt(tt);
  }
  bool isAt(TreeTopIterator& other)
  {
    return isAt(other.currentTree());
  }
  bool isAt(PreorderNodeIterator& other);
