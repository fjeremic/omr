...
IMIndex TR_IGBase::_highIndexTable[NUM_PRECOMPUTED_HIGH_INDICES] = { 0, 0, 1, 3, 6, 10, 15, 21, 28, // 8
...
IMIndex TR_IGBase::getNodePairToBVIndex(IGNodeIndex index1, IGNodeIndex index2)
{
  IMIndex low, high;
...
//
IMIndex TR_IGBase::getOrderedNodePairToBVIndex(IGNodeIndex low, IGNodeIndex high)
{
