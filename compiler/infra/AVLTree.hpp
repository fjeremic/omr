...
template<class T>
int32_t
TR_AVLTreeHandler<T>::balanceLeft(T*& node)
{
...
template<class T>
int32_t
TR_AVLTreeHandler<T>::balanceRight(T*& node)
{
...
template<class T>
T*
TR_AVLTreeHandler<T>::findOrCreate(int32_t key,
                                   T*& node,
                                   int32_t& heightChanged)
{
...
template<class T>
T*
TR_AVLTreeHandler<T>::remove(int32_t key, T*& node, int32_t& heightChanged)
{
...
template<class T>
void
TR_AVLTreeHandler<T>::swapRightmost(T*& node, T*& swap)
{
