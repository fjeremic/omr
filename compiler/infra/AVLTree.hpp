...
public:
  ...
  TR_AVLTreeIterator()
    ...
    , _next(NULL)
  {}
  TR_AVLTreeIterator(TR_AVLTree<T>& tree)
  {
    reset(tree);
  }

  TR_AVLTree<T>* getBase()
  {
    return _tree;
  }
...
public:
  ...
  T* getRoot(TR_AVLTree<T>& tree)
  {
    return tree.getRoot();
  }
  void setRoot(TR_AVLTree<T>& tree, T* node)
  {
    tree.setRoot(node);
  }
