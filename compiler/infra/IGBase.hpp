...
public:
  ...
  IGNodeIndex getNumNodes()
  {
    return _numNodes;
  }
  IGNodeIndex setNumNodes(IGNodeIndex n)
  {
    return (_numNodes = n);
  }
  IGNodeIndex incNumNodes()
  {
    return (++_numNodes);
  }
  bool isEmpty()
  ...
  IGNodeColour getNumColours()
  {
    return _numColours;
  }
  IGNodeColour setNumColours(IGNodeColour c)
  {
    return (_numColours = c);
  }

  TR_BitVector* getInterferenceMatrix()
  {
    return _interferenceMatrix;
  }
  void setInterferenceMatrix(TR_BitVector* im)
  {
    _interferenceMatrix = im;
  }
