...
void
TR_SingleTimer::initialize(const char* title, TR_Memory* trMemory)
{
  if (title) {
...
void
TR_SingleTimer::startTiming(TR::Compilation* comp)
{
  if (!_timerRunning) {
...
uint32_t
TR_SingleTimer::stopTiming(TR::Compilation* comp)
{
  if (_timerRunning) {
