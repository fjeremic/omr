...
public:
  ...
  IGNodeColour getColour()
  {
    return _colour;
  }
  void setColour(IGNodeColour c)
  {
    _colour = c;
  }
  bool isColoured()
  {
    return (_colour == UNCOLOURED) ? false : true;
  }

  IGNodeIndex getIndex()
  {
    return _index;
  }
  void setIndex(IGNodeIndex i)
  {
    _index = i;
  }

  List<TR_IGNode>& getAdjList()
  {
    return _adjList;
  }
  ...
  void setEntity(void* p)
  {
    _pEntity = p;
  }

  IGNodeDegree getWorkingDegree()
  {
    return _workingDegree;
  }
  void setWorkingDegree(IGNodeDegree d)
  {
    _workingDegree = d;
  }
  ...
  {
    TR_ASSERT(_workingDegree >= 1, "decWorkingDegree: working degree is less than 0! (_workingDegree=%d nodeIndex=%d)",
      _workingDegree, getIndex());
    return --_workingDegree;
  }
  ...
  IGNodeDegree getDegree()
  {
    return _degree;
  }
  void setDegree(IGNodeDegree d)
  {
    _degree = d;
  }
  ...
  bool isRemovedFromIG()
  {
    return _flags.testAny(IsRemovedFromIG);
  }
  void setIsRemovedFromIG()
  {
    _flags.set(IsRemovedFromIG);
  }
  void resetIsRemovedFromIG()
  {
    _flags.reset(IsRemovedFromIG);
  }
