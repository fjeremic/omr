...
public:
  ...
  static bool match(TR::SimpleRegex *regex, const char *,
                    bool isCaseSensitive = true);
  static bool match(TR::SimpleRegex *regex, int, bool isCaseSensitive = true);
  static bool match(TR::SimpleRegex *regex, TR_ResolvedMethod *,
                    bool isCaseSensitive = true);
  static bool matchIgnoringLocale(TR::SimpleRegex *regex, const char *,
                                  bool isCaseSensitive = true);
...
private:
  ...
  static Simple *processSimple(char *&s, TR_YesNoMaybe allowAlternates,
                               bool &foundError);
