...
class deque : public std::deque<T, typed_allocator<T, Alloc> > {
 public:
  ...
  explicit deque(size_type size, const T &initialValue,
...
template <typename T, class Alloc>
TR::deque<T, Alloc>::deque(size_type size, const T &initialValue,
                           const allocator_type &allocator)
    : container_type(size, initialValue, allocator) {}

template <typename T, class Alloc>
template <typename InputIterator>
TR::deque<T, Alloc>::deque(InputIterator first, InputIterator last,
                           const allocator_type &allocator)
...
template <typename T, class Alloc>
typename TR::deque<T, Alloc>::reference TR::deque<T, Alloc>::operator[](
    size_type index) {
...
template <typename T, class Alloc>
typename TR::deque<T, Alloc>::const_reference TR::deque<T, Alloc>::operator[](
