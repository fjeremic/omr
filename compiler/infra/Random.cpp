...
uint32_t
TR_RandomGenerator::getRandom()
{
  // Linear congruential parameters used by GCC; see
...
int32_t
TR_RandomGenerator::getRandom(int32_t min, int32_t max)
{
...
void
TR_RandomGenerator::setSeed(uint32_t newSeed)
{
  _bits = newSeed;
...
void
TR_RandomGenerator::exercise(int32_t period, TR::Compilation* comp)
{
