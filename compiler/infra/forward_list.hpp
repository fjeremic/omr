...
template <typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::iterator TR::forward_list<T, Alloc>::begin()
{
...
template <typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::iterator TR::forward_list<T, Alloc>::end()
{
...
template <typename T, typename Alloc>
typename TR::forward_list<T, Alloc>::reference TR::forward_list<T, Alloc>::front()
{
