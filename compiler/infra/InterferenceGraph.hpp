...
protected:
  ...
  void partitionNodesIntoDegreeSets(CS2::ABitVector<TR::Allocator>& workingSet,
    CS2::ABitVector<TR::Allocator>& colourableDegreeSet, CS2::ABitVector<TR::Allocator>& notColourableDegreeSet);
...
public:
  ...
  TR_IGNode* getNodeTable(IGNodeIndex i)
  {
    return ((*_nodeTable)[i]);
  }

  TR_Stack<TR_IGNode*>* getNodeStack()
  {
    return _nodeStack;
  }
