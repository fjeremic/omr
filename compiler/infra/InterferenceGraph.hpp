...
public:
  ...
  TR_Stack<TR_IGNode *> *setNodeStack(TR_Stack<TR_IGNode *> *ns) {
    return (_nodeStack = ns);
  }

  int32_t entityHashBucket(void *entity) {
    return (int32_t)(((uintptrj_t)entity >> 2) % _entityHash._numBuckets);
  }
  ...
  void addInterferenceBetween(void *entity1, void *entity2) {
    ...
    TR_ASSERT(igNode1,
              "addInterferenceBetween: entity1 %p does not exist in this "
              "interference graph\n",
              entity1);
    TR_ASSERT(igNode2,
              "addInterferenceBetween: entity2 %p does not exist in this "
              "interference graph\n",
              entity2);
  ...
  void removeInterferenceBetween(void *entity1, void *entity2) {
    ...
    TR_ASSERT(igNode1,
              "hasInterference: entity1 %p does not exist in this interference "
              "graph\n",
              entity1);
    TR_ASSERT(igNode2,
              "hasInterference: entity2 %p does not exist in this interference "
              "graph\n",
              entity2);
