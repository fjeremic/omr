...
TR::CFGNode* OMR::CFG::addNode(TR::CFGNode* n,
...
void OMR::CFG::copyExceptionSuccessors(TR::CFGNode* from,
                                       TR::CFGNode* to,
...
TR::CFGEdge* TR::CFGEdge::createEdge(TR::CFGNode* pF,
                                     TR::CFGNode* pT,
                                     TR_Memory* trMemory,
...
TR::CFGEdge* TR::CFGEdge::createExceptionEdge(TR::CFGNode* pF,
                                              TR::CFGNode* pT,
                                              TR_Memory* trMemory,
                                              TR_AllocationKind allocKind) {
  TR::CFGEdge* newEdge = new (trMemory, allocKind) TR::CFGEdge(pF, pT);
...
//
static OrphanType unreachableOrphan(TR::CFG* cfg,
                                    TR::CFGNode* from,
                                    TR::CFGNode* to) {
...
void OMR::CFG::removeEdge(TR::CFGEdgeList& succList,
                          int32_t selfNumber,
                          int32_t destNumber) {
...
static void setFrequencyOnSuccessor(TR_RegionStructure* region,
                                    TR::CFGNode* succ,
                                    TR::CFGNode* start,
                                    int32_t succNum,
...
static void generalFrequencyPropagation(TR_RegionStructure* region,
                                        TR_SuccessorIterator sit,
                                        TR::Block* block,
                                        TR_BitVector* _seenNodes,
                                        int32_t* _regionFrequencies,
...
int32_t OMR::CFG::getLowFrequency() {
  return LOW_FREQ;
}

int32_t OMR::CFG::getAvgFrequency() {
  return AVG_FREQ;
}
...
void OMR::CFG::getBranchCounters(TR::Node* node,
                                 TR::Block* block,
                                 int32_t* taken,
                                 int32_t* notTaken,
                                 TR::Compilation* comp) {
...
TR::Region& OMR::CFG::getInternalRegion() {
