...
template<class T>
T*
TR_HedgeTreeHandler<T>::findOrCreate(int32_t key, T*& node, int32_t& rebalance)
{
...
template<class T>
T*
TR_HedgeTreeHandler<T>::remove(int32_t key, T*& node, int32_t& rebalance)
{
...
template<class T>
void
TR_HedgeTreeHandler<T>::swapRightmost(T*& node, T*& swap)
{
