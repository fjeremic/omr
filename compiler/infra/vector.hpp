...
class vector : public std::vector<T, typed_allocator<T, Alloc> > {
 public:
  ...
  explicit vector(size_type size, const T &initialValue,
...
template <typename T, class Alloc>
TR::vector<T, Alloc>::vector(size_type size, const T &initialValue,
                             const allocator_type &allocator)
    : container_type(size, initialValue, allocator) {}

template <typename T, class Alloc>
template <typename InputIterator>
TR::vector<T, Alloc>::vector(InputIterator first, InputIterator last,
                             const allocator_type &allocator)
...
template <typename T, class Alloc>
typename TR::vector<T, Alloc>::reference TR::vector<T, Alloc>::operator[](
    size_type index) {
...
template <typename T, class Alloc>
typename TR::vector<T, Alloc>::const_reference TR::vector<T, Alloc>::operator[](
