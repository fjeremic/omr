...
public:
  ...
  TR::Region& structureRegion()
  {
    return _structureRegion;
  }
  ...
  TR::CFGNode* setStart(TR::CFGNode* p)
  {
    return (_pStart = p);
  }
  ...
  TR::CFGNode* setEnd(TR::CFGNode* p)
  {
    return (_pEnd = p);
  }
  ...
  {
    return _rootStructure;
  }
  TR_Structure* setStructure(TR_Structure* p);
  TR_Structure* invalidateStructure();

  TR::CFGNode* getFirstNode()
  {
    return _nodes.getFirst();
  }
  TR_LinkHead1<TR::CFGNode>& getNodes()
  {
    return _nodes;
  }
  ...
  int32_t getNextNodeNumber()
  {
    return _nextNodeNumber;
  }
  void setNextNodeNumber(int32_t n)
  {
    _nextNodeNumber = n;
  }
  int32_t allocateNodeNumber()
  {
    return _nextNodeNumber++;
  }
  ...
  bool getMightHaveUnreachableBlocks()
  {
    return _mightHaveUnreachableBlocks;
  }
  void setHasUnreachableBlocks()
  {
    _doesHaveUnreachableBlocks = true;
  }
  bool getHasUnreachableBlocks()
  {
    return _doesHaveUnreachableBlocks;
  }

  bool getIgnoreUnreachableBlocks()
  {
    return _ignoreUnreachableBlocks;
  }
  void setIgnoreUnreachableBlocks(bool flag)
  {
    _ignoreUnreachableBlocks = flag;
  }
  ...
  TR::CFGNode* getForwardTraversalElement(int32_t idx)
  {
    return _forwardTraversalOrder[idx];
  }
  int32_t getForwardTraversalLength()
  {
    return _forwardTraversalLength;
  }
  TR::CFGNode* getBackwardTraversalElement(int32_t idx)
  {
    return _backwardTraversalOrder[idx];
  }
  int32_t getBackwardTraversalLength()
  {
    return _backwardTraversalLength;
  }
  ...
  void setMaxFrequency(int32_t f)
  {
    _maxFrequency = f;
  }
  int32_t getMaxFrequency()
  {
  ...
  void setMaxEdgeFrequency(int32_t f)
  {
    _maxEdgeFrequency = f;
  }
  int32_t getMaxEdgeFrequency()
  {
    return _maxEdgeFrequency;
  }

  int32_t getOldMaxEdgeFrequency()
  {
    return _oldMaxEdgeFrequency;
  }

  TR_BitVector* getFrequencySet()
  {
    return _frequencySet;
  }

  int32_t getInitialBlockFrequency()
  {
    return _initialBlockFrequency;
  }
