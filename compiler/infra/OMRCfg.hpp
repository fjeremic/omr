...
class CFG {
 public:
  ...
  TR::CFGNode* addNode(TR::CFGNode* n,
  ...
  void removeEdge(TR::CFGEdgeList& succList,
                  int32_t selfNumber,
                  int32_t destNumber);
  ...
  int32_t createTraversalOrder(bool forward,
  ...
  void getBranchCounters(TR::Node* node,
                         TR::Block* block,
                         int32_t* taken,
                         int32_t* notTaken,
                         TR::Compilation* comp);
  ...
  void setEdgeFrequenciesOnNode(TR::CFGNode* node,
                                int32_t branchToCount,
                                int32_t fallThroughCount,
                                TR::Compilation* comp);
  void setUniformEdgeFrequenciesOnNode(TR::CFGNode* node,
                                       int32_t branchToCount,
                                       bool addFrequency,
                                       TR::Compilation* comp);
  ...
  //
  void getBranchCountersFromProfilingData(TR::Node* node,
                                          TR::Block* block,
                                          int32_t* taken,
                                          int32_t* notTaken) {
    return;
