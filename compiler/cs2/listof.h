...
public:
  ListOf(const Allocator &a = Allocator())
      : BaseArrayOf<AElementType, Allocator, segmentBits>(a), fNextAvailable(0),
        fInitialSize() {}
  ...
  public:
    Cursor(const CS2_LI_DECL &a)
        : fList(a), fSegmentIndex(0), fElementIndex(0), fSegment(NULL) {}
...
CS2_LI_TEMP inline AElementType &CS2_LI_DECL::
operator[](ListIndex index) const {
...
CS2_LI_TEMP inline CS2_LI_DECL::ListOf(const CS2_LI_DECL &list)
    : CS2_AR_DECL(list, list.allocator()), fNextAvailable(list.fNextAvailable),
...
CS2_LI_TEMP inline CS2_LI_DECL &CS2_LI_DECL::
operator=(const CS2_LI_DECL &list) {
  ListIndex listIndex;
