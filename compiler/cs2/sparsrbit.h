...
inline void ASparseBitVector<Allocator>::Or(ASparseBitVector<Allocator>** vs, SparseBitIndex nvs)
{
    ...
    typename ASparseBitVector<Allocator>::Segment** ls = (typename ASparseBitVector<Allocator>::Segment**)Allocator::allocate(sizeof(void*) * nvs);
...
template <class Allocator>
inline void ASparseBitVector<Allocator>::Or(ASparseBitVector<Allocator>** vs, SparseBitIndex nvs, const ASparseBitVector<Allocator>& mask)
{
...
template <class Allocator>
inline bool ASparseBitVector<Allocator>::OrMask(const ASparseBitVector<Allocator>& inputVector,
