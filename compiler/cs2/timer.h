...
class PhaseMeasuringNode : private Allocator {
 public:
  ...
  uint32_t sprintfMetric(char* line,
                         Metric total,
                         bool alternativeFormat = false,
...
class PhaseMeasuringSummary {
 ...
 private:
  template <class ostream>
  void DumpSummaryNode(ostream& s,
                       ListIndex root,
                       uint32_t indent,
                       Metric total,
                       bool running = false,
...
template <class Meter, class Allocator>
template <class ostream>
inline void PhaseMeasuringNode<Meter, Allocator>::Dump(ostream& out,
                                                       uint32_t indent,
                                                       Metric total,
                                                       bool running,
...
class LexicalBlockTimer : public LexicalBlockProfiler<RunnableTimer,
                                                      Allocator,
                                                      PhaseTimingSummary> {
 private:
  // Should not be copy constructed or copied.
