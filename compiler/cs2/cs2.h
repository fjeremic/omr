...
#ifdef _MSC_VER
// MSCV doesn't support C99 features, but recommends this as an alternative
...
public:
  exception(const char *file = NULL, uint32_t line = 0) : _f(file), _l(line) {}
