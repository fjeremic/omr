...
CS2_ARTEMP inline const AElementType &CS2_BASEARDECL::
operator[](size_t elementIndex) const {
  return ElementAt(elementIndex);
}

CS2_ARTEMP inline AElementType &CS2_BASEARDECL::
...
CS2_ARTEMP inline CS2_BASEARDECL::BaseArrayOf(const CS2_BASEARDECL &inputArray,
                                              const Allocator &a)
    : Allocator(a), fMaxSegments(inputArray.fMaxSegments),
...
CS2_ARTEMP inline CS2_BASEARDECL &CS2_BASEARDECL::
operator=(const CS2_BASEARDECL &inputArray) {
...
public:
  ...
  ArrayOf(ArrayOf<AElementType, Allocator, segmentBits> &inputArray,
      ...
      : CS2_BASEARDECL(a), fInitializer(inputArray.fInitializer),
        fNumInitialized(0) {
