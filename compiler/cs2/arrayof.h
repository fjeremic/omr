...
CS2_ARTEMP inline CS2_BASEARDECL& CS2_BASEARDECL::operator=(const CS2_BASEARDECL& inputArray)
{
    ...
    if (fMaxSegments < inputArray.fMaxSegments) {
        ...
        DerivedElement** newSegmentMap = (DerivedElement**)Allocator::allocate(inputArray.fMaxSegments * sizeof(DerivedElement*));
...
public:
    ...
    public:
        ...
        bool IsLast() const
        {
            return (fSegmentIndex == fNumSegments - 1 && fElementIndex == fNumElements - 1);
        }
    ...
    public:
        ...
        // comparison
        bool operator==(const iterator& other) const { return this == &other || (fArray == other.fArray && fCursor == other.fCursor); }
