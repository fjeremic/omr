...
public:
    ...
    public:
        ...
        // comparison
        bool operator==(const iterator& other) const { return this == &other || (Cursor::fVector == other.fVector && Cursor::fIndex == other.fIndex); }
...
template <class Allocator>
inline bool ABitVector<Allocator>::operator==(const ABitVector<Allocator>& v) const
{
    uint32_t bx = 0, wx = 0,
...
inline BitIndex ABitVector<Allocator>::ClearLastOneIfThereIsOneInRange(BitIndex low, BitIndex high, bool& foundone)
{
    ...
    for (BitIndex wordIndex = highWordIndex;
        ...
        if (WordAt(wordIndex) != kZeroBits) {
            int32_t rc = wordIndex * kBitWordSize + kBitWordSize - BitManipulator::TrailingZeroes(WordAt(wordIndex)) - 1;
...
template <class Allocator>
inline bool ABitVector<Allocator>::And(const ABitVector<Allocator>& inputVector,
...
// Place the result in the output vector.
template <class Allocator>
inline bool ABitVector<Allocator>::Andc(const ABitVector<Allocator>& inputVector,
    ABitVector<Allocator>& outputVector) const
{
    uint32_t wordIndex, thisWordSize, inputWordSize, smallerWordSize,
        largerWordSize, outputWordSize;
...
template <class Allocator>
inline bool ABitVector<Allocator>::Or(const ABitVector<Allocator>& inputVector,
    ABitVector<Allocator>& outputVector) const
{
    uint32_t wordIndex, thisWordSize, inputWordSize, smallerWordSize,
        largerWordSize, outputWordSize;
...
template <class Allocator>
inline bool ABitVector<Allocator>::Xor(const ABitVector<Allocator>& inputVector,
    ABitVector<Allocator>& outputVector) const
{
    uint32_t wordIndex, thisWordSize, inputWordSize, smallerWordSize,
        largerWordSize, outputWordSize;
