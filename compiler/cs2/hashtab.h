...
CS2_HT_TEMP void inline CS2_HT_DECL::init(HashIndex numElements)
{
    ...
    HashIndex const closedAreaSize = BitManipulator::CeilingPowerOfTwo(numElements) < kMinimumHashTableSize ? kMinimumHashTableSize : BitManipulator::CeilingPowerOfTwo(numElements);
...
CS2_HT_TEMP bool inline CS2_HT_DECL::Locate(const AKeyType& key, HashIndex& hashIndex,
