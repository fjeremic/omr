...
extern "C" void
CEEKTBCK(void **dsaptr, int *dsa_format, void **caaptr, int *member_id,
         char *program_unit_name, int *program_unit_name_length,
         void **program_unit_address, int *call_instruction_address,
         char *entry_name, int *entry_name_length, void **entry_address,
         int *caller_call_instruction_address, void **caller_dsaptr,
         int *caller_dsa_format, char *statement_id, int *statement_id_length,
         void **cibptr, int *caller_main, _FEEDBACK *fc);
