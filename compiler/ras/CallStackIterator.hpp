...
protected:
  ...
  virtual uintptr_t getOffsetInProcedure()
  {
    return 0;
  }
  virtual bool isDone()
...
extern "C" void CEEKTBCK(void** dsaptr, int* dsa_format, void** caaptr, int* member_id, char* program_unit_name,
  ...
  int* caller_dsa_format, char* statement_id, int* statement_id_length, void** cibptr, int* caller_main, _FEEDBACK* fc);
