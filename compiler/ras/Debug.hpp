...
TR_Debug*
createDebugObject(TR::Compilation*);
...
public:
  ...
  virtual char* formattedString(char* buf,
                                uint32_t bufLen,
                                const char* format,
                                va_list args,
  ...
  virtual char* limitOption(char*,
                            void*,
                            TR::OptionTable*,
                            TR::Options*,
                            bool loadLimit);
  virtual int32_t* loadCustomStrategy(char* optFileName);
  virtual bool methodCanBeCompiled(TR_Memory* mem,
                                   TR_ResolvedMethod*,
                                   TR_FilterBST*&);
  virtual bool methodCanBeRelocated(TR_Memory* mem,
                                    TR_ResolvedMethod*,
                                    TR_FilterBST*&);
  virtual bool methodSigCanBeCompiled(const char*,
                                      TR_FilterBST*&,
                                      TR::Method::Type methodType);
  virtual bool methodSigCanBeRelocated(const char*, TR_FilterBST*&);
  virtual bool methodSigCanBeCompiledOrRelocated(const char*,
                                                 TR_FilterBST*&,
                                                 bool isRelocation,
                                                 TR::Method::Type methodType);
  virtual bool methodCanBeFound(TR_Memory*,
                                TR_ResolvedMethod*,
                                TR::CompilationFilters*,
                                TR_FilterBST*&);
  virtual bool methodSigCanBeFound(const char*,
                                   TR::CompilationFilters*,
                                   TR_FilterBST*&,
                                   TR::Method::Type methodType);
  ...
  virtual TR_FilterBST* addFilter(char*&,
                                  int32_t,
                                  int32_t,
                                  int32_t,
                                  TR::CompilationFilters*);
  ...
  virtual void printOptimizationHeader(const char*,
                                       const char*,
                                       int32_t,
                                       bool mustBeDone);
  ...
  virtual void printBlockOrders(TR::FILE*,
                                const char*,
  ...
  virtual void print(TR::FILE*,
                     TR_RegionAnalysis* structure,
                     uint32_t indentation);
  virtual int32_t print(TR::FILE*, TR::TreeTop*);
  virtual int32_t print(TR::FILE*,
                        TR::Node*,
                        uint32_t indentation = 0,
                        bool printSubtree = true);
  virtual void print(TR::FILE*, TR::SymbolReference*);
  virtual void print(TR::SymbolReference*,
                     TR_PrettyPrinterString&,
  ...
  virtual int32_t printWithFixedPrefix(TR::FILE*,
                                       TR::Node*,
                                       uint32_t indentation,
                                       bool printChildren,
                                       bool printRefCounts,
  ...
  virtual void print(J9JITExceptionTable* data,
  ...
  virtual void dumpSingleTreeWithInstrs(TR::TreeTop*,
                                        TR::Instruction*,
                                        bool,
                                        bool,
                                        bool,
                                        bool);
  virtual void dumpMethodInstrs(TR::FILE*,
                                const char*,
                                bool,
                                bool header = false);
  ...
  virtual void dumpInstructionComments(TR::FILE*,
                                       TR::Instruction*,
  ...
  virtual void printRegisterMask(TR::FILE* pOutFile,
  ...
  void printRegMemInstruction(TR::FILE*,
                              const char*,
                              TR::RealRegister* reg,
                              TR::RealRegister* base = 0,
                              int32_t = 0);
  void printRegRegInstruction(TR::FILE*,
                              const char*,
                              TR::RealRegister* reg1,
                              TR::RealRegister* reg2 = 0);
  void printRegImmInstruction(TR::FILE*,
                              const char*,
                              TR::RealRegister* reg,
                              int32_t imm);
  void printMemRegInstruction(TR::FILE*,
                              const char*,
                              TR::RealRegister* base,
                              int32_t offset,
                              TR::RealRegister* = 0);
  void printMemImmInstruction(TR::FILE*,
                              const char*,
                              TR::RealRegister* base,
                              int32_t offset,
                              int32_t imm);
  ...
  virtual void printNodesInEdgeListIterator(TR::FILE*,
                                            TR::CFGEdgeList& li,
                                            bool fromNode);
  ...
  virtual void print(TR::FILE*,
                     ...
                     uint32_t indentation);
  virtual void printSubGraph(TR::FILE*,
                             TR_RegionStructure* regionStructure,
                             uint32_t indentation);
  virtual void print(TR::FILE*,
  ...
  virtual void* dxMallocAndRead(uintptrj_t size,
                                void* remotePtr,
  ...
  void printBasicPreNodeInfoAndIndent(TR::FILE*,
                                      TR::Node*,
                                      uint32_t indentation);
  ...
  int32_t* printStackAtlas(uintptrj_t startPC,
                           uint8_t* mapBits,
                           int32_t numberOfSlotsMapped,
                           bool fourByteOffsets,
                           int32_t* sizeOfStackAtlas,
                           int32_t frameSize);
  uint16_t printStackAtlasDetails(uintptrj_t startPC,
                                  uint8_t* mapBits,
                                  int numberOfSlotsMapped,
                                  bool fourByteOffsets,
                                  int32_t* sizeOfStackAtlas,
                                  int32_t frameSize,
                                  int32_t* offsetInfo);
  uint8_t* printMapInfo(uintptrj_t startPC,
                        uint8_t* mapBits,
                        int32_t numberOfSlotsMapped,
                        bool fourByteOffsets,
                        int32_t* sizeOfStackAtlas,
                        ...
                        int32_t offsetInfo[],
                        bool nummaps = false);
  void printStackMapInfo(uint8_t*& mapBits,
                         int32_t numberOfSlotsMapped,
                         int32_t* sizeOfStackAtlas,
                         int32_t* offsetInfo,
                         bool nummaps = false);
  ...
  void printSnippetLabel(TR::FILE*,
                         TR::LabelSymbol* label,
                         uint8_t* cursor,
                         const char* comment1,
                         const char* comment2 = 0);
  uint8_t* printPrefix(TR::FILE*,
                       TR::Instruction*,
                       uint8_t* cursor,
                       uint8_t size);
  ...
  int32_t printRestartJump(TR::FILE*,
                           TR::X86RestartSnippet*,
                           uint8_t*,
                           int32_t,
                           const char*);

  char* printSymbolName(TR::FILE*,
                        TR::Symbol*,
                        TR::SymbolReference*,
  ...
  void findLogFile(const char* logFileName,
                   TR::Options* cmdOptions,
                   TR::Options** optionArray,
                   int32_t arraySize,
                   int32_t& index);
  ...
  void printVCG(TR::FILE*,
                TR::Block* block,
                int32_t vorder = -1,
                int32_t horder = -1);

  void printByteCodeStack(int32_t parentStackIndex,
  ...
  int32_t printPrefixAndMnemonicWithoutBarrier(TR::FILE*,
                                               ...
                                               int32_t barrier);
  void printPrefixAndMemoryBarrier(TR::FILE*,
                                   TR::Instruction* instr,
                                   int32_t barrier,
  ...
  void printDependencyConditions(TR_X86RegisterDependencyGroup*,
                                 uint8_t,
                                 char*,
                                 TR::FILE*);
  ...
  int32_t printIntConstant(TR::FILE* pOutFile,
                           int64_t value,
                           int8_t radix,
                           TR_RegisterSizes size = TR_WordReg,
                           bool padWithZeros = false);
  int32_t printDecimalConstant(TR::FILE* pOutFile,
                               int64_t value,
                               int8_t width,
                               bool padWithZeros);
  int32_t printHexConstant(TR::FILE* pOutFile,
                           int64_t value,
                           int8_t width,
                           bool padWithZeros);
  void printInstructionComment(TR::FILE* pOutFile,
                               int32_t tabStops,
                               TR::Instruction* instr);
  void printFPRegisterComment(TR::FILE* pOutFile,
                              TR::Register* target,
                              TR::Register* source);
  ...
  uint8_t* printEmitLoadPPCHelperAddrToCtr(TR::FILE*,
                                           uint8_t*,
                                           int32_t,
                                           TR::RealRegister*);
  uint8_t* printEmitLoadIndirectPPCHelperAddrToCtr(TR::FILE*,
                                                   uint8_t*,
                                                   TR::RealRegister*,
                                                   TR::RealRegister*,
                                                   int32_t);
  ...
  uint8_t* print(TR::FILE* pOutFile,
                 TR::PPCArrayCopyCallSnippet* snippet,
                 uint8_t* cursor);
  ...
  void printS390RegisterDependency(TR::FILE* pOutFile,
                                   TR::Register* virtReg,
                                   int realReg,
                                   bool uses,
                                   bool defs);
...
#define TRACERA_INSTRUCTION_INSERTED (0x0002)
  ...
  const static uint32_t DEFAULT_NODE_LENGTH =
    82; // Tree information printed to the right of node OPCode will be aligned
        // if node OPCode's length <= DEFAULT_NODE_LENGTH, or will follow the
        // node OPCode immediately (non-aligned) otherwise.
