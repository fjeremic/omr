...
public:
  ...
  virtual const char *
  getVirtualGuardTestTypeName(TR_VirtualGuardTestType testType);
  ...
  void printStackMapInfo(uint8_t *&mapBits, int32_t numberOfSlotsMapped,
                         ...
                         bool nummaps = false);
  void
  printJ9JITExceptionTableDetails(J9JITExceptionTable *data,
  ...
  void
  printFullRegisterDependencyInfo(TR::FILE *,
  ...
  uint8_t *
  printRuntimeInstrumentationOnOffInstruction(TR::FILE *pOutFile,
                                              uint8_t *cursor, bool isRION,
