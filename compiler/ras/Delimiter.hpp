...
class Delimiter {
 public:
  Delimiter(TR::Compilation *comp, bool trace, char *tag, char *comment0 = NULL,
            char *comment1 = NULL, char *comment2 = NULL)
      : _tag(tag), _comp(comp), _trace(trace) {
