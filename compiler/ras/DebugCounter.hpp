...
class DebugCounter : public DebugCounterBase {
 ...
 public:
  ...
  //
  static void prependDebugCounter(
      TR::Compilation *comp, const char *name, TR::TreeTop *nextTreeTop,
  ...
  { Free = 30,         // Time spent maintaining counters is undetectable
    ...
    Undetermined = 0,  // The default.  Use another value only if you have
                       // reason to believe it's justified.
  ...
  void accumulate(int64_t increment) {
    ...
    if (contributesToDenominator()) _denominator->accumulate(increment);
  }
