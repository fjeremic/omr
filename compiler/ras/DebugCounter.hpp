...
public:
  ...
  DebugCounterReloData* getReloData()
  {
    return _reloData;
  }
...
public:
  ...
  //
  static void prependDebugCounter(TR::Compilation* comp, const char* name, TR::TreeTop* nextTreeTop, int32_t delta = 1,
  ...
  DebugCounter* getDenominator()
  {
    return _denominator;
  }
  bool isDenominator()
  {
    return _flags.testAny(IsDenominator);
  }
