...
class DebugCounterBase {
 public:
  ...
  bool initializeReloData(TR::Compilation* comp,
                          int32_t delta,
                          int8_t fidelity,
                          int32_t staticDelta);
  void finalizeReloData(TR::Compilation* comp,
                        TR::Node* node,
                        uint8_t seqKind = 0);
...
class DebugCounter : public DebugCounterBase {
 ...
 public:
  ...
  //
  static const char* debugCounterName(TR::Compilation* comp,
                                      const char* format,
                                      ...);
  ...
  //
  static DebugCounter* getDebugCounter(TR::Compilation* comp,
                                       const char* name,
                                       int8_t fidelity,
                                       int32_t staticDelta);

  static void incStaticDebugCounter(TR::Compilation* comp,
                                    const char* name,
  ...
  static void prependDebugCounter(TR::Compilation* comp,
                                  const char* name,
                                  TR::TreeTop* nextTreeTop,
                                  int32_t delta,
                                  int8_t fidelity,
...
class DebugCounterGroup {
  CS2::HashTable<const char*, DebugCounter*, TRPersistentMemoryAllocator>
      _countersHashTable;
  CS2::HashTable<const char*,
                 DebugCounterAggregation*,
  ...
  DebugCounter* createCounter(const char* name,
                              int8_t fidelity,
 ...
 public:
  ...
  const char* counterName(TR::Compilation* comp,
                          const char* format,
                          va_list args);
