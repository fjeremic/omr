...
typedef BOOL(__stdcall *PREAD_PROCESS_MEMORY_ROUTINE64)(HANDLE, DWORD64, PVOID,
                                                        DWORD, LPDWORD);
...
typedef DWORD64(__stdcall *PTRANSLATE_ADDRESS_ROUTINE64)(HANDLE, HANDLE,
                                                         LPADDRESS64);
...
typedef BOOL(__stdcall *StackWalk64Type)(DWORD, HANDLE, HANDLE, LPSTACKFRAME64,
                                         PVOID, PREAD_PROCESS_MEMORY_ROUTINE64,
                                         PFUNCTION_TABLE_ACCESS_ROUTINE64,
                                         PGET_MODULE_BASE_ROUTINE64,
                                         PTRANSLATE_ADDRESS_ROUTINE64);
StackWalk64Type StackWalk64;
typedef BOOL(__stdcall *SymFromAddrType)(HANDLE, DWORD64, PDWORD64,
                                         PSYMBOL_INFO);
