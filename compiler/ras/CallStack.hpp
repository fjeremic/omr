...
typedef BOOL(__stdcall* PREAD_PROCESS_MEMORY_ROUTINE64)(HANDLE,
                                                        DWORD64,
                                                        PVOID,
                                                        DWORD,
                                                        LPDWORD);
...
typedef DWORD64(__stdcall* PTRANSLATE_ADDRESS_ROUTINE64)(HANDLE,
                                                         HANDLE,
                                                         LPADDRESS64);
...
typedef BOOL(__stdcall* StackWalk64Type)(DWORD,
                                         HANDLE,
                                         HANDLE,
                                         LPSTACKFRAME64,
                                         PVOID,
...
typedef BOOL(__stdcall* SymFromAddrType)(HANDLE,
                                         DWORD64,
                                         PDWORD64,
                                         PSYMBOL_INFO);
