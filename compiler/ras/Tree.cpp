...
void TR_Debug::print(TR::FILE* outFile,
                     TR_RegionAnalysis* regionAnalysis,
...
void TR_Debug::printBaseInfo(TR::FILE* pOutFile,
                             TR_Structure* structure,
                             uint32_t indentation) {
  if (pOutFile == NULL)
    return;
...
static void printInlinePath(TR::FILE* pOutFile,
...
void TR_Debug::printIRTrees(TR::FILE* pOutFile,
                            const char* title,
...
void TR_Debug::printBlockOrders(TR::FILE* pOutFile,
                                const char* title,
                                TR::ResolvedMethodSymbol* methodSymbol) {
  TR::TreeTop* tt = methodSymbol->getFirstTreeTop();
...
char* TR_Debug::formattedString(char* buf,
                                uint32_t bufLen,
                                const char* format,
                                va_list args,
...
int32_t TR_Debug::print(TR::FILE* pOutFile,
                        TR::Node* node,
                        uint32_t indentation,
                        bool printChildren) {
  if (pOutFile == NULL)
...
// Return the number of nodes encountered.
//
int32_t TR_Debug::printWithFixedPrefix(TR::FILE* pOutFile,
                                       TR::Node* node,
                                       uint32_t indentation,
                                       bool printChildren,
                                       bool printRefCounts,
...
void TR_Debug::printBasicPostNodeInfo(TR::FILE* pOutFile,
                                      TR::Node* node,
                                      uint32_t indentation) {
  TR_PrettyPrinterString output(this);
  if (pOutFile == NULL)
...
void TR_Debug::printNodeInfo(TR::Node* node,
                             TR_PrettyPrinterString& output,
                             bool prettyPrint) {
  TR_PrettyPrinterString globalIndexPrefix(this);
...
const char* TR_Debug::getName(TR::ILOpCode opCode) {
