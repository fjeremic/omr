...
void TR::DebugCounter::prependDebugCounterBump(TR::Compilation* comp, TR::TreeTop* nextTreeTop, TR::DebugCounterBase* counter, int32_t delta)
{
...
void TR::DebugCounter::prependDebugCounterBump(TR::Compilation* comp, TR::TreeTop* nextTreeTop, TR::DebugCounterBase* counter, TR::Node* deltaNode)
{
...
void TR::DebugCounter::prependDebugCounter(TR::Compilation* comp, const char* name, TR::TreeTop* nextTreeTop, int32_t delta, int8_t fidelity, int32_t staticDelta)
{
...
void TR::DebugCounter::prependDebugCounter(TR::Compilation* comp, const char* name, TR::TreeTop* nextTreeTop, TR::Node* deltaNode, int8_t fidelity, int32_t staticDelta)
{
    if (!comp->getOptions()->enableDebugCounters())
        return;
    if (!nextTreeTop)
...
void TR::DebugCounter::generateRelocation(TR::Compilation* comp, uint8_t* location, TR::Node* node, TR::DebugCounterBase* counter)
{
...
void TR::DebugCounter::generateRelocation(TR::Compilation* comp, TR::Instruction* firstInstruction, TR::Node* node, TR::DebugCounterBase* counter, uint8_t seqKind)
{
...
void TR::DebugCounter::generateRelocation(TR::Compilation* comp, TR::Instruction* firstInstruction, TR::Instruction* secondInstruction, TR::Node* node, TR::DebugCounterBase* counter, uint8_t seqKind)
{
    counter->finalizeReloData(comp, node, seqKind);
...
bool TR::DebugCounterBase::initializeReloData(TR::Compilation* comp, int32_t delta, int8_t fidelity, int32_t staticDelta)
{
    if (!_reloData) {
