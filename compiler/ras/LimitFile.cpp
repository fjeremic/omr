...
TR_FilterBST* TR_Debug::addFilter(char*& filterString,
                                  int32_t scanningExclude,
                                  int32_t optionSetIndex,
                                  int32_t lineNum,
...
bool TR_Debug::scanInlineFilters(FILE* inlineFile,
                                 int32_t& lineNumber,
                                 TR::CompilationFilters* filters) {
 ...
 */
char* TR_Debug::inlinefileOption(char* option,
                                 void* base,
        ...
        while (isdigit(p[0])) {
          ...
          if ((curPseudoRandomListElem == NULL) ||
            ...
            TR_PseudoRandomNumbersListElement* newPseudoRandomListElem =
                (TR_PseudoRandomNumbersListElement*)(TR::Compiler
                                                         ->regionAllocator
                                                         .allocate(sz));
...
char* TR_Debug::limitOption(char* option,
                            void* base,
                            TR::OptionTable* entry,
                            TR::Options* cmdLineOptions,
                            bool loadLimit) {
...
bool TR_Debug::methodCanBeFound(TR_Memory* trMemory,
