...
void TR_Debug::addInstructionComment(TR::Instruction* instr,
                                     char* comment,
                                     ...) {
  TR_ASSERT(_comp, "Required compilation object is NULL.\n");
...
const char* TR_Debug::getDiagnosticFormat(const char* format,
                                          char* buffer,
                                          int32_t length) {
...
//
uint8_t* TR_Debug::printPrefix(TR::FILE* pOutFile,
...
void TR_Debug::printSnippetLabel(TR::FILE* pOutFile,
...
const char* TR_Debug::getName(void* address,
                              const char* prefix,
                              uint32_t nextNumber,
                              bool enumerate) {
  TR_ASSERT(_comp, "Required compilation object is NULL.\n");
...
void TR_Debug::clearNodeChecklist() {
...
void TR_Debug::dumpMethodInstrs(TR::FILE* pOutFile,
                                const char* title,
                                bool dumpTrees,
                                bool header) {
...
//
void TR_Debug::printNodeEvaluation(TR::Node* node,
...
void TR_Debug::print(TR::FILE* pOutFile,
                     TR::Instruction* inst,
                     const char* title) {
  if (pOutFile == NULL)
    return;
...
void TR_Debug::print(TR::FILE* pOutFile,
                     TR::list<TR::Snippet*>& snippetList,
                     bool isWarm) {
  if (pOutFile == NULL)
    return;
...
void TR_Debug::printRegisterMask(TR::FILE* pOutFile,
                                 TR_RegisterMask mask,
                                 TR_RegisterKinds rk) {
  if (pOutFile == NULL)
    return;
...
void TR_Debug::print(TR::FILE* pOutFile,
                     TR::RegisterMappedSymbol* localCursor,
                     bool isSpillTemp) {
  trfprintf(pOutFile,
...
long _stdcall CreateProcessA(const char* appName,
                             const char* cmdLine,
...
static void printDenominators(TR::DebugCounter* c,
                              int64_t rawCount,
                              FILE* counterFile) {
  if (!c)
    return;
...
static int32_t partition(void* array,
                         int32_t first,
                         int32_t last,
                         int32_t elemSize,
...
static void quicksort(void* array,
                      int32_t first,
                      int32_t last,
                      int32_t elemSize,
                      int (*cmpFunc)(void*, void*)) {
