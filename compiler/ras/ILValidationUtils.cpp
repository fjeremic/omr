...
bool
TR::isILValidationLoggingEnabled(TR::Compilation* comp)
{
  return (comp->getOption(TR_TraceILValidator));
}

void
TR::checkILCondition(TR::Node* node,
                     bool condition,
                     TR::Compilation* comp,
...
void
TR::printILDiagnostic(TR::Compilation* comp, const char* formatStr, ...)
{
  va_list stderr_args;
...
void
TR::vprintILDiagnostic(TR::Compilation* comp, const char* formatStr, va_list ap)
{
  va_list stderr_copy;
