...
#define SYMOPT_DEBUG 0x80000000
    ...
    while (_trace_size < MAX_STACK_SIZE) {
        ...
        PSYMBOL_INFO pSymbol = (PSYMBOL_INFO)TR::globalAllocator("CallStackIterator").allocate((sizeof(SYMBOL_INFO) + MAX_SYM_NAME * sizeof(TCHAR) + sizeof(ULONG64) - 1) / sizeof(ULONG64));
