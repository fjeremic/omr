...
void TR_Debug::dumpOptions(char* optionsType, char* options, char* envOptions, TR::Options* cmdLineOptions,
  TR::OptionTable* ojit, TR::OptionTable* ofe, void* feBase, TR_FrontEnd* fe)
{
  TR::OptionTable* entry;
  char* base;
