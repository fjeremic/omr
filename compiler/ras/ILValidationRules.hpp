...
private:
  void checkNodeSoundness(TR::TreeTop* location,
                          TR::Node* node,
                          TR::NodeChecklist& ancestorNodes,
                          TR::NodeChecklist& visitedNodes);

  void checkSoundnessCondition(TR::TreeTop* location,
                               bool condition,
...
public:
   ...
   * @return returns on success.
   */
  virtual void validate(TR::TreeTop* firstTreeTop,
                        TR::TreeTop* exitTreeTop) = 0;
