 ...
 */
#if defined(J9ZOS390)
#define J9THREAD_MAX_TLS_KEYS                                                  \
  123 /* One of the TLS slots is replaced by os_errno2 on ZOS */
#else /* !J9ZOS390 */
...
#define J9THREAD_CATEGORY_SYSTEM_GC_THREAD                                     \
  (0x2 | J9THREAD_CATEGORY_SYSTEM_THREAD)
#define J9THREAD_CATEGORY_SYSTEM_JIT_THREAD                                    \
  (0x4 | J9THREAD_CATEGORY_SYSTEM_THREAD)

#define J9THREAD_CATEGORY_RESOURCE_MONITOR_THREAD 0x10

#define J9THREAD_CATEGORY_APPLICATION_THREAD 0x100
#define J9THREAD_USER_DEFINED_THREAD_CATEGORY_1                                \
  (0x1000 | J9THREAD_CATEGORY_APPLICATION_THREAD)
#define J9THREAD_USER_DEFINED_THREAD_CATEGORY_2                                \
  (0x2000 | J9THREAD_CATEGORY_APPLICATION_THREAD)
#define J9THREAD_USER_DEFINED_THREAD_CATEGORY_3                                \
  (0x3000 | J9THREAD_CATEGORY_APPLICATION_THREAD)
#define J9THREAD_USER_DEFINED_THREAD_CATEGORY_4                                \
  (0x4000 | J9THREAD_CATEGORY_APPLICATION_THREAD)
#define J9THREAD_USER_DEFINED_THREAD_CATEGORY_5                                \
  (0x5000 | J9THREAD_CATEGORY_APPLICATION_THREAD)
...
#if defined(OMR_THR_JLM_HOLD_TIMES)
#define J9_ABSTRACT_THREAD_FIELDS_2 struct J9ThreadTracing* tracing;
...
#if defined(OMR_THR_MCS_LOCKS)
#define J9_ABSTRACT_THREAD_FIELDS_4 omrthread_mcs_nodes_t mcsNodes;
...
#define J9_ABSTRACT_MONITOR_FIELDS_2 struct J9ThreadMonitorTracing* tracing;
#else /* OMR_THR_JLM */
...
#if defined(OMR_THR_ADAPTIVE_SPIN)
#define J9_ABSTRACT_MONITOR_FIELDS_5 uintptr_t sampleCounter;
...
#define J9_ABSTRACT_MONITOR_FIELDS_7 volatile uintptr_t spinThreads;
#else /* defined(OMR_THR_SPIN_WAKE_CONTROL) &&                                 \
         defined(OMR_THR_THREE_TIER_LOCKING) */
#define J9_ABSTRACT_MONITOR_FIELDS_7
#endif /* defined(OMR_THR_SPIN_WAKE_CONTROL) &&                                \
          defined(OMR_THR_THREE_TIER_LOCKING) */

#if defined(OMR_THR_MCS_LOCKS)
#define J9_ABSTRACT_MONITOR_FIELDS_8 omrthread_mcs_node_t volatile queueTail;
#else /* defined(OMR_THR_MCS_LOCKS) */
...
#define J9THREAD_ERR_USAGE_RETRIEVAL_ERROR                                     \
  20 /* error retrieving thread usage data. */
#define J9THREAD_ERR_USAGE_RETRIEVAL_UNSUPPORTED                               \
  21 /* -XX:-EnableCPUmonitor has been set, usage retrieval unsupported. */
#define J9THREAD_ERR_INVALID_TIMESTAMP 22 /* Invalid timestamp retrieved. */

/* return values from omrthread_get_cpu_time() */
#define J9THREAD_ERR_NO_SUCH_THREAD                                            \
  23 /* Underlying thread is no longer available. */
...
#if defined(OMR_THR_MCS_LOCKS)
#define OMRTHREAD_ERR_CANT_ALLOC_MCS_NODES                                     \
  26   /* Error initializing J9Thread->mcsNodes. */
#endif /* defined(OMR_THR_MCS_LOCKS) */

/* Bit flag indicating that os_errno is set. This flag must not interfere with
 * the sign bit. */
