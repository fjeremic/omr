...
#define UT_APPLICATION_TRACE_MODULE 99
   ...
   * =============================================================================
   */
  typedef void (*UtListenerWrapper)(void* userData,
                                    OMR_VMThread* env,
                                    void** thrLocal,
                                    const char* modName,
                                    uint32_t traceId,
  ...
  typedef void (*utsSubscriberAlarmCallback)(
    struct UtSubscription* subscription);
...
#define UT_SERVER_INTF_NAME "UTSI"
  ...
  {
    void (*TraceVNoThread)(UtModuleInfo* modInfo,
                           uint32_t traceId,
                           const char* spec,
                           va_list varArgs);
    omr_error_t (*TraceSnap)(UtThreadData** thr, char* label, char** response);
    omr_error_t (*TraceSnapWithPriority)(UtThreadData** thr,
                                         char* label,
                                         int32_t snapPriority,
                                         char** response,
                                         int32_t sync);
    omr_error_t (*AddComponent)(UtModuleInfo* modInfo, const char** fmt);
    omr_error_t (*GetComponents)(UtThreadData** thr,
                                 char*** list,
                                 int32_t* number);
    omr_error_t (*GetComponent)(char* name,
    ...
    char* (*FormatNextTracePoint)(struct UtTracePointIterator* iter,
                                  char* buffer,
                                  uint32_t buffLen);
    omr_error_t (*FreeTracePointIterator)(UtThreadData** thr,
                                          struct UtTracePointIterator* iter);
    omr_error_t (*RegisterRecordSubscriber)(UtThreadData** thr,
                                            const char* description,
                                            utsSubscriberCallback func,
                                            utsSubscriberAlarmCallback alarm,
                                            void* userData,
                                            struct UtTraceBuffer* start,
                                            struct UtTraceBuffer* stop,
    ...
    omr_error_t (*DeregisterTracePointSubscriber)(UtThreadData** thr,
                                                  UtSubscription* subscription);
    omr_error_t (*TraceRegister)(UtThreadData** thr,
                                 UtListenerWrapper func,
                                 void* userData);
    omr_error_t (*TraceDeregister)(UtThreadData** thr,
                                   UtListenerWrapper func,
                                   void* userData);
