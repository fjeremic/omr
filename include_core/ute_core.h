 ...
 * =============================================================================
 */
typedef void (*UtListenerWrapper)(void* userData, OMR_VMThread* env, void** thrLocal, const char* modName,
  uint32_t traceId, const char* format, va_list varargs);
...
struct UtServerInterface {
  ...
  omr_error_t (*TraceSnapWithPriority)(
    UtThreadData** thr, char* label, int32_t snapPriority, char** response, int32_t sync);
  ...
  omr_error_t (*RegisterRecordSubscriber)(UtThreadData** thr, const char* description, utsSubscriberCallback func,
    utsSubscriberAlarmCallback alarm, void* userData, struct UtTraceBuffer* start, struct UtTraceBuffer* stop,
  ...
  omr_error_t (*FlushTraceData)(
    UtThreadData** thr, struct UtTraceBuffer** first, struct UtTraceBuffer** last, int32_t pause);
  omr_error_t (*GetTraceMetadata)(void** data, int32_t* length);
  void (*DisableTrace)(int32_t type);
  void (*EnableTrace)(int32_t type);
  omr_error_t (*RegisterTracePointSubscriber)(UtThreadData** thr, char* description, utsSubscriberCallback callback,
    utsSubscriberAlarmCallback alarm, void* userData, UtSubscription** subscription);
