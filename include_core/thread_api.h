 ...
 * @return uintptr_t
 */
uintptr_t omrthread_get_stack_range(omrthread_t thread, void** stackStart, void** stackEnd);
 ...
 */
J9ThreadMonitorTracing* omrthread_monitor_get_tracing(omrthread_monitor_t monitor);
#endif /* OMR_THR_JLM */
 ...
 */
omrthread_monitor_t omrthread_monitor_walk(omrthread_monitor_walk_state_t* walkState);
 ...
 * @return omrthread_monitor_t
 */
omrthread_monitor_t omrthread_monitor_walk_no_locking(omrthread_monitor_walk_state_t* walkState);
 ...
 * @return intptr_t
 */
intptr_t omrthread_create(omrthread_t* handle, uintptr_t stacksize, uintptr_t priority, uintptr_t suspend,
 ...
 * @return intptr_t
 */
intptr_t omrthread_create_ex(omrthread_t* handle, const omrthread_attr_t* attr, uintptr_t suspend,
  omrthread_entrypoint_t entrypoint, void* entryarg);
 ...
 * @return intptr_t
 */
intptr_t omrthread_monitor_destroy_nolock(omrthread_t self, omrthread_monitor_t monitor);
 ...
 * @return intptr_t
 */
intptr_t omrthread_monitor_enter_abortable_using_threadId(omrthread_monitor_t monitor, omrthread_t threadId);
 ...
 * @return intptr_t
 */
intptr_t omrthread_monitor_enter_using_threadId(omrthread_monitor_t monitor, omrthread_t threadId);
 ...
 * @return intptr_t
 */
intptr_t omrthread_monitor_exit_using_threadId(omrthread_monitor_t monitor, omrthread_t threadId);
 ...
 * @return intptr_t
 */
intptr_t omrthread_monitor_try_enter_using_threadId(omrthread_monitor_t monitor, omrthread_t threadId);
 ...
 * @return intptr_t
 */
intptr_t omrthread_monitor_wait_abortable(omrthread_monitor_t monitor, int64_t millis, intptr_t nanos);
 ...
 * @return intptr_t
 */
intptr_t omrthread_monitor_wait_interruptable(omrthread_monitor_t monitor, int64_t millis, intptr_t nanos);
 ...
 * @return intptr_t
 */
intptr_t omrthread_monitor_wait_timed(omrthread_monitor_t monitor, int64_t millis, intptr_t nanos);
 ...
 */
intptr_t omrthread_set_category(omrthread_t thread, uintptr_t category, uintptr_t type);
