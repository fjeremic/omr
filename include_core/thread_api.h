 ...
 * @return uintptr_t
 */
uintptr_t omrthread_get_stack_range(omrthread_t thread,
                                    void** stackStart,
                                    void** stackEnd);
 ...
 * @return intptr_t
 */
intptr_t omrthread_rwmutex_init(omrthread_rwmutex_t* handle,
                                uintptr_t flags,
                                const char* name);
 ...
 * @return intptr_t
 */
intptr_t omrthread_tls_set(omrthread_t thread,
