...
public:
  ...
  explicit IntrusiveListIterator(T* root)
    : _current(root)
  {}
  ...
  IntrusiveListIterator<T, Accessor>& operator=(
    const IntrusiveListIterator<T, Accessor>& rhs)
  {
...
public:
  ...
  explicit IntrusiveListConstIterator(T* root)
    : _current(root)
  {}
  ...
  IntrusiveListConstIterator<T, Accessor>& operator=(
    const IntrusiveListConstIterator<T, Accessor>& rhs)
  {
    _current = rhs._current;
    return *this;
  }
...
bool
operator==(const IntrusiveListIterator<T, A>& lhs,
