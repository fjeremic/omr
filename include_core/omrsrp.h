...
/* OMRTODO
 * The #ifndef checks are exploited by j9dbgext.h to override the SRP macros
 * with out-of-process variants. j9dbgext.h is used by trdbgext.c.
 */
...
#endif
#define NNSRP_SET(field, value)                                                \
  (field) = (J9SRP)(((uint8_t *)(value)) - (uint8_t *)&(field))
#define SRP_SET(field, value)                                                  \
  (field) = (J9SRP)((value) ? (((uint8_t *)(value)) - (uint8_t *)&(field)) : 0)
...
#ifndef NNWSRP_GET
#define NNWSRP_GET(field, type)                                                \
  ((type)(((uint8_t *)&(field)) + (J9WSRP)(field)))
#endif
#ifndef WSRP_GET
#define WSRP_GET(field, type) ((type)((field) ? NNWSRP_GET(field, type) : NULL))
#endif
#define NNWSRP_SET(field, value)                                               \
  (field) = (J9WSRP)(((uint8_t *)(value)) - (uint8_t *)&(field))
#define WSRP_SET(field, value)                                                 \
  (field) = (J9WSRP)((value) ? (((uint8_t *)(value)) - (uint8_t *)&(field)) : 0)
