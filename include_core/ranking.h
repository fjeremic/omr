...
extern "C"
{
   ...
   * value.  The keys are organized by some sorting based on their rank in such
   * a way that we can access that key's count in O(1) time.   Updates of count
   * values are also quick (increments of count values should not require much
   * time).
   *
