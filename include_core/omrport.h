...
typedef enum J9MemoryState { J9NUMA_PREFERRED,
    J9NUMA_ALLOWED,
    J9NUMA_DENIED } J9MemoryState;
...
typedef struct OMRPortLibrary {
    ...
    BOOLEAN (*sysinfo_cgroup_is_memlimit_set)
    (struct OMRPortLibrary* portLibrary);
    ...
    BOOLEAN (*heap_grow)
    (struct OMRPortLibrary* portLibrary, struct J9Heap* heap, uintptr_t growAmount);
