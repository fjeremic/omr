...
#define AVL_SETBALANCE(x, bal) \
  (((x)->leftChild) = (J9WSRP)(((uintptr_t)((x)->leftChild) & (~(uintptr_t)AVL_BALANCEMASK)) | (bal)))

#define AVL_SRP_SETNODE(field, value) \
  (field) = (J9WSRP)(                 \
    ((uintptr_t)field & AVL_BALANCEMASK) | ((value) ? (uintptr_t)(((uint8_t*)(value)) - (uint8_t*)&(field)) : 0))
#define AVL_NNSRP_SETNODE(field, value) \
  (field) = (J9WSRP)(((uintptr_t)field & AVL_BALANCEMASK) | (uintptr_t)(((uint8_t*)(value)) - (uint8_t*)&(field)))
...
#define AVL_SRP_GETNODE(node) \
  ((J9AVLTreeNode*)(AVL_GETNODE(node) ? ((((uint8_t*)&(node)) + (J9WSRP)(AVL_GETNODE(node)))) : NULL))
