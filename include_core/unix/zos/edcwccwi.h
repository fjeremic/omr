...
? ? = ifndef __edcwccwi ? ? = ifdef __COMPILER_VER__
                            ? ? = pragma filetag("IBM-1047") ? ? = endif
#define __edcwccwi 1
...
#define __STATIC_REINIT_FULL 1
  ...
  __dsa_prev(const void* /* pointer to current DSA           */
  ...
  void*                 /* pointer to entry point -- NULL =
                           could not find                   */
  __ep_find(const void* /* pointer to DSA                   */
  ...
  __fnwsa(const void* /* pointer to entry point           */
  ...
  __bldxfd(void* /* pointer to entry point           */

  );
#endif /* __XPLINK__ && !LP64 */

  typedef struct __jumpinfo_vr_ext
  {
   ...
   **********************************************************************
   */
  void __far_jump(struct __jumpinfo * /* pointer to jump info buffer      */
  );
  ...
  unsigned long                       /* returns the previous value of the
                                         ...
                                         first call)                      */
  __set_stack_softlimit(unsigned long /* soft limit stack size in bytes   */
...
#if __EDC_TARGET >= __EDC_LE4107 /* was '__EDC_LE410A' Modified for            \
                                    jit_freeSystemStackPointer */
...
#define _VHM_REPORT 4
  ...
  struct __event1_s
  {
    ...
    unsigned int __ev1_le_xplink : 1, __ev1_le_reserved : 31;
    unsigned int __ev1_vhm_xplink : 1, __ev1_vhm_reserved : 31;
  };
...
#endif
#define __LE_SAVSTACK_ADDR (((void**)(*(((void**)(__LAA_P)) + 11))) + 4)
#define __LE_SAVSTACK_ASYNC_ADDR (((void**)(*(((void**)(__LAA_P)) + 11))) + 42)
#endif
