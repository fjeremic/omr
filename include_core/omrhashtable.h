...
#define J9HASH_TABLE_COLLISION_RESILIENT \
  0x00000002 /*!< Use hash table using avl trees for collision resolution instead of lists */
...
#define J9HASH_TABLE_ALLOW_SIZE_OPTIMIZATION \
  0x00000008 /*!< Allow space optimized hashTable, some functions not supported */
...
#define J9HASH_TABLE_AVL_TREE_TAG_BIT \
  0x00000001 /*!< Bit to indicate that hastable slot contains a pointer to an AVL tree */
...
typedef uintptr_t (*J9HashTableEqualFn)(
  void* leftEntry, void* rightEntry, void* userData); /* Forward struct declaration */
typedef intptr_t (*J9HashTableComparatorFn)(struct J9AVLTree* tree, struct J9AVLTreeNode* leftNode,
  struct J9AVLTreeNode* rightNode); /* Forward struct declaration */
typedef void (*J9HashTablePrintFn)(
  OMRPortLibrary* portLibrary, void* entry, void* userData); /* Forward struct declaration */
