...
#define IS_ZERO_DBL_PTR(dblptr)        \
  ((LOW_U32_FROM_DBL_PTR(dblptr) == 0) \
    && ((HIGH_U32_FROM_DBL_PTR(dblptr) == 0) || (HIGH_U32_FROM_DBL_PTR(dblptr) == DOUBLE_SIGN_MASK_HI)))
#define IS_ONE_DBL_PTR(dblptr)                                                                  \
  ((HIGH_U32_FROM_DBL_PTR(dblptr) == 0x3ff00000 || HIGH_U32_FROM_DBL_PTR(dblptr) == 0xbff00000) \
    && (LOW_U32_FROM_DBL_PTR(dblptr) == 0))
#define IS_NAN_DBL_PTR(dblptr)                                                            \
  (((HIGH_U32_FROM_DBL_PTR(dblptr) & DOUBLE_EXPONENT_MASK_HI) == DOUBLE_EXPONENT_MASK_HI) \
    && (LOW_U32_FROM_DBL_PTR(dblptr) | (HIGH_U32_FROM_DBL_PTR(dblptr) & DOUBLE_MANTISSA_MASK_HI)))
#define IS_INF_DBL_PTR(dblptr)                                                                                        \
  (((HIGH_U32_FROM_DBL_PTR(dblptr) & (DOUBLE_EXPONENT_MASK_HI | DOUBLE_MANTISSA_MASK_HI)) == DOUBLE_EXPONENT_MASK_HI) \
    && (LOW_U32_FROM_DBL_PTR(dblptr) == 0))
#define IS_DENORMAL_DBL_PTR(dblptr)                                 \
  (((HIGH_U32_FROM_DBL_PTR(dblptr) & DOUBLE_EXPONENT_MASK_HI) == 0) \
    && ((HIGH_U32_FROM_DBL_PTR(dblptr) & DOUBLE_MANTISSA_MASK_HI) != 0 || (LOW_U32_FROM_DBL_PTR(dblptr) != 0)))
...
#define IS_NEGATIVE_MAX_DBL_PTR(dblptr) \
  ((HIGH_U32_FROM_DBL_PTR(dblptr) == 0xFFEFFFFF) && (LOW_U32_FROM_DBL_PTR(dblptr) == 0xFFFFFFFF))
...
#define IS_DENORMAL_SNGL_PTR(fltptr) \
  (((*U32P((fltptr)) & (uint32_t)~SINGLE_SIGN_MASK) - (uint32_t)1) < (uint32_t)SINGLE_MANTISSA_MASK)
...
#define SET_NINF_DBL_PTR(dblptr)                                                   \
  HIGH_U32_FROM_DBL_PTR(dblptr) = (DOUBLE_EXPONENT_MASK_HI | DOUBLE_SIGN_MASK_HI); \
  LOW_U32_FROM_DBL_PTR(dblptr) = 0
