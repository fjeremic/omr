...
typedef struct OMR_SysInfo {
  uintptr_t
    systemCpuTimeNegativeElapsedTimeCount; /* consecutive negative elapsed time count for system CPU load calculation */
  uintptr_t processCpuTimeNegativeElapsedTimeCount; /* consecutive negative elapsed time count for process CPU load
                                                       calculation */
  OMRSysInfoCpuLoadCallStatus
    systemCpuLoadCallStatus; /* whether GetSystemCpuLoad is supported on this platform or user have sufficient rights */
  OMRSysInfoCpuLoadCallStatus processCpuLoadCallStatus; /* whether GetProcessCpuLoad is supported on this platform or
                                                           user have sufficient rights */
