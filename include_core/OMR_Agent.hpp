...
public:
  ...
  /* The following private data has been made public so that this header file
   * can be processed for DDR */

  typedef omr_error_t (*onloadfunc_t)(OMR_TI const *ti, OMR_VM *vm,
                                      char const *options,
...
public:
   ...
   * OMR_ERROR_ILLEGAL_ARGUMENT if the agent is in an invalid state for invoking
   * OnLoad.
   */
