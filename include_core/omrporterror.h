 ...
 *
 * When an error is reported by the operating system the port library must
 * translate this OS specific error code to a portable error code.  All portable
 * error codes are negative numbers.  Not every module of the port library will
 * have error codes dedicated to it's own use, some will use the generic
 * portable error code values.
 *
 * Errors reported by the OS may be recorded by calling the port library
 * functions @ref omrerror.c::omrerror_set_last_error
 * "omrerror_set_last_error()" or @ref
 * omrerror.c::omrerror_set_last_error_with_message
 * "omrerror_set_last_error_with_message()" or @ref
 * omrerror.c::omrerror_set_last_error_with_message_format
 * "omrerror_set_last_error_with_message_format()". The mapping of the OS
 * specific error code to a portable error code is the responsibility of the
 * calling module.
 */
 ...
 * Where possible it is recommended that all modules that return error codes
 * have their own set
 *
 ...
 * The least significant 16 bits will identify the errno that occured while
...
#define OMRPORT_ERROR_MMAP_MAP_FILE_UNSUPPORTEDWRITE                           \
  (OMRPORT_ERROR_MMAP_BASE - 1)
...
#define OMRPORT_ERROR_MMAP_MAP_FILE_CREATEMAPPINGOBJECTFAILED                  \
  (OMRPORT_ERROR_MMAP_BASE - 4)
...
#define OMRPORT_ERROR_SYSINFO_ENV_INIT_CRASHED_COPYING_BUFFER                  \
  (OMRPORT_ERROR_SYSINFO_BASE - 1)
...
#define OMRPORT_ERROR_SYSINFO_QUERY_SETUP_FAILED                               \
  (OMRPORT_ERROR_SYSINFO_BASE - 4)
#define OMRPORT_ERROR_SYSINFO_NOT_SUPPORTED (OMRPORT_ERROR_SYSINFO_BASE - 5)
#define OMRPORT_ERROR_SYSINFO_INSUFFICIENT_PRIVILEGE                           \
  (OMRPORT_ERROR_SYSINFO_BASE - 6)
#define OMRPORT_ERROR_SYSINFO_NULL_OBJECT_RECEIVED                             \
  (OMRPORT_ERROR_SYSINFO_BASE - 7)
#define OMRPORT_ERROR_SYSINFO_ERROR_READING_MEMORY_INFO                        \
  (OMRPORT_ERROR_SYSINFO_BASE - 8)
#define OMRPORT_ERROR_SYSINFO_PARAM_HAS_INVALID_RANGE                          \
  (OMRPORT_ERROR_SYSINFO_BASE - 9)
#define OMRPORT_ERROR_SYSINFO_ERROR_READING_PROCESSOR_INFO                     \
  (OMRPORT_ERROR_SYSINFO_BASE - 10)
#define OMRPORT_ERROR_SYSINFO_MEMORY_ALLOC_FAILED                              \
  (OMRPORT_ERROR_SYSINFO_BASE - 11)
#define OMRPORT_ERROR_SYSINFO_UNEXPECTED_PROCESSOR_COUNT                       \
  (OMRPORT_ERROR_SYSINFO_BASE - 12)
...
#define OMRPORT_ERROR_SYSINFO_PROCESSOR_COUNT_UNSTABLE                         \
  (OMRPORT_ERROR_SYSINFO_BASE - 15)
#define OMRPORT_ERROR_SYSINFO_GET_OPEN_FILES_NOT_SUPPORTED                     \
  (OMRPORT_ERROR_SYSINFO_BASE - 16)
#define OMRPORT_ERROR_SYSINFO_CGROUP_UNSUPPORTED_PLATFORM                      \
  (OMRPORT_ERROR_SYSINFO_BASE - 17)
#define OMRPORT_ERROR_SYSINFO_PROCESS_CGROUP_FILE_FOPEN_FAILED                 \
  (OMRPORT_ERROR_SYSINFO_BASE - 18)
#define OMRPORT_ERROR_SYSINFO_PROCESS_CGROUP_FILE_READ_FAILED                  \
  (OMRPORT_ERROR_SYSINFO_BASE - 19)
#define OMRPORT_ERROR_SYSINFO_SYS_FS_CGROUP_STATFS_FAILED                      \
  (OMRPORT_ERROR_SYSINFO_BASE - 20)
#define OMRPORT_ERROR_SYSINFO_SYS_FS_CGROUP_TMPFS_NOT_MOUNTED                  \
  (OMRPORT_ERROR_SYSINFO_BASE - 21)
#define OMRPORT_ERROR_SYSINFO_CGROUP_SUBSYSTEM_UNAVAILABLE                     \
  (OMRPORT_ERROR_SYSINFO_BASE - 22)
#define OMRPORT_ERROR_SYSINFO_CGROUP_NAME_NOT_AVAILABLE                        \
  (OMRPORT_ERROR_SYSINFO_BASE - 23)
#define OMRPORT_ERROR_SYSINFO_CGROUP_SUBSYSTEM_FILE_FOPEN_FAILED               \
  (OMRPORT_ERROR_SYSINFO_BASE - 24)
#define OMRPORT_ERROR_SYSINFO_CGROUP_MEMLIMIT_NOT_SET                          \
  (OMRPORT_ERROR_SYSINFO_BASE - 25)
#define OMRPORT_ERROR_SYSINFO_CGROUP_SUBSYSTEM_FILE_INVALID_VALUE              \
  (OMRPORT_ERROR_SYSINFO_BASE - 26)
#define OMRPORT_ERROR_SYSINFO_CGROUP_SUBSYSTEM_METRIC_NOT_AVAILABLE            \
  (OMRPORT_ERROR_SYSINFO_BASE - 27)
...
#define OMRPORT_ERROR_STRING_UNSUPPORTED_ENCODING                              \
  (OMRPORT_ERROR_STRING_BASE - 3)
