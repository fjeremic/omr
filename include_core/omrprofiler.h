...
#pragma warning(disable : 4200)
   ...
   * the new entry.
   * @retval OMR_ERROR_FAILED_TO_ATTACH_NATIVE_THREAD Unable to attach to the
   * omrthread library, which is needed to lock the method dictionary.
   ...
   * This allows omrglue code to be compiled without access to
   * tracegen-generated header files.
   *
   ...
   * key of the method's entry in the method dictionary.
   */
   ...
   * tracegen-generated header files.
   *
   * Stack stampling is enabled if either of the sampling tracepoints is
   * enabled, regardless of whether the method dictionary is enabled.
   *
