 ...
 * must be provided in name / value pairs. If a name has no value, a NULL array
 ...
 * currentThread->_os_thread are used to register the thread. The trace engine's
 * thread identifier will be saved into a field of currentThread.
