...
#define J9_EVENT_IS_HOOKED(interface, event) \
  (((uint8_t*)(&(interface).common + 1))[(event)&J9HOOK_EVENT_NUM_MASK] & J9HOOK_FLAG_HOOKED)
#define J9_EVENT_IS_RESERVED(interface, event) \
  (((uint8_t*)(&(interface).common + 1))[(event)&J9HOOK_EVENT_NUM_MASK] & J9HOOK_FLAG_RESERVED)
...
typedef void (*J9HookFunction)(struct J9HookInterface** hookInterface, uintptr_t eventNum, void* eventData,
...
typedef struct J9HookInterface {
  ...
  intptr_t (*J9HookRegister)(
    struct J9HookInterface** hookInterface, uintptr_t eventNum, J9HookFunction function, void* userData, ...);
  intptr_t (*J9HookRegisterWithCallSite)(struct J9HookInterface** hookInterface, uintptr_t eventNum,
...
#define J9HOOK_DUMPINFO(interface, event)                          \
  (&((OMREventInfo4Dump*)&(((J9HookRecord**)((uint8_t*)(interface) \
    + (interface)->size))[0 - (interface)->eventSize]))[event - (interface)->eventSize])
