...
#define J9HOOK_LIB_CONTROL_TRACE_STOP "trace_stop"
  ...
  typedef struct J9HookInterface
  {
    ...
    intptr_t (*J9HookRegister)(struct J9HookInterface** hookInterface,
                               ...
                               void* userData,
                               ...);
    intptr_t (*J9HookRegisterWithCallSite)(
      struct J9HookInterface** hookInterface,
      uintptr_t eventNum,
      J9HookFunction function,
      const char* callsite,
...
#define OMRHOOK_DEFAULT_THRESHOLD_IN_MICROSECONDS_WARNING_CALLBACK_ELAPSED_TIME \
  ...
  /* array of OMREventInfo4Dump is added in individual hookInterface by Hook
     ...
     macro to access &infos4Dump[event] locate infos4Dump from end of interface
     to avoid alignment calculating
  */
