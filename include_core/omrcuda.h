...
typedef enum J9CudaError {
   ...
   * may return this value include omrcuda_eventQuery() and
   * omrcuda_streamQuery().
   */
   ...
   * J9CUDA_DEVICE_LIMIT_DEV_RUNTIME_PENDING_LAUNCH_COUNT to be higher than the
...
typedef struct J9CudaJitOptions {
   ...
   * specified size (or larger) may be actually be launched. If set to zero, no
   * limit will be imposed. If set to a non-zero value, this field will be
 ...
 */
typedef void (*J9CudaStreamCallback)(J9CudaStream stream, int32_t error,
                                     uintptr_t userData);
