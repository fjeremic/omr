...
/* to add errors to this set of defines, include the textual error message in
...
/* set an error before hand, just in case we fail so badly we can't record it
 * after. error is negative to note speculation */
